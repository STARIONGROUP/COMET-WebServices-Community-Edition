...
namespace CDP4Orm.Dao
{
    ...
    public partial interface ISiteDirectoryDao : IDao
    {
        ...
        /// </returns>
        IEnumerable<CDP4Common.DTO.SiteDirectory> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false);

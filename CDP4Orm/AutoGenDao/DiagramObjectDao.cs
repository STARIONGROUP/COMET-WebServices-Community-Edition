...
namespace CDP4Orm.Dao
{
    ...
    public partial class DiagramObjectDao : DiagramShapeDao, IDiagramObjectDao
    {
        ...
        /// </returns>
        public virtual IEnumerable<CDP4Common.DTO.DiagramObject> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false)
        {
        ...
        public virtual bool Upsert(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.DiagramObject diagramObject, CDP4Common.DTO.Thing container = null)
        {
            ...
            using (var command = new NpgsqlCommand())
            {
                ...
                sqlBuilder.AppendFormat(" DO UPDATE \"{0}\".\"DiagramObject\"", partition);

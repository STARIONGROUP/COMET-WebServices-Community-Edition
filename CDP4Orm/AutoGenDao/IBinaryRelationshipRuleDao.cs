...
namespace CDP4Orm.Dao
{
    ...
    public partial interface IBinaryRelationshipRuleDao : IDao
    {
        ...
        /// </returns>
        IEnumerable<CDP4Common.DTO.BinaryRelationshipRule> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false);

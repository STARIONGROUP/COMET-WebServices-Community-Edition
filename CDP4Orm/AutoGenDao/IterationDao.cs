    ...
    public partial class IterationDao : ThingDao, IIterationDao
    {
        ...
        public void CopyIteration(NpgsqlTransaction transaction, string sourcePartition, string targetPartition)
        {
            using (var command = new NpgsqlCommand())
            {
                ...
                sqlBuilder.AppendFormat("INSERT INTO \"{0}\".\"ArchitectureDiagram\" SELECT * FROM \"{1}\".\"ArchitectureDiagram\";", targetPartition, sourcePartition);
                ...
                sqlBuilder.AppendFormat("INSERT INTO \"{0}\".\"DiagramFrame\" SELECT * FROM \"{1}\".\"DiagramFrame\";", targetPartition, sourcePartition);
                ...
                sqlBuilder.AppendFormat("INSERT INTO \"{0}\".\"DiagramPort\" SELECT * FROM \"{1}\".\"DiagramPort\";", targetPartition, sourcePartition);

    ...
    public partial class IterationDao : ThingDao, IIterationDao
    {
        ...
        public void CopyIteration(NpgsqlTransaction transaction, string sourcePartition, string targetPartition)
        {
            using (var command = new NpgsqlCommand())
            {
                ...
                sqlBuilder.AppendFormat("INSERT INTO \"{0}\".\"ArchitectureDiagram\" (\"Iid\", \"ValueTypeDictionary\", \"ValidFrom\", \"ValidTo\", \"Owner\", \"TopArchitectureElement\") SELECT \"Iid\", \"ValueTypeDictionary\", \"ValidFrom\", \"ValidTo\", \"Owner\", \"TopArchitectureElement\" FROM \"{1}\".\"ArchitectureDiagram\";", targetPartition, sourcePartition);
                ...
                sqlBuilder.AppendFormat("INSERT INTO \"{0}\".\"ArchitectureElement\" (\"Iid\", \"ValueTypeDictionary\", \"ValidFrom\", \"ValidTo\") SELECT \"Iid\", \"ValueTypeDictionary\", \"ValidFrom\", \"ValidTo\" FROM \"{1}\".\"ArchitectureElement\";", targetPartition, sourcePartition);
                ...
                sqlBuilder.AppendFormat("INSERT INTO \"{0}\".\"Attachment\" (\"Iid\", \"ValueTypeDictionary\", \"ValidFrom\", \"ValidTo\", \"Container\") SELECT \"Iid\", \"ValueTypeDictionary\", \"ValidFrom\", \"ValidTo\", \"Container\" FROM \"{1}\".\"Attachment\";", targetPartition, sourcePartition);
                ...
                sqlBuilder.AppendFormat("INSERT INTO \"{0}\".\"Behavior\" (\"Iid\", \"ValueTypeDictionary\", \"ValidFrom\", \"ValidTo\", \"Container\") SELECT \"Iid\", \"ValueTypeDictionary\", \"ValidFrom\", \"ValidTo\", \"Container\" FROM \"{1}\".\"Behavior\";", targetPartition, sourcePartition);
                ...
                sqlBuilder.AppendFormat("INSERT INTO \"{0}\".\"BehavioralParameter\" (\"Iid\", \"ValueTypeDictionary\", \"ValidFrom\", \"ValidTo\", \"Container\", \"Parameter\") SELECT \"Iid\", \"ValueTypeDictionary\", \"ValidFrom\", \"ValidTo\", \"Container\", \"Parameter\" FROM \"{1}\".\"BehavioralParameter\";", targetPartition, sourcePartition);
                sqlBuilder.AppendFormat("UPDATE \"{0}\".\"BehavioralParameter\" SET \"ValidFrom\" = \"SiteDirectory\".get_transaction_time(), \"ValidTo\" = 'infinity';", targetPartition);
                ...
                sqlBuilder.AppendFormat("INSERT INTO \"{0}\".\"DiagramCanvas\" (\"Iid\", \"ValueTypeDictionary\", \"ValidFrom\", \"ValidTo\", \"Container\", \"LockedBy\") SELECT \"Iid\", \"ValueTypeDictionary\", \"ValidFrom\", \"ValidTo\", \"Container\", \"LockedBy\" FROM \"{1}\".\"DiagramCanvas\";", targetPartition, sourcePartition);
                ...
                sqlBuilder.AppendFormat("INSERT INTO \"{0}\".\"DiagramFrame\" (\"Iid\", \"ValueTypeDictionary\", \"ValidFrom\", \"ValidTo\") SELECT \"Iid\", \"ValueTypeDictionary\", \"ValidFrom\", \"ValidTo\" FROM \"{1}\".\"DiagramFrame\";", targetPartition, sourcePartition);
                sqlBuilder.AppendFormat("UPDATE \"{0}\".\"DiagramFrame\" SET \"ValidFrom\" = \"SiteDirectory\".get_transaction_time(), \"ValidTo\" = 'infinity';", targetPartition);
                ...
                sqlBuilder.AppendFormat("INSERT INTO \"{0}\".\"DiagramPort\" (\"Iid\", \"ValueTypeDictionary\", \"ValidFrom\", \"ValidTo\") SELECT \"Iid\", \"ValueTypeDictionary\", \"ValidFrom\", \"ValidTo\" FROM \"{1}\".\"DiagramPort\";", targetPartition, sourcePartition);
                sqlBuilder.AppendFormat("UPDATE \"{0}\".\"DiagramPort\" SET \"ValidFrom\" = \"SiteDirectory\".get_transaction_time(), \"ValidTo\" = 'infinity';", targetPartition);
                ...
                sqlBuilder.AppendFormat("INSERT INTO \"{0}\".\"Attachment_FileType\" (\"Attachment\", \"FileType\", \"ValidFrom\", \"ValidTo\") SELECT \"Attachment\", \"FileType\", \"ValidFrom\", \"ValidTo\" FROM \"{1}\".\"Attachment_FileType\";", targetPartition, sourcePartition);
        ...
        public void ModifyUserTrigger(NpgsqlTransaction transaction, string sourcePartition, bool enable)
        {
            ...
            using (var command = new NpgsqlCommand())
            {
                ...
                sqlBuilder.AppendFormat("ALTER TABLE \"{0}\".\"DiagramFrame\" {1} TRIGGER USER;", sourcePartition, triggerStatus);
                ...
                sqlBuilder.AppendFormat("ALTER TABLE \"{0}\".\"DiagramPort\" {1} TRIGGER USER;", sourcePartition, triggerStatus);

// --------------------------------------------------------------------------------------------------------------------
// <copyright file="BookDao.cs" company="Starion Group S.A.">
...
namespace CDP4Orm.Dao
{
    ...
    /// <summary>
    /// The Book Data Access Object which acts as an ORM layer to the SQL database.
    /// </summary>
    [ExcludeFromCodeCoverage]
    public partial class BookDao : ThingDao, IBookDao
    {
        /// <summary>
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having a list of instances of <see cref="CDP4Common.DTO.Book"/> as result.
        /// </returns>
        public virtual async Task<IEnumerable<CDP4Common.DTO.Book>> ReadAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false, DateTime? instant = null)
        {
        ...
        /// </param>
        /// <returns>
        /// A deserialized instance of <see cref="CDP4Common.DTO.Book"/>.
        /// </returns>
        public virtual CDP4Common.DTO.Book MapToDto(NpgsqlDataReader reader)
        {
            ...
            var dto = new CDP4Common.DTO.Book(iid, revisionNumber);
            ...
            dto.Section.AddRange(Utils.ParseOrderedList<Guid>(reader["Section"] as string[,]));
        ...
        /// </returns>
        public virtual async Task<bool> WriteAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.Book book, long sequence, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            var beforeWriteResult = await this.BeforeWriteAsync(transaction, partition, book, container, valueTypeDictionaryAdditions);
            ...
            if (!isHandled)
            {
                beforeWrite = beforeWrite && await base.WriteAsync(transaction, partition, book, container);
                ...
                {
                    await this.AddCategoryAsync(transaction, partition, book.Iid, item);
                }
            }

            return await this.AfterWriteAsync(beforeWrite, transaction, partition, book, container);
        }
        ...
        /// An awaitable <see cref="Task"/> having True if the concept was successfully persisted as result.
        /// </returns>
        public virtual async Task<bool> UpsertAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.Book book, long sequence, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            await base.UpsertAsync(transaction, partition, book, container);
            ...
            foreach (var item in book.Category)
            {
                await this.UpsertCategoryAsync(transaction, partition, book.Iid, item);
            }
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="CDP4Common.DTO.Book"/> id that will be the source for each link table record.
        /// </param> 
        /// <param name="value">
        ...
        /// </param>
        /// <param name="book">
        /// The Book DTO that is to be updated.
        /// </param>
        /// <param name="container">
        ...
        /// </returns>
        public virtual async Task<bool> UpdateAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.Book book, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            var beforeUpdateResult = await this.BeforeUpdateAsync(transaction, partition, book, container, valueTypeDictionaryAdditions);
            ...
            if (!isHandled)
            {
                beforeUpdate = beforeUpdate && await base.UpdateAsync(transaction, partition, book, container);
            ...
            return await this.AfterUpdateAsync(beforeUpdate, transaction, partition, book, container);
        }
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="CDP4Common.DTO.Book"/> id that is to be deleted.
        /// </param>
        /// <returns>
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="CDP4Common.DTO.Book"/> id that is the source of each link table record.
        /// </param> 
        /// <param name="value">
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="CDP4Common.DTO.Book"/> id that is the source for each link table record.
        /// </param> 
        /// <param name="category">
        ...
        public async Task<bool> DeleteCategoryAsync(NpgsqlTransaction transaction, string partition, Guid iid, Guid category)
        {
            ...
            {
                var sqlBuilder = new System.Text.StringBuilder();
                sqlBuilder.AppendFormat("DELETE FROM \"{0}\".\"Book_Category\"", partition);
                sqlBuilder.Append(" WHERE \"Book\" = :book");
        ...
        /// <summary>
        /// Build a SQL read query for the current <see cref="BookDao" />
        /// </summary>
        ...
        public override string BuildReadQuery(string partition, DateTime? instant)
        {
            ...
            sqlBuilder.Append(" \"Book\".\"Container\",");

            sqlBuilder.Append(" \"Book\".\"Sequence\",");

            sqlBuilder.Append(" \"Actor\",");

            sqlBuilder.Append(" \"Book\".\"Owner\",");
            sqlBuilder.Append(" COALESCE(\"Thing_ExcludedDomain\".\"ExcludedDomain\",'{}'::text[]) AS \"ExcludedDomain\",");
            sqlBuilder.Append(" COALESCE(\"Thing_ExcludedPerson\".\"ExcludedPerson\",'{}'::text[]) AS \"ExcludedPerson\",");
            sqlBuilder.Append(" COALESCE(\"Book_Category\".\"Category\",'{}'::text[]) AS \"Category\",");
            sqlBuilder.Append(" COALESCE(\"Book_Section\".\"Section\",'{}'::text[]) AS \"Section\",");

            sqlBuilder.Remove(sqlBuilder.Length - 1, 1);
            sqlBuilder.AppendFormat(" FROM ({0}) AS \"Thing\"", this.GetThingDataSql(partition, instant));
            sqlBuilder.AppendFormat(" JOIN ({0}) AS \"Book\" USING (\"Iid\")", this.GetBookDataSql(partition, instant));
            ...
            sqlBuilder.Append(" LEFT JOIN (SELECT \"Book\" AS \"Iid\", array_agg(\"Category\"::text) AS \"Category\"");
            sqlBuilder.AppendFormat(" FROM ({0}) AS \"Book_Category\"", this.GetBook_CategoryDataSql(partition, instant));
            sqlBuilder.AppendFormat(" JOIN ({0}) AS \"Book\" ON \"Book\" = \"Iid\"", this.GetBookDataSql(partition, instant));
            sqlBuilder.Append(" GROUP BY \"Book\") AS \"Book_Category\" USING (\"Iid\")");

            sqlBuilder.Append(" LEFT JOIN (SELECT \"Section\".\"Container\" AS \"Iid\", ARRAY[array_agg(\"Section\".\"Sequence\"::text), array_agg(\"Section\".\"Iid\"::text)] AS \"Section\"");
            sqlBuilder.AppendFormat(" FROM ({0}) AS \"Section\"", this.GetSectionDataSql(partition, instant));
            sqlBuilder.AppendFormat(" JOIN ({0}) AS \"Book\" ON \"Section\".\"Container\" = \"Book\".\"Iid\"", this.GetBookDataSql(partition, instant));
            sqlBuilder.Append(" GROUP BY \"Section\".\"Container\") AS \"Book_Section\" USING (\"Iid\")");
        ...
        {
            var sqlBuilder = new StringBuilder();
            sqlBuilder.Append(" LEFT JOIN (SELECT \"Book_Audit\".\"Actor\", \"Book_Audit\".\"Iid\"");
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"Book_Audit\" AS \"Book_Audit\"", partition);
            sqlBuilder.Append(" WHERE \"Book_Audit\".\"ValidTo\" = 'infinity'");
            sqlBuilder.Append(" GROUP BY \"Book_Audit\".\"Iid\", \"Book_Audit\".\"Actor\") AS \"Actor\" USING (\"Iid\")");
            return sqlBuilder.ToString();
        }
        ...
        public override string GetValueTypeSet() => "\"Thing\".\"ValueTypeDictionary\" || \"Book\".\"ValueTypeDictionary\"";
        ...
        /// </param>
        /// <returns>The DataSql string</returns>
        private string GetBook_CategoryDataSql(string partition, DateTime? instant)
        {
            var sqlBuilder = new StringBuilder();

            var fields = "\"Book\",\"Category\",\"ValidFrom\",\"ValidTo\"";
            sqlBuilder.AppendFormat(" SELECT {0}", fields);
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"Book_Category\"", partition);
            ...
            if (instant.HasValue && instant.Value != DateTime.MaxValue)
            {
                ...
                sqlBuilder.Append(" UNION ALL");
                sqlBuilder.AppendFormat(" SELECT {0}", fields);
                sqlBuilder.AppendFormat(" FROM \"{0}\".\"Book_Category_Audit\"", partition);
                sqlBuilder.Append(" WHERE \"Action\" <> 'I'");
                sqlBuilder.Append(" AND \"ValidFrom\" < :instant");
                sqlBuilder.Append(" AND \"ValidTo\" >= :instant");
            }

...
namespace CDP4Orm.Dao
{
    ...
    public partial class BookDao : ThingDao, IBookDao
    {
        ...
        /// </returns>
        public virtual IEnumerable<CDP4Common.DTO.Book> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false)
        {
        ...
        public override string BuildReadQuery(string partition)
        {
            ...
            sqlBuilder.AppendFormat(" JOIN \"{0}\".\"Book_Data\"() AS \"Book\" USING (\"Iid\")", partition);
            ...
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"Book_Category_Data\"() AS \"Book_Category\"", partition);
            sqlBuilder.AppendFormat(" JOIN \"{0}\".\"Book_Data\"() AS \"Book\" ON \"Book\" = \"Iid\"", partition);
            ...
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"Section_Data\"() AS \"Section\"", partition);
            sqlBuilder.AppendFormat(" JOIN \"{0}\".\"Book_Data\"() AS \"Book\" ON \"Section\".\"Container\" = \"Book\".\"Iid\"", partition);

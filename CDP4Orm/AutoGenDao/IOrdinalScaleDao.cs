...
namespace CDP4Orm.Dao
{
    ...
    public partial interface IOrdinalScaleDao : IDao
    {
        ...
        /// </returns>
        IEnumerable<CDP4Common.DTO.OrdinalScale> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false);

// --------------------------------------------------------------------------------------------------------------------
// <copyright file="SiteLogEntryDao.cs" company="RHEA System S.A.">
...
namespace CDP4Orm.Dao
{
    ...
    public partial class SiteLogEntryDao : ThingDao, ISiteLogEntryDao
    {
        ...
        /// </returns>
        public virtual IEnumerable<CDP4Common.DTO.SiteLogEntry> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false)
        {
            using (var command = new NpgsqlCommand())
            {
                ...
                {
                    sqlBuilder.AppendFormat("SELECT \"Jsonb\" FROM \"{0}\".\"SiteLogEntry_Cache\"", partition);
        ...
        public override string BuildReadQuery(string partition)
        {
            ...
            sqlBuilder.AppendFormat(" JOIN \"{0}\".\"SiteLogEntry_Data\"() AS \"SiteLogEntry\" USING (\"Iid\")", partition);
            ...
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"SiteLogEntry_Category_Data\"() AS \"SiteLogEntry_Category\"", partition);
            sqlBuilder.AppendFormat(" JOIN \"{0}\".\"SiteLogEntry_Data\"() AS \"SiteLogEntry\" ON \"SiteLogEntry\" = \"Iid\"", partition);
            ...
            sqlBuilder.AppendFormat(" JOIN \"{0}\".\"SiteLogEntry_Data\"() AS \"SiteLogEntry\" ON \"LogEntryChangelogItem\".\"Container\" = \"SiteLogEntry\".\"Iid\"", partition);
            ...
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"SiteLogEntry_AffectedDomainIid_Data\"() AS \"SiteLogEntry_AffectedDomainIid\"", partition);
            sqlBuilder.AppendFormat(" JOIN \"{0}\".\"SiteLogEntry_Data\"() AS \"SiteLogEntry\" ON \"SiteLogEntry\"= \"Iid\"", partition);
            ...
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"SiteLogEntry_AffectedItemIid_Data\"() AS \"SiteLogEntry_AffectedItemIid\"", partition);
            sqlBuilder.AppendFormat(" JOIN \"{0}\".\"SiteLogEntry_Data\"() AS \"SiteLogEntry\" ON \"SiteLogEntry\"= \"Iid\"", partition);

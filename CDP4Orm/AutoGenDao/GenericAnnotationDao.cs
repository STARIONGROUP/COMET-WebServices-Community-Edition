...
namespace CDP4Orm.Dao
{
    ...
    public abstract partial class GenericAnnotationDao : ThingDao
    {
        ...
        /// <summary>
        /// Build a SQL read query for the current <see cref="GenericAnnotationDao" />
        /// </summary>
        ...
        {
            var sqlBuilder = new StringBuilder();
            sqlBuilder.Append(" LEFT JOIN (SELECT \"GenericAnnotation_Audit\".\"Actor\", \"GenericAnnotation_Audit\".\"Iid\"");
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"GenericAnnotation_Audit\" AS \"GenericAnnotation_Audit\"", partition);
            sqlBuilder.Append(" WHERE \"GenericAnnotation_Audit\".\"ValidTo\" = 'infinity'");
            sqlBuilder.Append(" GROUP BY \"GenericAnnotation_Audit\".\"Iid\", \"GenericAnnotation_Audit\".\"Actor\") AS \"Actor\" USING (\"Iid\")");
            return sqlBuilder.ToString();
        }
        ...
        public override string GetValueTypeSet() => "\"Thing\".\"ValueTypeDictionary\" || \"GenericAnnotation\".\"ValueTypeDictionary\"";
    }
}

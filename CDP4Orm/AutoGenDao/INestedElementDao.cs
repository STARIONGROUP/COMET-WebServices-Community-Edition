...
namespace CDP4Orm.Dao
{
    ...
    public partial interface INestedElementDao : IDao
    {
        ...
        /// </returns>
        IEnumerable<CDP4Common.DTO.NestedElement> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false);

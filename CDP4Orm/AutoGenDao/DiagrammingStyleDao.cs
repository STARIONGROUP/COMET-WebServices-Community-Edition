...
namespace CDP4Orm.Dao
{
    ...
    public abstract partial class DiagrammingStyleDao : DiagramThingBaseDao
    {
        ...
        /// <summary>
        /// Build a SQL read query for the current <see cref="DiagrammingStyleDao" />
        /// </summary>
        ...
        {
            var sqlBuilder = new StringBuilder();
            sqlBuilder.Append(" LEFT JOIN (SELECT \"DiagrammingStyle_Audit\".\"Actor\", \"DiagrammingStyle_Audit\".\"Iid\"");
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"DiagrammingStyle_Audit\" AS \"DiagrammingStyle_Audit\"", partition);
            sqlBuilder.Append(" WHERE \"DiagrammingStyle_Audit\".\"ValidTo\" = 'infinity'");
            sqlBuilder.Append(" GROUP BY \"DiagrammingStyle_Audit\".\"Iid\", \"DiagrammingStyle_Audit\".\"Actor\") AS \"Actor\" USING (\"Iid\")");
            return sqlBuilder.ToString();
        }
        ...
        public override string GetValueTypeSet() => "\"Thing\".\"ValueTypeDictionary\" || \"DiagramThingBase\".\"ValueTypeDictionary\" || \"DiagrammingStyle\".\"ValueTypeDictionary\"";
    }
}

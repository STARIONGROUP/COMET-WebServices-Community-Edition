...
namespace CDP4Orm.Dao
{
    ...
    public abstract partial class ParameterBaseDao : ThingDao
    {
        ...
        /// <summary>
        /// Build a SQL read query for the current <see cref="ParameterBaseDao" />
        /// </summary>
        ...
        {
            var sqlBuilder = new StringBuilder();
            sqlBuilder.Append(" LEFT JOIN (SELECT \"ParameterBase_Audit\".\"Actor\", \"ParameterBase_Audit\".\"Iid\"");
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"ParameterBase_Audit\" AS \"ParameterBase_Audit\"", partition);
            sqlBuilder.Append(" WHERE \"ParameterBase_Audit\".\"ValidTo\" = 'infinity'");
            sqlBuilder.Append(" GROUP BY \"ParameterBase_Audit\".\"Iid\", \"ParameterBase_Audit\".\"Actor\") AS \"Actor\" USING (\"Iid\")");
            return sqlBuilder.ToString();
        }
        ...
        public override string GetValueTypeSet() => "\"Thing\".\"ValueTypeDictionary\" || \"ParameterBase\".\"ValueTypeDictionary\"";
    }
}

...
namespace CDP4Orm.Dao
{
    ...
    public partial class DomainOfExpertiseDao : DefinedThingDao, IDomainOfExpertiseDao
    {
        ...
        /// </returns>
        public virtual IEnumerable<CDP4Common.DTO.DomainOfExpertise> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false)
        {
        ...
        public override string BuildReadQuery(string partition)
        {
            ...
            sqlBuilder.AppendFormat(" JOIN \"{0}\".\"DomainOfExpertise_Data\"() AS \"DomainOfExpertise\" USING (\"Iid\")", partition);
            ...
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"DomainOfExpertise_Category_Data\"() AS \"DomainOfExpertise_Category\"", partition);
            sqlBuilder.AppendFormat(" JOIN \"{0}\".\"DomainOfExpertise_Data\"() AS \"DomainOfExpertise\" ON \"DomainOfExpertise\" = \"Iid\"", partition);

...
namespace CDP4Orm.Dao
{
    ...
    public partial class DomainOfExpertiseDao : DefinedThingDao, IDomainOfExpertiseDao
    {
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="CDP4Common.DTO.DomainOfExpertise"/>.
        /// </returns>
        public virtual IEnumerable<CDP4Common.DTO.DomainOfExpertise> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false, DateTime? instant = null)
        {
                ...
                if (isCachedDtoReadEnabledAndInstant)
                {
                    ...
                    using (var reader = command.ExecuteReader())
                    {
                        while (reader.Read())
                        {
                            ...
                            if (thing != null)
                            {
                                yield return thing as DomainOfExpertise;
                            }
                        }
                    }
                }
        ...
        /// </returns>
        public virtual bool Update(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.DomainOfExpertise domainOfExpertise, CDP4Common.DTO.Thing container = null)
        {
            bool isHandled;
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            var beforeUpdate = this.BeforeUpdate(transaction, partition, domainOfExpertise, container, out isHandled, valueTypeDictionaryAdditions);
            if (!isHandled)
            {
                beforeUpdate = beforeUpdate && base.Update(transaction, partition, domainOfExpertise, container);
            ...
            return this.AfterUpdate(beforeUpdate, transaction, partition, domainOfExpertise, container);
        }

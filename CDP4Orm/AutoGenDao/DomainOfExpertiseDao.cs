...
namespace CDP4Orm.Dao
{
    ...
    /// <summary>
    /// The DomainOfExpertise Data Access Object which acts as an ORM layer to the SQL database.
    /// </summary>
    public partial class DomainOfExpertiseDao : DefinedThingDao, IDomainOfExpertiseDao
    {
        /// <summary>
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having a list of instances of <see cref="CDP4Common.DTO.DomainOfExpertise"/> as result.
        /// </returns>
        public virtual async Task<IEnumerable<CDP4Common.DTO.DomainOfExpertise>> ReadAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false, DateTime? instant = null)
        {
                ...
                if (isCachedDtoReadEnabledAndInstant)
                {
                    ...
                    await using (var reader = await command.ExecuteReaderAsync())
                    {
                        while (await reader.ReadAsync())
                        {
                            ...
                            if (thing != null)
                            {
                                result.Add(thing as DomainOfExpertise);
                            }
                        }
                    }
                }
        ...
        /// </returns>
        public virtual async Task<bool> WriteAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.DomainOfExpertise domainOfExpertise, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            var beforeWriteResult = await this.BeforeWriteAsync(transaction, partition, domainOfExpertise, container, valueTypeDictionaryAdditions);
            ...
            if (!isHandled)
            {
                beforeWrite = beforeWrite && await base.WriteAsync(transaction, partition, domainOfExpertise, container);
                ...
                foreach (var item in domainOfExpertise.Category)
                {
                    await this.AddCategoryAsync(transaction, partition, domainOfExpertise.Iid, item);
                }
            }

            return await this.AfterWriteAsync(beforeWrite, transaction, partition, domainOfExpertise, container);
        }
        ...
        /// An awaitable <see cref="Task"/> having True if the concept was successfully persisted as result.
        /// </returns>
        public virtual async Task<bool> UpsertAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.DomainOfExpertise domainOfExpertise, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            await base.UpsertAsync(transaction, partition, domainOfExpertise, container);
            ...
            foreach (var item in domainOfExpertise.Category)
            {
                await this.UpsertCategoryAsync(transaction, partition, domainOfExpertise.Iid, item);
            }
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="CDP4Common.DTO.DomainOfExpertise"/> id that will be the source for each link table record.
        /// </param> 
        /// <param name="value">
        ...
        /// </param>
        /// <param name="domainOfExpertise">
        /// The DomainOfExpertise DTO that is to be updated.
        /// </param>
        /// <param name="container">
        ...
        /// </returns>
        public virtual async Task<bool> UpdateAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.DomainOfExpertise domainOfExpertise, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            var beforeUpdateResult = await this.BeforeUpdateAsync(transaction, partition, domainOfExpertise, container, valueTypeDictionaryAdditions);
            ...
            if (!isHandled)
            {
                beforeUpdate = beforeUpdate && await base.UpdateAsync(transaction, partition, domainOfExpertise, container);
            ...
            return await this.AfterUpdateAsync(beforeUpdate, transaction, partition, domainOfExpertise, container);
        }
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="CDP4Common.DTO.DomainOfExpertise"/> id that is to be deleted.
        /// </param>
        /// <returns>
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="CDP4Common.DTO.DomainOfExpertise"/> id that is the source of each link table record.
        /// </param> 
        /// <param name="value">
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="CDP4Common.DTO.DomainOfExpertise"/> id that is the source for each link table record.
        /// </param> 
        /// <param name="category">
        ...
        public async Task<bool> DeleteCategoryAsync(NpgsqlTransaction transaction, string partition, Guid iid, Guid category)
        {
            ...
            {
                var sqlBuilder = new System.Text.StringBuilder();
                sqlBuilder.AppendFormat("DELETE FROM \"{0}\".\"DomainOfExpertise_Category\"", partition);
                sqlBuilder.Append(" WHERE \"DomainOfExpertise\" = :domainOfExpertise");
        ...
        /// <summary>
        /// Build a SQL read query for the current <see cref="DomainOfExpertiseDao" />
        /// </summary>
        ...
        public override string BuildReadQuery(string partition, DateTime? instant)
        {
            ...
            sqlBuilder.Append(" \"DomainOfExpertise\".\"Container\",");
            ...
            sqlBuilder.Append(" COALESCE(\"DomainOfExpertise_Category\".\"Category\",'{}'::text[]) AS \"Category\",");
            ...
            sqlBuilder.AppendFormat(" JOIN ({0}) AS \"DomainOfExpertise\" USING (\"Iid\")", this.GetDomainOfExpertiseDataSql(partition, instant));
            ...
            sqlBuilder.Append(" LEFT JOIN (SELECT \"DomainOfExpertise\" AS \"Iid\", array_agg(\"Category\"::text) AS \"Category\"");
            sqlBuilder.AppendFormat(" FROM ({0}) AS \"DomainOfExpertise_Category\"", this.GetDomainOfExpertise_CategoryDataSql(partition, instant));
            sqlBuilder.AppendFormat(" JOIN ({0}) AS \"DomainOfExpertise\" ON \"DomainOfExpertise\" = \"Iid\"", this.GetDomainOfExpertiseDataSql(partition, instant));
            sqlBuilder.Append(" GROUP BY \"DomainOfExpertise\") AS \"DomainOfExpertise_Category\" USING (\"Iid\")");
        ...
        {
            var sqlBuilder = new StringBuilder();
            sqlBuilder.Append(" LEFT JOIN (SELECT \"DomainOfExpertise_Audit\".\"Actor\", \"DomainOfExpertise_Audit\".\"Iid\"");
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"DomainOfExpertise_Audit\" AS \"DomainOfExpertise_Audit\"", partition);
            sqlBuilder.Append(" WHERE \"DomainOfExpertise_Audit\".\"ValidTo\" = 'infinity'");
            sqlBuilder.Append(" GROUP BY \"DomainOfExpertise_Audit\".\"Iid\", \"DomainOfExpertise_Audit\".\"Actor\") AS \"Actor\" USING (\"Iid\")");
            return sqlBuilder.ToString();
        }
        ...
        public override string GetValueTypeSet() => "\"Thing\".\"ValueTypeDictionary\" || \"DefinedThing\".\"ValueTypeDictionary\" || \"DomainOfExpertise\".\"ValueTypeDictionary\"";
        ...
        /// </param>
        /// <returns>The DataSql string</returns>
        private string GetDomainOfExpertise_CategoryDataSql(string partition, DateTime? instant)
        {
            var sqlBuilder = new StringBuilder();

            var fields = "\"DomainOfExpertise\",\"Category\",\"ValidFrom\",\"ValidTo\"";
            sqlBuilder.AppendFormat(" SELECT {0}", fields);
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"DomainOfExpertise_Category\"", partition);
            ...
            if (instant.HasValue && instant.Value != DateTime.MaxValue)
            {
                ...
                sqlBuilder.Append(" UNION ALL");
                sqlBuilder.AppendFormat(" SELECT {0}", fields);
                sqlBuilder.AppendFormat(" FROM \"{0}\".\"DomainOfExpertise_Category_Audit\"", partition);
                sqlBuilder.Append(" WHERE \"Action\" <> 'I'");
                sqlBuilder.Append(" AND \"ValidFrom\" < :instant");
                sqlBuilder.Append(" AND \"ValidTo\" >= :instant");
            }

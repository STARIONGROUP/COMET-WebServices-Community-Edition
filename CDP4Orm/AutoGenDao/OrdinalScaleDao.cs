...
namespace CDP4Orm.Dao
{
    ...
    public partial class OrdinalScaleDao : MeasurementScaleDao, IOrdinalScaleDao
    {
        ...
        /// </returns>
        public virtual IEnumerable<CDP4Common.DTO.OrdinalScale> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false, DateTime? instant = null)
        {
        ...
        /// True if the concept was successfully persisted.
        /// </returns>
        public virtual bool Upsert(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.OrdinalScale ordinalScale, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            base.Upsert(transaction, partition, ordinalScale, container);

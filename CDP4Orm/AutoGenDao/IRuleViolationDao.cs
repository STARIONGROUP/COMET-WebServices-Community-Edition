...
namespace CDP4Orm.Dao
{
    ...
    public partial interface IRuleViolationDao : IDao
    {
        ...
        /// </returns>
        IEnumerable<CDP4Common.DTO.RuleViolation> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false, DateTime? instant = null);
        ...
        /// </returns>
        bool Update(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.RuleViolation ruleViolation, CDP4Common.DTO.Thing container = null);

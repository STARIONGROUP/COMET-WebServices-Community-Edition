...
namespace CDP4Orm.Dao
{
    ...
    public partial interface IRuleViolationDao : IDao
    {
        ...
        /// </returns>
        IEnumerable<CDP4Common.DTO.RuleViolation> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false);

...
namespace CDP4Orm.Dao
{
    ...
    public partial class ValueGroupDao : DefinedThingDao, IValueGroupDao
    {
        ...
        /// </returns>
        public virtual IEnumerable<CDP4Common.DTO.ValueGroup> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false, DateTime? instant = null)
        {
                ...
                if (isCachedDtoReadEnabledAndInstant)
                {
                    ...
                    using (var reader = command.ExecuteReader())
                    {
                        while (reader.Read())
                        {
                            ...
                            if (thing != null)
                            {
                                yield return thing as ValueGroup;
                            }
                        }
                    }
                }
        ...
        /// </returns>
        public virtual bool Write(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.ValueGroup valueGroup, CDP4Common.DTO.Thing container = null)
        {
            bool isHandled;
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            var beforeWrite = this.BeforeWrite(transaction, partition, valueGroup, container, out isHandled, valueTypeDictionaryAdditions);
            if (!isHandled)
            {
                beforeWrite = beforeWrite && base.Write(transaction, partition, valueGroup, container);
                ...
                valueGroup.Category.ForEach(x => this.AddCategory(transaction, partition, valueGroup.Iid, x));
            }

            return this.AfterWrite(beforeWrite, transaction, partition, valueGroup, container);
        }
        ...
        /// True if the concept was successfully persisted.
        /// </returns>
        public virtual bool Upsert(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.ValueGroup valueGroup, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            base.Upsert(transaction, partition, valueGroup, container);
            ...
            valueGroup.Category.ForEach(x => this.UpsertCategory(transaction, partition, valueGroup.Iid, x));
        ...
        /// </returns>
        public virtual bool Update(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.ValueGroup valueGroup, CDP4Common.DTO.Thing container = null)
        {
            bool isHandled;
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            var beforeUpdate = this.BeforeUpdate(transaction, partition, valueGroup, container, out isHandled, valueTypeDictionaryAdditions);
            if (!isHandled)
            {
                beforeUpdate = beforeUpdate && base.Update(transaction, partition, valueGroup, container);
            ...
            return this.AfterUpdate(beforeUpdate, transaction, partition, valueGroup, container);
        }

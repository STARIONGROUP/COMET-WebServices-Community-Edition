// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ValueGroupDao.cs" company="Starion Group S.A.">
...
namespace CDP4Orm.Dao
{
    ...
    /// <summary>
    /// The ValueGroup Data Access Object which acts as an ORM layer to the SQL database.
    /// </summary>
    [ExcludeFromCodeCoverage]
    public partial class ValueGroupDao : DefinedThingDao, IValueGroupDao
    {
        /// <summary>
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having a list of instances of <see cref="CDP4Common.DTO.ValueGroup"/> as result.
        /// </returns>
        public virtual async Task<IEnumerable<CDP4Common.DTO.ValueGroup>> ReadAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false, DateTime? instant = null)
        {
            var result = new List<ValueGroup>();
            ...
            await using (var command = new NpgsqlCommand())
            {
                ...
                {
                    sqlBuilder.AppendFormat("SELECT \"Jsonb\", \"Actor\" FROM \"{0}\".\"ValueGroup_Cache\"", partition);
                    ...
                    await using (var reader = await command.ExecuteReaderAsync())
                    {
                        while (await reader.ReadAsync())
                        {
                            ...
                            if (thing != null)
                            {
                                result.Add(thing as ValueGroup);
                            }
                        }
                    }
                }
        ...
        /// </param>
        /// <returns>
        /// A deserialized instance of <see cref="CDP4Common.DTO.ValueGroup"/>.
        /// </returns>
        public virtual CDP4Common.DTO.ValueGroup MapToDto(NpgsqlDataReader reader)
        {
            ...
            var dto = new CDP4Common.DTO.ValueGroup(iid, revisionNumber);
        ...
        /// The valueGroup DTO that is to be persisted.
        /// </param>
        ...
        /// </returns>
        public virtual async Task<bool> WriteAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.ValueGroup valueGroup, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            var beforeWriteResult = await this.BeforeWriteAsync(transaction, partition, valueGroup, container, valueTypeDictionaryAdditions);
            ...
            if (!isHandled)
            {
                beforeWrite = beforeWrite && await base.WriteAsync(transaction, partition, valueGroup, container);

                await using (var command = new NpgsqlCommand())
                {
                    var sqlBuilder = new System.Text.StringBuilder();

                    sqlBuilder.AppendFormat("INSERT INTO \"{0}\".\"ValueGroup\"", partition);
                ...
                foreach (var item in valueGroup.Category)
                {
                    await this.AddCategoryAsync(transaction, partition, valueGroup.Iid, item);
                }
            }

            return await this.AfterWriteAsync(beforeWrite, transaction, partition, valueGroup, container);
        }
        ...
        /// An awaitable <see cref="Task"/> having True if the concept was successfully persisted as result.
        /// </returns>
        public virtual async Task<bool> UpsertAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.ValueGroup valueGroup, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            await base.UpsertAsync(transaction, partition, valueGroup, container);
            ...
            foreach (var item in valueGroup.Category)
            {
                await this.UpsertCategoryAsync(transaction, partition, valueGroup.Iid, item);
            }
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="CDP4Common.DTO.ValueGroup"/> id that will be the source for each link table record.
        /// </param> 
        /// <param name="value">
        ...
        public async Task<bool> AddCategoryAsync(NpgsqlTransaction transaction, string partition, Guid iid, Guid category)
        {
            ...
            {
                var sqlBuilder = new System.Text.StringBuilder();
                sqlBuilder.AppendFormat("INSERT INTO \"{0}\".\"ValueGroup_Category\"", partition);
                sqlBuilder.AppendFormat(" (\"ValueGroup\", \"Category\")");
                sqlBuilder.Append(" VALUES (:valueGroup, :category);");

                command.Parameters.Add("valueGroup", NpgsqlDbType.Uuid).Value = iid;
        ...
        public async Task<bool> UpsertCategoryAsync(NpgsqlTransaction transaction, string partition, Guid iid, Guid category)
        {
            await using (var command = new NpgsqlCommand())
            {
                ...
                sqlBuilder.AppendFormat(" (\"ValueGroup\", \"Category\")");
                sqlBuilder.Append(" VALUES (:valueGroup, :category)");
                sqlBuilder.Append(" ON CONFLICT ON CONSTRAINT \"ValueGroup_Category_PK\"");
                sqlBuilder.Append(" DO UPDATE ");
                sqlBuilder.Append(" SET (\"ValueGroup\", \"Category\")");
                sqlBuilder.Append(" = (:valueGroup, :category);");
        ...
        /// </param>
        /// <param name="valueGroup">
        /// The ValueGroup DTO that is to be updated.
        /// </param>
        /// <param name="container">
        ...
        /// </returns>
        public virtual async Task<bool> UpdateAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.ValueGroup valueGroup, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            var beforeUpdateResult = await this.BeforeUpdateAsync(transaction, partition, valueGroup, container, valueTypeDictionaryAdditions);
            ...
            if (!isHandled)
            {
                beforeUpdate = beforeUpdate && await base.UpdateAsync(transaction, partition, valueGroup, container);
            ...
            return await this.AfterUpdateAsync(beforeUpdate, transaction, partition, valueGroup, container);
        }
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="CDP4Common.DTO.ValueGroup"/> id that is to be deleted.
        /// </param>
        /// <returns>
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="CDP4Common.DTO.ValueGroup"/> id that is the source of each link table record.
        /// </param> 
        /// <param name="value">
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="CDP4Common.DTO.ValueGroup"/> id that is the source for each link table record.
        /// </param> 
        /// <param name="category">
        ...
        public async Task<bool> DeleteCategoryAsync(NpgsqlTransaction transaction, string partition, Guid iid, Guid category)
        {
            ...
            {
                var sqlBuilder = new System.Text.StringBuilder();
                sqlBuilder.AppendFormat("DELETE FROM \"{0}\".\"ValueGroup_Category\"", partition);
                sqlBuilder.Append(" WHERE \"ValueGroup\" = :valueGroup");
        ...
        /// <summary>
        /// Build a SQL read query for the current <see cref="ValueGroupDao" />
        /// </summary>
        ...
        public override string BuildReadQuery(string partition, DateTime? instant)
        {
            ...
            sqlBuilder.Append(" \"ValueGroup\".\"Container\",");
            ...
            sqlBuilder.Append(" COALESCE(\"ValueGroup_Category\".\"Category\",'{}'::text[]) AS \"Category\",");
            ...
            sqlBuilder.AppendFormat(" JOIN ({0}) AS \"ValueGroup\" USING (\"Iid\")", this.GetValueGroupDataSql(partition, instant));
            ...
            sqlBuilder.Append(" LEFT JOIN (SELECT \"ValueGroup\" AS \"Iid\", array_agg(\"Category\"::text) AS \"Category\"");
            sqlBuilder.AppendFormat(" FROM ({0}) AS \"ValueGroup_Category\"", this.GetValueGroup_CategoryDataSql(partition, instant));
            sqlBuilder.AppendFormat(" JOIN ({0}) AS \"ValueGroup\" ON \"ValueGroup\" = \"Iid\"", this.GetValueGroupDataSql(partition, instant));
            sqlBuilder.Append(" GROUP BY \"ValueGroup\") AS \"ValueGroup_Category\" USING (\"Iid\")");
        ...
        {
            var sqlBuilder = new StringBuilder();
            sqlBuilder.Append(" LEFT JOIN (SELECT \"ValueGroup_Audit\".\"Actor\", \"ValueGroup_Audit\".\"Iid\"");
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"ValueGroup_Audit\" AS \"ValueGroup_Audit\"", partition);
            sqlBuilder.Append(" WHERE \"ValueGroup_Audit\".\"ValidTo\" = 'infinity'");
            sqlBuilder.Append(" GROUP BY \"ValueGroup_Audit\".\"Iid\", \"ValueGroup_Audit\".\"Actor\") AS \"Actor\" USING (\"Iid\")");
            return sqlBuilder.ToString();
        }
        ...
        public override string GetValueTypeSet() => "\"Thing\".\"ValueTypeDictionary\" || \"DefinedThing\".\"ValueTypeDictionary\" || \"ValueGroup\".\"ValueTypeDictionary\"";
        ...
        /// </param>
        /// <returns>The DataSql string</returns>
        private string GetValueGroup_CategoryDataSql(string partition, DateTime? instant)
        {
            var sqlBuilder = new StringBuilder();

            var fields = "\"ValueGroup\",\"Category\",\"ValidFrom\",\"ValidTo\"";
            sqlBuilder.AppendFormat(" SELECT {0}", fields);
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"ValueGroup_Category\"", partition);
            ...
            if (instant.HasValue && instant.Value != DateTime.MaxValue)
            {
                ...
                sqlBuilder.Append(" UNION ALL");
                sqlBuilder.AppendFormat(" SELECT {0}", fields);
                sqlBuilder.AppendFormat(" FROM \"{0}\".\"ValueGroup_Category_Audit\"", partition);
                sqlBuilder.Append(" WHERE \"Action\" <> 'I'");
                sqlBuilder.Append(" AND \"ValidFrom\" < :instant");
                sqlBuilder.Append(" AND \"ValidTo\" >= :instant");
            }

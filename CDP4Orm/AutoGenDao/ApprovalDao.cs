    ...
    public partial class ApprovalDao : GenericAnnotationDao, IApprovalDao
    {
        ...
        public virtual IEnumerable<CDP4Common.DTO.Approval> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false)
        {
            using (var command = new NpgsqlCommand())
            {
                ...
                {
                    sqlBuilder.AppendFormat("SELECT * FROM \"{0}\".\"Approval_View\"", partition);
        ...
        public virtual bool Update(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.Approval approval, CDP4Common.DTO.Thing container = null)
        {
            ...
            if (!isHandled)
            {
                ...
                using (var command = new NpgsqlCommand())
                {
                    ...
                    sqlBuilder.AppendFormat(" SET (\"Container\", \"Author\", \"Owner\", \"ValueTypeDictionary\")");
                    sqlBuilder.AppendFormat(" = (:container, :author, :owner, \"ValueTypeDictionary\" || :valueTypeDictionary)");

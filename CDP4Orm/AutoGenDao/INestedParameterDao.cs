...
namespace CDP4Orm.Dao
{
    ...
    public partial interface INestedParameterDao : IDao
    {
        ...
        /// </returns>
        IEnumerable<CDP4Common.DTO.NestedParameter> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false);

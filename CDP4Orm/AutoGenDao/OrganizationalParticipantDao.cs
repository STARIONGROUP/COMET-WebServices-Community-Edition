// --------------------------------------------------------------------------------------------------------------------
// <copyright file="OrganizationalParticipantDao.cs" company="Starion Group S.A.">
...
namespace CDP4Orm.Dao
{
    ...
    /// <summary>
    /// The OrganizationalParticipant Data Access Object which acts as an ORM layer to the SQL database.
    /// </summary>
    public partial class OrganizationalParticipantDao : ThingDao, IOrganizationalParticipantDao
    {
        /// <summary>
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having a list of instances of <see cref="CDP4Common.DTO.OrganizationalParticipant"/> as result.
        /// </returns>
        public virtual async Task<IEnumerable<CDP4Common.DTO.OrganizationalParticipant>> ReadAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false, DateTime? instant = null)
        {
            var result = new List<OrganizationalParticipant>();
            ...
            await using (var command = new NpgsqlCommand())
            {
                ...
                {
                    sqlBuilder.AppendFormat("SELECT \"Jsonb\", \"Actor\" FROM \"{0}\".\"OrganizationalParticipant_Cache\"", partition);
                    ...
                    await using (var reader = await command.ExecuteReaderAsync())
                    {
                        while (await reader.ReadAsync())
                        {
                            ...
                            if (thing != null)
                            {
                                result.Add(thing as OrganizationalParticipant);
                            }
                        }
                    }
                }
        ...
        /// </param>
        /// <returns>
        /// A deserialized instance of <see cref="CDP4Common.DTO.OrganizationalParticipant"/>.
        /// </returns>
        public virtual CDP4Common.DTO.OrganizationalParticipant MapToDto(NpgsqlDataReader reader)
        {
            ...
            var dto = new CDP4Common.DTO.OrganizationalParticipant(iid, revisionNumber);
            dto.Actor = reader["Actor"] is DBNull ? (Guid?)null : Guid.Parse(reader["Actor"].ToString());
            dto.ExcludedDomain.AddRange(Array.ConvertAll((string[])reader["ExcludedDomain"], Guid.Parse));
            dto.ExcludedPerson.AddRange(Array.ConvertAll((string[])reader["ExcludedPerson"], Guid.Parse));
            dto.Organization = Guid.Parse(reader["Organization"].ToString());
        ...
        /// The organizationalParticipant DTO that is to be persisted.
        /// </param>
        ...
        /// </returns>
        public virtual async Task<bool> WriteAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.OrganizationalParticipant organizationalParticipant, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            var beforeWriteResult = await this.BeforeWriteAsync(transaction, partition, organizationalParticipant, container, valueTypeDictionaryAdditions);
            ...
            if (!isHandled)
            {
                beforeWrite = beforeWrite && await base.WriteAsync(transaction, partition, organizationalParticipant, container);

                await using (var command = new NpgsqlCommand())
                {
                    var sqlBuilder = new System.Text.StringBuilder();

                    sqlBuilder.AppendFormat("INSERT INTO \"{0}\".\"OrganizationalParticipant\"", partition);
                    sqlBuilder.AppendFormat(" (\"Iid\", \"Container\", \"Organization\")");
                    sqlBuilder.AppendFormat(" VALUES (:iid, :container, :organization);");
            ...
            return await this.AfterWriteAsync(beforeWrite, transaction, partition, organizationalParticipant, container);
        }
        ...
        /// An awaitable <see cref="Task"/> having True if the concept was successfully persisted as result.
        /// </returns>
        public virtual async Task<bool> UpsertAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.OrganizationalParticipant organizationalParticipant, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            await base.UpsertAsync(transaction, partition, organizationalParticipant, container);
        ...
        /// </returns>
        public virtual async Task<bool> UpdateAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.OrganizationalParticipant organizationalParticipant, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            var beforeUpdateResult = await this.BeforeUpdateAsync(transaction, partition, organizationalParticipant, container, valueTypeDictionaryAdditions);
            ...
            if (!isHandled)
            {
                beforeUpdate = beforeUpdate && await base.UpdateAsync(transaction, partition, organizationalParticipant, container);
            ...
            return await this.AfterUpdateAsync(beforeUpdate, transaction, partition, organizationalParticipant, container);
        }
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="CDP4Common.DTO.OrganizationalParticipant"/> id that is to be deleted.
        /// </param>
        /// <returns>
        ...
        /// <summary>
        /// Build a SQL read query for the current <see cref="OrganizationalParticipantDao" />
        /// </summary>
        ...
        public override string BuildReadQuery(string partition, DateTime? instant)
        {
            ...
            sqlBuilder.Append(" \"OrganizationalParticipant\".\"Container\",");

            sqlBuilder.Append(" NULL::bigint AS \"Sequence\",");

            sqlBuilder.Append(" \"Actor\",");

            sqlBuilder.Append(" \"OrganizationalParticipant\".\"Organization\",");
            sqlBuilder.Append(" COALESCE(\"Thing_ExcludedDomain\".\"ExcludedDomain\",'{}'::text[]) AS \"ExcludedDomain\",");
            sqlBuilder.Append(" COALESCE(\"Thing_ExcludedPerson\".\"ExcludedPerson\",'{}'::text[]) AS \"ExcludedPerson\",");

            sqlBuilder.Remove(sqlBuilder.Length - 1, 1);
            sqlBuilder.AppendFormat(" FROM ({0}) AS \"Thing\"", this.GetThingDataSql(partition, instant));
            sqlBuilder.AppendFormat(" JOIN ({0}) AS \"OrganizationalParticipant\" USING (\"Iid\")", this.GetOrganizationalParticipantDataSql(partition, instant));
        ...
        {
            var sqlBuilder = new StringBuilder();
            sqlBuilder.Append(" LEFT JOIN (SELECT \"OrganizationalParticipant_Audit\".\"Actor\", \"OrganizationalParticipant_Audit\".\"Iid\"");
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"OrganizationalParticipant_Audit\" AS \"OrganizationalParticipant_Audit\"", partition);
            sqlBuilder.Append(" WHERE \"OrganizationalParticipant_Audit\".\"ValidTo\" = 'infinity'");
            sqlBuilder.Append(" GROUP BY \"OrganizationalParticipant_Audit\".\"Iid\", \"OrganizationalParticipant_Audit\".\"Actor\") AS \"Actor\" USING (\"Iid\")");
            return sqlBuilder.ToString();
        }
        ...
        public override string GetValueTypeSet() => "\"Thing\".\"ValueTypeDictionary\" || \"OrganizationalParticipant\".\"ValueTypeDictionary\"";

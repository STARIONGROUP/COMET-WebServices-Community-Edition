...
namespace CDP4Orm.Dao
{
    ...
    public partial interface IRelationshipParameterValueDao : IDao
    {
        ...
        /// </returns>
        IEnumerable<CDP4Common.DTO.RelationshipParameterValue> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false);

...
namespace CDP4Orm.Dao
{
    ...
    public partial interface IRelationshipParameterValueDao : IDao
    {
        ...
        /// </returns>
        IEnumerable<CDP4Common.DTO.RelationshipParameterValue> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false, DateTime? instant = null);
        ...
        /// </returns>
        bool Update(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.RelationshipParameterValue relationshipParameterValue, CDP4Common.DTO.Thing container = null);

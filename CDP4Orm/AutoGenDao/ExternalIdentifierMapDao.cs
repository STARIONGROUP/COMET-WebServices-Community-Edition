...
namespace CDP4Orm.Dao
{
    ...
    public partial class ExternalIdentifierMapDao : ThingDao, IExternalIdentifierMapDao
    {
        ...
        public override string BuildReadQuery(string partition)
        {
            ...
            sqlBuilder.AppendFormat(" JOIN \"{0}\".\"ExternalIdentifierMap_Data\"() AS \"ExternalIdentifierMap\" USING (\"Iid\")", partition);
            ...
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"IdCorrespondence_Data\"() AS \"IdCorrespondence\"", partition);
            sqlBuilder.AppendFormat(" JOIN \"{0}\".\"ExternalIdentifierMap_Data\"() AS \"ExternalIdentifierMap\" ON \"IdCorrespondence\".\"Container\" = \"ExternalIdentifierMap\".\"Iid\"", partition);

...
namespace CDP4Orm.Dao
{
    ...
    public partial class DateParameterTypeDao : ScalarParameterTypeDao, IDateParameterTypeDao
    {
        ...
        /// </returns>
        public virtual IEnumerable<CDP4Common.DTO.DateParameterType> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false)
        {
        ...
        public override string BuildReadQuery(string partition)
        {
            ...
            sqlBuilder.AppendFormat(" JOIN \"{0}\".\"DateParameterType_Data\"() AS \"DateParameterType\" USING (\"Iid\")", partition);

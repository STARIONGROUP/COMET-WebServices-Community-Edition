...
namespace CDP4Orm.Dao
{
    ...
    public partial interface ISiteDirectoryThingReferenceDao : IDao
    {
        ...
        /// </returns>
        IEnumerable<CDP4Common.DTO.SiteDirectoryThingReference> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false, DateTime? instant = null);
        ...
        /// </returns>
        bool Update(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.SiteDirectoryThingReference siteDirectoryThingReference, CDP4Common.DTO.Thing container = null);

...
namespace CDP4Orm.Dao
{
    ...
    public partial interface ISiteDirectoryThingReferenceDao : IDao
    {
        ...
        /// </returns>
        IEnumerable<CDP4Common.DTO.SiteDirectoryThingReference> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false);

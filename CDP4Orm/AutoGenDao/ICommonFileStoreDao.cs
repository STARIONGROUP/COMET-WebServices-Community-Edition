...
namespace CDP4Orm.Dao
{
    ...
    public partial interface ICommonFileStoreDao : IDao
    {
        ...
        /// </returns>
        IEnumerable<CDP4Common.DTO.CommonFileStore> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false);

...
namespace CDP4Orm.Dao
{
    ...
    public partial class BehaviorDao : DefinedThingDao, IBehaviorDao
    {
        ...
        /// </returns>
        public virtual IEnumerable<CDP4Common.DTO.Behavior> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false, DateTime? instant = null)
        {
            using (var command = new NpgsqlCommand())
            {
                ...
                {
                    sqlBuilder.AppendFormat("SELECT \"Jsonb\", \"Actor\" FROM \"{0}\".\"Behavior_Cache\"", partition);
        ...
        /// <summary>
        /// Build a SQL read query for the current <see cref="BehaviorDao" />
        /// </summary>
        ...
        public override string BuildReadQuery(string partition, DateTime? instant)
        {
            ...
            sqlBuilder.Append(" \"Behavior\".\"Container\",");
            ...
            sqlBuilder.Append(" COALESCE(\"Behavior_BehavioralParameter\".\"BehavioralParameter\",'{}'::text[]) AS \"BehavioralParameter\",");
            ...
            sqlBuilder.AppendFormat(" JOIN ({0}) AS \"Behavior\" USING (\"Iid\")", this.GetBehaviorDataSql(partition, instant));
            ...
            sqlBuilder.Append(" LEFT JOIN (SELECT \"BehavioralParameter\".\"Container\" AS \"Iid\", array_agg(\"BehavioralParameter\".\"Iid\"::text) AS \"BehavioralParameter\"");
            sqlBuilder.AppendFormat(" FROM ({0}) AS \"BehavioralParameter\"", this.GetBehavioralParameterDataSql(partition, instant));
            sqlBuilder.AppendFormat(" JOIN ({0}) AS \"Behavior\" ON \"BehavioralParameter\".\"Container\" = \"Behavior\".\"Iid\"", this.GetBehaviorDataSql(partition, instant));
            sqlBuilder.Append(" GROUP BY \"BehavioralParameter\".\"Container\") AS \"Behavior_BehavioralParameter\" USING (\"Iid\")");
        ...
        {
            var sqlBuilder = new StringBuilder();
            sqlBuilder.Append(" LEFT JOIN (SELECT \"Behavior_Audit\".\"Actor\", \"Behavior_Audit\".\"Iid\"");
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"Behavior_Audit\" AS \"Behavior_Audit\"", partition);
            sqlBuilder.Append(" WHERE \"Behavior_Audit\".\"ValidTo\" = 'infinity'");
            sqlBuilder.Append(" GROUP BY \"Behavior_Audit\".\"Iid\", \"Behavior_Audit\".\"Actor\") AS \"Actor\" USING (\"Iid\")");
            return sqlBuilder.ToString();
        }
        ...
        public override string GetValueTypeSet() => "\"Thing\".\"ValueTypeDictionary\" || \"DefinedThing\".\"ValueTypeDictionary\" || \"Behavior\".\"ValueTypeDictionary\"";

...
namespace CDP4Orm.Dao
{
    ...
    public partial class ReviewItemDiscrepancyDao : ModellingAnnotationItemDao, IReviewItemDiscrepancyDao
    {
        ...
        /// </returns>
        public virtual IEnumerable<CDP4Common.DTO.ReviewItemDiscrepancy> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false, DateTime? instant = null)
        {

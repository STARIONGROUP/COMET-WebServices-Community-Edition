...
namespace CDP4Orm.Dao
{
    ...
    public partial interface IFileDao : IDao
    {
        ...
        /// </returns>
        IEnumerable<CDP4Common.DTO.File> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false);

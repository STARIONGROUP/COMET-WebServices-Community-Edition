// --------------------------------------------------------------------------------------------------------------------
// <copyright file="StakeHolderValueMapSettingsDao.cs" company="Starion Group S.A.">
...
namespace CDP4Orm.Dao
{
    ...
    public partial class StakeHolderValueMapSettingsDao : ThingDao, IStakeHolderValueMapSettingsDao
    {
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having a list of instances of <see cref="CDP4Common.DTO.StakeHolderValueMapSettings"/> as result.
        /// </returns>
        public virtual async Task<IEnumerable<CDP4Common.DTO.StakeHolderValueMapSettings>> ReadAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false, DateTime? instant = null)
        {
            var result = new List<StakeHolderValueMapSettings>();
            ...
            await using (var command = new NpgsqlCommand())
            {
                ...
                {
                    sqlBuilder.AppendFormat("SELECT \"Jsonb\", \"Actor\" FROM \"{0}\".\"StakeHolderValueMapSettings_Cache\"", partition);
                    ...
                    await using (var reader = await command.ExecuteReaderAsync())
                    {
                        while (await reader.ReadAsync())
                        {
                            ...
                            if (thing != null)
                            {
                                result.Add(thing as StakeHolderValueMapSettings);
                            }
                        }
                    }
                }
        ...
        /// </returns>
        public virtual async Task<bool> WriteAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.StakeHolderValueMapSettings stakeHolderValueMapSettings, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            var beforeWriteResult = await this.BeforeWriteAsync(transaction, partition, stakeHolderValueMapSettings, container, valueTypeDictionaryAdditions);
            ...
            if (!isHandled)
            {
                beforeWrite = beforeWrite && await base.WriteAsync(transaction, partition, stakeHolderValueMapSettings, container);
            ...
            return await this.AfterWriteAsync(beforeWrite, transaction, partition, stakeHolderValueMapSettings, container);
        }
        ...
        /// An awaitable <see cref="Task"/> having True if the concept was successfully persisted as result.
        /// </returns>
        public virtual async Task<bool> UpsertAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.StakeHolderValueMapSettings stakeHolderValueMapSettings, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            await base.UpsertAsync(transaction, partition, stakeHolderValueMapSettings, container);
        ...
        /// </returns>
        public virtual async Task<bool> UpdateAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.StakeHolderValueMapSettings stakeHolderValueMapSettings, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            var beforeUpdateResult = await this.BeforeUpdateAsync(transaction, partition, stakeHolderValueMapSettings, container, valueTypeDictionaryAdditions);
            ...
            if (!isHandled)
            {
                beforeUpdate = beforeUpdate && await base.UpdateAsync(transaction, partition, stakeHolderValueMapSettings, container);
            ...
            return await this.AfterUpdateAsync(beforeUpdate, transaction, partition, stakeHolderValueMapSettings, container);
        }
        ...
        /// <summary>
        /// Build a SQL read query for the current <see cref="StakeHolderValueMapSettingsDao" />
        /// </summary>
        ...
        public override string BuildReadQuery(string partition, DateTime? instant)
        {
            ...
            sqlBuilder.Append(" \"StakeHolderValueMapSettings\".\"Container\",");

            sqlBuilder.Append(" NULL::bigint AS \"Sequence\",");

            sqlBuilder.Append(" \"Actor\",");

            sqlBuilder.Append(" \"StakeHolderValueMapSettings\".\"GoalToValueGroupRelationship\",");

            sqlBuilder.Append(" \"StakeHolderValueMapSettings\".\"StakeholderValueToRequirementRelationship\",");

            sqlBuilder.Append(" \"StakeHolderValueMapSettings\".\"ValueGroupToStakeholderValueRelationship\",");
            sqlBuilder.Append(" COALESCE(\"Thing_ExcludedDomain\".\"ExcludedDomain\",'{}'::text[]) AS \"ExcludedDomain\",");
            sqlBuilder.Append(" COALESCE(\"Thing_ExcludedPerson\".\"ExcludedPerson\",'{}'::text[]) AS \"ExcludedPerson\",");

            sqlBuilder.Remove(sqlBuilder.Length - 1, 1);
            sqlBuilder.AppendFormat(" FROM ({0}) AS \"Thing\"", this.GetThingDataSql(partition, instant));
            sqlBuilder.AppendFormat(" JOIN ({0}) AS \"StakeHolderValueMapSettings\" USING (\"Iid\")", this.GetStakeHolderValueMapSettingsDataSql(partition, instant));
        ...
        {
            var sqlBuilder = new StringBuilder();
            sqlBuilder.Append(" LEFT JOIN (SELECT \"StakeHolderValueMapSettings_Audit\".\"Actor\", \"StakeHolderValueMapSettings_Audit\".\"Iid\"");
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"StakeHolderValueMapSettings_Audit\" AS \"StakeHolderValueMapSettings_Audit\"", partition);
            sqlBuilder.Append(" WHERE \"StakeHolderValueMapSettings_Audit\".\"ValidTo\" = 'infinity'");
            sqlBuilder.Append(" GROUP BY \"StakeHolderValueMapSettings_Audit\".\"Iid\", \"StakeHolderValueMapSettings_Audit\".\"Actor\") AS \"Actor\" USING (\"Iid\")");
            return sqlBuilder.ToString();
        }
        ...
        public override string GetValueTypeSet() => "\"Thing\".\"ValueTypeDictionary\" || \"StakeHolderValueMapSettings\".\"ValueTypeDictionary\"";

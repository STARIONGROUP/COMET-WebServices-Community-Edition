...
namespace CDP4Orm.Dao
{
    ...
    public partial class StakeHolderValueMapSettingsDao : ThingDao, IStakeHolderValueMapSettingsDao
    {
        ...
        /// </returns>
        public virtual IEnumerable<CDP4Common.DTO.StakeHolderValueMapSettings> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false, DateTime? instant = null)
        {
        ...
        /// True if the concept was successfully persisted.
        /// </returns>
        public virtual bool Upsert(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.StakeHolderValueMapSettings stakeHolderValueMapSettings, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            base.Upsert(transaction, partition, stakeHolderValueMapSettings, container);

...
namespace CDP4Orm.Dao
{
    ...
    public partial interface IEnumerationParameterTypeDao : IDao
    {
        ...
        /// </returns>
        IEnumerable<CDP4Common.DTO.EnumerationParameterType> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false);

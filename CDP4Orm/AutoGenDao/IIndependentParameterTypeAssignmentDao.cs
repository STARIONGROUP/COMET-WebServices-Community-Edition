// --------------------------------------------------------------------------------------------------------------------
// <copyright file="IIndependentParameterTypeAssignmentDao.cs" company="RHEA System S.A.">
...
namespace CDP4Orm.Dao
{
    ...
    public partial interface IIndependentParameterTypeAssignmentDao : IDao
    {
        ...
        /// </returns>
        IEnumerable<CDP4Common.DTO.IndependentParameterTypeAssignment> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false, DateTime? instant = null);
        ...
        /// </returns>
        bool Update(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.IndependentParameterTypeAssignment independentParameterTypeAssignment, CDP4Common.DTO.Thing container = null);

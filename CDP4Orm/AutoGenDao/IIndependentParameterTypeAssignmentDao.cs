...
namespace CDP4Orm.Dao
{
    ...
    public partial interface IIndependentParameterTypeAssignmentDao : IDao
    {
        ...
        /// </returns>
        IEnumerable<CDP4Common.DTO.IndependentParameterTypeAssignment> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false);

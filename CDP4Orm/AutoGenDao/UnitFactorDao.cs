...
namespace CDP4Orm.Dao
{
    ...
    public partial class UnitFactorDao : ThingDao, IUnitFactorDao
    {
        ...
        /// </returns>
        public virtual IEnumerable<CDP4Common.DTO.UnitFactor> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false)
        {
        ...
        public override string BuildReadQuery(string partition)
        {
            ...
            sqlBuilder.AppendFormat(" JOIN \"{0}\".\"UnitFactor_Data\"() AS \"UnitFactor\" USING (\"Iid\")", partition);

// --------------------------------------------------------------------------------------------------------------------
// <copyright file="FileTypeDao.cs" company="Starion Group S.A.">
...
namespace CDP4Orm.Dao
{
    ...
    /// <summary>
    /// The FileType Data Access Object which acts as an ORM layer to the SQL database.
    /// </summary>
    public partial class FileTypeDao : DefinedThingDao, IFileTypeDao
    {
        /// <summary>
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having a list of instances of <see cref="CDP4Common.DTO.FileType"/> as result.
        /// </returns>
        public virtual async Task<IEnumerable<CDP4Common.DTO.FileType>> ReadAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false, DateTime? instant = null)
        {
            ...
            await using (var command = new NpgsqlCommand())
            {
                ...
                {
                    sqlBuilder.AppendFormat("SELECT \"Jsonb\", \"Actor\" FROM \"{0}\".\"FileType_Cache\"", partition);
        ...
        /// </param>
        /// <returns>
        /// A deserialized instance of <see cref="CDP4Common.DTO.FileType"/>.
        /// </returns>
        public virtual CDP4Common.DTO.FileType MapToDto(NpgsqlDataReader reader)
        {
            ...
            var dto = new CDP4Common.DTO.FileType(iid, revisionNumber);
            ...
            if (valueDict.TryGetValue("Extension", out tempExtension))
            {
                dto.Extension = tempExtension.UnEscape();
            }
        ...
        /// </returns>
        public virtual async Task<bool> WriteAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.FileType fileType, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            var beforeWriteResult = await this.BeforeWriteAsync(transaction, partition, fileType, container, valueTypeDictionaryAdditions);
            ...
            if (!isHandled)
            {
                beforeWrite = beforeWrite && await base.WriteAsync(transaction, partition, fileType, container);
                ...
                foreach (var item in fileType.Category)
                {
                    await this.AddCategoryAsync(transaction, partition, fileType.Iid, item);
                }
            }

            return await this.AfterWriteAsync(beforeWrite, transaction, partition, fileType, container);
        }
        ...
        /// An awaitable <see cref="Task"/> having True if the concept was successfully persisted as result.
        /// </returns>
        public virtual async Task<bool> UpsertAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.FileType fileType, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            await base.UpsertAsync(transaction, partition, fileType, container);
            ...
            foreach (var item in fileType.Category)
            {
                await this.UpsertCategoryAsync(transaction, partition, fileType.Iid, item);
            }
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="CDP4Common.DTO.FileType"/> id that will be the source for each link table record.
        /// </param> 
        /// <param name="value">
        ...
        /// </param>
        /// <param name="fileType">
        /// The FileType DTO that is to be updated.
        /// </param>
        /// <param name="container">
        ...
        /// </returns>
        public virtual async Task<bool> UpdateAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.FileType fileType, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            var beforeUpdateResult = await this.BeforeUpdateAsync(transaction, partition, fileType, container, valueTypeDictionaryAdditions);
            ...
            if (!isHandled)
            {
                beforeUpdate = beforeUpdate && await base.UpdateAsync(transaction, partition, fileType, container);
            ...
            return await this.AfterUpdateAsync(beforeUpdate, transaction, partition, fileType, container);
        }
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="CDP4Common.DTO.FileType"/> id that is to be deleted.
        /// </param>
        /// <returns>
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="CDP4Common.DTO.FileType"/> id that is the source of each link table record.
        /// </param> 
        /// <param name="value">
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="CDP4Common.DTO.FileType"/> id that is the source for each link table record.
        /// </param> 
        /// <param name="category">
        ...
        public async Task<bool> DeleteCategoryAsync(NpgsqlTransaction transaction, string partition, Guid iid, Guid category)
        {
            ...
            {
                var sqlBuilder = new System.Text.StringBuilder();
                sqlBuilder.AppendFormat("DELETE FROM \"{0}\".\"FileType_Category\"", partition);
                sqlBuilder.Append(" WHERE \"FileType\" = :fileType");
        ...
        /// <summary>
        /// Build a SQL read query for the current <see cref="FileTypeDao" />
        /// </summary>
        ...
        public override string BuildReadQuery(string partition, DateTime? instant)
        {
            ...
            sqlBuilder.Append(" \"FileType\".\"Container\",");
            ...
            sqlBuilder.Append(" COALESCE(\"FileType_Category\".\"Category\",'{}'::text[]) AS \"Category\",");
            ...
            sqlBuilder.AppendFormat(" JOIN ({0}) AS \"FileType\" USING (\"Iid\")", this.GetFileTypeDataSql(partition, instant));
            ...
            sqlBuilder.Append(" LEFT JOIN (SELECT \"FileType\" AS \"Iid\", array_agg(\"Category\"::text) AS \"Category\"");
            sqlBuilder.AppendFormat(" FROM ({0}) AS \"FileType_Category\"", this.GetFileType_CategoryDataSql(partition, instant));
            sqlBuilder.AppendFormat(" JOIN ({0}) AS \"FileType\" ON \"FileType\" = \"Iid\"", this.GetFileTypeDataSql(partition, instant));
            sqlBuilder.Append(" GROUP BY \"FileType\") AS \"FileType_Category\" USING (\"Iid\")");
        ...
        {
            var sqlBuilder = new StringBuilder();
            sqlBuilder.Append(" LEFT JOIN (SELECT \"FileType_Audit\".\"Actor\", \"FileType_Audit\".\"Iid\"");
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"FileType_Audit\" AS \"FileType_Audit\"", partition);
            sqlBuilder.Append(" WHERE \"FileType_Audit\".\"ValidTo\" = 'infinity'");
            sqlBuilder.Append(" GROUP BY \"FileType_Audit\".\"Iid\", \"FileType_Audit\".\"Actor\") AS \"Actor\" USING (\"Iid\")");
            return sqlBuilder.ToString();
        }
        ...
        public override string GetValueTypeSet() => "\"Thing\".\"ValueTypeDictionary\" || \"DefinedThing\".\"ValueTypeDictionary\" || \"FileType\".\"ValueTypeDictionary\"";
        ...
        /// </param>
        /// <returns>The DataSql string</returns>
        private string GetFileType_CategoryDataSql(string partition, DateTime? instant)
        {
            var sqlBuilder = new StringBuilder();

            var fields = "\"FileType\",\"Category\",\"ValidFrom\",\"ValidTo\"";
            sqlBuilder.AppendFormat(" SELECT {0}", fields);
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"FileType_Category\"", partition);
            ...
            if (instant.HasValue && instant.Value != DateTime.MaxValue)
            {
                ...
                sqlBuilder.Append(" UNION ALL");
                sqlBuilder.AppendFormat(" SELECT {0}", fields);
                sqlBuilder.AppendFormat(" FROM \"{0}\".\"FileType_Category_Audit\"", partition);
                sqlBuilder.Append(" WHERE \"Action\" <> 'I'");
                sqlBuilder.Append(" AND \"ValidFrom\" < :instant");
                sqlBuilder.Append(" AND \"ValidTo\" >= :instant");
            }

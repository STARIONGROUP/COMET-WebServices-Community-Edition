...
namespace CDP4Orm.Dao
{
    ...
    public partial class FileTypeDao : DefinedThingDao, IFileTypeDao
    {
        ...
        /// </returns>
        public virtual IEnumerable<CDP4Common.DTO.FileType> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false)
        {
        ...
        public override string BuildReadQuery(string partition)
        {
            ...
            sqlBuilder.AppendFormat(" JOIN \"{0}\".\"FileType_Data\"() AS \"FileType\" USING (\"Iid\")", partition);
            ...
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"FileType_Category_Data\"() AS \"FileType_Category\"", partition);
            sqlBuilder.AppendFormat(" JOIN \"{0}\".\"FileType_Data\"() AS \"FileType\" ON \"FileType\" = \"Iid\"", partition);

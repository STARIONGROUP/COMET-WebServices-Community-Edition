...
namespace CDP4Orm.Dao
{
    ...
    public partial interface IGlossaryDao : IDao
    {
        ...
        /// </returns>
        IEnumerable<CDP4Common.DTO.Glossary> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false);

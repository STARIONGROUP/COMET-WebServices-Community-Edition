// --------------------------------------------------------------------------------------------------------------------
// <copyright file="BinaryRelationshipDao.cs" company="Starion Group S.A.">
...
namespace CDP4Orm.Dao
{
    ...
    public partial class BinaryRelationshipDao : RelationshipDao, IBinaryRelationshipDao
    {
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having a list of instances of <see cref="CDP4Common.DTO.BinaryRelationship"/> as result.
        /// </returns>
        public virtual async Task<IEnumerable<CDP4Common.DTO.BinaryRelationship>> ReadAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false, DateTime? instant = null)
        {
            var result = new List<BinaryRelationship>();
                ...
                if (isCachedDtoReadEnabledAndInstant)
                {
                    ...
                    await using (var reader = await command.ExecuteReaderAsync())
                    {
                        while (await reader.ReadAsync())
                        {
                            ...
                            if (thing != null)
                            {
                                result.Add(thing as BinaryRelationship);
                            }
                        }
                    }
                }
        ...
        /// </returns>
        public virtual async Task<bool> WriteAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.BinaryRelationship binaryRelationship, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            var beforeWriteResult = await this.BeforeWriteAsync(transaction, partition, binaryRelationship, container, valueTypeDictionaryAdditions);
            ...
            if (!isHandled)
            {
                beforeWrite = beforeWrite && await base.WriteAsync(transaction, partition, binaryRelationship, container);
            ...
            return await this.AfterWriteAsync(beforeWrite, transaction, partition, binaryRelationship, container);
        }
        ...
        /// An awaitable <see cref="Task"/> having True if the concept was successfully persisted as result.
        /// </returns>
        public virtual async Task<bool> UpsertAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.BinaryRelationship binaryRelationship, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            await base.UpsertAsync(transaction, partition, binaryRelationship, container);
        ...
        /// </returns>
        public virtual async Task<bool> UpdateAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.BinaryRelationship binaryRelationship, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            var beforeUpdateResult = await this.BeforeUpdateAsync(transaction, partition, binaryRelationship, container, valueTypeDictionaryAdditions);
            ...
            if (!isHandled)
            {
                beforeUpdate = beforeUpdate && await base.UpdateAsync(transaction, partition, binaryRelationship, container);
            ...
            return await this.AfterUpdateAsync(beforeUpdate, transaction, partition, binaryRelationship, container);
        }
        ...
        /// <summary>
        /// Build a SQL read query for the current <see cref="BinaryRelationshipDao" />
        /// </summary>
        ...
        public override string BuildReadQuery(string partition, DateTime? instant)
        {
            ...
            sqlBuilder.Append(" \"BinaryRelationship\".\"Source\",");

            sqlBuilder.Append(" \"BinaryRelationship\".\"Target\",");
            ...
            sqlBuilder.AppendFormat(" JOIN ({0}) AS \"BinaryRelationship\" USING (\"Iid\")", this.GetBinaryRelationshipDataSql(partition, instant));
        ...
        {
            var sqlBuilder = new StringBuilder();
            sqlBuilder.Append(" LEFT JOIN (SELECT \"BinaryRelationship_Audit\".\"Actor\", \"BinaryRelationship_Audit\".\"Iid\"");
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"BinaryRelationship_Audit\" AS \"BinaryRelationship_Audit\"", partition);
            sqlBuilder.Append(" WHERE \"BinaryRelationship_Audit\".\"ValidTo\" = 'infinity'");
            sqlBuilder.Append(" GROUP BY \"BinaryRelationship_Audit\".\"Iid\", \"BinaryRelationship_Audit\".\"Actor\") AS \"Actor\" USING (\"Iid\")");
            return sqlBuilder.ToString();
        }
        ...
        public override string GetValueTypeSet() => "\"Thing\".\"ValueTypeDictionary\" || \"Relationship\".\"ValueTypeDictionary\" || \"BinaryRelationship\".\"ValueTypeDictionary\"";
        ...
        /// </param>
        /// <returns>The DataSql string</returns>
        private string GetBinaryRelationshipDataSql(string partition, DateTime? instant)
        {
            var sqlBuilder = new StringBuilder();

            var fields = " \"Iid\", \"ValueTypeDictionary\", \"Source\", \"Target\",\"ValidFrom\",\"ValidTo\"";
            sqlBuilder.AppendFormat(" SELECT {0}", fields);
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"BinaryRelationship\"", partition);
            ...
            if (instant.HasValue && instant.Value != DateTime.MaxValue)
            {
                ...
                sqlBuilder.Append(" UNION ALL");
                sqlBuilder.AppendFormat(" SELECT {0}", fields);
                sqlBuilder.AppendFormat(" FROM \"{0}\".\"BinaryRelationship_Audit\"", partition);
                sqlBuilder.Append(" WHERE \"Action\" <> 'I'");
                sqlBuilder.Append(" AND \"ValidFrom\" < :instant");
                sqlBuilder.Append(" AND \"ValidTo\" >= :instant");
            }

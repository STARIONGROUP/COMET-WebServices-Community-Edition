...
namespace CDP4Orm.Dao
{
    ...
    public partial class TelephoneNumberDao : ThingDao, ITelephoneNumberDao
    {
        ...
        /// </returns>
        public virtual IEnumerable<CDP4Common.DTO.TelephoneNumber> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false, DateTime? instant = null)
        {
        ...
        /// True if the concept was successfully persisted.
        /// </returns>
        public virtual bool Upsert(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.TelephoneNumber telephoneNumber, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            base.Upsert(transaction, partition, telephoneNumber, container);
            ...
            telephoneNumber.VcardType.ForEach(x => this.UpsertVcardType(transaction, partition, telephoneNumber.Iid, x));
        ...
        /// True if the value link was successfully created.
        /// </returns>
        public bool UpsertVcardType(NpgsqlTransaction transaction, string partition, Guid iid, CDP4Common.SiteDirectoryData.VcardTelephoneNumberKind vcardType)
        {
            using (var command = new NpgsqlCommand())
            {
                var sqlBuilder = new System.Text.StringBuilder();

...
namespace CDP4Orm.Dao
{
    ...
    public partial class TelephoneNumberDao : ThingDao, ITelephoneNumberDao
    {
        ...
        public override string BuildReadQuery(string partition)
        {
            ...
            sqlBuilder.AppendFormat(" JOIN \"{0}\".\"TelephoneNumber_Data\"() AS \"TelephoneNumber\" USING (\"Iid\")", partition);
            ...
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"TelephoneNumber_VcardType_Data\"() AS \"TelephoneNumber_VcardType\"", partition);
            sqlBuilder.AppendFormat(" JOIN \"{0}\".\"TelephoneNumber_Data\"() AS \"TelephoneNumber\" ON \"TelephoneNumber\"= \"Iid\"", partition);

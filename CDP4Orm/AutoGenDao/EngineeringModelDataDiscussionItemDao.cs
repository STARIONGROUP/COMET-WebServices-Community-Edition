    ...
    public partial class EngineeringModelDataDiscussionItemDao : DiscussionItemDao, IEngineeringModelDataDiscussionItemDao
    {
        ...
        public virtual IEnumerable<CDP4Common.DTO.EngineeringModelDataDiscussionItem> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false)
        {
            using (var command = new NpgsqlCommand())
            {
                ...
                {
                    sqlBuilder.AppendFormat("SELECT * FROM \"{0}\".\"EngineeringModelDataDiscussionItem_View\"", partition);
        ...
        public virtual bool Upsert(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.EngineeringModelDataDiscussionItem engineeringModelDataDiscussionItem, CDP4Common.DTO.Thing container = null)
        {
            ...
            using (var command = new NpgsqlCommand())
            {
                ...
                sqlBuilder.AppendFormat(" DO UPDATE \"{0}\".\"EngineeringModelDataDiscussionItem\"", partition);

...
namespace CDP4Orm.Dao
{
    ...
    public partial interface IDomainFileStoreDao : IDao
    {
        ...
        /// </returns>
        IEnumerable<CDP4Common.DTO.DomainFileStore> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false);

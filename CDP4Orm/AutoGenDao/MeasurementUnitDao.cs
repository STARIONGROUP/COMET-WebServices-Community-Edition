...
namespace CDP4Orm.Dao
{
    ...
    public abstract partial class MeasurementUnitDao : DefinedThingDao
    {
        ...
        /// True if the concept was successfully persisted.
        /// </returns>
        public virtual bool Upsert(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.MeasurementUnit measurementUnit, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            base.Upsert(transaction, partition, measurementUnit, container);
        ...
        /// <summary>
        /// Build a SQL read query for the current <see cref="MeasurementUnitDao" />
        /// </summary>
        ...
        {
            var sqlBuilder = new StringBuilder();
            sqlBuilder.Append(" LEFT JOIN (SELECT \"MeasurementUnit_Audit\".\"Actor\", \"MeasurementUnit_Audit\".\"Iid\"");
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"MeasurementUnit_Audit\" AS \"MeasurementUnit_Audit\"", partition);
            sqlBuilder.Append(" WHERE \"MeasurementUnit_Audit\".\"ValidTo\" = 'infinity'");
            sqlBuilder.Append(" GROUP BY \"MeasurementUnit_Audit\".\"Iid\", \"MeasurementUnit_Audit\".\"Actor\") AS \"Actor\" USING (\"Iid\")");
            return sqlBuilder.ToString();
        }
        ...
        public override string GetValueTypeSet() => "\"Thing\".\"ValueTypeDictionary\" || \"DefinedThing\".\"ValueTypeDictionary\" || \"MeasurementUnit\".\"ValueTypeDictionary\"";
    }
}

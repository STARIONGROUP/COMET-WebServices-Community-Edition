...
namespace CDP4Orm.Dao
{
    ...
    public partial interface IBehaviorDao : IDao
    {
        ...
        /// </returns>
        IEnumerable<CDP4Common.DTO.Behavior> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false);

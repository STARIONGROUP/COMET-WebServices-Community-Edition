// --------------------------------------------------------------------------------------------------------------------
// <copyright file="IBehaviorDao.cs" company="RHEA System S.A.">
...
namespace CDP4Orm.Dao
{
    ...
    /// <summary>
    /// The Behavior Service Interface which uses the ORM layer to interact with the data model.
    /// </summary>
    public partial interface IBehaviorDao : IDao
    {
        /// <summary>
        ...
        /// </returns>
        IEnumerable<CDP4Common.DTO.Behavior> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false, DateTime? instant = null);
        ...
        /// </param>
        /// <param name="behavior">
        /// The <see cref="CDP4Common.DTO.Behavior"/> that is to be persisted.
        /// </param> 
        ...
        /// </returns>
        bool Write(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.Behavior behavior, CDP4Common.DTO.Thing container = null);
        ...
        /// True if the concept was successfully persisted.
        /// </returns>
        bool Upsert(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.Behavior behavior, CDP4Common.DTO.Thing container = null);
        ...
        /// </param>
        /// <param name="behavior">
        /// The <see cref="CDP4Common.DTO.Behavior"/> that is to be updated.
        /// </param>
        /// <param name="container">
        ...
        /// </returns>
        bool Update(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.Behavior behavior, CDP4Common.DTO.Thing container = null);
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="CDP4Common.DTO.Behavior"/> id that is the source for the reordered link table record.
        /// </param> 
        /// <param name="value">
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="CDP4Common.DTO.Behavior"/> id that is the source of each link table record.
        /// </param> 
        /// <param name="value">

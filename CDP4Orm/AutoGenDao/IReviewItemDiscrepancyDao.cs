...
namespace CDP4Orm.Dao
{
    ...
    public partial interface IReviewItemDiscrepancyDao : IDao
    {
        ...
        /// </returns>
        bool Update(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.ReviewItemDiscrepancy reviewItemDiscrepancy, CDP4Common.DTO.Thing container = null);

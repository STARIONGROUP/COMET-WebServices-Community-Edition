// --------------------------------------------------------------------------------------------------------------------
// <copyright file="EnumerationValueDefinitionDao.cs" company="Starion Group S.A.">
...
namespace CDP4Orm.Dao
{
    ...
    public partial class EnumerationValueDefinitionDao : DefinedThingDao, IEnumerationValueDefinitionDao
    {
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having a list of instances of <see cref="CDP4Common.DTO.EnumerationValueDefinition"/> as result.
        /// </returns>
        public virtual async Task<IEnumerable<CDP4Common.DTO.EnumerationValueDefinition>> ReadAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false, DateTime? instant = null)
        {
            var result = new List<EnumerationValueDefinition>();
            ...
            await using (var command = new NpgsqlCommand())
            {
                ...
                {
                    sqlBuilder.AppendFormat("SELECT \"Jsonb\", \"Actor\" FROM \"{0}\".\"EnumerationValueDefinition_Cache\"", partition);
                    ...
                    await using (var reader = await command.ExecuteReaderAsync())
                    {
                        while (await reader.ReadAsync())
                        {
                            ...
                            if (thing != null)
                            {
                                result.Add(thing as EnumerationValueDefinition);
                            }
                        }
                    }
                }
        ...
        /// </returns>
        public virtual async Task<bool> WriteAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.EnumerationValueDefinition enumerationValueDefinition, long sequence, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            var beforeWriteResult = await this.BeforeWriteAsync(transaction, partition, enumerationValueDefinition, container, valueTypeDictionaryAdditions);
            ...
            if (!isHandled)
            {
                beforeWrite = beforeWrite && await base.WriteAsync(transaction, partition, enumerationValueDefinition, container);
            ...
            return await this.AfterWriteAsync(beforeWrite, transaction, partition, enumerationValueDefinition, container);
        }
        ...
        /// An awaitable <see cref="Task"/> having True if the concept was successfully persisted as result.
        /// </returns>
        public virtual async Task<bool> UpsertAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.EnumerationValueDefinition enumerationValueDefinition, long sequence, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            await base.UpsertAsync(transaction, partition, enumerationValueDefinition, container);
        ...
        /// </returns>
        public virtual async Task<bool> UpdateAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.EnumerationValueDefinition enumerationValueDefinition, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            var beforeUpdateResult = await this.BeforeUpdateAsync(transaction, partition, enumerationValueDefinition, container, valueTypeDictionaryAdditions);
            ...
            if (!isHandled)
            {
                beforeUpdate = beforeUpdate && await base.UpdateAsync(transaction, partition, enumerationValueDefinition, container);
            ...
            return await this.AfterUpdateAsync(beforeUpdate, transaction, partition, enumerationValueDefinition, container);
        }
        ...
        /// <summary>
        /// Build a SQL read query for the current <see cref="EnumerationValueDefinitionDao" />
        /// </summary>
        ...
        public override string BuildReadQuery(string partition, DateTime? instant)
        {
            ...
            sqlBuilder.Append(" \"EnumerationValueDefinition\".\"Container\",");

            sqlBuilder.Append(" \"EnumerationValueDefinition\".\"Sequence\",");
            ...
            sqlBuilder.AppendFormat(" JOIN ({0}) AS \"EnumerationValueDefinition\" USING (\"Iid\")", this.GetEnumerationValueDefinitionDataSql(partition, instant));
        ...
        {
            var sqlBuilder = new StringBuilder();
            sqlBuilder.Append(" LEFT JOIN (SELECT \"EnumerationValueDefinition_Audit\".\"Actor\", \"EnumerationValueDefinition_Audit\".\"Iid\"");
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"EnumerationValueDefinition_Audit\" AS \"EnumerationValueDefinition_Audit\"", partition);
            sqlBuilder.Append(" WHERE \"EnumerationValueDefinition_Audit\".\"ValidTo\" = 'infinity'");
            sqlBuilder.Append(" GROUP BY \"EnumerationValueDefinition_Audit\".\"Iid\", \"EnumerationValueDefinition_Audit\".\"Actor\") AS \"Actor\" USING (\"Iid\")");
            return sqlBuilder.ToString();
        }
        ...
        public override string GetValueTypeSet() => "\"Thing\".\"ValueTypeDictionary\" || \"DefinedThing\".\"ValueTypeDictionary\" || \"EnumerationValueDefinition\".\"ValueTypeDictionary\"";

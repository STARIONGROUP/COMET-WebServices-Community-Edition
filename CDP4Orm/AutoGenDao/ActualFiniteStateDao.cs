...
namespace CDP4Orm.Dao
{
    ...
    public partial class ActualFiniteStateDao : ThingDao, IActualFiniteStateDao
    {
        ...
        /// </returns>
        public virtual IEnumerable<CDP4Common.DTO.ActualFiniteState> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false)
        {
        ...
        public override string BuildReadQuery(string partition)
        {
            ...
            sqlBuilder.AppendFormat(" JOIN \"{0}\".\"ActualFiniteState_Data\"() AS \"ActualFiniteState\" USING (\"Iid\")", partition);
            ...
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"ActualFiniteState_PossibleState_Data\"() AS \"ActualFiniteState_PossibleState\"", partition);
            sqlBuilder.AppendFormat(" JOIN \"{0}\".\"ActualFiniteState_Data\"() AS \"ActualFiniteState\" ON \"ActualFiniteState\" = \"Iid\"", partition);

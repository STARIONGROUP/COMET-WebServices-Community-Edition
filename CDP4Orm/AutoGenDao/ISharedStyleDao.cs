...
namespace CDP4Orm.Dao
{
    ...
    public partial interface ISharedStyleDao : IDao
    {
        ...
        /// </returns>
        IEnumerable<CDP4Common.DTO.SharedStyle> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false);

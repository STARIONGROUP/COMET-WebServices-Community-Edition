...
namespace CDP4Orm.Dao
{
    ...
    public partial interface IRuleVerificationListDao : IDao
    {
        ...
        /// </returns>
        IEnumerable<CDP4Common.DTO.RuleVerificationList> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false);

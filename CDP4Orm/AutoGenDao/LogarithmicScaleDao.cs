...
namespace CDP4Orm.Dao
{
    ...
    public partial class LogarithmicScaleDao : MeasurementScaleDao, ILogarithmicScaleDao
    {
        ...
        public override string BuildReadQuery(string partition)
        {
            ...
            sqlBuilder.AppendFormat(" JOIN \"{0}\".\"LogarithmicScale_Data\"() AS \"LogarithmicScale\" USING (\"Iid\")", partition);
            ...
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"ScaleReferenceQuantityValue_Data\"() AS \"ScaleReferenceQuantityValue\"", partition);
            sqlBuilder.AppendFormat(" JOIN \"{0}\".\"LogarithmicScale_Data\"() AS \"LogarithmicScale\" ON \"ScaleReferenceQuantityValue\".\"Container\" = \"LogarithmicScale\".\"Iid\"", partition);

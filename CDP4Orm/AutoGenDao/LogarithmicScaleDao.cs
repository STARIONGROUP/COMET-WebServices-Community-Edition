// --------------------------------------------------------------------------------------------------------------------
// <copyright file="LogarithmicScaleDao.cs" company="Starion Group S.A.">
...
namespace CDP4Orm.Dao
{
    ...
    public partial class LogarithmicScaleDao : MeasurementScaleDao, ILogarithmicScaleDao
    {
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having a list of instances of <see cref="CDP4Common.DTO.LogarithmicScale"/> as result.
        /// </returns>
        public virtual async Task<IEnumerable<CDP4Common.DTO.LogarithmicScale>> ReadAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false, DateTime? instant = null)
        {
            var result = new List<LogarithmicScale>();
            ...
            await using (var command = new NpgsqlCommand())
            {
                ...
                {
                    sqlBuilder.AppendFormat("SELECT \"Jsonb\", \"Actor\" FROM \"{0}\".\"LogarithmicScale_Cache\"", partition);
                    ...
                    await using (var reader = await command.ExecuteReaderAsync())
                    {
                        while (await reader.ReadAsync())
                        {
                            ...
                            if (thing != null)
                            {
                                result.Add(thing as LogarithmicScale);
                            }
                        }
                    }
                }
        ...
        /// </returns>
        public virtual async Task<bool> WriteAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.LogarithmicScale logarithmicScale, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            var beforeWriteResult = await this.BeforeWriteAsync(transaction, partition, logarithmicScale, container, valueTypeDictionaryAdditions);
            ...
            if (!isHandled)
            {
                beforeWrite = beforeWrite && await base.WriteAsync(transaction, partition, logarithmicScale, container);
            ...
            return await this.AfterWriteAsync(beforeWrite, transaction, partition, logarithmicScale, container);
        }
        ...
        /// An awaitable <see cref="Task"/> having True if the concept was successfully persisted as result.
        /// </returns>
        public virtual async Task<bool> UpsertAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.LogarithmicScale logarithmicScale, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            await base.UpsertAsync(transaction, partition, logarithmicScale, container);
            ...
            await using (var command = new NpgsqlCommand())
            {
                ...
                sqlBuilder.Append(" SET (\"ValueTypeDictionary\", \"ReferenceQuantityKind\")");
                sqlBuilder.Append(" = (:valueTypeDictionary, :referenceQuantityKind);");
        ...
        /// </returns>
        public virtual async Task<bool> UpdateAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.LogarithmicScale logarithmicScale, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            var beforeUpdateResult = await this.BeforeUpdateAsync(transaction, partition, logarithmicScale, container, valueTypeDictionaryAdditions);
            ...
            if (!isHandled)
            {
                beforeUpdate = beforeUpdate && await base.UpdateAsync(transaction, partition, logarithmicScale, container);
            ...
            return await this.AfterUpdateAsync(beforeUpdate, transaction, partition, logarithmicScale, container);
        }
        ...
        /// <summary>
        /// Build a SQL read query for the current <see cref="LogarithmicScaleDao" />
        /// </summary>
        ...
        public override string BuildReadQuery(string partition, DateTime? instant)
        {
            ...
            sqlBuilder.Append(" \"LogarithmicScale\".\"ReferenceQuantityKind\",");
            ...
            sqlBuilder.Append(" COALESCE(\"LogarithmicScale_ReferenceQuantityValue\".\"ReferenceQuantityValue\",'{}'::text[]) AS \"ReferenceQuantityValue\",");
            ...
            sqlBuilder.AppendFormat(" JOIN ({0}) AS \"LogarithmicScale\" USING (\"Iid\")", this.GetLogarithmicScaleDataSql(partition, instant));
            ...
            sqlBuilder.Append(" LEFT JOIN (SELECT \"ScaleReferenceQuantityValue\".\"Container\" AS \"Iid\", array_agg(\"ScaleReferenceQuantityValue\".\"Iid\"::text) AS \"ReferenceQuantityValue\"");
            sqlBuilder.AppendFormat(" FROM ({0}) AS \"ScaleReferenceQuantityValue\"", this.GetScaleReferenceQuantityValueDataSql(partition, instant));
            sqlBuilder.AppendFormat(" JOIN ({0}) AS \"LogarithmicScale\" ON \"ScaleReferenceQuantityValue\".\"Container\" = \"LogarithmicScale\".\"Iid\"", this.GetLogarithmicScaleDataSql(partition, instant));
            sqlBuilder.Append(" GROUP BY \"ScaleReferenceQuantityValue\".\"Container\") AS \"LogarithmicScale_ReferenceQuantityValue\" USING (\"Iid\")");
        ...
        {
            var sqlBuilder = new StringBuilder();
            sqlBuilder.Append(" LEFT JOIN (SELECT \"LogarithmicScale_Audit\".\"Actor\", \"LogarithmicScale_Audit\".\"Iid\"");
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"LogarithmicScale_Audit\" AS \"LogarithmicScale_Audit\"", partition);
            sqlBuilder.Append(" WHERE \"LogarithmicScale_Audit\".\"ValidTo\" = 'infinity'");
            sqlBuilder.Append(" GROUP BY \"LogarithmicScale_Audit\".\"Iid\", \"LogarithmicScale_Audit\".\"Actor\") AS \"Actor\" USING (\"Iid\")");
            return sqlBuilder.ToString();
        }
        ...
        public override string GetValueTypeSet() => "\"Thing\".\"ValueTypeDictionary\" || \"DefinedThing\".\"ValueTypeDictionary\" || \"MeasurementScale\".\"ValueTypeDictionary\" || \"LogarithmicScale\".\"ValueTypeDictionary\"";
        ...
        /// </param>
        /// <returns>The DataSql string</returns>
        private string GetLogarithmicScaleDataSql(string partition, DateTime? instant)
        {
            var sqlBuilder = new StringBuilder();

            var fields = " \"Iid\", \"ValueTypeDictionary\", \"ReferenceQuantityKind\",\"ValidFrom\",\"ValidTo\"";
            sqlBuilder.AppendFormat(" SELECT {0}", fields);
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"LogarithmicScale\"", partition);
            ...
            if (instant.HasValue && instant.Value != DateTime.MaxValue)
            {
                ...
                sqlBuilder.Append(" UNION ALL");
                sqlBuilder.AppendFormat(" SELECT {0}", fields);
                sqlBuilder.AppendFormat(" FROM \"{0}\".\"LogarithmicScale_Audit\"", partition);
                sqlBuilder.Append(" WHERE \"Action\" <> 'I'");
                sqlBuilder.Append(" AND \"ValidFrom\" < :instant");
                sqlBuilder.Append(" AND \"ValidTo\" >= :instant");
            }

...
namespace CDP4Orm.Dao
{
    ...
    public partial interface IRequestForWaiverDao : IDao
    {
        ...
        /// </returns>
        IEnumerable<CDP4Common.DTO.RequestForWaiver> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false);

...
namespace CDP4Orm.Dao
{
    ...
    public partial interface IBoundsDao : IDao
    {
        ...
        /// </returns>
        IEnumerable<CDP4Common.DTO.Bounds> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false);

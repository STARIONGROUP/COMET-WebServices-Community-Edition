...
namespace CDP4Orm.Dao
{
    ...
    public partial class FolderDao : ThingDao, IFolderDao
    {
        ...
        /// </returns>
        public virtual IEnumerable<CDP4Common.DTO.Folder> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false)
        {
        ...
        public override string BuildReadQuery(string partition)
        {
            ...
            sqlBuilder.AppendFormat(" JOIN \"{0}\".\"Folder_Data\"() AS \"Folder\" USING (\"Iid\")", partition);

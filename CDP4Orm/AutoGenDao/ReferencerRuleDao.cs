...
namespace CDP4Orm.Dao
{
    ...
    public partial class ReferencerRuleDao : RuleDao, IReferencerRuleDao
    {
        ...
        /// </returns>
        public virtual IEnumerable<CDP4Common.DTO.ReferencerRule> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false)
        {
        ...
        public override string BuildReadQuery(string partition)
        {
            ...
            sqlBuilder.AppendFormat(" JOIN \"{0}\".\"ReferencerRule_Data\"() AS \"ReferencerRule\" USING (\"Iid\")", partition);
            ...
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"ReferencerRule_ReferencedCategory_Data\"() AS \"ReferencerRule_ReferencedCategory\"", partition);
            sqlBuilder.AppendFormat(" JOIN \"{0}\".\"ReferencerRule_Data\"() AS \"ReferencerRule\" ON \"ReferencerRule\" = \"Iid\"", partition);

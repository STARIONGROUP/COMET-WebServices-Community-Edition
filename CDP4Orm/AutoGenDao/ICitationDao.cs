...
namespace CDP4Orm.Dao
{
    ...
    public partial interface ICitationDao : IDao
    {
        ...
        /// </returns>
        IEnumerable<CDP4Common.DTO.Citation> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false);

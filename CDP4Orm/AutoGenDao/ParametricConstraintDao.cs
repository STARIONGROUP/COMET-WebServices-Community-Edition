// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ParametricConstraintDao.cs" company="Starion Group S.A.">
...
namespace CDP4Orm.Dao
{
    ...
    public partial class ParametricConstraintDao : ThingDao, IParametricConstraintDao
    {
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having a list of instances of <see cref="CDP4Common.DTO.ParametricConstraint"/> as result.
        /// </returns>
        public virtual async Task<IEnumerable<CDP4Common.DTO.ParametricConstraint>> ReadAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false, DateTime? instant = null)
        {
            var result = new List<ParametricConstraint>();
            ...
            await using (var command = new NpgsqlCommand())
            {
                ...
                {
                    sqlBuilder.AppendFormat("SELECT \"Jsonb\", \"Actor\" FROM \"{0}\".\"ParametricConstraint_Cache\"", partition);
                    ...
                    await using (var reader = await command.ExecuteReaderAsync())
                    {
                        while (await reader.ReadAsync())
                        {
                            ...
                            if (thing != null)
                            {
                                result.Add(thing as ParametricConstraint);
                            }
                        }
                    }
                }
        ...
        /// </returns>
        public virtual async Task<bool> WriteAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.ParametricConstraint parametricConstraint, long sequence, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            var beforeWriteResult = await this.BeforeWriteAsync(transaction, partition, parametricConstraint, container, valueTypeDictionaryAdditions);
            ...
            if (!isHandled)
            {
                beforeWrite = beforeWrite && await base.WriteAsync(transaction, partition, parametricConstraint, container);
            ...
            return await this.AfterWriteAsync(beforeWrite, transaction, partition, parametricConstraint, container);
        }
        ...
        /// An awaitable <see cref="Task"/> having True if the concept was successfully persisted as result.
        /// </returns>
        public virtual async Task<bool> UpsertAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.ParametricConstraint parametricConstraint, long sequence, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            await base.UpsertAsync(transaction, partition, parametricConstraint, container);
        ...
        /// </returns>
        public virtual async Task<bool> UpdateAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.ParametricConstraint parametricConstraint, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            var beforeUpdateResult = await this.BeforeUpdateAsync(transaction, partition, parametricConstraint, container, valueTypeDictionaryAdditions);
            ...
            if (!isHandled)
            {
                beforeUpdate = beforeUpdate && await base.UpdateAsync(transaction, partition, parametricConstraint, container);
            ...
            return await this.AfterUpdateAsync(beforeUpdate, transaction, partition, parametricConstraint, container);
        }
        ...
        /// <summary>
        /// Build a SQL read query for the current <see cref="ParametricConstraintDao" />
        /// </summary>
        ...
        public override string BuildReadQuery(string partition, DateTime? instant)
        {
            ...
            sqlBuilder.Append(" \"ParametricConstraint\".\"Container\",");

            sqlBuilder.Append(" \"ParametricConstraint\".\"Sequence\",");

            sqlBuilder.Append(" \"Actor\",");

            sqlBuilder.Append(" \"ParametricConstraint\".\"TopExpression\",");
            sqlBuilder.Append(" COALESCE(\"Thing_ExcludedDomain\".\"ExcludedDomain\",'{}'::text[]) AS \"ExcludedDomain\",");
            sqlBuilder.Append(" COALESCE(\"Thing_ExcludedPerson\".\"ExcludedPerson\",'{}'::text[]) AS \"ExcludedPerson\",");
            sqlBuilder.Append(" COALESCE(\"ParametricConstraint_Expression\".\"Expression\",'{}'::text[]) AS \"Expression\",");

            sqlBuilder.Remove(sqlBuilder.Length - 1, 1);
            sqlBuilder.AppendFormat(" FROM ({0}) AS \"Thing\"", this.GetThingDataSql(partition, instant));
            sqlBuilder.AppendFormat(" JOIN ({0}) AS \"ParametricConstraint\" USING (\"Iid\")", this.GetParametricConstraintDataSql(partition, instant));
            ...
            sqlBuilder.Append(" LEFT JOIN (SELECT \"BooleanExpression\".\"Container\" AS \"Iid\", array_agg(\"BooleanExpression\".\"Iid\"::text) AS \"Expression\"");
            sqlBuilder.AppendFormat(" FROM ({0}) AS \"BooleanExpression\"", this.GetBooleanExpressionDataSql(partition, instant));
            sqlBuilder.AppendFormat(" JOIN ({0}) AS \"ParametricConstraint\" ON \"BooleanExpression\".\"Container\" = \"ParametricConstraint\".\"Iid\"", this.GetParametricConstraintDataSql(partition, instant));
            sqlBuilder.Append(" GROUP BY \"BooleanExpression\".\"Container\") AS \"ParametricConstraint_Expression\" USING (\"Iid\")");
        ...
        {
            var sqlBuilder = new StringBuilder();
            sqlBuilder.Append(" LEFT JOIN (SELECT \"ParametricConstraint_Audit\".\"Actor\", \"ParametricConstraint_Audit\".\"Iid\"");
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"ParametricConstraint_Audit\" AS \"ParametricConstraint_Audit\"", partition);
            sqlBuilder.Append(" WHERE \"ParametricConstraint_Audit\".\"ValidTo\" = 'infinity'");
            sqlBuilder.Append(" GROUP BY \"ParametricConstraint_Audit\".\"Iid\", \"ParametricConstraint_Audit\".\"Actor\") AS \"Actor\" USING (\"Iid\")");
            return sqlBuilder.ToString();
        }
        ...
        public override string GetValueTypeSet() => "\"Thing\".\"ValueTypeDictionary\" || \"ParametricConstraint\".\"ValueTypeDictionary\"";

...
namespace CDP4Orm.Dao
{
    ...
    public partial class ParametricConstraintDao : ThingDao, IParametricConstraintDao
    {
        ...
        public override string BuildReadQuery(string partition)
        {
            ...
            sqlBuilder.AppendFormat(" JOIN \"{0}\".\"ParametricConstraint_Data\"() AS \"ParametricConstraint\" USING (\"Iid\")", partition);
            ...
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"BooleanExpression_Data\"() AS \"BooleanExpression\"", partition);
            sqlBuilder.AppendFormat(" JOIN \"{0}\".\"ParametricConstraint_Data\"() AS \"ParametricConstraint\" ON \"BooleanExpression\".\"Container\" = \"ParametricConstraint\".\"Iid\"", partition);

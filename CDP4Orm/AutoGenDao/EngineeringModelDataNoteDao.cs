// --------------------------------------------------------------------------------------------------------------------
// <copyright file="EngineeringModelDataNoteDao.cs" company="Starion Group S.A.">
...
namespace CDP4Orm.Dao
{
    ...
    public partial class EngineeringModelDataNoteDao : EngineeringModelDataAnnotationDao, IEngineeringModelDataNoteDao
    {
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having a list of instances of <see cref="CDP4Common.DTO.EngineeringModelDataNote"/> as result.
        /// </returns>
        public virtual async Task<IEnumerable<CDP4Common.DTO.EngineeringModelDataNote>> ReadAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false, DateTime? instant = null)
        {
            var result = new List<EngineeringModelDataNote>();
            ...
            await using (var command = new NpgsqlCommand())
            {
                ...
                {
                    sqlBuilder.AppendFormat("SELECT \"Jsonb\", \"Actor\" FROM \"{0}\".\"EngineeringModelDataNote_Cache\"", partition);
                    ...
                    await using (var reader = await command.ExecuteReaderAsync())
                    {
                        while (await reader.ReadAsync())
                        {
                            ...
                            if (thing != null)
                            {
                                result.Add(thing as EngineeringModelDataNote);
                            }
                        }
                    }
                }
        ...
        /// </returns>
        public virtual async Task<bool> WriteAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.EngineeringModelDataNote engineeringModelDataNote, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            var beforeWriteResult = await this.BeforeWriteAsync(transaction, partition, engineeringModelDataNote, container, valueTypeDictionaryAdditions);
            ...
            if (!isHandled)
            {
                beforeWrite = beforeWrite && await base.WriteAsync(transaction, partition, engineeringModelDataNote, container);
            ...
            return await this.AfterWriteAsync(beforeWrite, transaction, partition, engineeringModelDataNote, container);
        }
        ...
        /// An awaitable <see cref="Task"/> having True if the concept was successfully persisted as result.
        /// </returns>
        public virtual async Task<bool> UpsertAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.EngineeringModelDataNote engineeringModelDataNote, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            await base.UpsertAsync(transaction, partition, engineeringModelDataNote, container);
        ...
        /// </returns>
        public virtual async Task<bool> UpdateAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.EngineeringModelDataNote engineeringModelDataNote, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            var beforeUpdateResult = await this.BeforeUpdateAsync(transaction, partition, engineeringModelDataNote, container, valueTypeDictionaryAdditions);
            ...
            if (!isHandled)
            {
                beforeUpdate = beforeUpdate && await base.UpdateAsync(transaction, partition, engineeringModelDataNote, container);
            ...
            return await this.AfterUpdateAsync(beforeUpdate, transaction, partition, engineeringModelDataNote, container);
        }
        ...
        /// <summary>
        /// Build a SQL read query for the current <see cref="EngineeringModelDataNoteDao" />
        /// </summary>
        ...
        public override string BuildReadQuery(string partition, DateTime? instant)
        {
            ...
            sqlBuilder.Append(" \"EngineeringModelDataNote\".\"Container\",");
            ...
            sqlBuilder.AppendFormat(" JOIN ({0}) AS \"EngineeringModelDataNote\" USING (\"Iid\")", this.GetEngineeringModelDataNoteDataSql(partition, instant));
        ...
        {
            var sqlBuilder = new StringBuilder();
            sqlBuilder.Append(" LEFT JOIN (SELECT \"EngineeringModelDataNote_Audit\".\"Actor\", \"EngineeringModelDataNote_Audit\".\"Iid\"");
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"EngineeringModelDataNote_Audit\" AS \"EngineeringModelDataNote_Audit\"", partition);
            sqlBuilder.Append(" WHERE \"EngineeringModelDataNote_Audit\".\"ValidTo\" = 'infinity'");
            sqlBuilder.Append(" GROUP BY \"EngineeringModelDataNote_Audit\".\"Iid\", \"EngineeringModelDataNote_Audit\".\"Actor\") AS \"Actor\" USING (\"Iid\")");
            return sqlBuilder.ToString();
        }
        ...
        public override string GetValueTypeSet() => "\"Thing\".\"ValueTypeDictionary\" || \"GenericAnnotation\".\"ValueTypeDictionary\" || \"EngineeringModelDataAnnotation\".\"ValueTypeDictionary\" || \"EngineeringModelDataNote\".\"ValueTypeDictionary\"";

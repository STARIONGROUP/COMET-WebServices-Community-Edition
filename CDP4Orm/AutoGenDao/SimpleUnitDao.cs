...
namespace CDP4Orm.Dao
{
    ...
    public partial class SimpleUnitDao : MeasurementUnitDao, ISimpleUnitDao
    {
        ...
        /// </returns>
        public virtual IEnumerable<CDP4Common.DTO.SimpleUnit> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false)
        {
        ...
        public override string BuildReadQuery(string partition)
        {
            ...
            sqlBuilder.AppendFormat(" JOIN \"{0}\".\"SimpleUnit_Data\"() AS \"SimpleUnit\" USING (\"Iid\")", partition);

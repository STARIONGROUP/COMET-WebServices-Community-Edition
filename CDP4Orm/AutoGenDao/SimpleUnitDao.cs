...
namespace CDP4Orm.Dao
{
    ...
    public partial class SimpleUnitDao : MeasurementUnitDao, ISimpleUnitDao
    {
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="CDP4Common.DTO.SimpleUnit"/>.
        /// </returns>
        public virtual IEnumerable<CDP4Common.DTO.SimpleUnit> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false, DateTime? instant = null)
        {
                ...
                if (isCachedDtoReadEnabledAndInstant)
                {
                    ...
                    using (var reader = command.ExecuteReader())
                    {
                        while (reader.Read())
                        {
                            ...
                            if (thing != null)
                            {
                                yield return thing as SimpleUnit;
                            }
                        }
                    }
                }

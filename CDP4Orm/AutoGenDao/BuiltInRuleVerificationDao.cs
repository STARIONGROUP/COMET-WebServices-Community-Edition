// --------------------------------------------------------------------------------------------------------------------
// <copyright file="BuiltInRuleVerificationDao.cs" company="Starion Group S.A.">
...
namespace CDP4Orm.Dao
{
    ...
    /// <summary>
    /// The BuiltInRuleVerification Data Access Object which acts as an ORM layer to the SQL database.
    /// </summary>
    [ExcludeFromCodeCoverage]
    public partial class BuiltInRuleVerificationDao : RuleVerificationDao, IBuiltInRuleVerificationDao
    {
        /// <summary>
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having a list of instances of <see cref="CDP4Common.DTO.BuiltInRuleVerification"/> as result.
        /// </returns>
        public virtual async Task<IEnumerable<CDP4Common.DTO.BuiltInRuleVerification>> ReadAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false, DateTime? instant = null)
        {
            var result = new List<BuiltInRuleVerification>();
                ...
                if (isCachedDtoReadEnabledAndInstant)
                {
                    ...
                    await using (var reader = await command.ExecuteReaderAsync())
                    {
                        while (await reader.ReadAsync())
                        {
                            ...
                            if (thing != null)
                            {
                                result.Add(thing as BuiltInRuleVerification);
                            }
                        }
                    }
                }
        ...
        /// </returns>
        public virtual async Task<bool> WriteAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.BuiltInRuleVerification builtInRuleVerification, long sequence, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            var beforeWriteResult = await this.BeforeWriteAsync(transaction, partition, builtInRuleVerification, container, valueTypeDictionaryAdditions);
            ...
            if (!isHandled)
            {
                beforeWrite = beforeWrite && await base.WriteAsync(transaction, partition, builtInRuleVerification, sequence, container);
            ...
            return await this.AfterWriteAsync(beforeWrite, transaction, partition, builtInRuleVerification, container);
        }
        ...
        /// An awaitable <see cref="Task"/> having True if the concept was successfully persisted as result.
        /// </returns>
        public virtual async Task<bool> UpsertAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.BuiltInRuleVerification builtInRuleVerification, long sequence, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            await base.UpsertAsync(transaction, partition, builtInRuleVerification, sequence, container);
        ...
        /// </param>
        /// <param name="builtInRuleVerification">
        /// The BuiltInRuleVerification DTO that is to be updated.
        /// </param>
        /// <param name="container">
        ...
        /// </returns>
        public virtual async Task<bool> UpdateAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.BuiltInRuleVerification builtInRuleVerification, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            var beforeUpdateResult = await this.BeforeUpdateAsync(transaction, partition, builtInRuleVerification, container, valueTypeDictionaryAdditions);
            ...
            if (!isHandled)
            {
                beforeUpdate = beforeUpdate && await base.UpdateAsync(transaction, partition, builtInRuleVerification, container);
            }

            return await this.AfterUpdateAsync(beforeUpdate, transaction, partition, builtInRuleVerification, container);
        }
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="CDP4Common.DTO.BuiltInRuleVerification"/> id that is to be deleted.
        /// </param>
        /// <returns>
        ...
        /// <summary>
        /// Build a SQL read query for the current <see cref="BuiltInRuleVerificationDao" />
        /// </summary>
        ...
        public override string BuildReadQuery(string partition, DateTime? instant)
        {
            ...
            sqlBuilder.Append(" \"RuleVerification\".\"Container\",");
            ...
            sqlBuilder.Append(" COALESCE(\"RuleVerification_Violation\".\"Violation\",'{}'::text[]) AS \"Violation\",");

            sqlBuilder.Remove(sqlBuilder.Length - 1, 1);
            sqlBuilder.AppendFormat(" FROM ({0}) AS \"Thing\"", this.GetThingDataSql(partition, instant));
            sqlBuilder.AppendFormat(" JOIN ({0}) AS \"RuleVerification\" USING (\"Iid\")", this.GetRuleVerificationDataSql(partition, instant));
            sqlBuilder.AppendFormat(" JOIN ({0}) AS \"BuiltInRuleVerification\" USING (\"Iid\")", this.GetBuiltInRuleVerificationDataSql(partition, instant));
            ...
            sqlBuilder.Append(" LEFT JOIN (SELECT \"RuleViolation\".\"Container\" AS \"Iid\", array_agg(\"RuleViolation\".\"Iid\"::text) AS \"Violation\"");
            sqlBuilder.AppendFormat(" FROM ({0}) AS \"RuleViolation\"", this.GetRuleViolationDataSql(partition, instant));
            sqlBuilder.AppendFormat(" JOIN ({0}) AS \"RuleVerification\" ON \"RuleViolation\".\"Container\" = \"RuleVerification\".\"Iid\"", this.GetRuleVerificationDataSql(partition, instant));
            sqlBuilder.Append(" GROUP BY \"RuleViolation\".\"Container\") AS \"RuleVerification_Violation\" USING (\"Iid\")");
        ...
        {
            var sqlBuilder = new StringBuilder();
            sqlBuilder.Append(" LEFT JOIN (SELECT \"BuiltInRuleVerification_Audit\".\"Actor\", \"BuiltInRuleVerification_Audit\".\"Iid\"");
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"BuiltInRuleVerification_Audit\" AS \"BuiltInRuleVerification_Audit\"", partition);
            sqlBuilder.Append(" WHERE \"BuiltInRuleVerification_Audit\".\"ValidTo\" = 'infinity'");
            sqlBuilder.Append(" GROUP BY \"BuiltInRuleVerification_Audit\".\"Iid\", \"BuiltInRuleVerification_Audit\".\"Actor\") AS \"Actor\" USING (\"Iid\")");
            return sqlBuilder.ToString();
        }
        ...
        public override string GetValueTypeSet() => "\"Thing\".\"ValueTypeDictionary\" || \"RuleVerification\".\"ValueTypeDictionary\" || \"BuiltInRuleVerification\".\"ValueTypeDictionary\"";
        ...
        /// </param>
        /// <returns>The DataSql string</returns>
        private string GetBuiltInRuleVerificationDataSql(string partition, DateTime? instant)
        {
            var sqlBuilder = new StringBuilder();

            var fields = " \"Iid\", \"ValueTypeDictionary\",\"ValidFrom\",\"ValidTo\"";
            sqlBuilder.AppendFormat(" SELECT {0}", fields);
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"BuiltInRuleVerification\"", partition);
            ...
            if (instant.HasValue && instant.Value != DateTime.MaxValue)
            {
                ...
                sqlBuilder.Append(" UNION ALL");
                sqlBuilder.AppendFormat(" SELECT {0}", fields);
                sqlBuilder.AppendFormat(" FROM \"{0}\".\"BuiltInRuleVerification_Audit\"", partition);
                sqlBuilder.Append(" WHERE \"Action\" <> 'I'");
                sqlBuilder.Append(" AND \"ValidFrom\" < :instant");
                sqlBuilder.Append(" AND \"ValidTo\" >= :instant");
            }

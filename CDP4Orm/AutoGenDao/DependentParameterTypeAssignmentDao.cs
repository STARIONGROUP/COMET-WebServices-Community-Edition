// --------------------------------------------------------------------------------------------------------------------
// <copyright file="DependentParameterTypeAssignmentDao.cs" company="Starion Group S.A.">
...
namespace CDP4Orm.Dao
{
    ...
    /// <summary>
    /// The DependentParameterTypeAssignment Data Access Object which acts as an ORM layer to the SQL database.
    /// </summary>
    [ExcludeFromCodeCoverage]
    public partial class DependentParameterTypeAssignmentDao : ThingDao, IDependentParameterTypeAssignmentDao
    {
        /// <summary>
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having a list of instances of <see cref="CDP4Common.DTO.DependentParameterTypeAssignment"/> as result.
        /// </returns>
        public virtual async Task<IEnumerable<CDP4Common.DTO.DependentParameterTypeAssignment>> ReadAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false, DateTime? instant = null)
        {
            var result = new List<DependentParameterTypeAssignment>();
                ...
                if (isCachedDtoReadEnabledAndInstant)
                {
                    ...
                    await using (var reader = await command.ExecuteReaderAsync())
                    {
                        while (await reader.ReadAsync())
                        {
                            ...
                            if (thing != null)
                            {
                                result.Add(thing as DependentParameterTypeAssignment);
                            }
                        }
                    }
                }
        ...
        /// </param>
        /// <returns>
        /// A deserialized instance of <see cref="CDP4Common.DTO.DependentParameterTypeAssignment"/>.
        /// </returns>
        public virtual CDP4Common.DTO.DependentParameterTypeAssignment MapToDto(NpgsqlDataReader reader)
        {
            ...
            var dto = new CDP4Common.DTO.DependentParameterTypeAssignment(iid, revisionNumber);
        ...
        /// </returns>
        public virtual async Task<bool> WriteAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.DependentParameterTypeAssignment dependentParameterTypeAssignment, long sequence, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            var beforeWriteResult = await this.BeforeWriteAsync(transaction, partition, dependentParameterTypeAssignment, container, valueTypeDictionaryAdditions);
            ...
            if (!isHandled)
            {
                beforeWrite = beforeWrite && await base.WriteAsync(transaction, partition, dependentParameterTypeAssignment, container);
            ...
            return await this.AfterWriteAsync(beforeWrite, transaction, partition, dependentParameterTypeAssignment, container);
        }
        ...
        /// An awaitable <see cref="Task"/> having True if the concept was successfully persisted as result.
        /// </returns>
        public virtual async Task<bool> UpsertAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.DependentParameterTypeAssignment dependentParameterTypeAssignment, long sequence, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            await base.UpsertAsync(transaction, partition, dependentParameterTypeAssignment, container);
        ...
        /// </param>
        /// <param name="dependentParameterTypeAssignment">
        /// The DependentParameterTypeAssignment DTO that is to be updated.
        /// </param>
        /// <param name="container">
        ...
        /// </returns>
        public virtual async Task<bool> UpdateAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.DependentParameterTypeAssignment dependentParameterTypeAssignment, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            var beforeUpdateResult = await this.BeforeUpdateAsync(transaction, partition, dependentParameterTypeAssignment, container, valueTypeDictionaryAdditions);
            ...
            if (!isHandled)
            {
                beforeUpdate = beforeUpdate && await base.UpdateAsync(transaction, partition, dependentParameterTypeAssignment, container);

                await using (var command = new NpgsqlCommand())
                {
                    var sqlBuilder = new System.Text.StringBuilder();
                    sqlBuilder.AppendFormat("UPDATE \"{0}\".\"DependentParameterTypeAssignment\"", partition);
            ...
            return await this.AfterUpdateAsync(beforeUpdate, transaction, partition, dependentParameterTypeAssignment, container);
        }
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="CDP4Common.DTO.DependentParameterTypeAssignment"/> id that is to be deleted.
        /// </param>
        /// <returns>
        ...
        /// <summary>
        /// Build a SQL read query for the current <see cref="DependentParameterTypeAssignmentDao" />
        /// </summary>
        ...
        public override string BuildReadQuery(string partition, DateTime? instant)
        {
            ...
            sqlBuilder.Append(" \"DependentParameterTypeAssignment\".\"Container\",");

            sqlBuilder.Append(" \"DependentParameterTypeAssignment\".\"Sequence\",");

            sqlBuilder.Append(" \"Actor\",");

            sqlBuilder.Append(" \"DependentParameterTypeAssignment\".\"MeasurementScale\",");

            sqlBuilder.Append(" \"DependentParameterTypeAssignment\".\"ParameterType\",");
            sqlBuilder.Append(" COALESCE(\"Thing_ExcludedDomain\".\"ExcludedDomain\",'{}'::text[]) AS \"ExcludedDomain\",");
            sqlBuilder.Append(" COALESCE(\"Thing_ExcludedPerson\".\"ExcludedPerson\",'{}'::text[]) AS \"ExcludedPerson\",");

            sqlBuilder.Remove(sqlBuilder.Length - 1, 1);
            sqlBuilder.AppendFormat(" FROM ({0}) AS \"Thing\"", this.GetThingDataSql(partition, instant));
            sqlBuilder.AppendFormat(" JOIN ({0}) AS \"DependentParameterTypeAssignment\" USING (\"Iid\")", this.GetDependentParameterTypeAssignmentDataSql(partition, instant));
        ...
        {
            var sqlBuilder = new StringBuilder();
            sqlBuilder.Append(" LEFT JOIN (SELECT \"DependentParameterTypeAssignment_Audit\".\"Actor\", \"DependentParameterTypeAssignment_Audit\".\"Iid\"");
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"DependentParameterTypeAssignment_Audit\" AS \"DependentParameterTypeAssignment_Audit\"", partition);
            sqlBuilder.Append(" WHERE \"DependentParameterTypeAssignment_Audit\".\"ValidTo\" = 'infinity'");
            sqlBuilder.Append(" GROUP BY \"DependentParameterTypeAssignment_Audit\".\"Iid\", \"DependentParameterTypeAssignment_Audit\".\"Actor\") AS \"Actor\" USING (\"Iid\")");
            return sqlBuilder.ToString();
        }
        ...
        public override string GetValueTypeSet() => "\"Thing\".\"ValueTypeDictionary\" || \"DependentParameterTypeAssignment\".\"ValueTypeDictionary\"";
        ...
        /// </param>
        /// <returns>The DataSql string</returns>
        private string GetDependentParameterTypeAssignmentDataSql(string partition, DateTime? instant)
        {
            var sqlBuilder = new StringBuilder();

            var fields = " \"Iid\", \"ValueTypeDictionary\", \"Sequence\", \"Container\", \"MeasurementScale\", \"ParameterType\",\"ValidFrom\",\"ValidTo\"";
            sqlBuilder.AppendFormat(" SELECT {0}", fields);
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"DependentParameterTypeAssignment\"", partition);
            ...
            if (instant.HasValue && instant.Value != DateTime.MaxValue)
            {
                ...
                sqlBuilder.Append(" UNION ALL");
                sqlBuilder.AppendFormat(" SELECT {0}", fields);
                sqlBuilder.AppendFormat(" FROM \"{0}\".\"DependentParameterTypeAssignment_Audit\"", partition);
                sqlBuilder.Append(" WHERE \"Action\" <> 'I'");
                sqlBuilder.Append(" AND \"ValidFrom\" < :instant");
                sqlBuilder.Append(" AND \"ValidTo\" >= :instant");
            }

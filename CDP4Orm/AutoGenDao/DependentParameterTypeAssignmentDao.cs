...
namespace CDP4Orm.Dao
{
    ...
    public partial class DependentParameterTypeAssignmentDao : ThingDao, IDependentParameterTypeAssignmentDao
    {
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="CDP4Common.DTO.DependentParameterTypeAssignment"/>.
        /// </returns>
        public virtual IEnumerable<CDP4Common.DTO.DependentParameterTypeAssignment> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false, DateTime? instant = null)
        {
                ...
                if (isCachedDtoReadEnabledAndInstant)
                {
                    ...
                    using (var reader = command.ExecuteReader())
                    {
                        while (reader.Read())
                        {
                            ...
                            if (thing != null)
                            {
                                yield return thing as DependentParameterTypeAssignment;
                            }
                        }
                    }
                }
        ...
        /// </returns>
        public virtual bool Write(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.DependentParameterTypeAssignment dependentParameterTypeAssignment, long sequence, CDP4Common.DTO.Thing container = null)
        {
            bool isHandled;
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            var beforeWrite = this.BeforeWrite(transaction, partition, dependentParameterTypeAssignment, container, out isHandled, valueTypeDictionaryAdditions);
            if (!isHandled)
            {
                beforeWrite = beforeWrite && base.Write(transaction, partition, dependentParameterTypeAssignment, container);
        ...
        /// </returns>
        public virtual bool Update(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.DependentParameterTypeAssignment dependentParameterTypeAssignment, CDP4Common.DTO.Thing container = null)
        {
            bool isHandled;
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            var beforeUpdate = this.BeforeUpdate(transaction, partition, dependentParameterTypeAssignment, container, out isHandled, valueTypeDictionaryAdditions);
            if (!isHandled)
            {
                beforeUpdate = beforeUpdate && base.Update(transaction, partition, dependentParameterTypeAssignment, container);
            ...
            return this.AfterUpdate(beforeUpdate, transaction, partition, dependentParameterTypeAssignment, container);
        }

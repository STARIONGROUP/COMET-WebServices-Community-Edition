    ...
    public partial class DependentParameterTypeAssignmentDao : ThingDao, IDependentParameterTypeAssignmentDao
    {
        ...
        public virtual IEnumerable<CDP4Common.DTO.DependentParameterTypeAssignment> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false)
        {
            using (var command = new NpgsqlCommand())
            {
                ...
                {
                    sqlBuilder.AppendFormat("SELECT * FROM \"{0}\".\"DependentParameterTypeAssignment_View\"", partition);
        ...
        public virtual bool Upsert(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.DependentParameterTypeAssignment dependentParameterTypeAssignment, long sequence, CDP4Common.DTO.Thing container = null)
        {
            ...
            using (var command = new NpgsqlCommand())
            {
                ...
                sqlBuilder.AppendFormat(" DO UPDATE \"{0}\".\"DependentParameterTypeAssignment\"", partition);

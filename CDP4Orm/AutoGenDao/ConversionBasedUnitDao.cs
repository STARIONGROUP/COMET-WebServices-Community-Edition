...
namespace CDP4Orm.Dao
{
    ...
    public abstract partial class ConversionBasedUnitDao : MeasurementUnitDao
    {
        ...
        /// <summary>
        /// Build a SQL read query for the current <see cref="ConversionBasedUnitDao" />
        /// </summary>
        ...
        {
            var sqlBuilder = new StringBuilder();
            sqlBuilder.Append(" LEFT JOIN (SELECT \"ConversionBasedUnit_Audit\".\"Actor\", \"ConversionBasedUnit_Audit\".\"Iid\"");
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"ConversionBasedUnit_Audit\" AS \"ConversionBasedUnit_Audit\"", partition);
            sqlBuilder.Append(" WHERE \"ConversionBasedUnit_Audit\".\"ValidTo\" = 'infinity'");
            sqlBuilder.Append(" GROUP BY \"ConversionBasedUnit_Audit\".\"Iid\", \"ConversionBasedUnit_Audit\".\"Actor\") AS \"Actor\" USING (\"Iid\")");
            return sqlBuilder.ToString();
        }
        ...
        public override string GetValueTypeSet() => "\"Thing\".\"ValueTypeDictionary\" || \"DefinedThing\".\"ValueTypeDictionary\" || \"MeasurementUnit\".\"ValueTypeDictionary\" || \"ConversionBasedUnit\".\"ValueTypeDictionary\"";
    }
}

...
namespace CDP4Orm.Dao
{
    ...
    public partial class DateTimeParameterTypeDao : ScalarParameterTypeDao, IDateTimeParameterTypeDao
    {
        ...
        /// </returns>
        public virtual IEnumerable<CDP4Common.DTO.DateTimeParameterType> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false)
        {
        ...
        public override string BuildReadQuery(string partition)
        {
            ...
            sqlBuilder.AppendFormat(" JOIN \"{0}\".\"DateTimeParameterType_Data\"() AS \"DateTimeParameterType\" USING (\"Iid\")", partition);

// --------------------------------------------------------------------------------------------------------------------
// <copyright file="CompoundParameterTypeDao.cs" company="Starion Group S.A.">
...
namespace CDP4Orm.Dao
{
    ...
    /// <summary>
    /// The CompoundParameterType Data Access Object which acts as an ORM layer to the SQL database.
    /// </summary>
    public partial class CompoundParameterTypeDao : ParameterTypeDao, ICompoundParameterTypeDao
    {
        /// <summary>
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having a list of instances of <see cref="CDP4Common.DTO.CompoundParameterType"/> as result.
        /// </returns>
        public virtual async Task<IEnumerable<CDP4Common.DTO.CompoundParameterType>> ReadAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false, DateTime? instant = null)
        {
            var result = new List<CompoundParameterType>();
            ...
            await using (var command = new NpgsqlCommand())
            {
                ...
                if (isCachedDtoReadEnabledAndInstant)
                {
                    ...
                    await using (var reader = await command.ExecuteReaderAsync())
                    {
                        while (await reader.ReadAsync())
                        {
                            ...
                            if (thing != null)
                            {
                                result.Add(thing as CompoundParameterType);
                            }
                        }
                    }
                }
                else
                {
                    ...
                    sqlBuilder.AppendFormat(" WHERE {0} -> 'ClassKind' = 'CompoundParameterType'", this.GetValueTypeSet());
        ...
        /// </param>
        /// <returns>
        /// A deserialized instance of <see cref="CDP4Common.DTO.CompoundParameterType"/>.
        /// </returns>
        public virtual CDP4Common.DTO.CompoundParameterType MapToDto(NpgsqlDataReader reader)
        {
        ...
        /// </returns>
        public virtual async Task<bool> WriteAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.CompoundParameterType compoundParameterType, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            var beforeWriteResult = await this.BeforeWriteAsync(transaction, partition, compoundParameterType, container, valueTypeDictionaryAdditions);
            ...
            if (!isHandled)
            {
                beforeWrite = beforeWrite && await base.WriteAsync(transaction, partition, compoundParameterType, container);
            ...
            return await this.AfterWriteAsync(beforeWrite, transaction, partition, compoundParameterType, container);
        }
        ...
        /// An awaitable <see cref="Task"/> having True if the concept was successfully persisted as result.
        /// </returns>
        public virtual async Task<bool> UpsertAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.CompoundParameterType compoundParameterType, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            await base.UpsertAsync(transaction, partition, compoundParameterType, container);
        ...
        /// </param>
        /// <param name="compoundParameterType">
        /// The CompoundParameterType DTO that is to be updated.
        /// </param>
        /// <param name="container">
        ...
        /// </returns>
        public virtual async Task<bool> UpdateAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.CompoundParameterType compoundParameterType, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            var beforeUpdateResult = await this.BeforeUpdateAsync(transaction, partition, compoundParameterType, container, valueTypeDictionaryAdditions);
            ...
            if (!isHandled)
            {
                beforeUpdate = beforeUpdate && await base.UpdateAsync(transaction, partition, compoundParameterType, container);
            ...
            return await this.AfterUpdateAsync(beforeUpdate, transaction, partition, compoundParameterType, container);
        }
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="CDP4Common.DTO.CompoundParameterType"/> id that is to be deleted.
        /// </param>
        /// <returns>
        ...
        /// <summary>
        /// Build a SQL read query for the current <see cref="CompoundParameterTypeDao" />
        /// </summary>
        ...
        {
            var sqlBuilder = new StringBuilder();
            sqlBuilder.Append(" LEFT JOIN (SELECT \"CompoundParameterType_Audit\".\"Actor\", \"CompoundParameterType_Audit\".\"Iid\"");
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"CompoundParameterType_Audit\" AS \"CompoundParameterType_Audit\"", partition);
            sqlBuilder.Append(" WHERE \"CompoundParameterType_Audit\".\"ValidTo\" = 'infinity'");
            sqlBuilder.Append(" GROUP BY \"CompoundParameterType_Audit\".\"Iid\", \"CompoundParameterType_Audit\".\"Actor\") AS \"Actor\" USING (\"Iid\")");
            return sqlBuilder.ToString();
        }
        ...
        public override string GetValueTypeSet() => "\"Thing\".\"ValueTypeDictionary\" || \"DefinedThing\".\"ValueTypeDictionary\" || \"ParameterType\".\"ValueTypeDictionary\" || \"CompoundParameterType\".\"ValueTypeDictionary\"";

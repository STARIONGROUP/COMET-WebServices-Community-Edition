// --------------------------------------------------------------------------------------------------------------------
// <copyright file="NoteDao.cs" company="RHEA System S.A.">
...
namespace CDP4Orm.Dao
{
    ...
    public abstract partial class NoteDao : ThingDao
    {
        ...
        /// <summary>
        /// Build a SQL read query for the current <see cref="NoteDao" />
        /// </summary>
        ...
        public override string BuildReadQuery(string partition)
        {
            ...
            sqlBuilder.Append(" \"Note\".\"Sequence\",");
        ...
        {
            var sqlBuilder = new StringBuilder();
            sqlBuilder.Append(" LEFT JOIN (SELECT \"Note_Audit\".\"Actor\", \"Note_Audit\".\"Iid\"");
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"Note_Audit\" AS \"Note_Audit\"", partition);
            sqlBuilder.Append(" WHERE \"Note_Audit\".\"ValidTo\" = 'infinity'");
            sqlBuilder.Append(" GROUP BY \"Note_Audit\".\"Iid\", \"Note_Audit\".\"Actor\") AS \"Actor\" USING (\"Iid\")");
            return sqlBuilder.ToString();
        }
        ...
        public override string GetValueTypeSet() => "\"Thing\".\"ValueTypeDictionary\" || \"Note\".\"ValueTypeDictionary\"";
    }
}

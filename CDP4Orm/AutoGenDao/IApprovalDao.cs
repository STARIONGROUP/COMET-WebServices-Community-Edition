...
namespace CDP4Orm.Dao
{
    ...
    public partial interface IApprovalDao : IDao
    {
        ...
        /// </returns>
        IEnumerable<CDP4Common.DTO.Approval> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false);

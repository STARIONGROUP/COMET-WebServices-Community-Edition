...
namespace CDP4Orm.Dao
{
    ...
    public partial interface IPersonRoleDao : IDao
    {
        ...
        /// </returns>
        IEnumerable<CDP4Common.DTO.PersonRole> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false);

...
namespace CDP4Orm.Dao
{
    ...
    public partial class OptionDao : DefinedThingDao, IOptionDao
    {
        ...
        public override string BuildReadQuery(string partition)
        {
            ...
            sqlBuilder.AppendFormat(" JOIN \"{0}\".\"Option_Data\"() AS \"Option\" USING (\"Iid\")", partition);
            ...
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"Option_Category_Data\"() AS \"Option_Category\"", partition);
            sqlBuilder.AppendFormat(" JOIN \"{0}\".\"Option_Data\"() AS \"Option\" ON \"Option\" = \"Iid\"", partition);
            ...
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"NestedElement_Data\"() AS \"NestedElement\"", partition);
            sqlBuilder.AppendFormat(" JOIN \"{0}\".\"Option_Data\"() AS \"Option\" ON \"NestedElement\".\"Container\" = \"Option\".\"Iid\"", partition);

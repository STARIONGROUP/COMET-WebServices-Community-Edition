...
namespace CDP4Orm.Dao
{
    ...
    public partial interface IPossibleFiniteStateListDao : IDao
    {
        ...
        /// </returns>
        IEnumerable<CDP4Common.DTO.PossibleFiniteStateList> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false);

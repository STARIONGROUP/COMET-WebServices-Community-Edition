...
namespace CDP4Orm.Dao
{
    ...
    public partial class ParticipantDao : ThingDao, IParticipantDao
    {
        ...
        public override string BuildReadQuery(string partition)
        {
            ...
            sqlBuilder.AppendFormat(" JOIN \"{0}\".\"Participant_Data\"() AS \"Participant\" USING (\"Iid\")", partition);
            ...
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"Participant_Domain_Data\"() AS \"Participant_Domain\"", partition);
            sqlBuilder.AppendFormat(" JOIN \"{0}\".\"Participant_Data\"() AS \"Participant\" ON \"Participant\" = \"Iid\"", partition);

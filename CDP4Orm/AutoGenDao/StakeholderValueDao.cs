...
namespace CDP4Orm.Dao
{
    ...
    public partial class StakeholderValueDao : DefinedThingDao, IStakeholderValueDao
    {
        ...
        public override string BuildReadQuery(string partition)
        {
            ...
            sqlBuilder.AppendFormat(" JOIN \"{0}\".\"StakeholderValue_Data\"() AS \"StakeholderValue\" USING (\"Iid\")", partition);
            ...
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"StakeholderValue_Category_Data\"() AS \"StakeholderValue_Category\"", partition);
            sqlBuilder.AppendFormat(" JOIN \"{0}\".\"StakeholderValue_Data\"() AS \"StakeholderValue\" ON \"StakeholderValue\" = \"Iid\"", partition);

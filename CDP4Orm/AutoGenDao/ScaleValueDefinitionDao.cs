// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ScaleValueDefinitionDao.cs" company="Starion Group S.A.">
...
namespace CDP4Orm.Dao
{
    ...
    /// <summary>
    /// The ScaleValueDefinition Data Access Object which acts as an ORM layer to the SQL database.
    /// </summary>
    public partial class ScaleValueDefinitionDao : DefinedThingDao, IScaleValueDefinitionDao
    {
        /// <summary>
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having a list of instances of <see cref="CDP4Common.DTO.ScaleValueDefinition"/> as result.
        /// </returns>
        public virtual async Task<IEnumerable<CDP4Common.DTO.ScaleValueDefinition>> ReadAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false, DateTime? instant = null)
        {
            var result = new List<ScaleValueDefinition>();
            ...
            await using (var command = new NpgsqlCommand())
            {
                ...
                {
                    sqlBuilder.AppendFormat("SELECT \"Jsonb\", \"Actor\" FROM \"{0}\".\"ScaleValueDefinition_Cache\"", partition);
                    ...
                    await using (var reader = await command.ExecuteReaderAsync())
                    {
                        while (await reader.ReadAsync())
                        {
                            ...
                            if (thing != null)
                            {
                                result.Add(thing as ScaleValueDefinition);
                            }
                        }
                    }
                }
        ...
        /// </param>
        /// <returns>
        /// A deserialized instance of <see cref="CDP4Common.DTO.ScaleValueDefinition"/>.
        /// </returns>
        public virtual CDP4Common.DTO.ScaleValueDefinition MapToDto(NpgsqlDataReader reader)
        {
            ...
            var dto = new CDP4Common.DTO.ScaleValueDefinition(iid, revisionNumber);
        ...
        /// The scaleValueDefinition DTO that is to be persisted.
        /// </param>
        ...
        /// </returns>
        public virtual async Task<bool> WriteAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.ScaleValueDefinition scaleValueDefinition, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            var beforeWriteResult = await this.BeforeWriteAsync(transaction, partition, scaleValueDefinition, container, valueTypeDictionaryAdditions);
            ...
            if (!isHandled)
            {
                beforeWrite = beforeWrite && await base.WriteAsync(transaction, partition, scaleValueDefinition, container);

                var valueTypeDictionaryContents = new Dictionary<string, string>
                {
                    { "Value", !this.IsDerived(scaleValueDefinition, "Value") ? scaleValueDefinition.Value.Escape() : string.Empty },
                ...
                await using (var command = new NpgsqlCommand())
                {
                    ...
                    sqlBuilder.AppendFormat("INSERT INTO \"{0}\".\"ScaleValueDefinition\"", partition);
            ...
            return await this.AfterWriteAsync(beforeWrite, transaction, partition, scaleValueDefinition, container);
        }
        ...
        /// An awaitable <see cref="Task"/> having True if the concept was successfully persisted as result.
        /// </returns>
        public virtual async Task<bool> UpsertAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.ScaleValueDefinition scaleValueDefinition, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            await base.UpsertAsync(transaction, partition, scaleValueDefinition, container);
        ...
        /// </param>
        /// <param name="scaleValueDefinition">
        /// The ScaleValueDefinition DTO that is to be updated.
        /// </param>
        /// <param name="container">
        ...
        /// </returns>
        public virtual async Task<bool> UpdateAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.ScaleValueDefinition scaleValueDefinition, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            var beforeUpdateResult = await this.BeforeUpdateAsync(transaction, partition, scaleValueDefinition, container, valueTypeDictionaryAdditions);
            ...
            if (!isHandled)
            {
                beforeUpdate = beforeUpdate && await base.UpdateAsync(transaction, partition, scaleValueDefinition, container);
            ...
            return await this.AfterUpdateAsync(beforeUpdate, transaction, partition, scaleValueDefinition, container);
        }
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="CDP4Common.DTO.ScaleValueDefinition"/> id that is to be deleted.
        /// </param>
        /// <returns>
        ...
        /// <summary>
        /// Build a SQL read query for the current <see cref="ScaleValueDefinitionDao" />
        /// </summary>
        ...
        public override string BuildReadQuery(string partition, DateTime? instant)
        {
            ...
            sqlBuilder.Append(" \"ScaleValueDefinition\".\"Container\",");
            ...
            sqlBuilder.AppendFormat(" JOIN ({0}) AS \"ScaleValueDefinition\" USING (\"Iid\")", this.GetScaleValueDefinitionDataSql(partition, instant));
        ...
        {
            var sqlBuilder = new StringBuilder();
            sqlBuilder.Append(" LEFT JOIN (SELECT \"ScaleValueDefinition_Audit\".\"Actor\", \"ScaleValueDefinition_Audit\".\"Iid\"");
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"ScaleValueDefinition_Audit\" AS \"ScaleValueDefinition_Audit\"", partition);
            sqlBuilder.Append(" WHERE \"ScaleValueDefinition_Audit\".\"ValidTo\" = 'infinity'");
            sqlBuilder.Append(" GROUP BY \"ScaleValueDefinition_Audit\".\"Iid\", \"ScaleValueDefinition_Audit\".\"Actor\") AS \"Actor\" USING (\"Iid\")");
            return sqlBuilder.ToString();
        }
        ...
        public override string GetValueTypeSet() => "\"Thing\".\"ValueTypeDictionary\" || \"DefinedThing\".\"ValueTypeDictionary\" || \"ScaleValueDefinition\".\"ValueTypeDictionary\"";

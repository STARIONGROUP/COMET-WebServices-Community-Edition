    ...
    public partial class IterationSetupDao : ThingDao, IIterationSetupDao
    {
        ...
        public virtual async Task<IEnumerable<CDP4Common.DTO.IterationSetup>> ReadAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false, DateTime? instant = null)
        {
            ...
            await using (var command = new NpgsqlCommand())
            {
                ...
                {
                    sqlBuilder.AppendFormat("SELECT \"Jsonb\", \"Actor\" FROM \"{0}\".\"IterationSetup_Cache\"", partition);
        ...
        public virtual async Task<bool> UpsertAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.IterationSetup iterationSetup, CDP4Common.DTO.Thing container = null)
        {
            ...
            await using (var command = new NpgsqlCommand())
            {
                ...
                sqlBuilder.Append(" SET (\"ValueTypeDictionary\", \"Container\", \"SourceIterationSetup\")");
        ...
        /// <summary>
        /// Build a SQL read query for the current <see cref="IterationSetupDao" />
        /// </summary>
        ...
        public override string BuildReadQuery(string partition, DateTime? instant)
        {
            ...
            sqlBuilder.Append(" \"IterationSetup\".\"Container\",");

            sqlBuilder.Append(" NULL::bigint AS \"Sequence\",");

            sqlBuilder.Append(" \"Actor\",");

            sqlBuilder.Append(" \"IterationSetup\".\"SourceIterationSetup\",");
            sqlBuilder.Append(" COALESCE(\"Thing_ExcludedDomain\".\"ExcludedDomain\",'{}'::text[]) AS \"ExcludedDomain\",");
            sqlBuilder.Append(" COALESCE(\"Thing_ExcludedPerson\".\"ExcludedPerson\",'{}'::text[]) AS \"ExcludedPerson\",");

            sqlBuilder.Remove(sqlBuilder.Length - 1, 1);
            sqlBuilder.AppendFormat(" FROM ({0}) AS \"Thing\"", this.GetThingDataSql(partition, instant));
            sqlBuilder.AppendFormat(" JOIN ({0}) AS \"IterationSetup\" USING (\"Iid\")", this.GetIterationSetupDataSql(partition, instant));
        ...
        {
            var sqlBuilder = new StringBuilder();
            sqlBuilder.Append(" LEFT JOIN (SELECT \"IterationSetup_Audit\".\"Actor\", \"IterationSetup_Audit\".\"Iid\"");
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"IterationSetup_Audit\" AS \"IterationSetup_Audit\"", partition);
            sqlBuilder.Append(" WHERE \"IterationSetup_Audit\".\"ValidTo\" = 'infinity'");
            sqlBuilder.Append(" GROUP BY \"IterationSetup_Audit\".\"Iid\", \"IterationSetup_Audit\".\"Actor\") AS \"Actor\" USING (\"Iid\")");
            return sqlBuilder.ToString();
        }
        ...
        public override string GetValueTypeSet() => "\"Thing\".\"ValueTypeDictionary\" || \"IterationSetup\".\"ValueTypeDictionary\"";

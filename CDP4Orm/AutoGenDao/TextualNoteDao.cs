...
namespace CDP4Orm.Dao
{
    ...
    public partial class TextualNoteDao : NoteDao, ITextualNoteDao
    {
        ...
        /// </returns>
        public virtual IEnumerable<CDP4Common.DTO.TextualNote> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false, DateTime? instant = null)
        {
        ...
        /// True if the concept was successfully persisted.
        /// </returns>
        public virtual bool Upsert(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.TextualNote textualNote, long sequence, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            base.Upsert(transaction, partition, textualNote, sequence, container);

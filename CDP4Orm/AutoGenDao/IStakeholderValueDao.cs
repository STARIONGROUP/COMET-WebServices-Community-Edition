...
namespace CDP4Orm.Dao
{
    ...
    public partial interface IStakeholderValueDao : IDao
    {
        ...
        /// </returns>
        IEnumerable<CDP4Common.DTO.StakeholderValue> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false);

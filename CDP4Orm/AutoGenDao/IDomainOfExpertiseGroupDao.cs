...
namespace CDP4Orm.Dao
{
    ...
    public partial interface IDomainOfExpertiseGroupDao : IDao
    {
        ...
        /// </returns>
        IEnumerable<CDP4Common.DTO.DomainOfExpertiseGroup> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false);

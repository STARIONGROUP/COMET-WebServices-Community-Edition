...
namespace CDP4Orm.Dao
{
    ...
    public partial class QuantityKindFactorDao : ThingDao, IQuantityKindFactorDao
    {
        ...
        /// </returns>
        public virtual IEnumerable<CDP4Common.DTO.QuantityKindFactor> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false, DateTime? instant = null)
        {
        ...
        /// True if the concept was successfully persisted.
        /// </returns>
        public virtual bool Upsert(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.QuantityKindFactor quantityKindFactor, long sequence, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            base.Upsert(transaction, partition, quantityKindFactor, container);

// --------------------------------------------------------------------------------------------------------------------
// <copyright file="DerivedQuantityKindDao.cs" company="Starion Group S.A.">
...
namespace CDP4Orm.Dao
{
    ...
    /// <summary>
    /// The DerivedQuantityKind Data Access Object which acts as an ORM layer to the SQL database.
    /// </summary>
    public partial class DerivedQuantityKindDao : QuantityKindDao, IDerivedQuantityKindDao
    {
        /// <summary>
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having a list of instances of <see cref="CDP4Common.DTO.DerivedQuantityKind"/> as result.
        /// </returns>
        public virtual async Task<IEnumerable<CDP4Common.DTO.DerivedQuantityKind>> ReadAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false, DateTime? instant = null)
        {
            var result = new List<DerivedQuantityKind>();
                ...
                if (isCachedDtoReadEnabledAndInstant)
                {
                    ...
                    await using (var reader = await command.ExecuteReaderAsync())
                    {
                        while (await reader.ReadAsync())
                        {
                            ...
                            if (thing != null)
                            {
                                result.Add(thing as DerivedQuantityKind);
                            }
                        }
                    }
                }
        ...
        /// </param>
        /// <returns>
        /// A deserialized instance of <see cref="CDP4Common.DTO.DerivedQuantityKind"/>.
        /// </returns>
        public virtual CDP4Common.DTO.DerivedQuantityKind MapToDto(NpgsqlDataReader reader)
        {
            ...
            var dto = new CDP4Common.DTO.DerivedQuantityKind(iid, revisionNumber);
            ...
            dto.QuantityKindFactor.AddRange(Utils.ParseOrderedList<Guid>(reader["QuantityKindFactor"] as string[,]));
        ...
        /// </returns>
        public virtual async Task<bool> WriteAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.DerivedQuantityKind derivedQuantityKind, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            var beforeWriteResult = await this.BeforeWriteAsync(transaction, partition, derivedQuantityKind, container, valueTypeDictionaryAdditions);
            ...
            if (!isHandled)
            {
                beforeWrite = beforeWrite && await base.WriteAsync(transaction, partition, derivedQuantityKind, container);
            ...
            return await this.AfterWriteAsync(beforeWrite, transaction, partition, derivedQuantityKind, container);
        }
        ...
        /// An awaitable <see cref="Task"/> having True if the concept was successfully persisted as result.
        /// </returns>
        public virtual async Task<bool> UpsertAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.DerivedQuantityKind derivedQuantityKind, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            await base.UpsertAsync(transaction, partition, derivedQuantityKind, container);
        ...
        /// </param>
        /// <param name="derivedQuantityKind">
        /// The DerivedQuantityKind DTO that is to be updated.
        /// </param>
        /// <param name="container">
        ...
        /// </returns>
        public virtual async Task<bool> UpdateAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.DerivedQuantityKind derivedQuantityKind, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            var beforeUpdateResult = await this.BeforeUpdateAsync(transaction, partition, derivedQuantityKind, container, valueTypeDictionaryAdditions);
            ...
            if (!isHandled)
            {
                beforeUpdate = beforeUpdate && await base.UpdateAsync(transaction, partition, derivedQuantityKind, container);
            }

            return await this.AfterUpdateAsync(beforeUpdate, transaction, partition, derivedQuantityKind, container);
        }
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="CDP4Common.DTO.DerivedQuantityKind"/> id that is to be deleted.
        /// </param>
        /// <returns>
        ...
        /// <summary>
        /// Build a SQL read query for the current <see cref="DerivedQuantityKindDao" />
        /// </summary>
        ...
        public override string BuildReadQuery(string partition, DateTime? instant)
        {
            ...
            sqlBuilder.Append(" COALESCE(\"DerivedQuantityKind_QuantityKindFactor\".\"QuantityKindFactor\",'{}'::text[]) AS \"QuantityKindFactor\",");
            ...
            sqlBuilder.AppendFormat(" JOIN ({0}) AS \"QuantityKind\" USING (\"Iid\")", this.GetQuantityKindDataSql(partition, instant));
            sqlBuilder.AppendFormat(" JOIN ({0}) AS \"DerivedQuantityKind\" USING (\"Iid\")", this.GetDerivedQuantityKindDataSql(partition, instant));
            ...
            sqlBuilder.AppendFormat(" FROM ({0}) AS \"QuantityKind_PossibleScale\"", this.GetQuantityKind_PossibleScaleDataSql(partition, instant));
            sqlBuilder.AppendFormat(" JOIN ({0}) AS \"QuantityKind\" ON \"QuantityKind\" = \"Iid\"", this.GetQuantityKindDataSql(partition, instant));
            sqlBuilder.Append(" GROUP BY \"QuantityKind\") AS \"QuantityKind_PossibleScale\" USING (\"Iid\")");

            sqlBuilder.Append(" LEFT JOIN (SELECT \"QuantityKindFactor\".\"Container\" AS \"Iid\", ARRAY[array_agg(\"QuantityKindFactor\".\"Sequence\"::text), array_agg(\"QuantityKindFactor\".\"Iid\"::text)] AS \"QuantityKindFactor\"");
            sqlBuilder.AppendFormat(" FROM ({0}) AS \"QuantityKindFactor\"", this.GetQuantityKindFactorDataSql(partition, instant));
            sqlBuilder.AppendFormat(" JOIN ({0}) AS \"DerivedQuantityKind\" ON \"QuantityKindFactor\".\"Container\" = \"DerivedQuantityKind\".\"Iid\"", this.GetDerivedQuantityKindDataSql(partition, instant));
            sqlBuilder.Append(" GROUP BY \"QuantityKindFactor\".\"Container\") AS \"DerivedQuantityKind_QuantityKindFactor\" USING (\"Iid\")");
        ...
        {
            var sqlBuilder = new StringBuilder();
            sqlBuilder.Append(" LEFT JOIN (SELECT \"DerivedQuantityKind_Audit\".\"Actor\", \"DerivedQuantityKind_Audit\".\"Iid\"");
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"DerivedQuantityKind_Audit\" AS \"DerivedQuantityKind_Audit\"", partition);
            sqlBuilder.Append(" WHERE \"DerivedQuantityKind_Audit\".\"ValidTo\" = 'infinity'");
            sqlBuilder.Append(" GROUP BY \"DerivedQuantityKind_Audit\".\"Iid\", \"DerivedQuantityKind_Audit\".\"Actor\") AS \"Actor\" USING (\"Iid\")");
            return sqlBuilder.ToString();
        }
        ...
        public override string GetValueTypeSet() => "\"Thing\".\"ValueTypeDictionary\" || \"DefinedThing\".\"ValueTypeDictionary\" || \"ParameterType\".\"ValueTypeDictionary\" || \"ScalarParameterType\".\"ValueTypeDictionary\" || \"QuantityKind\".\"ValueTypeDictionary\" || \"DerivedQuantityKind\".\"ValueTypeDictionary\"";
        ...
        /// </param>
        /// <returns>The DataSql string</returns>
        private string GetDerivedQuantityKindDataSql(string partition, DateTime? instant)
        {
            var sqlBuilder = new StringBuilder();

            var fields = " \"Iid\", \"ValueTypeDictionary\",\"ValidFrom\",\"ValidTo\"";
            sqlBuilder.AppendFormat(" SELECT {0}", fields);
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"DerivedQuantityKind\"", partition);
            ...
            if (instant.HasValue && instant.Value != DateTime.MaxValue)
            {
                ...
                sqlBuilder.Append(" UNION ALL");
                sqlBuilder.AppendFormat(" SELECT {0}", fields);
                sqlBuilder.AppendFormat(" FROM \"{0}\".\"DerivedQuantityKind_Audit\"", partition);
                sqlBuilder.Append(" WHERE \"Action\" <> 'I'");
                sqlBuilder.Append(" AND \"ValidFrom\" < :instant");
                sqlBuilder.Append(" AND \"ValidTo\" >= :instant");
            }
        ...
        /// </param>
        /// <returns>The DataSql string</returns>
        private string GetQuantityKindFactorDataSql(string partition, DateTime? instant)
        {
            var sqlBuilder = new StringBuilder();

            var fields = " \"Iid\", \"ValueTypeDictionary\", \"Sequence\", \"Container\", \"QuantityKind\",\"ValidFrom\",\"ValidTo\"";
            sqlBuilder.AppendFormat(" SELECT {0}", fields);
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"QuantityKindFactor\"", partition);
            ...
            if (instant.HasValue && instant.Value != DateTime.MaxValue)
            {
                ...
                sqlBuilder.Append(" UNION ALL");
                sqlBuilder.AppendFormat(" SELECT {0}", fields);
                sqlBuilder.AppendFormat(" FROM \"{0}\".\"QuantityKindFactor_Audit\"", partition);
                sqlBuilder.Append(" WHERE \"Action\" <> 'I'");
                sqlBuilder.Append(" AND \"ValidFrom\" < :instant");
                sqlBuilder.Append(" AND \"ValidTo\" >= :instant");
            }

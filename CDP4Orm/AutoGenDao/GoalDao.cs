...
namespace CDP4Orm.Dao
{
    ...
    public partial class GoalDao : DefinedThingDao, IGoalDao
    {
        ...
        /// </returns>
        public virtual IEnumerable<CDP4Common.DTO.Goal> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false)
        {
        ...
        public override string BuildReadQuery(string partition)
        {
            ...
            sqlBuilder.AppendFormat(" JOIN \"{0}\".\"Goal_Data\"() AS \"Goal\" USING (\"Iid\")", partition);
            ...
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"Goal_Category_Data\"() AS \"Goal_Category\"", partition);
            sqlBuilder.AppendFormat(" JOIN \"{0}\".\"Goal_Data\"() AS \"Goal\" ON \"Goal\" = \"Iid\"", partition);

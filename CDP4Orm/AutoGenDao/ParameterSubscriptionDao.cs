// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ParameterSubscriptionDao.cs" company="Starion Group S.A.">
...
namespace CDP4Orm.Dao
{
    ...
    /// <summary>
    /// The ParameterSubscription Data Access Object which acts as an ORM layer to the SQL database.
    /// </summary>
    public partial class ParameterSubscriptionDao : ParameterBaseDao, IParameterSubscriptionDao
    {
        /// <summary>
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having a list of instances of <see cref="CDP4Common.DTO.ParameterSubscription"/> as result.
        /// </returns>
        public virtual async Task<IEnumerable<CDP4Common.DTO.ParameterSubscription>> ReadAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false, DateTime? instant = null)
        {
            var result = new List<ParameterSubscription>();
            ...
            await using (var command = new NpgsqlCommand())
            {
                ...
                {
                    sqlBuilder.AppendFormat("SELECT \"Jsonb\", \"Actor\" FROM \"{0}\".\"ParameterSubscription_Cache\"", partition);
                    ...
                    await using (var reader = await command.ExecuteReaderAsync())
                    {
                        while (await reader.ReadAsync())
                        {
                            ...
                            if (thing != null)
                            {
                                result.Add(thing as ParameterSubscription);
                            }
                        }
                    }
                }
        ...
        /// </returns>
        public virtual async Task<bool> WriteAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.ParameterSubscription parameterSubscription, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            var beforeWriteResult = await this.BeforeWriteAsync(transaction, partition, parameterSubscription, container, valueTypeDictionaryAdditions);
            ...
            if (!isHandled)
            {
                beforeWrite = beforeWrite && await base.WriteAsync(transaction, partition, parameterSubscription, container);
            ...
            return await this.AfterWriteAsync(beforeWrite, transaction, partition, parameterSubscription, container);
        }
        ...
        /// An awaitable <see cref="Task"/> having True if the concept was successfully persisted as result.
        /// </returns>
        public virtual async Task<bool> UpsertAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.ParameterSubscription parameterSubscription, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            await base.UpsertAsync(transaction, partition, parameterSubscription, container);
        ...
        /// </returns>
        public virtual async Task<bool> UpdateAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.ParameterSubscription parameterSubscription, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            var beforeUpdateResult = await this.BeforeUpdateAsync(transaction, partition, parameterSubscription, container, valueTypeDictionaryAdditions);
            ...
            if (!isHandled)
            {
                beforeUpdate = beforeUpdate && await base.UpdateAsync(transaction, partition, parameterSubscription, container);
            ...
            return await this.AfterUpdateAsync(beforeUpdate, transaction, partition, parameterSubscription, container);
        }
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="CDP4Common.DTO.ParameterSubscription"/> id that is to be deleted.
        /// </param>
        /// <returns>
        ...
        /// <summary>
        /// Build a SQL read query for the current <see cref="ParameterSubscriptionDao" />
        /// </summary>
        ...
        public override string BuildReadQuery(string partition, DateTime? instant)
        {
            ...
            sqlBuilder.Append(" \"ParameterSubscription\".\"Container\",");
            ...
            sqlBuilder.Append(" COALESCE(\"ParameterSubscription_ValueSet\".\"ValueSet\",'{}'::text[]) AS \"ValueSet\",");
            ...
            sqlBuilder.AppendFormat(" JOIN ({0}) AS \"ParameterSubscription\" USING (\"Iid\")", this.GetParameterSubscriptionDataSql(partition, instant));
            ...
            sqlBuilder.Append(" LEFT JOIN (SELECT \"ParameterSubscriptionValueSet\".\"Container\" AS \"Iid\", array_agg(\"ParameterSubscriptionValueSet\".\"Iid\"::text) AS \"ValueSet\"");
            sqlBuilder.AppendFormat(" FROM ({0}) AS \"ParameterSubscriptionValueSet\"", this.GetParameterSubscriptionValueSetDataSql(partition, instant));
            sqlBuilder.AppendFormat(" JOIN ({0}) AS \"ParameterSubscription\" ON \"ParameterSubscriptionValueSet\".\"Container\" = \"ParameterSubscription\".\"Iid\"", this.GetParameterSubscriptionDataSql(partition, instant));
            sqlBuilder.Append(" GROUP BY \"ParameterSubscriptionValueSet\".\"Container\") AS \"ParameterSubscription_ValueSet\" USING (\"Iid\")");
        ...
        {
            var sqlBuilder = new StringBuilder();
            sqlBuilder.Append(" LEFT JOIN (SELECT \"ParameterSubscription_Audit\".\"Actor\", \"ParameterSubscription_Audit\".\"Iid\"");
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"ParameterSubscription_Audit\" AS \"ParameterSubscription_Audit\"", partition);
            sqlBuilder.Append(" WHERE \"ParameterSubscription_Audit\".\"ValidTo\" = 'infinity'");
            sqlBuilder.Append(" GROUP BY \"ParameterSubscription_Audit\".\"Iid\", \"ParameterSubscription_Audit\".\"Actor\") AS \"Actor\" USING (\"Iid\")");
            return sqlBuilder.ToString();
        }
        ...
        public override string GetValueTypeSet() => "\"Thing\".\"ValueTypeDictionary\" || \"ParameterBase\".\"ValueTypeDictionary\" || \"ParameterSubscription\".\"ValueTypeDictionary\"";
        ...
        /// </param>
        /// <returns>The DataSql string</returns>
        private string GetParameterSubscriptionValueSetDataSql(string partition, DateTime? instant)
        {
            var sqlBuilder = new StringBuilder();

            var fields = " \"Iid\", \"ValueTypeDictionary\", \"Container\", \"SubscribedValueSet\",\"ValidFrom\",\"ValidTo\"";
            sqlBuilder.AppendFormat(" SELECT {0}", fields);
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"ParameterSubscriptionValueSet\"", partition);
            ...
            if (instant.HasValue && instant.Value != DateTime.MaxValue)
            {
                ...
                sqlBuilder.Append(" UNION ALL");
                sqlBuilder.AppendFormat(" SELECT {0}", fields);
                sqlBuilder.AppendFormat(" FROM \"{0}\".\"ParameterSubscriptionValueSet_Audit\"", partition);
                sqlBuilder.Append(" WHERE \"Action\" <> 'I'");
                sqlBuilder.Append(" AND \"ValidFrom\" < :instant");
                sqlBuilder.Append(" AND \"ValidTo\" >= :instant");
            }

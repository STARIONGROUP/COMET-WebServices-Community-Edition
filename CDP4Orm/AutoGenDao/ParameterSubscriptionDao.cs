...
namespace CDP4Orm.Dao
{
    ...
    public partial class ParameterSubscriptionDao : ParameterBaseDao, IParameterSubscriptionDao
    {
        ...
        /// </returns>
        public virtual IEnumerable<CDP4Common.DTO.ParameterSubscription> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false)
        {
            using (var command = new NpgsqlCommand())
            {
                ...
                {
                    sqlBuilder.AppendFormat("SELECT * FROM \"{0}\".\"ParameterSubscription_View\"", partition);
        ...
        public virtual bool Upsert(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.ParameterSubscription parameterSubscription, CDP4Common.DTO.Thing container = null)
        {
            ...
            using (var command = new NpgsqlCommand())
            {
                ...
                sqlBuilder.AppendFormat(" DO UPDATE \"{0}\".\"ParameterSubscription\"", partition);

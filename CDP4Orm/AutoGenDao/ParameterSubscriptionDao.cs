...
namespace CDP4Orm.Dao
{
    ...
    public partial class ParameterSubscriptionDao : ParameterBaseDao, IParameterSubscriptionDao
    {
        ...
        public override string BuildReadQuery(string partition)
        {
            ...
            sqlBuilder.AppendFormat(" JOIN \"{0}\".\"ParameterSubscription_Data\"() AS \"ParameterSubscription\" USING (\"Iid\")", partition);
            ...
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"ParameterSubscriptionValueSet_Data\"() AS \"ParameterSubscriptionValueSet\"", partition);
            sqlBuilder.AppendFormat(" JOIN \"{0}\".\"ParameterSubscription_Data\"() AS \"ParameterSubscription\" ON \"ParameterSubscriptionValueSet\".\"Container\" = \"ParameterSubscription\".\"Iid\"", partition);

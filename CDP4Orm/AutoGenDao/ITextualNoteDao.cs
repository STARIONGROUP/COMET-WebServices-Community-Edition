...
namespace CDP4Orm.Dao
{
    ...
    public partial interface ITextualNoteDao : IDao
    {
        ...
        /// </returns>
        IEnumerable<CDP4Common.DTO.TextualNote> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false);

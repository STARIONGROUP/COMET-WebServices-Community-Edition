...
namespace CDP4Orm.Dao
{
    ...
    public partial class ModelLogEntryDao : ThingDao, IModelLogEntryDao
    {
        ...
        /// True if the concept was successfully persisted.
        /// </returns>
        public virtual bool Upsert(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.ModelLogEntry modelLogEntry, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            base.Upsert(transaction, partition, modelLogEntry, container);
            ...
            modelLogEntry.AffectedItemIid.ForEach(x => this.UpsertAffectedItemIid(transaction, partition, modelLogEntry.Iid, x));
            modelLogEntry.Category.ForEach(x => this.UpsertCategory(transaction, partition, modelLogEntry.Iid, x));

...
namespace CDP4Orm.Dao
{
    ...
    public partial class DiagramCanvasDao : DiagramElementContainerDao, IDiagramCanvasDao
    {
        ...
        /// </returns>
        public virtual IEnumerable<CDP4Common.DTO.DiagramCanvas> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false, DateTime? instant = null)
        {
            using (var command = new NpgsqlCommand())
            {
                ...
                else
                {
                    ...
                    sqlBuilder.AppendFormat(" WHERE {0} -> 'ClassKind' = 'DiagramCanvas'", this.GetValueTypeSet());

...
namespace CDP4Orm.Dao
{
    ...
    public partial interface IFileRevisionDao : IDao
    {
        ...
        /// </returns>
        IEnumerable<CDP4Common.DTO.FileRevision> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false);

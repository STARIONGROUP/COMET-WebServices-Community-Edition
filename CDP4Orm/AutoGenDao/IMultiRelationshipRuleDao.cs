...
namespace CDP4Orm.Dao
{
    ...
    public partial interface IMultiRelationshipRuleDao : IDao
    {
        ...
        /// </returns>
        IEnumerable<CDP4Common.DTO.MultiRelationshipRule> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false);

...
namespace CDP4Orm.Dao
{
    ...
    public partial interface IEngineeringModelDao : IDao
    {
        ...
        /// </returns>
        Task<IEnumerable<CDP4Common.DTO.EngineeringModel>> ReadAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false, DateTime? instant = null);
        ...
        /// </returns>
        Task<bool> WriteAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.EngineeringModel engineeringModel, CDP4Common.DTO.Thing container = null);
        ...
        /// An awaitable <see cref="Task"/> having True if the concept was successfully persisted as result.
        /// </returns>
        Task<bool> UpsertAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.EngineeringModel engineeringModel, CDP4Common.DTO.Thing container = null);
        ...
        /// An awaitable <see cref="Task"/> having True if the concept was successfully persisted as result.
        /// </returns>
        Task<bool> UpdateAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.EngineeringModel engineeringModel, CDP4Common.DTO.Thing container = null);
        ...
        /// </returns>
        Task CopyEngineeringModelAsync(NpgsqlTransaction transaction, string sourcePartition, string targetPartition);
        ...
        /// An awaitable <see cref="Task"/>.
        /// </returns>
        Task CopyEngineeringModelAndResetCreatedOnAsync(NpgsqlTransaction transaction, string sourcePartition, string targetPartition);
    }
}

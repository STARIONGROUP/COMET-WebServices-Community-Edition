...
namespace CDP4Orm.Dao
{
    ...
    public partial interface IEngineeringModelDao : IDao
    {
        ...
        /// </returns>
        IEnumerable<CDP4Common.DTO.EngineeringModel> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false);

...
namespace CDP4Orm.Dao
{
    ...
    public partial interface IParameterSubscriptionValueSetDao : IDao
    {
        ...
        /// </returns>
        IEnumerable<CDP4Common.DTO.ParameterSubscriptionValueSet> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false, DateTime? instant = null);
        ...
        /// </returns>
        bool Update(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.ParameterSubscriptionValueSet parameterSubscriptionValueSet, CDP4Common.DTO.Thing container = null);

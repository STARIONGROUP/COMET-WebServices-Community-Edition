...
namespace CDP4Orm.Dao
{
    ...
    public partial interface IParameterSubscriptionValueSetDao : IDao
    {
        ...
        /// </returns>
        IEnumerable<CDP4Common.DTO.ParameterSubscriptionValueSet> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false);

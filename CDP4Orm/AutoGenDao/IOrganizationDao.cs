// --------------------------------------------------------------------------------------------------------------------
// <copyright file="IOrganizationDao.cs" company="RHEA System S.A.">
...
namespace CDP4Orm.Dao
{
    ...
    public partial interface IOrganizationDao : IDao
    {
        ...
        /// </returns>
        IEnumerable<CDP4Common.DTO.Organization> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false, DateTime? instant = null);
        ...
        /// </returns>
        bool Update(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.Organization organization, CDP4Common.DTO.Thing container = null);

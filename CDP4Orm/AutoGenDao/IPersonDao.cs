...
namespace CDP4Orm.Dao
{
    ...
    public partial interface IPersonDao : IDao
    {
        ...
        /// </returns>
        IEnumerable<CDP4Common.DTO.Person> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false);

// --------------------------------------------------------------------------------------------------------------------
// <copyright file="NestedElementDao.cs" company="Starion Group S.A.">
...
namespace CDP4Orm.Dao
{
    ...
    public partial class NestedElementDao : ThingDao, INestedElementDao
    {
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having a list of instances of <see cref="CDP4Common.DTO.NestedElement"/> as result.
        /// </returns>
        public virtual async Task<IEnumerable<CDP4Common.DTO.NestedElement>> ReadAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false, DateTime? instant = null)
        {
            ...
            await using (var command = new NpgsqlCommand())
            {
                ...
                {
                    sqlBuilder.AppendFormat("SELECT \"Jsonb\", \"Actor\" FROM \"{0}\".\"NestedElement_Cache\"", partition);
                    ...
                    await using (var reader = await command.ExecuteReaderAsync())
                    {
                        while (await reader.ReadAsync())
                        {
                            ...
                            if (thing != null)
                            {
                                result.Add(thing as NestedElement);
                            }
                        }
                    }
                }
        ...
        /// </returns>
        public virtual async Task<bool> WriteAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.NestedElement nestedElement, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            var beforeWriteResult = await this.BeforeWriteAsync(transaction, partition, nestedElement, container, valueTypeDictionaryAdditions);
            ...
            if (!isHandled)
            {
                beforeWrite = beforeWrite && await base.WriteAsync(transaction, partition, nestedElement, container);
                ...
                foreach (var item in nestedElement.ElementUsage)
                {
                    await this.AddElementUsageAsync(transaction, partition, nestedElement.Iid, item);
                }
            }

            return await this.AfterWriteAsync(beforeWrite, transaction, partition, nestedElement, container);
        }
        ...
        /// An awaitable <see cref="Task"/> having True if the concept was successfully persisted as result.
        /// </returns>
        public virtual async Task<bool> UpsertAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.NestedElement nestedElement, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            await base.UpsertAsync(transaction, partition, nestedElement, container);
            ...
            foreach (var item in nestedElement.ElementUsage)
            {
                await this.UpsertElementUsageAsync(transaction, partition, nestedElement.Iid, item);
            }
        ...
        public override async Task<bool> AddToCollectionPropertyAsync(NpgsqlTransaction transaction, string partition, string propertyName, Guid iid, object value)
        {
            ...
            switch (propertyName)
            {
                case "ElementUsage":
                    {
                        isCreated = await this.AddElementUsageAsync(transaction, partition, iid, (CDP4Common.Types.OrderedItem)value);
                        break;
                    }
        ...
        /// An awaitable <see cref="Task"/> having True if the value link was successfully created as result.
        /// </returns>
        public async Task<bool> AddElementUsageAsync(NpgsqlTransaction transaction, string partition, Guid iid, CDP4Common.Types.OrderedItem elementUsage)
        {
            await using (var command = new NpgsqlCommand())
            {
                var sqlBuilder = new System.Text.StringBuilder();
        ...
        /// An awaitable <see cref="Task"/> having True if the value link was successfully created as result.
        /// </returns>
        public async Task<bool> UpsertElementUsageAsync(NpgsqlTransaction transaction, string partition, Guid iid, CDP4Common.Types.OrderedItem elementUsage)
        {
            await using (var command = new NpgsqlCommand())
            {
                var sqlBuilder = new System.Text.StringBuilder();
        ...
        /// </returns>
        public virtual async Task<bool> UpdateAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.NestedElement nestedElement, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            var beforeUpdateResult = await this.BeforeUpdateAsync(transaction, partition, nestedElement, container, valueTypeDictionaryAdditions);
            ...
            if (!isHandled)
            {
                beforeUpdate = beforeUpdate && await base.UpdateAsync(transaction, partition, nestedElement, container);
            ...
            return await this.AfterUpdateAsync(beforeUpdate, transaction, partition, nestedElement, container);
        }
        ...
        public override async Task<bool> ReorderCollectionPropertyAsync(NpgsqlTransaction transaction, string partition, string propertyName, Guid iid, CDP4Common.Types.OrderedItem orderUpdate)
        {
            ...
            switch (propertyName)
            {
                case "ElementUsage":
                    {
                        isReordered = await this.ReorderElementUsageAsync(transaction, partition, iid, orderUpdate);
                        break;
                    }
        ...
        /// An awaitable <see cref="Task"/> having True if the value link was successfully reordered as result.
        /// </returns>
        public async Task<bool> ReorderElementUsageAsync(NpgsqlTransaction transaction, string partition, Guid iid, CDP4Common.Types.OrderedItem elementUsage)
        {
            await using (var command = new NpgsqlCommand())
            {
                var sqlBuilder = new System.Text.StringBuilder();
        ...
        public override async Task<bool> DeleteFromCollectionPropertyAsync(NpgsqlTransaction transaction, string partition, string propertyName, Guid iid, object value)
        {
            ...
            switch (propertyName)
            {
                case "ElementUsage":
                    {
                        isDeleted = await this.DeleteElementUsageAsync(transaction, partition, iid, (CDP4Common.Types.OrderedItem)value);
                        break;
                    }
        ...
        /// </returns>
        public async Task<bool> DeleteElementUsageAsync(NpgsqlTransaction transaction, string partition, Guid iid, CDP4Common.Types.OrderedItem elementUsage)
        {
            await using (var command = new NpgsqlCommand())
            {
                var sqlBuilder = new System.Text.StringBuilder();
        ...
        /// <summary>
        /// Build a SQL read query for the current <see cref="NestedElementDao" />
        /// </summary>
        ...
        public override string BuildReadQuery(string partition, DateTime? instant)
        {
            ...
            sqlBuilder.Append(" \"NestedElement\".\"Container\",");

            sqlBuilder.Append(" NULL::bigint AS \"Sequence\",");

            sqlBuilder.Append(" \"Actor\",");

            sqlBuilder.Append(" \"NestedElement\".\"RootElement\",");
            sqlBuilder.Append(" COALESCE(\"Thing_ExcludedDomain\".\"ExcludedDomain\",'{}'::text[]) AS \"ExcludedDomain\",");
            sqlBuilder.Append(" COALESCE(\"Thing_ExcludedPerson\".\"ExcludedPerson\",'{}'::text[]) AS \"ExcludedPerson\",");
            sqlBuilder.Append(" COALESCE(\"NestedElement_ElementUsage\".\"ElementUsage\",'{}'::text[]) AS \"ElementUsage\",");
            sqlBuilder.Append(" COALESCE(\"NestedElement_NestedParameter\".\"NestedParameter\",'{}'::text[]) AS \"NestedParameter\",");

            sqlBuilder.Remove(sqlBuilder.Length - 1, 1);
            sqlBuilder.AppendFormat(" FROM ({0}) AS \"Thing\"", this.GetThingDataSql(partition, instant));
            sqlBuilder.AppendFormat(" JOIN ({0}) AS \"NestedElement\" USING (\"Iid\")", this.GetNestedElementDataSql(partition, instant));
            ...
            sqlBuilder.AppendFormat(" FROM ({0}) AS \"NestedElement_ElementUsage\"", this.GetNestedElement_ElementUsageDataSql(partition, instant));
            sqlBuilder.AppendFormat(" JOIN ({0}) AS \"NestedElement\" ON \"NestedElement\" = \"Iid\"", this.GetNestedElementDataSql(partition, instant));
            sqlBuilder.Append(" GROUP BY \"NestedElement\") AS \"NestedElement_ElementUsage\" USING (\"Iid\")");

            sqlBuilder.Append(" LEFT JOIN (SELECT \"NestedParameter\".\"Container\" AS \"Iid\", array_agg(\"NestedParameter\".\"Iid\"::text) AS \"NestedParameter\"");
            sqlBuilder.AppendFormat(" FROM ({0}) AS \"NestedParameter\"", this.GetNestedParameterDataSql(partition, instant));
            sqlBuilder.AppendFormat(" JOIN ({0}) AS \"NestedElement\" ON \"NestedParameter\".\"Container\" = \"NestedElement\".\"Iid\"", this.GetNestedElementDataSql(partition, instant));
            sqlBuilder.Append(" GROUP BY \"NestedParameter\".\"Container\") AS \"NestedElement_NestedParameter\" USING (\"Iid\")");
        ...
        {
            var sqlBuilder = new StringBuilder();
            sqlBuilder.Append(" LEFT JOIN (SELECT \"NestedElement_Audit\".\"Actor\", \"NestedElement_Audit\".\"Iid\"");
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"NestedElement_Audit\" AS \"NestedElement_Audit\"", partition);
            sqlBuilder.Append(" WHERE \"NestedElement_Audit\".\"ValidTo\" = 'infinity'");
            sqlBuilder.Append(" GROUP BY \"NestedElement_Audit\".\"Iid\", \"NestedElement_Audit\".\"Actor\") AS \"Actor\" USING (\"Iid\")");
            return sqlBuilder.ToString();
        }
        ...
        public override string GetValueTypeSet() => "\"Thing\".\"ValueTypeDictionary\" || \"NestedElement\".\"ValueTypeDictionary\"";
        ...
        /// </param>
        /// <returns>The DataSql string</returns>
        private string GetNestedElementDataSql(string partition, DateTime? instant)
        {
            var sqlBuilder = new StringBuilder();

            var fields = " \"Iid\", \"ValueTypeDictionary\", \"Container\", \"RootElement\",\"ValidFrom\",\"ValidTo\"";
            sqlBuilder.AppendFormat(" SELECT {0}", fields);
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"NestedElement\"", partition);
            ...
            if (instant.HasValue && instant.Value != DateTime.MaxValue)
            {
                ...
                sqlBuilder.Append(" UNION ALL");
                sqlBuilder.AppendFormat(" SELECT {0}", fields);
                sqlBuilder.AppendFormat(" FROM \"{0}\".\"NestedElement_Audit\"", partition);
                sqlBuilder.Append(" WHERE \"Action\" <> 'I'");
                sqlBuilder.Append(" AND \"ValidFrom\" < :instant");
                sqlBuilder.Append(" AND \"ValidTo\" >= :instant");
            }
        ...
        /// </param>
        /// <returns>The DataSql string</returns>
        private string GetNestedElement_ElementUsageDataSql(string partition, DateTime? instant)
        {
            var sqlBuilder = new StringBuilder();

            var fields = "\"NestedElement\",\"ElementUsage\",\"ValidFrom\",\"ValidTo\"";

            fields += ", \"Sequence\"";
            sqlBuilder.AppendFormat(" SELECT {0}", fields);
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"NestedElement_ElementUsage\"", partition);
            ...
            if (instant.HasValue && instant.Value != DateTime.MaxValue)
            {
                ...
                sqlBuilder.Append(" UNION ALL");
                sqlBuilder.AppendFormat(" SELECT {0}", fields);
                sqlBuilder.AppendFormat(" FROM \"{0}\".\"NestedElement_ElementUsage_Audit\"", partition);
                sqlBuilder.Append(" WHERE \"Action\" <> 'I'");
                sqlBuilder.Append(" AND \"ValidFrom\" < :instant");
                sqlBuilder.Append(" AND \"ValidTo\" >= :instant");
            }
        ...
        /// </param>
        /// <returns>The DataSql string</returns>
        private string GetNestedParameterDataSql(string partition, DateTime? instant)
        {
            var sqlBuilder = new StringBuilder();

            var fields = " \"Iid\", \"ValueTypeDictionary\", \"Container\", \"ActualState\", \"AssociatedParameter\", \"Owner\",\"ValidFrom\",\"ValidTo\"";
            sqlBuilder.AppendFormat(" SELECT {0}", fields);
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"NestedParameter\"", partition);
            ...
            if (instant.HasValue && instant.Value != DateTime.MaxValue)
            {
                ...
                sqlBuilder.Append(" UNION ALL");
                sqlBuilder.AppendFormat(" SELECT {0}", fields);
                sqlBuilder.AppendFormat(" FROM \"{0}\".\"NestedParameter_Audit\"", partition);
                sqlBuilder.Append(" WHERE \"Action\" <> 'I'");
                sqlBuilder.Append(" AND \"ValidFrom\" < :instant");
                sqlBuilder.Append(" AND \"ValidTo\" >= :instant");
            }

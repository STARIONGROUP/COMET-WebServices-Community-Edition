...
namespace CDP4Orm.Dao
{
    ...
    public partial class NestedElementDao : ThingDao, INestedElementDao
    {
        ...
        public override string BuildReadQuery(string partition)
        {
            ...
            sqlBuilder.AppendFormat(" JOIN \"{0}\".\"NestedElement_Data\"() AS \"NestedElement\" USING (\"Iid\")", partition);
            ...
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"NestedParameter_Data\"() AS \"NestedParameter\"", partition);
            sqlBuilder.AppendFormat(" JOIN \"{0}\".\"NestedElement_Data\"() AS \"NestedElement\" ON \"NestedParameter\".\"Container\" = \"NestedElement\".\"Iid\"", partition);

...
namespace CDP4Orm.Dao
{
    ...
    public partial interface IDiagramObjectDao : IDao
    {
        ...
        /// </returns>
        IEnumerable<CDP4Common.DTO.DiagramObject> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false);

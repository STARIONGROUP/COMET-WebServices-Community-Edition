...
namespace CDP4Orm.Dao
{
    ...
    public partial class DerivedUnitDao : MeasurementUnitDao, IDerivedUnitDao
    {
        ...
        /// </returns>
        public virtual IEnumerable<CDP4Common.DTO.DerivedUnit> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false)
        {
        ...
        public override string BuildReadQuery(string partition)
        {
            ...
            sqlBuilder.AppendFormat(" JOIN \"{0}\".\"DerivedUnit_Data\"() AS \"DerivedUnit\" USING (\"Iid\")", partition);
            ...
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"UnitFactor_Data\"() AS \"UnitFactor\"", partition);
            sqlBuilder.AppendFormat(" JOIN \"{0}\".\"DerivedUnit_Data\"() AS \"DerivedUnit\" ON \"UnitFactor\".\"Container\" = \"DerivedUnit\".\"Iid\"", partition);

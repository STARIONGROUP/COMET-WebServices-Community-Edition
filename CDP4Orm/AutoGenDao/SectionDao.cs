...
namespace CDP4Orm.Dao
{
    ...
    public partial class SectionDao : ThingDao, ISectionDao
    {
        ...
        /// </returns>
        public virtual IEnumerable<CDP4Common.DTO.Section> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false)
        {
        ...
        public override string BuildReadQuery(string partition)
        {
            ...
            sqlBuilder.AppendFormat(" JOIN \"{0}\".\"Section_Data\"() AS \"Section\" USING (\"Iid\")", partition);
            ...
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"Section_Category_Data\"() AS \"Section_Category\"", partition);
            sqlBuilder.AppendFormat(" JOIN \"{0}\".\"Section_Data\"() AS \"Section\" ON \"Section\" = \"Iid\"", partition);
            ...
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"Page_Data\"() AS \"Page\"", partition);
            sqlBuilder.AppendFormat(" JOIN \"{0}\".\"Section_Data\"() AS \"Section\" ON \"Page\".\"Container\" = \"Section\".\"Iid\"", partition);

    ...
    public partial class SectionDao : ThingDao, ISectionDao
    {
        ...
        public virtual IEnumerable<CDP4Common.DTO.Section> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false)
        {
            using (var command = new NpgsqlCommand())
            {
                ...
                {
                    sqlBuilder.AppendFormat("SELECT * FROM \"{0}\".\"Section_View\"", partition);
        ...
        public virtual bool Upsert(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.Section section, long sequence, CDP4Common.DTO.Thing container = null)
        {
            ...
            using (var command = new NpgsqlCommand())
            {
                ...
                sqlBuilder.AppendFormat(" DO UPDATE \"{0}\".\"Section\"", partition);
        ...
        public bool UpsertCategory(NpgsqlTransaction transaction, string partition, Guid iid, Guid category)
        {
            using (var command = new NpgsqlCommand())
            {
                ...
                sqlBuilder.AppendFormat(" DO UPDATE \"{0}\".\"Section_Category\"", partition);
                sqlBuilder.AppendFormat(" SET (\"Section\", \"Category\")");

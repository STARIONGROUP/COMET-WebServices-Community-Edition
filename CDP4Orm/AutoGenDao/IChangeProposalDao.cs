...
namespace CDP4Orm.Dao
{
    ...
    public partial interface IChangeProposalDao : IDao
    {
        ...
        /// </returns>
        IEnumerable<CDP4Common.DTO.ChangeProposal> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false);

...
namespace CDP4Orm.Dao
{
    ...
    public partial interface IContractChangeNoticeDao : IDao
    {
        ...
        /// </returns>
        IEnumerable<CDP4Common.DTO.ContractChangeNotice> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false);

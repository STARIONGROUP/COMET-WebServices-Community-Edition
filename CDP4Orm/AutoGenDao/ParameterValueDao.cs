...
namespace CDP4Orm.Dao
{
    ...
    public abstract partial class ParameterValueDao : ThingDao
    {
        ...
        /// True if the concept was successfully persisted.
        /// </returns>
        public virtual bool Upsert(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.ParameterValue parameterValue, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            base.Upsert(transaction, partition, parameterValue, container);
        ...
        /// <summary>
        /// Build a SQL read query for the current <see cref="ParameterValueDao" />
        /// </summary>
        ...
        {
            var sqlBuilder = new StringBuilder();
            sqlBuilder.Append(" LEFT JOIN (SELECT \"ParameterValue_Audit\".\"Actor\", \"ParameterValue_Audit\".\"Iid\"");
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"ParameterValue_Audit\" AS \"ParameterValue_Audit\"", partition);
            sqlBuilder.Append(" WHERE \"ParameterValue_Audit\".\"ValidTo\" = 'infinity'");
            sqlBuilder.Append(" GROUP BY \"ParameterValue_Audit\".\"Iid\", \"ParameterValue_Audit\".\"Actor\") AS \"Actor\" USING (\"Iid\")");
            return sqlBuilder.ToString();
        }
        ...
        public override string GetValueTypeSet() => "\"Thing\".\"ValueTypeDictionary\" || \"ParameterValue\".\"ValueTypeDictionary\"";
    }
}

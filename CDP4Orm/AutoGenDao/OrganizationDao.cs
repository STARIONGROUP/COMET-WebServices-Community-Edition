...
namespace CDP4Orm.Dao
{
    ...
    /// <summary>
    /// The Organization Data Access Object which acts as an ORM layer to the SQL database.
    /// </summary>
    public partial class OrganizationDao : ThingDao, IOrganizationDao
    {
        /// <summary>
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having a list of instances of <see cref="CDP4Common.DTO.Organization"/> as result.
        /// </returns>
        public virtual async Task<IEnumerable<CDP4Common.DTO.Organization>> ReadAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false, DateTime? instant = null)
        {
            ...
            await using (var command = new NpgsqlCommand())
            {
                ...
                {
                    sqlBuilder.AppendFormat("SELECT \"Jsonb\", \"Actor\" FROM \"{0}\".\"Organization_Cache\"", partition);
                    ...
                    await using (var reader = await command.ExecuteReaderAsync())
                    {
                        while (await reader.ReadAsync())
                        {
                            ...
                            if (thing != null)
                            {
                                result.Add(thing as Organization);
                            }
                        }
                    }
                }
        ...
        /// </param>
        /// <returns>
        /// A deserialized instance of <see cref="CDP4Common.DTO.Organization"/>.
        /// </returns>
        public virtual CDP4Common.DTO.Organization MapToDto(NpgsqlDataReader reader)
        {
            ...
            var dto = new CDP4Common.DTO.Organization(iid, revisionNumber);
        ...
        /// The organization DTO that is to be persisted.
        /// </param>
        ...
        /// </returns>
        public virtual async Task<bool> WriteAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.Organization organization, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            var beforeWriteResult = await this.BeforeWriteAsync(transaction, partition, organization, container, valueTypeDictionaryAdditions);
            ...
            if (!isHandled)
            {
                beforeWrite = beforeWrite && await base.WriteAsync(transaction, partition, organization, container);

                var valueTypeDictionaryContents = new Dictionary<string, string>
                {
                    { "IsDeprecated", !this.IsDerived(organization, "IsDeprecated") ? organization.IsDeprecated.ToString() : string.Empty },
                    { "Name", !this.IsDerived(organization, "Name") ? organization.Name.Escape() : string.Empty },
                    { "ShortName", !this.IsDerived(organization, "ShortName") ? organization.ShortName.Escape() : string.Empty },
                ...
                await using (var command = new NpgsqlCommand())
                {
                    ...
                    sqlBuilder.AppendFormat("INSERT INTO \"{0}\".\"Organization\"", partition);
            ...
            return await this.AfterWriteAsync(beforeWrite, transaction, partition, organization, container);
        }
        ...
        /// An awaitable <see cref="Task"/> having True if the concept was successfully persisted as result.
        /// </returns>
        public virtual async Task<bool> UpsertAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.Organization organization, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            await base.UpsertAsync(transaction, partition, organization, container);
        ...
        /// </param>
        /// <param name="organization">
        /// The Organization DTO that is to be updated.
        /// </param>
        /// <param name="container">
        ...
        /// </returns>
        public virtual async Task<bool> UpdateAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.Organization organization, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            var beforeUpdateResult = await this.BeforeUpdateAsync(transaction, partition, organization, container, valueTypeDictionaryAdditions);
            ...
            if (!isHandled)
            {
                beforeUpdate = beforeUpdate && await base.UpdateAsync(transaction, partition, organization, container);
            ...
            return await this.AfterUpdateAsync(beforeUpdate, transaction, partition, organization, container);
        }
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="CDP4Common.DTO.Organization"/> id that is to be deleted.
        /// </param>
        /// <returns>
        ...
        /// <summary>
        /// Build a SQL read query for the current <see cref="OrganizationDao" />
        /// </summary>
        ...
        public override string BuildReadQuery(string partition, DateTime? instant)
        {
            ...
            sqlBuilder.Append(" \"Organization\".\"Container\",");
            ...
            sqlBuilder.AppendFormat(" JOIN ({0}) AS \"Organization\" USING (\"Iid\")", this.GetOrganizationDataSql(partition, instant));
        ...
        {
            var sqlBuilder = new StringBuilder();
            sqlBuilder.Append(" LEFT JOIN (SELECT \"Organization_Audit\".\"Actor\", \"Organization_Audit\".\"Iid\"");
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"Organization_Audit\" AS \"Organization_Audit\"", partition);
            sqlBuilder.Append(" WHERE \"Organization_Audit\".\"ValidTo\" = 'infinity'");
            sqlBuilder.Append(" GROUP BY \"Organization_Audit\".\"Iid\", \"Organization_Audit\".\"Actor\") AS \"Actor\" USING (\"Iid\")");
            return sqlBuilder.ToString();
        }
        ...
        public override string GetValueTypeSet() => "\"Thing\".\"ValueTypeDictionary\" || \"Organization\".\"ValueTypeDictionary\"";

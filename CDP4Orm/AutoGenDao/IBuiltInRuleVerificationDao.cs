...
namespace CDP4Orm.Dao
{
    ...
    public partial interface IBuiltInRuleVerificationDao : IDao
    {
        ...
        /// </returns>
        IEnumerable<CDP4Common.DTO.BuiltInRuleVerification> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false);

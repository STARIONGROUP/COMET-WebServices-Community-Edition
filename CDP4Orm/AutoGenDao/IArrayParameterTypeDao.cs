// --------------------------------------------------------------------------------------------------------------------
// <copyright file="IArrayParameterTypeDao.cs" company="Starion Group S.A.">
...
namespace CDP4Orm.Dao
{
    ...
    /// <summary>
    /// The ArrayParameterType Service Interface which uses the ORM layer to interact with the data model.
    /// </summary>
    public partial interface IArrayParameterTypeDao : IDao
    {
        /// <summary>
        ...
        /// </returns>
        Task<IEnumerable<CDP4Common.DTO.ArrayParameterType>> ReadAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false, DateTime? instant = null);
        ...
        /// The <see cref="CDP4Common.DTO.ArrayParameterType"/> that is to be persisted.
        /// </param> 
        ...
        /// </returns>
        Task<bool> WriteAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.ArrayParameterType arrayParameterType, CDP4Common.DTO.Thing container = null);
        ...
        /// An awaitable <see cref="Task"/> having True if the concept was successfully persisted as result.
        /// </returns>
        Task<bool> UpsertAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.ArrayParameterType arrayParameterType, CDP4Common.DTO.Thing container = null);
        ...
        /// </param>
        /// <param name="arrayParameterType">
        /// The <see cref="CDP4Common.DTO.ArrayParameterType"/> that is to be updated.
        /// </param>
        /// <param name="container">
        ...
        /// An awaitable <see cref="Task"/> having True if the concept was successfully persisted as result.
        /// </returns>
        Task<bool> UpdateAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.ArrayParameterType arrayParameterType, CDP4Common.DTO.Thing container = null);

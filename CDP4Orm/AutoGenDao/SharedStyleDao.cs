...
namespace CDP4Orm.Dao
{
    ...
    public partial class SharedStyleDao : DiagrammingStyleDao, ISharedStyleDao
    {
        ...
        public override string BuildReadQuery(string partition)
        {
            ...
            sqlBuilder.AppendFormat(" JOIN \"{0}\".\"DiagrammingStyle_Data\"() AS \"DiagrammingStyle\" USING (\"Iid\")", partition);
            sqlBuilder.AppendFormat(" JOIN \"{0}\".\"SharedStyle_Data\"() AS \"SharedStyle\" USING (\"Iid\")", partition);
            ...
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"Color_Data\"() AS \"Color\"", partition);
            sqlBuilder.AppendFormat(" JOIN \"{0}\".\"DiagrammingStyle_Data\"() AS \"DiagrammingStyle\" ON \"Color\".\"Container\" = \"DiagrammingStyle\".\"Iid\"", partition);

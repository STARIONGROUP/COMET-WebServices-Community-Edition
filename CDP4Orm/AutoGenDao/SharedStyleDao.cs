...
namespace CDP4Orm.Dao
{
    ...
    public partial class SharedStyleDao : DiagrammingStyleDao, ISharedStyleDao
    {
        ...
        /// </returns>
        public virtual IEnumerable<CDP4Common.DTO.SharedStyle> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false, DateTime? instant = null)
        {

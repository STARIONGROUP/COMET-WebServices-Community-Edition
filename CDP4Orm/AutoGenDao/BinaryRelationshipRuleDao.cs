// --------------------------------------------------------------------------------------------------------------------
// <copyright file="BinaryRelationshipRuleDao.cs" company="Starion Group S.A.">
...
namespace CDP4Orm.Dao
{
    ...
    public partial class BinaryRelationshipRuleDao : RuleDao, IBinaryRelationshipRuleDao
    {
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having a list of instances of <see cref="CDP4Common.DTO.BinaryRelationshipRule"/> as result.
        /// </returns>
        public virtual async Task<IEnumerable<CDP4Common.DTO.BinaryRelationshipRule>> ReadAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false, DateTime? instant = null)
        {
            var result = new List<BinaryRelationshipRule>();
                ...
                if (isCachedDtoReadEnabledAndInstant)
                {
                    ...
                    await using (var reader = await command.ExecuteReaderAsync())
                    {
                        while (await reader.ReadAsync())
                        {
                            ...
                            if (thing != null)
                            {
                                result.Add(thing as BinaryRelationshipRule);
                            }
                        }
                    }
                }
        ...
        /// </returns>
        public virtual async Task<bool> WriteAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.BinaryRelationshipRule binaryRelationshipRule, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            var beforeWriteResult = await this.BeforeWriteAsync(transaction, partition, binaryRelationshipRule, container, valueTypeDictionaryAdditions);
            ...
            if (!isHandled)
            {
                beforeWrite = beforeWrite && await base.WriteAsync(transaction, partition, binaryRelationshipRule, container);
            ...
            return await this.AfterWriteAsync(beforeWrite, transaction, partition, binaryRelationshipRule, container);
        }
        ...
        /// An awaitable <see cref="Task"/> having True if the concept was successfully persisted as result.
        /// </returns>
        public virtual async Task<bool> UpsertAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.BinaryRelationshipRule binaryRelationshipRule, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            await base.UpsertAsync(transaction, partition, binaryRelationshipRule, container);
        ...
        /// </returns>
        public virtual async Task<bool> UpdateAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.BinaryRelationshipRule binaryRelationshipRule, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            var beforeUpdateResult = await this.BeforeUpdateAsync(transaction, partition, binaryRelationshipRule, container, valueTypeDictionaryAdditions);
            ...
            if (!isHandled)
            {
                beforeUpdate = beforeUpdate && await base.UpdateAsync(transaction, partition, binaryRelationshipRule, container);
            ...
            return await this.AfterUpdateAsync(beforeUpdate, transaction, partition, binaryRelationshipRule, container);
        }
        ...
        /// <summary>
        /// Build a SQL read query for the current <see cref="BinaryRelationshipRuleDao" />
        /// </summary>
        ...
        public override string BuildReadQuery(string partition, DateTime? instant)
        {
            ...
            sqlBuilder.Append(" \"BinaryRelationshipRule\".\"RelationshipCategory\",");

            sqlBuilder.Append(" \"BinaryRelationshipRule\".\"SourceCategory\",");

            sqlBuilder.Append(" \"BinaryRelationshipRule\".\"TargetCategory\",");
            ...
            sqlBuilder.AppendFormat(" JOIN ({0}) AS \"BinaryRelationshipRule\" USING (\"Iid\")", this.GetBinaryRelationshipRuleDataSql(partition, instant));
        ...
        {
            var sqlBuilder = new StringBuilder();
            sqlBuilder.Append(" LEFT JOIN (SELECT \"BinaryRelationshipRule_Audit\".\"Actor\", \"BinaryRelationshipRule_Audit\".\"Iid\"");
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"BinaryRelationshipRule_Audit\" AS \"BinaryRelationshipRule_Audit\"", partition);
            sqlBuilder.Append(" WHERE \"BinaryRelationshipRule_Audit\".\"ValidTo\" = 'infinity'");
            sqlBuilder.Append(" GROUP BY \"BinaryRelationshipRule_Audit\".\"Iid\", \"BinaryRelationshipRule_Audit\".\"Actor\") AS \"Actor\" USING (\"Iid\")");
            return sqlBuilder.ToString();
        }
        ...
        public override string GetValueTypeSet() => "\"Thing\".\"ValueTypeDictionary\" || \"DefinedThing\".\"ValueTypeDictionary\" || \"Rule\".\"ValueTypeDictionary\" || \"BinaryRelationshipRule\".\"ValueTypeDictionary\"";
        ...
        /// </param>
        /// <returns>The DataSql string</returns>
        private string GetBinaryRelationshipRuleDataSql(string partition, DateTime? instant)
        {
            var sqlBuilder = new StringBuilder();

            var fields = " \"Iid\", \"ValueTypeDictionary\", \"RelationshipCategory\", \"SourceCategory\", \"TargetCategory\",\"ValidFrom\",\"ValidTo\"";
            sqlBuilder.AppendFormat(" SELECT {0}", fields);
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"BinaryRelationshipRule\"", partition);
            ...
            if (instant.HasValue && instant.Value != DateTime.MaxValue)
            {
                ...
                sqlBuilder.Append(" UNION ALL");
                sqlBuilder.AppendFormat(" SELECT {0}", fields);
                sqlBuilder.AppendFormat(" FROM \"{0}\".\"BinaryRelationshipRule_Audit\"", partition);
                sqlBuilder.Append(" WHERE \"Action\" <> 'I'");
                sqlBuilder.Append(" AND \"ValidFrom\" < :instant");
                sqlBuilder.Append(" AND \"ValidTo\" >= :instant");
            }

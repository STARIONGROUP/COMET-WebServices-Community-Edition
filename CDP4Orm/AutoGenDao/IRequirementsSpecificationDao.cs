...
namespace CDP4Orm.Dao
{
    ...
    public partial interface IRequirementsSpecificationDao : IDao
    {
        ...
        /// </returns>
        IEnumerable<CDP4Common.DTO.RequirementsSpecification> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false);

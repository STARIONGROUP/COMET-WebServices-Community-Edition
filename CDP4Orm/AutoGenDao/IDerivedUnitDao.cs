...
namespace CDP4Orm.Dao
{
    ...
    public partial interface IDerivedUnitDao : IDao
    {
        ...
        /// </returns>
        IEnumerable<CDP4Common.DTO.DerivedUnit> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false);

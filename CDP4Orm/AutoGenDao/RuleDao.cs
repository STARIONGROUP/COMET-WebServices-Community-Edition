// --------------------------------------------------------------------------------------------------------------------
// <copyright file="RuleDao.cs" company="RHEA System S.A.">
...
namespace CDP4Orm.Dao
{
    ...
    /// <summary>
    /// The abstract Rule Data Access Object which acts as an ORM layer to the SQL database.
    /// </summary>
    public abstract partial class RuleDao : DefinedThingDao
    {
        ...
        /// </param>
        /// <param name="rule">
        /// The rule DTO that is to be persisted.
        /// </param>
        ...
        /// </returns>
        public virtual bool Write(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.Rule rule, CDP4Common.DTO.Thing container = null)
        {
            bool isHandled;
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            var beforeWrite = this.BeforeWrite(transaction, partition, rule, container, out isHandled, valueTypeDictionaryAdditions);
            if (!isHandled)
            {
                beforeWrite = beforeWrite && base.Write(transaction, partition, rule, container);

                var valueTypeDictionaryContents = new Dictionary<string, string>
                {
                    { "IsDeprecated", !this.IsDerived(rule, "IsDeprecated") ? rule.IsDeprecated.ToString() : string.Empty },
                ...
                using (var command = new NpgsqlCommand())
                {
                    ...
                    sqlBuilder.AppendFormat("INSERT INTO \"{0}\".\"Rule\"", partition);
            ...
            return this.AfterWrite(beforeWrite, transaction, partition, rule, container);
        }
        ...
        /// True if the concept was successfully persisted.
        /// </returns>
        public virtual bool Upsert(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.Rule rule, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            base.Upsert(transaction, partition, rule, container);
        ...
        /// </param>
        /// <param name="rule">
        /// The Rule DTO that is to be updated.
        /// </param>
        /// <param name="container">
        ...
        /// </returns>
        public virtual bool Update(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.Rule rule, CDP4Common.DTO.Thing container = null)
        {
            bool isHandled;
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            var beforeUpdate = this.BeforeUpdate(transaction, partition, rule, container, out isHandled, valueTypeDictionaryAdditions);
            if (!isHandled)
            {
                beforeUpdate = beforeUpdate && base.Update(transaction, partition, rule, container);
            ...
            return this.AfterUpdate(beforeUpdate, transaction, partition, rule, container);
        }
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="CDP4Common.DTO.Rule"/> id that is to be deleted.
        /// </param>
        /// <returns>
        ...
        /// <summary>
        /// Build a SQL read query for the current <see cref="RuleDao" />
        /// </summary>
        ...
        {
            var sqlBuilder = new StringBuilder();
            sqlBuilder.Append(" LEFT JOIN (SELECT \"Rule_Audit\".\"Actor\", \"Rule_Audit\".\"Iid\"");
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"Rule_Audit\" AS \"Rule_Audit\"", partition);
            sqlBuilder.Append(" WHERE \"Rule_Audit\".\"ValidTo\" = 'infinity'");
            sqlBuilder.Append(" GROUP BY \"Rule_Audit\".\"Iid\", \"Rule_Audit\".\"Actor\") AS \"Actor\" USING (\"Iid\")");
            return sqlBuilder.ToString();
        }
        ...
        public override string GetValueTypeSet() => "\"Thing\".\"ValueTypeDictionary\" || \"DefinedThing\".\"ValueTypeDictionary\" || \"Rule\".\"ValueTypeDictionary\"";
    }
}

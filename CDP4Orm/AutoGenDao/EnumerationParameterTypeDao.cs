// --------------------------------------------------------------------------------------------------------------------
// <copyright file="EnumerationParameterTypeDao.cs" company="Starion Group S.A.">
...
namespace CDP4Orm.Dao
{
    ...
    /// <summary>
    /// The EnumerationParameterType Data Access Object which acts as an ORM layer to the SQL database.
    /// </summary>
    public partial class EnumerationParameterTypeDao : ScalarParameterTypeDao, IEnumerationParameterTypeDao
    {
        /// <summary>
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having a list of instances of <see cref="CDP4Common.DTO.EnumerationParameterType"/> as result.
        /// </returns>
        public virtual async Task<IEnumerable<CDP4Common.DTO.EnumerationParameterType>> ReadAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false, DateTime? instant = null)
        {
            var result = new List<EnumerationParameterType>();
            ...
            await using (var command = new NpgsqlCommand())
            {
                ...
                {
                    sqlBuilder.AppendFormat("SELECT \"Jsonb\", \"Actor\" FROM \"{0}\".\"EnumerationParameterType_Cache\"", partition);
                    ...
                    await using (var reader = await command.ExecuteReaderAsync())
                    {
                        while (await reader.ReadAsync())
                        {
                            ...
                            if (thing != null)
                            {
                                result.Add(thing as EnumerationParameterType);
                            }
                        }
                    }
                }
        ...
        /// </param>
        /// <returns>
        /// A deserialized instance of <see cref="CDP4Common.DTO.EnumerationParameterType"/>.
        /// </returns>
        public virtual CDP4Common.DTO.EnumerationParameterType MapToDto(NpgsqlDataReader reader)
        {
            ...
            var dto = new CDP4Common.DTO.EnumerationParameterType(iid, revisionNumber);
            ...
            dto.ValueDefinition.AddRange(Utils.ParseOrderedList<Guid>(reader["ValueDefinition"] as string[,]));

            if (valueDict.TryGetValue("AllowMultiSelect", out tempAllowMultiSelect))
            {
                dto.AllowMultiSelect = bool.Parse(tempAllowMultiSelect);
            }
        ...
        /// </returns>
        public virtual async Task<bool> WriteAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.EnumerationParameterType enumerationParameterType, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            var beforeWriteResult = await this.BeforeWriteAsync(transaction, partition, enumerationParameterType, container, valueTypeDictionaryAdditions);
            ...
            if (!isHandled)
            {
                beforeWrite = beforeWrite && await base.WriteAsync(transaction, partition, enumerationParameterType, container);
            ...
            return await this.AfterWriteAsync(beforeWrite, transaction, partition, enumerationParameterType, container);
        }
        ...
        /// An awaitable <see cref="Task"/> having True if the concept was successfully persisted as result.
        /// </returns>
        public virtual async Task<bool> UpsertAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.EnumerationParameterType enumerationParameterType, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            await base.UpsertAsync(transaction, partition, enumerationParameterType, container);
        ...
        /// </param>
        /// <param name="enumerationParameterType">
        /// The EnumerationParameterType DTO that is to be updated.
        /// </param>
        /// <param name="container">
        ...
        /// </returns>
        public virtual async Task<bool> UpdateAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.EnumerationParameterType enumerationParameterType, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            var beforeUpdateResult = await this.BeforeUpdateAsync(transaction, partition, enumerationParameterType, container, valueTypeDictionaryAdditions);
            ...
            if (!isHandled)
            {
                beforeUpdate = beforeUpdate && await base.UpdateAsync(transaction, partition, enumerationParameterType, container);
            ...
            return await this.AfterUpdateAsync(beforeUpdate, transaction, partition, enumerationParameterType, container);
        }
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="CDP4Common.DTO.EnumerationParameterType"/> id that is to be deleted.
        /// </param>
        /// <returns>
        ...
        /// <summary>
        /// Build a SQL read query for the current <see cref="EnumerationParameterTypeDao" />
        /// </summary>
        ...
        public override string BuildReadQuery(string partition, DateTime? instant)
        {
            ...
            sqlBuilder.Append(" COALESCE(\"EnumerationParameterType_ValueDefinition\".\"ValueDefinition\",'{}'::text[]) AS \"ValueDefinition\",");
            ...
            sqlBuilder.AppendFormat(" JOIN ({0}) AS \"EnumerationParameterType\" USING (\"Iid\")", this.GetEnumerationParameterTypeDataSql(partition, instant));
            ...
            sqlBuilder.Append(" LEFT JOIN (SELECT \"EnumerationValueDefinition\".\"Container\" AS \"Iid\", ARRAY[array_agg(\"EnumerationValueDefinition\".\"Sequence\"::text), array_agg(\"EnumerationValueDefinition\".\"Iid\"::text)] AS \"ValueDefinition\"");
            sqlBuilder.AppendFormat(" FROM ({0}) AS \"EnumerationValueDefinition\"", this.GetEnumerationValueDefinitionDataSql(partition, instant));
            sqlBuilder.AppendFormat(" JOIN ({0}) AS \"EnumerationParameterType\" ON \"EnumerationValueDefinition\".\"Container\" = \"EnumerationParameterType\".\"Iid\"", this.GetEnumerationParameterTypeDataSql(partition, instant));
            sqlBuilder.Append(" GROUP BY \"EnumerationValueDefinition\".\"Container\") AS \"EnumerationParameterType_ValueDefinition\" USING (\"Iid\")");
        ...
        {
            var sqlBuilder = new StringBuilder();
            sqlBuilder.Append(" LEFT JOIN (SELECT \"EnumerationParameterType_Audit\".\"Actor\", \"EnumerationParameterType_Audit\".\"Iid\"");
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"EnumerationParameterType_Audit\" AS \"EnumerationParameterType_Audit\"", partition);
            sqlBuilder.Append(" WHERE \"EnumerationParameterType_Audit\".\"ValidTo\" = 'infinity'");
            sqlBuilder.Append(" GROUP BY \"EnumerationParameterType_Audit\".\"Iid\", \"EnumerationParameterType_Audit\".\"Actor\") AS \"Actor\" USING (\"Iid\")");
            return sqlBuilder.ToString();
        }
        ...
        public override string GetValueTypeSet() => "\"Thing\".\"ValueTypeDictionary\" || \"DefinedThing\".\"ValueTypeDictionary\" || \"ParameterType\".\"ValueTypeDictionary\" || \"ScalarParameterType\".\"ValueTypeDictionary\" || \"EnumerationParameterType\".\"ValueTypeDictionary\"";
        ...
        /// </param>
        /// <returns>The DataSql string</returns>
        private string GetEnumerationParameterTypeDataSql(string partition, DateTime? instant)
        {
            var sqlBuilder = new StringBuilder();

            var fields = " \"Iid\", \"ValueTypeDictionary\",\"ValidFrom\",\"ValidTo\"";
            sqlBuilder.AppendFormat(" SELECT {0}", fields);
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"EnumerationParameterType\"", partition);
            ...
            if (instant.HasValue && instant.Value != DateTime.MaxValue)
            {
                ...
                sqlBuilder.Append(" UNION ALL");
                sqlBuilder.AppendFormat(" SELECT {0}", fields);
                sqlBuilder.AppendFormat(" FROM \"{0}\".\"EnumerationParameterType_Audit\"", partition);
                sqlBuilder.Append(" WHERE \"Action\" <> 'I'");
                sqlBuilder.Append(" AND \"ValidFrom\" < :instant");
                sqlBuilder.Append(" AND \"ValidTo\" >= :instant");
            }
        ...
        /// </param>
        /// <returns>The DataSql string</returns>
        private string GetEnumerationValueDefinitionDataSql(string partition, DateTime? instant)
        {
            var sqlBuilder = new StringBuilder();

            var fields = " \"Iid\", \"ValueTypeDictionary\", \"Sequence\", \"Container\",\"ValidFrom\",\"ValidTo\"";
            sqlBuilder.AppendFormat(" SELECT {0}", fields);
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"EnumerationValueDefinition\"", partition);
            ...
            if (instant.HasValue && instant.Value != DateTime.MaxValue)
            {
                ...
                sqlBuilder.Append(" UNION ALL");
                sqlBuilder.AppendFormat(" SELECT {0}", fields);
                sqlBuilder.AppendFormat(" FROM \"{0}\".\"EnumerationValueDefinition_Audit\"", partition);
                sqlBuilder.Append(" WHERE \"Action\" <> 'I'");
                sqlBuilder.Append(" AND \"ValidFrom\" < :instant");
                sqlBuilder.Append(" AND \"ValidTo\" >= :instant");
            }

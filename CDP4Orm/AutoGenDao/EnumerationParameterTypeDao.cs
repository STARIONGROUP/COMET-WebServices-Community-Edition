...
namespace CDP4Orm.Dao
{
    ...
    public partial class EnumerationParameterTypeDao : ScalarParameterTypeDao, IEnumerationParameterTypeDao
    {
        ...
        /// </returns>
        public virtual IEnumerable<CDP4Common.DTO.EnumerationParameterType> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false)
        {
        ...
        public override string BuildReadQuery(string partition)
        {
            ...
            sqlBuilder.AppendFormat(" JOIN \"{0}\".\"EnumerationParameterType_Data\"() AS \"EnumerationParameterType\" USING (\"Iid\")", partition);
            ...
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"EnumerationValueDefinition_Data\"() AS \"EnumerationValueDefinition\"", partition);
            sqlBuilder.AppendFormat(" JOIN \"{0}\".\"EnumerationParameterType_Data\"() AS \"EnumerationParameterType\" ON \"EnumerationValueDefinition\".\"Container\" = \"EnumerationParameterType\".\"Iid\"", partition);

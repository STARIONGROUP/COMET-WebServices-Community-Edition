...
namespace CDP4Orm.Dao
{
    ...
    public partial interface IDependentParameterTypeAssignmentDao : IDao
    {
        ...
        /// </returns>
        IEnumerable<CDP4Common.DTO.DependentParameterTypeAssignment> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false, DateTime? instant = null);
        ...
        /// </returns>
        bool Update(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.DependentParameterTypeAssignment dependentParameterTypeAssignment, CDP4Common.DTO.Thing container = null);

...
namespace CDP4Orm.Dao
{
    ...
    public partial interface IDependentParameterTypeAssignmentDao : IDao
    {
        ...
        /// </returns>
        IEnumerable<CDP4Common.DTO.DependentParameterTypeAssignment> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false);

...
namespace CDP4Orm.Dao
{
    ...
    public partial interface IParticipantPermissionDao : IDao
    {
        ...
        /// </returns>
        IEnumerable<CDP4Common.DTO.ParticipantPermission> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false);

...
namespace CDP4Orm.Dao
{
    ...
    public partial interface IBinaryNoteDao : IDao
    {
        ...
        /// </returns>
        IEnumerable<CDP4Common.DTO.BinaryNote> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false);

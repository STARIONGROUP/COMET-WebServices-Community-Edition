...
namespace CDP4Orm.Dao
{
    ...
    public partial interface IModelLogEntryDao : IDao
    {
        ...
        /// </returns>
        IEnumerable<CDP4Common.DTO.ModelLogEntry> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false);

...
namespace CDP4Orm.Dao
{
    ...
    public partial interface IModelLogEntryDao : IDao
    {
        ...
        /// </returns>
        IEnumerable<CDP4Common.DTO.ModelLogEntry> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false, DateTime? instant = null);
        ...
        /// </returns>
        bool Update(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.ModelLogEntry modelLogEntry, CDP4Common.DTO.Thing container = null);

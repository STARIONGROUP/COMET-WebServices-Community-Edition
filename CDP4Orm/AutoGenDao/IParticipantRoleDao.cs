...
namespace CDP4Orm.Dao
{
    ...
    public partial interface IParticipantRoleDao : IDao
    {
        ...
        /// </returns>
        IEnumerable<CDP4Common.DTO.ParticipantRole> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false);

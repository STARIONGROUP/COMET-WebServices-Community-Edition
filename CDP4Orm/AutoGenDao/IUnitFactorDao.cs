...
namespace CDP4Orm.Dao
{
    ...
    public partial interface IUnitFactorDao : IDao
    {
        ...
        /// </returns>
        IEnumerable<CDP4Common.DTO.UnitFactor> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false, DateTime? instant = null);
        ...
        /// </returns>
        bool Write(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.UnitFactor unitFactor, long sequence, CDP4Common.DTO.Thing container = null);
        ...
        /// True if the concept was successfully persisted.
        /// </returns>
        bool Upsert(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.UnitFactor unitFactor, long sequence, CDP4Common.DTO.Thing container = null);
        ...
        /// </returns>
        bool Update(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.UnitFactor unitFactor, CDP4Common.DTO.Thing container = null);

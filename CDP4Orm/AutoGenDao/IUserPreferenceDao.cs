...
namespace CDP4Orm.Dao
{
    ...
    public partial interface IUserPreferenceDao : IDao
    {
        ...
        /// </returns>
        IEnumerable<CDP4Common.DTO.UserPreference> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false, DateTime? instant = null);
        ...
        /// True if the concept was successfully persisted.
        /// </returns>
        bool Upsert(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.UserPreference userPreference, CDP4Common.DTO.Thing container = null);
        ...
        /// </returns>
        bool Update(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.UserPreference userPreference, CDP4Common.DTO.Thing container = null);

...
namespace CDP4Orm.Dao
{
    ...
    public partial interface IUserPreferenceDao : IDao
    {
        ...
        /// </returns>
        IEnumerable<CDP4Common.DTO.UserPreference> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false);

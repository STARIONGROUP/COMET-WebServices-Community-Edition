// --------------------------------------------------------------------------------------------------------------------
// <copyright file="HyperLinkDao.cs" company="Starion Group S.A.">
...
namespace CDP4Orm.Dao
{
    ...
    /// <summary>
    /// The HyperLink Data Access Object which acts as an ORM layer to the SQL database.
    /// </summary>
    [ExcludeFromCodeCoverage]
    public partial class HyperLinkDao : ThingDao, IHyperLinkDao
    {
        /// <summary>
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having a list of instances of <see cref="CDP4Common.DTO.HyperLink"/> as result.
        /// </returns>
        public virtual async Task<IEnumerable<CDP4Common.DTO.HyperLink>> ReadAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false, DateTime? instant = null)
        {
            ...
            await using (var command = new NpgsqlCommand())
            {
                ...
                {
                    sqlBuilder.AppendFormat("SELECT \"Jsonb\", \"Actor\" FROM \"{0}\".\"HyperLink_Cache\"", partition);
        ...
        /// </param>
        /// <returns>
        /// A deserialized instance of <see cref="CDP4Common.DTO.HyperLink"/>.
        /// </returns>
        public virtual CDP4Common.DTO.HyperLink MapToDto(NpgsqlDataReader reader)
        {
            string tempContent;
            ...
            var dto = new CDP4Common.DTO.HyperLink(iid, revisionNumber);
        ...
        /// </returns>
        public virtual async Task<bool> WriteAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.HyperLink hyperLink, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            var beforeWriteResult = await this.BeforeWriteAsync(transaction, partition, hyperLink, container, valueTypeDictionaryAdditions);
            ...
            if (!isHandled)
            {
                beforeWrite = beforeWrite && await base.WriteAsync(transaction, partition, hyperLink, container);
            ...
            return await this.AfterWriteAsync(beforeWrite, transaction, partition, hyperLink, container);
        }
        ...
        /// An awaitable <see cref="Task"/> having True if the concept was successfully persisted as result.
        /// </returns>
        public virtual async Task<bool> UpsertAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.HyperLink hyperLink, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            await base.UpsertAsync(transaction, partition, hyperLink, container);
        ...
        /// </param>
        /// <param name="hyperLink">
        /// The HyperLink DTO that is to be updated.
        /// </param>
        /// <param name="container">
        ...
        /// </returns>
        public virtual async Task<bool> UpdateAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.HyperLink hyperLink, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            var beforeUpdateResult = await this.BeforeUpdateAsync(transaction, partition, hyperLink, container, valueTypeDictionaryAdditions);
            ...
            if (!isHandled)
            {
                beforeUpdate = beforeUpdate && await base.UpdateAsync(transaction, partition, hyperLink, container);
            ...
            return await this.AfterUpdateAsync(beforeUpdate, transaction, partition, hyperLink, container);
        }
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="CDP4Common.DTO.HyperLink"/> id that is to be deleted.
        /// </param>
        /// <returns>
        ...
        /// <summary>
        /// Build a SQL read query for the current <see cref="HyperLinkDao" />
        /// </summary>
        ...
        public override string BuildReadQuery(string partition, DateTime? instant)
        {
            ...
            sqlBuilder.Append(" \"HyperLink\".\"Container\",");
            ...
            sqlBuilder.AppendFormat(" JOIN ({0}) AS \"HyperLink\" USING (\"Iid\")", this.GetHyperLinkDataSql(partition, instant));
        ...
        {
            var sqlBuilder = new StringBuilder();
            sqlBuilder.Append(" LEFT JOIN (SELECT \"HyperLink_Audit\".\"Actor\", \"HyperLink_Audit\".\"Iid\"");
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"HyperLink_Audit\" AS \"HyperLink_Audit\"", partition);
            sqlBuilder.Append(" WHERE \"HyperLink_Audit\".\"ValidTo\" = 'infinity'");
            sqlBuilder.Append(" GROUP BY \"HyperLink_Audit\".\"Iid\", \"HyperLink_Audit\".\"Actor\") AS \"Actor\" USING (\"Iid\")");
            return sqlBuilder.ToString();
        }
        ...
        public override string GetValueTypeSet() => "\"Thing\".\"ValueTypeDictionary\" || \"HyperLink\".\"ValueTypeDictionary\"";

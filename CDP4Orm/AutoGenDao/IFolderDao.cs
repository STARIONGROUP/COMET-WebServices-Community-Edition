...
namespace CDP4Orm.Dao
{
    ...
    public partial interface IFolderDao : IDao
    {
        ...
        /// </returns>
        IEnumerable<CDP4Common.DTO.Folder> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false);

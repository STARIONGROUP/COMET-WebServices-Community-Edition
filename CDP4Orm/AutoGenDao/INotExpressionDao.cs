...
namespace CDP4Orm.Dao
{
    ...
    public partial interface INotExpressionDao : IDao
    {
        ...
        /// </returns>
        IEnumerable<CDP4Common.DTO.NotExpression> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false);

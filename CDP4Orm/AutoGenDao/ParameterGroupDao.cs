// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ParameterGroupDao.cs" company="RHEA System S.A.">
...
namespace CDP4Orm.Dao
{
    ...
    public partial class ParameterGroupDao : ThingDao, IParameterGroupDao
    {
        ...
        /// </returns>
        public virtual IEnumerable<CDP4Common.DTO.ParameterGroup> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false)
        {
            using (var command = new NpgsqlCommand())
            {
                ...
                {
                    sqlBuilder.AppendFormat("SELECT \"Jsonb\" FROM \"{0}\".\"ParameterGroup_Cache\"", partition);
                ...
                {
                    sqlBuilder.AppendFormat("SELECT * FROM \"{0}\".\"ParameterGroup_View\"", partition);
        ...
        public virtual bool Update(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.ParameterGroup parameterGroup, CDP4Common.DTO.Thing container = null)
        {
            ...
            if (!isHandled)
            {
                ...
                using (var command = new NpgsqlCommand())
                {
                    ...
                    sqlBuilder.AppendFormat(" SET (\"Container\", \"ContainingGroup\", \"ValueTypeDictionary\")");
                    sqlBuilder.AppendFormat(" = (:container, :containingGroup, \"ValueTypeDictionary\" || :valueTypeDictionary)");

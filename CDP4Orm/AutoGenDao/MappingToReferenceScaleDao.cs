// --------------------------------------------------------------------------------------------------------------------
// <copyright file="MappingToReferenceScaleDao.cs" company="Starion Group S.A.">
...
namespace CDP4Orm.Dao
{
    ...
    public partial class MappingToReferenceScaleDao : ThingDao, IMappingToReferenceScaleDao
    {
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having a list of instances of <see cref="CDP4Common.DTO.MappingToReferenceScale"/> as result.
        /// </returns>
        public virtual async Task<IEnumerable<CDP4Common.DTO.MappingToReferenceScale>> ReadAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false, DateTime? instant = null)
        {
            var result = new List<MappingToReferenceScale>();
            ...
            await using (var command = new NpgsqlCommand())
            {
                ...
                {
                    sqlBuilder.AppendFormat("SELECT \"Jsonb\", \"Actor\" FROM \"{0}\".\"MappingToReferenceScale_Cache\"", partition);
                    ...
                    await using (var reader = await command.ExecuteReaderAsync())
                    {
                        while (await reader.ReadAsync())
                        {
                            ...
                            if (thing != null)
                            {
                                result.Add(thing as MappingToReferenceScale);
                            }
                        }
                    }
                }
        ...
        /// </returns>
        public virtual async Task<bool> WriteAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.MappingToReferenceScale mappingToReferenceScale, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            var beforeWriteResult = await this.BeforeWriteAsync(transaction, partition, mappingToReferenceScale, container, valueTypeDictionaryAdditions);
            ...
            if (!isHandled)
            {
                beforeWrite = beforeWrite && await base.WriteAsync(transaction, partition, mappingToReferenceScale, container);
            ...
            return await this.AfterWriteAsync(beforeWrite, transaction, partition, mappingToReferenceScale, container);
        }
        ...
        /// An awaitable <see cref="Task"/> having True if the concept was successfully persisted as result.
        /// </returns>
        public virtual async Task<bool> UpsertAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.MappingToReferenceScale mappingToReferenceScale, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            await base.UpsertAsync(transaction, partition, mappingToReferenceScale, container);
            ...
            await using (var command = new NpgsqlCommand())
            {
                ...
                sqlBuilder.Append(" SET (\"Container\", \"DependentScaleValue\", \"ReferenceScaleValue\")");
                sqlBuilder.Append(" = (:container, :dependentScaleValue, :referenceScaleValue);");
        ...
        /// </returns>
        public virtual async Task<bool> UpdateAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.MappingToReferenceScale mappingToReferenceScale, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            var beforeUpdateResult = await this.BeforeUpdateAsync(transaction, partition, mappingToReferenceScale, container, valueTypeDictionaryAdditions);
            ...
            if (!isHandled)
            {
                beforeUpdate = beforeUpdate && await base.UpdateAsync(transaction, partition, mappingToReferenceScale, container);
            ...
            return await this.AfterUpdateAsync(beforeUpdate, transaction, partition, mappingToReferenceScale, container);
        }
        ...
        /// <summary>
        /// Build a SQL read query for the current <see cref="MappingToReferenceScaleDao" />
        /// </summary>
        ...
        public override string BuildReadQuery(string partition, DateTime? instant)
        {
            ...
            sqlBuilder.Append(" \"MappingToReferenceScale\".\"Container\",");

            sqlBuilder.Append(" NULL::bigint AS \"Sequence\",");

            sqlBuilder.Append(" \"Actor\",");

            sqlBuilder.Append(" \"MappingToReferenceScale\".\"DependentScaleValue\",");

            sqlBuilder.Append(" \"MappingToReferenceScale\".\"ReferenceScaleValue\",");
            sqlBuilder.Append(" COALESCE(\"Thing_ExcludedDomain\".\"ExcludedDomain\",'{}'::text[]) AS \"ExcludedDomain\",");
            sqlBuilder.Append(" COALESCE(\"Thing_ExcludedPerson\".\"ExcludedPerson\",'{}'::text[]) AS \"ExcludedPerson\",");

            sqlBuilder.Remove(sqlBuilder.Length - 1, 1);
            sqlBuilder.AppendFormat(" FROM ({0}) AS \"Thing\"", this.GetThingDataSql(partition, instant));
            sqlBuilder.AppendFormat(" JOIN ({0}) AS \"MappingToReferenceScale\" USING (\"Iid\")", this.GetMappingToReferenceScaleDataSql(partition, instant));
        ...
        {
            var sqlBuilder = new StringBuilder();
            sqlBuilder.Append(" LEFT JOIN (SELECT \"MappingToReferenceScale_Audit\".\"Actor\", \"MappingToReferenceScale_Audit\".\"Iid\"");
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"MappingToReferenceScale_Audit\" AS \"MappingToReferenceScale_Audit\"", partition);
            sqlBuilder.Append(" WHERE \"MappingToReferenceScale_Audit\".\"ValidTo\" = 'infinity'");
            sqlBuilder.Append(" GROUP BY \"MappingToReferenceScale_Audit\".\"Iid\", \"MappingToReferenceScale_Audit\".\"Actor\") AS \"Actor\" USING (\"Iid\")");
            return sqlBuilder.ToString();
        }
        ...
        public override string GetValueTypeSet() => "\"Thing\".\"ValueTypeDictionary\" || \"MappingToReferenceScale\".\"ValueTypeDictionary\"";

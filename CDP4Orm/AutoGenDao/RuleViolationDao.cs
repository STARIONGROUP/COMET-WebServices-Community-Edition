...
namespace CDP4Orm.Dao
{
    ...
    public partial class RuleViolationDao : ThingDao, IRuleViolationDao
    {
        ...
        public override string BuildReadQuery(string partition)
        {
            ...
            sqlBuilder.AppendFormat(" JOIN \"{0}\".\"RuleViolation_Data\"() AS \"RuleViolation\" USING (\"Iid\")", partition);
            ...
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"RuleViolation_ViolatingThing_Data\"() AS \"RuleViolation_ViolatingThing\"", partition);
            sqlBuilder.AppendFormat(" JOIN \"{0}\".\"RuleViolation_Data\"() AS \"RuleViolation\" ON \"RuleViolation\"= \"Iid\"", partition);

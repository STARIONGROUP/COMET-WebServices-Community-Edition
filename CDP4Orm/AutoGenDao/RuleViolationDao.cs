...
namespace CDP4Orm.Dao
{
    ...
    public partial class RuleViolationDao : ThingDao, IRuleViolationDao
    {
        ...
        /// </returns>
        public virtual IEnumerable<CDP4Common.DTO.RuleViolation> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false, DateTime? instant = null)
        {
        ...
        /// True if the concept was successfully persisted.
        /// </returns>
        public virtual bool Upsert(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.RuleViolation ruleViolation, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            base.Upsert(transaction, partition, ruleViolation, container);
            ...
            ruleViolation.ViolatingThing.ForEach(x => this.UpsertViolatingThing(transaction, partition, ruleViolation.Iid, x));
        ...
        /// True if the value link was successfully created.
        /// </returns>
        public bool UpsertViolatingThing(NpgsqlTransaction transaction, string partition, Guid iid, Guid violatingThing)
        {
            using (var command = new NpgsqlCommand())
            {
                var sqlBuilder = new System.Text.StringBuilder();

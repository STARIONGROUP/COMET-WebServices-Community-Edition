// --------------------------------------------------------------------------------------------------------------------
// <copyright file="NaturalLanguageDao.cs" company="Starion Group S.A.">
...
namespace CDP4Orm.Dao
{
    ...
    /// <summary>
    /// The NaturalLanguage Data Access Object which acts as an ORM layer to the SQL database.
    /// </summary>
    [ExcludeFromCodeCoverage]
    public partial class NaturalLanguageDao : ThingDao, INaturalLanguageDao
    {
        /// <summary>
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having a list of instances of <see cref="CDP4Common.DTO.NaturalLanguage"/> as result.
        /// </returns>
        public virtual async Task<IEnumerable<CDP4Common.DTO.NaturalLanguage>> ReadAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false, DateTime? instant = null)
        {
            var result = new List<NaturalLanguage>();
            ...
            await using (var command = new NpgsqlCommand())
            {
                ...
                {
                    sqlBuilder.AppendFormat("SELECT \"Jsonb\", \"Actor\" FROM \"{0}\".\"NaturalLanguage_Cache\"", partition);
                    ...
                    await using (var reader = await command.ExecuteReaderAsync())
                    {
                        while (await reader.ReadAsync())
                        {
                            ...
                            if (thing != null)
                            {
                                result.Add(thing as NaturalLanguage);
                            }
                        }
                    }
                }
        ...
        /// </param>
        /// <returns>
        /// A deserialized instance of <see cref="CDP4Common.DTO.NaturalLanguage"/>.
        /// </returns>
        public virtual CDP4Common.DTO.NaturalLanguage MapToDto(NpgsqlDataReader reader)
        {
            string tempLanguageCode;
            string tempModifiedOn;
            string tempName;
            string tempNativeName;
            ...
            var dto = new CDP4Common.DTO.NaturalLanguage(iid, revisionNumber);
            ...
            if (valueDict.TryGetValue("NativeName", out tempNativeName))
            {
                dto.NativeName = tempNativeName.UnEscape();
            }
        ...
        /// The naturalLanguage DTO that is to be persisted.
        /// </param>
        ...
        /// </returns>
        public virtual async Task<bool> WriteAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.NaturalLanguage naturalLanguage, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            var beforeWriteResult = await this.BeforeWriteAsync(transaction, partition, naturalLanguage, container, valueTypeDictionaryAdditions);
            ...
            if (!isHandled)
            {
                beforeWrite = beforeWrite && await base.WriteAsync(transaction, partition, naturalLanguage, container);

                var valueTypeDictionaryContents = new Dictionary<string, string>
                {
                    { "LanguageCode", !this.IsDerived(naturalLanguage, "LanguageCode") ? naturalLanguage.LanguageCode.Escape() : string.Empty },
                    { "Name", !this.IsDerived(naturalLanguage, "Name") ? naturalLanguage.Name.Escape() : string.Empty },
                    { "NativeName", !this.IsDerived(naturalLanguage, "NativeName") ? naturalLanguage.NativeName.Escape() : string.Empty },
                ...
                await using (var command = new NpgsqlCommand())
                {
                    ...
                    sqlBuilder.AppendFormat("INSERT INTO \"{0}\".\"NaturalLanguage\"", partition);
            ...
            return await this.AfterWriteAsync(beforeWrite, transaction, partition, naturalLanguage, container);
        }
        ...
        /// An awaitable <see cref="Task"/> having True if the concept was successfully persisted as result.
        /// </returns>
        public virtual async Task<bool> UpsertAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.NaturalLanguage naturalLanguage, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            await base.UpsertAsync(transaction, partition, naturalLanguage, container);
        ...
        /// </param>
        /// <param name="naturalLanguage">
        /// The NaturalLanguage DTO that is to be updated.
        /// </param>
        /// <param name="container">
        ...
        /// </returns>
        public virtual async Task<bool> UpdateAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.NaturalLanguage naturalLanguage, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            var beforeUpdateResult = await this.BeforeUpdateAsync(transaction, partition, naturalLanguage, container, valueTypeDictionaryAdditions);
            ...
            if (!isHandled)
            {
                beforeUpdate = beforeUpdate && await base.UpdateAsync(transaction, partition, naturalLanguage, container);
            ...
            return await this.AfterUpdateAsync(beforeUpdate, transaction, partition, naturalLanguage, container);
        }
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="CDP4Common.DTO.NaturalLanguage"/> id that is to be deleted.
        /// </param>
        /// <returns>
        ...
        /// <summary>
        /// Build a SQL read query for the current <see cref="NaturalLanguageDao" />
        /// </summary>
        ...
        public override string BuildReadQuery(string partition, DateTime? instant)
        {
            ...
            sqlBuilder.Append(" \"NaturalLanguage\".\"Container\",");
            ...
            sqlBuilder.AppendFormat(" JOIN ({0}) AS \"NaturalLanguage\" USING (\"Iid\")", this.GetNaturalLanguageDataSql(partition, instant));
        ...
        {
            var sqlBuilder = new StringBuilder();
            sqlBuilder.Append(" LEFT JOIN (SELECT \"NaturalLanguage_Audit\".\"Actor\", \"NaturalLanguage_Audit\".\"Iid\"");
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"NaturalLanguage_Audit\" AS \"NaturalLanguage_Audit\"", partition);
            sqlBuilder.Append(" WHERE \"NaturalLanguage_Audit\".\"ValidTo\" = 'infinity'");
            sqlBuilder.Append(" GROUP BY \"NaturalLanguage_Audit\".\"Iid\", \"NaturalLanguage_Audit\".\"Actor\") AS \"Actor\" USING (\"Iid\")");
            return sqlBuilder.ToString();
        }
        ...
        public override string GetValueTypeSet() => "\"Thing\".\"ValueTypeDictionary\" || \"NaturalLanguage\".\"ValueTypeDictionary\"";

...
namespace CDP4Orm.Dao
{
    ...
    public partial class LogEntryChangelogItemDao : ThingDao, ILogEntryChangelogItemDao
    {
        ...
        public override string BuildReadQuery(string partition)
        {
            ...
            sqlBuilder.AppendFormat(" JOIN \"{0}\".\"LogEntryChangelogItem_Data\"() AS \"LogEntryChangelogItem\" USING (\"Iid\")", partition);
            ...
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"LogEntryChangelogItem_AffectedReferenceIid_Data\"() AS \"LogEntryChangelogItem_AffectedReferenceIid\"", partition);
            sqlBuilder.AppendFormat(" JOIN \"{0}\".\"LogEntryChangelogItem_Data\"() AS \"LogEntryChangelogItem\" ON \"LogEntryChangelogItem\"= \"Iid\"", partition);

...
namespace CDP4Orm.Dao
{
    ...
    public partial class LogEntryChangelogItemDao : ThingDao, ILogEntryChangelogItemDao
    {
        ...
        /// </returns>
        public virtual IEnumerable<CDP4Common.DTO.LogEntryChangelogItem> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false, DateTime? instant = null)
        {

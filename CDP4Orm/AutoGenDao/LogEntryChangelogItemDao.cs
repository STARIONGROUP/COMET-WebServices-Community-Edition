// --------------------------------------------------------------------------------------------------------------------
// <copyright file="LogEntryChangelogItemDao.cs" company="Starion Group S.A.">
...
namespace CDP4Orm.Dao
{
    ...
    public partial class LogEntryChangelogItemDao : ThingDao, ILogEntryChangelogItemDao
    {
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having a list of instances of <see cref="CDP4Common.DTO.LogEntryChangelogItem"/> as result.
        /// </returns>
        public virtual async Task<IEnumerable<CDP4Common.DTO.LogEntryChangelogItem>> ReadAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false, DateTime? instant = null)
        {
            var result = new List<LogEntryChangelogItem>();
            ...
            await using (var command = new NpgsqlCommand())
            {
                ...
                {
                    sqlBuilder.AppendFormat("SELECT \"Jsonb\", \"Actor\" FROM \"{0}\".\"LogEntryChangelogItem_Cache\"", partition);
                    ...
                    await using (var reader = await command.ExecuteReaderAsync())
                    {
                        while (await reader.ReadAsync())
                        {
                            ...
                            if (thing != null)
                            {
                                result.Add(thing as LogEntryChangelogItem);
                            }
                        }
                    }
                }
        ...
        /// </returns>
        public virtual async Task<bool> WriteAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.LogEntryChangelogItem logEntryChangelogItem, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            var beforeWriteResult = await this.BeforeWriteAsync(transaction, partition, logEntryChangelogItem, container, valueTypeDictionaryAdditions);
            ...
            if (!isHandled)
            {
                beforeWrite = beforeWrite && await base.WriteAsync(transaction, partition, logEntryChangelogItem, container);
                ...
                foreach (var item in logEntryChangelogItem.AffectedReferenceIid)
                {
                    await this.AddAffectedReferenceIidAsync(transaction, partition, logEntryChangelogItem.Iid, item);
                }
            }

            return await this.AfterWriteAsync(beforeWrite, transaction, partition, logEntryChangelogItem, container);
        }
        ...
        /// An awaitable <see cref="Task"/> having True if the concept was successfully persisted as result.
        /// </returns>
        public virtual async Task<bool> UpsertAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.LogEntryChangelogItem logEntryChangelogItem, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            await base.UpsertAsync(transaction, partition, logEntryChangelogItem, container);
            ...
            foreach (var item in logEntryChangelogItem.AffectedReferenceIid)
            {
                await this.UpsertAffectedReferenceIidAsync(transaction, partition, logEntryChangelogItem.Iid, item);
            }
        ...
        public override async Task<bool> AddToCollectionPropertyAsync(NpgsqlTransaction transaction, string partition, string propertyName, Guid iid, object value)
        {
            ...
            switch (propertyName)
            {
                case "AffectedReferenceIid":
                    {
                        isCreated = await this.AddAffectedReferenceIidAsync(transaction, partition, iid, (Guid)value);
                        break;
                    }
        ...
        /// An awaitable <see cref="Task"/> having True if the value link was successfully created as result.
        /// </returns>
        public async Task<bool> AddAffectedReferenceIidAsync(NpgsqlTransaction transaction, string partition, Guid iid, Guid affectedReferenceIid)
        {
            await using (var command = new NpgsqlCommand())
            {
                var sqlBuilder = new System.Text.StringBuilder();
        ...
        /// An awaitable <see cref="Task"/> having True if the value link was successfully created as result.
        /// </returns>
        public async Task<bool> UpsertAffectedReferenceIidAsync(NpgsqlTransaction transaction, string partition, Guid iid, Guid affectedReferenceIid)
        {
            await using (var command = new NpgsqlCommand())
            {
                var sqlBuilder = new System.Text.StringBuilder();
        ...
        /// </returns>
        public virtual async Task<bool> UpdateAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.LogEntryChangelogItem logEntryChangelogItem, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            var beforeUpdateResult = await this.BeforeUpdateAsync(transaction, partition, logEntryChangelogItem, container, valueTypeDictionaryAdditions);
            ...
            if (!isHandled)
            {
                beforeUpdate = beforeUpdate && await base.UpdateAsync(transaction, partition, logEntryChangelogItem, container);
            ...
            return await this.AfterUpdateAsync(beforeUpdate, transaction, partition, logEntryChangelogItem, container);
        }
        ...
        public override async Task<bool> DeleteFromCollectionPropertyAsync(NpgsqlTransaction transaction, string partition, string propertyName, Guid iid, object value)
        {
            ...
            switch (propertyName)
            {
                case "AffectedReferenceIid":
                    {
                        isDeleted = await this.DeleteAffectedReferenceIidAsync(transaction, partition, iid, (Guid)value);
                        break;
                    }
        ...
        /// </returns>
        public async Task<bool> DeleteAffectedReferenceIidAsync(NpgsqlTransaction transaction, string partition, Guid iid, Guid affectedReferenceIid)
        {
            await using (var command = new NpgsqlCommand())
            {
                var sqlBuilder = new System.Text.StringBuilder();
        ...
        /// <summary>
        /// Build a SQL read query for the current <see cref="LogEntryChangelogItemDao" />
        /// </summary>
        ...
        public override string BuildReadQuery(string partition, DateTime? instant)
        {
            ...
            sqlBuilder.Append(" \"LogEntryChangelogItem\".\"Container\",");
            ...
            sqlBuilder.Append(" COALESCE(\"LogEntryChangelogItem_AffectedReferenceIid\".\"AffectedReferenceIid\",'{}'::text[]) AS \"AffectedReferenceIid\",");

            sqlBuilder.Remove(sqlBuilder.Length - 1, 1);
            sqlBuilder.AppendFormat(" FROM ({0}) AS \"Thing\"", this.GetThingDataSql(partition, instant));
            sqlBuilder.AppendFormat(" JOIN ({0}) AS \"LogEntryChangelogItem\" USING (\"Iid\")", this.GetLogEntryChangelogItemDataSql(partition, instant));
            ...
            sqlBuilder.Append(" LEFT JOIN (SELECT \"LogEntryChangelogItem\" AS \"Iid\", array_agg(\"AffectedReferenceIid\"::text) AS \"AffectedReferenceIid\"");
            sqlBuilder.AppendFormat(" FROM ({0}) AS \"LogEntryChangelogItem_AffectedReferenceIid\"", this.GetLogEntryChangelogItem_AffectedReferenceIidDataSql(partition, instant));
            sqlBuilder.AppendFormat(" JOIN ({0}) AS \"LogEntryChangelogItem\" ON \"LogEntryChangelogItem\"= \"Iid\"", this.GetLogEntryChangelogItemDataSql(partition, instant));
            sqlBuilder.Append(" GROUP BY \"LogEntryChangelogItem\") AS \"LogEntryChangelogItem_AffectedReferenceIid\" USING (\"Iid\")");
        ...
        {
            var sqlBuilder = new StringBuilder();
            sqlBuilder.Append(" LEFT JOIN (SELECT \"LogEntryChangelogItem_Audit\".\"Actor\", \"LogEntryChangelogItem_Audit\".\"Iid\"");
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"LogEntryChangelogItem_Audit\" AS \"LogEntryChangelogItem_Audit\"", partition);
            sqlBuilder.Append(" WHERE \"LogEntryChangelogItem_Audit\".\"ValidTo\" = 'infinity'");
            sqlBuilder.Append(" GROUP BY \"LogEntryChangelogItem_Audit\".\"Iid\", \"LogEntryChangelogItem_Audit\".\"Actor\") AS \"Actor\" USING (\"Iid\")");
            return sqlBuilder.ToString();
        }
        ...
        public override string GetValueTypeSet() => "\"Thing\".\"ValueTypeDictionary\" || \"LogEntryChangelogItem\".\"ValueTypeDictionary\"";
        ...
        /// </param>
        /// <returns>The DataSql string</returns>
        private string GetLogEntryChangelogItem_AffectedReferenceIidDataSql(string partition, DateTime? instant)
        {
            var sqlBuilder = new StringBuilder();

            var fields = "\"LogEntryChangelogItem\",\"AffectedReferenceIid\",\"ValidFrom\",\"ValidTo\"";
            sqlBuilder.AppendFormat(" SELECT {0}", fields);
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"LogEntryChangelogItem_AffectedReferenceIid\"", partition);
            ...
            if (instant.HasValue && instant.Value != DateTime.MaxValue)
            {
                ...
                sqlBuilder.Append(" UNION ALL");
                sqlBuilder.AppendFormat(" SELECT {0}", fields);
                sqlBuilder.AppendFormat(" FROM \"{0}\".\"LogEntryChangelogItem_AffectedReferenceIid_Audit\"", partition);
                sqlBuilder.Append(" WHERE \"Action\" <> 'I'");
                sqlBuilder.Append(" AND \"ValidFrom\" < :instant");
                sqlBuilder.Append(" AND \"ValidTo\" >= :instant");
            }

...
namespace CDP4Orm.Dao
{
    ...
    public partial interface ILogEntryChangelogItemDao : IDao
    {
        ...
        /// </returns>
        IEnumerable<CDP4Common.DTO.LogEntryChangelogItem> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false);

...
namespace CDP4Orm.Dao
{
    ...
    public partial class SimpleQuantityKindDao : QuantityKindDao, ISimpleQuantityKindDao
    {
        ...
        /// </returns>
        public virtual IEnumerable<CDP4Common.DTO.SimpleQuantityKind> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false, DateTime? instant = null)
        {

// --------------------------------------------------------------------------------------------------------------------
// <copyright file="OwnedStyleDao.cs" company="Starion Group S.A.">
...
namespace CDP4Orm.Dao
{
    ...
    public partial class OwnedStyleDao : DiagrammingStyleDao, IOwnedStyleDao
    {
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having a list of instances of <see cref="CDP4Common.DTO.OwnedStyle"/> as result.
        /// </returns>
        public virtual async Task<IEnumerable<CDP4Common.DTO.OwnedStyle>> ReadAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false, DateTime? instant = null)
        {
            var result = new List<OwnedStyle>();
            ...
            await using (var command = new NpgsqlCommand())
            {
                ...
                {
                    sqlBuilder.AppendFormat("SELECT \"Jsonb\", \"Actor\" FROM \"{0}\".\"OwnedStyle_Cache\"", partition);
                    ...
                    await using (var reader = await command.ExecuteReaderAsync())
                    {
                        while (await reader.ReadAsync())
                        {
                            ...
                            if (thing != null)
                            {
                                result.Add(thing as OwnedStyle);
                            }
                        }
                    }
                }
        ...
        /// </returns>
        public virtual async Task<bool> WriteAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.OwnedStyle ownedStyle, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            var beforeWriteResult = await this.BeforeWriteAsync(transaction, partition, ownedStyle, container, valueTypeDictionaryAdditions);
            ...
            if (!isHandled)
            {
                beforeWrite = beforeWrite && await base.WriteAsync(transaction, partition, ownedStyle, container);
            ...
            return await this.AfterWriteAsync(beforeWrite, transaction, partition, ownedStyle, container);
        }
        ...
        /// An awaitable <see cref="Task"/> having True if the concept was successfully persisted as result.
        /// </returns>
        public virtual async Task<bool> UpsertAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.OwnedStyle ownedStyle, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            await base.UpsertAsync(transaction, partition, ownedStyle, container);
        ...
        /// </returns>
        public virtual async Task<bool> UpdateAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.OwnedStyle ownedStyle, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            var beforeUpdateResult = await this.BeforeUpdateAsync(transaction, partition, ownedStyle, container, valueTypeDictionaryAdditions);
            ...
            if (!isHandled)
            {
                beforeUpdate = beforeUpdate && await base.UpdateAsync(transaction, partition, ownedStyle, container);
            ...
            return await this.AfterUpdateAsync(beforeUpdate, transaction, partition, ownedStyle, container);
        }
        ...
        /// <summary>
        /// Build a SQL read query for the current <see cref="OwnedStyleDao" />
        /// </summary>
        ...
        public override string BuildReadQuery(string partition, DateTime? instant)
        {
            ...
            sqlBuilder.Append(" \"OwnedStyle\".\"Container\",");

            sqlBuilder.Append(" NULL::bigint AS \"Sequence\",");

            sqlBuilder.Append(" \"Actor\",");

            sqlBuilder.Append(" \"DiagrammingStyle\".\"FillColor\",");

            sqlBuilder.Append(" \"DiagrammingStyle\".\"FontColor\",");

            sqlBuilder.Append(" \"DiagrammingStyle\".\"StrokeColor\",");
            sqlBuilder.Append(" COALESCE(\"Thing_ExcludedDomain\".\"ExcludedDomain\",'{}'::text[]) AS \"ExcludedDomain\",");
            sqlBuilder.Append(" COALESCE(\"Thing_ExcludedPerson\".\"ExcludedPerson\",'{}'::text[]) AS \"ExcludedPerson\",");
            sqlBuilder.Append(" COALESCE(\"DiagrammingStyle_UsedColor\".\"UsedColor\",'{}'::text[]) AS \"UsedColor\",");
            ...
            sqlBuilder.AppendFormat(" JOIN ({0}) AS \"DiagrammingStyle\" USING (\"Iid\")", this.GetDiagrammingStyleDataSql(partition, instant));
            sqlBuilder.AppendFormat(" JOIN ({0}) AS \"OwnedStyle\" USING (\"Iid\")", this.GetOwnedStyleDataSql(partition, instant));
            ...
            sqlBuilder.Append(" LEFT JOIN (SELECT \"Color\".\"Container\" AS \"Iid\", array_agg(\"Color\".\"Iid\"::text) AS \"UsedColor\"");
            sqlBuilder.AppendFormat(" FROM ({0}) AS \"Color\"", this.GetColorDataSql(partition, instant));
            sqlBuilder.AppendFormat(" JOIN ({0}) AS \"DiagrammingStyle\" ON \"Color\".\"Container\" = \"DiagrammingStyle\".\"Iid\"", this.GetDiagrammingStyleDataSql(partition, instant));
            sqlBuilder.Append(" GROUP BY \"Color\".\"Container\") AS \"DiagrammingStyle_UsedColor\" USING (\"Iid\")");
        ...
        {
            var sqlBuilder = new StringBuilder();
            sqlBuilder.Append(" LEFT JOIN (SELECT \"OwnedStyle_Audit\".\"Actor\", \"OwnedStyle_Audit\".\"Iid\"");
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"OwnedStyle_Audit\" AS \"OwnedStyle_Audit\"", partition);
            sqlBuilder.Append(" WHERE \"OwnedStyle_Audit\".\"ValidTo\" = 'infinity'");
            sqlBuilder.Append(" GROUP BY \"OwnedStyle_Audit\".\"Iid\", \"OwnedStyle_Audit\".\"Actor\") AS \"Actor\" USING (\"Iid\")");
            return sqlBuilder.ToString();
        }
        ...
        public override string GetValueTypeSet() => "\"Thing\".\"ValueTypeDictionary\" || \"DiagramThingBase\".\"ValueTypeDictionary\" || \"DiagrammingStyle\".\"ValueTypeDictionary\" || \"OwnedStyle\".\"ValueTypeDictionary\"";

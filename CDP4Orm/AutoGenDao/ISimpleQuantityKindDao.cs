...
namespace CDP4Orm.Dao
{
    ...
    public partial interface ISimpleQuantityKindDao : IDao
    {
        ...
        /// </returns>
        IEnumerable<CDP4Common.DTO.SimpleQuantityKind> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false, DateTime? instant = null);
        ...
        /// </returns>
        bool Update(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.SimpleQuantityKind simpleQuantityKind, CDP4Common.DTO.Thing container = null);

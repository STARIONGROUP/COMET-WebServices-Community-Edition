// --------------------------------------------------------------------------------------------------------------------
// <copyright file="LinearConversionUnitDao.cs" company="Starion Group S.A.">
...
namespace CDP4Orm.Dao
{
    ...
    /// <summary>
    /// The LinearConversionUnit Data Access Object which acts as an ORM layer to the SQL database.
    /// </summary>
    public partial class LinearConversionUnitDao : ConversionBasedUnitDao, ILinearConversionUnitDao
    {
        /// <summary>
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having a list of instances of <see cref="CDP4Common.DTO.LinearConversionUnit"/> as result.
        /// </returns>
        public virtual async Task<IEnumerable<CDP4Common.DTO.LinearConversionUnit>> ReadAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false, DateTime? instant = null)
        {
            var result = new List<LinearConversionUnit>();
            ...
            await using (var command = new NpgsqlCommand())
            {
                ...
                {
                    sqlBuilder.AppendFormat("SELECT \"Jsonb\", \"Actor\" FROM \"{0}\".\"LinearConversionUnit_Cache\"", partition);
                    ...
                    await using (var reader = await command.ExecuteReaderAsync())
                    {
                        while (await reader.ReadAsync())
                        {
                            ...
                            if (thing != null)
                            {
                                result.Add(thing as LinearConversionUnit);
                            }
                        }
                    }
                }
        ...
        /// </param>
        /// <returns>
        /// A deserialized instance of <see cref="CDP4Common.DTO.LinearConversionUnit"/>.
        /// </returns>
        public virtual CDP4Common.DTO.LinearConversionUnit MapToDto(NpgsqlDataReader reader)
        {
            ...
            var dto = new CDP4Common.DTO.LinearConversionUnit(iid, revisionNumber);
            ...
            dto.ReferenceUnit = Guid.Parse(reader["ReferenceUnit"].ToString());

            if (valueDict.TryGetValue("ConversionFactor", out tempConversionFactor))
            {
                dto.ConversionFactor = tempConversionFactor.UnEscape();
            }
        ...
        /// The linearConversionUnit DTO that is to be persisted.
        /// </param>
        ...
        /// </returns>
        public virtual async Task<bool> WriteAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.LinearConversionUnit linearConversionUnit, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            var beforeWriteResult = await this.BeforeWriteAsync(transaction, partition, linearConversionUnit, container, valueTypeDictionaryAdditions);
            ...
            if (!isHandled)
            {
                beforeWrite = beforeWrite && await base.WriteAsync(transaction, partition, linearConversionUnit, container);

                await using (var command = new NpgsqlCommand())
                {
                    var sqlBuilder = new System.Text.StringBuilder();

                    sqlBuilder.AppendFormat("INSERT INTO \"{0}\".\"LinearConversionUnit\"", partition);
            ...
            return await this.AfterWriteAsync(beforeWrite, transaction, partition, linearConversionUnit, container);
        }
        ...
        /// An awaitable <see cref="Task"/> having True if the concept was successfully persisted as result.
        /// </returns>
        public virtual async Task<bool> UpsertAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.LinearConversionUnit linearConversionUnit, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            await base.UpsertAsync(transaction, partition, linearConversionUnit, container);
        ...
        /// </param>
        /// <param name="linearConversionUnit">
        /// The LinearConversionUnit DTO that is to be updated.
        /// </param>
        /// <param name="container">
        ...
        /// </returns>
        public virtual async Task<bool> UpdateAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.LinearConversionUnit linearConversionUnit, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            var beforeUpdateResult = await this.BeforeUpdateAsync(transaction, partition, linearConversionUnit, container, valueTypeDictionaryAdditions);
            ...
            if (!isHandled)
            {
                beforeUpdate = beforeUpdate && await base.UpdateAsync(transaction, partition, linearConversionUnit, container);
            }

            return await this.AfterUpdateAsync(beforeUpdate, transaction, partition, linearConversionUnit, container);
        }
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="CDP4Common.DTO.LinearConversionUnit"/> id that is to be deleted.
        /// </param>
        /// <returns>
        ...
        /// <summary>
        /// Build a SQL read query for the current <see cref="LinearConversionUnitDao" />
        /// </summary>
        ...
        public override string BuildReadQuery(string partition, DateTime? instant)
        {
            ...
            sqlBuilder.Append(" \"ConversionBasedUnit\".\"ReferenceUnit\",");
            ...
            sqlBuilder.AppendFormat(" JOIN ({0}) AS \"ConversionBasedUnit\" USING (\"Iid\")", this.GetConversionBasedUnitDataSql(partition, instant));
            sqlBuilder.AppendFormat(" JOIN ({0}) AS \"LinearConversionUnit\" USING (\"Iid\")", this.GetLinearConversionUnitDataSql(partition, instant));
        ...
        {
            var sqlBuilder = new StringBuilder();
            sqlBuilder.Append(" LEFT JOIN (SELECT \"LinearConversionUnit_Audit\".\"Actor\", \"LinearConversionUnit_Audit\".\"Iid\"");
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"LinearConversionUnit_Audit\" AS \"LinearConversionUnit_Audit\"", partition);
            sqlBuilder.Append(" WHERE \"LinearConversionUnit_Audit\".\"ValidTo\" = 'infinity'");
            sqlBuilder.Append(" GROUP BY \"LinearConversionUnit_Audit\".\"Iid\", \"LinearConversionUnit_Audit\".\"Actor\") AS \"Actor\" USING (\"Iid\")");
            return sqlBuilder.ToString();
        }
        ...
        public override string GetValueTypeSet() => "\"Thing\".\"ValueTypeDictionary\" || \"DefinedThing\".\"ValueTypeDictionary\" || \"MeasurementUnit\".\"ValueTypeDictionary\" || \"ConversionBasedUnit\".\"ValueTypeDictionary\" || \"LinearConversionUnit\".\"ValueTypeDictionary\"";
        ...
        /// </param>
        /// <returns>The DataSql string</returns>
        private string GetConversionBasedUnitDataSql(string partition, DateTime? instant)
        {
            var sqlBuilder = new StringBuilder();

            var fields = " \"Iid\", \"ValueTypeDictionary\", \"ReferenceUnit\",\"ValidFrom\",\"ValidTo\"";
            sqlBuilder.AppendFormat(" SELECT {0}", fields);
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"ConversionBasedUnit\"", partition);
            ...
            if (instant.HasValue && instant.Value != DateTime.MaxValue)
            {
                ...
                sqlBuilder.Append(" UNION ALL");
                sqlBuilder.AppendFormat(" SELECT {0}", fields);
                sqlBuilder.AppendFormat(" FROM \"{0}\".\"ConversionBasedUnit_Audit\"", partition);
                sqlBuilder.Append(" WHERE \"Action\" <> 'I'");
                sqlBuilder.Append(" AND \"ValidFrom\" < :instant");
                sqlBuilder.Append(" AND \"ValidTo\" >= :instant");
            }
        ...
        /// </param>
        /// <returns>The DataSql string</returns>
        private string GetLinearConversionUnitDataSql(string partition, DateTime? instant)
        {
            var sqlBuilder = new StringBuilder();

            var fields = " \"Iid\", \"ValueTypeDictionary\",\"ValidFrom\",\"ValidTo\"";
            sqlBuilder.AppendFormat(" SELECT {0}", fields);
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"LinearConversionUnit\"", partition);
            ...
            if (instant.HasValue && instant.Value != DateTime.MaxValue)
            {
                ...
                sqlBuilder.Append(" UNION ALL");
                sqlBuilder.AppendFormat(" SELECT {0}", fields);
                sqlBuilder.AppendFormat(" FROM \"{0}\".\"LinearConversionUnit_Audit\"", partition);
                sqlBuilder.Append(" WHERE \"Action\" <> 'I'");
                sqlBuilder.Append(" AND \"ValidFrom\" < :instant");
                sqlBuilder.Append(" AND \"ValidTo\" >= :instant");
            }

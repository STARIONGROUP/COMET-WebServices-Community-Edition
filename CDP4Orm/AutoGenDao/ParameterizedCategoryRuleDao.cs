...
namespace CDP4Orm.Dao
{
    ...
    public partial class ParameterizedCategoryRuleDao : RuleDao, IParameterizedCategoryRuleDao
    {
        ...
        public override string BuildReadQuery(string partition)
        {
            ...
            sqlBuilder.AppendFormat(" JOIN \"{0}\".\"ParameterizedCategoryRule_Data\"() AS \"ParameterizedCategoryRule\" USING (\"Iid\")", partition);
            ...
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"ParameterizedCategoryRule_ParameterType_Data\"() AS \"ParameterizedCategoryRule_ParameterType\"", partition);
            sqlBuilder.AppendFormat(" JOIN \"{0}\".\"ParameterizedCategoryRule_Data\"() AS \"ParameterizedCategoryRule\" ON \"ParameterizedCategoryRule\" = \"Iid\"", partition);

...
namespace CDP4Orm.Dao
{
    ...
    public partial interface IConstantDao : IDao
    {
        ...
        /// </returns>
        IEnumerable<CDP4Common.DTO.Constant> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false, DateTime? instant = null);
        ...
        /// </returns>
        bool Update(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.Constant constant, CDP4Common.DTO.Thing container = null);

...
namespace CDP4Orm.Dao
{
    ...
    public partial interface ISpecializedQuantityKindDao : IDao
    {
        ...
        /// </returns>
        IEnumerable<CDP4Common.DTO.SpecializedQuantityKind> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false);

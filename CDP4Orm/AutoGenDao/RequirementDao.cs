// --------------------------------------------------------------------------------------------------------------------
// <copyright file="RequirementDao.cs" company="Starion Group S.A.">
...
namespace CDP4Orm.Dao
{
    ...
    /// <summary>
    /// The Requirement Data Access Object which acts as an ORM layer to the SQL database.
    /// </summary>
    [ExcludeFromCodeCoverage]
    public partial class RequirementDao : SimpleParameterizableThingDao, IRequirementDao
    {
        /// <summary>
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having a list of instances of <see cref="CDP4Common.DTO.Requirement"/> as result.
        /// </returns>
        public virtual async Task<IEnumerable<CDP4Common.DTO.Requirement>> ReadAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false, DateTime? instant = null)
        {
            ...
            await using (var command = new NpgsqlCommand())
            {
                ...
                {
                    sqlBuilder.AppendFormat("SELECT \"Jsonb\", \"Actor\" FROM \"{0}\".\"Requirement_Cache\"", partition);
                    ...
                    await using (var reader = await command.ExecuteReaderAsync())
                    {
                        while (await reader.ReadAsync())
                        {
                            ...
                            if (thing != null)
                            {
                                result.Add(thing as Requirement);
                            }
                        }
                    }
                }
        ...
        /// </param>
        /// <returns>
        /// A deserialized instance of <see cref="CDP4Common.DTO.Requirement"/>.
        /// </returns>
        public virtual CDP4Common.DTO.Requirement MapToDto(NpgsqlDataReader reader)
        {
            ...
            var dto = new CDP4Common.DTO.Requirement(iid, revisionNumber);
            ...
            dto.ParametricConstraint.AddRange(Utils.ParseOrderedList<Guid>(reader["ParametricConstraint"] as string[,]));
        ...
        /// </returns>
        public virtual async Task<bool> WriteAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.Requirement requirement, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            var beforeWriteResult = await this.BeforeWriteAsync(transaction, partition, requirement, container, valueTypeDictionaryAdditions);
            ...
            if (!isHandled)
            {
                beforeWrite = beforeWrite && await base.WriteAsync(transaction, partition, requirement, container);
                ...
                foreach (var item in requirement.Category)
                {
                    await this.AddCategoryAsync(transaction, partition, requirement.Iid, item);
                }
            }

            return await this.AfterWriteAsync(beforeWrite, transaction, partition, requirement, container);
        }
        ...
        /// An awaitable <see cref="Task"/> having True if the concept was successfully persisted as result.
        /// </returns>
        public virtual async Task<bool> UpsertAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.Requirement requirement, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            await base.UpsertAsync(transaction, partition, requirement, container);
            ...
            foreach (var item in requirement.Category)
            {
                await this.UpsertCategoryAsync(transaction, partition, requirement.Iid, item);
            }
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="CDP4Common.DTO.Requirement"/> id that will be the source for each link table record.
        /// </param> 
        /// <param name="value">
        ...
        /// </param>
        /// <param name="requirement">
        /// The Requirement DTO that is to be updated.
        /// </param>
        /// <param name="container">
        ...
        /// </returns>
        public virtual async Task<bool> UpdateAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.Requirement requirement, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            var beforeUpdateResult = await this.BeforeUpdateAsync(transaction, partition, requirement, container, valueTypeDictionaryAdditions);
            ...
            if (!isHandled)
            {
                beforeUpdate = beforeUpdate && await base.UpdateAsync(transaction, partition, requirement, container);
            ...
            return await this.AfterUpdateAsync(beforeUpdate, transaction, partition, requirement, container);
        }
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="CDP4Common.DTO.Requirement"/> id that is to be deleted.
        /// </param>
        /// <returns>
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="CDP4Common.DTO.Requirement"/> id that is the source of each link table record.
        /// </param> 
        /// <param name="value">
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="CDP4Common.DTO.Requirement"/> id that is the source for each link table record.
        /// </param> 
        /// <param name="category">
        ...
        public async Task<bool> DeleteCategoryAsync(NpgsqlTransaction transaction, string partition, Guid iid, Guid category)
        {
            ...
            {
                var sqlBuilder = new System.Text.StringBuilder();
                sqlBuilder.AppendFormat("DELETE FROM \"{0}\".\"Requirement_Category\"", partition);
                sqlBuilder.Append(" WHERE \"Requirement\" = :requirement");
        ...
        /// <summary>
        /// Build a SQL read query for the current <see cref="RequirementDao" />
        /// </summary>
        ...
        public override string BuildReadQuery(string partition, DateTime? instant)
        {
            ...
            sqlBuilder.Append(" \"Requirement\".\"Container\",");
            ...
            sqlBuilder.Append(" \"Requirement\".\"Group\",");
            ...
            sqlBuilder.Append(" COALESCE(\"Requirement_Category\".\"Category\",'{}'::text[]) AS \"Category\",");
            sqlBuilder.Append(" COALESCE(\"Requirement_ParametricConstraint\".\"ParametricConstraint\",'{}'::text[]) AS \"ParametricConstraint\",");
            ...
            sqlBuilder.AppendFormat(" JOIN ({0}) AS \"SimpleParameterizableThing\" USING (\"Iid\")", this.GetSimpleParameterizableThingDataSql(partition, instant));
            sqlBuilder.AppendFormat(" JOIN ({0}) AS \"Requirement\" USING (\"Iid\")", this.GetRequirementDataSql(partition, instant));
            ...
            sqlBuilder.AppendFormat(" FROM ({0}) AS \"SimpleParameterValue\"", this.GetSimpleParameterValueDataSql(partition, instant));
            sqlBuilder.AppendFormat(" JOIN ({0}) AS \"SimpleParameterizableThing\" ON \"SimpleParameterValue\".\"Container\" = \"SimpleParameterizableThing\".\"Iid\"", this.GetSimpleParameterizableThingDataSql(partition, instant));
            sqlBuilder.Append(" GROUP BY \"SimpleParameterValue\".\"Container\") AS \"SimpleParameterizableThing_ParameterValue\" USING (\"Iid\")");

            sqlBuilder.Append(" LEFT JOIN (SELECT \"Requirement\" AS \"Iid\", array_agg(\"Category\"::text) AS \"Category\"");
            sqlBuilder.AppendFormat(" FROM ({0}) AS \"Requirement_Category\"", this.GetRequirement_CategoryDataSql(partition, instant));
            sqlBuilder.AppendFormat(" JOIN ({0}) AS \"Requirement\" ON \"Requirement\" = \"Iid\"", this.GetRequirementDataSql(partition, instant));
            sqlBuilder.Append(" GROUP BY \"Requirement\") AS \"Requirement_Category\" USING (\"Iid\")");

            sqlBuilder.Append(" LEFT JOIN (SELECT \"ParametricConstraint\".\"Container\" AS \"Iid\", ARRAY[array_agg(\"ParametricConstraint\".\"Sequence\"::text), array_agg(\"ParametricConstraint\".\"Iid\"::text)] AS \"ParametricConstraint\"");
            sqlBuilder.AppendFormat(" FROM ({0}) AS \"ParametricConstraint\"", this.GetParametricConstraintDataSql(partition, instant));
            sqlBuilder.AppendFormat(" JOIN ({0}) AS \"Requirement\" ON \"ParametricConstraint\".\"Container\" = \"Requirement\".\"Iid\"", this.GetRequirementDataSql(partition, instant));
            sqlBuilder.Append(" GROUP BY \"ParametricConstraint\".\"Container\") AS \"Requirement_ParametricConstraint\" USING (\"Iid\")");
        ...
        {
            var sqlBuilder = new StringBuilder();
            sqlBuilder.Append(" LEFT JOIN (SELECT \"Requirement_Audit\".\"Actor\", \"Requirement_Audit\".\"Iid\"");
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"Requirement_Audit\" AS \"Requirement_Audit\"", partition);
            sqlBuilder.Append(" WHERE \"Requirement_Audit\".\"ValidTo\" = 'infinity'");
            sqlBuilder.Append(" GROUP BY \"Requirement_Audit\".\"Iid\", \"Requirement_Audit\".\"Actor\") AS \"Actor\" USING (\"Iid\")");
            return sqlBuilder.ToString();
        }
        ...
        public override string GetValueTypeSet() => "\"Thing\".\"ValueTypeDictionary\" || \"DefinedThing\".\"ValueTypeDictionary\" || \"SimpleParameterizableThing\".\"ValueTypeDictionary\" || \"Requirement\".\"ValueTypeDictionary\"";
        ...
        /// </param>
        /// <returns>The DataSql string</returns>
        private string GetSimpleParameterizableThingDataSql(string partition, DateTime? instant)
        {
            var sqlBuilder = new StringBuilder();

            var fields = " \"Iid\", \"ValueTypeDictionary\", \"Owner\",\"ValidFrom\",\"ValidTo\"";
            sqlBuilder.AppendFormat(" SELECT {0}", fields);
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"SimpleParameterizableThing\"", partition);
            ...
            if (instant.HasValue && instant.Value != DateTime.MaxValue)
            {
                ...
                sqlBuilder.Append(" UNION ALL");
                sqlBuilder.AppendFormat(" SELECT {0}", fields);
                sqlBuilder.AppendFormat(" FROM \"{0}\".\"SimpleParameterizableThing_Audit\"", partition);
                sqlBuilder.Append(" WHERE \"Action\" <> 'I'");
                sqlBuilder.Append(" AND \"ValidFrom\" < :instant");
                sqlBuilder.Append(" AND \"ValidTo\" >= :instant");
            }
        ...
        /// </param>
        /// <returns>The DataSql string</returns>
        private string GetSimpleParameterValueDataSql(string partition, DateTime? instant)
        {
            var sqlBuilder = new StringBuilder();

            var fields = " \"Iid\", \"ValueTypeDictionary\", \"Container\", \"ParameterType\", \"Scale\",\"ValidFrom\",\"ValidTo\"";
            sqlBuilder.AppendFormat(" SELECT {0}", fields);
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"SimpleParameterValue\"", partition);
            ...
            if (instant.HasValue && instant.Value != DateTime.MaxValue)
            {
                ...
                sqlBuilder.Append(" UNION ALL");
                sqlBuilder.AppendFormat(" SELECT {0}", fields);
                sqlBuilder.AppendFormat(" FROM \"{0}\".\"SimpleParameterValue_Audit\"", partition);
                sqlBuilder.Append(" WHERE \"Action\" <> 'I'");
                sqlBuilder.Append(" AND \"ValidFrom\" < :instant");
                sqlBuilder.Append(" AND \"ValidTo\" >= :instant");
            }
        ...
        /// </param>
        /// <returns>The DataSql string</returns>
        private string GetRequirement_CategoryDataSql(string partition, DateTime? instant)
        {
            var sqlBuilder = new StringBuilder();

            var fields = "\"Requirement\",\"Category\",\"ValidFrom\",\"ValidTo\"";
            sqlBuilder.AppendFormat(" SELECT {0}", fields);
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"Requirement_Category\"", partition);
            ...
            if (instant.HasValue && instant.Value != DateTime.MaxValue)
            {
                ...
                sqlBuilder.Append(" UNION ALL");
                sqlBuilder.AppendFormat(" SELECT {0}", fields);
                sqlBuilder.AppendFormat(" FROM \"{0}\".\"Requirement_Category_Audit\"", partition);
                sqlBuilder.Append(" WHERE \"Action\" <> 'I'");
                sqlBuilder.Append(" AND \"ValidFrom\" < :instant");
                sqlBuilder.Append(" AND \"ValidTo\" >= :instant");
            }
        ...
        /// </param>
        /// <returns>The DataSql string</returns>
        private string GetParametricConstraintDataSql(string partition, DateTime? instant)
        {
            var sqlBuilder = new StringBuilder();

            var fields = " \"Iid\", \"ValueTypeDictionary\", \"Sequence\", \"Container\", \"TopExpression\",\"ValidFrom\",\"ValidTo\"";
            sqlBuilder.AppendFormat(" SELECT {0}", fields);
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"ParametricConstraint\"", partition);
            ...
            if (instant.HasValue && instant.Value != DateTime.MaxValue)
            {
                ...
                sqlBuilder.Append(" UNION ALL");
                sqlBuilder.AppendFormat(" SELECT {0}", fields);
                sqlBuilder.AppendFormat(" FROM \"{0}\".\"ParametricConstraint_Audit\"", partition);
                sqlBuilder.Append(" WHERE \"Action\" <> 'I'");
                sqlBuilder.Append(" AND \"ValidFrom\" < :instant");
                sqlBuilder.Append(" AND \"ValidTo\" >= :instant");
            }

...
namespace CDP4Orm.Dao
{
    ...
    public partial interface IExternalIdentifierMapDao : IDao
    {
        ...
        /// </returns>
        IEnumerable<CDP4Common.DTO.ExternalIdentifierMap> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false);

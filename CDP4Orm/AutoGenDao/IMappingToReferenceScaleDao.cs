...
namespace CDP4Orm.Dao
{
    ...
    public partial interface IMappingToReferenceScaleDao : IDao
    {
        ...
        /// </returns>
        IEnumerable<CDP4Common.DTO.MappingToReferenceScale> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false);

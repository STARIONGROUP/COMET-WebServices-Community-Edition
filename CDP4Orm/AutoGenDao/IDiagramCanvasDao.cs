...
namespace CDP4Orm.Dao
{
    ...
    public partial interface IDiagramCanvasDao : IDao
    {
        ...
        /// </returns>
        IEnumerable<CDP4Common.DTO.DiagramCanvas> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false);

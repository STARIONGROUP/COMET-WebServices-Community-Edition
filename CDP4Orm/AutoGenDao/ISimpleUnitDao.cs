...
namespace CDP4Orm.Dao
{
    ...
    public partial interface ISimpleUnitDao : IDao
    {
        ...
        /// </returns>
        IEnumerable<CDP4Common.DTO.SimpleUnit> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false);

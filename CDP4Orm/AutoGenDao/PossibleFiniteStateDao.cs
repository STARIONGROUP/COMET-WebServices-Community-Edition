...
namespace CDP4Orm.Dao
{
    ...
    public partial class PossibleFiniteStateDao : DefinedThingDao, IPossibleFiniteStateDao
    {
        ...
        /// </returns>
        public virtual IEnumerable<CDP4Common.DTO.PossibleFiniteState> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false, DateTime? instant = null)
        {

// --------------------------------------------------------------------------------------------------------------------
// <copyright file="UnitPrefixDao.cs" company="Starion Group S.A.">
...
namespace CDP4Orm.Dao
{
    ...
    /// <summary>
    /// The UnitPrefix Data Access Object which acts as an ORM layer to the SQL database.
    /// </summary>
    public partial class UnitPrefixDao : DefinedThingDao, IUnitPrefixDao
    {
        /// <summary>
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having a list of instances of <see cref="CDP4Common.DTO.UnitPrefix"/> as result.
        /// </returns>
        public virtual async Task<IEnumerable<CDP4Common.DTO.UnitPrefix>> ReadAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false, DateTime? instant = null)
        {
            var result = new List<UnitPrefix>();
            ...
            await using (var command = new NpgsqlCommand())
            {
                ...
                {
                    sqlBuilder.AppendFormat("SELECT \"Jsonb\", \"Actor\" FROM \"{0}\".\"UnitPrefix_Cache\"", partition);
                    ...
                    await using (var reader = await command.ExecuteReaderAsync())
                    {
                        while (await reader.ReadAsync())
                        {
                            ...
                            if (thing != null)
                            {
                                result.Add(thing as UnitPrefix);
                            }
                        }
                    }
                }
        ...
        /// </param>
        /// <returns>
        /// A deserialized instance of <see cref="CDP4Common.DTO.UnitPrefix"/>.
        /// </returns>
        public virtual CDP4Common.DTO.UnitPrefix MapToDto(NpgsqlDataReader reader)
        {
            ...
            var dto = new CDP4Common.DTO.UnitPrefix(iid, revisionNumber);
        ...
        /// The unitPrefix DTO that is to be persisted.
        /// </param>
        ...
        /// </returns>
        public virtual async Task<bool> WriteAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.UnitPrefix unitPrefix, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            var beforeWriteResult = await this.BeforeWriteAsync(transaction, partition, unitPrefix, container, valueTypeDictionaryAdditions);
            ...
            if (!isHandled)
            {
                beforeWrite = beforeWrite && await base.WriteAsync(transaction, partition, unitPrefix, container);

                var valueTypeDictionaryContents = new Dictionary<string, string>
                {
                    { "ConversionFactor", !this.IsDerived(unitPrefix, "ConversionFactor") ? unitPrefix.ConversionFactor.Escape() : string.Empty },
                    { "IsDeprecated", !this.IsDerived(unitPrefix, "IsDeprecated") ? unitPrefix.IsDeprecated.ToString() : string.Empty },
                ...
                await using (var command = new NpgsqlCommand())
                {
                    ...
                    sqlBuilder.AppendFormat("INSERT INTO \"{0}\".\"UnitPrefix\"", partition);
            ...
            return await this.AfterWriteAsync(beforeWrite, transaction, partition, unitPrefix, container);
        }
        ...
        /// An awaitable <see cref="Task"/> having True if the concept was successfully persisted as result.
        /// </returns>
        public virtual async Task<bool> UpsertAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.UnitPrefix unitPrefix, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            await base.UpsertAsync(transaction, partition, unitPrefix, container);
        ...
        /// </param>
        /// <param name="unitPrefix">
        /// The UnitPrefix DTO that is to be updated.
        /// </param>
        /// <param name="container">
        ...
        /// </returns>
        public virtual async Task<bool> UpdateAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.UnitPrefix unitPrefix, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            var beforeUpdateResult = await this.BeforeUpdateAsync(transaction, partition, unitPrefix, container, valueTypeDictionaryAdditions);
            ...
            if (!isHandled)
            {
                beforeUpdate = beforeUpdate && await base.UpdateAsync(transaction, partition, unitPrefix, container);
            ...
            return await this.AfterUpdateAsync(beforeUpdate, transaction, partition, unitPrefix, container);
        }
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="CDP4Common.DTO.UnitPrefix"/> id that is to be deleted.
        /// </param>
        /// <returns>
        ...
        /// <summary>
        /// Build a SQL read query for the current <see cref="UnitPrefixDao" />
        /// </summary>
        ...
        public override string BuildReadQuery(string partition, DateTime? instant)
        {
            ...
            sqlBuilder.Append(" \"UnitPrefix\".\"Container\",");
            ...
            sqlBuilder.AppendFormat(" JOIN ({0}) AS \"UnitPrefix\" USING (\"Iid\")", this.GetUnitPrefixDataSql(partition, instant));
        ...
        {
            var sqlBuilder = new StringBuilder();
            sqlBuilder.Append(" LEFT JOIN (SELECT \"UnitPrefix_Audit\".\"Actor\", \"UnitPrefix_Audit\".\"Iid\"");
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"UnitPrefix_Audit\" AS \"UnitPrefix_Audit\"", partition);
            sqlBuilder.Append(" WHERE \"UnitPrefix_Audit\".\"ValidTo\" = 'infinity'");
            sqlBuilder.Append(" GROUP BY \"UnitPrefix_Audit\".\"Iid\", \"UnitPrefix_Audit\".\"Actor\") AS \"Actor\" USING (\"Iid\")");
            return sqlBuilder.ToString();
        }
        ...
        public override string GetValueTypeSet() => "\"Thing\".\"ValueTypeDictionary\" || \"DefinedThing\".\"ValueTypeDictionary\" || \"UnitPrefix\".\"ValueTypeDictionary\"";

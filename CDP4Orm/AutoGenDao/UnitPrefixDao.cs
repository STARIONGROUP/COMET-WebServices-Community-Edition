...
namespace CDP4Orm.Dao
{
    ...
    public partial class UnitPrefixDao : DefinedThingDao, IUnitPrefixDao
    {
        ...
        /// </returns>
        public virtual IEnumerable<CDP4Common.DTO.UnitPrefix> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false)
        {
        ...
        public override string BuildReadQuery(string partition)
        {
            ...
            sqlBuilder.AppendFormat(" JOIN \"{0}\".\"UnitPrefix_Data\"() AS \"UnitPrefix\" USING (\"Iid\")", partition);

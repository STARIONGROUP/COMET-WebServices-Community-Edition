...
namespace CDP4Orm.Dao
{
    ...
    public partial class GlossaryDao : DefinedThingDao, IGlossaryDao
    {
        ...
        public override string BuildReadQuery(string partition)
        {
            ...
            sqlBuilder.AppendFormat(" JOIN \"{0}\".\"Glossary_Data\"() AS \"Glossary\" USING (\"Iid\")", partition);
            ...
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"Glossary_Category_Data\"() AS \"Glossary_Category\"", partition);
            sqlBuilder.AppendFormat(" JOIN \"{0}\".\"Glossary_Data\"() AS \"Glossary\" ON \"Glossary\" = \"Iid\"", partition);
            ...
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"Term_Data\"() AS \"Term\"", partition);
            sqlBuilder.AppendFormat(" JOIN \"{0}\".\"Glossary_Data\"() AS \"Glossary\" ON \"Term\".\"Container\" = \"Glossary\".\"Iid\"", partition);

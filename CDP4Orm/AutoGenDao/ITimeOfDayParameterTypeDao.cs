...
namespace CDP4Orm.Dao
{
    ...
    public partial interface ITimeOfDayParameterTypeDao : IDao
    {
        ...
        /// </returns>
        Task<IEnumerable<CDP4Common.DTO.TimeOfDayParameterType>> ReadAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false, DateTime? instant = null);
        ...
        /// </returns>
        Task<bool> WriteAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.TimeOfDayParameterType timeOfDayParameterType, CDP4Common.DTO.Thing container = null);
        ...
        /// An awaitable <see cref="Task"/> having True if the concept was successfully persisted as result.
        /// </returns>
        Task<bool> UpsertAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.TimeOfDayParameterType timeOfDayParameterType, CDP4Common.DTO.Thing container = null);
        ...
        /// An awaitable <see cref="Task"/> having True if the concept was successfully persisted as result.
        /// </returns>
        Task<bool> UpdateAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.TimeOfDayParameterType timeOfDayParameterType, CDP4Common.DTO.Thing container = null);

...
namespace CDP4Orm.Dao
{
    ...
    public partial interface IRequirementsContainerParameterValueDao : IDao
    {
        ...
        /// </returns>
        IEnumerable<CDP4Common.DTO.RequirementsContainerParameterValue> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false);

// --------------------------------------------------------------------------------------------------------------------
// <copyright file="TopContainerDao.cs" company="RHEA System S.A.">
...
namespace CDP4Orm.Dao
{
    ...
    public abstract partial class TopContainerDao : ThingDao
    {
        ...
        /// </returns>
        public virtual bool Write(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.TopContainer topContainer, CDP4Common.DTO.Thing container = null)
        {
            bool isHandled;
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            var beforeWrite = this.BeforeWrite(transaction, partition, topContainer, container, out isHandled, valueTypeDictionaryAdditions);
            if (!isHandled)
            {
                beforeWrite = beforeWrite && base.Write(transaction, partition, topContainer, container);
            ...
            return this.AfterWrite(beforeWrite, transaction, partition, topContainer, container);
        }
        ...
        /// <summary>
        /// Build a SQL read query for the current <see cref="TopContainerDao" />
        /// </summary>
        ...
        {
            var sqlBuilder = new StringBuilder();
            sqlBuilder.Append(" LEFT JOIN (SELECT \"TopContainer_Audit\".\"Actor\", \"TopContainer_Audit\".\"Iid\"");
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"TopContainer_Audit\" AS \"TopContainer_Audit\"", partition);
            sqlBuilder.Append(" WHERE \"TopContainer_Audit\".\"ValidTo\" = 'infinity'");
            sqlBuilder.Append(" GROUP BY \"TopContainer_Audit\".\"Iid\", \"TopContainer_Audit\".\"Actor\") AS \"Actor\" USING (\"Iid\")");
            return sqlBuilder.ToString();
        }
        ...
        public override string GetValueTypeSet() => "\"Thing\".\"ValueTypeDictionary\" || \"TopContainer\".\"ValueTypeDictionary\"";
    }
}

// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ParticipantRoleDao.cs" company="Starion Group S.A.">
...
namespace CDP4Orm.Dao
{
    ...
    /// <summary>
    /// The ParticipantRole Data Access Object which acts as an ORM layer to the SQL database.
    /// </summary>
    public partial class ParticipantRoleDao : DefinedThingDao, IParticipantRoleDao
    {
        /// <summary>
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having a list of instances of <see cref="CDP4Common.DTO.ParticipantRole"/> as result.
        /// </returns>
        public virtual async Task<IEnumerable<CDP4Common.DTO.ParticipantRole>> ReadAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false, DateTime? instant = null)
        {
            var result = new List<ParticipantRole>();
            ...
            await using (var command = new NpgsqlCommand())
            {
                ...
                {
                    sqlBuilder.AppendFormat("SELECT \"Jsonb\", \"Actor\" FROM \"{0}\".\"ParticipantRole_Cache\"", partition);
                    ...
                    await using (var reader = await command.ExecuteReaderAsync())
                    {
                        while (await reader.ReadAsync())
                        {
                            ...
                            if (thing != null)
                            {
                                result.Add(thing as ParticipantRole);
                            }
                        }
                    }
                }
        ...
        /// </param>
        /// <returns>
        /// A deserialized instance of <see cref="CDP4Common.DTO.ParticipantRole"/>.
        /// </returns>
        public virtual CDP4Common.DTO.ParticipantRole MapToDto(NpgsqlDataReader reader)
        {
            ...
            var dto = new CDP4Common.DTO.ParticipantRole(iid, revisionNumber);
            ...
            dto.ParticipantPermission.AddRange(Array.ConvertAll((string[])reader["ParticipantPermission"], Guid.Parse));
        ...
        /// The participantRole DTO that is to be persisted.
        /// </param>
        ...
        /// </returns>
        public virtual async Task<bool> WriteAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.ParticipantRole participantRole, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            var beforeWriteResult = await this.BeforeWriteAsync(transaction, partition, participantRole, container, valueTypeDictionaryAdditions);
            ...
            if (!isHandled)
            {
                beforeWrite = beforeWrite && await base.WriteAsync(transaction, partition, participantRole, container);

                var valueTypeDictionaryContents = new Dictionary<string, string>
                {
                    { "IsDeprecated", !this.IsDerived(participantRole, "IsDeprecated") ? participantRole.IsDeprecated.ToString() : string.Empty },
                ...
                await using (var command = new NpgsqlCommand())
                {
                    ...
                    sqlBuilder.AppendFormat("INSERT INTO \"{0}\".\"ParticipantRole\"", partition);
            ...
            return await this.AfterWriteAsync(beforeWrite, transaction, partition, participantRole, container);
        }
        ...
        /// An awaitable <see cref="Task"/> having True if the concept was successfully persisted as result.
        /// </returns>
        public virtual async Task<bool> UpsertAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.ParticipantRole participantRole, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            await base.UpsertAsync(transaction, partition, participantRole, container);
        ...
        /// </param>
        /// <param name="participantRole">
        /// The ParticipantRole DTO that is to be updated.
        /// </param>
        /// <param name="container">
        ...
        /// </returns>
        public virtual async Task<bool> UpdateAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.ParticipantRole participantRole, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            var beforeUpdateResult = await this.BeforeUpdateAsync(transaction, partition, participantRole, container, valueTypeDictionaryAdditions);
            ...
            if (!isHandled)
            {
                beforeUpdate = beforeUpdate && await base.UpdateAsync(transaction, partition, participantRole, container);
            ...
            return await this.AfterUpdateAsync(beforeUpdate, transaction, partition, participantRole, container);
        }
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="CDP4Common.DTO.ParticipantRole"/> id that is to be deleted.
        /// </param>
        /// <returns>
        ...
        /// <summary>
        /// Build a SQL read query for the current <see cref="ParticipantRoleDao" />
        /// </summary>
        ...
        public override string BuildReadQuery(string partition, DateTime? instant)
        {
            ...
            sqlBuilder.Append(" \"ParticipantRole\".\"Container\",");
            ...
            sqlBuilder.Append(" COALESCE(\"ParticipantRole_ParticipantPermission\".\"ParticipantPermission\",'{}'::text[]) AS \"ParticipantPermission\",");
            ...
            sqlBuilder.AppendFormat(" JOIN ({0}) AS \"ParticipantRole\" USING (\"Iid\")", this.GetParticipantRoleDataSql(partition, instant));
            ...
            sqlBuilder.Append(" LEFT JOIN (SELECT \"ParticipantPermission\".\"Container\" AS \"Iid\", array_agg(\"ParticipantPermission\".\"Iid\"::text) AS \"ParticipantPermission\"");
            sqlBuilder.AppendFormat(" FROM ({0}) AS \"ParticipantPermission\"", this.GetParticipantPermissionDataSql(partition, instant));
            sqlBuilder.AppendFormat(" JOIN ({0}) AS \"ParticipantRole\" ON \"ParticipantPermission\".\"Container\" = \"ParticipantRole\".\"Iid\"", this.GetParticipantRoleDataSql(partition, instant));
            sqlBuilder.Append(" GROUP BY \"ParticipantPermission\".\"Container\") AS \"ParticipantRole_ParticipantPermission\" USING (\"Iid\")");
        ...
        {
            var sqlBuilder = new StringBuilder();
            sqlBuilder.Append(" LEFT JOIN (SELECT \"ParticipantRole_Audit\".\"Actor\", \"ParticipantRole_Audit\".\"Iid\"");
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"ParticipantRole_Audit\" AS \"ParticipantRole_Audit\"", partition);
            sqlBuilder.Append(" WHERE \"ParticipantRole_Audit\".\"ValidTo\" = 'infinity'");
            sqlBuilder.Append(" GROUP BY \"ParticipantRole_Audit\".\"Iid\", \"ParticipantRole_Audit\".\"Actor\") AS \"Actor\" USING (\"Iid\")");
            return sqlBuilder.ToString();
        }
        ...
        public override string GetValueTypeSet() => "\"Thing\".\"ValueTypeDictionary\" || \"DefinedThing\".\"ValueTypeDictionary\" || \"ParticipantRole\".\"ValueTypeDictionary\"";
        ...
        /// </param>
        /// <returns>The DataSql string</returns>
        private string GetParticipantPermissionDataSql(string partition, DateTime? instant)
        {
            var sqlBuilder = new StringBuilder();

            var fields = " \"Iid\", \"ValueTypeDictionary\", \"Container\",\"ValidFrom\",\"ValidTo\"";
            sqlBuilder.AppendFormat(" SELECT {0}", fields);
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"ParticipantPermission\"", partition);
            ...
            if (instant.HasValue && instant.Value != DateTime.MaxValue)
            {
                ...
                sqlBuilder.Append(" UNION ALL");
                sqlBuilder.AppendFormat(" SELECT {0}", fields);
                sqlBuilder.AppendFormat(" FROM \"{0}\".\"ParticipantPermission_Audit\"", partition);
                sqlBuilder.Append(" WHERE \"Action\" <> 'I'");
                sqlBuilder.Append(" AND \"ValidFrom\" < :instant");
                sqlBuilder.Append(" AND \"ValidTo\" >= :instant");
            }

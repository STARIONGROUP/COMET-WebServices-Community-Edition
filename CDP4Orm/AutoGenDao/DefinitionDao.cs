...
namespace CDP4Orm.Dao
{
    ...
    public partial class DefinitionDao : ThingDao, IDefinitionDao
    {
        ...
        public override string BuildReadQuery(string partition)
        {
            ...
            sqlBuilder.AppendFormat(" JOIN \"{0}\".\"Definition_Data\"() AS \"Definition\" USING (\"Iid\")", partition);
            ...
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"Citation_Data\"() AS \"Citation\"", partition);
            sqlBuilder.AppendFormat(" JOIN \"{0}\".\"Definition_Data\"() AS \"Definition\" ON \"Citation\".\"Container\" = \"Definition\".\"Iid\"", partition);
            ...
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"Definition_Example_Data\"() AS \"Definition_Example\"", partition);
            sqlBuilder.AppendFormat(" JOIN \"{0}\".\"Definition_Data\"() AS \"Definition\" ON \"Definition\"= \"Iid\"", partition);
            ...
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"Definition_Note_Data\"() AS \"Definition_Note\"", partition);
            sqlBuilder.AppendFormat(" JOIN \"{0}\".\"Definition_Data\"() AS \"Definition\" ON \"Definition\"= \"Iid\"", partition);

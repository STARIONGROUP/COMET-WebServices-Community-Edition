// --------------------------------------------------------------------------------------------------------------------
// <copyright file="PersonRoleDao.cs" company="Starion Group S.A.">
...
namespace CDP4Orm.Dao
{
    ...
    /// <summary>
    /// The PersonRole Data Access Object which acts as an ORM layer to the SQL database.
    /// </summary>
    [ExcludeFromCodeCoverage]
    public partial class PersonRoleDao : DefinedThingDao, IPersonRoleDao
    {
        /// <summary>
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having a list of instances of <see cref="CDP4Common.DTO.PersonRole"/> as result.
        /// </returns>
        public virtual async Task<IEnumerable<CDP4Common.DTO.PersonRole>> ReadAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false, DateTime? instant = null)
        {
            ...
            await using (var command = new NpgsqlCommand())
            {
                ...
                {
                    sqlBuilder.AppendFormat("SELECT \"Jsonb\", \"Actor\" FROM \"{0}\".\"PersonRole_Cache\"", partition);
                    ...
                    await using (var reader = await command.ExecuteReaderAsync())
                    {
                        while (await reader.ReadAsync())
                        {
                            ...
                            if (thing != null)
                            {
                                result.Add(thing as PersonRole);
                            }
                        }
                    }
                }
        ...
        /// </param>
        /// <returns>
        /// A deserialized instance of <see cref="CDP4Common.DTO.PersonRole"/>.
        /// </returns>
        public virtual CDP4Common.DTO.PersonRole MapToDto(NpgsqlDataReader reader)
        {
            ...
            var dto = new CDP4Common.DTO.PersonRole(iid, revisionNumber);
            ...
            dto.PersonPermission.AddRange(Array.ConvertAll((string[])reader["PersonPermission"], Guid.Parse));
        ...
        /// The personRole DTO that is to be persisted.
        /// </param>
        ...
        /// </returns>
        public virtual async Task<bool> WriteAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.PersonRole personRole, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            var beforeWriteResult = await this.BeforeWriteAsync(transaction, partition, personRole, container, valueTypeDictionaryAdditions);
            ...
            if (!isHandled)
            {
                beforeWrite = beforeWrite && await base.WriteAsync(transaction, partition, personRole, container);

                var valueTypeDictionaryContents = new Dictionary<string, string>
                {
                    { "IsDeprecated", !this.IsDerived(personRole, "IsDeprecated") ? personRole.IsDeprecated.ToString() : string.Empty },
                ...
                await using (var command = new NpgsqlCommand())
                {
                    ...
                    sqlBuilder.AppendFormat("INSERT INTO \"{0}\".\"PersonRole\"", partition);
            ...
            return await this.AfterWriteAsync(beforeWrite, transaction, partition, personRole, container);
        }
        ...
        /// An awaitable <see cref="Task"/> having True if the concept was successfully persisted as result.
        /// </returns>
        public virtual async Task<bool> UpsertAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.PersonRole personRole, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            await base.UpsertAsync(transaction, partition, personRole, container);
        ...
        /// </param>
        /// <param name="personRole">
        /// The PersonRole DTO that is to be updated.
        /// </param>
        /// <param name="container">
        ...
        /// </returns>
        public virtual async Task<bool> UpdateAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.PersonRole personRole, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            var beforeUpdateResult = await this.BeforeUpdateAsync(transaction, partition, personRole, container, valueTypeDictionaryAdditions);
            ...
            if (!isHandled)
            {
                beforeUpdate = beforeUpdate && await base.UpdateAsync(transaction, partition, personRole, container);
            ...
            return await this.AfterUpdateAsync(beforeUpdate, transaction, partition, personRole, container);
        }
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="CDP4Common.DTO.PersonRole"/> id that is to be deleted.
        /// </param>
        /// <returns>
        ...
        /// <summary>
        /// Build a SQL read query for the current <see cref="PersonRoleDao" />
        /// </summary>
        ...
        public override string BuildReadQuery(string partition, DateTime? instant)
        {
            ...
            sqlBuilder.Append(" \"PersonRole\".\"Container\",");
            ...
            sqlBuilder.Append(" COALESCE(\"PersonRole_PersonPermission\".\"PersonPermission\",'{}'::text[]) AS \"PersonPermission\",");
            ...
            sqlBuilder.AppendFormat(" JOIN ({0}) AS \"PersonRole\" USING (\"Iid\")", this.GetPersonRoleDataSql(partition, instant));
            ...
            sqlBuilder.Append(" LEFT JOIN (SELECT \"PersonPermission\".\"Container\" AS \"Iid\", array_agg(\"PersonPermission\".\"Iid\"::text) AS \"PersonPermission\"");
            sqlBuilder.AppendFormat(" FROM ({0}) AS \"PersonPermission\"", this.GetPersonPermissionDataSql(partition, instant));
            sqlBuilder.AppendFormat(" JOIN ({0}) AS \"PersonRole\" ON \"PersonPermission\".\"Container\" = \"PersonRole\".\"Iid\"", this.GetPersonRoleDataSql(partition, instant));
            sqlBuilder.Append(" GROUP BY \"PersonPermission\".\"Container\") AS \"PersonRole_PersonPermission\" USING (\"Iid\")");
        ...
        {
            var sqlBuilder = new StringBuilder();
            sqlBuilder.Append(" LEFT JOIN (SELECT \"PersonRole_Audit\".\"Actor\", \"PersonRole_Audit\".\"Iid\"");
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"PersonRole_Audit\" AS \"PersonRole_Audit\"", partition);
            sqlBuilder.Append(" WHERE \"PersonRole_Audit\".\"ValidTo\" = 'infinity'");
            sqlBuilder.Append(" GROUP BY \"PersonRole_Audit\".\"Iid\", \"PersonRole_Audit\".\"Actor\") AS \"Actor\" USING (\"Iid\")");
            return sqlBuilder.ToString();
        }
        ...
        public override string GetValueTypeSet() => "\"Thing\".\"ValueTypeDictionary\" || \"DefinedThing\".\"ValueTypeDictionary\" || \"PersonRole\".\"ValueTypeDictionary\"";
        ...
        /// </param>
        /// <returns>The DataSql string</returns>
        private string GetPersonPermissionDataSql(string partition, DateTime? instant)
        {
            var sqlBuilder = new StringBuilder();

            var fields = " \"Iid\", \"ValueTypeDictionary\", \"Container\",\"ValidFrom\",\"ValidTo\"";
            sqlBuilder.AppendFormat(" SELECT {0}", fields);
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"PersonPermission\"", partition);
            ...
            if (instant.HasValue && instant.Value != DateTime.MaxValue)
            {
                ...
                sqlBuilder.Append(" UNION ALL");
                sqlBuilder.AppendFormat(" SELECT {0}", fields);
                sqlBuilder.AppendFormat(" FROM \"{0}\".\"PersonPermission_Audit\"", partition);
                sqlBuilder.Append(" WHERE \"Action\" <> 'I'");
                sqlBuilder.Append(" AND \"ValidFrom\" < :instant");
                sqlBuilder.Append(" AND \"ValidTo\" >= :instant");
            }

// --------------------------------------------------------------------------------------------------------------------
// <copyright file="IAttachmentDao.cs" company="RHEA System S.A.">
...
namespace CDP4Orm.Dao
{
    ...
    /// <summary>
    /// The Attachment Service Interface which uses the ORM layer to interact with the data model.
    /// </summary>
    public partial interface IAttachmentDao : IDao
    {
        /// <summary>
        ...
        /// </returns>
        IEnumerable<CDP4Common.DTO.Attachment> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false, DateTime? instant = null);
        ...
        /// The <see cref="CDP4Common.DTO.Attachment"/> that is to be persisted.
        /// </param> 
        ...
        /// </returns>
        bool Write(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.Attachment attachment, CDP4Common.DTO.Thing container = null);
        ...
        /// True if the concept was successfully persisted.
        /// </returns>
        bool Upsert(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.Attachment attachment, CDP4Common.DTO.Thing container = null);
        ...
        /// </param>
        /// <param name="attachment">
        /// The <see cref="CDP4Common.DTO.Attachment"/> that is to be updated.
        /// </param>
        /// <param name="container">
        ...
        /// </returns>
        bool Update(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.Attachment attachment, CDP4Common.DTO.Thing container = null);
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="CDP4Common.DTO.Attachment"/> id that is the source for the reordered link table record.
        /// </param> 
        /// <param name="value">

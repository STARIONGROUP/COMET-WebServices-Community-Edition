// --------------------------------------------------------------------------------------------------------------------
// <copyright file="IdCorrespondenceDao.cs" company="Starion Group S.A.">
...
namespace CDP4Orm.Dao
{
    ...
    /// <summary>
    /// The IdCorrespondence Data Access Object which acts as an ORM layer to the SQL database.
    /// </summary>
    public partial class IdCorrespondenceDao : ThingDao, IIdCorrespondenceDao
    {
        /// <summary>
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having a list of instances of <see cref="CDP4Common.DTO.IdCorrespondence"/> as result.
        /// </returns>
        public virtual async Task<IEnumerable<CDP4Common.DTO.IdCorrespondence>> ReadAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false, DateTime? instant = null)
        {
            var result = new List<IdCorrespondence>();
            ...
            await using (var command = new NpgsqlCommand())
            {
                ...
                {
                    sqlBuilder.AppendFormat("SELECT \"Jsonb\", \"Actor\" FROM \"{0}\".\"IdCorrespondence_Cache\"", partition);
                    ...
                    await using (var reader = await command.ExecuteReaderAsync())
                    {
                        while (await reader.ReadAsync())
                        {
                            ...
                            if (thing != null)
                            {
                                result.Add(thing as IdCorrespondence);
                            }
                        }
                    }
                }
        ...
        /// </param>
        /// <returns>
        /// A deserialized instance of <see cref="CDP4Common.DTO.IdCorrespondence"/>.
        /// </returns>
        public virtual CDP4Common.DTO.IdCorrespondence MapToDto(NpgsqlDataReader reader)
        {
            string tempExternalId;
            string tempInternalThing;
            ...
            var dto = new CDP4Common.DTO.IdCorrespondence(iid, revisionNumber);
            dto.Actor = reader["Actor"] is DBNull ? (Guid?)null : Guid.Parse(reader["Actor"].ToString());
            dto.ExcludedDomain.AddRange(Array.ConvertAll((string[])reader["ExcludedDomain"], Guid.Parse));
            dto.ExcludedPerson.AddRange(Array.ConvertAll((string[])reader["ExcludedPerson"], Guid.Parse));

            if (valueDict.TryGetValue("ExternalId", out tempExternalId))
            {
                dto.ExternalId = tempExternalId.UnEscape();
            }

            if (valueDict.TryGetValue("InternalThing", out tempInternalThing))
            {
                dto.InternalThing = Guid.Parse(tempInternalThing);
            }
        ...
        /// The idCorrespondence DTO that is to be persisted.
        /// </param>
        ...
        /// </returns>
        public virtual async Task<bool> WriteAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.IdCorrespondence idCorrespondence, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            var beforeWriteResult = await this.BeforeWriteAsync(transaction, partition, idCorrespondence, container, valueTypeDictionaryAdditions);
            ...
            if (!isHandled)
            {
                beforeWrite = beforeWrite && await base.WriteAsync(transaction, partition, idCorrespondence, container);

                var valueTypeDictionaryContents = new Dictionary<string, string>
                {
                    { "ExternalId", !this.IsDerived(idCorrespondence, "ExternalId") ? idCorrespondence.ExternalId.Escape() : string.Empty },
                    { "InternalThing", !this.IsDerived(idCorrespondence, "InternalThing") ? idCorrespondence.InternalThing.ToString() : string.Empty },
                ...
                await using (var command = new NpgsqlCommand())
                {
                    ...
                    sqlBuilder.AppendFormat("INSERT INTO \"{0}\".\"IdCorrespondence\"", partition);
            ...
            return await this.AfterWriteAsync(beforeWrite, transaction, partition, idCorrespondence, container);
        }
        ...
        /// An awaitable <see cref="Task"/> having True if the concept was successfully persisted as result.
        /// </returns>
        public virtual async Task<bool> UpsertAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.IdCorrespondence idCorrespondence, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            await base.UpsertAsync(transaction, partition, idCorrespondence, container);
        ...
        /// </param>
        /// <param name="idCorrespondence">
        /// The IdCorrespondence DTO that is to be updated.
        /// </param>
        /// <param name="container">
        ...
        /// </returns>
        public virtual async Task<bool> UpdateAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.IdCorrespondence idCorrespondence, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            var beforeUpdateResult = await this.BeforeUpdateAsync(transaction, partition, idCorrespondence, container, valueTypeDictionaryAdditions);
            ...
            if (!isHandled)
            {
                beforeUpdate = beforeUpdate && await base.UpdateAsync(transaction, partition, idCorrespondence, container);
            ...
            return await this.AfterUpdateAsync(beforeUpdate, transaction, partition, idCorrespondence, container);
        }
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="CDP4Common.DTO.IdCorrespondence"/> id that is to be deleted.
        /// </param>
        /// <returns>
        ...
        /// <summary>
        /// Build a SQL read query for the current <see cref="IdCorrespondenceDao" />
        /// </summary>
        ...
        public override string BuildReadQuery(string partition, DateTime? instant)
        {
            ...
            sqlBuilder.Append(" \"IdCorrespondence\".\"Container\",");
            ...
            sqlBuilder.AppendFormat(" JOIN ({0}) AS \"IdCorrespondence\" USING (\"Iid\")", this.GetIdCorrespondenceDataSql(partition, instant));
        ...
        {
            var sqlBuilder = new StringBuilder();
            sqlBuilder.Append(" LEFT JOIN (SELECT \"IdCorrespondence_Audit\".\"Actor\", \"IdCorrespondence_Audit\".\"Iid\"");
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"IdCorrespondence_Audit\" AS \"IdCorrespondence_Audit\"", partition);
            sqlBuilder.Append(" WHERE \"IdCorrespondence_Audit\".\"ValidTo\" = 'infinity'");
            sqlBuilder.Append(" GROUP BY \"IdCorrespondence_Audit\".\"Iid\", \"IdCorrespondence_Audit\".\"Actor\") AS \"Actor\" USING (\"Iid\")");
            return sqlBuilder.ToString();
        }
        ...
        public override string GetValueTypeSet() => "\"Thing\".\"ValueTypeDictionary\" || \"IdCorrespondence\".\"ValueTypeDictionary\"";

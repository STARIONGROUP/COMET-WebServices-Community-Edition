// --------------------------------------------------------------------------------------------------------------------
// <copyright file="AliasDao.cs" company="Starion Group S.A.">
...
namespace CDP4Orm.Dao
{
    ...
    /// <summary>
    /// The Alias Data Access Object which acts as an ORM layer to the SQL database.
    /// </summary>
    public partial class AliasDao : ThingDao, IAliasDao
    {
        /// <summary>
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having a list of instances of <see cref="CDP4Common.DTO.Alias"/> as result.
        /// </returns>
        public virtual async Task<IEnumerable<CDP4Common.DTO.Alias>> ReadAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false, DateTime? instant = null)
        {
        ...
        /// </param>
        /// <returns>
        /// A deserialized instance of <see cref="CDP4Common.DTO.Alias"/>.
        /// </returns>
        public virtual CDP4Common.DTO.Alias MapToDto(NpgsqlDataReader reader)
        {
            string tempContent;
            string tempIsSynonym;
            ...
            var dto = new CDP4Common.DTO.Alias(iid, revisionNumber);
            ...
            if (valueDict.TryGetValue("IsSynonym", out tempIsSynonym))
            {
                dto.IsSynonym = bool.Parse(tempIsSynonym);
            }
        ...
        /// </returns>
        public virtual async Task<bool> WriteAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.Alias alias, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            var beforeWriteResult = await this.BeforeWriteAsync(transaction, partition, alias, container, valueTypeDictionaryAdditions);
            ...
            if (!isHandled)
            {
                beforeWrite = beforeWrite && await base.WriteAsync(transaction, partition, alias, container);
            ...
            return await this.AfterWriteAsync(beforeWrite, transaction, partition, alias, container);
        }
        ...
        /// An awaitable <see cref="Task"/> having True if the concept was successfully persisted as result.
        /// </returns>
        public virtual async Task<bool> UpsertAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.Alias alias, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            await base.UpsertAsync(transaction, partition, alias, container);
        ...
        /// </param>
        /// <param name="alias">
        /// The Alias DTO that is to be updated.
        /// </param>
        /// <param name="container">
        ...
        /// </returns>
        public virtual async Task<bool> UpdateAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.Alias alias, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            var beforeUpdateResult = await this.BeforeUpdateAsync(transaction, partition, alias, container, valueTypeDictionaryAdditions);
            ...
            if (!isHandled)
            {
                beforeUpdate = beforeUpdate && await base.UpdateAsync(transaction, partition, alias, container);
            ...
            return await this.AfterUpdateAsync(beforeUpdate, transaction, partition, alias, container);
        }
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="CDP4Common.DTO.Alias"/> id that is to be deleted.
        /// </param>
        /// <returns>
        ...
        /// <summary>
        /// Build a SQL read query for the current <see cref="AliasDao" />
        /// </summary>
        ...
        public override string BuildReadQuery(string partition, DateTime? instant)
        {
            ...
            sqlBuilder.Append(" \"Alias\".\"Container\",");
            ...
            sqlBuilder.AppendFormat(" JOIN ({0}) AS \"Alias\" USING (\"Iid\")", this.GetAliasDataSql(partition, instant));
        ...
        {
            var sqlBuilder = new StringBuilder();
            sqlBuilder.Append(" LEFT JOIN (SELECT \"Alias_Audit\".\"Actor\", \"Alias_Audit\".\"Iid\"");
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"Alias_Audit\" AS \"Alias_Audit\"", partition);
            sqlBuilder.Append(" WHERE \"Alias_Audit\".\"ValidTo\" = 'infinity'");
            sqlBuilder.Append(" GROUP BY \"Alias_Audit\".\"Iid\", \"Alias_Audit\".\"Actor\") AS \"Actor\" USING (\"Iid\")");
            return sqlBuilder.ToString();
        }
        ...
        public override string GetValueTypeSet() => "\"Thing\".\"ValueTypeDictionary\" || \"Alias\".\"ValueTypeDictionary\"";

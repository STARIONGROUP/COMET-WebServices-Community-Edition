...
namespace CDP4Orm.Dao
{
    ...
    public partial interface IQuantityKindFactorDao : IDao
    {
        ...
        /// </returns>
        IEnumerable<CDP4Common.DTO.QuantityKindFactor> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false);

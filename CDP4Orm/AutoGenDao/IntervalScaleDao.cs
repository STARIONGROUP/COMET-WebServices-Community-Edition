...
namespace CDP4Orm.Dao
{
    ...
    public partial class IntervalScaleDao : MeasurementScaleDao, IIntervalScaleDao
    {
        ...
        /// </returns>
        public virtual IEnumerable<CDP4Common.DTO.IntervalScale> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false)
        {
        ...
        public override string BuildReadQuery(string partition)
        {
            ...
            sqlBuilder.AppendFormat(" JOIN \"{0}\".\"IntervalScale_Data\"() AS \"IntervalScale\" USING (\"Iid\")", partition);

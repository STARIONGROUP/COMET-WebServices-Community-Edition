// --------------------------------------------------------------------------------------------------------------------
// <copyright file="SiteDirectoryDataDiscussionItemDao.cs" company="Starion Group S.A.">
...
namespace CDP4Orm.Dao
{
    ...
    public partial class SiteDirectoryDataDiscussionItemDao : DiscussionItemDao, ISiteDirectoryDataDiscussionItemDao
    {
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having a list of instances of <see cref="CDP4Common.DTO.SiteDirectoryDataDiscussionItem"/> as result.
        /// </returns>
        public virtual async Task<IEnumerable<CDP4Common.DTO.SiteDirectoryDataDiscussionItem>> ReadAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false, DateTime? instant = null)
        {
            var result = new List<SiteDirectoryDataDiscussionItem>();
            ...
            await using (var command = new NpgsqlCommand())
            {
                ...
                {
                    sqlBuilder.AppendFormat("SELECT \"Jsonb\", \"Actor\" FROM \"{0}\".\"SiteDirectoryDataDiscussionItem_Cache\"", partition);
                    ...
                    await using (var reader = await command.ExecuteReaderAsync())
                    {
                        while (await reader.ReadAsync())
                        {
                            ...
                            if (thing != null)
                            {
                                result.Add(thing as SiteDirectoryDataDiscussionItem);
                            }
                        }
                    }
                }
        ...
        /// </returns>
        public virtual async Task<bool> WriteAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.SiteDirectoryDataDiscussionItem siteDirectoryDataDiscussionItem, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            var beforeWriteResult = await this.BeforeWriteAsync(transaction, partition, siteDirectoryDataDiscussionItem, container, valueTypeDictionaryAdditions);
            ...
            if (!isHandled)
            {
                beforeWrite = beforeWrite && await base.WriteAsync(transaction, partition, siteDirectoryDataDiscussionItem, container);
            ...
            return await this.AfterWriteAsync(beforeWrite, transaction, partition, siteDirectoryDataDiscussionItem, container);
        }
        ...
        /// An awaitable <see cref="Task"/> having True if the concept was successfully persisted as result.
        /// </returns>
        public virtual async Task<bool> UpsertAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.SiteDirectoryDataDiscussionItem siteDirectoryDataDiscussionItem, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            await base.UpsertAsync(transaction, partition, siteDirectoryDataDiscussionItem, container);
        ...
        /// </returns>
        public virtual async Task<bool> UpdateAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.SiteDirectoryDataDiscussionItem siteDirectoryDataDiscussionItem, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            var beforeUpdateResult = await this.BeforeUpdateAsync(transaction, partition, siteDirectoryDataDiscussionItem, container, valueTypeDictionaryAdditions);
            ...
            if (!isHandled)
            {
                beforeUpdate = beforeUpdate && await base.UpdateAsync(transaction, partition, siteDirectoryDataDiscussionItem, container);
            ...
            return await this.AfterUpdateAsync(beforeUpdate, transaction, partition, siteDirectoryDataDiscussionItem, container);
        }
        ...
        /// <summary>
        /// Build a SQL read query for the current <see cref="SiteDirectoryDataDiscussionItemDao" />
        /// </summary>
        ...
        public override string BuildReadQuery(string partition, DateTime? instant)
        {
            ...
            sqlBuilder.Append(" \"SiteDirectoryDataDiscussionItem\".\"Container\",");
            ...
            sqlBuilder.Append(" \"SiteDirectoryDataDiscussionItem\".\"Author\",");
            ...
            sqlBuilder.AppendFormat(" JOIN ({0}) AS \"SiteDirectoryDataDiscussionItem\" USING (\"Iid\")", this.GetSiteDirectoryDataDiscussionItemDataSql(partition, instant));
        ...
        {
            var sqlBuilder = new StringBuilder();
            sqlBuilder.Append(" LEFT JOIN (SELECT \"SiteDirectoryDataDiscussionItem_Audit\".\"Actor\", \"SiteDirectoryDataDiscussionItem_Audit\".\"Iid\"");
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"SiteDirectoryDataDiscussionItem_Audit\" AS \"SiteDirectoryDataDiscussionItem_Audit\"", partition);
            sqlBuilder.Append(" WHERE \"SiteDirectoryDataDiscussionItem_Audit\".\"ValidTo\" = 'infinity'");
            sqlBuilder.Append(" GROUP BY \"SiteDirectoryDataDiscussionItem_Audit\".\"Iid\", \"SiteDirectoryDataDiscussionItem_Audit\".\"Actor\") AS \"Actor\" USING (\"Iid\")");
            return sqlBuilder.ToString();
        }
        ...
        public override string GetValueTypeSet() => "\"Thing\".\"ValueTypeDictionary\" || \"GenericAnnotation\".\"ValueTypeDictionary\" || \"DiscussionItem\".\"ValueTypeDictionary\" || \"SiteDirectoryDataDiscussionItem\".\"ValueTypeDictionary\"";

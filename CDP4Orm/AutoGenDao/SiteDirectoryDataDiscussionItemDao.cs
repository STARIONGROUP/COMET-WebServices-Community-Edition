...
namespace CDP4Orm.Dao
{
    ...
    public partial class SiteDirectoryDataDiscussionItemDao : DiscussionItemDao, ISiteDirectoryDataDiscussionItemDao
    {
        ...
        public override string BuildReadQuery(string partition)
        {
            ...
            sqlBuilder.AppendFormat(" JOIN \"{0}\".\"DiscussionItem_Data\"() AS \"DiscussionItem\" USING (\"Iid\")", partition);
            sqlBuilder.AppendFormat(" JOIN \"{0}\".\"SiteDirectoryDataDiscussionItem_Data\"() AS \"SiteDirectoryDataDiscussionItem\" USING (\"Iid\")", partition);

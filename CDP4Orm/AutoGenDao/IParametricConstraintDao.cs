...
namespace CDP4Orm.Dao
{
    ...
    public partial interface IParametricConstraintDao : IDao
    {
        ...
        /// </returns>
        IEnumerable<CDP4Common.DTO.ParametricConstraint> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false);

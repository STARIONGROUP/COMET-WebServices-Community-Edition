...
namespace CDP4Orm.Dao
{
    ...
    public partial interface IEngineeringModelDataDiscussionItemDao : IDao
    {
        ...
        /// </returns>
        IEnumerable<CDP4Common.DTO.EngineeringModelDataDiscussionItem> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false);

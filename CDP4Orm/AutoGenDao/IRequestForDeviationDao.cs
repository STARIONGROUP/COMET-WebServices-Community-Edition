...
namespace CDP4Orm.Dao
{
    ...
    public partial interface IRequestForDeviationDao : IDao
    {
        ...
        /// </returns>
        IEnumerable<CDP4Common.DTO.RequestForDeviation> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false);

...
namespace CDP4Orm.Dao
{
    ...
    public partial interface IReferencerRuleDao : IDao
    {
        ...
        /// </returns>
        IEnumerable<CDP4Common.DTO.ReferencerRule> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false);

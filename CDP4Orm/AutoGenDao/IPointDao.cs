...
namespace CDP4Orm.Dao
{
    ...
    public partial interface IPointDao : IDao
    {
        ...
        /// </returns>
        IEnumerable<CDP4Common.DTO.Point> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false);

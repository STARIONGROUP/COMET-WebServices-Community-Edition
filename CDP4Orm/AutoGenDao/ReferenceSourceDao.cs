        ...
        public virtual bool Write(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.ReferenceSource referenceSource, CDP4Common.DTO.Thing container = null)
        {
            ...
            if (!isHandled)
            {
                ...
                using (var command = new NpgsqlCommand())
                {
                    ...
                    sqlBuilder.AppendFormat(" (\"Iid\", \"ValueTypeDictionary\", \"Container\", \"Publisher\", \"PublishedIn\")");
                    sqlBuilder.AppendFormat(" VALUES (:iid, :valueTypeDictionary, :container, :publisher, :publishedIn);");
        ...
        public virtual bool Update(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.ReferenceSource referenceSource, CDP4Common.DTO.Thing container = null)
        {
            ...
            if (!isHandled)
            {
                ...
                using (var command = new NpgsqlCommand())
                {
                    ...
                    sqlBuilder.AppendFormat(" SET (\"Container\", \"Publisher\", \"PublishedIn\", \"ValueTypeDictionary\")");
                    sqlBuilder.AppendFormat(" = (:container, :publisher, :publishedIn, \"ValueTypeDictionary\" || :valueTypeDictionary)");

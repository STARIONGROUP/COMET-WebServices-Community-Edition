...
namespace CDP4Orm.Dao
{
    ...
    public partial class ReferenceSourceDao : DefinedThingDao, IReferenceSourceDao
    {
        ...
        public override string BuildReadQuery(string partition)
        {
            ...
            sqlBuilder.AppendFormat(" JOIN \"{0}\".\"ReferenceSource_Data\"() AS \"ReferenceSource\" USING (\"Iid\")", partition);
            ...
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"ReferenceSource_Category_Data\"() AS \"ReferenceSource_Category\"", partition);
            sqlBuilder.AppendFormat(" JOIN \"{0}\".\"ReferenceSource_Data\"() AS \"ReferenceSource\" ON \"ReferenceSource\" = \"Iid\"", partition);

...
namespace CDP4Orm.Dao
{
    ...
    public partial interface IPersonPermissionDao : IDao
    {
        ...
        /// </returns>
        IEnumerable<CDP4Common.DTO.PersonPermission> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false);

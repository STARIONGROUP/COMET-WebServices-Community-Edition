// --------------------------------------------------------------------------------------------------------------------
// <copyright file="MultiRelationshipRuleDao.cs" company="Starion Group S.A.">
...
namespace CDP4Orm.Dao
{
    ...
    public partial class MultiRelationshipRuleDao : RuleDao, IMultiRelationshipRuleDao
    {
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having a list of instances of <see cref="CDP4Common.DTO.MultiRelationshipRule"/> as result.
        /// </returns>
        public virtual async Task<IEnumerable<CDP4Common.DTO.MultiRelationshipRule>> ReadAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false, DateTime? instant = null)
        {
            var result = new List<MultiRelationshipRule>();
            ...
            await using (var command = new NpgsqlCommand())
            {
                ...
                {
                    sqlBuilder.AppendFormat("SELECT \"Jsonb\", \"Actor\" FROM \"{0}\".\"MultiRelationshipRule_Cache\"", partition);
                    ...
                    await using (var reader = await command.ExecuteReaderAsync())
                    {
                        while (await reader.ReadAsync())
                        {
                            ...
                            if (thing != null)
                            {
                                result.Add(thing as MultiRelationshipRule);
                            }
                        }
                    }
                }
        ...
        /// </returns>
        public virtual async Task<bool> WriteAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.MultiRelationshipRule multiRelationshipRule, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            var beforeWriteResult = await this.BeforeWriteAsync(transaction, partition, multiRelationshipRule, container, valueTypeDictionaryAdditions);
            ...
            if (!isHandled)
            {
                beforeWrite = beforeWrite && await base.WriteAsync(transaction, partition, multiRelationshipRule, container);
                ...
                foreach (var item in multiRelationshipRule.RelatedCategory)
                {
                    await this.AddRelatedCategoryAsync(transaction, partition, multiRelationshipRule.Iid, item);
                }
            }

            return await this.AfterWriteAsync(beforeWrite, transaction, partition, multiRelationshipRule, container);
        }
        ...
        /// An awaitable <see cref="Task"/> having True if the concept was successfully persisted as result.
        /// </returns>
        public virtual async Task<bool> UpsertAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.MultiRelationshipRule multiRelationshipRule, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            await base.UpsertAsync(transaction, partition, multiRelationshipRule, container);
            ...
            foreach (var item in multiRelationshipRule.RelatedCategory)
            {
                await this.UpsertRelatedCategoryAsync(transaction, partition, multiRelationshipRule.Iid, item);
            }
        ...
        public override async Task<bool> AddToCollectionPropertyAsync(NpgsqlTransaction transaction, string partition, string propertyName, Guid iid, object value)
        {
            ...
            switch (propertyName)
            {
                case "RelatedCategory":
                    {
                        isCreated = await this.AddRelatedCategoryAsync(transaction, partition, iid, (Guid)value);
                        break;
                    }
        ...
        /// An awaitable <see cref="Task"/> having True if the value link was successfully created as result.
        /// </returns>
        public async Task<bool> AddRelatedCategoryAsync(NpgsqlTransaction transaction, string partition, Guid iid, Guid relatedCategory)
        {
            await using (var command = new NpgsqlCommand())
            {
                var sqlBuilder = new System.Text.StringBuilder();
        ...
        /// An awaitable <see cref="Task"/> having True if the value link was successfully created as result.
        /// </returns>
        public async Task<bool> UpsertRelatedCategoryAsync(NpgsqlTransaction transaction, string partition, Guid iid, Guid relatedCategory)
        {
            await using (var command = new NpgsqlCommand())
            {
                var sqlBuilder = new System.Text.StringBuilder();
        ...
        /// </returns>
        public virtual async Task<bool> UpdateAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.MultiRelationshipRule multiRelationshipRule, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            var beforeUpdateResult = await this.BeforeUpdateAsync(transaction, partition, multiRelationshipRule, container, valueTypeDictionaryAdditions);
            ...
            if (!isHandled)
            {
                beforeUpdate = beforeUpdate && await base.UpdateAsync(transaction, partition, multiRelationshipRule, container);
            ...
            return await this.AfterUpdateAsync(beforeUpdate, transaction, partition, multiRelationshipRule, container);
        }
        ...
        public override async Task<bool> DeleteFromCollectionPropertyAsync(NpgsqlTransaction transaction, string partition, string propertyName, Guid iid, object value)
        {
            ...
            switch (propertyName)
            {
                case "RelatedCategory":
                    {
                        isDeleted = await this.DeleteRelatedCategoryAsync(transaction, partition, iid, (Guid)value);
                        break;
                    }
        ...
        /// </returns>
        public async Task<bool> DeleteRelatedCategoryAsync(NpgsqlTransaction transaction, string partition, Guid iid, Guid relatedCategory)
        {
            await using (var command = new NpgsqlCommand())
            {
                var sqlBuilder = new System.Text.StringBuilder();
        ...
        /// <summary>
        /// Build a SQL read query for the current <see cref="MultiRelationshipRuleDao" />
        /// </summary>
        ...
        public override string BuildReadQuery(string partition, DateTime? instant)
        {
            ...
            sqlBuilder.Append(" \"MultiRelationshipRule\".\"RelationshipCategory\",");
            ...
            sqlBuilder.Append(" COALESCE(\"MultiRelationshipRule_RelatedCategory\".\"RelatedCategory\",'{}'::text[]) AS \"RelatedCategory\",");
            ...
            sqlBuilder.AppendFormat(" JOIN ({0}) AS \"MultiRelationshipRule\" USING (\"Iid\")", this.GetMultiRelationshipRuleDataSql(partition, instant));
            ...
            sqlBuilder.Append(" LEFT JOIN (SELECT \"MultiRelationshipRule\" AS \"Iid\", array_agg(\"RelatedCategory\"::text) AS \"RelatedCategory\"");
            sqlBuilder.AppendFormat(" FROM ({0}) AS \"MultiRelationshipRule_RelatedCategory\"", this.GetMultiRelationshipRule_RelatedCategoryDataSql(partition, instant));
            sqlBuilder.AppendFormat(" JOIN ({0}) AS \"MultiRelationshipRule\" ON \"MultiRelationshipRule\" = \"Iid\"", this.GetMultiRelationshipRuleDataSql(partition, instant));
            sqlBuilder.Append(" GROUP BY \"MultiRelationshipRule\") AS \"MultiRelationshipRule_RelatedCategory\" USING (\"Iid\")");
        ...
        {
            var sqlBuilder = new StringBuilder();
            sqlBuilder.Append(" LEFT JOIN (SELECT \"MultiRelationshipRule_Audit\".\"Actor\", \"MultiRelationshipRule_Audit\".\"Iid\"");
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"MultiRelationshipRule_Audit\" AS \"MultiRelationshipRule_Audit\"", partition);
            sqlBuilder.Append(" WHERE \"MultiRelationshipRule_Audit\".\"ValidTo\" = 'infinity'");
            sqlBuilder.Append(" GROUP BY \"MultiRelationshipRule_Audit\".\"Iid\", \"MultiRelationshipRule_Audit\".\"Actor\") AS \"Actor\" USING (\"Iid\")");
            return sqlBuilder.ToString();
        }
        ...
        public override string GetValueTypeSet() => "\"Thing\".\"ValueTypeDictionary\" || \"DefinedThing\".\"ValueTypeDictionary\" || \"Rule\".\"ValueTypeDictionary\" || \"MultiRelationshipRule\".\"ValueTypeDictionary\"";
        ...
        /// </param>
        /// <returns>The DataSql string</returns>
        private string GetMultiRelationshipRuleDataSql(string partition, DateTime? instant)
        {
            var sqlBuilder = new StringBuilder();

            var fields = " \"Iid\", \"ValueTypeDictionary\", \"RelationshipCategory\",\"ValidFrom\",\"ValidTo\"";
            sqlBuilder.AppendFormat(" SELECT {0}", fields);
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"MultiRelationshipRule\"", partition);
            ...
            if (instant.HasValue && instant.Value != DateTime.MaxValue)
            {
                ...
                sqlBuilder.Append(" UNION ALL");
                sqlBuilder.AppendFormat(" SELECT {0}", fields);
                sqlBuilder.AppendFormat(" FROM \"{0}\".\"MultiRelationshipRule_Audit\"", partition);
                sqlBuilder.Append(" WHERE \"Action\" <> 'I'");
                sqlBuilder.Append(" AND \"ValidFrom\" < :instant");
                sqlBuilder.Append(" AND \"ValidTo\" >= :instant");
            }
        ...
        /// </param>
        /// <returns>The DataSql string</returns>
        private string GetMultiRelationshipRule_RelatedCategoryDataSql(string partition, DateTime? instant)
        {
            var sqlBuilder = new StringBuilder();

            var fields = "\"MultiRelationshipRule\",\"RelatedCategory\",\"ValidFrom\",\"ValidTo\"";
            sqlBuilder.AppendFormat(" SELECT {0}", fields);
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"MultiRelationshipRule_RelatedCategory\"", partition);
            ...
            if (instant.HasValue && instant.Value != DateTime.MaxValue)
            {
                ...
                sqlBuilder.Append(" UNION ALL");
                sqlBuilder.AppendFormat(" SELECT {0}", fields);
                sqlBuilder.AppendFormat(" FROM \"{0}\".\"MultiRelationshipRule_RelatedCategory_Audit\"", partition);
                sqlBuilder.Append(" WHERE \"Action\" <> 'I'");
                sqlBuilder.Append(" AND \"ValidFrom\" < :instant");
                sqlBuilder.Append(" AND \"ValidTo\" >= :instant");
            }

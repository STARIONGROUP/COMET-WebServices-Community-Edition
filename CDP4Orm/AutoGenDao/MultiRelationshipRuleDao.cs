...
namespace CDP4Orm.Dao
{
    ...
    public partial class MultiRelationshipRuleDao : RuleDao, IMultiRelationshipRuleDao
    {
        ...
        public override string BuildReadQuery(string partition)
        {
            ...
            sqlBuilder.AppendFormat(" JOIN \"{0}\".\"MultiRelationshipRule_Data\"() AS \"MultiRelationshipRule\" USING (\"Iid\")", partition);
            ...
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"MultiRelationshipRule_RelatedCategory_Data\"() AS \"MultiRelationshipRule_RelatedCategory\"", partition);
            sqlBuilder.AppendFormat(" JOIN \"{0}\".\"MultiRelationshipRule_Data\"() AS \"MultiRelationshipRule\" ON \"MultiRelationshipRule\" = \"Iid\"", partition);

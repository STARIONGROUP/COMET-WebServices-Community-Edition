...
namespace CDP4Orm.Dao
{
    ...
    public partial interface IDecompositionRuleDao : IDao
    {
        ...
        /// </returns>
        IEnumerable<CDP4Common.DTO.DecompositionRule> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false);

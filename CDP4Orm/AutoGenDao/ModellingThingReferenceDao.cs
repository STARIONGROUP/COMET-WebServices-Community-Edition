// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ModellingThingReferenceDao.cs" company="Starion Group S.A.">
...
namespace CDP4Orm.Dao
{
    ...
    public partial class ModellingThingReferenceDao : ThingReferenceDao, IModellingThingReferenceDao
    {
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having a list of instances of <see cref="CDP4Common.DTO.ModellingThingReference"/> as result.
        /// </returns>
        public virtual async Task<IEnumerable<CDP4Common.DTO.ModellingThingReference>> ReadAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false, DateTime? instant = null)
        {
            var result = new List<ModellingThingReference>();
            ...
            await using (var command = new NpgsqlCommand())
            {
                ...
                {
                    sqlBuilder.AppendFormat("SELECT \"Jsonb\", \"Actor\" FROM \"{0}\".\"ModellingThingReference_Cache\"", partition);
                    ...
                    await using (var reader = await command.ExecuteReaderAsync())
                    {
                        while (await reader.ReadAsync())
                        {
                            ...
                            if (thing != null)
                            {
                                result.Add(thing as ModellingThingReference);
                            }
                        }
                    }
                }
        ...
        /// </param>
        /// <returns>
        /// A deserialized instance of <see cref="CDP4Common.DTO.ModellingThingReference"/>.
        /// </returns>
        public virtual CDP4Common.DTO.ModellingThingReference MapToDto(NpgsqlDataReader reader)
        {
            ...
            var dto = new CDP4Common.DTO.ModellingThingReference(iid, revisionNumber);
        ...
        /// The modellingThingReference DTO that is to be persisted.
        /// </param>
        ...
        /// </returns>
        public virtual async Task<bool> WriteAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.ModellingThingReference modellingThingReference, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            var beforeWriteResult = await this.BeforeWriteAsync(transaction, partition, modellingThingReference, container, valueTypeDictionaryAdditions);
            ...
            if (!isHandled)
            {
                beforeWrite = beforeWrite && await base.WriteAsync(transaction, partition, modellingThingReference, container);

                await using (var command = new NpgsqlCommand())
                {
                    var sqlBuilder = new System.Text.StringBuilder();

                    sqlBuilder.AppendFormat("INSERT INTO \"{0}\".\"ModellingThingReference\"", partition);
            ...
            return await this.AfterWriteAsync(beforeWrite, transaction, partition, modellingThingReference, container);
        }
        ...
        /// An awaitable <see cref="Task"/> having True if the concept was successfully persisted as result.
        /// </returns>
        public virtual async Task<bool> UpsertAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.ModellingThingReference modellingThingReference, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            await base.UpsertAsync(transaction, partition, modellingThingReference, container);
        ...
        /// </param>
        /// <param name="modellingThingReference">
        /// The ModellingThingReference DTO that is to be updated.
        /// </param>
        /// <param name="container">
        ...
        /// </returns>
        public virtual async Task<bool> UpdateAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.ModellingThingReference modellingThingReference, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            var beforeUpdateResult = await this.BeforeUpdateAsync(transaction, partition, modellingThingReference, container, valueTypeDictionaryAdditions);
            ...
            if (!isHandled)
            {
                beforeUpdate = beforeUpdate && await base.UpdateAsync(transaction, partition, modellingThingReference, container);
            ...
            return await this.AfterUpdateAsync(beforeUpdate, transaction, partition, modellingThingReference, container);
        }
        ...
        /// <summary>
        /// Build a SQL read query for the current <see cref="ModellingThingReferenceDao" />
        /// </summary>
        ...
        public override string BuildReadQuery(string partition, DateTime? instant)
        {
            ...
            sqlBuilder.Append(" \"ModellingThingReference\".\"Container\",");
            ...
            sqlBuilder.AppendFormat(" JOIN ({0}) AS \"ThingReference\" USING (\"Iid\")", this.GetThingReferenceDataSql(partition, instant));
            sqlBuilder.AppendFormat(" JOIN ({0}) AS \"ModellingThingReference\" USING (\"Iid\")", this.GetModellingThingReferenceDataSql(partition, instant));
        ...
        {
            var sqlBuilder = new StringBuilder();
            sqlBuilder.Append(" LEFT JOIN (SELECT \"ModellingThingReference_Audit\".\"Actor\", \"ModellingThingReference_Audit\".\"Iid\"");
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"ModellingThingReference_Audit\" AS \"ModellingThingReference_Audit\"", partition);
            sqlBuilder.Append(" WHERE \"ModellingThingReference_Audit\".\"ValidTo\" = 'infinity'");
            sqlBuilder.Append(" GROUP BY \"ModellingThingReference_Audit\".\"Iid\", \"ModellingThingReference_Audit\".\"Actor\") AS \"Actor\" USING (\"Iid\")");
            return sqlBuilder.ToString();
        }
        ...
        public override string GetValueTypeSet() => "\"Thing\".\"ValueTypeDictionary\" || \"ThingReference\".\"ValueTypeDictionary\" || \"ModellingThingReference\".\"ValueTypeDictionary\"";
        ...
        /// </param>
        /// <returns>The DataSql string</returns>
        private string GetThingReferenceDataSql(string partition, DateTime? instant)
        {
            var sqlBuilder = new StringBuilder();

            var fields = " \"Iid\", \"ValueTypeDictionary\", \"ReferencedThing\",\"ValidFrom\",\"ValidTo\"";
            sqlBuilder.AppendFormat(" SELECT {0}", fields);
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"ThingReference\"", partition);
            ...
            if (instant.HasValue && instant.Value != DateTime.MaxValue)
            {
                ...
                sqlBuilder.Append(" UNION ALL");
                sqlBuilder.AppendFormat(" SELECT {0}", fields);
                sqlBuilder.AppendFormat(" FROM \"{0}\".\"ThingReference_Audit\"", partition);
                sqlBuilder.Append(" WHERE \"Action\" <> 'I'");
                sqlBuilder.Append(" AND \"ValidFrom\" < :instant");
                sqlBuilder.Append(" AND \"ValidTo\" >= :instant");
            }

...
namespace CDP4Orm.Dao
{
    ...
    public partial interface IHyperLinkDao : IDao
    {
        ...
        /// </returns>
        IEnumerable<CDP4Common.DTO.HyperLink> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false);

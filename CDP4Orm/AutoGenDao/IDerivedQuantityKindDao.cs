...
namespace CDP4Orm.Dao
{
    ...
    public partial interface IDerivedQuantityKindDao : IDao
    {
        ...
        /// </returns>
        IEnumerable<CDP4Common.DTO.DerivedQuantityKind> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false, DateTime? instant = null);
        ...
        /// </returns>
        bool Update(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.DerivedQuantityKind derivedQuantityKind, CDP4Common.DTO.Thing container = null);

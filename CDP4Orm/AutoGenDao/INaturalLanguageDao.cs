// --------------------------------------------------------------------------------------------------------------------
// <copyright file="INaturalLanguageDao.cs" company="Starion Group S.A.">
...
namespace CDP4Orm.Dao
{
    ...
    /// <summary>
    /// The NaturalLanguage Service Interface which uses the ORM layer to interact with the data model.
    /// </summary>
    public partial interface INaturalLanguageDao : IDao
    {
        /// <summary>
        ...
        /// </returns>
        Task<IEnumerable<CDP4Common.DTO.NaturalLanguage>> ReadAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false, DateTime? instant = null);
        ...
        /// The <see cref="CDP4Common.DTO.NaturalLanguage"/> that is to be persisted.
        /// </param> 
        ...
        /// </returns>
        Task<bool> WriteAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.NaturalLanguage naturalLanguage, CDP4Common.DTO.Thing container = null);
        ...
        /// An awaitable <see cref="Task"/> having True if the concept was successfully persisted as result.
        /// </returns>
        Task<bool> UpsertAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.NaturalLanguage naturalLanguage, CDP4Common.DTO.Thing container = null);
        ...
        /// </param>
        /// <param name="naturalLanguage">
        /// The <see cref="CDP4Common.DTO.NaturalLanguage"/> that is to be updated.
        /// </param>
        /// <param name="container">
        ...
        /// An awaitable <see cref="Task"/> having True if the concept was successfully persisted as result.
        /// </returns>
        Task<bool> UpdateAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.NaturalLanguage naturalLanguage, CDP4Common.DTO.Thing container = null);
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="CDP4Common.DTO.NaturalLanguage"/> id that is the source for the reordered link table record.
        /// </param> 
        /// <param name="value">
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="CDP4Common.DTO.NaturalLanguage"/> id that is the source of each link table record.
        /// </param> 
        /// <param name="value">

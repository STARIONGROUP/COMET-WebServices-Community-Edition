...
namespace CDP4Orm.Dao
{
    ...
    public partial interface INaturalLanguageDao : IDao
    {
        ...
        /// </returns>
        IEnumerable<CDP4Common.DTO.NaturalLanguage> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false);

...
namespace CDP4Orm.Dao
{
    ...
    public partial interface ISiteLogEntryDao : IDao
    {
        ...
        /// </returns>
        IEnumerable<CDP4Common.DTO.SiteLogEntry> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false);

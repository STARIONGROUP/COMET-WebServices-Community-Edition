...
namespace CDP4Orm.Dao
{
    ...
    public partial interface IRelationalExpressionDao : IDao
    {
        ...
        /// </returns>
        IEnumerable<CDP4Common.DTO.RelationalExpression> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false);

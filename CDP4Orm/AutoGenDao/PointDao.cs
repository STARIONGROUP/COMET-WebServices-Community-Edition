// --------------------------------------------------------------------------------------------------------------------
// <copyright file="PointDao.cs" company="Starion Group S.A.">
...
namespace CDP4Orm.Dao
{
    ...
    /// <summary>
    /// The Point Data Access Object which acts as an ORM layer to the SQL database.
    /// </summary>
    [ExcludeFromCodeCoverage]
    public partial class PointDao : DiagramThingBaseDao, IPointDao
    {
        /// <summary>
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having a list of instances of <see cref="CDP4Common.DTO.Point"/> as result.
        /// </returns>
        public virtual async Task<IEnumerable<CDP4Common.DTO.Point>> ReadAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false, DateTime? instant = null)
        {
            ...
            await using (var command = new NpgsqlCommand())
            {
                ...
                {
                    sqlBuilder.AppendFormat("SELECT \"Jsonb\", \"Actor\" FROM \"{0}\".\"Point_Cache\"", partition);
        ...
        /// </param>
        /// <returns>
        /// A deserialized instance of <see cref="CDP4Common.DTO.Point"/>.
        /// </returns>
        public virtual CDP4Common.DTO.Point MapToDto(NpgsqlDataReader reader)
        {
            ...
            var dto = new CDP4Common.DTO.Point(iid, revisionNumber);
            ...
            if (valueDict.TryGetValue("X", out tempX))
            {
                dto.X = float.Parse(tempX);
            }

            if (valueDict.TryGetValue("Y", out tempY))
            {
                dto.Y = float.Parse(tempY);
            }
        ...
        /// </param>
        /// <param name="point">
        /// The point DTO that is to be persisted.
        /// </param>
        /// <param name="sequence">
        ...
        /// </returns>
        public virtual async Task<bool> WriteAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.Point point, long sequence, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            var beforeWriteResult = await this.BeforeWriteAsync(transaction, partition, point, container, valueTypeDictionaryAdditions);
            ...
            if (!isHandled)
            {
                beforeWrite = beforeWrite && await base.WriteAsync(transaction, partition, point, container);

                var valueTypeDictionaryContents = new Dictionary<string, string>
                {
                    { "X", !this.IsDerived(point, "X") ? point.X.ToString() : string.Empty },
                    { "Y", !this.IsDerived(point, "Y") ? point.Y.ToString() : string.Empty },
                ...
                await using (var command = new NpgsqlCommand())
                {
                    ...
                    sqlBuilder.AppendFormat("INSERT INTO \"{0}\".\"Point\"", partition);
            ...
            return await this.AfterWriteAsync(beforeWrite, transaction, partition, point, container);
        }
        ...
        /// An awaitable <see cref="Task"/> having True if the concept was successfully persisted as result.
        /// </returns>
        public virtual async Task<bool> UpsertAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.Point point, long sequence, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            await base.UpsertAsync(transaction, partition, point, container);
        ...
        /// </param>
        /// <param name="point">
        /// The Point DTO that is to be updated.
        /// </param>
        /// <param name="container">
        ...
        /// </returns>
        public virtual async Task<bool> UpdateAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.Point point, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            var beforeUpdateResult = await this.BeforeUpdateAsync(transaction, partition, point, container, valueTypeDictionaryAdditions);
            ...
            if (!isHandled)
            {
                beforeUpdate = beforeUpdate && await base.UpdateAsync(transaction, partition, point, container);
            ...
            return await this.AfterUpdateAsync(beforeUpdate, transaction, partition, point, container);
        }
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="CDP4Common.DTO.Point"/> id that is to be deleted.
        /// </param>
        /// <returns>
        ...
        /// <summary>
        /// Build a SQL read query for the current <see cref="PointDao" />
        /// </summary>
        ...
        public override string BuildReadQuery(string partition, DateTime? instant)
        {
            ...
            sqlBuilder.Append(" \"Point\".\"Container\",");

            sqlBuilder.Append(" \"Point\".\"Sequence\",");
            ...
            sqlBuilder.AppendFormat(" JOIN ({0}) AS \"Point\" USING (\"Iid\")", this.GetPointDataSql(partition, instant));
        ...
        {
            var sqlBuilder = new StringBuilder();
            sqlBuilder.Append(" LEFT JOIN (SELECT \"Point_Audit\".\"Actor\", \"Point_Audit\".\"Iid\"");
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"Point_Audit\" AS \"Point_Audit\"", partition);
            sqlBuilder.Append(" WHERE \"Point_Audit\".\"ValidTo\" = 'infinity'");
            sqlBuilder.Append(" GROUP BY \"Point_Audit\".\"Iid\", \"Point_Audit\".\"Actor\") AS \"Actor\" USING (\"Iid\")");
            return sqlBuilder.ToString();
        }
        ...
        public override string GetValueTypeSet() => "\"Thing\".\"ValueTypeDictionary\" || \"DiagramThingBase\".\"ValueTypeDictionary\" || \"Point\".\"ValueTypeDictionary\"";

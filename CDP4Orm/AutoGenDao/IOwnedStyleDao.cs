...
namespace CDP4Orm.Dao
{
    ...
    public partial interface IOwnedStyleDao : IDao
    {
        ...
        /// </returns>
        IEnumerable<CDP4Common.DTO.OwnedStyle> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false);

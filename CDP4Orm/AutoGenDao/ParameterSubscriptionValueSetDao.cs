...
namespace CDP4Orm.Dao
{
    ...
    public partial class ParameterSubscriptionValueSetDao : ThingDao, IParameterSubscriptionValueSetDao
    {
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="CDP4Common.DTO.ParameterSubscriptionValueSet"/>.
        /// </returns>
        public virtual IEnumerable<CDP4Common.DTO.ParameterSubscriptionValueSet> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false, DateTime? instant = null)
        {
                ...
                if (isCachedDtoReadEnabledAndInstant)
                {
                    ...
                    using (var reader = command.ExecuteReader())
                    {
                        while (reader.Read())
                        {
                            ...
                            if (thing != null)
                            {
                                yield return thing as ParameterSubscriptionValueSet;
                            }
                        }
                    }
                }
        ...
        /// </returns>
        public virtual bool Write(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.ParameterSubscriptionValueSet parameterSubscriptionValueSet, CDP4Common.DTO.Thing container = null)
        {
            bool isHandled;
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            var beforeWrite = this.BeforeWrite(transaction, partition, parameterSubscriptionValueSet, container, out isHandled, valueTypeDictionaryAdditions);
            if (!isHandled)
            {
                beforeWrite = beforeWrite && base.Write(transaction, partition, parameterSubscriptionValueSet, container);
            ...
            return this.AfterWrite(beforeWrite, transaction, partition, parameterSubscriptionValueSet, container);
        }
        ...
        /// True if the concept was successfully persisted.
        /// </returns>
        public virtual bool Upsert(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.ParameterSubscriptionValueSet parameterSubscriptionValueSet, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            base.Upsert(transaction, partition, parameterSubscriptionValueSet, container);

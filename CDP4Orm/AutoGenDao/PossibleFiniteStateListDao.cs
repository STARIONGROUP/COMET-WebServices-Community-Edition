// --------------------------------------------------------------------------------------------------------------------
// <copyright file="PossibleFiniteStateListDao.cs" company="Starion Group S.A.">
...
namespace CDP4Orm.Dao
{
    ...
    /// <summary>
    /// The PossibleFiniteStateList Data Access Object which acts as an ORM layer to the SQL database.
    /// </summary>
    public partial class PossibleFiniteStateListDao : DefinedThingDao, IPossibleFiniteStateListDao
    {
        /// <summary>
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having a list of instances of <see cref="CDP4Common.DTO.PossibleFiniteStateList"/> as result.
        /// </returns>
        public virtual async Task<IEnumerable<CDP4Common.DTO.PossibleFiniteStateList>> ReadAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false, DateTime? instant = null)
        {
            var result = new List<PossibleFiniteStateList>();
            ...
            await using (var command = new NpgsqlCommand())
            {
                ...
                {
                    sqlBuilder.AppendFormat("SELECT \"Jsonb\", \"Actor\" FROM \"{0}\".\"PossibleFiniteStateList_Cache\"", partition);
                    ...
                    await using (var reader = await command.ExecuteReaderAsync())
                    {
                        while (await reader.ReadAsync())
                        {
                            ...
                            if (thing != null)
                            {
                                result.Add(thing as PossibleFiniteStateList);
                            }
                        }
                    }
                }
        ...
        /// </param>
        /// <returns>
        /// A deserialized instance of <see cref="CDP4Common.DTO.PossibleFiniteStateList"/>.
        /// </returns>
        public virtual CDP4Common.DTO.PossibleFiniteStateList MapToDto(NpgsqlDataReader reader)
        {
            ...
            dto.PossibleState.AddRange(Utils.ParseOrderedList<Guid>(reader["PossibleState"] as string[,]));
        ...
        /// The possibleFiniteStateList DTO that is to be persisted.
        /// </param>
        ...
        /// </returns>
        public virtual async Task<bool> WriteAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.PossibleFiniteStateList possibleFiniteStateList, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            var beforeWriteResult = await this.BeforeWriteAsync(transaction, partition, possibleFiniteStateList, container, valueTypeDictionaryAdditions);
            ...
            if (!isHandled)
            {
                beforeWrite = beforeWrite && await base.WriteAsync(transaction, partition, possibleFiniteStateList, container);
                ...
                foreach (var item in possibleFiniteStateList.Category)
                {
                    await this.AddCategoryAsync(transaction, partition, possibleFiniteStateList.Iid, item);
                }
            }

            return await this.AfterWriteAsync(beforeWrite, transaction, partition, possibleFiniteStateList, container);
        }
        ...
        /// An awaitable <see cref="Task"/> having True if the concept was successfully persisted as result.
        /// </returns>
        public virtual async Task<bool> UpsertAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.PossibleFiniteStateList possibleFiniteStateList, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            await base.UpsertAsync(transaction, partition, possibleFiniteStateList, container);
            ...
            foreach (var item in possibleFiniteStateList.Category)
            {
                await this.UpsertCategoryAsync(transaction, partition, possibleFiniteStateList.Iid, item);
            }
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="CDP4Common.DTO.PossibleFiniteStateList"/> id that will be the source for each link table record.
        /// </param> 
        /// <param name="value">
        ...
        /// </param>
        /// <param name="possibleFiniteStateList">
        /// The PossibleFiniteStateList DTO that is to be updated.
        /// </param>
        /// <param name="container">
        ...
        /// </returns>
        public virtual async Task<bool> UpdateAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.PossibleFiniteStateList possibleFiniteStateList, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            var beforeUpdateResult = await this.BeforeUpdateAsync(transaction, partition, possibleFiniteStateList, container, valueTypeDictionaryAdditions);
            ...
            if (!isHandled)
            {
                beforeUpdate = beforeUpdate && await base.UpdateAsync(transaction, partition, possibleFiniteStateList, container);

                await using (var command = new NpgsqlCommand())
                {
                    var sqlBuilder = new System.Text.StringBuilder();
                    sqlBuilder.AppendFormat("UPDATE \"{0}\".\"PossibleFiniteStateList\"", partition);
            ...
            return await this.AfterUpdateAsync(beforeUpdate, transaction, partition, possibleFiniteStateList, container);
        }
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="CDP4Common.DTO.PossibleFiniteStateList"/> id that is to be deleted.
        /// </param>
        /// <returns>
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="CDP4Common.DTO.PossibleFiniteStateList"/> id that is the source of each link table record.
        /// </param> 
        /// <param name="value">
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="CDP4Common.DTO.PossibleFiniteStateList"/> id that is the source for each link table record.
        /// </param> 
        /// <param name="category">
        ...
        public async Task<bool> DeleteCategoryAsync(NpgsqlTransaction transaction, string partition, Guid iid, Guid category)
        {
            ...
            {
                var sqlBuilder = new System.Text.StringBuilder();
                sqlBuilder.AppendFormat("DELETE FROM \"{0}\".\"PossibleFiniteStateList_Category\"", partition);
                sqlBuilder.Append(" WHERE \"PossibleFiniteStateList\" = :possibleFiniteStateList");
        ...
        /// <summary>
        /// Build a SQL read query for the current <see cref="PossibleFiniteStateListDao" />
        /// </summary>
        ...
        public override string BuildReadQuery(string partition, DateTime? instant)
        {
            ...
            sqlBuilder.Append(" \"PossibleFiniteStateList\".\"Container\",");

            sqlBuilder.Append(" NULL::bigint AS \"Sequence\",");

            sqlBuilder.Append(" \"Actor\",");

            sqlBuilder.Append(" \"PossibleFiniteStateList\".\"DefaultState\",");

            sqlBuilder.Append(" \"PossibleFiniteStateList\".\"Owner\",");
            ...
            sqlBuilder.Append(" COALESCE(\"PossibleFiniteStateList_Category\".\"Category\",'{}'::text[]) AS \"Category\",");
            sqlBuilder.Append(" COALESCE(\"PossibleFiniteStateList_PossibleState\".\"PossibleState\",'{}'::text[]) AS \"PossibleState\",");
            ...
            sqlBuilder.AppendFormat(" JOIN ({0}) AS \"PossibleFiniteStateList\" USING (\"Iid\")", this.GetPossibleFiniteStateListDataSql(partition, instant));
            ...
            sqlBuilder.Append(" LEFT JOIN (SELECT \"PossibleFiniteStateList\" AS \"Iid\", array_agg(\"Category\"::text) AS \"Category\"");
            sqlBuilder.AppendFormat(" FROM ({0}) AS \"PossibleFiniteStateList_Category\"", this.GetPossibleFiniteStateList_CategoryDataSql(partition, instant));
            sqlBuilder.AppendFormat(" JOIN ({0}) AS \"PossibleFiniteStateList\" ON \"PossibleFiniteStateList\" = \"Iid\"", this.GetPossibleFiniteStateListDataSql(partition, instant));
            sqlBuilder.Append(" GROUP BY \"PossibleFiniteStateList\") AS \"PossibleFiniteStateList_Category\" USING (\"Iid\")");

            sqlBuilder.Append(" LEFT JOIN (SELECT \"PossibleFiniteState\".\"Container\" AS \"Iid\", ARRAY[array_agg(\"PossibleFiniteState\".\"Sequence\"::text), array_agg(\"PossibleFiniteState\".\"Iid\"::text)] AS \"PossibleState\"");
            sqlBuilder.AppendFormat(" FROM ({0}) AS \"PossibleFiniteState\"", this.GetPossibleFiniteStateDataSql(partition, instant));
            sqlBuilder.AppendFormat(" JOIN ({0}) AS \"PossibleFiniteStateList\" ON \"PossibleFiniteState\".\"Container\" = \"PossibleFiniteStateList\".\"Iid\"", this.GetPossibleFiniteStateListDataSql(partition, instant));
            sqlBuilder.Append(" GROUP BY \"PossibleFiniteState\".\"Container\") AS \"PossibleFiniteStateList_PossibleState\" USING (\"Iid\")");
        ...
        {
            var sqlBuilder = new StringBuilder();
            sqlBuilder.Append(" LEFT JOIN (SELECT \"PossibleFiniteStateList_Audit\".\"Actor\", \"PossibleFiniteStateList_Audit\".\"Iid\"");
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"PossibleFiniteStateList_Audit\" AS \"PossibleFiniteStateList_Audit\"", partition);
            sqlBuilder.Append(" WHERE \"PossibleFiniteStateList_Audit\".\"ValidTo\" = 'infinity'");
            sqlBuilder.Append(" GROUP BY \"PossibleFiniteStateList_Audit\".\"Iid\", \"PossibleFiniteStateList_Audit\".\"Actor\") AS \"Actor\" USING (\"Iid\")");
            return sqlBuilder.ToString();
        }
        ...
        public override string GetValueTypeSet() => "\"Thing\".\"ValueTypeDictionary\" || \"DefinedThing\".\"ValueTypeDictionary\" || \"PossibleFiniteStateList\".\"ValueTypeDictionary\"";
        ...
        /// </param>
        /// <returns>The DataSql string</returns>
        private string GetPossibleFiniteStateList_CategoryDataSql(string partition, DateTime? instant)
        {
            var sqlBuilder = new StringBuilder();

            var fields = "\"PossibleFiniteStateList\",\"Category\",\"ValidFrom\",\"ValidTo\"";
            sqlBuilder.AppendFormat(" SELECT {0}", fields);
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"PossibleFiniteStateList_Category\"", partition);
            ...
            if (instant.HasValue && instant.Value != DateTime.MaxValue)
            {
                ...
                sqlBuilder.Append(" UNION ALL");
                sqlBuilder.AppendFormat(" SELECT {0}", fields);
                sqlBuilder.AppendFormat(" FROM \"{0}\".\"PossibleFiniteStateList_Category_Audit\"", partition);
                sqlBuilder.Append(" WHERE \"Action\" <> 'I'");
                sqlBuilder.Append(" AND \"ValidFrom\" < :instant");
                sqlBuilder.Append(" AND \"ValidTo\" >= :instant");
            }

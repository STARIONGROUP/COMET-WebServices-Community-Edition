...
namespace CDP4Orm.Dao
{
    ...
    public partial class EmailAddressDao : ThingDao, IEmailAddressDao
    {
        ...
        /// </returns>
        public virtual IEnumerable<CDP4Common.DTO.EmailAddress> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false)
        {
        ...
        public override string BuildReadQuery(string partition)
        {
            ...
            sqlBuilder.AppendFormat(" JOIN \"{0}\".\"EmailAddress_Data\"() AS \"EmailAddress\" USING (\"Iid\")", partition);

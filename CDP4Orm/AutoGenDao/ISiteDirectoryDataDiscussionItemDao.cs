...
namespace CDP4Orm.Dao
{
    ...
    public partial interface ISiteDirectoryDataDiscussionItemDao : IDao
    {
        ...
        /// </returns>
        IEnumerable<CDP4Common.DTO.SiteDirectoryDataDiscussionItem> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false, DateTime? instant = null);
        ...
        /// </returns>
        bool Update(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.SiteDirectoryDataDiscussionItem siteDirectoryDataDiscussionItem, CDP4Common.DTO.Thing container = null);

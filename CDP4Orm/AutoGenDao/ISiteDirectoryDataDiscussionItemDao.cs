...
namespace CDP4Orm.Dao
{
    ...
    public partial interface ISiteDirectoryDataDiscussionItemDao : IDao
    {
        ...
        /// </returns>
        IEnumerable<CDP4Common.DTO.SiteDirectoryDataDiscussionItem> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false);

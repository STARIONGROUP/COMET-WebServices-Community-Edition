...
namespace CDP4Orm.Dao
{
    ...
    public abstract partial class DefinedThingDao : ThingDao
    {
        ...
        /// <summary>
        /// Build a SQL read query for the current <see cref="DefinedThingDao" />
        /// </summary>
        ...
        {
            var sqlBuilder = new StringBuilder();
            sqlBuilder.Append(" LEFT JOIN (SELECT \"DefinedThing_Audit\".\"Actor\", \"DefinedThing_Audit\".\"Iid\"");
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"DefinedThing_Audit\" AS \"DefinedThing_Audit\"", partition);
            sqlBuilder.Append(" WHERE \"DefinedThing_Audit\".\"ValidTo\" = 'infinity'");
            sqlBuilder.Append(" GROUP BY \"DefinedThing_Audit\".\"Iid\", \"DefinedThing_Audit\".\"Actor\") AS \"Actor\" USING (\"Iid\")");
            return sqlBuilder.ToString();
        }
        ...
        public override string GetValueTypeSet() => "\"Thing\".\"ValueTypeDictionary\" || \"DefinedThing\".\"ValueTypeDictionary\"";
    }
}

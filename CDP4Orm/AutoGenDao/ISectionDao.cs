// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ISectionDao.cs" company="RHEA System S.A.">
...
namespace CDP4Orm.Dao
{
    ...
    /// <summary>
    /// The Section Service Interface which uses the ORM layer to interact with the data model.
    /// </summary>
    public partial interface ISectionDao : IDao
    {
        /// <summary>
        ...
        /// </returns>
        IEnumerable<CDP4Common.DTO.Section> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false);
        ...
        /// </param>
        /// <param name="section">
        /// The <see cref="CDP4Common.DTO.Section"/> that is to be persisted.
        /// </param>
        /// <param name="sequence">
        ...
        /// </param>
        /// <param name="section">
        /// The <see cref="CDP4Common.DTO.Section"/> that is to be updated.
        /// </param>
        /// <param name="container">
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="CDP4Common.DTO.Section"/> id that is the source for the reordered link table record.
        /// </param> 
        /// <param name="value">

...
namespace CDP4Orm.Dao
{
    ...
    public partial interface ISolutionDao : IDao
    {
        ...
        /// </returns>
        IEnumerable<CDP4Common.DTO.Solution> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false);

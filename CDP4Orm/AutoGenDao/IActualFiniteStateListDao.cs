...
namespace CDP4Orm.Dao
{
    ...
    public partial interface IActualFiniteStateListDao : IDao
    {
        ...
        /// </returns>
        IEnumerable<CDP4Common.DTO.ActualFiniteStateList> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false);

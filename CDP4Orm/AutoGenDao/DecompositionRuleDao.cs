...
namespace CDP4Orm.Dao
{
    ...
    public partial class DecompositionRuleDao : RuleDao, IDecompositionRuleDao
    {
        ...
        /// </returns>
        public virtual IEnumerable<CDP4Common.DTO.DecompositionRule> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false)
        {
        ...
        public override string BuildReadQuery(string partition)
        {
            ...
            sqlBuilder.AppendFormat(" JOIN \"{0}\".\"Rule_Data\"() AS \"Rule\" USING (\"Iid\")", partition);
            sqlBuilder.AppendFormat(" JOIN \"{0}\".\"DecompositionRule_Data\"() AS \"DecompositionRule\" USING (\"Iid\")", partition);
            ...
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"DecompositionRule_ContainedCategory_Data\"() AS \"DecompositionRule_ContainedCategory\"", partition);
            sqlBuilder.AppendFormat(" JOIN \"{0}\".\"DecompositionRule_Data\"() AS \"DecompositionRule\" ON \"DecompositionRule\" = \"Iid\"", partition);

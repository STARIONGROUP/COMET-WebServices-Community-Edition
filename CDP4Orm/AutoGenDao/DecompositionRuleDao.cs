// --------------------------------------------------------------------------------------------------------------------
// <copyright file="DecompositionRuleDao.cs" company="Starion Group S.A.">
...
namespace CDP4Orm.Dao
{
    ...
    /// <summary>
    /// The DecompositionRule Data Access Object which acts as an ORM layer to the SQL database.
    /// </summary>
    [ExcludeFromCodeCoverage]
    public partial class DecompositionRuleDao : RuleDao, IDecompositionRuleDao
    {
        /// <summary>
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having a list of instances of <see cref="CDP4Common.DTO.DecompositionRule"/> as result.
        /// </returns>
        public virtual async Task<IEnumerable<CDP4Common.DTO.DecompositionRule>> ReadAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false, DateTime? instant = null)
        {
            var result = new List<DecompositionRule>();
                ...
                if (isCachedDtoReadEnabledAndInstant)
                {
                    ...
                    await using (var reader = await command.ExecuteReaderAsync())
                    {
                        while (await reader.ReadAsync())
                        {
                            ...
                            if (thing != null)
                            {
                                result.Add(thing as DecompositionRule);
                            }
                        }
                    }
                }
        ...
        /// </param>
        /// <returns>
        /// A deserialized instance of <see cref="CDP4Common.DTO.DecompositionRule"/>.
        /// </returns>
        public virtual CDP4Common.DTO.DecompositionRule MapToDto(NpgsqlDataReader reader)
        {
            string tempIsDeprecated;
            string tempMaxContained;
            string tempMinContained;
            ...
            if (valueDict.TryGetValue("MaxContained", out tempMaxContained) && tempMaxContained != null)
            {
                dto.MaxContained = int.Parse(tempMaxContained);
            }

            if (valueDict.TryGetValue("MinContained", out tempMinContained))
            {
                dto.MinContained = int.Parse(tempMinContained);
            }
        ...
        /// </returns>
        public virtual async Task<bool> WriteAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.DecompositionRule decompositionRule, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            var beforeWriteResult = await this.BeforeWriteAsync(transaction, partition, decompositionRule, container, valueTypeDictionaryAdditions);
            ...
            if (!isHandled)
            {
                beforeWrite = beforeWrite && await base.WriteAsync(transaction, partition, decompositionRule, container);
                ...
                foreach (var item in decompositionRule.ContainedCategory)
                {
                    await this.AddContainedCategoryAsync(transaction, partition, decompositionRule.Iid, item);
                }
            }

            return await this.AfterWriteAsync(beforeWrite, transaction, partition, decompositionRule, container);
        }
        ...
        /// An awaitable <see cref="Task"/> having True if the concept was successfully persisted as result.
        /// </returns>
        public virtual async Task<bool> UpsertAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.DecompositionRule decompositionRule, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            await base.UpsertAsync(transaction, partition, decompositionRule, container);
            ...
            foreach (var item in decompositionRule.ContainedCategory)
            {
                await this.UpsertContainedCategoryAsync(transaction, partition, decompositionRule.Iid, item);
            }
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="CDP4Common.DTO.DecompositionRule"/> id that will be the source for each link table record.
        /// </param> 
        /// <param name="value">
        ...
        public override async Task<bool> AddToCollectionPropertyAsync(NpgsqlTransaction transaction, string partition, string propertyName, Guid iid, object value)
        {
            ...
            switch (propertyName)
            {
                case "ContainedCategory":
                    {
                        isCreated = await this.AddContainedCategoryAsync(transaction, partition, iid, (Guid)value);
                        break;
                    }
        ...
        /// The <see cref="CDP4Common.DTO.DecompositionRule"/> id that will be the source for each link table record.
        /// </param> 
        /// <param name="containedCategory">
        /// The value for which a link table record wil be created.
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having True if the value link was successfully created as result.
        /// </returns>
        public async Task<bool> AddContainedCategoryAsync(NpgsqlTransaction transaction, string partition, Guid iid, Guid containedCategory)
        {
            await using (var command = new NpgsqlCommand())
            {
                var sqlBuilder = new System.Text.StringBuilder();
        ...
        /// An awaitable <see cref="Task"/> having True if the value link was successfully created as result.
        /// </returns>
        public async Task<bool> UpsertContainedCategoryAsync(NpgsqlTransaction transaction, string partition, Guid iid, Guid containedCategory)
        {
            await using (var command = new NpgsqlCommand())
            {
                var sqlBuilder = new System.Text.StringBuilder();
        ...
        /// </param>
        /// <param name="decompositionRule">
        /// The DecompositionRule DTO that is to be updated.
        /// </param>
        /// <param name="container">
        ...
        /// </returns>
        public virtual async Task<bool> UpdateAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.DecompositionRule decompositionRule, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            var beforeUpdateResult = await this.BeforeUpdateAsync(transaction, partition, decompositionRule, container, valueTypeDictionaryAdditions);
            ...
            if (!isHandled)
            {
                beforeUpdate = beforeUpdate && await base.UpdateAsync(transaction, partition, decompositionRule, container);
            ...
            return await this.AfterUpdateAsync(beforeUpdate, transaction, partition, decompositionRule, container);
        }
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="CDP4Common.DTO.DecompositionRule"/> id that is to be deleted.
        /// </param>
        /// <returns>
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="CDP4Common.DTO.DecompositionRule"/> id that is the source of each link table record.
        /// </param> 
        /// <param name="value">
        ...
        public override async Task<bool> DeleteFromCollectionPropertyAsync(NpgsqlTransaction transaction, string partition, string propertyName, Guid iid, object value)
        {
            ...
            switch (propertyName)
            {
                case "ContainedCategory":
                    {
                        isDeleted = await this.DeleteContainedCategoryAsync(transaction, partition, iid, (Guid)value);
                        break;
                    }
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="CDP4Common.DTO.DecompositionRule"/> id that is the source for each link table record.
        /// </param> 
        /// <param name="containedCategory">
        ...
        /// </returns>
        public async Task<bool> DeleteContainedCategoryAsync(NpgsqlTransaction transaction, string partition, Guid iid, Guid containedCategory)
        {
            await using (var command = new NpgsqlCommand())
            {
                var sqlBuilder = new System.Text.StringBuilder();
                sqlBuilder.AppendFormat("DELETE FROM \"{0}\".\"DecompositionRule_ContainedCategory\"", partition);
                sqlBuilder.Append(" WHERE \"DecompositionRule\" = :decompositionRule");
                sqlBuilder.Append(" AND \"ContainedCategory\" = :containedCategory;");
        ...
        /// <summary>
        /// Build a SQL read query for the current <see cref="DecompositionRuleDao" />
        /// </summary>
        ...
        public override string BuildReadQuery(string partition, DateTime? instant)
        {
            ...
            sqlBuilder.Append(" COALESCE(\"DecompositionRule_ContainedCategory\".\"ContainedCategory\",'{}'::text[]) AS \"ContainedCategory\",");
            ...
            sqlBuilder.AppendFormat(" JOIN ({0}) AS \"Rule\" USING (\"Iid\")", this.GetRuleDataSql(partition, instant));
            sqlBuilder.AppendFormat(" JOIN ({0}) AS \"DecompositionRule\" USING (\"Iid\")", this.GetDecompositionRuleDataSql(partition, instant));
            ...
            sqlBuilder.Append(" LEFT JOIN (SELECT \"DecompositionRule\" AS \"Iid\", array_agg(\"ContainedCategory\"::text) AS \"ContainedCategory\"");
            sqlBuilder.AppendFormat(" FROM ({0}) AS \"DecompositionRule_ContainedCategory\"", this.GetDecompositionRule_ContainedCategoryDataSql(partition, instant));
            sqlBuilder.AppendFormat(" JOIN ({0}) AS \"DecompositionRule\" ON \"DecompositionRule\" = \"Iid\"", this.GetDecompositionRuleDataSql(partition, instant));
            sqlBuilder.Append(" GROUP BY \"DecompositionRule\") AS \"DecompositionRule_ContainedCategory\" USING (\"Iid\")");
        ...
        {
            var sqlBuilder = new StringBuilder();
            sqlBuilder.Append(" LEFT JOIN (SELECT \"DecompositionRule_Audit\".\"Actor\", \"DecompositionRule_Audit\".\"Iid\"");
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"DecompositionRule_Audit\" AS \"DecompositionRule_Audit\"", partition);
            sqlBuilder.Append(" WHERE \"DecompositionRule_Audit\".\"ValidTo\" = 'infinity'");
            sqlBuilder.Append(" GROUP BY \"DecompositionRule_Audit\".\"Iid\", \"DecompositionRule_Audit\".\"Actor\") AS \"Actor\" USING (\"Iid\")");
            return sqlBuilder.ToString();
        }
        ...
        public override string GetValueTypeSet() => "\"Thing\".\"ValueTypeDictionary\" || \"DefinedThing\".\"ValueTypeDictionary\" || \"Rule\".\"ValueTypeDictionary\" || \"DecompositionRule\".\"ValueTypeDictionary\"";
        ...
        /// </param>
        /// <returns>The DataSql string</returns>
        private string GetDecompositionRuleDataSql(string partition, DateTime? instant)
        {
            var sqlBuilder = new StringBuilder();

            var fields = " \"Iid\", \"ValueTypeDictionary\", \"ContainingCategory\",\"ValidFrom\",\"ValidTo\"";
            sqlBuilder.AppendFormat(" SELECT {0}", fields);
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"DecompositionRule\"", partition);
            ...
            if (instant.HasValue && instant.Value != DateTime.MaxValue)
            {
                ...
                sqlBuilder.Append(" UNION ALL");
                sqlBuilder.AppendFormat(" SELECT {0}", fields);
                sqlBuilder.AppendFormat(" FROM \"{0}\".\"DecompositionRule_Audit\"", partition);
                sqlBuilder.Append(" WHERE \"Action\" <> 'I'");
                sqlBuilder.Append(" AND \"ValidFrom\" < :instant");
                sqlBuilder.Append(" AND \"ValidTo\" >= :instant");
            }
        ...
        /// </param>
        /// <returns>The DataSql string</returns>
        private string GetDecompositionRule_ContainedCategoryDataSql(string partition, DateTime? instant)
        {
            var sqlBuilder = new StringBuilder();

            var fields = "\"DecompositionRule\",\"ContainedCategory\",\"ValidFrom\",\"ValidTo\"";
            sqlBuilder.AppendFormat(" SELECT {0}", fields);
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"DecompositionRule_ContainedCategory\"", partition);
            ...
            if (instant.HasValue && instant.Value != DateTime.MaxValue)
            {
                ...
                sqlBuilder.Append(" UNION ALL");
                sqlBuilder.AppendFormat(" SELECT {0}", fields);
                sqlBuilder.AppendFormat(" FROM \"{0}\".\"DecompositionRule_ContainedCategory_Audit\"", partition);
                sqlBuilder.Append(" WHERE \"Action\" <> 'I'");
                sqlBuilder.Append(" AND \"ValidFrom\" < :instant");
                sqlBuilder.Append(" AND \"ValidTo\" >= :instant");
            }

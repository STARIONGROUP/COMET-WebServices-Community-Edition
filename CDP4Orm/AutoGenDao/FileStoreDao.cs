...
namespace CDP4Orm.Dao
{
    ...
    public abstract partial class FileStoreDao : ThingDao
    {
        ...
        /// <summary>
        /// Build a SQL read query for the current <see cref="FileStoreDao" />
        /// </summary>
        ...
        {
            var sqlBuilder = new StringBuilder();
            sqlBuilder.Append(" LEFT JOIN (SELECT \"FileStore_Audit\".\"Actor\", \"FileStore_Audit\".\"Iid\"");
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"FileStore_Audit\" AS \"FileStore_Audit\"", partition);
            sqlBuilder.Append(" WHERE \"FileStore_Audit\".\"ValidTo\" = 'infinity'");
            sqlBuilder.Append(" GROUP BY \"FileStore_Audit\".\"Iid\", \"FileStore_Audit\".\"Actor\") AS \"Actor\" USING (\"Iid\")");
            return sqlBuilder.ToString();
        }
        ...
        public override string GetValueTypeSet() => "\"Thing\".\"ValueTypeDictionary\" || \"FileStore\".\"ValueTypeDictionary\"";
    }
}

...
namespace CDP4Orm.Dao
{
    ...
    public partial interface ITelephoneNumberDao : IDao
    {
        ...
        /// </returns>
        IEnumerable<CDP4Common.DTO.TelephoneNumber> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false);

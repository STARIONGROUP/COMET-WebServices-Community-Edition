...
namespace CDP4Orm.Dao
{
    ...
    public partial class CitationDao : ThingDao, ICitationDao
    {
        ...
        /// </returns>
        public virtual IEnumerable<CDP4Common.DTO.Citation> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false)
        {
        ...
        public override string BuildReadQuery(string partition)
        {
            ...
            sqlBuilder.AppendFormat(" JOIN \"{0}\".\"Citation_Data\"() AS \"Citation\" USING (\"Iid\")", partition);

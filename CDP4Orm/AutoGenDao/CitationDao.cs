    ...
    public partial class CitationDao : ThingDao, ICitationDao
    {
        ...
        public virtual IEnumerable<CDP4Common.DTO.Citation> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false)
        {
            using (var command = new NpgsqlCommand())
            {
                ...
                {
                    sqlBuilder.AppendFormat("SELECT * FROM \"{0}\".\"Citation_View\"", partition);
        ...
        public virtual bool Update(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.Citation citation, CDP4Common.DTO.Thing container = null)
        {
            ...
            if (!isHandled)
            {
                ...
                using (var command = new NpgsqlCommand())
                {
                    ...
                    sqlBuilder.AppendFormat(" SET (\"Container\", \"Source\", \"ValueTypeDictionary\")");
                    sqlBuilder.AppendFormat(" = (:container, :source, \"ValueTypeDictionary\" || :valueTypeDictionary)");

...
namespace CDP4Orm.Dao
{
    ...
    public partial interface IFileTypeDao : IDao
    {
        ...
        /// </returns>
        IEnumerable<CDP4Common.DTO.FileType> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false);

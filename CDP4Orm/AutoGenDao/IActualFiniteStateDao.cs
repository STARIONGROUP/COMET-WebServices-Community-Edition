...
namespace CDP4Orm.Dao
{
    ...
    public partial interface IActualFiniteStateDao : IDao
    {
        ...
        /// </returns>
        IEnumerable<CDP4Common.DTO.ActualFiniteState> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false);

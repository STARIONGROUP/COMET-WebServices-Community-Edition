...
namespace CDP4Orm.Dao
{
    ...
    public partial class BooleanParameterTypeDao : ScalarParameterTypeDao, IBooleanParameterTypeDao
    {
        ...
        /// </returns>
        public virtual IEnumerable<CDP4Common.DTO.BooleanParameterType> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false)
        {
        ...
        public override string BuildReadQuery(string partition)
        {
            ...
            sqlBuilder.AppendFormat(" JOIN \"{0}\".\"BooleanParameterType_Data\"() AS \"BooleanParameterType\" USING (\"Iid\")", partition);

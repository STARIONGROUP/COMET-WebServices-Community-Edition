...
namespace CDP4Orm.Dao
{
    ...
    public partial class ActionItemDao : ModellingAnnotationItemDao, IActionItemDao
    {
        ...
        /// </returns>
        public virtual IEnumerable<CDP4Common.DTO.ActionItem> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false, DateTime? instant = null)
        {

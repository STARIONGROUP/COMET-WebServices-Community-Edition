...
namespace CDP4Orm.Dao
{
    ...
    public partial interface IModelReferenceDataLibraryDao : IDao
    {
        ...
        /// </returns>
        IEnumerable<CDP4Common.DTO.ModelReferenceDataLibrary> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false);

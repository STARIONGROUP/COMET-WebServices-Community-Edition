// --------------------------------------------------------------------------------------------------------------------
// <copyright file="IModelReferenceDataLibraryDao.cs" company="Starion Group S.A.">
...
namespace CDP4Orm.Dao
{
    ...
    /// </summary>
    public partial interface IModelReferenceDataLibraryDao : IDao
    {
        /// <summary>
        ...
        /// </returns>
        Task<IEnumerable<CDP4Common.DTO.ModelReferenceDataLibrary>> ReadAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false, DateTime? instant = null);
        ...
        /// The <see cref="CDP4Common.DTO.ModelReferenceDataLibrary"/> that is to be persisted.
        /// </param> 
        ...
        /// </returns>
        Task<bool> WriteAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.ModelReferenceDataLibrary modelReferenceDataLibrary, CDP4Common.DTO.Thing container = null);
        ...
        /// An awaitable <see cref="Task"/> having True if the concept was successfully persisted as result.
        /// </returns>
        Task<bool> UpsertAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.ModelReferenceDataLibrary modelReferenceDataLibrary, CDP4Common.DTO.Thing container = null);
        ...
        /// </param>
        /// <param name="modelReferenceDataLibrary">
        /// The <see cref="CDP4Common.DTO.ModelReferenceDataLibrary"/> that is to be updated.
        /// </param>
        /// <param name="container">
        ...
        /// An awaitable <see cref="Task"/> having True if the concept was successfully persisted as result.
        /// </returns>
        Task<bool> UpdateAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.ModelReferenceDataLibrary modelReferenceDataLibrary, CDP4Common.DTO.Thing container = null);
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="CDP4Common.DTO.ModelReferenceDataLibrary"/> id that is the source for the reordered link table record.
        /// </param> 
        /// <param name="value">
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="CDP4Common.DTO.ModelReferenceDataLibrary"/> id that is the source of each link table record.
        /// </param> 
        /// <param name="value">

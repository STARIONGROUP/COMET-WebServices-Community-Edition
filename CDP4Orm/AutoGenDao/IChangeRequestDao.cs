...
namespace CDP4Orm.Dao
{
    ...
    public partial interface IChangeRequestDao : IDao
    {
        ...
        /// </returns>
        IEnumerable<CDP4Common.DTO.ChangeRequest> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false);

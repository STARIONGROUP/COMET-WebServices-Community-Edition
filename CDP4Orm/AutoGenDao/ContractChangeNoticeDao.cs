...
namespace CDP4Orm.Dao
{
    ...
    public partial class ContractChangeNoticeDao : ModellingAnnotationItemDao, IContractChangeNoticeDao
    {
        ...
        /// </returns>
        public virtual IEnumerable<CDP4Common.DTO.ContractChangeNotice> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false, DateTime? instant = null)
        {

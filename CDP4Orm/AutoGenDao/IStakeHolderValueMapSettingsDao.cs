...
namespace CDP4Orm.Dao
{
    ...
    public partial interface IStakeHolderValueMapSettingsDao : IDao
    {
        ...
        /// </returns>
        IEnumerable<CDP4Common.DTO.StakeHolderValueMapSettings> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false);

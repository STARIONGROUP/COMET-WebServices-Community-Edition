...
namespace CDP4Orm.Dao
{
    ...
    public partial class ParticipantPermissionDao : ThingDao, IParticipantPermissionDao
    {
        ...
        /// </returns>
        public virtual IEnumerable<CDP4Common.DTO.ParticipantPermission> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false)
        {
        ...
        public override string BuildReadQuery(string partition)
        {
            ...
            sqlBuilder.AppendFormat(" JOIN \"{0}\".\"ParticipantPermission_Data\"() AS \"ParticipantPermission\" USING (\"Iid\")", partition);

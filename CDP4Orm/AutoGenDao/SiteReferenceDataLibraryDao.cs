...
namespace CDP4Orm.Dao
{
    ...
    public partial class SiteReferenceDataLibraryDao : ReferenceDataLibraryDao, ISiteReferenceDataLibraryDao
    {
        ...
        /// True if the concept was successfully persisted.
        /// </returns>
        public virtual bool Upsert(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.SiteReferenceDataLibrary siteReferenceDataLibrary, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            base.Upsert(transaction, partition, siteReferenceDataLibrary, container);

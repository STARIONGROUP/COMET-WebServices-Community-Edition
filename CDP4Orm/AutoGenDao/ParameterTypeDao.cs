...
namespace CDP4Orm.Dao
{
    ...
    public abstract partial class ParameterTypeDao : DefinedThingDao
    {
        ...
        /// <summary>
        /// Build a SQL read query for the current <see cref="ParameterTypeDao" />
        /// </summary>
        ...
        {
            var sqlBuilder = new StringBuilder();
            sqlBuilder.Append(" LEFT JOIN (SELECT \"ParameterType_Audit\".\"Actor\", \"ParameterType_Audit\".\"Iid\"");
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"ParameterType_Audit\" AS \"ParameterType_Audit\"", partition);
            sqlBuilder.Append(" WHERE \"ParameterType_Audit\".\"ValidTo\" = 'infinity'");
            sqlBuilder.Append(" GROUP BY \"ParameterType_Audit\".\"Iid\", \"ParameterType_Audit\".\"Actor\") AS \"Actor\" USING (\"Iid\")");
            return sqlBuilder.ToString();
        }
        ...
        public override string GetValueTypeSet() => "\"Thing\".\"ValueTypeDictionary\" || \"DefinedThing\".\"ValueTypeDictionary\" || \"ParameterType\".\"ValueTypeDictionary\"";
    }
}

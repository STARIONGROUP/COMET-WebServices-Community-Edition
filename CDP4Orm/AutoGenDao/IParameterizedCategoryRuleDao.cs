...
namespace CDP4Orm.Dao
{
    ...
    public partial interface IParameterizedCategoryRuleDao : IDao
    {
        ...
        /// </returns>
        IEnumerable<CDP4Common.DTO.ParameterizedCategoryRule> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false, DateTime? instant = null);
        ...
        /// </returns>
        bool Update(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.ParameterizedCategoryRule parameterizedCategoryRule, CDP4Common.DTO.Thing container = null);

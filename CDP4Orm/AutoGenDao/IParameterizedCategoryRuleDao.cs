...
namespace CDP4Orm.Dao
{
    ...
    public partial interface IParameterizedCategoryRuleDao : IDao
    {
        ...
        /// </returns>
        IEnumerable<CDP4Common.DTO.ParameterizedCategoryRule> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false);

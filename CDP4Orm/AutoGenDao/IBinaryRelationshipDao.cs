...
namespace CDP4Orm.Dao
{
    ...
    public partial interface IBinaryRelationshipDao : IDao
    {
        ...
        /// </returns>
        IEnumerable<CDP4Common.DTO.BinaryRelationship> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false);

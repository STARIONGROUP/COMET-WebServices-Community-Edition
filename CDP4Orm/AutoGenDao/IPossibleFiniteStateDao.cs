...
namespace CDP4Orm.Dao
{
    ...
    public partial interface IPossibleFiniteStateDao : IDao
    {
        ...
        /// </returns>
        IEnumerable<CDP4Common.DTO.PossibleFiniteState> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false);

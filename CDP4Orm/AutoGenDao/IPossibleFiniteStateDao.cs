...
namespace CDP4Orm.Dao
{
    ...
    public partial interface IPossibleFiniteStateDao : IDao
    {
        ...
        /// </returns>
        IEnumerable<CDP4Common.DTO.PossibleFiniteState> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false, DateTime? instant = null);
        ...
        /// </returns>
        bool Update(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.PossibleFiniteState possibleFiniteState, CDP4Common.DTO.Thing container = null);

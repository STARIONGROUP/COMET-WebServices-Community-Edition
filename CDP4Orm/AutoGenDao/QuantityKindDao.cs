...
namespace CDP4Orm.Dao
{
    ...
    public abstract partial class QuantityKindDao : ScalarParameterTypeDao
    {
        ...
        /// <summary>
        /// Build a SQL read query for the current <see cref="QuantityKindDao" />
        /// </summary>
        ...
        {
            var sqlBuilder = new StringBuilder();
            sqlBuilder.Append(" LEFT JOIN (SELECT \"QuantityKind_Audit\".\"Actor\", \"QuantityKind_Audit\".\"Iid\"");
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"QuantityKind_Audit\" AS \"QuantityKind_Audit\"", partition);
            sqlBuilder.Append(" WHERE \"QuantityKind_Audit\".\"ValidTo\" = 'infinity'");
            sqlBuilder.Append(" GROUP BY \"QuantityKind_Audit\".\"Iid\", \"QuantityKind_Audit\".\"Actor\") AS \"Actor\" USING (\"Iid\")");
            return sqlBuilder.ToString();
        }
        ...
        public override string GetValueTypeSet() => "\"Thing\".\"ValueTypeDictionary\" || \"DefinedThing\".\"ValueTypeDictionary\" || \"ParameterType\".\"ValueTypeDictionary\" || \"ScalarParameterType\".\"ValueTypeDictionary\" || \"QuantityKind\".\"ValueTypeDictionary\"";
    }
}

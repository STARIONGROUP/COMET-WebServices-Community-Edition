...
namespace CDP4Orm.Dao
{
    ...
    public partial class RuleVerificationListDao : DefinedThingDao, IRuleVerificationListDao
    {
        ...
        public override string BuildReadQuery(string partition)
        {
            ...
            sqlBuilder.AppendFormat(" JOIN \"{0}\".\"RuleVerificationList_Data\"() AS \"RuleVerificationList\" USING (\"Iid\")", partition);
            ...
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"RuleVerification_Data\"() AS \"RuleVerification\"", partition);
            sqlBuilder.AppendFormat(" JOIN \"{0}\".\"RuleVerificationList_Data\"() AS \"RuleVerificationList\" ON \"RuleVerification\".\"Container\" = \"RuleVerificationList\".\"Iid\"", partition);

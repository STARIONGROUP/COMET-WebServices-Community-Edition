...
namespace CDP4Orm.Dao
{
    ...
    public partial interface ILogarithmicScaleDao : IDao
    {
        ...
        /// </returns>
        IEnumerable<CDP4Common.DTO.LogarithmicScale> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false, DateTime? instant = null);
        ...
        /// </returns>
        bool Update(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.LogarithmicScale logarithmicScale, CDP4Common.DTO.Thing container = null);

// --------------------------------------------------------------------------------------------------------------------
// <copyright file="UserPreferenceDao.cs" company="Starion Group S.A.">
...
namespace CDP4Orm.Dao
{
    ...
    /// <summary>
    /// The UserPreference Data Access Object which acts as an ORM layer to the SQL database.
    /// </summary>
    [ExcludeFromCodeCoverage]
    public partial class UserPreferenceDao : ThingDao, IUserPreferenceDao
    {
        /// <summary>
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having a list of instances of <see cref="CDP4Common.DTO.UserPreference"/> as result.
        /// </returns>
        public virtual async Task<IEnumerable<CDP4Common.DTO.UserPreference>> ReadAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false, DateTime? instant = null)
        {
            var result = new List<UserPreference>();
            ...
            await using (var command = new NpgsqlCommand())
            {
                ...
                {
                    sqlBuilder.AppendFormat("SELECT \"Jsonb\", \"Actor\" FROM \"{0}\".\"UserPreference_Cache\"", partition);
                    ...
                    await using (var reader = await command.ExecuteReaderAsync())
                    {
                        while (await reader.ReadAsync())
                        {
                            ...
                            if (thing != null)
                            {
                                result.Add(thing as UserPreference);
                            }
                        }
                    }
                }
        ...
        /// </param>
        /// <returns>
        /// A deserialized instance of <see cref="CDP4Common.DTO.UserPreference"/>.
        /// </returns>
        public virtual CDP4Common.DTO.UserPreference MapToDto(NpgsqlDataReader reader)
        {
            ...
            var dto = new CDP4Common.DTO.UserPreference(iid, revisionNumber);
        ...
        /// The userPreference DTO that is to be persisted.
        /// </param>
        ...
        /// </returns>
        public virtual async Task<bool> WriteAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.UserPreference userPreference, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            var beforeWriteResult = await this.BeforeWriteAsync(transaction, partition, userPreference, container, valueTypeDictionaryAdditions);
            ...
            if (!isHandled)
            {
                beforeWrite = beforeWrite && await base.WriteAsync(transaction, partition, userPreference, container);

                var valueTypeDictionaryContents = new Dictionary<string, string>
                {
                    { "ShortName", !this.IsDerived(userPreference, "ShortName") ? userPreference.ShortName.Escape() : string.Empty },
                    { "Value", !this.IsDerived(userPreference, "Value") ? userPreference.Value.Escape() : string.Empty },
                ...
                await using (var command = new NpgsqlCommand())
                {
                    ...
                    sqlBuilder.AppendFormat("INSERT INTO \"{0}\".\"UserPreference\"", partition);
            ...
            return await this.AfterWriteAsync(beforeWrite, transaction, partition, userPreference, container);
        }
        ...
        /// An awaitable <see cref="Task"/> having True if the concept was successfully persisted as result.
        /// </returns>
        public virtual async Task<bool> UpsertAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.UserPreference userPreference, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            await base.UpsertAsync(transaction, partition, userPreference, container);
        ...
        /// </param>
        /// <param name="userPreference">
        /// The UserPreference DTO that is to be updated.
        /// </param>
        /// <param name="container">
        ...
        /// </returns>
        public virtual async Task<bool> UpdateAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.UserPreference userPreference, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            var beforeUpdateResult = await this.BeforeUpdateAsync(transaction, partition, userPreference, container, valueTypeDictionaryAdditions);
            ...
            if (!isHandled)
            {
                beforeUpdate = beforeUpdate && await base.UpdateAsync(transaction, partition, userPreference, container);
            ...
            return await this.AfterUpdateAsync(beforeUpdate, transaction, partition, userPreference, container);
        }
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="CDP4Common.DTO.UserPreference"/> id that is to be deleted.
        /// </param>
        /// <returns>
        ...
        /// <summary>
        /// Build a SQL read query for the current <see cref="UserPreferenceDao" />
        /// </summary>
        ...
        public override string BuildReadQuery(string partition, DateTime? instant)
        {
            ...
            sqlBuilder.Append(" \"UserPreference\".\"Container\",");
            ...
            sqlBuilder.AppendFormat(" JOIN ({0}) AS \"UserPreference\" USING (\"Iid\")", this.GetUserPreferenceDataSql(partition, instant));
        ...
        {
            var sqlBuilder = new StringBuilder();
            sqlBuilder.Append(" LEFT JOIN (SELECT \"UserPreference_Audit\".\"Actor\", \"UserPreference_Audit\".\"Iid\"");
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"UserPreference_Audit\" AS \"UserPreference_Audit\"", partition);
            sqlBuilder.Append(" WHERE \"UserPreference_Audit\".\"ValidTo\" = 'infinity'");
            sqlBuilder.Append(" GROUP BY \"UserPreference_Audit\".\"Iid\", \"UserPreference_Audit\".\"Actor\") AS \"Actor\" USING (\"Iid\")");
            return sqlBuilder.ToString();
        }
        ...
        public override string GetValueTypeSet() => "\"Thing\".\"ValueTypeDictionary\" || \"UserPreference\".\"ValueTypeDictionary\"";

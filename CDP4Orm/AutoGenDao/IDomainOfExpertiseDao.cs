...
namespace CDP4Orm.Dao
{
    ...
    public partial interface IDomainOfExpertiseDao : IDao
    {
        ...
        /// </returns>
        IEnumerable<CDP4Common.DTO.DomainOfExpertise> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false);

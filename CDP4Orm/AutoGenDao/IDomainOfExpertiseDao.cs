...
namespace CDP4Orm.Dao
{
    ...
    public partial interface IDomainOfExpertiseDao : IDao
    {
        ...
        /// </returns>
        IEnumerable<CDP4Common.DTO.DomainOfExpertise> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false, DateTime? instant = null);
        ...
        /// </returns>
        bool Update(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.DomainOfExpertise domainOfExpertise, CDP4Common.DTO.Thing container = null);

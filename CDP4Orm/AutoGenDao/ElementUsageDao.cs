// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ElementUsageDao.cs" company="Starion Group S.A.">
...
namespace CDP4Orm.Dao
{
    ...
    /// <summary>
    /// The ElementUsage Data Access Object which acts as an ORM layer to the SQL database.
    /// </summary>
    public partial class ElementUsageDao : ElementBaseDao, IElementUsageDao
    {
        /// <summary>
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having a list of instances of <see cref="CDP4Common.DTO.ElementUsage"/> as result.
        /// </returns>
        public virtual async Task<IEnumerable<CDP4Common.DTO.ElementUsage>> ReadAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false, DateTime? instant = null)
        {
            var result = new List<ElementUsage>();
            ...
            await using (var command = new NpgsqlCommand())
            {
                ...
                {
                    sqlBuilder.AppendFormat("SELECT \"Jsonb\", \"Actor\" FROM \"{0}\".\"ElementUsage_Cache\"", partition);
                    ...
                    await using (var reader = await command.ExecuteReaderAsync())
                    {
                        while (await reader.ReadAsync())
                        {
                            ...
                            if (thing != null)
                            {
                                result.Add(thing as ElementUsage);
                            }
                        }
                    }
                }
        ...
        /// </returns>
        public virtual async Task<bool> WriteAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.ElementUsage elementUsage, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            var beforeWriteResult = await this.BeforeWriteAsync(transaction, partition, elementUsage, container, valueTypeDictionaryAdditions);
            ...
            if (!isHandled)
            {
                beforeWrite = beforeWrite && await base.WriteAsync(transaction, partition, elementUsage, container);
                ...
                foreach (var item in elementUsage.ExcludeOption)
                {
                    await this.AddExcludeOptionAsync(transaction, partition, elementUsage.Iid, item);
                }
            }

            return await this.AfterWriteAsync(beforeWrite, transaction, partition, elementUsage, container);
        }
        ...
        /// An awaitable <see cref="Task"/> having True if the concept was successfully persisted as result.
        /// </returns>
        public virtual async Task<bool> UpsertAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.ElementUsage elementUsage, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            await base.UpsertAsync(transaction, partition, elementUsage, container);
            ...
            foreach (var item in elementUsage.ExcludeOption)
            {
                await this.UpsertExcludeOptionAsync(transaction, partition, elementUsage.Iid, item);
            }
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="CDP4Common.DTO.ElementUsage"/> id that will be the source for each link table record.
        /// </param> 
        /// <param name="value">
        ...
        /// </returns>
        public virtual async Task<bool> UpdateAsync(NpgsqlTransaction transaction, string partition, CDP4Common.DTO.ElementUsage elementUsage, CDP4Common.DTO.Thing container = null)
        {
            var valueTypeDictionaryAdditions = new Dictionary<string, string>();
            var beforeUpdateResult = await this.BeforeUpdateAsync(transaction, partition, elementUsage, container, valueTypeDictionaryAdditions);
            ...
            if (!isHandled)
            {
                beforeUpdate = beforeUpdate && await base.UpdateAsync(transaction, partition, elementUsage, container);
            ...
            return await this.AfterUpdateAsync(beforeUpdate, transaction, partition, elementUsage, container);
        }
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="CDP4Common.DTO.ElementUsage"/> id that is to be deleted.
        /// </param>
        /// <returns>
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="CDP4Common.DTO.ElementUsage"/> id that is the source of each link table record.
        /// </param> 
        /// <param name="value">
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="CDP4Common.DTO.ElementUsage"/> id that is the source for each link table record.
        /// </param> 
        /// <param name="excludeOption">
        ...
        public async Task<bool> DeleteExcludeOptionAsync(NpgsqlTransaction transaction, string partition, Guid iid, Guid excludeOption)
        {
            ...
            {
                var sqlBuilder = new System.Text.StringBuilder();
                sqlBuilder.AppendFormat("DELETE FROM \"{0}\".\"ElementUsage_ExcludeOption\"", partition);
                sqlBuilder.Append(" WHERE \"ElementUsage\" = :elementUsage");
        ...
        /// <summary>
        /// Build a SQL read query for the current <see cref="ElementUsageDao" />
        /// </summary>
        ...
        public override string BuildReadQuery(string partition, DateTime? instant)
        {
            ...
            sqlBuilder.Append(" \"ElementUsage\".\"Container\",");
            ...
            sqlBuilder.Append(" \"ElementUsage\".\"ElementDefinition\",");
            ...
            sqlBuilder.Append(" COALESCE(\"ElementUsage_ExcludeOption\".\"ExcludeOption\",'{}'::text[]) AS \"ExcludeOption\",");
            sqlBuilder.Append(" COALESCE(\"ElementUsage_ParameterOverride\".\"ParameterOverride\",'{}'::text[]) AS \"ParameterOverride\",");
            ...
            sqlBuilder.AppendFormat(" JOIN ({0}) AS \"ElementUsage\" USING (\"Iid\")", this.GetElementUsageDataSql(partition, instant));
            ...
            sqlBuilder.Append(" LEFT JOIN (SELECT \"ElementUsage\" AS \"Iid\", array_agg(\"ExcludeOption\"::text) AS \"ExcludeOption\"");
            sqlBuilder.AppendFormat(" FROM ({0}) AS \"ElementUsage_ExcludeOption\"", this.GetElementUsage_ExcludeOptionDataSql(partition, instant));
            sqlBuilder.AppendFormat(" JOIN ({0}) AS \"ElementUsage\" ON \"ElementUsage\" = \"Iid\"", this.GetElementUsageDataSql(partition, instant));
            sqlBuilder.Append(" GROUP BY \"ElementUsage\") AS \"ElementUsage_ExcludeOption\" USING (\"Iid\")");

            sqlBuilder.Append(" LEFT JOIN (SELECT \"ParameterOverride\".\"Container\" AS \"Iid\", array_agg(\"ParameterOverride\".\"Iid\"::text) AS \"ParameterOverride\"");
            sqlBuilder.AppendFormat(" FROM ({0}) AS \"ParameterOverride\"", this.GetParameterOverrideDataSql(partition, instant));
            sqlBuilder.AppendFormat(" JOIN ({0}) AS \"ElementUsage\" ON \"ParameterOverride\".\"Container\" = \"ElementUsage\".\"Iid\"", this.GetElementUsageDataSql(partition, instant));
            sqlBuilder.Append(" GROUP BY \"ParameterOverride\".\"Container\") AS \"ElementUsage_ParameterOverride\" USING (\"Iid\")");
        ...
        {
            var sqlBuilder = new StringBuilder();
            sqlBuilder.Append(" LEFT JOIN (SELECT \"ElementUsage_Audit\".\"Actor\", \"ElementUsage_Audit\".\"Iid\"");
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"ElementUsage_Audit\" AS \"ElementUsage_Audit\"", partition);
            sqlBuilder.Append(" WHERE \"ElementUsage_Audit\".\"ValidTo\" = 'infinity'");
            sqlBuilder.Append(" GROUP BY \"ElementUsage_Audit\".\"Iid\", \"ElementUsage_Audit\".\"Actor\") AS \"Actor\" USING (\"Iid\")");
            return sqlBuilder.ToString();
        }
        ...
        public override string GetValueTypeSet() => "\"Thing\".\"ValueTypeDictionary\" || \"DefinedThing\".\"ValueTypeDictionary\" || \"ElementBase\".\"ValueTypeDictionary\" || \"ElementUsage\".\"ValueTypeDictionary\"";
        ...
        /// </param>
        /// <returns>The DataSql string</returns>
        private string GetElementUsage_ExcludeOptionDataSql(string partition, DateTime? instant)
        {
            var sqlBuilder = new StringBuilder();

            var fields = "\"ElementUsage\",\"ExcludeOption\",\"ValidFrom\",\"ValidTo\"";
            sqlBuilder.AppendFormat(" SELECT {0}", fields);
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"ElementUsage_ExcludeOption\"", partition);
            ...
            if (instant.HasValue && instant.Value != DateTime.MaxValue)
            {
                ...
                sqlBuilder.Append(" UNION ALL");
                sqlBuilder.AppendFormat(" SELECT {0}", fields);
                sqlBuilder.AppendFormat(" FROM \"{0}\".\"ElementUsage_ExcludeOption_Audit\"", partition);
                sqlBuilder.Append(" WHERE \"Action\" <> 'I'");
                sqlBuilder.Append(" AND \"ValidFrom\" < :instant");
                sqlBuilder.Append(" AND \"ValidTo\" >= :instant");
            }
        ...
        /// </param>
        /// <returns>The DataSql string</returns>
        private string GetParameterOverrideDataSql(string partition, DateTime? instant)
        {
            var sqlBuilder = new StringBuilder();

            var fields = " \"Iid\", \"ValueTypeDictionary\", \"Container\", \"Parameter\",\"ValidFrom\",\"ValidTo\"";
            sqlBuilder.AppendFormat(" SELECT {0}", fields);
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"ParameterOverride\"", partition);
            ...
            if (instant.HasValue && instant.Value != DateTime.MaxValue)
            {
                ...
                sqlBuilder.Append(" UNION ALL");
                sqlBuilder.AppendFormat(" SELECT {0}", fields);
                sqlBuilder.AppendFormat(" FROM \"{0}\".\"ParameterOverride_Audit\"", partition);
                sqlBuilder.Append(" WHERE \"Action\" <> 'I'");
                sqlBuilder.Append(" AND \"ValidFrom\" < :instant");
                sqlBuilder.Append(" AND \"ValidTo\" >= :instant");
            }

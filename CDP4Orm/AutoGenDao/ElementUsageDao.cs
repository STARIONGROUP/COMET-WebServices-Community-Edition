...
namespace CDP4Orm.Dao
{
    ...
    public partial class ElementUsageDao : ElementBaseDao, IElementUsageDao
    {
        ...
        /// </returns>
        public virtual IEnumerable<CDP4Common.DTO.ElementUsage> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false)
        {
        ...
        public override string BuildReadQuery(string partition)
        {
            ...
            sqlBuilder.AppendFormat(" JOIN \"{0}\".\"ElementUsage_Data\"() AS \"ElementUsage\" USING (\"Iid\")", partition);
            ...
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"ElementUsage_ExcludeOption_Data\"() AS \"ElementUsage_ExcludeOption\"", partition);
            sqlBuilder.AppendFormat(" JOIN \"{0}\".\"ElementUsage_Data\"() AS \"ElementUsage\" ON \"ElementUsage\" = \"Iid\"", partition);
            ...
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"ParameterOverride_Data\"() AS \"ParameterOverride\"", partition);
            sqlBuilder.AppendFormat(" JOIN \"{0}\".\"ElementUsage_Data\"() AS \"ElementUsage\" ON \"ParameterOverride\".\"Container\" = \"ElementUsage\".\"Iid\"", partition);

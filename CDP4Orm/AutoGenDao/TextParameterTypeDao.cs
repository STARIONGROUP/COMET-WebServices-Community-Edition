...
namespace CDP4Orm.Dao
{
    ...
    public partial class TextParameterTypeDao : ScalarParameterTypeDao, ITextParameterTypeDao
    {
        ...
        /// </returns>
        public virtual IEnumerable<CDP4Common.DTO.TextParameterType> Read(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids = null, bool isCachedDtoReadEnabledAndInstant = false)
        {
        ...
        public override string BuildReadQuery(string partition)
        {
            ...
            sqlBuilder.AppendFormat(" JOIN \"{0}\".\"TextParameterType_Data\"() AS \"TextParameterType\" USING (\"Iid\")", partition);

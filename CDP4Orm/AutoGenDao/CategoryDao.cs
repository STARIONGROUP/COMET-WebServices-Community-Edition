...
namespace CDP4Orm.Dao
{
    ...
    public partial class CategoryDao : DefinedThingDao, ICategoryDao
    {
        ...
        public override string BuildReadQuery(string partition)
        {
            ...
            sqlBuilder.AppendFormat(" JOIN \"{0}\".\"Category_Data\"() AS \"Category\" USING (\"Iid\")", partition);
            ...
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"Category_SuperCategory_Data\"() AS \"Category_SuperCategory\"", partition);
            sqlBuilder.AppendFormat(" JOIN \"{0}\".\"Category_Data\"() AS \"Category\" ON \"Category\" = \"Iid\"", partition);
            ...
            sqlBuilder.AppendFormat(" FROM \"{0}\".\"Category_PermissibleClass_Data\"() AS \"Category_PermissibleClass\"", partition);
            sqlBuilder.AppendFormat(" JOIN \"{0}\".\"Category_Data\"() AS \"Category\" ON \"Category\"= \"Iid\"", partition);

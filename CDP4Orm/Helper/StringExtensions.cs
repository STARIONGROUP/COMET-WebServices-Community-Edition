...
namespace CDP4Orm.Helper
{
    ...
    {
        public static string PartitionNamePattern = "^[A-Za-z]+(_[a-z0-9]+)*$";
        ...
        /// </returns>
        public static bool IsValidatePartitionName(this string partitionName)
        {
            return Regex.IsMatch(partitionName, PartitionNamePattern);
        }
    }
}

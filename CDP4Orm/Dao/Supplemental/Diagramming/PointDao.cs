...
namespace CDP4Orm.Dao
{
    ...
    public partial class PointDao
    {
        ...
        {
            //get container DiagramEdge and use that for GetTopDiagramCanvas
            using (var command = new NpgsqlCommand())
            {
                ...
                if (command.ExecuteScalar() is Guid containerId)
                {
                    return this.DiagramCanvasDao.GetTopDiagramCanvas(transaction, partition, containerId);
                }
            }

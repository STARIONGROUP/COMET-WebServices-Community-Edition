...
namespace CDP4Orm.Dao.Revision
{
    ...
    public interface IRevisionDao
    {
        ...
        /// </returns>
        Task<ReadOnlyCollection<RevisionInfo>> ReadAsync(NpgsqlTransaction transaction, string partition, int revision);
        ...
        /// List of instances of <see cref="RevisionInfo"/>.
        /// </returns>
        Task<ReadOnlyCollection<RevisionInfo>> ReadCurrentRevisionChangesAsync(NpgsqlTransaction transaction, string partition, int revision);
        ...
        /// </returns>
        Task<ReadOnlyCollection<RevisionRegistryInfo>> ReadRevisionRegistryAsync(NpgsqlTransaction transaction, string partition);
        ...
        Task<ReadOnlyCollection<Thing>> ReadRevisionAsync(NpgsqlTransaction transaction, string partition, Guid thingIid, int revisionFrom, int revisionTo);
        ...
        Task WriteRevisionAsync(NpgsqlTransaction transaction, string partition, Thing thing, Guid actor);
        ...
        /// <param name="actor">The identifier of the person who made this revision</param>
        Task BulkWriteRevisionAsync(NpgsqlTransaction transaction, string partition, IReadOnlyCollection<Thing> things, Guid actor);
    }
}
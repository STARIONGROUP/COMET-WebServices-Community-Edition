// --------------------------------------------------------------------------------------------------------------------
// <copyright file="AuthenticatorException.cs" company="RHEA System S.A.">
...
namespace CometServer.Exceptions
{
    ...
    /// <summary>
    /// The <see cref="AuthenticatorException"/> is thrown when the application cannot connect to the database
    /// during the authentcation procedure
    /// </summary>
    [Serializable]

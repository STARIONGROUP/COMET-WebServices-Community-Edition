// --------------------------------------------------------------------------------------------------------------------
// <copyright file="IChangeLogService.cs" company="Starion Group S.A.">
...
namespace CometServer.Services.ChangeLog
{
    ...
    public interface IChangeLogService
    {
        ...
        /// </returns>
        Task<bool> TryAppendModelChangeLogDataAsync(NpgsqlTransaction transaction, string partition, Guid actor, int transactionRevision, PostOperation operation, IReadOnlyList<Thing> things);
    }
}

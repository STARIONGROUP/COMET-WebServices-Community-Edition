...
namespace CometServer.Services.Operations.SideEffects
{
    ...
    public sealed class PersonPermissionSideEffect : OperationSideEffect<PersonPermission>
    {
        ...
        /// The security Context used for permission checking.
        /// </param>
        public override async Task AfterUpdateAsync(PersonPermission thing, Thing container, PersonPermission originalThing, NpgsqlTransaction transaction,
        ...
        /// The <see cref="Thing"/> instance that will be inspected.
        /// </param>
        private Task ValidateAccessRightKindAsync(PersonPermission thing)
        {

...
namespace CometServer.Services
{
    ...
    public sealed partial class DiagramObjectService : ServiceBase, IDiagramObjectService
    {
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="DiagramObject"/>, optionally with contained <see cref="Thing"/>s.
        /// </returns>
        ...
        {
            return this.DiagramObjectDao.AddToCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.DiagramObjectDao.DeleteFromCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.DiagramObjectDao.ReorderCollectionProperty(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public bool DeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.DiagramObjectDao.Delete(transaction, partition, thing.Iid);
        }
        ...
        public bool RawDeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.DiagramObjectDao.RawDelete(transaction, partition, thing.Iid);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="DiagramObject"/>.
        /// </returns>
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            diagramObjectColl.AddRange(this.ArchitectureElementService.GetShallow(transaction, partition, idFilter, authorizedContext));
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="DiagramObject"/> and contained <see cref="Thing"/>s.
        /// </returns>
        public IEnumerable<Thing> GetDeep(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            results.AddRange(this.LocalStyleService.GetDeep(transaction, partition, diagramObjectColl.SelectMany(x => x.LocalStyle), containerSecurityContext));
        ...
        /// True if the persistence was successful.
        /// </returns>
        private bool CreateContainment(NpgsqlTransaction transaction, string partition, DiagramObject diagramObject)
        {
            var results = new List<bool>();

            foreach (var bounds in this.ResolveFromRequestCache(diagramObject.Bounds))
            {
                results.Add(this.BoundsService.CreateConcept(transaction, partition, bounds, diagramObject));
            }

            foreach (var diagramElement in this.ResolveFromRequestCache(diagramObject.DiagramElement))
            {
                results.Add(this.DiagramElementService.CreateConcept(transaction, partition, diagramElement, diagramObject));
            }

            foreach (var localStyle in this.ResolveFromRequestCache(diagramObject.LocalStyle))
            {
                results.Add(this.LocalStyleService.CreateConcept(transaction, partition, localStyle, diagramObject));
            }

...
namespace CometServer.Services
{
    ...
    public sealed partial class DomainFileStoreService : ServiceBase, IDomainFileStoreService
    {
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="DomainFileStore"/>, optionally with contained <see cref="Thing"/>s.
        /// </returns>
        ...
        {
            return this.DomainFileStoreDao.AddToCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.DomainFileStoreDao.DeleteFromCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.DomainFileStoreDao.ReorderCollectionProperty(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public bool DeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.DomainFileStoreDao.Delete(transaction, partition, thing.Iid);
        }
        ...
        public bool RawDeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.DomainFileStoreDao.RawDelete(transaction, partition, thing.Iid);
        }
        ...
        public bool UpdateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return this.DomainFileStoreDao.Update(transaction, partition, domainFileStore, container);
        }
        ...
        public bool CreateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var domainFileStore = thing as DomainFileStore;
            var createSuccesful = this.DomainFileStoreDao.Write(transaction, partition, domainFileStore, container);
            return createSuccesful && this.CreateContainment(transaction, partition, domainFileStore);
        }
        ...
        {
            var domainFileStore = thing as DomainFileStore;
            var createSuccesful = this.DomainFileStoreDao.Upsert(transaction, partition, domainFileStore, container);
            return createSuccesful && this.UpsertContainment(transaction, partition, domainFileStore);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="DomainFileStore"/>.
        /// </returns>
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var domainFileStoreColl = new List<Thing>(this.DomainFileStoreDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction), (DateTime)this.TransactionManager.GetRawSessionInstant(transaction)));

            return this.AfterGet(domainFileStoreColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="DomainFileStore"/> and contained <see cref="Thing"/>s.
        /// </returns>
        ...
        /// True if the persistence was successful.
        /// </returns>
        private bool UpsertContainment(NpgsqlTransaction transaction, string partition, DomainFileStore domainFileStore)
        {
            var results = new List<bool>();

            foreach (var file in this.ResolveFromRequestCache(domainFileStore.File))
            {
                results.Add(this.FileService.UpsertConcept(transaction, partition, file, domainFileStore));
            }

            foreach (var folder in this.ResolveFromRequestCache(domainFileStore.Folder))
            {
                results.Add(this.FolderService.UpsertConcept(transaction, partition, folder, domainFileStore));
            }

...
namespace CometServer.Services
{
    ...
    /// </summary>
    public sealed partial class ArchitectureDiagramService : ServiceBase, IArchitectureDiagramService
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets or sets the <see cref="IArchitectureDiagramDao"/>.
        /// </summary>
        public IArchitectureDiagramDao ArchitectureDiagramDao { get; set; }

        /// <summary>
        /// Get the requested <see cref="ArchitectureDiagram"/>s from the ORM layer.
        /// </summary>
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="ArchitectureDiagram"/>, optionally with contained <see cref="Thing"/>s.
        /// </returns>
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="ArchitectureDiagram"/> id that will be the source for each link table record.
        /// </param>
        /// <param name="value">
        ...
        {
            return this.ArchitectureDiagramDao.AddToCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="ArchitectureDiagram"/> id that is the source of the link table records.
        /// </param>
        /// <param name="value">
        ...
        {
            return this.ArchitectureDiagramDao.DeleteFromCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="ArchitectureDiagram"/> id that is the source for the reordered link table record.
        /// </param>
        ...
        {
            return this.ArchitectureDiagramDao.ReorderCollectionProperty(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        /// <summary>
        /// Delete the supplied <see cref="ArchitectureDiagram"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="ArchitectureDiagram"/> to delete.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="ArchitectureDiagram"/> to be removed.
        /// </param>
        /// <returns>
        ...
        public bool DeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.ArchitectureDiagramDao.Delete(transaction, partition, thing.Iid);
        }
        ...
        public bool RawDeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.ArchitectureDiagramDao.RawDelete(transaction, partition, thing.Iid);
        }

        /// <summary>
        /// Update the supplied <see cref="ArchitectureDiagram"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="ArchitectureDiagram"/> <see cref="Thing"/> to update.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="ArchitectureDiagram"/> to be updated.
        /// </param>
        /// <returns>
        ...
        public bool UpdateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return this.ArchitectureDiagramDao.Update(transaction, partition, architectureDiagram, container);
        }

        /// <summary>
        /// Persist the supplied <see cref="ArchitectureDiagram"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="ArchitectureDiagram"/> <see cref="Thing"/> to create.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="ArchitectureDiagram"/> to be persisted.
        /// </param>
        /// <param name="sequence">
        ...
        public bool CreateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var architectureDiagram = thing as ArchitectureDiagram;
            var createSuccesful = this.ArchitectureDiagramDao.Write(transaction, partition, architectureDiagram, container);
            return createSuccesful && this.CreateContainment(transaction, partition, architectureDiagram);
        }

        /// <summary>
        /// Persist the supplied <see cref="ArchitectureDiagram"/> instance. Update if it already exists.
        /// This is typically used during the import of existing data to the Database.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        ...
        {
            var architectureDiagram = thing as ArchitectureDiagram;
            var createSuccesful = this.ArchitectureDiagramDao.Upsert(transaction, partition, architectureDiagram, container);
            return createSuccesful && this.UpsertContainment(transaction, partition, architectureDiagram);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="ArchitectureDiagram"/>.
        /// </returns>
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var authorizedContext = this.AuthorizeReadRequest("ArchitectureDiagram", containerSecurityContext, partition);
            ...
            var architectureDiagramColl = new List<Thing>(this.ArchitectureDiagramDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction), (DateTime)this.TransactionManager.GetRawSessionInstant(transaction)));

            return this.AfterGet(architectureDiagramColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="ArchitectureDiagram"/> and contained <see cref="Thing"/>s.
        /// </returns>
        public IEnumerable<Thing> GetDeep(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var architectureDiagramColl = results.Where(i => i.GetType() == typeof(ArchitectureDiagram)).Cast<ArchitectureDiagram>().ToList();

            results.AddRange(this.BoundsService.GetDeep(transaction, partition, architectureDiagramColl.SelectMany(x => x.Bounds), containerSecurityContext));
            results.AddRange(this.DiagramElementService.GetDeep(transaction, partition, architectureDiagramColl.SelectMany(x => x.DiagramElement), containerSecurityContext));
        ...
        /// <summary>
        /// Persist the <see cref="ArchitectureDiagram"/> containment tree to the ORM layer.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// The <see cref="ArchitectureDiagram"/> instance to persist.
        /// </param>
        /// <returns>
        /// True if the persistence was successful.
        /// </returns>
        private bool CreateContainment(NpgsqlTransaction transaction, string partition, ArchitectureDiagram architectureDiagram)
        {
            var results = new List<bool>();

            foreach (var bounds in this.ResolveFromRequestCache(architectureDiagram.Bounds))
            {
                results.Add(this.BoundsService.CreateConcept(transaction, partition, bounds, architectureDiagram));
            }

            foreach (var diagramElement in this.ResolveFromRequestCache(architectureDiagram.DiagramElement))
            {
                results.Add(this.DiagramElementService.CreateConcept(transaction, partition, diagramElement, architectureDiagram));
            }
        ...
        /// <summary>
        /// Persist the <see cref="ArchitectureDiagram"/> containment tree to the ORM layer. Update if it already exists.
        /// This is typically used during the import of existing data to the Database.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        ...
        /// True if the persistence was successful.
        /// </returns>
        private bool UpsertContainment(NpgsqlTransaction transaction, string partition, ArchitectureDiagram architectureDiagram)
        {
            var results = new List<bool>();

            foreach (var bounds in this.ResolveFromRequestCache(architectureDiagram.Bounds))
            {
                results.Add(this.BoundsService.UpsertConcept(transaction, partition, bounds, architectureDiagram));
            }

            foreach (var diagramElement in this.ResolveFromRequestCache(architectureDiagram.DiagramElement))
            {
                results.Add(this.DiagramElementService.UpsertConcept(transaction, partition, diagramElement, architectureDiagram));
            }

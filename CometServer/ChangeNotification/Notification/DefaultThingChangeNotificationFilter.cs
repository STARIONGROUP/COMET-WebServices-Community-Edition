// --------------------------------------------------------------------------------------------------------------------
// <copyright file="DefaultThingChangeNotificationFilter.cs" company="Starion Group S.A.">
...
namespace CometServer.ChangeNotification.Notification
{
    ...
    /// <summary>
    /// Implements logic for Change notification filtering for an individual <see cref="Thing"/>.
    /// </summary>
    public class DefaultThingChangeNotificationFilter : ChangeNotificationFilter
    {
        /// <summary>
        ...
        public override bool CheckFilter(LogEntryChangelogItem logEntryChangelogItem)
        {
            return logEntryChangelogItem.AffectedReferenceIid.Intersect(this.DomainOfExpertises.Select(x => x.Iid)).Any()
                   &&
                   (logEntryChangelogItem.AffectedItemIid == this.Iid || logEntryChangelogItem.AffectedReferenceIid.Contains(this.Iid));
        }
    }
}

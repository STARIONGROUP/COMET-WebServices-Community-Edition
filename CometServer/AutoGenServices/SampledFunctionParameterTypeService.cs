...
namespace CometServer.Services
{
    ...
    public sealed partial class SampledFunctionParameterTypeService : ServiceBase, ISampledFunctionParameterTypeService
    {
        ...
        {
            return this.SampledFunctionParameterTypeDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.SampledFunctionParameterTypeDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.SampledFunctionParameterTypeDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.SampledFunctionParameterTypeDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

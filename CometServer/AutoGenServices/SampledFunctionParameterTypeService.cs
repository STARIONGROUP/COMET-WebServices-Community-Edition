...
namespace CometServer.Services
{
    ...
    public sealed partial class SampledFunctionParameterTypeService : ServiceBase, ISampledFunctionParameterTypeService
    {
        ...
        public async Task<IEnumerable<Thing>> GetShallowAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var sampledFunctionParameterTypeColl = new List<Thing>(await this.SampledFunctionParameterTypeDao.ReadAsync(transaction, partition, idFilter, isCachedDtoReadEnabled, sessionInstant));

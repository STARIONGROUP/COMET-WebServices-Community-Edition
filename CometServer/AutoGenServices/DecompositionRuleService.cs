...
namespace CometServer.Services
{
    ...
    public sealed partial class DecompositionRuleService : ServiceBase, IDecompositionRuleService
    {
        ...
        public async Task<IEnumerable<Thing>> GetShallowAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var decompositionRuleColl = new List<Thing>(await this.DecompositionRuleDao.ReadAsync(transaction, partition, idFilter, isCachedDtoReadEnabled, sessionInstant));

...
namespace CometServer.Services
{
    ...
    public sealed partial class DecompositionRuleService : ServiceBase, IDecompositionRuleService
    {
        ...
        {
            return this.DecompositionRuleDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.DecompositionRuleDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.DecompositionRuleDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.DecompositionRuleDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

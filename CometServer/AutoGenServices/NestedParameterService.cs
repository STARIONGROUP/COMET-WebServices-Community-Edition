...
namespace CometServer.Services
{
    ...
    public sealed partial class NestedParameterService : ServiceBase, INestedParameterService
    {
        ...
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var nestedParameterColl = new List<Thing>(this.NestedParameterDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction)));

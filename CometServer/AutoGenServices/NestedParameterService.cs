...
namespace CometServer.Services
{
    ...
    public sealed partial class NestedParameterService : ServiceBase, INestedParameterService
    {
        ...
        {
            return this.NestedParameterDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.NestedParameterDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.NestedParameterDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.NestedParameterDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

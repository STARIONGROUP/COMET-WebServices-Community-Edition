...
namespace CometServer.Services
{
    ...
    public sealed partial class NestedParameterService : ServiceBase, INestedParameterService
    {
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="NestedParameter"/>, optionally with contained <see cref="Thing"/>s.
        /// </returns>
        ...
        {
            return this.NestedParameterDao.AddToCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.NestedParameterDao.DeleteFromCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.NestedParameterDao.ReorderCollectionProperty(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public bool DeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.NestedParameterDao.Delete(transaction, partition, thing.Iid);
        }
        ...
        public bool RawDeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.NestedParameterDao.RawDelete(transaction, partition, thing.Iid);
        }
        ...
        public bool UpdateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return this.NestedParameterDao.Update(transaction, partition, nestedParameter, container);
        }
        ...
        public bool CreateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var nestedParameter = thing as NestedParameter;
            return this.NestedParameterDao.Write(transaction, partition, nestedParameter, container);
        }
        ...
        {
            var nestedParameter = thing as NestedParameter;
            return this.NestedParameterDao.Upsert(transaction, partition, nestedParameter, container);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="NestedParameter"/>.
        /// </returns>
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var nestedParameterColl = new List<Thing>(this.NestedParameterDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction), (DateTime)this.TransactionManager.GetRawSessionInstant(transaction)));

            return this.AfterGet(nestedParameterColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="NestedParameter"/> and contained <see cref="Thing"/>s.
        /// </returns>

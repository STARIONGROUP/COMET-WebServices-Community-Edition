...
namespace CometServer.Services
{
    ...
    public sealed partial class StakeholderService : ServiceBase, IStakeholderService
    {
        ...
        {
            return this.StakeholderDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.StakeholderDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.StakeholderDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.StakeholderDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

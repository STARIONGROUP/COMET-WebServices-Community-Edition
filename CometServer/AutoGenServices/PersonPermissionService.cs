...
namespace CometServer.Services
{
    ...
    public sealed partial class PersonPermissionService : ServiceBase, IPersonPermissionService
    {
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="PersonPermission"/>, optionally with contained <see cref="Thing"/>s.
        /// </returns>
        ...
        {
            return this.PersonPermissionDao.AddToCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.PersonPermissionDao.DeleteFromCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.PersonPermissionDao.ReorderCollectionProperty(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public bool DeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.PersonPermissionDao.Delete(transaction, partition, thing.Iid);
        }
        ...
        public bool RawDeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.PersonPermissionDao.RawDelete(transaction, partition, thing.Iid);
        }
        ...
        public bool UpdateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return this.PersonPermissionDao.Update(transaction, partition, personPermission, container);
        }
        ...
        public bool CreateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var personPermission = thing as PersonPermission;
            return this.PersonPermissionDao.Write(transaction, partition, personPermission, container);
        }
        ...
        {
            var personPermission = thing as PersonPermission;
            return this.PersonPermissionDao.Upsert(transaction, partition, personPermission, container);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="PersonPermission"/>.
        /// </returns>
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="PersonPermission"/> and contained <see cref="Thing"/>s.
        /// </returns>

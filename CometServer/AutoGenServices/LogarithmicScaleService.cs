// --------------------------------------------------------------------------------------------------------------------
// <copyright file="LogarithmicScaleService.cs" company="Starion Group S.A.">
...
namespace CometServer.Services
{
    ...
    /// <summary>
    /// The <see cref="LogarithmicScale"/> Service which uses the ORM layer to interact with the data model.
    /// </summary>
    public sealed partial class LogarithmicScaleService : ServiceBase, ILogarithmicScaleService
    {
        /// <summary>
        ...
        /// </summary>
        public IScaleReferenceQuantityValueService ReferenceQuantityValueService { get; set; }
        ...
        /// <summary>
        /// Gets or sets the <see cref="ILogarithmicScaleDao"/>.
        /// </summary>
        public ILogarithmicScaleDao LogarithmicScaleDao { get; set; }

        /// <summary>
        /// Get the requested <see cref="LogarithmicScale"/>s from the ORM layer.
        /// </summary>
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having a list of instances of <see cref="LogarithmicScale"/>, optionally with contained <see cref="Thing"/>s as result.
        /// </returns>
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="LogarithmicScale"/> id that will be the source for each link table record.
        /// </param>
        /// <param name="value">
        ...
        {
            return await this.LogarithmicScaleDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="LogarithmicScale"/> id that is the source of the link table records.
        /// </param>
        /// <param name="value">
        ...
        {
            return await this.LogarithmicScaleDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="LogarithmicScale"/> id that is the source for the reordered link table record.
        /// </param>
        ...
        {
            return await this.LogarithmicScaleDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        /// <summary>
        /// Delete the supplied <see cref="LogarithmicScale"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="LogarithmicScale"/> to delete.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="LogarithmicScale"/> to be removed.
        /// </param>
        /// <returns>
        ...
        public async Task<bool> DeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return await this.LogarithmicScaleDao.DeleteAsync(transaction, partition, thing.Iid);
        }
        ...
        public async Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return await this.LogarithmicScaleDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

        /// <summary>
        /// Update the supplied <see cref="LogarithmicScale"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="LogarithmicScale"/> <see cref="Thing"/> to update.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="LogarithmicScale"/> to be updated.
        /// </param>
        /// <returns>
        ...
        public async Task<bool> UpdateConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return await this.LogarithmicScaleDao.UpdateAsync(transaction, partition, logarithmicScale, container);
        }

        /// <summary>
        /// Persist the supplied <see cref="LogarithmicScale"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="LogarithmicScale"/> <see cref="Thing"/> to create.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="LogarithmicScale"/> to be persisted.
        /// </param>
        /// <param name="sequence">
        ...
        public async Task<bool> CreateConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var logarithmicScale = thing as LogarithmicScale;
            var createSuccesful = await this.LogarithmicScaleDao.WriteAsync(transaction, partition, logarithmicScale, container);
            return createSuccesful && await this.CreateContainmentAsync(transaction, partition, logarithmicScale);
        }

        /// <summary>
        /// Persist the supplied <see cref="LogarithmicScale"/> instance. Update if it already exists.
        /// This is typically used during the import of existing data to the Database.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        ...
        {
            var logarithmicScale = thing as LogarithmicScale;
            var createSuccesful = await this.LogarithmicScaleDao.UpsertAsync(transaction, partition, logarithmicScale, container);
            return createSuccesful && await this.UpsertContainmentAsync(transaction, partition, logarithmicScale);
        }
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having List of instances of <see cref="LogarithmicScale"/> as result.
        /// </returns>
        public async Task<IEnumerable<Thing>> GetShallowAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var authorizedContext = this.AuthorizeReadRequest("LogarithmicScale", containerSecurityContext, partition);
            ...
            var logarithmicScaleColl = new List<Thing>(await this.LogarithmicScaleDao.ReadAsync(transaction, partition, idFilter, await this.TransactionManager.IsCachedDtoReadEnabledAsync(transaction), (DateTime)(await this.TransactionManager.GetRawSessionInstantAsync(transaction))));

            return await this.AfterGetAsync(logarithmicScaleColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having List of instances of <see cref="LogarithmicScale"/> and contained <see cref="Thing"/>s as result.
        /// </returns>
        public async Task<IEnumerable<Thing>> GetDeepAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            results.AddRange(await this.AliasService.GetDeepAsync(transaction, partition, logarithmicScaleColl.SelectMany(x => x.Alias), containerSecurityContext));
            results.AddRange(await this.DefinitionService.GetDeepAsync(transaction, partition, logarithmicScaleColl.SelectMany(x => x.Definition), containerSecurityContext));
            results.AddRange(await this.HyperLinkService.GetDeepAsync(transaction, partition, logarithmicScaleColl.SelectMany(x => x.HyperLink), containerSecurityContext));
            results.AddRange(await this.MappingToReferenceScaleService.GetDeepAsync(transaction, partition, logarithmicScaleColl.SelectMany(x => x.MappingToReferenceScale), containerSecurityContext));
            results.AddRange(await this.ReferenceQuantityValueService.GetDeepAsync(transaction, partition, logarithmicScaleColl.SelectMany(x => x.ReferenceQuantityValue), containerSecurityContext));
            results.AddRange(await this.ValueDefinitionService.GetDeepAsync(transaction, partition, logarithmicScaleColl.SelectMany(x => x.ValueDefinition), containerSecurityContext));
        ...
        /// <summary>
        /// Persist the <see cref="LogarithmicScale"/> containment tree to the ORM layer.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// An awaitable <see cref="Task"/> having True if the persistence was successful as result.
        /// </returns>
        private async Task<bool> CreateContainmentAsync(NpgsqlTransaction transaction, string partition, LogarithmicScale logarithmicScale)
        {
            var results = new List<bool>();

            foreach (var alias in this.ResolveFromRequestCache(logarithmicScale.Alias))
            {
                results.Add(await this.AliasService.CreateConceptAsync(transaction, partition, alias, logarithmicScale));
            }

            foreach (var definition in this.ResolveFromRequestCache(logarithmicScale.Definition))
            {
                results.Add(await this.DefinitionService.CreateConceptAsync(transaction, partition, definition, logarithmicScale));
            }

            foreach (var hyperLink in this.ResolveFromRequestCache(logarithmicScale.HyperLink))
            {
                results.Add(await this.HyperLinkService.CreateConceptAsync(transaction, partition, hyperLink, logarithmicScale));
            }

            foreach (var mappingToReferenceScale in this.ResolveFromRequestCache(logarithmicScale.MappingToReferenceScale))
            {
                results.Add(await this.MappingToReferenceScaleService.CreateConceptAsync(transaction, partition, mappingToReferenceScale, logarithmicScale));
            }

            foreach (var referenceQuantityValue in this.ResolveFromRequestCache(logarithmicScale.ReferenceQuantityValue))
            {
                results.Add(await this.ReferenceQuantityValueService.CreateConceptAsync(transaction, partition, referenceQuantityValue, logarithmicScale));
            }

            foreach (var valueDefinition in this.ResolveFromRequestCache(logarithmicScale.ValueDefinition))
            {
                results.Add(await this.ValueDefinitionService.CreateConceptAsync(transaction, partition, valueDefinition, logarithmicScale));
            }
        ...
        /// An awaitable <see cref="Task"/> having True if the persistence was successful as result.
        /// </returns>
        private async Task<bool> UpsertContainmentAsync(NpgsqlTransaction transaction, string partition, LogarithmicScale logarithmicScale)
        {
            var results = new List<bool>();

            foreach (var alias in this.ResolveFromRequestCache(logarithmicScale.Alias))
            {
                results.Add(await this.AliasService.UpsertConceptAsync(transaction, partition, alias, logarithmicScale));
            }

            foreach (var definition in this.ResolveFromRequestCache(logarithmicScale.Definition))
            {
                results.Add(await this.DefinitionService.UpsertConceptAsync(transaction, partition, definition, logarithmicScale));
            }

            foreach (var hyperLink in this.ResolveFromRequestCache(logarithmicScale.HyperLink))
            {
                results.Add(await this.HyperLinkService.UpsertConceptAsync(transaction, partition, hyperLink, logarithmicScale));
            }

            foreach (var mappingToReferenceScale in this.ResolveFromRequestCache(logarithmicScale.MappingToReferenceScale))
            {
                results.Add(await this.MappingToReferenceScaleService.UpsertConceptAsync(transaction, partition, mappingToReferenceScale, logarithmicScale));
            }

            foreach (var referenceQuantityValue in this.ResolveFromRequestCache(logarithmicScale.ReferenceQuantityValue))
            {
                results.Add(await this.ReferenceQuantityValueService.UpsertConceptAsync(transaction, partition, referenceQuantityValue, logarithmicScale));
            }

            foreach (var valueDefinition in this.ResolveFromRequestCache(logarithmicScale.ValueDefinition))
            {
                results.Add(await this.ValueDefinitionService.UpsertConceptAsync(transaction, partition, valueDefinition, logarithmicScale));
            }

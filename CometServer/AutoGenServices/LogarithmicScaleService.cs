...
namespace CometServer.Services
{
    ...
    public sealed partial class LogarithmicScaleService : ServiceBase, ILogarithmicScaleService
    {
        ...
        {
            return this.LogarithmicScaleDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.LogarithmicScaleDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.LogarithmicScaleDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.LogarithmicScaleDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

...
namespace CometServer.Services
{
    ...
    public sealed partial class LogarithmicScaleService : ServiceBase, ILogarithmicScaleService
    {
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="LogarithmicScale"/>, optionally with contained <see cref="Thing"/>s.
        /// </returns>
        ...
        {
            return this.LogarithmicScaleDao.AddToCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.LogarithmicScaleDao.DeleteFromCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.LogarithmicScaleDao.ReorderCollectionProperty(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public bool DeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.LogarithmicScaleDao.Delete(transaction, partition, thing.Iid);
        }
        ...
        public bool RawDeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.LogarithmicScaleDao.RawDelete(transaction, partition, thing.Iid);
        }
        ...
        public bool UpdateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return this.LogarithmicScaleDao.Update(transaction, partition, logarithmicScale, container);
        }
        ...
        public bool CreateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var logarithmicScale = thing as LogarithmicScale;
            var createSuccesful = this.LogarithmicScaleDao.Write(transaction, partition, logarithmicScale, container);
            return createSuccesful && this.CreateContainment(transaction, partition, logarithmicScale);
        }
        ...
        {
            var logarithmicScale = thing as LogarithmicScale;
            var createSuccesful = this.LogarithmicScaleDao.Upsert(transaction, partition, logarithmicScale, container);
            return createSuccesful && this.UpsertContainment(transaction, partition, logarithmicScale);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="LogarithmicScale"/>.
        /// </returns>
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="LogarithmicScale"/> and contained <see cref="Thing"/>s.
        /// </returns>
        public IEnumerable<Thing> GetDeep(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            results.AddRange(this.ReferenceQuantityValueService.GetDeep(transaction, partition, logarithmicScaleColl.SelectMany(x => x.ReferenceQuantityValue), containerSecurityContext));
            results.AddRange(this.ValueDefinitionService.GetDeep(transaction, partition, logarithmicScaleColl.SelectMany(x => x.ValueDefinition), containerSecurityContext));
        ...
        /// True if the persistence was successful.
        /// </returns>
        private bool CreateContainment(NpgsqlTransaction transaction, string partition, LogarithmicScale logarithmicScale)
        {
            ...
            {
                results.Add(this.HyperLinkService.CreateConcept(transaction, partition, hyperLink, logarithmicScale));
            }

            foreach (var mappingToReferenceScale in this.ResolveFromRequestCache(logarithmicScale.MappingToReferenceScale))
            {
                results.Add(this.MappingToReferenceScaleService.CreateConcept(transaction, partition, mappingToReferenceScale, logarithmicScale));
            }

            foreach (var referenceQuantityValue in this.ResolveFromRequestCache(logarithmicScale.ReferenceQuantityValue))
            {
                results.Add(this.ReferenceQuantityValueService.CreateConcept(transaction, partition, referenceQuantityValue, logarithmicScale));
            }

            foreach (var valueDefinition in this.ResolveFromRequestCache(logarithmicScale.ValueDefinition))
            {
                results.Add(this.ValueDefinitionService.CreateConcept(transaction, partition, valueDefinition, logarithmicScale));
            }

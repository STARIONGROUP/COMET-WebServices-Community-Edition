...
namespace CometServer.Services
{
    ...
    public sealed partial class PossibleFiniteStateListService : ServiceBase, IPossibleFiniteStateListService
    {
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="PossibleFiniteStateList"/>, optionally with contained <see cref="Thing"/>s.
        /// </returns>
        ...
        {
            return this.PossibleFiniteStateListDao.AddToCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.PossibleFiniteStateListDao.DeleteFromCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.PossibleFiniteStateListDao.ReorderCollectionProperty(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public bool DeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.PossibleFiniteStateListDao.Delete(transaction, partition, thing.Iid);
        }
        ...
        public bool RawDeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.PossibleFiniteStateListDao.RawDelete(transaction, partition, thing.Iid);
        }
        ...
        public bool UpdateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return this.PossibleFiniteStateListDao.Update(transaction, partition, possibleFiniteStateList, container);
        }
        ...
        public bool CreateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var possibleFiniteStateList = thing as PossibleFiniteStateList;
            var createSuccesful = this.PossibleFiniteStateListDao.Write(transaction, partition, possibleFiniteStateList, container);
            return createSuccesful && this.CreateContainment(transaction, partition, possibleFiniteStateList);
        }
        ...
        {
            var possibleFiniteStateList = thing as PossibleFiniteStateList;
            var createSuccesful = this.PossibleFiniteStateListDao.Upsert(transaction, partition, possibleFiniteStateList, container);
            return createSuccesful && this.UpsertContainment(transaction, partition, possibleFiniteStateList);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="PossibleFiniteStateList"/>.
        /// </returns>
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var possibleFiniteStateListColl = new List<Thing>(this.PossibleFiniteStateListDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction), (DateTime)this.TransactionManager.GetRawSessionInstant(transaction)));

            return this.AfterGet(possibleFiniteStateListColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="PossibleFiniteStateList"/> and contained <see cref="Thing"/>s.
        /// </returns>
        ...
        /// True if the persistence was successful.
        /// </returns>
        private bool CreateContainment(NpgsqlTransaction transaction, string partition, PossibleFiniteStateList possibleFiniteStateList)
        {
            ...
            {
                results.Add(this.HyperLinkService.CreateConcept(transaction, partition, hyperLink, possibleFiniteStateList));
            }

            foreach (var possibleState in this.ResolveFromRequestCache(possibleFiniteStateList.PossibleState))
            {
                results.Add(this.PossibleStateService.CreateConcept(transaction, partition, (PossibleFiniteState)possibleState.V, possibleFiniteStateList, possibleState.K));
            }
        ...
        /// True if the persistence was successful.
        /// </returns>
        private bool UpsertContainment(NpgsqlTransaction transaction, string partition, PossibleFiniteStateList possibleFiniteStateList)
        {
            var results = new List<bool>();
            ...
            foreach (var definition in this.ResolveFromRequestCache(possibleFiniteStateList.Definition))
            {
                results.Add(this.DefinitionService.UpsertConcept(transaction, partition, definition, possibleFiniteStateList));
            }

            foreach (var hyperLink in this.ResolveFromRequestCache(possibleFiniteStateList.HyperLink))
            {
                results.Add(this.HyperLinkService.UpsertConcept(transaction, partition, hyperLink, possibleFiniteStateList));
            }

            foreach (var possibleState in this.ResolveFromRequestCache(possibleFiniteStateList.PossibleState))
            {
                results.Add(this.PossibleStateService.UpsertConcept(transaction, partition, (PossibleFiniteState)possibleState.V, possibleFiniteStateList, possibleState.K));
            }

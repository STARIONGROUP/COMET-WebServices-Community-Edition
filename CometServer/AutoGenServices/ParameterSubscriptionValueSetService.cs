// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ParameterSubscriptionValueSetService.cs" company="Starion Group S.A.">
...
namespace CometServer.Services
{
    ...
    /// <summary>
    /// The <see cref="ParameterSubscriptionValueSet"/> Service which uses the ORM layer to interact with the data model.
    /// </summary>
    public sealed partial class ParameterSubscriptionValueSetService : ServiceBase, IParameterSubscriptionValueSetService
    {
        /// <summary>
        /// Gets or sets the <see cref="IParameterSubscriptionValueSetDao"/>.
        /// </summary>
        public IParameterSubscriptionValueSetDao ParameterSubscriptionValueSetDao { get; set; }
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having a list of instances of <see cref="ParameterSubscriptionValueSet"/>, optionally with contained <see cref="Thing"/>s as result.
        /// </returns>
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="ParameterSubscriptionValueSet"/> id that will be the source for each link table record.
        /// </param>
        /// <param name="value">
        ...
        {
            return await this.ParameterSubscriptionValueSetDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="ParameterSubscriptionValueSet"/> id that is the source of the link table records.
        /// </param>
        /// <param name="value">
        ...
        {
            return await this.ParameterSubscriptionValueSetDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return await this.ParameterSubscriptionValueSetDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        /// <summary>
        /// Delete the supplied <see cref="ParameterSubscriptionValueSet"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="ParameterSubscriptionValueSet"/> to delete.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="ParameterSubscriptionValueSet"/> to be removed.
        /// </param>
        /// <returns>
        ...
        public async Task<bool> DeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return await this.ParameterSubscriptionValueSetDao.DeleteAsync(transaction, partition, thing.Iid);
        }
        ...
        public async Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return await this.ParameterSubscriptionValueSetDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

        /// <summary>
        /// Update the supplied <see cref="ParameterSubscriptionValueSet"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="ParameterSubscriptionValueSet"/> <see cref="Thing"/> to update.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="ParameterSubscriptionValueSet"/> to be updated.
        /// </param>
        /// <returns>
        ...
        public async Task<bool> UpdateConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return await this.ParameterSubscriptionValueSetDao.UpdateAsync(transaction, partition, parameterSubscriptionValueSet, container);
        }

        /// <summary>
        /// Persist the supplied <see cref="ParameterSubscriptionValueSet"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="ParameterSubscriptionValueSet"/> <see cref="Thing"/> to create.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="ParameterSubscriptionValueSet"/> to be persisted.
        /// </param>
        /// <param name="sequence">
        ...
        public async Task<bool> CreateConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var parameterSubscriptionValueSet = thing as ParameterSubscriptionValueSet;
            return await this.ParameterSubscriptionValueSetDao.WriteAsync(transaction, partition, parameterSubscriptionValueSet, container);
        }

        /// <summary>
        /// Persist the supplied <see cref="ParameterSubscriptionValueSet"/> instance. Update if it already exists.
        /// This is typically used during the import of existing data to the Database.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        ...
        {
            var parameterSubscriptionValueSet = thing as ParameterSubscriptionValueSet;
            return await this.ParameterSubscriptionValueSetDao.UpsertAsync(transaction, partition, parameterSubscriptionValueSet, container);
        }
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having List of instances of <see cref="ParameterSubscriptionValueSet"/> as result.
        /// </returns>
        public async Task<IEnumerable<Thing>> GetShallowAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var parameterSubscriptionValueSetColl = new List<Thing>(await this.ParameterSubscriptionValueSetDao.ReadAsync(transaction, partition, idFilter, await this.TransactionManager.IsCachedDtoReadEnabledAsync(transaction), (DateTime)(await this.TransactionManager.GetRawSessionInstantAsync(transaction))));

            return await this.AfterGetAsync(parameterSubscriptionValueSetColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having List of instances of <see cref="ParameterSubscriptionValueSet"/> and contained <see cref="Thing"/>s as result.
        /// </returns>

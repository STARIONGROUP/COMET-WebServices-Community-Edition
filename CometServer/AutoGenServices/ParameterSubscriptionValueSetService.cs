...
namespace CometServer.Services
{
    ...
    public sealed partial class ParameterSubscriptionValueSetService : ServiceBase, IParameterSubscriptionValueSetService
    {
        ...
        public async Task<IEnumerable<Thing>> GetShallowAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var parameterSubscriptionValueSetColl = new List<Thing>(await this.ParameterSubscriptionValueSetDao.ReadAsync(transaction, partition, idFilter, isCachedDtoReadEnabled, sessionInstant));

...
namespace CometServer.Services
{
    ...
    public sealed partial class ParameterSubscriptionValueSetService : ServiceBase, IParameterSubscriptionValueSetService
    {
        ...
        {
            return this.ParameterSubscriptionValueSetDao.AddToCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.ParameterSubscriptionValueSetDao.DeleteFromCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        public bool DeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.ParameterSubscriptionValueSetDao.Delete(transaction, partition, thing.Iid);
        }
        ...
        public bool RawDeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.ParameterSubscriptionValueSetDao.RawDelete(transaction, partition, thing.Iid);
        }
        ...
        public bool UpdateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return this.ParameterSubscriptionValueSetDao.Update(transaction, partition, parameterSubscriptionValueSet, container);
        }
        ...
        public bool CreateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var parameterSubscriptionValueSet = thing as ParameterSubscriptionValueSet;
            return this.ParameterSubscriptionValueSetDao.Write(transaction, partition, parameterSubscriptionValueSet, container);
        }
        ...
        {
            var parameterSubscriptionValueSet = thing as ParameterSubscriptionValueSet;
            return this.ParameterSubscriptionValueSetDao.Upsert(transaction, partition, parameterSubscriptionValueSet, container);
        }
        ...
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var parameterSubscriptionValueSetColl = new List<Thing>(this.ParameterSubscriptionValueSetDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction), (DateTime)this.TransactionManager.GetRawSessionInstant(transaction)));

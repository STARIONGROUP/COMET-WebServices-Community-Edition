...
namespace CometServer.Services
{
    ...
    public sealed partial class ParameterSubscriptionValueSetService : ServiceBase, IParameterSubscriptionValueSetService
    {
        ...
        {
            return this.ParameterSubscriptionValueSetDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.ParameterSubscriptionValueSetDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.ParameterSubscriptionValueSetDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.ParameterSubscriptionValueSetDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

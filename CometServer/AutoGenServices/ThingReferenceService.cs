// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ThingReferenceService.cs" company="Starion Group S.A.">
...
namespace CometServer.Services
{
    ...
    /// <summary>
    /// The <see cref="ThingReference"/> Service which uses the ORM layer to interact with the data model.
    /// </summary>
    [ExcludeFromCodeCoverage]
    public sealed partial class ThingReferenceService : ServiceBase, IThingReferenceService
    {
        /// <summary>
        ...
        /// <summary>
        /// Get the requested <see cref="ThingReference"/>s from the ORM layer.
        /// </summary>
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having a list of instances of <see cref="ThingReference"/>, optionally with contained <see cref="Thing"/>s as result.
        /// </returns>
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="ThingReference"/> id that will be the source for each link table record.
        /// </param>
        /// <param name="value">
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="ThingReference"/> id that is the source of the link table records.
        /// </param>
        /// <param name="value">
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="ThingReference"/> id that is the source for the reordered link table record.
        /// </param>
        ...
        /// <summary>
        /// Delete the supplied <see cref="ThingReference"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="ThingReference"/> to delete.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="ThingReference"/> to be removed.
        /// </param>
        /// <returns>
        ...
        /// <summary>
        /// Update the supplied <see cref="ThingReference"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="ThingReference"/> <see cref="Thing"/> to update.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="ThingReference"/> to be updated.
        /// </param>
        /// <returns>
        ...
        public async Task<bool> UpdateConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            var thingReference = thing as ThingReference;
            throw new NotSupportedException(string.Format("The abstract DTO type: {0} cannot be updated.", thingReference.GetType().Name));
        }

        /// <summary>
        /// Persist the supplied <see cref="ThingReference"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="ThingReference"/> <see cref="Thing"/> to create.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="ThingReference"/> to be persisted.
        /// </param>
        /// <param name="sequence">
        ...
        public async Task<bool> CreateConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var thingReference = thing as ThingReference;
            throw new NotSupportedException(string.Format("The abstract DTO type: {0} cannot be created.", thingReference.GetType().Name));
        }

        /// <summary>
        /// Persist the supplied <see cref="ThingReference"/> instance. Update if it already exists.
        /// This is typically used during the import of existing data to the Database.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having List of instances of <see cref="ThingReference"/> as result.
        /// </returns>
        public async Task<IEnumerable<Thing>> GetShallowAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var authorizedContext = this.AuthorizeReadRequest("ThingReference", containerSecurityContext, partition);
            ...
            var thingReferenceColl = new List<Thing>();
            thingReferenceColl.AddRange(await this.ModellingThingReferenceService.GetShallowAsync(transaction, partition, idFilter, authorizedContext));
            thingReferenceColl.AddRange(await this.SiteDirectoryThingReferenceService.GetShallowAsync(transaction, partition, idFilter, authorizedContext));

            return await this.AfterGetAsync(thingReferenceColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having List of instances of <see cref="ThingReference"/> and contained <see cref="Thing"/>s as result.
        /// </returns>
        public async Task<IEnumerable<Thing>> GetDeepAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            results.AddRange(await this.ModellingThingReferenceService.GetDeepAsync(transaction, partition, idFilter, containerSecurityContext));
            results.AddRange(await this.SiteDirectoryThingReferenceService.GetDeepAsync(transaction, partition, idFilter, containerSecurityContext));
            return results;
        }

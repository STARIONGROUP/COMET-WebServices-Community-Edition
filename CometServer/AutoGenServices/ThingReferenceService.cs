...
namespace CometServer.Services
{
    ...
    public sealed partial class ThingReferenceService : ServiceBase, IThingReferenceService
    {
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="ThingReference"/>, optionally with contained <see cref="Thing"/>s.
        /// </returns>
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="ThingReference"/>.
        /// </returns>
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            thingReferenceColl.AddRange(this.ModellingThingReferenceService.GetShallow(transaction, partition, idFilter, authorizedContext));
            thingReferenceColl.AddRange(this.SiteDirectoryThingReferenceService.GetShallow(transaction, partition, idFilter, authorizedContext));

            return this.AfterGet(thingReferenceColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="ThingReference"/> and contained <see cref="Thing"/>s.
        /// </returns>
        public IEnumerable<Thing> GetDeep(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            results.AddRange(this.ModellingThingReferenceService.GetDeep(transaction, partition, idFilter, containerSecurityContext));
            results.AddRange(this.SiteDirectoryThingReferenceService.GetDeep(transaction, partition, idFilter, containerSecurityContext));
            return results;
        }

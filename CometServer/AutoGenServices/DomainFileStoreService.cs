...
namespace CometServer.Services
{
    ...
    public sealed partial class DomainFileStoreService : ServiceBase, IDomainFileStoreService
    {
        ...
        {
            return this.DomainFileStoreDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.DomainFileStoreDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.DomainFileStoreDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.DomainFileStoreDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

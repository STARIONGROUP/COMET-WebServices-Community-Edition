...
namespace CometServer.Services
{
    ...
    /// <summary>
    /// The <see cref="DomainFileStore"/> Service which uses the ORM layer to interact with the data model.
    /// </summary>
    public sealed partial class DomainFileStoreService : ServiceBase, IDomainFileStoreService
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets or sets the <see cref="IDomainFileStoreDao"/>.
        /// </summary>
        public IDomainFileStoreDao DomainFileStoreDao { get; set; }

        /// <summary>
        /// Get the requested <see cref="DomainFileStore"/>s from the ORM layer.
        /// </summary>
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having a list of instances of <see cref="DomainFileStore"/>, optionally with contained <see cref="Thing"/>s as result.
        /// </returns>
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="DomainFileStore"/> id that will be the source for each link table record.
        /// </param>
        /// <param name="value">
        ...
        {
            return await this.DomainFileStoreDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="DomainFileStore"/> id that is the source of the link table records.
        /// </param>
        /// <param name="value">
        ...
        {
            return await this.DomainFileStoreDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="DomainFileStore"/> id that is the source for the reordered link table record.
        /// </param>
        ...
        {
            return await this.DomainFileStoreDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        /// <summary>
        /// Delete the supplied <see cref="DomainFileStore"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="DomainFileStore"/> to delete.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="DomainFileStore"/> to be removed.
        /// </param>
        /// <returns>
        ...
        public async Task<bool> DeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return await this.DomainFileStoreDao.DeleteAsync(transaction, partition, thing.Iid);
        }
        ...
        public async Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return await this.DomainFileStoreDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

        /// <summary>
        /// Update the supplied <see cref="DomainFileStore"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="DomainFileStore"/> <see cref="Thing"/> to update.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="DomainFileStore"/> to be updated.
        /// </param>
        /// <returns>
        ...
        public async Task<bool> UpdateConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return await this.DomainFileStoreDao.UpdateAsync(transaction, partition, domainFileStore, container);
        }

        /// <summary>
        /// Persist the supplied <see cref="DomainFileStore"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="DomainFileStore"/> <see cref="Thing"/> to create.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="DomainFileStore"/> to be persisted.
        /// </param>
        /// <param name="sequence">
        ...
        public async Task<bool> CreateConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var domainFileStore = thing as DomainFileStore;
            var createSuccesful = await this.DomainFileStoreDao.WriteAsync(transaction, partition, domainFileStore, container);
            return createSuccesful && await this.CreateContainmentAsync(transaction, partition, domainFileStore);
        }

        /// <summary>
        /// Persist the supplied <see cref="DomainFileStore"/> instance. Update if it already exists.
        /// This is typically used during the import of existing data to the Database.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        ...
        {
            var domainFileStore = thing as DomainFileStore;
            var createSuccesful = await this.DomainFileStoreDao.UpsertAsync(transaction, partition, domainFileStore, container);
            return createSuccesful && await this.UpsertContainmentAsync(transaction, partition, domainFileStore);
        }
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having List of instances of <see cref="DomainFileStore"/> as result.
        /// </returns>
        public async Task<IEnumerable<Thing>> GetShallowAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var authorizedContext = this.AuthorizeReadRequest("DomainFileStore", containerSecurityContext, partition);
            ...
            var domainFileStoreColl = new List<Thing>(await this.DomainFileStoreDao.ReadAsync(transaction, partition, idFilter, await this.TransactionManager.IsCachedDtoReadEnabledAsync(transaction), (DateTime)(await this.TransactionManager.GetRawSessionInstantAsync(transaction))));

            return await this.AfterGetAsync(domainFileStoreColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having List of instances of <see cref="DomainFileStore"/> and contained <see cref="Thing"/>s as result.
        /// </returns>
        public async Task<IEnumerable<Thing>> GetDeepAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            results.AddRange(await this.FileService.GetDeepAsync(transaction, partition, domainFileStoreColl.SelectMany(x => x.File), containerSecurityContext));
            results.AddRange(await this.FolderService.GetDeepAsync(transaction, partition, domainFileStoreColl.SelectMany(x => x.Folder), containerSecurityContext));
        ...
        /// <summary>
        /// Persist the <see cref="DomainFileStore"/> containment tree to the ORM layer.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// The <see cref="DomainFileStore"/> instance to persist.
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having True if the persistence was successful as result.
        /// </returns>
        private async Task<bool> CreateContainmentAsync(NpgsqlTransaction transaction, string partition, DomainFileStore domainFileStore)
        {
            var results = new List<bool>();

            foreach (var file in this.ResolveFromRequestCache(domainFileStore.File))
            {
                results.Add(await this.FileService.CreateConceptAsync(transaction, partition, file, domainFileStore));
            }

            foreach (var folder in this.ResolveFromRequestCache(domainFileStore.Folder))
            {
                results.Add(await this.FolderService.CreateConceptAsync(transaction, partition, folder, domainFileStore));
            }
        ...
        /// <summary>
        /// Persist the <see cref="DomainFileStore"/> containment tree to the ORM layer. Update if it already exists.
        /// This is typically used during the import of existing data to the Database.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        ...
        /// An awaitable <see cref="Task"/> having True if the persistence was successful as result.
        /// </returns>
        private async Task<bool> UpsertContainmentAsync(NpgsqlTransaction transaction, string partition, DomainFileStore domainFileStore)
        {
            var results = new List<bool>();

            foreach (var file in this.ResolveFromRequestCache(domainFileStore.File))
            {
                results.Add(await this.FileService.UpsertConceptAsync(transaction, partition, file, domainFileStore));
            }

            foreach (var folder in this.ResolveFromRequestCache(domainFileStore.Folder))
            {
                results.Add(await this.FolderService.UpsertConceptAsync(transaction, partition, folder, domainFileStore));
            }

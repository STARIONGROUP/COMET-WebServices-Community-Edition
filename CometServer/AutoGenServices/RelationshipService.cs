// --------------------------------------------------------------------------------------------------------------------
// <copyright file="RelationshipService.cs" company="Starion Group S.A.">
...
namespace CometServer.Services
{
    ...
    /// <summary>
    /// The <see cref="Relationship"/> Service which uses the ORM layer to interact with the data model.
    /// </summary>
    public sealed partial class RelationshipService : ServiceBase, IRelationshipService
    {
        /// <summary>
        /// Gets or sets the <see cref="IBinaryRelationshipService"/>.
        /// </summary>
        public IBinaryRelationshipService BinaryRelationshipService { get; set; }

        /// <summary>
        /// Gets or sets the <see cref="IMultiRelationshipService"/>.
        /// </summary>
        public IMultiRelationshipService MultiRelationshipService { get; set; }

        /// <summary>
        /// Get the requested <see cref="Relationship"/>s from the ORM layer.
        /// </summary>
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having a list of instances of <see cref="Relationship"/>, optionally with contained <see cref="Thing"/>s as result.
        /// </returns>
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="Relationship"/> id that will be the source for each link table record.
        /// </param>
        /// <param name="value">
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="Relationship"/> id that is the source of the link table records.
        /// </param>
        /// <param name="value">
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="Relationship"/> id that is the source for the reordered link table record.
        /// </param>
        ...
        /// <summary>
        /// Delete the supplied <see cref="Relationship"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="Relationship"/> to delete.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="Relationship"/> to be removed.
        /// </param>
        /// <returns>
        ...
        /// <summary>
        /// Update the supplied <see cref="Relationship"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="Relationship"/> <see cref="Thing"/> to update.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="Relationship"/> to be updated.
        /// </param>
        /// <returns>
        ...
        public async Task<bool> UpdateConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            var relationship = thing as Relationship;
            if (relationship.IsSameOrDerivedClass<BinaryRelationship>())
            {
                return await this.BinaryRelationshipService.UpdateConceptAsync(transaction, partition, relationship, container);
            }

            if (relationship.IsSameOrDerivedClass<MultiRelationship>())
            {
                return await this.MultiRelationshipService.UpdateConceptAsync(transaction, partition, relationship, container);
            }
            throw new NotSupportedException(string.Format("The supplied DTO type: {0} is not a supported type", relationship.GetType().Name));
        }

        /// <summary>
        /// Persist the supplied <see cref="Relationship"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="Relationship"/> <see cref="Thing"/> to create.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="Relationship"/> to be persisted.
        /// </param>
        /// <param name="sequence">
        ...
        public async Task<bool> CreateConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            if (relationship.IsSameOrDerivedClass<BinaryRelationship>())
            {
                return await this.BinaryRelationshipService.CreateConceptAsync(transaction, partition, relationship, container);
            }

            if (relationship.IsSameOrDerivedClass<MultiRelationship>())
            {
                return await this.MultiRelationshipService.CreateConceptAsync(transaction, partition, relationship, container);
            }
            throw new NotSupportedException(string.Format("The supplied DTO type: {0} is not a supported type", relationship.GetType().Name));
        }

        /// <summary>
        /// Persist the supplied <see cref="Relationship"/> instance. Update if it already exists.
        /// This is typically used during the import of existing data to the Database.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        ...
        public async Task<bool> UpsertConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            if (relationship.IsSameOrDerivedClass<BinaryRelationship>())
            {
                return await this.BinaryRelationshipService.UpsertConceptAsync(transaction, partition, relationship, container);
            }

            if (relationship.IsSameOrDerivedClass<MultiRelationship>())
            {
                return await this.MultiRelationshipService.UpsertConceptAsync(transaction, partition, relationship, container);
            }
            throw new NotSupportedException(string.Format("The supplied DTO type: {0} is not a supported type", relationship.GetType().Name));
        }
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having List of instances of <see cref="Relationship"/> as result.
        /// </returns>
        public async Task<IEnumerable<Thing>> GetShallowAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var authorizedContext = this.AuthorizeReadRequest("Relationship", containerSecurityContext, partition);
            ...
            var relationshipColl = new List<Thing>();
            relationshipColl.AddRange(await this.BinaryRelationshipService.GetShallowAsync(transaction, partition, idFilter, authorizedContext));
            relationshipColl.AddRange(await this.MultiRelationshipService.GetShallowAsync(transaction, partition, idFilter, authorizedContext));

            return await this.AfterGetAsync(relationshipColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having List of instances of <see cref="Relationship"/> and contained <see cref="Thing"/>s as result.
        /// </returns>
        public async Task<IEnumerable<Thing>> GetDeepAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            results.AddRange(await this.BinaryRelationshipService.GetDeepAsync(transaction, partition, idFilter, containerSecurityContext));
            results.AddRange(await this.MultiRelationshipService.GetDeepAsync(transaction, partition, idFilter, containerSecurityContext));
            return results;
        }

...
namespace CometServer.Services
{
    ...
    public sealed partial class ExternalIdentifierMapService : ServiceBase, IExternalIdentifierMapService
    {
        ...
        {
            return this.ExternalIdentifierMapDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.ExternalIdentifierMapDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.ExternalIdentifierMapDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.ExternalIdentifierMapDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

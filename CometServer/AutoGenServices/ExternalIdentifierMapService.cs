// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ExternalIdentifierMapService.cs" company="Starion Group S.A.">
...
namespace CometServer.Services
{
    ...
    /// <summary>
    /// The <see cref="ExternalIdentifierMap"/> Service which uses the ORM layer to interact with the data model.
    /// </summary>
    public sealed partial class ExternalIdentifierMapService : ServiceBase, IExternalIdentifierMapService
    {
        /// <summary>
        /// Gets or sets the <see cref="IIdCorrespondenceService"/>.
        /// </summary>
        public IIdCorrespondenceService CorrespondenceService { get; set; }

        /// <summary>
        /// Gets or sets the <see cref="IExternalIdentifierMapDao"/>.
        /// </summary>
        public IExternalIdentifierMapDao ExternalIdentifierMapDao { get; set; }

        /// <summary>
        /// Get the requested <see cref="ExternalIdentifierMap"/>s from the ORM layer.
        /// </summary>
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having a list of instances of <see cref="ExternalIdentifierMap"/>, optionally with contained <see cref="Thing"/>s as result.
        /// </returns>
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="ExternalIdentifierMap"/> id that will be the source for each link table record.
        /// </param>
        /// <param name="value">
        ...
        {
            return await this.ExternalIdentifierMapDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="ExternalIdentifierMap"/> id that is the source of the link table records.
        /// </param>
        /// <param name="value">
        ...
        {
            return await this.ExternalIdentifierMapDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="ExternalIdentifierMap"/> id that is the source for the reordered link table record.
        /// </param>
        ...
        {
            return await this.ExternalIdentifierMapDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        /// <summary>
        /// Delete the supplied <see cref="ExternalIdentifierMap"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="ExternalIdentifierMap"/> to delete.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="ExternalIdentifierMap"/> to be removed.
        /// </param>
        /// <returns>
        ...
        public async Task<bool> DeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return await this.ExternalIdentifierMapDao.DeleteAsync(transaction, partition, thing.Iid);
        }
        ...
        public async Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return await this.ExternalIdentifierMapDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

        /// <summary>
        /// Update the supplied <see cref="ExternalIdentifierMap"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="ExternalIdentifierMap"/> <see cref="Thing"/> to update.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="ExternalIdentifierMap"/> to be updated.
        /// </param>
        /// <returns>
        ...
        public async Task<bool> UpdateConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return await this.ExternalIdentifierMapDao.UpdateAsync(transaction, partition, externalIdentifierMap, container);
        }

        /// <summary>
        /// Persist the supplied <see cref="ExternalIdentifierMap"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="ExternalIdentifierMap"/> <see cref="Thing"/> to create.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="ExternalIdentifierMap"/> to be persisted.
        /// </param>
        /// <param name="sequence">
        ...
        public async Task<bool> CreateConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var externalIdentifierMap = thing as ExternalIdentifierMap;
            var createSuccesful = await this.ExternalIdentifierMapDao.WriteAsync(transaction, partition, externalIdentifierMap, container);
            return createSuccesful && await this.CreateContainmentAsync(transaction, partition, externalIdentifierMap);
        }

        /// <summary>
        /// Persist the supplied <see cref="ExternalIdentifierMap"/> instance. Update if it already exists.
        /// This is typically used during the import of existing data to the Database.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        ...
        {
            var externalIdentifierMap = thing as ExternalIdentifierMap;
            var createSuccesful = await this.ExternalIdentifierMapDao.UpsertAsync(transaction, partition, externalIdentifierMap, container);
            return createSuccesful && await this.UpsertContainmentAsync(transaction, partition, externalIdentifierMap);
        }
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having List of instances of <see cref="ExternalIdentifierMap"/> as result.
        /// </returns>
        public async Task<IEnumerable<Thing>> GetShallowAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var authorizedContext = this.AuthorizeReadRequest("ExternalIdentifierMap", containerSecurityContext, partition);
            ...
            var externalIdentifierMapColl = new List<Thing>(await this.ExternalIdentifierMapDao.ReadAsync(transaction, partition, idFilter, await this.TransactionManager.IsCachedDtoReadEnabledAsync(transaction), (DateTime)(await this.TransactionManager.GetRawSessionInstantAsync(transaction))));

            return await this.AfterGetAsync(externalIdentifierMapColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having List of instances of <see cref="ExternalIdentifierMap"/> and contained <see cref="Thing"/>s as result.
        /// </returns>
        public async Task<IEnumerable<Thing>> GetDeepAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var externalIdentifierMapColl = results.Where(i => i.GetType() == typeof(ExternalIdentifierMap)).Cast<ExternalIdentifierMap>().ToList();

            results.AddRange(await this.CorrespondenceService.GetDeepAsync(transaction, partition, externalIdentifierMapColl.SelectMany(x => x.Correspondence), containerSecurityContext));
        ...
        /// <summary>
        /// Persist the <see cref="ExternalIdentifierMap"/> containment tree to the ORM layer.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// The <see cref="ExternalIdentifierMap"/> instance to persist.
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having True if the persistence was successful as result.
        /// </returns>
        private async Task<bool> CreateContainmentAsync(NpgsqlTransaction transaction, string partition, ExternalIdentifierMap externalIdentifierMap)
        {
            var results = new List<bool>();

            foreach (var correspondence in this.ResolveFromRequestCache(externalIdentifierMap.Correspondence))
            {
                results.Add(await this.CorrespondenceService.CreateConceptAsync(transaction, partition, correspondence, externalIdentifierMap));
            }
        ...
        /// <summary>
        /// Persist the <see cref="ExternalIdentifierMap"/> containment tree to the ORM layer. Update if it already exists.
        /// This is typically used during the import of existing data to the Database.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        ...
        /// An awaitable <see cref="Task"/> having True if the persistence was successful as result.
        /// </returns>
        private async Task<bool> UpsertContainmentAsync(NpgsqlTransaction transaction, string partition, ExternalIdentifierMap externalIdentifierMap)
        {
            var results = new List<bool>();

            foreach (var correspondence in this.ResolveFromRequestCache(externalIdentifierMap.Correspondence))
            {
                results.Add(await this.CorrespondenceService.UpsertConceptAsync(transaction, partition, correspondence, externalIdentifierMap));
            }

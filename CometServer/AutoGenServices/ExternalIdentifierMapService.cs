...
namespace CometServer.Services
{
    ...
    public sealed partial class ExternalIdentifierMapService : ServiceBase, IExternalIdentifierMapService
    {
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="ExternalIdentifierMap"/>, optionally with contained <see cref="Thing"/>s.
        /// </returns>
        ...
        {
            return this.ExternalIdentifierMapDao.AddToCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.ExternalIdentifierMapDao.DeleteFromCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.ExternalIdentifierMapDao.ReorderCollectionProperty(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public bool DeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.ExternalIdentifierMapDao.Delete(transaction, partition, thing.Iid);
        }
        ...
        public bool RawDeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.ExternalIdentifierMapDao.RawDelete(transaction, partition, thing.Iid);
        }
        ...
        public bool UpdateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return this.ExternalIdentifierMapDao.Update(transaction, partition, externalIdentifierMap, container);
        }
        ...
        public bool CreateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var externalIdentifierMap = thing as ExternalIdentifierMap;
            var createSuccesful = this.ExternalIdentifierMapDao.Write(transaction, partition, externalIdentifierMap, container);
            return createSuccesful && this.CreateContainment(transaction, partition, externalIdentifierMap);
        }
        ...
        {
            var externalIdentifierMap = thing as ExternalIdentifierMap;
            var createSuccesful = this.ExternalIdentifierMapDao.Upsert(transaction, partition, externalIdentifierMap, container);
            return createSuccesful && this.UpsertContainment(transaction, partition, externalIdentifierMap);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="ExternalIdentifierMap"/>.
        /// </returns>
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var externalIdentifierMapColl = new List<Thing>(this.ExternalIdentifierMapDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction), (DateTime)this.TransactionManager.GetRawSessionInstant(transaction)));

            return this.AfterGet(externalIdentifierMapColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="ExternalIdentifierMap"/> and contained <see cref="Thing"/>s.
        /// </returns>
        public IEnumerable<Thing> GetDeep(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            results.AddRange(this.CorrespondenceService.GetDeep(transaction, partition, externalIdentifierMapColl.SelectMany(x => x.Correspondence), containerSecurityContext));
        ...
        private bool CreateContainment(NpgsqlTransaction transaction, string partition, ExternalIdentifierMap externalIdentifierMap)
        {
            ...
            {
                results.Add(this.CorrespondenceService.CreateConcept(transaction, partition, correspondence, externalIdentifierMap));
            }
        ...
        /// True if the persistence was successful.
        /// </returns>
        private bool UpsertContainment(NpgsqlTransaction transaction, string partition, ExternalIdentifierMap externalIdentifierMap)
        {
            var results = new List<bool>();

            foreach (var correspondence in this.ResolveFromRequestCache(externalIdentifierMap.Correspondence))
            {
                results.Add(this.CorrespondenceService.UpsertConcept(transaction, partition, correspondence, externalIdentifierMap));
            }

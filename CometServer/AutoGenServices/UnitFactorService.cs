...
namespace CometServer.Services
{
    ...
    public sealed partial class UnitFactorService : ServiceBase, IUnitFactorService
    {
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="UnitFactor"/>, optionally with contained <see cref="Thing"/>s.
        /// </returns>
        ...
        {
            return this.UnitFactorDao.AddToCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.UnitFactorDao.DeleteFromCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.UnitFactorDao.ReorderCollectionProperty(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        {
            return this.UnitFactorDao.ReorderContainment(transaction, partition, orderedItem);
        }
        ...
        public bool DeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.UnitFactorDao.Delete(transaction, partition, thing.Iid);
        }
        ...
        public bool RawDeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.UnitFactorDao.RawDelete(transaction, partition, thing.Iid);
        }
        ...
        public bool UpdateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return this.UnitFactorDao.Update(transaction, partition, unitFactor, container);
        }
        ...
        public bool CreateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var unitFactor = thing as UnitFactor;
            return this.UnitFactorDao.Write(transaction, partition, unitFactor, sequence, container);
        }
        ...
        {
            var unitFactor = thing as UnitFactor;
            return this.UnitFactorDao.Upsert(transaction, partition, unitFactor, sequence, container);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="UnitFactor"/>.
        /// </returns>
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var unitFactorColl = new List<Thing>(this.UnitFactorDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction), (DateTime)this.TransactionManager.GetRawSessionInstant(transaction)));

            return this.AfterGet(unitFactorColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="UnitFactor"/> and contained <see cref="Thing"/>s.
        /// </returns>

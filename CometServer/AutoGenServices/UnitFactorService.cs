...
namespace CometServer.Services
{
    ...
    public sealed partial class UnitFactorService : ServiceBase, IUnitFactorService
    {
        ...
        {
            return this.UnitFactorDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.UnitFactorDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.UnitFactorDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        {
            return this.UnitFactorDao.ReorderContainmentAsync(transaction, partition, orderedItem);
        }
        ...
        public Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.UnitFactorDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

...
namespace CometServer.Services
{
    ...
    /// <summary>
    /// The <see cref="RuleVerification"/> Service which uses the ORM layer to interact with the data model.
    /// </summary>
    [ExcludeFromCodeCoverage]
    public sealed partial class RuleVerificationService : ServiceBase, IRuleVerificationService
    {
        /// <summary>
        /// Gets or sets the <see cref="IBuiltInRuleVerificationService"/>.
        /// </summary>
        public IBuiltInRuleVerificationService BuiltInRuleVerificationService { get; set; }

        /// <summary>
        /// Gets or sets the <see cref="IUserRuleVerificationService"/>.
        /// </summary>
        public IUserRuleVerificationService UserRuleVerificationService { get; set; }

        /// <summary>
        /// Get the requested <see cref="RuleVerification"/>s from the ORM layer.
        /// </summary>
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having a list of instances of <see cref="RuleVerification"/>, optionally with contained <see cref="Thing"/>s as result.
        /// </returns>
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="RuleVerification"/> id that will be the source for each link table record.
        /// </param>
        /// <param name="value">
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="RuleVerification"/> id that is the source of the link table records.
        /// </param>
        /// <param name="value">
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="RuleVerification"/> id that is the source for the reordered link table record.
        /// </param>
        ...
        /// <summary>
        /// Delete the supplied <see cref="RuleVerification"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="RuleVerification"/> to delete.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="RuleVerification"/> to be removed.
        /// </param>
        /// <returns>
        ...
        /// <summary>
        /// Update the supplied <see cref="RuleVerification"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="RuleVerification"/> <see cref="Thing"/> to update.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="RuleVerification"/> to be updated.
        /// </param>
        /// <returns>
        ...
        public async Task<bool> UpdateConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            var ruleVerification = thing as RuleVerification;
            if (ruleVerification.IsSameOrDerivedClass<BuiltInRuleVerification>())
            {
                return await this.BuiltInRuleVerificationService.UpdateConceptAsync(transaction, partition, ruleVerification, container);
            }

            if (ruleVerification.IsSameOrDerivedClass<UserRuleVerification>())
            {
                return await this.UserRuleVerificationService.UpdateConceptAsync(transaction, partition, ruleVerification, container);
            }
            throw new NotSupportedException(string.Format("The supplied DTO type: {0} is not a supported type", ruleVerification.GetType().Name));
        }

        /// <summary>
        /// Persist the supplied <see cref="RuleVerification"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="RuleVerification"/> <see cref="Thing"/> to create.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="RuleVerification"/> to be persisted.
        /// </param>
        /// <param name="sequence">
        ...
        public async Task<bool> CreateConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            if (ruleVerification.IsSameOrDerivedClass<BuiltInRuleVerification>())
            {
                return await this.BuiltInRuleVerificationService.CreateConceptAsync(transaction, partition, ruleVerification, container, sequence);
            }

            if (ruleVerification.IsSameOrDerivedClass<UserRuleVerification>())
            {
                return await this.UserRuleVerificationService.CreateConceptAsync(transaction, partition, ruleVerification, container, sequence);
            }
            throw new NotSupportedException(string.Format("The supplied DTO type: {0} is not a supported type", ruleVerification.GetType().Name));
        }

        /// <summary>
        /// Persist the supplied <see cref="RuleVerification"/> instance. Update if it already exists.
        /// This is typically used during the import of existing data to the Database.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        ...
        public async Task<bool> UpsertConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            if (ruleVerification.IsSameOrDerivedClass<BuiltInRuleVerification>())
            {
                return await this.BuiltInRuleVerificationService.UpsertConceptAsync(transaction, partition, ruleVerification, container, sequence);
            }

            if (ruleVerification.IsSameOrDerivedClass<UserRuleVerification>())
            {
                return await this.UserRuleVerificationService.UpsertConceptAsync(transaction, partition, ruleVerification, container, sequence);
            }
            throw new NotSupportedException(string.Format("The supplied DTO type: {0} is not a supported type", ruleVerification.GetType().Name));
        }
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having List of instances of <see cref="RuleVerification"/> as result.
        /// </returns>
        public async Task<IEnumerable<Thing>> GetShallowAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var authorizedContext = this.AuthorizeReadRequest("RuleVerification", containerSecurityContext, partition);
            ...
            var ruleVerificationColl = new List<Thing>();
            ruleVerificationColl.AddRange(await this.BuiltInRuleVerificationService.GetShallowAsync(transaction, partition, idFilter, authorizedContext));
            ruleVerificationColl.AddRange(await this.UserRuleVerificationService.GetShallowAsync(transaction, partition, idFilter, authorizedContext));

            return await this.AfterGetAsync(ruleVerificationColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having List of instances of <see cref="RuleVerification"/> and contained <see cref="Thing"/>s as result.
        /// </returns>
        public async Task<IEnumerable<Thing>> GetDeepAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            results.AddRange(await this.BuiltInRuleVerificationService.GetDeepAsync(transaction, partition, idFilter, containerSecurityContext));
            results.AddRange(await this.UserRuleVerificationService.GetDeepAsync(transaction, partition, idFilter, containerSecurityContext));
            return results;
        }

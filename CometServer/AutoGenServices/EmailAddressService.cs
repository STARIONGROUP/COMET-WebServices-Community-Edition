...
namespace CometServer.Services
{
    ...
    public sealed partial class EmailAddressService : ServiceBase, IEmailAddressService
    {
        ...
        {
            return this.EmailAddressDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.EmailAddressDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.EmailAddressDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.EmailAddressDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

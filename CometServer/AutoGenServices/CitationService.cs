...
namespace CometServer.Services
{
    ...
    public sealed partial class CitationService : ServiceBase, ICitationService
    {
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="Citation"/>, optionally with contained <see cref="Thing"/>s.
        /// </returns>
        ...
        {
            return this.CitationDao.AddToCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.CitationDao.DeleteFromCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.CitationDao.ReorderCollectionProperty(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public bool DeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.CitationDao.Delete(transaction, partition, thing.Iid);
        }
        ...
        public bool RawDeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.CitationDao.RawDelete(transaction, partition, thing.Iid);
        }
        ...
        public bool UpdateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return this.CitationDao.Update(transaction, partition, citation, container);
        }
        ...
        public bool CreateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var citation = thing as Citation;
            return this.CitationDao.Write(transaction, partition, citation, container);
        }
        ...
        {
            var citation = thing as Citation;
            return this.CitationDao.Upsert(transaction, partition, citation, container);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="Citation"/>.
        /// </returns>
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var citationColl = new List<Thing>(this.CitationDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction), (DateTime)this.TransactionManager.GetRawSessionInstant(transaction)));

            return this.AfterGet(citationColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="Citation"/> and contained <see cref="Thing"/>s.
        /// </returns>

...
namespace CometServer.Services
{
    ...
    public sealed partial class CitationService : ServiceBase, ICitationService
    {
        ...
        {
            return this.CitationDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.CitationDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.CitationDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.CitationDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

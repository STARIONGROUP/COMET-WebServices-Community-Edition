// --------------------------------------------------------------------------------------------------------------------
// <copyright file="RelationshipParameterValueService.cs" company="Starion Group S.A.">
...
namespace CometServer.Services
{
    ...
    /// <summary>
    /// The <see cref="RelationshipParameterValue"/> Service which uses the ORM layer to interact with the data model.
    /// </summary>
    public sealed partial class RelationshipParameterValueService : ServiceBase, IRelationshipParameterValueService
    {
        /// <summary>
        /// Gets or sets the <see cref="IRelationshipParameterValueDao"/>.
        /// </summary>
        public IRelationshipParameterValueDao RelationshipParameterValueDao { get; set; }

        /// <summary>
        /// Get the requested <see cref="RelationshipParameterValue"/>s from the ORM layer.
        /// </summary>
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having a list of instances of <see cref="RelationshipParameterValue"/>, optionally with contained <see cref="Thing"/>s as result.
        /// </returns>
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="RelationshipParameterValue"/> id that will be the source for each link table record.
        /// </param>
        /// <param name="value">
        ...
        {
            return await this.RelationshipParameterValueDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="RelationshipParameterValue"/> id that is the source of the link table records.
        /// </param>
        /// <param name="value">
        ...
        {
            return await this.RelationshipParameterValueDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="RelationshipParameterValue"/> id that is the source for the reordered link table record.
        /// </param>
        ...
        {
            return await this.RelationshipParameterValueDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        /// <summary>
        /// Delete the supplied <see cref="RelationshipParameterValue"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="RelationshipParameterValue"/> to delete.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="RelationshipParameterValue"/> to be removed.
        /// </param>
        /// <returns>
        ...
        public async Task<bool> DeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return await this.RelationshipParameterValueDao.DeleteAsync(transaction, partition, thing.Iid);
        }
        ...
        public async Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return await this.RelationshipParameterValueDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

        /// <summary>
        /// Update the supplied <see cref="RelationshipParameterValue"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="RelationshipParameterValue"/> <see cref="Thing"/> to update.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="RelationshipParameterValue"/> to be updated.
        /// </param>
        /// <returns>
        ...
        public async Task<bool> UpdateConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return await this.RelationshipParameterValueDao.UpdateAsync(transaction, partition, relationshipParameterValue, container);
        }

        /// <summary>
        /// Persist the supplied <see cref="RelationshipParameterValue"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="RelationshipParameterValue"/> <see cref="Thing"/> to create.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="RelationshipParameterValue"/> to be persisted.
        /// </param>
        /// <param name="sequence">
        ...
        public async Task<bool> CreateConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var relationshipParameterValue = thing as RelationshipParameterValue;
            return await this.RelationshipParameterValueDao.WriteAsync(transaction, partition, relationshipParameterValue, container);
        }

        /// <summary>
        /// Persist the supplied <see cref="RelationshipParameterValue"/> instance. Update if it already exists.
        /// This is typically used during the import of existing data to the Database.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        ...
        {
            var relationshipParameterValue = thing as RelationshipParameterValue;
            return await this.RelationshipParameterValueDao.UpsertAsync(transaction, partition, relationshipParameterValue, container);
        }
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having List of instances of <see cref="RelationshipParameterValue"/> as result.
        /// </returns>
        public async Task<IEnumerable<Thing>> GetShallowAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var authorizedContext = this.AuthorizeReadRequest("RelationshipParameterValue", containerSecurityContext, partition);
            ...
            var relationshipParameterValueColl = new List<Thing>(await this.RelationshipParameterValueDao.ReadAsync(transaction, partition, idFilter, await this.TransactionManager.IsCachedDtoReadEnabledAsync(transaction), (DateTime)(await this.TransactionManager.GetRawSessionInstantAsync(transaction))));

            return await this.AfterGetAsync(relationshipParameterValueColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having List of instances of <see cref="RelationshipParameterValue"/> and contained <see cref="Thing"/>s as result.
        /// </returns>

...
namespace CometServer.Services
{
    ...
    public sealed partial class RelationshipParameterValueService : ServiceBase, IRelationshipParameterValueService
    {
        ...
        {
            return this.RelationshipParameterValueDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.RelationshipParameterValueDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.RelationshipParameterValueDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.RelationshipParameterValueDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

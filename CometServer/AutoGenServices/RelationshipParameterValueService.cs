...
namespace CometServer.Services
{
    ...
    public sealed partial class RelationshipParameterValueService : ServiceBase, IRelationshipParameterValueService
    {
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="RelationshipParameterValue"/>, optionally with contained <see cref="Thing"/>s.
        /// </returns>
        ...
        {
            return this.RelationshipParameterValueDao.AddToCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.RelationshipParameterValueDao.DeleteFromCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.RelationshipParameterValueDao.ReorderCollectionProperty(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public bool DeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.RelationshipParameterValueDao.Delete(transaction, partition, thing.Iid);
        }
        ...
        public bool RawDeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.RelationshipParameterValueDao.RawDelete(transaction, partition, thing.Iid);
        }
        ...
        public bool UpdateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return this.RelationshipParameterValueDao.Update(transaction, partition, relationshipParameterValue, container);
        }
        ...
        public bool CreateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var relationshipParameterValue = thing as RelationshipParameterValue;
            return this.RelationshipParameterValueDao.Write(transaction, partition, relationshipParameterValue, container);
        }
        ...
        {
            var relationshipParameterValue = thing as RelationshipParameterValue;
            return this.RelationshipParameterValueDao.Upsert(transaction, partition, relationshipParameterValue, container);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="RelationshipParameterValue"/>.
        /// </returns>
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var relationshipParameterValueColl = new List<Thing>(this.RelationshipParameterValueDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction), (DateTime)this.TransactionManager.GetRawSessionInstant(transaction)));

            return this.AfterGet(relationshipParameterValueColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="RelationshipParameterValue"/> and contained <see cref="Thing"/>s.
        /// </returns>

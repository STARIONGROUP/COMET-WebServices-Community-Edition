...
namespace CometServer.Services
{
    ...
    public sealed partial class ColorService : ServiceBase, IColorService
    {
        ...
        {
            return this.ColorDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.ColorDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.ColorDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.ColorDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

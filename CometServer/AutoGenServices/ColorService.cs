...
namespace CometServer.Services
{
    ...
    public sealed partial class ColorService : ServiceBase, IColorService
    {
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="Color"/>, optionally with contained <see cref="Thing"/>s.
        /// </returns>
        ...
        {
            return this.ColorDao.AddToCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.ColorDao.DeleteFromCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.ColorDao.ReorderCollectionProperty(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public bool DeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.ColorDao.Delete(transaction, partition, thing.Iid);
        }
        ...
        public bool RawDeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.ColorDao.RawDelete(transaction, partition, thing.Iid);
        }
        ...
        public bool UpdateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return this.ColorDao.Update(transaction, partition, color, container);
        }
        ...
        public bool CreateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var color = thing as Color;
            return this.ColorDao.Write(transaction, partition, color, container);
        }
        ...
        {
            var color = thing as Color;
            return this.ColorDao.Upsert(transaction, partition, color, container);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="Color"/>.
        /// </returns>
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var colorColl = new List<Thing>(this.ColorDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction), (DateTime)this.TransactionManager.GetRawSessionInstant(transaction)));

            return this.AfterGet(colorColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="Color"/> and contained <see cref="Thing"/>s.
        /// </returns>

...
namespace CometServer.Services
{
    ...
    public sealed partial class ArrayParameterTypeService : ServiceBase, IArrayParameterTypeService
    {
        ...
        public async Task<IEnumerable<Thing>> GetShallowAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var arrayParameterTypeColl = new List<Thing>(await this.ArrayParameterTypeDao.ReadAsync(transaction, partition, idFilter, isCachedDtoReadEnabled, sessionInstant));

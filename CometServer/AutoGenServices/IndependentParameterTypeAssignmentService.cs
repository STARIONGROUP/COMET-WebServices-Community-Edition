...
namespace CometServer.Services
{
    ...
    public sealed partial class IndependentParameterTypeAssignmentService : ServiceBase, IIndependentParameterTypeAssignmentService
    {
        ...
        public async Task<IEnumerable<Thing>> GetShallowAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var independentParameterTypeAssignmentColl = new List<Thing>(await this.IndependentParameterTypeAssignmentDao.ReadAsync(transaction, partition, idFilter, isCachedDtoReadEnabled, sessionInstant));

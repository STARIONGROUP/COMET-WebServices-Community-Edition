// --------------------------------------------------------------------------------------------------------------------
// <copyright file="IndependentParameterTypeAssignmentService.cs" company="Starion Group S.A.">
...
namespace CometServer.Services
{
    ...
    /// <summary>
    /// The <see cref="IndependentParameterTypeAssignment"/> Service which uses the ORM layer to interact with the data model.
    /// </summary>
    public sealed partial class IndependentParameterTypeAssignmentService : ServiceBase, IIndependentParameterTypeAssignmentService
    {
        /// <summary>
        /// Gets or sets the <see cref="IIndependentParameterTypeAssignmentDao"/>.
        /// </summary>
        public IIndependentParameterTypeAssignmentDao IndependentParameterTypeAssignmentDao { get; set; }

        /// <summary>
        /// Get the requested <see cref="IndependentParameterTypeAssignment"/>s from the ORM layer.
        /// </summary>
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having a list of instances of <see cref="IndependentParameterTypeAssignment"/>, optionally with contained <see cref="Thing"/>s as result.
        /// </returns>
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="IndependentParameterTypeAssignment"/> id that will be the source for each link table record.
        /// </param>
        /// <param name="value">
        ...
        {
            return await this.IndependentParameterTypeAssignmentDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="IndependentParameterTypeAssignment"/> id that is the source of the link table records.
        /// </param>
        /// <param name="value">
        ...
        {
            return await this.IndependentParameterTypeAssignmentDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="IndependentParameterTypeAssignment"/> id that is the source for the reordered link table record.
        /// </param>
        ...
        {
            return await this.IndependentParameterTypeAssignmentDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        {
            return await this.IndependentParameterTypeAssignmentDao.ReorderContainmentAsync(transaction, partition, orderedItem);
        }

        /// <summary>
        /// Delete the supplied <see cref="IndependentParameterTypeAssignment"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="IndependentParameterTypeAssignment"/> to delete.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="IndependentParameterTypeAssignment"/> to be removed.
        /// </param>
        /// <returns>
        ...
        public async Task<bool> DeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return await this.IndependentParameterTypeAssignmentDao.DeleteAsync(transaction, partition, thing.Iid);
        }
        ...
        public async Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return await this.IndependentParameterTypeAssignmentDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

        /// <summary>
        /// Update the supplied <see cref="IndependentParameterTypeAssignment"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="IndependentParameterTypeAssignment"/> <see cref="Thing"/> to update.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="IndependentParameterTypeAssignment"/> to be updated.
        /// </param>
        /// <returns>
        ...
        public async Task<bool> UpdateConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return await this.IndependentParameterTypeAssignmentDao.UpdateAsync(transaction, partition, independentParameterTypeAssignment, container);
        }

        /// <summary>
        /// Persist the supplied <see cref="IndependentParameterTypeAssignment"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="IndependentParameterTypeAssignment"/> <see cref="Thing"/> to create.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="IndependentParameterTypeAssignment"/> to be persisted.
        /// </param>
        /// <param name="sequence">
        ...
        public async Task<bool> CreateConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var independentParameterTypeAssignment = thing as IndependentParameterTypeAssignment;
            return await this.IndependentParameterTypeAssignmentDao.WriteAsync(transaction, partition, independentParameterTypeAssignment, sequence, container);
        }

        /// <summary>
        /// Persist the supplied <see cref="IndependentParameterTypeAssignment"/> instance. Update if it already exists.
        /// This is typically used during the import of existing data to the Database.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        ...
        {
            var independentParameterTypeAssignment = thing as IndependentParameterTypeAssignment;
            return await this.IndependentParameterTypeAssignmentDao.UpsertAsync(transaction, partition, independentParameterTypeAssignment, sequence, container);
        }
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having List of instances of <see cref="IndependentParameterTypeAssignment"/> as result.
        /// </returns>
        public async Task<IEnumerable<Thing>> GetShallowAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var authorizedContext = this.AuthorizeReadRequest("IndependentParameterTypeAssignment", containerSecurityContext, partition);
            ...
            var independentParameterTypeAssignmentColl = new List<Thing>(await this.IndependentParameterTypeAssignmentDao.ReadAsync(transaction, partition, idFilter, await this.TransactionManager.IsCachedDtoReadEnabledAsync(transaction), (DateTime)(await this.TransactionManager.GetRawSessionInstantAsync(transaction))));

            return await this.AfterGetAsync(independentParameterTypeAssignmentColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having List of instances of <see cref="IndependentParameterTypeAssignment"/> and contained <see cref="Thing"/>s as result.
        /// </returns>

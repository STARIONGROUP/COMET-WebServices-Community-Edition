...
namespace CometServer.Services
{
    ...
    public sealed partial class IndependentParameterTypeAssignmentService : ServiceBase, IIndependentParameterTypeAssignmentService
    {
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="IndependentParameterTypeAssignment"/>, optionally with contained <see cref="Thing"/>s.
        /// </returns>
        ...
        {
            return this.IndependentParameterTypeAssignmentDao.AddToCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.IndependentParameterTypeAssignmentDao.DeleteFromCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.IndependentParameterTypeAssignmentDao.ReorderCollectionProperty(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        {
            return this.IndependentParameterTypeAssignmentDao.ReorderContainment(transaction, partition, orderedItem);
        }
        ...
        public bool DeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.IndependentParameterTypeAssignmentDao.Delete(transaction, partition, thing.Iid);
        }
        ...
        public bool RawDeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.IndependentParameterTypeAssignmentDao.RawDelete(transaction, partition, thing.Iid);
        }
        ...
        public bool UpdateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return this.IndependentParameterTypeAssignmentDao.Update(transaction, partition, independentParameterTypeAssignment, container);
        }
        ...
        public bool CreateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var independentParameterTypeAssignment = thing as IndependentParameterTypeAssignment;
            return this.IndependentParameterTypeAssignmentDao.Write(transaction, partition, independentParameterTypeAssignment, sequence, container);
        }
        ...
        {
            var independentParameterTypeAssignment = thing as IndependentParameterTypeAssignment;
            return this.IndependentParameterTypeAssignmentDao.Upsert(transaction, partition, independentParameterTypeAssignment, sequence, container);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="IndependentParameterTypeAssignment"/>.
        /// </returns>
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var independentParameterTypeAssignmentColl = new List<Thing>(this.IndependentParameterTypeAssignmentDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction), (DateTime)this.TransactionManager.GetRawSessionInstant(transaction)));

            return this.AfterGet(independentParameterTypeAssignmentColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="IndependentParameterTypeAssignment"/> and contained <see cref="Thing"/>s.
        /// </returns>

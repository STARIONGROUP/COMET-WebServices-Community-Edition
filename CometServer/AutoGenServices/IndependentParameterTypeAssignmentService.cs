...
namespace CometServer.Services
{
    ...
    public sealed partial class IndependentParameterTypeAssignmentService : ServiceBase, IIndependentParameterTypeAssignmentService
    {
        ...
        {
            return this.IndependentParameterTypeAssignmentDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.IndependentParameterTypeAssignmentDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.IndependentParameterTypeAssignmentDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        {
            return this.IndependentParameterTypeAssignmentDao.ReorderContainmentAsync(transaction, partition, orderedItem);
        }
        ...
        public Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.IndependentParameterTypeAssignmentDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

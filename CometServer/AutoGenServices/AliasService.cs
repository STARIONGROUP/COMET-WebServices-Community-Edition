...
namespace CometServer.Services
{
    ...
    public sealed partial class AliasService : ServiceBase, IAliasService
    {
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="Alias"/>, optionally with contained <see cref="Thing"/>s.
        /// </returns>
        ...
        {
            return this.AliasDao.AddToCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.AliasDao.DeleteFromCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.AliasDao.ReorderCollectionProperty(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public bool DeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.AliasDao.Delete(transaction, partition, thing.Iid);
        }
        ...
        public bool RawDeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.AliasDao.RawDelete(transaction, partition, thing.Iid);
        }
        ...
        public bool UpdateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return this.AliasDao.Update(transaction, partition, alias, container);
        }
        ...
        public bool CreateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var alias = thing as Alias;
            return this.AliasDao.Write(transaction, partition, alias, container);
        }
        ...
        {
            var alias = thing as Alias;
            return this.AliasDao.Upsert(transaction, partition, alias, container);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="Alias"/>.
        /// </returns>
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var aliasColl = new List<Thing>(this.AliasDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction), (DateTime)this.TransactionManager.GetRawSessionInstant(transaction)));

            return this.AfterGet(aliasColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="Alias"/> and contained <see cref="Thing"/>s.
        /// </returns>

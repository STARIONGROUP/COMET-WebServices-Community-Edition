...
namespace CometServer.Services
{
    ...
    public sealed partial class AliasService : ServiceBase, IAliasService
    {
        ...
        {
            return this.AliasDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.AliasDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.AliasDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.AliasDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

// --------------------------------------------------------------------------------------------------------------------
// <copyright file="NoteService.cs" company="Starion Group S.A.">
...
namespace CometServer.Services
{
    ...
    /// <summary>
    /// The <see cref="Note"/> Service which uses the ORM layer to interact with the data model.
    /// </summary>
    public sealed partial class NoteService : ServiceBase, INoteService
    {
        /// <summary>
        /// Gets or sets the <see cref="IBinaryNoteService"/>.
        /// </summary>
        public IBinaryNoteService BinaryNoteService { get; set; }

        /// <summary>
        /// Gets or sets the <see cref="ITextualNoteService"/>.
        /// </summary>
        public ITextualNoteService TextualNoteService { get; set; }

        /// <summary>
        /// Get the requested <see cref="Note"/>s from the ORM layer.
        /// </summary>
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having a list of instances of <see cref="Note"/>, optionally with contained <see cref="Thing"/>s as result.
        /// </returns>
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="Note"/> id that will be the source for each link table record.
        /// </param>
        /// <param name="value">
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="Note"/> id that is the source of the link table records.
        /// </param>
        /// <param name="value">
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="Note"/> id that is the source for the reordered link table record.
        /// </param>
        ...
        /// <summary>
        /// Delete the supplied <see cref="Note"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="Note"/> to delete.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="Note"/> to be removed.
        /// </param>
        /// <returns>
        ...
        /// <summary>
        /// Update the supplied <see cref="Note"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="Note"/> <see cref="Thing"/> to update.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="Note"/> to be updated.
        /// </param>
        /// <returns>
        ...
        public async Task<bool> UpdateConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            var note = thing as Note;
            if (note.IsSameOrDerivedClass<BinaryNote>())
            {
                return await this.BinaryNoteService.UpdateConceptAsync(transaction, partition, note, container);
            }

            if (note.IsSameOrDerivedClass<TextualNote>())
            {
                return await this.TextualNoteService.UpdateConceptAsync(transaction, partition, note, container);
            }
            throw new NotSupportedException(string.Format("The supplied DTO type: {0} is not a supported type", note.GetType().Name));
        }

        /// <summary>
        /// Persist the supplied <see cref="Note"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="Note"/> <see cref="Thing"/> to create.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="Note"/> to be persisted.
        /// </param>
        /// <param name="sequence">
        ...
        public async Task<bool> CreateConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            if (note.IsSameOrDerivedClass<BinaryNote>())
            {
                return await this.BinaryNoteService.CreateConceptAsync(transaction, partition, note, container, sequence);
            }

            if (note.IsSameOrDerivedClass<TextualNote>())
            {
                return await this.TextualNoteService.CreateConceptAsync(transaction, partition, note, container, sequence);
            }
            throw new NotSupportedException(string.Format("The supplied DTO type: {0} is not a supported type", note.GetType().Name));
        }

        /// <summary>
        /// Persist the supplied <see cref="Note"/> instance. Update if it already exists.
        /// This is typically used during the import of existing data to the Database.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        ...
        public async Task<bool> UpsertConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            if (note.IsSameOrDerivedClass<BinaryNote>())
            {
                return await this.BinaryNoteService.UpsertConceptAsync(transaction, partition, note, container, sequence);
            }

            if (note.IsSameOrDerivedClass<TextualNote>())
            {
                return await this.TextualNoteService.UpsertConceptAsync(transaction, partition, note, container, sequence);
            }
            throw new NotSupportedException(string.Format("The supplied DTO type: {0} is not a supported type", note.GetType().Name));
        }
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having List of instances of <see cref="Note"/> as result.
        /// </returns>
        public async Task<IEnumerable<Thing>> GetShallowAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var authorizedContext = this.AuthorizeReadRequest("Note", containerSecurityContext, partition);
            ...
            var noteColl = new List<Thing>();
            noteColl.AddRange(await this.BinaryNoteService.GetShallowAsync(transaction, partition, idFilter, authorizedContext));
            noteColl.AddRange(await this.TextualNoteService.GetShallowAsync(transaction, partition, idFilter, authorizedContext));

            return await this.AfterGetAsync(noteColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having List of instances of <see cref="Note"/> and contained <see cref="Thing"/>s as result.
        /// </returns>
        public async Task<IEnumerable<Thing>> GetDeepAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            results.AddRange(await this.BinaryNoteService.GetDeepAsync(transaction, partition, idFilter, containerSecurityContext));
            results.AddRange(await this.TextualNoteService.GetDeepAsync(transaction, partition, idFilter, containerSecurityContext));
            return results;
        }

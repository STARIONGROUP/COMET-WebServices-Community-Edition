...
namespace CometServer.Services
{
    ...
    public sealed partial class NoteService : ServiceBase, INoteService
    {
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="Note"/>, optionally with contained <see cref="Thing"/>s.
        /// </returns>
        ...
        public bool UpdateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            {
                return this.BinaryNoteService.UpdateConcept(transaction, partition, note, container);
            }

            if (note.IsSameOrDerivedClass<TextualNote>())
            {
                return this.TextualNoteService.UpdateConcept(transaction, partition, note, container);
            }
        ...
        public bool CreateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            if (note.IsSameOrDerivedClass<BinaryNote>())
            {
                return this.BinaryNoteService.CreateConcept(transaction, partition, note, container, sequence);
            }

            if (note.IsSameOrDerivedClass<TextualNote>())
            {
                return this.TextualNoteService.CreateConcept(transaction, partition, note, container, sequence);
            }
            throw new NotSupportedException(string.Format("The supplied DTO type: {0} is not a supported type", note.GetType().Name));
        }
        ...
        public bool UpsertConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            if (note.IsSameOrDerivedClass<BinaryNote>())
            {
                return this.BinaryNoteService.UpsertConcept(transaction, partition, note, container, sequence);
            }

            if (note.IsSameOrDerivedClass<TextualNote>())
            {
                return this.TextualNoteService.UpsertConcept(transaction, partition, note, container, sequence);
            }
            throw new NotSupportedException(string.Format("The supplied DTO type: {0} is not a supported type", note.GetType().Name));
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="Note"/>.
        /// </returns>
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            noteColl.AddRange(this.BinaryNoteService.GetShallow(transaction, partition, idFilter, authorizedContext));
            noteColl.AddRange(this.TextualNoteService.GetShallow(transaction, partition, idFilter, authorizedContext));

            return this.AfterGet(noteColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="Note"/> and contained <see cref="Thing"/>s.
        /// </returns>
        public IEnumerable<Thing> GetDeep(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            results.AddRange(this.BinaryNoteService.GetDeep(transaction, partition, idFilter, containerSecurityContext));
            results.AddRange(this.TextualNoteService.GetDeep(transaction, partition, idFilter, containerSecurityContext));
            return results;
        }

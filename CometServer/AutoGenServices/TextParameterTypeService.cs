...
namespace CometServer.Services
{
    ...
    public sealed partial class TextParameterTypeService : ServiceBase, ITextParameterTypeService
    {
        ...
        public async Task<IEnumerable<Thing>> GetShallowAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var textParameterTypeColl = new List<Thing>(await this.TextParameterTypeDao.ReadAsync(transaction, partition, idFilter, isCachedDtoReadEnabled, sessionInstant));

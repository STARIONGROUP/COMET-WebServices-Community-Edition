...
namespace CometServer.Services
{
    ...
    public sealed partial class PrefixedUnitService : ServiceBase, IPrefixedUnitService
    {
        ...
        {
            return this.PrefixedUnitDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.PrefixedUnitDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.PrefixedUnitDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.PrefixedUnitDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

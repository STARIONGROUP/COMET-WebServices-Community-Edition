// --------------------------------------------------------------------------------------------------------------------
// <copyright file="DiagramElementThingService.cs" company="Starion Group S.A.">
...
namespace CometServer.Services
{
    ...
    /// <summary>
    /// The <see cref="DiagramElementThing"/> Service which uses the ORM layer to interact with the data model.
    /// </summary>
    public sealed partial class DiagramElementThingService : ServiceBase, IDiagramElementThingService
    {
        /// <summary>
        /// Gets or sets the <see cref="IDiagramEdgeService"/>.
        /// </summary>
        public IDiagramEdgeService DiagramEdgeService { get; set; }

        /// <summary>
        /// Gets or sets the <see cref="IDiagramShapeService"/>.
        /// </summary>
        public IDiagramShapeService DiagramShapeService { get; set; }

        /// <summary>
        /// Get the requested <see cref="DiagramElementThing"/>s from the ORM layer.
        /// </summary>
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having a list of instances of <see cref="DiagramElementThing"/>, optionally with contained <see cref="Thing"/>s as result.
        /// </returns>
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="DiagramElementThing"/> id that will be the source for each link table record.
        /// </param>
        /// <param name="value">
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="DiagramElementThing"/> id that is the source of the link table records.
        /// </param>
        /// <param name="value">
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="DiagramElementThing"/> id that is the source for the reordered link table record.
        /// </param>
        ...
        /// <summary>
        /// Delete the supplied <see cref="DiagramElementThing"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="DiagramElementThing"/> to delete.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="DiagramElementThing"/> to be removed.
        /// </param>
        /// <returns>
        ...
        /// <summary>
        /// Update the supplied <see cref="DiagramElementThing"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="DiagramElementThing"/> <see cref="Thing"/> to update.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="DiagramElementThing"/> to be updated.
        /// </param>
        /// <returns>
        ...
        public async Task<bool> UpdateConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            var diagramElementThing = thing as DiagramElementThing;
            if (diagramElementThing.IsSameOrDerivedClass<DiagramEdge>())
            {
                return await this.DiagramEdgeService.UpdateConceptAsync(transaction, partition, diagramElementThing, container);
            }

            if (diagramElementThing.IsSameOrDerivedClass<DiagramShape>())
            {
                return await this.DiagramShapeService.UpdateConceptAsync(transaction, partition, diagramElementThing, container);
            }
            throw new NotSupportedException(string.Format("The supplied DTO type: {0} is not a supported type", diagramElementThing.GetType().Name));
        }

        /// <summary>
        /// Persist the supplied <see cref="DiagramElementThing"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="DiagramElementThing"/> <see cref="Thing"/> to create.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="DiagramElementThing"/> to be persisted.
        /// </param>
        /// <param name="sequence">
        ...
        public async Task<bool> CreateConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            if (diagramElementThing.IsSameOrDerivedClass<DiagramEdge>())
            {
                return await this.DiagramEdgeService.CreateConceptAsync(transaction, partition, diagramElementThing, container);
            }

            if (diagramElementThing.IsSameOrDerivedClass<DiagramShape>())
            {
                return await this.DiagramShapeService.CreateConceptAsync(transaction, partition, diagramElementThing, container);
            }
            throw new NotSupportedException(string.Format("The supplied DTO type: {0} is not a supported type", diagramElementThing.GetType().Name));
        }

        /// <summary>
        /// Persist the supplied <see cref="DiagramElementThing"/> instance. Update if it already exists.
        /// This is typically used during the import of existing data to the Database.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        ...
        public async Task<bool> UpsertConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            if (diagramElementThing.IsSameOrDerivedClass<DiagramEdge>())
            {
                return await this.DiagramEdgeService.UpsertConceptAsync(transaction, partition, diagramElementThing, container);
            }

            if (diagramElementThing.IsSameOrDerivedClass<DiagramShape>())
            {
                return await this.DiagramShapeService.UpsertConceptAsync(transaction, partition, diagramElementThing, container);
            }
            throw new NotSupportedException(string.Format("The supplied DTO type: {0} is not a supported type", diagramElementThing.GetType().Name));
        }
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having List of instances of <see cref="DiagramElementThing"/> as result.
        /// </returns>
        public async Task<IEnumerable<Thing>> GetShallowAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            diagramElementThingColl.AddRange(await this.DiagramEdgeService.GetShallowAsync(transaction, partition, idFilter, authorizedContext));
            diagramElementThingColl.AddRange(await this.DiagramShapeService.GetShallowAsync(transaction, partition, idFilter, authorizedContext));

            return await this.AfterGetAsync(diagramElementThingColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having List of instances of <see cref="DiagramElementThing"/> and contained <see cref="Thing"/>s as result.
        /// </returns>
        public async Task<IEnumerable<Thing>> GetDeepAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            results.AddRange(await this.DiagramEdgeService.GetDeepAsync(transaction, partition, idFilter, containerSecurityContext));
            results.AddRange(await this.DiagramShapeService.GetDeepAsync(transaction, partition, idFilter, containerSecurityContext));
            return results;
        }

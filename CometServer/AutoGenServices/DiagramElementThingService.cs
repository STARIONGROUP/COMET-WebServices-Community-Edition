...
namespace CometServer.Services
{
    ...
    public sealed partial class DiagramElementThingService : ServiceBase, IDiagramElementThingService
    {
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="DiagramElementThing"/>, optionally with contained <see cref="Thing"/>s.
        /// </returns>
        ...
        public bool UpdateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            {
                return this.DiagramEdgeService.UpdateConcept(transaction, partition, diagramElementThing, container);
            }

            if (diagramElementThing.IsSameOrDerivedClass<DiagramShape>())
            {
                return this.DiagramShapeService.UpdateConcept(transaction, partition, diagramElementThing, container);
            }
        ...
        public bool CreateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            if (diagramElementThing.IsSameOrDerivedClass<DiagramEdge>())
            {
                return this.DiagramEdgeService.CreateConcept(transaction, partition, diagramElementThing, container);
            }

            if (diagramElementThing.IsSameOrDerivedClass<DiagramShape>())
            {
                return this.DiagramShapeService.CreateConcept(transaction, partition, diagramElementThing, container);
            }
            throw new NotSupportedException(string.Format("The supplied DTO type: {0} is not a supported type", diagramElementThing.GetType().Name));
        }
        ...
        public bool UpsertConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            if (diagramElementThing.IsSameOrDerivedClass<DiagramEdge>())
            {
                return this.DiagramEdgeService.UpsertConcept(transaction, partition, diagramElementThing, container);
            }

            if (diagramElementThing.IsSameOrDerivedClass<DiagramShape>())
            {
                return this.DiagramShapeService.UpsertConcept(transaction, partition, diagramElementThing, container);
            }
            throw new NotSupportedException(string.Format("The supplied DTO type: {0} is not a supported type", diagramElementThing.GetType().Name));
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="DiagramElementThing"/> and contained <see cref="Thing"/>s.
        /// </returns>

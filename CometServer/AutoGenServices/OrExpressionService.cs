...
namespace CometServer.Services
{
    ...
    public sealed partial class OrExpressionService : ServiceBase, IOrExpressionService
    {
        ...
        {
            return this.OrExpressionDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.OrExpressionDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.OrExpressionDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.OrExpressionDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

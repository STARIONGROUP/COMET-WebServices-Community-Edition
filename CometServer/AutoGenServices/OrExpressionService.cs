...
namespace CometServer.Services
{
    ...
    public sealed partial class OrExpressionService : ServiceBase, IOrExpressionService
    {
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="OrExpression"/>, optionally with contained <see cref="Thing"/>s.
        /// </returns>
        ...
        {
            return this.OrExpressionDao.AddToCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.OrExpressionDao.DeleteFromCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.OrExpressionDao.ReorderCollectionProperty(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public bool DeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.OrExpressionDao.Delete(transaction, partition, thing.Iid);
        }
        ...
        public bool RawDeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.OrExpressionDao.RawDelete(transaction, partition, thing.Iid);
        }
        ...
        public bool UpdateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return this.OrExpressionDao.Update(transaction, partition, orExpression, container);
        }
        ...
        public bool CreateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var orExpression = thing as OrExpression;
            return this.OrExpressionDao.Write(transaction, partition, orExpression, container);
        }
        ...
        {
            var orExpression = thing as OrExpression;
            return this.OrExpressionDao.Upsert(transaction, partition, orExpression, container);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="OrExpression"/>.
        /// </returns>
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var orExpressionColl = new List<Thing>(this.OrExpressionDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction), (DateTime)this.TransactionManager.GetRawSessionInstant(transaction)));

            return this.AfterGet(orExpressionColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="OrExpression"/> and contained <see cref="Thing"/>s.
        /// </returns>

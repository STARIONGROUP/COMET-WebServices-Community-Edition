...
namespace CometServer.Services
{
    ...
    public sealed partial class SharedStyleService : ServiceBase, ISharedStyleService
    {
        ...
        {
            return this.SharedStyleDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.SharedStyleDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.SharedStyleDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.SharedStyleDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

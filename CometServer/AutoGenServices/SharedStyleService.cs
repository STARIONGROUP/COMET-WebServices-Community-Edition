...
namespace CometServer.Services
{
    ...
    public sealed partial class SharedStyleService : ServiceBase, ISharedStyleService
    {
        ...
        {
            return this.SharedStyleDao.AddToCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.SharedStyleDao.DeleteFromCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.SharedStyleDao.ReorderCollectionProperty(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public bool DeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.SharedStyleDao.Delete(transaction, partition, thing.Iid);
        }
        ...
        public bool RawDeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.SharedStyleDao.RawDelete(transaction, partition, thing.Iid);
        }
        ...
        public bool UpdateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return this.SharedStyleDao.Update(transaction, partition, sharedStyle, container);
        }
        ...
        public bool CreateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var sharedStyle = thing as SharedStyle;
            var createSuccesful = this.SharedStyleDao.Write(transaction, partition, sharedStyle, container);
            return createSuccesful && this.CreateContainment(transaction, partition, sharedStyle);
        }
        ...
        {
            var sharedStyle = thing as SharedStyle;
            var createSuccesful = this.SharedStyleDao.Upsert(transaction, partition, sharedStyle, container);
            return createSuccesful && this.UpsertContainment(transaction, partition, sharedStyle);
        }
        ...
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var sharedStyleColl = new List<Thing>(this.SharedStyleDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction), (DateTime)this.TransactionManager.GetRawSessionInstant(transaction)));

            return this.AfterGet(sharedStyleColl, transaction, partition, idFilter);
        }
        ...
        /// True if the persistence was successful.
        /// </returns>
        private bool CreateContainment(NpgsqlTransaction transaction, string partition, SharedStyle sharedStyle)
        {
        ...
        /// True if the persistence was successful.
        /// </returns>
        private bool UpsertContainment(NpgsqlTransaction transaction, string partition, SharedStyle sharedStyle)
        {
            var results = new List<bool>();

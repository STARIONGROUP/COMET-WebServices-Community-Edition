...
namespace CometServer.Services
{
    ...
    public sealed partial class IdCorrespondenceService : ServiceBase, IIdCorrespondenceService
    {
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="IdCorrespondence"/>, optionally with contained <see cref="Thing"/>s.
        /// </returns>
        ...
        {
            return this.IdCorrespondenceDao.AddToCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.IdCorrespondenceDao.DeleteFromCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.IdCorrespondenceDao.ReorderCollectionProperty(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public bool DeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.IdCorrespondenceDao.Delete(transaction, partition, thing.Iid);
        }
        ...
        public bool RawDeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.IdCorrespondenceDao.RawDelete(transaction, partition, thing.Iid);
        }
        ...
        public bool UpdateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return this.IdCorrespondenceDao.Update(transaction, partition, idCorrespondence, container);
        }
        ...
        public bool CreateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var idCorrespondence = thing as IdCorrespondence;
            return this.IdCorrespondenceDao.Write(transaction, partition, idCorrespondence, container);
        }
        ...
        {
            var idCorrespondence = thing as IdCorrespondence;
            return this.IdCorrespondenceDao.Upsert(transaction, partition, idCorrespondence, container);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="IdCorrespondence"/>.
        /// </returns>
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var idCorrespondenceColl = new List<Thing>(this.IdCorrespondenceDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction), (DateTime)this.TransactionManager.GetRawSessionInstant(transaction)));

            return this.AfterGet(idCorrespondenceColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="IdCorrespondence"/> and contained <see cref="Thing"/>s.
        /// </returns>

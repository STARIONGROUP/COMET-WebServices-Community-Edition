...
namespace CometServer.Services
{
    ...
    public sealed partial class IdCorrespondenceService : ServiceBase, IIdCorrespondenceService
    {
        ...
        {
            return this.IdCorrespondenceDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.IdCorrespondenceDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.IdCorrespondenceDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.IdCorrespondenceDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

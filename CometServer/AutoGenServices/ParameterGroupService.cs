...
namespace CometServer.Services
{
    ...
    public sealed partial class ParameterGroupService : ServiceBase, IParameterGroupService
    {
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="ParameterGroup"/>, optionally with contained <see cref="Thing"/>s.
        /// </returns>
        ...
        {
            return this.ParameterGroupDao.AddToCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.ParameterGroupDao.DeleteFromCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.ParameterGroupDao.ReorderCollectionProperty(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public bool DeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.ParameterGroupDao.Delete(transaction, partition, thing.Iid);
        }
        ...
        public bool RawDeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.ParameterGroupDao.RawDelete(transaction, partition, thing.Iid);
        }
        ...
        public bool UpdateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return this.ParameterGroupDao.Update(transaction, partition, parameterGroup, container);
        }
        ...
        public bool CreateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var parameterGroup = thing as ParameterGroup;
            return this.ParameterGroupDao.Write(transaction, partition, parameterGroup, container);
        }
        ...
        {
            var parameterGroup = thing as ParameterGroup;
            return this.ParameterGroupDao.Upsert(transaction, partition, parameterGroup, container);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="ParameterGroup"/>.
        /// </returns>
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var parameterGroupColl = new List<Thing>(this.ParameterGroupDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction), (DateTime)this.TransactionManager.GetRawSessionInstant(transaction)));

            return this.AfterGet(parameterGroupColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="ParameterGroup"/> and contained <see cref="Thing"/>s.
        /// </returns>

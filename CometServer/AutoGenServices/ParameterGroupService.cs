...
namespace CometServer.Services
{
    ...
    public sealed partial class ParameterGroupService : ServiceBase, IParameterGroupService
    {
        ...
        {
            return this.ParameterGroupDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.ParameterGroupDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.ParameterGroupDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.ParameterGroupDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

...
namespace CometServer.Services
{
    ...
    public sealed partial class BooleanParameterTypeService : ServiceBase, IBooleanParameterTypeService
    {
        ...
        {
            return this.BooleanParameterTypeDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.BooleanParameterTypeDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.BooleanParameterTypeDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.BooleanParameterTypeDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

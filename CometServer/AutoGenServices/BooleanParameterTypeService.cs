...
namespace CometServer.Services
{
    ...
    public sealed partial class BooleanParameterTypeService : ServiceBase, IBooleanParameterTypeService
    {
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="BooleanParameterType"/>, optionally with contained <see cref="Thing"/>s.
        /// </returns>
        ...
        {
            return this.BooleanParameterTypeDao.AddToCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.BooleanParameterTypeDao.DeleteFromCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.BooleanParameterTypeDao.ReorderCollectionProperty(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public bool DeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.BooleanParameterTypeDao.Delete(transaction, partition, thing.Iid);
        }
        ...
        public bool RawDeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.BooleanParameterTypeDao.RawDelete(transaction, partition, thing.Iid);
        }
        ...
        public bool UpdateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return this.BooleanParameterTypeDao.Update(transaction, partition, booleanParameterType, container);
        }
        ...
        public bool CreateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var booleanParameterType = thing as BooleanParameterType;
            var createSuccesful = this.BooleanParameterTypeDao.Write(transaction, partition, booleanParameterType, container);
            return createSuccesful && this.CreateContainment(transaction, partition, booleanParameterType);
        }
        ...
        {
            var booleanParameterType = thing as BooleanParameterType;
            var createSuccesful = this.BooleanParameterTypeDao.Upsert(transaction, partition, booleanParameterType, container);
            return createSuccesful && this.UpsertContainment(transaction, partition, booleanParameterType);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="BooleanParameterType"/>.
        /// </returns>
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var booleanParameterTypeColl = new List<Thing>(this.BooleanParameterTypeDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction), (DateTime)this.TransactionManager.GetRawSessionInstant(transaction)));

            return this.AfterGet(booleanParameterTypeColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="BooleanParameterType"/> and contained <see cref="Thing"/>s.
        /// </returns>
        ...
        /// True if the persistence was successful.
        /// </returns>
        private bool CreateContainment(NpgsqlTransaction transaction, string partition, BooleanParameterType booleanParameterType)
        {
            ...
            {
                results.Add(this.HyperLinkService.CreateConcept(transaction, partition, hyperLink, booleanParameterType));
            }
        ...
        /// True if the persistence was successful.
        /// </returns>
        private bool UpsertContainment(NpgsqlTransaction transaction, string partition, BooleanParameterType booleanParameterType)
        {
            var results = new List<bool>();
            ...
            foreach (var definition in this.ResolveFromRequestCache(booleanParameterType.Definition))
            {
                results.Add(this.DefinitionService.UpsertConcept(transaction, partition, definition, booleanParameterType));
            }

            foreach (var hyperLink in this.ResolveFromRequestCache(booleanParameterType.HyperLink))
            {
                results.Add(this.HyperLinkService.UpsertConcept(transaction, partition, hyperLink, booleanParameterType));
            }

...
namespace CometServer.Services
{
    ...
    public sealed partial class BooleanParameterTypeService : ServiceBase, IBooleanParameterTypeService
    {
        ...
        public async Task<IEnumerable<Thing>> GetShallowAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var booleanParameterTypeColl = new List<Thing>(await this.BooleanParameterTypeDao.ReadAsync(transaction, partition, idFilter, isCachedDtoReadEnabled, sessionInstant));

...
namespace CometServer.Services
{
    ...
    public sealed partial class OwnedStyleService : ServiceBase, IOwnedStyleService
    {
        ...
        {
            return this.OwnedStyleDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.OwnedStyleDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.OwnedStyleDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.OwnedStyleDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

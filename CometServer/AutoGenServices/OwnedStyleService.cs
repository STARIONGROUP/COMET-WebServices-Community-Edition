...
namespace CometServer.Services
{
    ...
    public sealed partial class OwnedStyleService : ServiceBase, IOwnedStyleService
    {
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="OwnedStyle"/>, optionally with contained <see cref="Thing"/>s.
        /// </returns>
        ...
        {
            return this.OwnedStyleDao.AddToCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.OwnedStyleDao.DeleteFromCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.OwnedStyleDao.ReorderCollectionProperty(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public bool DeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.OwnedStyleDao.Delete(transaction, partition, thing.Iid);
        }
        ...
        public bool RawDeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.OwnedStyleDao.RawDelete(transaction, partition, thing.Iid);
        }
        ...
        public bool UpdateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return this.OwnedStyleDao.Update(transaction, partition, ownedStyle, container);
        }
        ...
        public bool CreateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var ownedStyle = thing as OwnedStyle;
            var createSuccesful = this.OwnedStyleDao.Write(transaction, partition, ownedStyle, container);
            return createSuccesful && this.CreateContainment(transaction, partition, ownedStyle);
        }
        ...
        {
            var ownedStyle = thing as OwnedStyle;
            var createSuccesful = this.OwnedStyleDao.Upsert(transaction, partition, ownedStyle, container);
            return createSuccesful && this.UpsertContainment(transaction, partition, ownedStyle);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="OwnedStyle"/>.
        /// </returns>
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var ownedStyleColl = new List<Thing>(this.OwnedStyleDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction), (DateTime)this.TransactionManager.GetRawSessionInstant(transaction)));

            return this.AfterGet(ownedStyleColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="OwnedStyle"/> and contained <see cref="Thing"/>s.
        /// </returns>
        public IEnumerable<Thing> GetDeep(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            results.AddRange(this.UsedColorService.GetDeep(transaction, partition, ownedStyleColl.SelectMany(x => x.UsedColor), containerSecurityContext));
        ...
        /// True if the persistence was successful.
        /// </returns>
        private bool CreateContainment(NpgsqlTransaction transaction, string partition, OwnedStyle ownedStyle)
        {
            var results = new List<bool>();

            foreach (var usedColor in this.ResolveFromRequestCache(ownedStyle.UsedColor))
            {
                results.Add(this.UsedColorService.CreateConcept(transaction, partition, usedColor, ownedStyle));
            }

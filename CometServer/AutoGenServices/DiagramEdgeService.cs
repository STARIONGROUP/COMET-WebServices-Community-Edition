...
namespace CometServer.Services
{
    ...
    /// <summary>
    /// The <see cref="DiagramEdge"/> Service which uses the ORM layer to interact with the data model.
    /// </summary>
    ...
    public sealed partial class DiagramEdgeService : ServiceBase, IDiagramEdgeService
    {
        ...
        /// <summary>
        /// Gets or sets the <see cref="IDiagramEdgeDao"/>.
        /// </summary>
        public IDiagramEdgeDao DiagramEdgeDao { get; set; }

        /// <summary>
        /// Get the requested <see cref="DiagramEdge"/>s from the ORM layer.
        /// </summary>
        ...
        {
            return this.DiagramEdgeDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.DiagramEdgeDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.DiagramEdgeDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.DiagramEdgeDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="DiagramEdge"/> <see cref="Thing"/> to update.
        /// </param>
        /// <param name="container">
        ...
        /// <summary>
        /// Persist the supplied <see cref="DiagramEdge"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        public async Task<IEnumerable<Thing>> GetShallowAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var diagramEdgeColl = new List<Thing>(await this.DiagramEdgeDao.ReadAsync(transaction, partition, idFilter, isCachedDtoReadEnabled, sessionInstant));
        ...
        /// <summary>
        /// Persist the <see cref="DiagramEdge"/> containment tree to the ORM layer.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>

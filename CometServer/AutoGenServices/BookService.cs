...
namespace CometServer.Services
{
    ...
    public sealed partial class BookService : ServiceBase, IBookService
    {
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="Book"/>, optionally with contained <see cref="Thing"/>s.
        /// </returns>
        ...
        {
            return this.BookDao.AddToCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.BookDao.DeleteFromCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.BookDao.ReorderCollectionProperty(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        {
            return this.BookDao.ReorderContainment(transaction, partition, orderedItem);
        }
        ...
        public bool DeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.BookDao.Delete(transaction, partition, thing.Iid);
        }
        ...
        public bool RawDeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.BookDao.RawDelete(transaction, partition, thing.Iid);
        }
        ...
        public bool UpdateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return this.BookDao.Update(transaction, partition, book, container);
        }
        ...
        public bool CreateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var book = thing as Book;
            var createSuccesful = this.BookDao.Write(transaction, partition, book, sequence, container);
            return createSuccesful && this.CreateContainment(transaction, partition, book);
        }
        ...
        {
            var book = thing as Book;
            var createSuccesful = this.BookDao.Upsert(transaction, partition, book, sequence, container);
            return createSuccesful && this.UpsertContainment(transaction, partition, book);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="Book"/>.
        /// </returns>
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var bookColl = new List<Thing>(this.BookDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction), (DateTime)this.TransactionManager.GetRawSessionInstant(transaction)));

            return this.AfterGet(bookColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="Book"/> and contained <see cref="Thing"/>s.
        /// </returns>
        ...
        /// True if the persistence was successful.
        /// </returns>
        private bool CreateContainment(NpgsqlTransaction transaction, string partition, Book book)
        {
            var results = new List<bool>();

            foreach (var section in this.ResolveFromRequestCache(book.Section))
            {
                results.Add(this.SectionService.CreateConcept(transaction, partition, (Section)section.V, book, section.K));
            }
        ...
        /// True if the persistence was successful.
        /// </returns>
        private bool UpsertContainment(NpgsqlTransaction transaction, string partition, Book book)
        {
            var results = new List<bool>();

            foreach (var section in this.ResolveFromRequestCache(book.Section))
            {
                results.Add(this.SectionService.UpsertConcept(transaction, partition, (Section)section.V, book, section.K));
            }

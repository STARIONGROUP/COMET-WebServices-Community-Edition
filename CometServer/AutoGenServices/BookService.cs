...
namespace CometServer.Services
{
    ...
    public sealed partial class BookService : ServiceBase, IBookService
    {
        ...
        {
            return this.BookDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.BookDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.BookDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        {
            return this.BookDao.ReorderContainmentAsync(transaction, partition, orderedItem);
        }
        ...
        public Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.BookDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

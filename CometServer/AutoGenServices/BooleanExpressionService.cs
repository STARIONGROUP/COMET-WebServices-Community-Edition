// --------------------------------------------------------------------------------------------------------------------
// <copyright file="BooleanExpressionService.cs" company="RHEA System S.A.">
...
namespace CometServer.Services
{
    ...
    {
        /// <summary>
        /// Gets or sets the <see cref="IAndExpressionService"/>.
        /// </summary>
        public IAndExpressionService AndExpressionService { get; set; }

        /// <summary>
        /// Gets or sets the <see cref="IExclusiveOrExpressionService"/>.
        /// </summary>
        public IExclusiveOrExpressionService ExclusiveOrExpressionService { get; set; }

        /// <summary>
        /// Gets or sets the <see cref="INotExpressionService"/>.
        /// </summary>
        public INotExpressionService NotExpressionService { get; set; }

        /// <summary>
        /// Gets or sets the <see cref="IOrExpressionService"/>.
        /// </summary>
        public IOrExpressionService OrExpressionService { get; set; }

        /// <summary>
        /// Gets or sets the <see cref="IRelationalExpressionService"/>.
        /// </summary>
        public IRelationalExpressionService RelationalExpressionService { get; set; }

        /// <summary>
        /// Get the requested <see cref="BooleanExpression"/>s from the ORM layer.
        /// </summary>
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="BooleanExpression"/> id that will be the source for each link table record.
        /// </param>
        /// <param name="value">
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="BooleanExpression"/> id that is the source of the link table records.
        /// </param>
        /// <param name="value">
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="BooleanExpression"/> id that is the source for the reordered link table record.
        /// </param>
        ...
        /// <summary>
        /// Delete the supplied <see cref="BooleanExpression"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="BooleanExpression"/> to delete.
        /// </param>
        ...
        /// <summary>
        /// Update the supplied <see cref="BooleanExpression"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="BooleanExpression"/> <see cref="Thing"/> to update.
        /// </param>
        /// <param name="container">
        ...
        /// <summary>
        /// Persist the supplied <see cref="BooleanExpression"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="BooleanExpression"/> <see cref="Thing"/> to create.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="BooleanExpression"/> to be persisted.
        /// </param>
        /// <param name="sequence">
        ...
        /// <summary>
        /// Persist the supplied <see cref="BooleanExpression"/> instance. Update if it already exists.
        /// This is typically used during the import of existing data to the Database.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.

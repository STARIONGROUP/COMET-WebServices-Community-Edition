// --------------------------------------------------------------------------------------------------------------------
// <copyright file="EngineeringModelDataAnnotationService.cs" company="Starion Group S.A.">
...
namespace CometServer.Services
{
    ...
    /// <summary>
    /// The <see cref="EngineeringModelDataAnnotation"/> Service which uses the ORM layer to interact with the data model.
    /// </summary>
    public sealed partial class EngineeringModelDataAnnotationService : ServiceBase, IEngineeringModelDataAnnotationService
    {
        /// <summary>
        ...
        /// <summary>
        /// Get the requested <see cref="EngineeringModelDataAnnotation"/>s from the ORM layer.
        /// </summary>
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having a list of instances of <see cref="EngineeringModelDataAnnotation"/>, optionally with contained <see cref="Thing"/>s as result.
        /// </returns>
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="EngineeringModelDataAnnotation"/> id that will be the source for each link table record.
        /// </param>
        /// <param name="value">
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="EngineeringModelDataAnnotation"/> id that is the source of the link table records.
        /// </param>
        /// <param name="value">
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="EngineeringModelDataAnnotation"/> id that is the source for the reordered link table record.
        /// </param>
        ...
        /// <summary>
        /// Delete the supplied <see cref="EngineeringModelDataAnnotation"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="EngineeringModelDataAnnotation"/> to delete.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="EngineeringModelDataAnnotation"/> to be removed.
        /// </param>
        /// <returns>
        ...
        /// <summary>
        /// Update the supplied <see cref="EngineeringModelDataAnnotation"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="EngineeringModelDataAnnotation"/> <see cref="Thing"/> to update.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="EngineeringModelDataAnnotation"/> to be updated.
        /// </param>
        /// <returns>
        ...
        public async Task<bool> UpdateConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            var engineeringModelDataAnnotation = thing as EngineeringModelDataAnnotation;
            throw new NotSupportedException(string.Format("The abstract DTO type: {0} cannot be updated.", engineeringModelDataAnnotation.GetType().Name));
        }

        /// <summary>
        /// Persist the supplied <see cref="EngineeringModelDataAnnotation"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="EngineeringModelDataAnnotation"/> <see cref="Thing"/> to create.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="EngineeringModelDataAnnotation"/> to be persisted.
        /// </param>
        /// <param name="sequence">
        ...
        public async Task<bool> CreateConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var engineeringModelDataAnnotation = thing as EngineeringModelDataAnnotation;
            throw new NotSupportedException(string.Format("The abstract DTO type: {0} cannot be created.", engineeringModelDataAnnotation.GetType().Name));
        }

        /// <summary>
        /// Persist the supplied <see cref="EngineeringModelDataAnnotation"/> instance. Update if it already exists.
        /// This is typically used during the import of existing data to the Database.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having List of instances of <see cref="EngineeringModelDataAnnotation"/> as result.
        /// </returns>
        public async Task<IEnumerable<Thing>> GetShallowAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var authorizedContext = this.AuthorizeReadRequest("EngineeringModelDataAnnotation", containerSecurityContext, partition);
            ...
            var engineeringModelDataAnnotationColl = new List<Thing>();
            engineeringModelDataAnnotationColl.AddRange(await this.EngineeringModelDataNoteService.GetShallowAsync(transaction, partition, idFilter, authorizedContext));
            engineeringModelDataAnnotationColl.AddRange(await this.ModellingAnnotationItemService.GetShallowAsync(transaction, partition, idFilter, authorizedContext));

            return await this.AfterGetAsync(engineeringModelDataAnnotationColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having List of instances of <see cref="EngineeringModelDataAnnotation"/> and contained <see cref="Thing"/>s as result.
        /// </returns>
        public async Task<IEnumerable<Thing>> GetDeepAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            results.AddRange(await this.EngineeringModelDataNoteService.GetDeepAsync(transaction, partition, idFilter, containerSecurityContext));
            results.AddRange(await this.ModellingAnnotationItemService.GetDeepAsync(transaction, partition, idFilter, containerSecurityContext));
            return results;
        }

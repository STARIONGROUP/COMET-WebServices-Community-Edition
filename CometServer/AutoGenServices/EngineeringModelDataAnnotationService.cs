...
namespace CometServer.Services
{
    ...
    public sealed partial class EngineeringModelDataAnnotationService : ServiceBase, IEngineeringModelDataAnnotationService
    {
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="EngineeringModelDataAnnotation"/>, optionally with contained <see cref="Thing"/>s.
        /// </returns>
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="EngineeringModelDataAnnotation"/>.
        /// </returns>
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            engineeringModelDataAnnotationColl.AddRange(this.EngineeringModelDataNoteService.GetShallow(transaction, partition, idFilter, authorizedContext));
            engineeringModelDataAnnotationColl.AddRange(this.ModellingAnnotationItemService.GetShallow(transaction, partition, idFilter, authorizedContext));

            return this.AfterGet(engineeringModelDataAnnotationColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="EngineeringModelDataAnnotation"/> and contained <see cref="Thing"/>s.
        /// </returns>
        public IEnumerable<Thing> GetDeep(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            results.AddRange(this.EngineeringModelDataNoteService.GetDeep(transaction, partition, idFilter, containerSecurityContext));
            results.AddRange(this.ModellingAnnotationItemService.GetDeep(transaction, partition, idFilter, containerSecurityContext));
            return results;
        }

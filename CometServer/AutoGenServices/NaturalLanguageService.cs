...
namespace CometServer.Services
{
    ...
    public sealed partial class NaturalLanguageService : ServiceBase, INaturalLanguageService
    {
        ...
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var naturalLanguageColl = new List<Thing>(this.NaturalLanguageDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction)));

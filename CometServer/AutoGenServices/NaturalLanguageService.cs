...
namespace CometServer.Services
{
    ...
    public sealed partial class NaturalLanguageService : ServiceBase, INaturalLanguageService
    {
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="NaturalLanguage"/>, optionally with contained <see cref="Thing"/>s.
        /// </returns>
        ...
        {
            return this.NaturalLanguageDao.AddToCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.NaturalLanguageDao.DeleteFromCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.NaturalLanguageDao.ReorderCollectionProperty(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public bool DeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.NaturalLanguageDao.Delete(transaction, partition, thing.Iid);
        }
        ...
        public bool RawDeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.NaturalLanguageDao.RawDelete(transaction, partition, thing.Iid);
        }
        ...
        public bool UpdateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return this.NaturalLanguageDao.Update(transaction, partition, naturalLanguage, container);
        }
        ...
        public bool CreateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var naturalLanguage = thing as NaturalLanguage;
            return this.NaturalLanguageDao.Write(transaction, partition, naturalLanguage, container);
        }
        ...
        {
            var naturalLanguage = thing as NaturalLanguage;
            return this.NaturalLanguageDao.Upsert(transaction, partition, naturalLanguage, container);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="NaturalLanguage"/>.
        /// </returns>
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var naturalLanguageColl = new List<Thing>(this.NaturalLanguageDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction), (DateTime)this.TransactionManager.GetRawSessionInstant(transaction)));

            return this.AfterGet(naturalLanguageColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="NaturalLanguage"/> and contained <see cref="Thing"/>s.
        /// </returns>

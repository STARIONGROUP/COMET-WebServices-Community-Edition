...
namespace CometServer.Services
{
    ...
    public sealed partial class NaturalLanguageService : ServiceBase, INaturalLanguageService
    {
        ...
        {
            return this.NaturalLanguageDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.NaturalLanguageDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.NaturalLanguageDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.NaturalLanguageDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

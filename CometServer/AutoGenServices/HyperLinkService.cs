...
namespace CometServer.Services
{
    ...
    public sealed partial class HyperLinkService : ServiceBase, IHyperLinkService
    {
        ...
        {
            return this.HyperLinkDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.HyperLinkDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.HyperLinkDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.HyperLinkDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

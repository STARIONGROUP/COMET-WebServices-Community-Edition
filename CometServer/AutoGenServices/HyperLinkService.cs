...
namespace CometServer.Services
{
    ...
    public sealed partial class HyperLinkService : ServiceBase, IHyperLinkService
    {
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="HyperLink"/>, optionally with contained <see cref="Thing"/>s.
        /// </returns>
        ...
        {
            return this.HyperLinkDao.AddToCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.HyperLinkDao.DeleteFromCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.HyperLinkDao.ReorderCollectionProperty(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public bool DeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.HyperLinkDao.Delete(transaction, partition, thing.Iid);
        }
        ...
        public bool RawDeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.HyperLinkDao.RawDelete(transaction, partition, thing.Iid);
        }
        ...
        public bool UpdateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return this.HyperLinkDao.Update(transaction, partition, hyperLink, container);
        }
        ...
        public bool CreateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var hyperLink = thing as HyperLink;
            return this.HyperLinkDao.Write(transaction, partition, hyperLink, container);
        }
        ...
        {
            var hyperLink = thing as HyperLink;
            return this.HyperLinkDao.Upsert(transaction, partition, hyperLink, container);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="HyperLink"/>.
        /// </returns>
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var hyperLinkColl = new List<Thing>(this.HyperLinkDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction), (DateTime)this.TransactionManager.GetRawSessionInstant(transaction)));

            return this.AfterGet(hyperLinkColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="HyperLink"/> and contained <see cref="Thing"/>s.
        /// </returns>

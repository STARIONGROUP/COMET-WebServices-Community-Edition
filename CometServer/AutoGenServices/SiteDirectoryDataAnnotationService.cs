...
namespace CometServer.Services
{
    ...
    public sealed partial class SiteDirectoryDataAnnotationService : ServiceBase, ISiteDirectoryDataAnnotationService
    {
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="SiteDirectoryDataAnnotation"/>, optionally with contained <see cref="Thing"/>s.
        /// </returns>
        ...
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var siteDirectoryDataAnnotationColl = new List<Thing>(this.SiteDirectoryDataAnnotationDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction), (DateTime)this.TransactionManager.GetRawSessionInstant(transaction)));
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="SiteDirectoryDataAnnotation"/> and contained <see cref="Thing"/>s.
        /// </returns>
        public IEnumerable<Thing> GetDeep(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            results.AddRange(this.DiscussionService.GetDeep(transaction, partition, siteDirectoryDataAnnotationColl.SelectMany(x => x.Discussion), containerSecurityContext));
            results.AddRange(this.RelatedThingService.GetDeep(transaction, partition, siteDirectoryDataAnnotationColl.SelectMany(x => x.RelatedThing), containerSecurityContext));
        ...
        private bool CreateContainment(NpgsqlTransaction transaction, string partition, SiteDirectoryDataAnnotation siteDirectoryDataAnnotation)
        {
            ...
            {
                results.Add(this.DiscussionService.CreateConcept(transaction, partition, discussion, siteDirectoryDataAnnotation));
            }

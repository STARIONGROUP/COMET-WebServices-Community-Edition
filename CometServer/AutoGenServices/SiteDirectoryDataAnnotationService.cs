...
namespace CometServer.Services
{
    ...
    public sealed partial class SiteDirectoryDataAnnotationService : ServiceBase, ISiteDirectoryDataAnnotationService
    {
        ...
        {
            return this.SiteDirectoryDataAnnotationDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.SiteDirectoryDataAnnotationDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.SiteDirectoryDataAnnotationDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.SiteDirectoryDataAnnotationDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

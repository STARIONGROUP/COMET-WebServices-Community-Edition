// --------------------------------------------------------------------------------------------------------------------
// <copyright file="SiteDirectoryDataAnnotationService.cs" company="Starion Group S.A.">
...
namespace CometServer.Services
{
    ...
    /// <summary>
    /// The <see cref="SiteDirectoryDataAnnotation"/> Service which uses the ORM layer to interact with the data model.
    /// </summary>
    public sealed partial class SiteDirectoryDataAnnotationService : ServiceBase, ISiteDirectoryDataAnnotationService
    {
        /// <summary>
        /// Gets or sets the <see cref="ISiteDirectoryDataDiscussionItemService"/>.
        /// </summary>
        public ISiteDirectoryDataDiscussionItemService DiscussionService { get; set; }

        /// <summary>
        /// Gets or sets the <see cref="ISiteDirectoryThingReferenceService"/>.
        /// </summary>
        public ISiteDirectoryThingReferenceService RelatedThingService { get; set; }

        /// <summary>
        /// Gets or sets the <see cref="ISiteDirectoryDataAnnotationDao"/>.
        /// </summary>
        public ISiteDirectoryDataAnnotationDao SiteDirectoryDataAnnotationDao { get; set; }

        /// <summary>
        /// Get the requested <see cref="SiteDirectoryDataAnnotation"/>s from the ORM layer.
        /// </summary>
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having a list of instances of <see cref="SiteDirectoryDataAnnotation"/>, optionally with contained <see cref="Thing"/>s as result.
        /// </returns>
        ...
        {
            return await this.SiteDirectoryDataAnnotationDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return await this.SiteDirectoryDataAnnotationDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return await this.SiteDirectoryDataAnnotationDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public async Task<bool> DeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return await this.SiteDirectoryDataAnnotationDao.DeleteAsync(transaction, partition, thing.Iid);
        }
        ...
        public async Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return await this.SiteDirectoryDataAnnotationDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="SiteDirectoryDataAnnotation"/> <see cref="Thing"/> to update.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="SiteDirectoryDataAnnotation"/> to be updated.
        /// </param>
        /// <returns>
        ...
        public async Task<bool> UpdateConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return await this.SiteDirectoryDataAnnotationDao.UpdateAsync(transaction, partition, siteDirectoryDataAnnotation, container);
        }

        /// <summary>
        /// Persist the supplied <see cref="SiteDirectoryDataAnnotation"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        public async Task<bool> CreateConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var siteDirectoryDataAnnotation = thing as SiteDirectoryDataAnnotation;
            var createSuccesful = await this.SiteDirectoryDataAnnotationDao.WriteAsync(transaction, partition, siteDirectoryDataAnnotation, container);
            return createSuccesful && await this.CreateContainmentAsync(transaction, partition, siteDirectoryDataAnnotation);
        }
        ...
        {
            var siteDirectoryDataAnnotation = thing as SiteDirectoryDataAnnotation;
            var createSuccesful = await this.SiteDirectoryDataAnnotationDao.UpsertAsync(transaction, partition, siteDirectoryDataAnnotation, container);
            return createSuccesful && await this.UpsertContainmentAsync(transaction, partition, siteDirectoryDataAnnotation);
        }
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having List of instances of <see cref="SiteDirectoryDataAnnotation"/> as result.
        /// </returns>
        public async Task<IEnumerable<Thing>> GetShallowAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var siteDirectoryDataAnnotationColl = new List<Thing>(await this.SiteDirectoryDataAnnotationDao.ReadAsync(transaction, partition, idFilter, await this.TransactionManager.IsCachedDtoReadEnabledAsync(transaction), (DateTime)(await this.TransactionManager.GetRawSessionInstantAsync(transaction))));

            return await this.AfterGetAsync(siteDirectoryDataAnnotationColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having List of instances of <see cref="SiteDirectoryDataAnnotation"/> and contained <see cref="Thing"/>s as result.
        /// </returns>
        public async Task<IEnumerable<Thing>> GetDeepAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            results.AddRange(await this.DiscussionService.GetDeepAsync(transaction, partition, siteDirectoryDataAnnotationColl.SelectMany(x => x.Discussion), containerSecurityContext));
            results.AddRange(await this.RelatedThingService.GetDeepAsync(transaction, partition, siteDirectoryDataAnnotationColl.SelectMany(x => x.RelatedThing), containerSecurityContext));
        ...
        /// <summary>
        /// Persist the <see cref="SiteDirectoryDataAnnotation"/> containment tree to the ORM layer.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// An awaitable <see cref="Task"/> having True if the persistence was successful as result.
        /// </returns>
        private async Task<bool> CreateContainmentAsync(NpgsqlTransaction transaction, string partition, SiteDirectoryDataAnnotation siteDirectoryDataAnnotation)
        {
            var results = new List<bool>();

            foreach (var discussion in this.ResolveFromRequestCache(siteDirectoryDataAnnotation.Discussion))
            {
                results.Add(await this.DiscussionService.CreateConceptAsync(transaction, partition, discussion, siteDirectoryDataAnnotation));
            }

            foreach (var relatedThing in this.ResolveFromRequestCache(siteDirectoryDataAnnotation.RelatedThing))
            {
                results.Add(await this.RelatedThingService.CreateConceptAsync(transaction, partition, relatedThing, siteDirectoryDataAnnotation));
            }
        ...
        /// An awaitable <see cref="Task"/> having True if the persistence was successful as result.
        /// </returns>
        private async Task<bool> UpsertContainmentAsync(NpgsqlTransaction transaction, string partition, SiteDirectoryDataAnnotation siteDirectoryDataAnnotation)
        {
            var results = new List<bool>();

            foreach (var discussion in this.ResolveFromRequestCache(siteDirectoryDataAnnotation.Discussion))
            {
                results.Add(await this.DiscussionService.UpsertConceptAsync(transaction, partition, discussion, siteDirectoryDataAnnotation));
            }

            foreach (var relatedThing in this.ResolveFromRequestCache(siteDirectoryDataAnnotation.RelatedThing))
            {
                results.Add(await this.RelatedThingService.UpsertConceptAsync(transaction, partition, relatedThing, siteDirectoryDataAnnotation));
            }

// --------------------------------------------------------------------------------------------------------------------
// <copyright file="BehavioralParameterService.cs" company="RHEA System S.A.">
...
namespace CometServer.Services
{
    ...
    /// <summary>
    /// The <see cref="BehavioralParameter"/> Service which uses the ORM layer to interact with the data model.
    /// </summary>
    public sealed partial class BehavioralParameterService : ServiceBase, IBehavioralParameterService
    {
        /// <summary>
        /// Gets or sets the <see cref="IBehavioralParameterDao"/>.
        /// </summary>
        public IBehavioralParameterDao BehavioralParameterDao { get; set; }

        /// <summary>
        /// Get the requested <see cref="BehavioralParameter"/>s from the ORM layer.
        /// </summary>
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="BehavioralParameter"/>, optionally with contained <see cref="Thing"/>s.
        /// </returns>
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="BehavioralParameter"/> id that will be the source for each link table record.
        /// </param>
        /// <param name="value">
        ...
        {
            return this.BehavioralParameterDao.AddToCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="BehavioralParameter"/> id that is the source of the link table records.
        /// </param>
        /// <param name="value">
        ...
        {
            return this.BehavioralParameterDao.DeleteFromCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="BehavioralParameter"/> id that is the source for the reordered link table record.
        /// </param>
        ...
        {
            return this.BehavioralParameterDao.ReorderCollectionProperty(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        /// <summary>
        /// Delete the supplied <see cref="BehavioralParameter"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="BehavioralParameter"/> to delete.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="BehavioralParameter"/> to be removed.
        /// </param>
        /// <returns>
        ...
        public bool DeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.BehavioralParameterDao.Delete(transaction, partition, thing.Iid);
        }
        ...
        public bool RawDeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.BehavioralParameterDao.RawDelete(transaction, partition, thing.Iid);
        }

        /// <summary>
        /// Update the supplied <see cref="BehavioralParameter"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="BehavioralParameter"/> <see cref="Thing"/> to update.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="BehavioralParameter"/> to be updated.
        /// </param>
        /// <returns>
        ...
        public bool UpdateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return this.BehavioralParameterDao.Update(transaction, partition, behavioralParameter, container);
        }

        /// <summary>
        /// Persist the supplied <see cref="BehavioralParameter"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="BehavioralParameter"/> <see cref="Thing"/> to create.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="BehavioralParameter"/> to be persisted.
        /// </param>
        /// <param name="sequence">
        ...
        public bool CreateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var behavioralParameter = thing as BehavioralParameter;
            return this.BehavioralParameterDao.Write(transaction, partition, behavioralParameter, container);
        }

        /// <summary>
        /// Persist the supplied <see cref="BehavioralParameter"/> instance. Update if it already exists.
        /// This is typically used during the import of existing data to the Database.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        ...
        {
            var behavioralParameter = thing as BehavioralParameter;
            return this.BehavioralParameterDao.Upsert(transaction, partition, behavioralParameter, container);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="BehavioralParameter"/>.
        /// </returns>
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var authorizedContext = this.AuthorizeReadRequest("BehavioralParameter", containerSecurityContext, partition);
            ...
            var behavioralParameterColl = new List<Thing>(this.BehavioralParameterDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction), (DateTime)this.TransactionManager.GetRawSessionInstant(transaction)));

            return this.AfterGet(behavioralParameterColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="BehavioralParameter"/> and contained <see cref="Thing"/>s.
        /// </returns>

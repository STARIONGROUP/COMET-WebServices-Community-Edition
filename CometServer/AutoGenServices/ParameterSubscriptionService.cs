...
namespace CometServer.Services
{
    ...
    /// <summary>
    /// The <see cref="ParameterSubscription"/> Service which uses the ORM layer to interact with the data model.
    /// </summary>
    public sealed partial class ParameterSubscriptionService : ServiceBase, IParameterSubscriptionService
    {
        /// <summary>
        /// Gets or sets the <see cref="IParameterSubscriptionValueSetService"/>.
        /// </summary>
        public IParameterSubscriptionValueSetService ValueSetService { get; set; }

        /// <summary>
        /// Gets or sets the <see cref="IParameterSubscriptionDao"/>.
        /// </summary>
        public IParameterSubscriptionDao ParameterSubscriptionDao { get; set; }

        /// <summary>
        /// Get the requested <see cref="ParameterSubscription"/>s from the ORM layer.
        /// </summary>
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having a list of instances of <see cref="ParameterSubscription"/>, optionally with contained <see cref="Thing"/>s as result.
        /// </returns>
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="ParameterSubscription"/> id that will be the source for each link table record.
        /// </param>
        /// <param name="value">
        ...
        {
            return await this.ParameterSubscriptionDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="ParameterSubscription"/> id that is the source of the link table records.
        /// </param>
        /// <param name="value">
        ...
        {
            return await this.ParameterSubscriptionDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="ParameterSubscription"/> id that is the source for the reordered link table record.
        /// </param>
        ...
        {
            return await this.ParameterSubscriptionDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public async Task<bool> DeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return await this.ParameterSubscriptionDao.DeleteAsync(transaction, partition, thing.Iid);
        }
        ...
        public async Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return await this.ParameterSubscriptionDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="ParameterSubscription"/> <see cref="Thing"/> to update.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="ParameterSubscription"/> to be updated.
        /// </param>
        /// <returns>
        ...
        public async Task<bool> UpdateConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return await this.ParameterSubscriptionDao.UpdateAsync(transaction, partition, parameterSubscription, container);
        }

        /// <summary>
        /// Persist the supplied <see cref="ParameterSubscription"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="ParameterSubscription"/> <see cref="Thing"/> to create.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="ParameterSubscription"/> to be persisted.
        /// </param>
        /// <param name="sequence">
        ...
        public async Task<bool> CreateConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var parameterSubscription = thing as ParameterSubscription;
            var createSuccesful = await this.ParameterSubscriptionDao.WriteAsync(transaction, partition, parameterSubscription, container);
            return createSuccesful && await this.CreateContainmentAsync(transaction, partition, parameterSubscription);
        }
        ...
        {
            var parameterSubscription = thing as ParameterSubscription;
            var createSuccesful = await this.ParameterSubscriptionDao.UpsertAsync(transaction, partition, parameterSubscription, container);
            return createSuccesful && await this.UpsertContainmentAsync(transaction, partition, parameterSubscription);
        }
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having List of instances of <see cref="ParameterSubscription"/> as result.
        /// </returns>
        public async Task<IEnumerable<Thing>> GetShallowAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var authorizedContext = this.AuthorizeReadRequest("ParameterSubscription", containerSecurityContext, partition);
            ...
            var parameterSubscriptionColl = new List<Thing>(await this.ParameterSubscriptionDao.ReadAsync(transaction, partition, idFilter, await this.TransactionManager.IsCachedDtoReadEnabledAsync(transaction), (DateTime)(await this.TransactionManager.GetRawSessionInstantAsync(transaction))));

            return await this.AfterGetAsync(parameterSubscriptionColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having List of instances of <see cref="ParameterSubscription"/> and contained <see cref="Thing"/>s as result.
        /// </returns>
        public async Task<IEnumerable<Thing>> GetDeepAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            results.AddRange(await this.ValueSetService.GetDeepAsync(transaction, partition, parameterSubscriptionColl.SelectMany(x => x.ValueSet), containerSecurityContext));
        ...
        /// <summary>
        /// Persist the <see cref="ParameterSubscription"/> containment tree to the ORM layer.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// The <see cref="ParameterSubscription"/> instance to persist.
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having True if the persistence was successful as result.
        /// </returns>
        private async Task<bool> CreateContainmentAsync(NpgsqlTransaction transaction, string partition, ParameterSubscription parameterSubscription)
        {
            var results = new List<bool>();

            foreach (var valueSet in this.ResolveFromRequestCache(parameterSubscription.ValueSet))
            {
                results.Add(await this.ValueSetService.CreateConceptAsync(transaction, partition, valueSet, parameterSubscription));
            }
        ...
        /// An awaitable <see cref="Task"/> having True if the persistence was successful as result.
        /// </returns>
        private async Task<bool> UpsertContainmentAsync(NpgsqlTransaction transaction, string partition, ParameterSubscription parameterSubscription)
        {
            var results = new List<bool>();

            foreach (var valueSet in this.ResolveFromRequestCache(parameterSubscription.ValueSet))
            {
                results.Add(await this.ValueSetService.UpsertConceptAsync(transaction, partition, valueSet, parameterSubscription));
            }

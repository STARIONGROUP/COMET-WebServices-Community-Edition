...
namespace CometServer.Services
{
    ...
    public sealed partial class SimpleUnitService : ServiceBase, ISimpleUnitService
    {
        ...
        {
            return this.SimpleUnitDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.SimpleUnitDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.SimpleUnitDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.SimpleUnitDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

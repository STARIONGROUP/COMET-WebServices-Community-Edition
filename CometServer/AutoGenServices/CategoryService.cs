...
namespace CometServer.Services
{
    ...
    public sealed partial class CategoryService : ServiceBase, ICategoryService
    {
        ...
        {
            return this.CategoryDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.CategoryDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.CategoryDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.CategoryDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

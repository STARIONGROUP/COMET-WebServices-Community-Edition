...
namespace CometServer.Services
{
    ...
    public sealed partial class ReviewItemDiscrepancyService : ServiceBase, IReviewItemDiscrepancyService
    {
        ...
        {
            return this.ReviewItemDiscrepancyDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.ReviewItemDiscrepancyDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.ReviewItemDiscrepancyDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.ReviewItemDiscrepancyDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

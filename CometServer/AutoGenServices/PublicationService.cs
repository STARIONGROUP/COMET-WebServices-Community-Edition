...
namespace CometServer.Services
{
    ...
    public sealed partial class PublicationService : ServiceBase, IPublicationService
    {
        ...
        {
            return this.PublicationDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.PublicationDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.PublicationDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.PublicationDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

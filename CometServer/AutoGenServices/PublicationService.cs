...
namespace CometServer.Services
{
    ...
    public sealed partial class PublicationService : ServiceBase, IPublicationService
    {
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="Publication"/>, optionally with contained <see cref="Thing"/>s.
        /// </returns>
        ...
        {
            return this.PublicationDao.AddToCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.PublicationDao.DeleteFromCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.PublicationDao.ReorderCollectionProperty(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public bool DeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.PublicationDao.Delete(transaction, partition, thing.Iid);
        }
        ...
        public bool RawDeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.PublicationDao.RawDelete(transaction, partition, thing.Iid);
        }
        ...
        public bool UpdateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return this.PublicationDao.Update(transaction, partition, publication, container);
        }
        ...
        public bool CreateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var publication = thing as Publication;
            return this.PublicationDao.Write(transaction, partition, publication, container);
        }
        ...
        {
            var publication = thing as Publication;
            return this.PublicationDao.Upsert(transaction, partition, publication, container);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="Publication"/>.
        /// </returns>
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var publicationColl = new List<Thing>(this.PublicationDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction), (DateTime)this.TransactionManager.GetRawSessionInstant(transaction)));

            return this.AfterGet(publicationColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="Publication"/> and contained <see cref="Thing"/>s.
        /// </returns>

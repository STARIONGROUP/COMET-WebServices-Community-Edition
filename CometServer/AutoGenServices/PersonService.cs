...
namespace CometServer.Services
{
    ...
    public sealed partial class PersonService : ServiceBase, IPersonService
    {
        ...
        {
            return this.PersonDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.PersonDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.PersonDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.PersonDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

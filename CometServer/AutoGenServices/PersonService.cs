...
namespace CometServer.Services
{
    ...
    public sealed partial class PersonService : ServiceBase, IPersonService
    {
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="Person"/>, optionally with contained <see cref="Thing"/>s.
        /// </returns>
        ...
        {
            return this.PersonDao.AddToCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.PersonDao.DeleteFromCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.PersonDao.ReorderCollectionProperty(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public bool DeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.PersonDao.Delete(transaction, partition, thing.Iid);
        }
        ...
        public bool UpdateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return this.PersonDao.Update(transaction, partition, person, container);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="Person"/>.
        /// </returns>
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var personColl = new List<Thing>(this.PersonDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction), (DateTime)this.TransactionManager.GetRawSessionInstant(transaction)));

            return this.AfterGet(personColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="Person"/> and contained <see cref="Thing"/>s.
        /// </returns>
        public IEnumerable<Thing> GetDeep(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            results.AddRange(this.EmailAddressService.GetDeep(transaction, partition, personColl.SelectMany(x => x.EmailAddress), containerSecurityContext));
            results.AddRange(this.TelephoneNumberService.GetDeep(transaction, partition, personColl.SelectMany(x => x.TelephoneNumber), containerSecurityContext));
            results.AddRange(this.UserPreferenceService.GetDeep(transaction, partition, personColl.SelectMany(x => x.UserPreference), containerSecurityContext));
        ...
        /// True if the persistence was successful.
        /// </returns>
        private bool CreateContainment(NpgsqlTransaction transaction, string partition, Person person)
        {
            var results = new List<bool>();

            foreach (var emailAddress in this.ResolveFromRequestCache(person.EmailAddress))
            {
                results.Add(this.EmailAddressService.CreateConcept(transaction, partition, emailAddress, person));
            }

            foreach (var telephoneNumber in this.ResolveFromRequestCache(person.TelephoneNumber))
            {
                results.Add(this.TelephoneNumberService.CreateConcept(transaction, partition, telephoneNumber, person));
            }

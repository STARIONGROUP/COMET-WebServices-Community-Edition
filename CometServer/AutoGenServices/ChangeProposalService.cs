...
namespace CometServer.Services
{
    ...
    public sealed partial class ChangeProposalService : ServiceBase, IChangeProposalService
    {
        ...
        {
            return this.ChangeProposalDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.ChangeProposalDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.ChangeProposalDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.ChangeProposalDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

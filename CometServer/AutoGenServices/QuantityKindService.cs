...
namespace CometServer.Services
{
    ...
    public sealed partial class QuantityKindService : ServiceBase, IQuantityKindService
    {
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="QuantityKind"/>, optionally with contained <see cref="Thing"/>s.
        /// </returns>
        ...
        public bool UpdateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            {
                return this.DerivedQuantityKindService.UpdateConcept(transaction, partition, quantityKind, container);
            }

            if (quantityKind.IsSameOrDerivedClass<SimpleQuantityKind>())
            {
                return this.SimpleQuantityKindService.UpdateConcept(transaction, partition, quantityKind, container);
            }

            if (quantityKind.IsSameOrDerivedClass<SpecializedQuantityKind>())
            {
                return this.SpecializedQuantityKindService.UpdateConcept(transaction, partition, quantityKind, container);
            }
        ...
        public bool CreateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            if (quantityKind.IsSameOrDerivedClass<DerivedQuantityKind>())
            {
                return this.DerivedQuantityKindService.CreateConcept(transaction, partition, quantityKind, container);
            }

            if (quantityKind.IsSameOrDerivedClass<SimpleQuantityKind>())
            {
                return this.SimpleQuantityKindService.CreateConcept(transaction, partition, quantityKind, container);
            }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="QuantityKind"/>.
        /// </returns>
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            quantityKindColl.AddRange(this.DerivedQuantityKindService.GetShallow(transaction, partition, idFilter, authorizedContext));
            quantityKindColl.AddRange(this.SimpleQuantityKindService.GetShallow(transaction, partition, idFilter, authorizedContext));
            quantityKindColl.AddRange(this.SpecializedQuantityKindService.GetShallow(transaction, partition, idFilter, authorizedContext));

            return this.AfterGet(quantityKindColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="QuantityKind"/> and contained <see cref="Thing"/>s.
        /// </returns>
        public IEnumerable<Thing> GetDeep(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            results.AddRange(this.DerivedQuantityKindService.GetDeep(transaction, partition, idFilter, containerSecurityContext));
            results.AddRange(this.SimpleQuantityKindService.GetDeep(transaction, partition, idFilter, containerSecurityContext));
            results.AddRange(this.SpecializedQuantityKindService.GetDeep(transaction, partition, idFilter, containerSecurityContext));
            return results;
        }

// --------------------------------------------------------------------------------------------------------------------
// <copyright file="QuantityKindService.cs" company="Starion Group S.A.">
...
namespace CometServer.Services
{
    ...
    /// <summary>
    /// The <see cref="QuantityKind"/> Service which uses the ORM layer to interact with the data model.
    /// </summary>
    public sealed partial class QuantityKindService : ServiceBase, IQuantityKindService
    {
        /// <summary>
        /// Gets or sets the <see cref="IDerivedQuantityKindService"/>.
        /// </summary>
        public IDerivedQuantityKindService DerivedQuantityKindService { get; set; }

        /// <summary>
        /// Gets or sets the <see cref="ISimpleQuantityKindService"/>.
        /// </summary>
        ...
        /// <summary>
        /// Get the requested <see cref="QuantityKind"/>s from the ORM layer.
        /// </summary>
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having a list of instances of <see cref="QuantityKind"/>, optionally with contained <see cref="Thing"/>s as result.
        /// </returns>
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="QuantityKind"/> id that will be the source for each link table record.
        /// </param>
        /// <param name="value">
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="QuantityKind"/> id that is the source of the link table records.
        /// </param>
        /// <param name="value">
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="QuantityKind"/> id that is the source for the reordered link table record.
        /// </param>
        ...
        /// <summary>
        /// Delete the supplied <see cref="QuantityKind"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="QuantityKind"/> to delete.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="QuantityKind"/> to be removed.
        /// </param>
        /// <returns>
        ...
        /// <summary>
        /// Update the supplied <see cref="QuantityKind"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="QuantityKind"/> <see cref="Thing"/> to update.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="QuantityKind"/> to be updated.
        /// </param>
        /// <returns>
        ...
        public async Task<bool> UpdateConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            {
                return await this.DerivedQuantityKindService.UpdateConceptAsync(transaction, partition, quantityKind, container);
            }

            if (quantityKind.IsSameOrDerivedClass<SimpleQuantityKind>())
            {
                return await this.SimpleQuantityKindService.UpdateConceptAsync(transaction, partition, quantityKind, container);
            }

            if (quantityKind.IsSameOrDerivedClass<SpecializedQuantityKind>())
            {
                return await this.SpecializedQuantityKindService.UpdateConceptAsync(transaction, partition, quantityKind, container);
            }
            throw new NotSupportedException(string.Format("The supplied DTO type: {0} is not a supported type", quantityKind.GetType().Name));
        }

        /// <summary>
        /// Persist the supplied <see cref="QuantityKind"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        public async Task<bool> CreateConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            if (quantityKind.IsSameOrDerivedClass<DerivedQuantityKind>())
            {
                return await this.DerivedQuantityKindService.CreateConceptAsync(transaction, partition, quantityKind, container);
            }

            if (quantityKind.IsSameOrDerivedClass<SimpleQuantityKind>())
            {
                return await this.SimpleQuantityKindService.CreateConceptAsync(transaction, partition, quantityKind, container);
            }

            if (quantityKind.IsSameOrDerivedClass<SpecializedQuantityKind>())
            {
                return await this.SpecializedQuantityKindService.CreateConceptAsync(transaction, partition, quantityKind, container);
            }
            throw new NotSupportedException(string.Format("The supplied DTO type: {0} is not a supported type", quantityKind.GetType().Name));
        }
        ...
        public async Task<bool> UpsertConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            if (quantityKind.IsSameOrDerivedClass<DerivedQuantityKind>())
            {
                return await this.DerivedQuantityKindService.UpsertConceptAsync(transaction, partition, quantityKind, container);
            }

            if (quantityKind.IsSameOrDerivedClass<SimpleQuantityKind>())
            {
                return await this.SimpleQuantityKindService.UpsertConceptAsync(transaction, partition, quantityKind, container);
            }

            if (quantityKind.IsSameOrDerivedClass<SpecializedQuantityKind>())
            {
                return await this.SpecializedQuantityKindService.UpsertConceptAsync(transaction, partition, quantityKind, container);
            }
            throw new NotSupportedException(string.Format("The supplied DTO type: {0} is not a supported type", quantityKind.GetType().Name));
        }
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having List of instances of <see cref="QuantityKind"/> as result.
        /// </returns>
        public async Task<IEnumerable<Thing>> GetShallowAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var authorizedContext = this.AuthorizeReadRequest("QuantityKind", containerSecurityContext, partition);
            ...
            var quantityKindColl = new List<Thing>();
            quantityKindColl.AddRange(await this.DerivedQuantityKindService.GetShallowAsync(transaction, partition, idFilter, authorizedContext));
            quantityKindColl.AddRange(await this.SimpleQuantityKindService.GetShallowAsync(transaction, partition, idFilter, authorizedContext));
            quantityKindColl.AddRange(await this.SpecializedQuantityKindService.GetShallowAsync(transaction, partition, idFilter, authorizedContext));

            return await this.AfterGetAsync(quantityKindColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having List of instances of <see cref="QuantityKind"/> and contained <see cref="Thing"/>s as result.
        /// </returns>
        public async Task<IEnumerable<Thing>> GetDeepAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            results.AddRange(await this.DerivedQuantityKindService.GetDeepAsync(transaction, partition, idFilter, containerSecurityContext));
            results.AddRange(await this.SimpleQuantityKindService.GetDeepAsync(transaction, partition, idFilter, containerSecurityContext));
            results.AddRange(await this.SpecializedQuantityKindService.GetDeepAsync(transaction, partition, idFilter, containerSecurityContext));
            return results;
        }

...
namespace CometServer.Services
{
    ...
    public sealed partial class RequirementsGroupService : ServiceBase, IRequirementsGroupService
    {
        ...
        {
            return this.RequirementsGroupDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.RequirementsGroupDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.RequirementsGroupDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.RequirementsGroupDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }
        ...
        public async Task<IEnumerable<Thing>> GetShallowAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var requirementsGroupColl = new List<Thing>(await this.RequirementsGroupDao.ReadAsync(transaction, partition, idFilter, isCachedDtoReadEnabled, sessionInstant));

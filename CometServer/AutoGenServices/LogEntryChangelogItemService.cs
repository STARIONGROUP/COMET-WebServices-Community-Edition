...
namespace CometServer.Services
{
    ...
    public sealed partial class LogEntryChangelogItemService : ServiceBase, ILogEntryChangelogItemService
    {
        ...
        {
            return this.LogEntryChangelogItemDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.LogEntryChangelogItemDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.LogEntryChangelogItemDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.LogEntryChangelogItemDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

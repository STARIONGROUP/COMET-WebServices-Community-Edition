...
namespace CometServer.Services
{
    ...
    public sealed partial class LogEntryChangelogItemService : ServiceBase, ILogEntryChangelogItemService
    {
        ...
        public async Task<IEnumerable<Thing>> GetShallowAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var logEntryChangelogItemColl = new List<Thing>(await this.LogEntryChangelogItemDao.ReadAsync(transaction, partition, idFilter, isCachedDtoReadEnabled, sessionInstant));

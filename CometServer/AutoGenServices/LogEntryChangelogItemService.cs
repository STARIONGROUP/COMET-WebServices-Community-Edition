...
namespace CometServer.Services
{
    ...
    public sealed partial class LogEntryChangelogItemService : ServiceBase, ILogEntryChangelogItemService
    {
        ...
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var logEntryChangelogItemColl = new List<Thing>(this.LogEntryChangelogItemDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction)));

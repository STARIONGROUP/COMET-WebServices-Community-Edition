...
namespace CometServer.Services
{
    ...
    public sealed partial class LogEntryChangelogItemService : ServiceBase, ILogEntryChangelogItemService
    {
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="LogEntryChangelogItem"/>, optionally with contained <see cref="Thing"/>s.
        /// </returns>
        ...
        {
            return this.LogEntryChangelogItemDao.AddToCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.LogEntryChangelogItemDao.DeleteFromCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.LogEntryChangelogItemDao.ReorderCollectionProperty(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public bool DeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.LogEntryChangelogItemDao.Delete(transaction, partition, thing.Iid);
        }
        ...
        public bool RawDeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.LogEntryChangelogItemDao.RawDelete(transaction, partition, thing.Iid);
        }
        ...
        public bool UpdateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return this.LogEntryChangelogItemDao.Update(transaction, partition, logEntryChangelogItem, container);
        }
        ...
        public bool CreateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var logEntryChangelogItem = thing as LogEntryChangelogItem;
            return this.LogEntryChangelogItemDao.Write(transaction, partition, logEntryChangelogItem, container);
        }
        ...
        {
            var logEntryChangelogItem = thing as LogEntryChangelogItem;
            return this.LogEntryChangelogItemDao.Upsert(transaction, partition, logEntryChangelogItem, container);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="LogEntryChangelogItem"/>.
        /// </returns>
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var logEntryChangelogItemColl = new List<Thing>(this.LogEntryChangelogItemDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction), (DateTime)this.TransactionManager.GetRawSessionInstant(transaction)));

            return this.AfterGet(logEntryChangelogItemColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="LogEntryChangelogItem"/> and contained <see cref="Thing"/>s.
        /// </returns>

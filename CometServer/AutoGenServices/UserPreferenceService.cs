...
namespace CometServer.Services
{
    ...
    public sealed partial class UserPreferenceService : ServiceBase, IUserPreferenceService
    {
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="UserPreference"/>, optionally with contained <see cref="Thing"/>s.
        /// </returns>
        ...
        {
            return this.UserPreferenceDao.AddToCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.UserPreferenceDao.DeleteFromCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.UserPreferenceDao.ReorderCollectionProperty(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public bool DeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.UserPreferenceDao.Delete(transaction, partition, thing.Iid);
        }
        ...
        public bool RawDeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.UserPreferenceDao.RawDelete(transaction, partition, thing.Iid);
        }
        ...
        public bool UpdateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return this.UserPreferenceDao.Update(transaction, partition, userPreference, container);
        }
        ...
        public bool CreateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var userPreference = thing as UserPreference;
            return this.UserPreferenceDao.Write(transaction, partition, userPreference, container);
        }
        ...
        {
            var userPreference = thing as UserPreference;
            return this.UserPreferenceDao.Upsert(transaction, partition, userPreference, container);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="UserPreference"/>.
        /// </returns>
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var userPreferenceColl = new List<Thing>(this.UserPreferenceDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction), (DateTime)this.TransactionManager.GetRawSessionInstant(transaction)));

            return this.AfterGet(userPreferenceColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="UserPreference"/> and contained <see cref="Thing"/>s.
        /// </returns>

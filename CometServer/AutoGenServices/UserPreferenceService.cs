...
namespace CometServer.Services
{
    ...
    public sealed partial class UserPreferenceService : ServiceBase, IUserPreferenceService
    {
        ...
        {
            return this.UserPreferenceDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.UserPreferenceDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.UserPreferenceDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.UserPreferenceDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

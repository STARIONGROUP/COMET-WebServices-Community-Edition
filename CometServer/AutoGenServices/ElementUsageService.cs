...
namespace CometServer.Services
{
    ...
    public sealed partial class ElementUsageService : ServiceBase, IElementUsageService
    {
        ...
        {
            return this.ElementUsageDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.ElementUsageDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.ElementUsageDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.ElementUsageDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

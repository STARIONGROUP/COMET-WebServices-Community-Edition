...
namespace CometServer.Services
{
    ...
    /// <summary>
    /// The <see cref="ElementUsage"/> Service which uses the ORM layer to interact with the data model.
    /// </summary>
    public sealed partial class ElementUsageService : ServiceBase, IElementUsageService
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets or sets the <see cref="IElementUsageDao"/>.
        /// </summary>
        public IElementUsageDao ElementUsageDao { get; set; }

        /// <summary>
        /// Get the requested <see cref="ElementUsage"/>s from the ORM layer.
        /// </summary>
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having a list of instances of <see cref="ElementUsage"/>, optionally with contained <see cref="Thing"/>s as result.
        /// </returns>
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="ElementUsage"/> id that will be the source for each link table record.
        /// </param>
        /// <param name="value">
        ...
        {
            return await this.ElementUsageDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="ElementUsage"/> id that is the source of the link table records.
        /// </param>
        /// <param name="value">
        ...
        {
            return await this.ElementUsageDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="ElementUsage"/> id that is the source for the reordered link table record.
        /// </param>
        ...
        {
            return await this.ElementUsageDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        /// <summary>
        /// Delete the supplied <see cref="ElementUsage"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="ElementUsage"/> to delete.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="ElementUsage"/> to be removed.
        /// </param>
        /// <returns>
        ...
        public async Task<bool> DeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return await this.ElementUsageDao.DeleteAsync(transaction, partition, thing.Iid);
        }
        ...
        public async Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return await this.ElementUsageDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

        /// <summary>
        /// Update the supplied <see cref="ElementUsage"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="ElementUsage"/> <see cref="Thing"/> to update.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="ElementUsage"/> to be updated.
        /// </param>
        /// <returns>
        ...
        public async Task<bool> UpdateConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return await this.ElementUsageDao.UpdateAsync(transaction, partition, elementUsage, container);
        }

        /// <summary>
        /// Persist the supplied <see cref="ElementUsage"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="ElementUsage"/> <see cref="Thing"/> to create.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="ElementUsage"/> to be persisted.
        /// </param>
        /// <param name="sequence">
        ...
        public async Task<bool> CreateConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var elementUsage = thing as ElementUsage;
            var createSuccesful = await this.ElementUsageDao.WriteAsync(transaction, partition, elementUsage, container);
            return createSuccesful && await this.CreateContainmentAsync(transaction, partition, elementUsage);
        }

        /// <summary>
        /// Persist the supplied <see cref="ElementUsage"/> instance. Update if it already exists.
        /// This is typically used during the import of existing data to the Database.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        ...
        {
            var elementUsage = thing as ElementUsage;
            var createSuccesful = await this.ElementUsageDao.UpsertAsync(transaction, partition, elementUsage, container);
            return createSuccesful && await this.UpsertContainmentAsync(transaction, partition, elementUsage);
        }
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having List of instances of <see cref="ElementUsage"/> as result.
        /// </returns>
        public async Task<IEnumerable<Thing>> GetShallowAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var authorizedContext = this.AuthorizeReadRequest("ElementUsage", containerSecurityContext, partition);
            ...
            var elementUsageColl = new List<Thing>(await this.ElementUsageDao.ReadAsync(transaction, partition, idFilter, await this.TransactionManager.IsCachedDtoReadEnabledAsync(transaction), (DateTime)(await this.TransactionManager.GetRawSessionInstantAsync(transaction))));

            return await this.AfterGetAsync(elementUsageColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having List of instances of <see cref="ElementUsage"/> and contained <see cref="Thing"/>s as result.
        /// </returns>
        public async Task<IEnumerable<Thing>> GetDeepAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            results.AddRange(await this.AliasService.GetDeepAsync(transaction, partition, elementUsageColl.SelectMany(x => x.Alias), containerSecurityContext));
            results.AddRange(await this.DefinitionService.GetDeepAsync(transaction, partition, elementUsageColl.SelectMany(x => x.Definition), containerSecurityContext));
            results.AddRange(await this.HyperLinkService.GetDeepAsync(transaction, partition, elementUsageColl.SelectMany(x => x.HyperLink), containerSecurityContext));
            results.AddRange(await this.ParameterOverrideService.GetDeepAsync(transaction, partition, elementUsageColl.SelectMany(x => x.ParameterOverride), containerSecurityContext));
        ...
        /// <summary>
        /// Persist the <see cref="ElementUsage"/> containment tree to the ORM layer.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// An awaitable <see cref="Task"/> having True if the persistence was successful as result.
        /// </returns>
        private async Task<bool> CreateContainmentAsync(NpgsqlTransaction transaction, string partition, ElementUsage elementUsage)
        {
            var results = new List<bool>();

            foreach (var alias in this.ResolveFromRequestCache(elementUsage.Alias))
            {
                results.Add(await this.AliasService.CreateConceptAsync(transaction, partition, alias, elementUsage));
            }

            foreach (var definition in this.ResolveFromRequestCache(elementUsage.Definition))
            {
                results.Add(await this.DefinitionService.CreateConceptAsync(transaction, partition, definition, elementUsage));
            }

            foreach (var hyperLink in this.ResolveFromRequestCache(elementUsage.HyperLink))
            {
                results.Add(await this.HyperLinkService.CreateConceptAsync(transaction, partition, hyperLink, elementUsage));
            }

            foreach (var parameterOverride in this.ResolveFromRequestCache(elementUsage.ParameterOverride))
            {
                results.Add(await this.ParameterOverrideService.CreateConceptAsync(transaction, partition, parameterOverride, elementUsage));
            }
        ...
        /// An awaitable <see cref="Task"/> having True if the persistence was successful as result.
        /// </returns>
        private async Task<bool> UpsertContainmentAsync(NpgsqlTransaction transaction, string partition, ElementUsage elementUsage)
        {
            var results = new List<bool>();

            foreach (var alias in this.ResolveFromRequestCache(elementUsage.Alias))
            {
                results.Add(await this.AliasService.UpsertConceptAsync(transaction, partition, alias, elementUsage));
            }

            foreach (var definition in this.ResolveFromRequestCache(elementUsage.Definition))
            {
                results.Add(await this.DefinitionService.UpsertConceptAsync(transaction, partition, definition, elementUsage));
            }

            foreach (var hyperLink in this.ResolveFromRequestCache(elementUsage.HyperLink))
            {
                results.Add(await this.HyperLinkService.UpsertConceptAsync(transaction, partition, hyperLink, elementUsage));
            }

            foreach (var parameterOverride in this.ResolveFromRequestCache(elementUsage.ParameterOverride))
            {
                results.Add(await this.ParameterOverrideService.UpsertConceptAsync(transaction, partition, parameterOverride, elementUsage));
            }

...
namespace CometServer.Services
{
    ...
    public sealed partial class ElementUsageService : ServiceBase, IElementUsageService
    {
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="ElementUsage"/>, optionally with contained <see cref="Thing"/>s.
        /// </returns>
        ...
        {
            return this.ElementUsageDao.AddToCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.ElementUsageDao.DeleteFromCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.ElementUsageDao.ReorderCollectionProperty(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public bool DeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.ElementUsageDao.Delete(transaction, partition, thing.Iid);
        }
        ...
        public bool RawDeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.ElementUsageDao.RawDelete(transaction, partition, thing.Iid);
        }
        ...
        public bool UpdateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return this.ElementUsageDao.Update(transaction, partition, elementUsage, container);
        }
        ...
        public bool CreateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var elementUsage = thing as ElementUsage;
            var createSuccesful = this.ElementUsageDao.Write(transaction, partition, elementUsage, container);
            return createSuccesful && this.CreateContainment(transaction, partition, elementUsage);
        }
        ...
        {
            var elementUsage = thing as ElementUsage;
            var createSuccesful = this.ElementUsageDao.Upsert(transaction, partition, elementUsage, container);
            return createSuccesful && this.UpsertContainment(transaction, partition, elementUsage);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="ElementUsage"/>.
        /// </returns>
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var elementUsageColl = new List<Thing>(this.ElementUsageDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction), (DateTime)this.TransactionManager.GetRawSessionInstant(transaction)));

            return this.AfterGet(elementUsageColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="ElementUsage"/> and contained <see cref="Thing"/>s.
        /// </returns>
        ...
        /// True if the persistence was successful.
        /// </returns>
        private bool CreateContainment(NpgsqlTransaction transaction, string partition, ElementUsage elementUsage)
        {
            ...
            {
                results.Add(this.HyperLinkService.CreateConcept(transaction, partition, hyperLink, elementUsage));
            }

            foreach (var parameterOverride in this.ResolveFromRequestCache(elementUsage.ParameterOverride))
            {
                results.Add(this.ParameterOverrideService.CreateConcept(transaction, partition, parameterOverride, elementUsage));
            }

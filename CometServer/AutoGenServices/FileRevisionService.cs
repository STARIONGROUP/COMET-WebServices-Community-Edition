...
namespace CometServer.Services
{
    ...
    public sealed partial class FileRevisionService : ServiceBase, IFileRevisionService
    {
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="FileRevision"/>, optionally with contained <see cref="Thing"/>s.
        /// </returns>
        ...
        {
            return this.FileRevisionDao.AddToCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.FileRevisionDao.DeleteFromCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.FileRevisionDao.ReorderCollectionProperty(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public bool DeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.FileRevisionDao.Delete(transaction, partition, thing.Iid);
        }
        ...
        public bool RawDeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.FileRevisionDao.RawDelete(transaction, partition, thing.Iid);
        }
        ...
        public bool UpdateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return this.FileRevisionDao.Update(transaction, partition, fileRevision, container);
        }
        ...
        public bool CreateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var fileRevision = thing as FileRevision;
            return this.FileRevisionDao.Write(transaction, partition, fileRevision, container);
        }
        ...
        {
            var fileRevision = thing as FileRevision;
            return this.FileRevisionDao.Upsert(transaction, partition, fileRevision, container);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="FileRevision"/>.
        /// </returns>
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var fileRevisionColl = new List<Thing>(this.FileRevisionDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction), (DateTime)this.TransactionManager.GetRawSessionInstant(transaction)));

            return this.AfterGet(fileRevisionColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="FileRevision"/> and contained <see cref="Thing"/>s.
        /// </returns>

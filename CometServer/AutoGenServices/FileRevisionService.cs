...
namespace CometServer.Services
{
    ...
    public sealed partial class FileRevisionService : ServiceBase, IFileRevisionService
    {
        ...
        {
            return this.FileRevisionDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.FileRevisionDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.FileRevisionDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.FileRevisionDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

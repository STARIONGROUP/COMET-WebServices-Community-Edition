...
namespace CometServer.Services
{
    ...
    public sealed partial class RelationalExpressionService : ServiceBase, IRelationalExpressionService
    {
        ...
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var relationalExpressionColl = new List<Thing>(this.RelationalExpressionDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction)));

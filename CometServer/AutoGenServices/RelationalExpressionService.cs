...
namespace CometServer.Services
{
    ...
    public sealed partial class RelationalExpressionService : ServiceBase, IRelationalExpressionService
    {
        ...
        {
            return this.RelationalExpressionDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.RelationalExpressionDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.RelationalExpressionDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.RelationalExpressionDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

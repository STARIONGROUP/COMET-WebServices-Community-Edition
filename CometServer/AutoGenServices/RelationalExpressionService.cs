...
namespace CometServer.Services
{
    ...
    public sealed partial class RelationalExpressionService : ServiceBase, IRelationalExpressionService
    {
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="RelationalExpression"/>, optionally with contained <see cref="Thing"/>s.
        /// </returns>
        ...
        {
            return this.RelationalExpressionDao.AddToCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.RelationalExpressionDao.DeleteFromCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.RelationalExpressionDao.ReorderCollectionProperty(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public bool DeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.RelationalExpressionDao.Delete(transaction, partition, thing.Iid);
        }
        ...
        public bool RawDeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.RelationalExpressionDao.RawDelete(transaction, partition, thing.Iid);
        }
        ...
        public bool UpdateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return this.RelationalExpressionDao.Update(transaction, partition, relationalExpression, container);
        }
        ...
        public bool CreateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var relationalExpression = thing as RelationalExpression;
            return this.RelationalExpressionDao.Write(transaction, partition, relationalExpression, container);
        }
        ...
        {
            var relationalExpression = thing as RelationalExpression;
            return this.RelationalExpressionDao.Upsert(transaction, partition, relationalExpression, container);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="RelationalExpression"/>.
        /// </returns>
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var relationalExpressionColl = new List<Thing>(this.RelationalExpressionDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction), (DateTime)this.TransactionManager.GetRawSessionInstant(transaction)));

            return this.AfterGet(relationalExpressionColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="RelationalExpression"/> and contained <see cref="Thing"/>s.
        /// </returns>

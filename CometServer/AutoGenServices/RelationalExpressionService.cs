...
namespace CometServer.Services
{
    ...
    public sealed partial class RelationalExpressionService : ServiceBase, IRelationalExpressionService
    {
        ...
        public async Task<IEnumerable<Thing>> GetShallowAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var relationalExpressionColl = new List<Thing>(await this.RelationalExpressionDao.ReadAsync(transaction, partition, idFilter, isCachedDtoReadEnabled, sessionInstant));

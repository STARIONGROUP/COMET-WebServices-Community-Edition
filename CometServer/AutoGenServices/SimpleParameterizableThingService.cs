...
namespace CometServer.Services
{
    ...
    public sealed partial class SimpleParameterizableThingService : ServiceBase, ISimpleParameterizableThingService
    {
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="SimpleParameterizableThing"/>, optionally with contained <see cref="Thing"/>s.
        /// </returns>
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="SimpleParameterizableThing"/>.
        /// </returns>
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            simpleParameterizableThingColl.AddRange(this.RequirementService.GetShallow(transaction, partition, idFilter, authorizedContext));

            return this.AfterGet(simpleParameterizableThingColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="SimpleParameterizableThing"/> and contained <see cref="Thing"/>s.
        /// </returns>
        public IEnumerable<Thing> GetDeep(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            results.AddRange(this.RequirementService.GetDeep(transaction, partition, idFilter, containerSecurityContext));
            return results;
        }

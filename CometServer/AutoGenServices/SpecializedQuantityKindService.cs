...
namespace CometServer.Services
{
    ...
    public sealed partial class SpecializedQuantityKindService : ServiceBase, ISpecializedQuantityKindService
    {
        ...
        {
            return this.SpecializedQuantityKindDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.SpecializedQuantityKindDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.SpecializedQuantityKindDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.SpecializedQuantityKindDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

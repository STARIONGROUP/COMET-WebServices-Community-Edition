...
namespace CometServer.Services
{
    ...
    public sealed partial class SpecializedQuantityKindService : ServiceBase, ISpecializedQuantityKindService
    {
        ...
        public async Task<IEnumerable<Thing>> GetShallowAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var specializedQuantityKindColl = new List<Thing>(await this.SpecializedQuantityKindDao.ReadAsync(transaction, partition, idFilter, isCachedDtoReadEnabled, sessionInstant));

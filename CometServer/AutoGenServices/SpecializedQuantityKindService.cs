// --------------------------------------------------------------------------------------------------------------------
// <copyright file="SpecializedQuantityKindService.cs" company="Starion Group S.A.">
...
namespace CometServer.Services
{
    ...
    /// <summary>
    /// The <see cref="SpecializedQuantityKind"/> Service which uses the ORM layer to interact with the data model.
    /// </summary>
    public sealed partial class SpecializedQuantityKindService : ServiceBase, ISpecializedQuantityKindService
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets or sets the <see cref="ISpecializedQuantityKindDao"/>.
        /// </summary>
        public ISpecializedQuantityKindDao SpecializedQuantityKindDao { get; set; }

        /// <summary>
        /// Get the requested <see cref="SpecializedQuantityKind"/>s from the ORM layer.
        /// </summary>
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having a list of instances of <see cref="SpecializedQuantityKind"/>, optionally with contained <see cref="Thing"/>s as result.
        /// </returns>
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="SpecializedQuantityKind"/> id that will be the source for each link table record.
        /// </param>
        /// <param name="value">
        ...
        {
            return await this.SpecializedQuantityKindDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="SpecializedQuantityKind"/> id that is the source of the link table records.
        /// </param>
        /// <param name="value">
        ...
        {
            return await this.SpecializedQuantityKindDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="SpecializedQuantityKind"/> id that is the source for the reordered link table record.
        /// </param>
        ...
        {
            return await this.SpecializedQuantityKindDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        /// <summary>
        /// Delete the supplied <see cref="SpecializedQuantityKind"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="SpecializedQuantityKind"/> to delete.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="SpecializedQuantityKind"/> to be removed.
        /// </param>
        /// <returns>
        ...
        public async Task<bool> DeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return await this.SpecializedQuantityKindDao.DeleteAsync(transaction, partition, thing.Iid);
        }
        ...
        public async Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return await this.SpecializedQuantityKindDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

        /// <summary>
        /// Update the supplied <see cref="SpecializedQuantityKind"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="SpecializedQuantityKind"/> <see cref="Thing"/> to update.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="SpecializedQuantityKind"/> to be updated.
        /// </param>
        /// <returns>
        ...
        public async Task<bool> UpdateConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return await this.SpecializedQuantityKindDao.UpdateAsync(transaction, partition, specializedQuantityKind, container);
        }

        /// <summary>
        /// Persist the supplied <see cref="SpecializedQuantityKind"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="SpecializedQuantityKind"/> <see cref="Thing"/> to create.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="SpecializedQuantityKind"/> to be persisted.
        /// </param>
        /// <param name="sequence">
        ...
        public async Task<bool> CreateConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var specializedQuantityKind = thing as SpecializedQuantityKind;
            var createSuccesful = await this.SpecializedQuantityKindDao.WriteAsync(transaction, partition, specializedQuantityKind, container);
            return createSuccesful && await this.CreateContainmentAsync(transaction, partition, specializedQuantityKind);
        }

        /// <summary>
        /// Persist the supplied <see cref="SpecializedQuantityKind"/> instance. Update if it already exists.
        /// This is typically used during the import of existing data to the Database.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        ...
        {
            var specializedQuantityKind = thing as SpecializedQuantityKind;
            var createSuccesful = await this.SpecializedQuantityKindDao.UpsertAsync(transaction, partition, specializedQuantityKind, container);
            return createSuccesful && await this.UpsertContainmentAsync(transaction, partition, specializedQuantityKind);
        }
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having List of instances of <see cref="SpecializedQuantityKind"/> as result.
        /// </returns>
        public async Task<IEnumerable<Thing>> GetShallowAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var authorizedContext = this.AuthorizeReadRequest("SpecializedQuantityKind", containerSecurityContext, partition);
            ...
            var specializedQuantityKindColl = new List<Thing>(await this.SpecializedQuantityKindDao.ReadAsync(transaction, partition, idFilter, await this.TransactionManager.IsCachedDtoReadEnabledAsync(transaction), (DateTime)(await this.TransactionManager.GetRawSessionInstantAsync(transaction))));

            return await this.AfterGetAsync(specializedQuantityKindColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having List of instances of <see cref="SpecializedQuantityKind"/> and contained <see cref="Thing"/>s as result.
        /// </returns>
        public async Task<IEnumerable<Thing>> GetDeepAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var specializedQuantityKindColl = results.Where(i => i.GetType() == typeof(SpecializedQuantityKind)).Cast<SpecializedQuantityKind>().ToList();

            results.AddRange(await this.AliasService.GetDeepAsync(transaction, partition, specializedQuantityKindColl.SelectMany(x => x.Alias), containerSecurityContext));
            results.AddRange(await this.DefinitionService.GetDeepAsync(transaction, partition, specializedQuantityKindColl.SelectMany(x => x.Definition), containerSecurityContext));
            results.AddRange(await this.HyperLinkService.GetDeepAsync(transaction, partition, specializedQuantityKindColl.SelectMany(x => x.HyperLink), containerSecurityContext));
        ...
        /// <summary>
        /// Persist the <see cref="SpecializedQuantityKind"/> containment tree to the ORM layer.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// An awaitable <see cref="Task"/> having True if the persistence was successful as result.
        /// </returns>
        private async Task<bool> CreateContainmentAsync(NpgsqlTransaction transaction, string partition, SpecializedQuantityKind specializedQuantityKind)
        {
            var results = new List<bool>();

            foreach (var alias in this.ResolveFromRequestCache(specializedQuantityKind.Alias))
            {
                results.Add(await this.AliasService.CreateConceptAsync(transaction, partition, alias, specializedQuantityKind));
            }

            foreach (var definition in this.ResolveFromRequestCache(specializedQuantityKind.Definition))
            {
                results.Add(await this.DefinitionService.CreateConceptAsync(transaction, partition, definition, specializedQuantityKind));
            }

            foreach (var hyperLink in this.ResolveFromRequestCache(specializedQuantityKind.HyperLink))
            {
                results.Add(await this.HyperLinkService.CreateConceptAsync(transaction, partition, hyperLink, specializedQuantityKind));
            }
        ...
        /// An awaitable <see cref="Task"/> having True if the persistence was successful as result.
        /// </returns>
        private async Task<bool> UpsertContainmentAsync(NpgsqlTransaction transaction, string partition, SpecializedQuantityKind specializedQuantityKind)
        {
            var results = new List<bool>();

            foreach (var alias in this.ResolveFromRequestCache(specializedQuantityKind.Alias))
            {
                results.Add(await this.AliasService.UpsertConceptAsync(transaction, partition, alias, specializedQuantityKind));
            }

            foreach (var definition in this.ResolveFromRequestCache(specializedQuantityKind.Definition))
            {
                results.Add(await this.DefinitionService.UpsertConceptAsync(transaction, partition, definition, specializedQuantityKind));
            }

            foreach (var hyperLink in this.ResolveFromRequestCache(specializedQuantityKind.HyperLink))
            {
                results.Add(await this.HyperLinkService.UpsertConceptAsync(transaction, partition, hyperLink, specializedQuantityKind));
            }

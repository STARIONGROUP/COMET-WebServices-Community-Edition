...
namespace CometServer.Services
{
    ...
    public sealed partial class FileTypeService : ServiceBase, IFileTypeService
    {
        ...
        {
            return this.FileTypeDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.FileTypeDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.FileTypeDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.FileTypeDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

...
namespace CometServer.Services
{
    ...
    public sealed partial class RequirementsContainerParameterValueService : ServiceBase, IRequirementsContainerParameterValueService
    {
        ...
        public async Task<IEnumerable<Thing>> GetShallowAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var requirementsContainerParameterValueColl = new List<Thing>(await this.RequirementsContainerParameterValueDao.ReadAsync(transaction, partition, idFilter, isCachedDtoReadEnabled, sessionInstant));

...
namespace CometServer.Services
{
    ...
    public sealed partial class RequirementsContainerParameterValueService : ServiceBase, IRequirementsContainerParameterValueService
    {
        ...
        {
            return this.RequirementsContainerParameterValueDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.RequirementsContainerParameterValueDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.RequirementsContainerParameterValueDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.RequirementsContainerParameterValueDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

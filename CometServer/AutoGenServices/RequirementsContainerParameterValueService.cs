...
namespace CometServer.Services
{
    ...
    public sealed partial class RequirementsContainerParameterValueService : ServiceBase, IRequirementsContainerParameterValueService
    {
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="RequirementsContainerParameterValue"/>, optionally with contained <see cref="Thing"/>s.
        /// </returns>
        ...
        {
            return this.RequirementsContainerParameterValueDao.AddToCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.RequirementsContainerParameterValueDao.DeleteFromCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        public bool DeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.RequirementsContainerParameterValueDao.Delete(transaction, partition, thing.Iid);
        }
        ...
        public bool RawDeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.RequirementsContainerParameterValueDao.RawDelete(transaction, partition, thing.Iid);
        }
        ...
        public bool UpdateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return this.RequirementsContainerParameterValueDao.Update(transaction, partition, requirementsContainerParameterValue, container);
        }
        ...
        public bool CreateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var requirementsContainerParameterValue = thing as RequirementsContainerParameterValue;
            return this.RequirementsContainerParameterValueDao.Write(transaction, partition, requirementsContainerParameterValue, container);
        }
        ...
        {
            var requirementsContainerParameterValue = thing as RequirementsContainerParameterValue;
            return this.RequirementsContainerParameterValueDao.Upsert(transaction, partition, requirementsContainerParameterValue, container);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="RequirementsContainerParameterValue"/>.
        /// </returns>
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var requirementsContainerParameterValueColl = new List<Thing>(this.RequirementsContainerParameterValueDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction), (DateTime)this.TransactionManager.GetRawSessionInstant(transaction)));

            return this.AfterGet(requirementsContainerParameterValueColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="RequirementsContainerParameterValue"/> and contained <see cref="Thing"/>s.
        /// </returns>

// --------------------------------------------------------------------------------------------------------------------
// <copyright file="RequirementsContainerParameterValueService.cs" company="Starion Group S.A.">
...
namespace CometServer.Services
{
    ...
    /// <summary>
    /// The <see cref="RequirementsContainerParameterValue"/> Service which uses the ORM layer to interact with the data model.
    /// </summary>
    public sealed partial class RequirementsContainerParameterValueService : ServiceBase, IRequirementsContainerParameterValueService
    {
        /// <summary>
        /// Gets or sets the <see cref="IRequirementsContainerParameterValueDao"/>.
        /// </summary>
        public IRequirementsContainerParameterValueDao RequirementsContainerParameterValueDao { get; set; }

        /// <summary>
        /// Get the requested <see cref="RequirementsContainerParameterValue"/>s from the ORM layer.
        /// </summary>
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having a list of instances of <see cref="RequirementsContainerParameterValue"/>, optionally with contained <see cref="Thing"/>s as result.
        /// </returns>
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="RequirementsContainerParameterValue"/> id that will be the source for each link table record.
        /// </param>
        /// <param name="value">
        ...
        {
            return await this.RequirementsContainerParameterValueDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="RequirementsContainerParameterValue"/> id that is the source of the link table records.
        /// </param>
        /// <param name="value">
        ...
        {
            return await this.RequirementsContainerParameterValueDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return await this.RequirementsContainerParameterValueDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        /// <summary>
        /// Delete the supplied <see cref="RequirementsContainerParameterValue"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="RequirementsContainerParameterValue"/> to delete.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="RequirementsContainerParameterValue"/> to be removed.
        /// </param>
        /// <returns>
        ...
        public async Task<bool> DeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return await this.RequirementsContainerParameterValueDao.DeleteAsync(transaction, partition, thing.Iid);
        }
        ...
        public async Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return await this.RequirementsContainerParameterValueDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

        /// <summary>
        /// Update the supplied <see cref="RequirementsContainerParameterValue"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="RequirementsContainerParameterValue"/> <see cref="Thing"/> to update.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="RequirementsContainerParameterValue"/> to be updated.
        /// </param>
        /// <returns>
        ...
        public async Task<bool> UpdateConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return await this.RequirementsContainerParameterValueDao.UpdateAsync(transaction, partition, requirementsContainerParameterValue, container);
        }

        /// <summary>
        /// Persist the supplied <see cref="RequirementsContainerParameterValue"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="RequirementsContainerParameterValue"/> <see cref="Thing"/> to create.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="RequirementsContainerParameterValue"/> to be persisted.
        /// </param>
        /// <param name="sequence">
        ...
        public async Task<bool> CreateConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var requirementsContainerParameterValue = thing as RequirementsContainerParameterValue;
            return await this.RequirementsContainerParameterValueDao.WriteAsync(transaction, partition, requirementsContainerParameterValue, container);
        }

        /// <summary>
        /// Persist the supplied <see cref="RequirementsContainerParameterValue"/> instance. Update if it already exists.
        /// This is typically used during the import of existing data to the Database.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        ...
        {
            var requirementsContainerParameterValue = thing as RequirementsContainerParameterValue;
            return await this.RequirementsContainerParameterValueDao.UpsertAsync(transaction, partition, requirementsContainerParameterValue, container);
        }
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having List of instances of <see cref="RequirementsContainerParameterValue"/> as result.
        /// </returns>
        public async Task<IEnumerable<Thing>> GetShallowAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var authorizedContext = this.AuthorizeReadRequest("RequirementsContainerParameterValue", containerSecurityContext, partition);
            ...
            var requirementsContainerParameterValueColl = new List<Thing>(await this.RequirementsContainerParameterValueDao.ReadAsync(transaction, partition, idFilter, await this.TransactionManager.IsCachedDtoReadEnabledAsync(transaction), (DateTime)(await this.TransactionManager.GetRawSessionInstantAsync(transaction))));

            return await this.AfterGetAsync(requirementsContainerParameterValueColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having List of instances of <see cref="RequirementsContainerParameterValue"/> and contained <see cref="Thing"/>s as result.
        /// </returns>

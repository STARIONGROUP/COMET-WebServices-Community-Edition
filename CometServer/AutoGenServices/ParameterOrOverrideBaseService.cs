...
namespace CometServer.Services
{
    ...
    public sealed partial class ParameterOrOverrideBaseService : ServiceBase, IParameterOrOverrideBaseService
    {
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="ParameterOrOverrideBase"/>, optionally with contained <see cref="Thing"/>s.
        /// </returns>
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="ParameterOrOverrideBase"/>.
        /// </returns>
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            parameterOrOverrideBaseColl.AddRange(this.ParameterService.GetShallow(transaction, partition, idFilter, authorizedContext));
            parameterOrOverrideBaseColl.AddRange(this.ParameterOverrideService.GetShallow(transaction, partition, idFilter, authorizedContext));

            return this.AfterGet(parameterOrOverrideBaseColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="ParameterOrOverrideBase"/> and contained <see cref="Thing"/>s.
        /// </returns>
        public IEnumerable<Thing> GetDeep(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            results.AddRange(this.ParameterService.GetDeep(transaction, partition, idFilter, containerSecurityContext));
            results.AddRange(this.ParameterOverrideService.GetDeep(transaction, partition, idFilter, containerSecurityContext));
            return results;
        }

...
namespace CometServer.Services
{
    ...
    public sealed partial class OrganizationService : ServiceBase, IOrganizationService
    {
        ...
        {
            return this.OrganizationDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.OrganizationDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.OrganizationDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.OrganizationDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

// --------------------------------------------------------------------------------------------------------------------
// <copyright file="OrganizationService.cs" company="RHEA System S.A.">
...
namespace CometServer.Services
{
    ...
    public sealed partial class OrganizationService : ServiceBase, IOrganizationService
    {
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="Organization"/>, optionally with contained <see cref="Thing"/>s.
        /// </returns>
        ...
        {
            return this.OrganizationDao.AddToCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.OrganizationDao.DeleteFromCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        public bool DeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.OrganizationDao.Delete(transaction, partition, thing.Iid);
        }
        ...
        public bool RawDeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.OrganizationDao.RawDelete(transaction, partition, thing.Iid);
        }
        ...
        public bool UpdateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return this.OrganizationDao.Update(transaction, partition, organization, container);
        }
        ...
        public bool CreateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var organization = thing as Organization;
            return this.OrganizationDao.Write(transaction, partition, organization, container);
        }
        ...
        {
            var organization = thing as Organization;
            return this.OrganizationDao.Upsert(transaction, partition, organization, container);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="Organization"/>.
        /// </returns>
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var organizationColl = new List<Thing>(this.OrganizationDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction), (DateTime)this.TransactionManager.GetRawSessionInstant(transaction)));

            return this.AfterGet(organizationColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="Organization"/> and contained <see cref="Thing"/>s.
        /// </returns>

...
namespace CometServer.Services
{
    ...
    public sealed partial class DiagramElementContainerService : ServiceBase, IDiagramElementContainerService
    {
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="DiagramElementContainer"/>, optionally with contained <see cref="Thing"/>s.
        /// </returns>
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="DiagramElementContainer"/>.
        /// </returns>
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            diagramElementContainerColl.AddRange(this.DiagramCanvasService.GetShallow(transaction, partition, idFilter, authorizedContext));
            diagramElementContainerColl.AddRange(this.DiagramElementThingService.GetShallow(transaction, partition, idFilter, authorizedContext));

            return this.AfterGet(diagramElementContainerColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="DiagramElementContainer"/> and contained <see cref="Thing"/>s.
        /// </returns>
        public IEnumerable<Thing> GetDeep(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            results.AddRange(this.DiagramCanvasService.GetDeep(transaction, partition, idFilter, containerSecurityContext));
            results.AddRange(this.DiagramElementThingService.GetDeep(transaction, partition, idFilter, containerSecurityContext));
            return results;
        }

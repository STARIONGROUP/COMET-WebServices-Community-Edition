...
namespace CometServer.Services
{
    ...
    public sealed partial class PointService : ServiceBase, IPointService
    {
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="Point"/>, optionally with contained <see cref="Thing"/>s.
        /// </returns>
        ...
        {
            return this.PointDao.AddToCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.PointDao.DeleteFromCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.PointDao.ReorderCollectionProperty(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        {
            return this.PointDao.ReorderContainment(transaction, partition, orderedItem);
        }
        ...
        public bool DeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.PointDao.Delete(transaction, partition, thing.Iid);
        }
        ...
        public bool RawDeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.PointDao.RawDelete(transaction, partition, thing.Iid);
        }
        ...
        public bool UpdateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return this.PointDao.Update(transaction, partition, point, container);
        }
        ...
        public bool CreateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var point = thing as Point;
            return this.PointDao.Write(transaction, partition, point, sequence, container);
        }
        ...
        {
            var point = thing as Point;
            return this.PointDao.Upsert(transaction, partition, point, sequence, container);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="Point"/>.
        /// </returns>
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var pointColl = new List<Thing>(this.PointDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction), (DateTime)this.TransactionManager.GetRawSessionInstant(transaction)));

            return this.AfterGet(pointColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="Point"/> and contained <see cref="Thing"/>s.
        /// </returns>

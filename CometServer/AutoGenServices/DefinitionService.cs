...
namespace CometServer.Services
{
    ...
    public sealed partial class DefinitionService : ServiceBase, IDefinitionService
    {
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="Definition"/>, optionally with contained <see cref="Thing"/>s.
        /// </returns>
        ...
        {
            return this.DefinitionDao.AddToCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.DefinitionDao.DeleteFromCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.DefinitionDao.ReorderCollectionProperty(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public bool DeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.DefinitionDao.Delete(transaction, partition, thing.Iid);
        }
        ...
        public bool RawDeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.DefinitionDao.RawDelete(transaction, partition, thing.Iid);
        }
        ...
        public bool UpdateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return this.DefinitionDao.Update(transaction, partition, definition, container);
        }
        ...
        public bool CreateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var definition = thing as Definition;
            var createSuccesful = this.DefinitionDao.Write(transaction, partition, definition, container);
            return createSuccesful && this.CreateContainment(transaction, partition, definition);
        }
        ...
        {
            var definition = thing as Definition;
            var createSuccesful = this.DefinitionDao.Upsert(transaction, partition, definition, container);
            return createSuccesful && this.UpsertContainment(transaction, partition, definition);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="Definition"/>.
        /// </returns>
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var definitionColl = new List<Thing>(this.DefinitionDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction), (DateTime)this.TransactionManager.GetRawSessionInstant(transaction)));

            return this.AfterGet(definitionColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="Definition"/> and contained <see cref="Thing"/>s.
        /// </returns>
        ...
        /// True if the persistence was successful.
        /// </returns>
        private bool CreateContainment(NpgsqlTransaction transaction, string partition, Definition definition)
        {
            var results = new List<bool>();

            foreach (var citation in this.ResolveFromRequestCache(definition.Citation))
            {
                results.Add(this.CitationService.CreateConcept(transaction, partition, citation, definition));
            }
        ...
        /// True if the persistence was successful.
        /// </returns>
        private bool UpsertContainment(NpgsqlTransaction transaction, string partition, Definition definition)
        {
            var results = new List<bool>();

            foreach (var citation in this.ResolveFromRequestCache(definition.Citation))
            {
                results.Add(this.CitationService.UpsertConcept(transaction, partition, citation, definition));
            }

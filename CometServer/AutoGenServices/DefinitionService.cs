...
namespace CometServer.Services
{
    ...
    public sealed partial class DefinitionService : ServiceBase, IDefinitionService
    {
        ...
        {
            return this.DefinitionDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.DefinitionDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.DefinitionDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.DefinitionDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

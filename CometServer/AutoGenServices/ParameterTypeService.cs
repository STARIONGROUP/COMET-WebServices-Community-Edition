// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ParameterTypeService.cs" company="Starion Group S.A.">
...
namespace CometServer.Services
{
    ...
    /// <summary>
    /// The <see cref="ParameterType"/> Service which uses the ORM layer to interact with the data model.
    /// </summary>
    public sealed partial class ParameterTypeService : ServiceBase, IParameterTypeService
    {
        /// <summary>
        ...
        /// <summary>
        /// Get the requested <see cref="ParameterType"/>s from the ORM layer.
        /// </summary>
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having a list of instances of <see cref="ParameterType"/>, optionally with contained <see cref="Thing"/>s as result.
        /// </returns>
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="ParameterType"/> id that will be the source for each link table record.
        /// </param>
        /// <param name="value">
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="ParameterType"/> id that is the source of the link table records.
        /// </param>
        /// <param name="value">
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="ParameterType"/> id that is the source for the reordered link table record.
        /// </param>
        ...
        /// <summary>
        /// Delete the supplied <see cref="ParameterType"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="ParameterType"/> to delete.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="ParameterType"/> to be removed.
        /// </param>
        /// <returns>
        ...
        /// <summary>
        /// Update the supplied <see cref="ParameterType"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="ParameterType"/> <see cref="Thing"/> to update.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="ParameterType"/> to be updated.
        /// </param>
        /// <returns>
        ...
        public async Task<bool> UpdateConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            if (parameterType.IsSameOrDerivedClass<CompoundParameterType>())
            {
                return await this.CompoundParameterTypeService.UpdateConceptAsync(transaction, partition, parameterType, container);
            }

            if (parameterType.IsSameOrDerivedClass<SampledFunctionParameterType>())
            {
                return await this.SampledFunctionParameterTypeService.UpdateConceptAsync(transaction, partition, parameterType, container);
            }

            if (parameterType.IsSameOrDerivedClass<ScalarParameterType>())
            {
                return await this.ScalarParameterTypeService.UpdateConceptAsync(transaction, partition, parameterType, container);
            }
            throw new NotSupportedException(string.Format("The supplied DTO type: {0} is not a supported type", parameterType.GetType().Name));
        }

        /// <summary>
        /// Persist the supplied <see cref="ParameterType"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="ParameterType"/> <see cref="Thing"/> to create.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="ParameterType"/> to be persisted.
        /// </param>
        /// <param name="sequence">
        ...
        public async Task<bool> CreateConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            if (parameterType.IsSameOrDerivedClass<CompoundParameterType>())
            {
                return await this.CompoundParameterTypeService.CreateConceptAsync(transaction, partition, parameterType, container);
            }

            if (parameterType.IsSameOrDerivedClass<SampledFunctionParameterType>())
            {
                return await this.SampledFunctionParameterTypeService.CreateConceptAsync(transaction, partition, parameterType, container);
            }

            if (parameterType.IsSameOrDerivedClass<ScalarParameterType>())
            {
                return await this.ScalarParameterTypeService.CreateConceptAsync(transaction, partition, parameterType, container);
            }
            throw new NotSupportedException(string.Format("The supplied DTO type: {0} is not a supported type", parameterType.GetType().Name));
        }

        /// <summary>
        /// Persist the supplied <see cref="ParameterType"/> instance. Update if it already exists.
        /// This is typically used during the import of existing data to the Database.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        ...
        public async Task<bool> UpsertConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            if (parameterType.IsSameOrDerivedClass<CompoundParameterType>())
            {
                return await this.CompoundParameterTypeService.UpsertConceptAsync(transaction, partition, parameterType, container);
            }

            if (parameterType.IsSameOrDerivedClass<SampledFunctionParameterType>())
            {
                return await this.SampledFunctionParameterTypeService.UpsertConceptAsync(transaction, partition, parameterType, container);
            }

            if (parameterType.IsSameOrDerivedClass<ScalarParameterType>())
            {
                return await this.ScalarParameterTypeService.UpsertConceptAsync(transaction, partition, parameterType, container);
            }
            throw new NotSupportedException(string.Format("The supplied DTO type: {0} is not a supported type", parameterType.GetType().Name));
        }
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having List of instances of <see cref="ParameterType"/> as result.
        /// </returns>
        public async Task<IEnumerable<Thing>> GetShallowAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var authorizedContext = this.AuthorizeReadRequest("ParameterType", containerSecurityContext, partition);
            ...
            parameterTypeColl.AddRange(await this.CompoundParameterTypeService.GetShallowAsync(transaction, partition, idFilter, authorizedContext));
            parameterTypeColl.AddRange(await this.SampledFunctionParameterTypeService.GetShallowAsync(transaction, partition, idFilter, authorizedContext));
            parameterTypeColl.AddRange(await this.ScalarParameterTypeService.GetShallowAsync(transaction, partition, idFilter, authorizedContext));

            return await this.AfterGetAsync(parameterTypeColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having List of instances of <see cref="ParameterType"/> and contained <see cref="Thing"/>s as result.
        /// </returns>
        public async Task<IEnumerable<Thing>> GetDeepAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            results.AddRange(await this.CompoundParameterTypeService.GetDeepAsync(transaction, partition, idFilter, containerSecurityContext));
            results.AddRange(await this.SampledFunctionParameterTypeService.GetDeepAsync(transaction, partition, idFilter, containerSecurityContext));
            results.AddRange(await this.ScalarParameterTypeService.GetDeepAsync(transaction, partition, idFilter, containerSecurityContext));
            return results;
        }

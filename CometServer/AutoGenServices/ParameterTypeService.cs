...
namespace CometServer.Services
{
    ...
    public sealed partial class ParameterTypeService : ServiceBase, IParameterTypeService
    {
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="ParameterType"/>, optionally with contained <see cref="Thing"/>s.
        /// </returns>
        ...
        public bool UpsertConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            if (parameterType.IsSameOrDerivedClass<CompoundParameterType>())
            {
                return this.CompoundParameterTypeService.UpsertConcept(transaction, partition, parameterType, container);
            }

            if (parameterType.IsSameOrDerivedClass<SampledFunctionParameterType>())
            {
                return this.SampledFunctionParameterTypeService.UpsertConcept(transaction, partition, parameterType, container);
            }

            if (parameterType.IsSameOrDerivedClass<ScalarParameterType>())
            {
                return this.ScalarParameterTypeService.UpsertConcept(transaction, partition, parameterType, container);
            }
            throw new NotSupportedException(string.Format("The supplied DTO type: {0} is not a supported type", parameterType.GetType().Name));
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="ParameterType"/>.
        /// </returns>
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="ParameterType"/> and contained <see cref="Thing"/>s.
        /// </returns>

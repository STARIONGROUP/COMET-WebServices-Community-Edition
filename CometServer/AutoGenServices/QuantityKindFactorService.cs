// --------------------------------------------------------------------------------------------------------------------
// <copyright file="QuantityKindFactorService.cs" company="Starion Group S.A.">
...
namespace CometServer.Services
{
    ...
    /// <summary>
    /// The <see cref="QuantityKindFactor"/> Service which uses the ORM layer to interact with the data model.
    /// </summary>
    public sealed partial class QuantityKindFactorService : ServiceBase, IQuantityKindFactorService
    {
        /// <summary>
        /// Gets or sets the <see cref="IQuantityKindFactorDao"/>.
        /// </summary>
        public IQuantityKindFactorDao QuantityKindFactorDao { get; set; }

        /// <summary>
        /// Get the requested <see cref="QuantityKindFactor"/>s from the ORM layer.
        /// </summary>
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having a list of instances of <see cref="QuantityKindFactor"/>, optionally with contained <see cref="Thing"/>s as result.
        /// </returns>
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="QuantityKindFactor"/> id that will be the source for each link table record.
        /// </param>
        /// <param name="value">
        ...
        {
            return await this.QuantityKindFactorDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="QuantityKindFactor"/> id that is the source of the link table records.
        /// </param>
        /// <param name="value">
        ...
        {
            return await this.QuantityKindFactorDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="QuantityKindFactor"/> id that is the source for the reordered link table record.
        /// </param>
        ...
        {
            return await this.QuantityKindFactorDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        {
            return await this.QuantityKindFactorDao.ReorderContainmentAsync(transaction, partition, orderedItem);
        }

        /// <summary>
        /// Delete the supplied <see cref="QuantityKindFactor"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="QuantityKindFactor"/> to delete.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="QuantityKindFactor"/> to be removed.
        /// </param>
        /// <returns>
        ...
        public async Task<bool> DeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return await this.QuantityKindFactorDao.DeleteAsync(transaction, partition, thing.Iid);
        }
        ...
        public async Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return await this.QuantityKindFactorDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

        /// <summary>
        /// Update the supplied <see cref="QuantityKindFactor"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="QuantityKindFactor"/> <see cref="Thing"/> to update.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="QuantityKindFactor"/> to be updated.
        /// </param>
        /// <returns>
        ...
        public async Task<bool> UpdateConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return await this.QuantityKindFactorDao.UpdateAsync(transaction, partition, quantityKindFactor, container);
        }

        /// <summary>
        /// Persist the supplied <see cref="QuantityKindFactor"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="QuantityKindFactor"/> <see cref="Thing"/> to create.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="QuantityKindFactor"/> to be persisted.
        /// </param>
        /// <param name="sequence">
        ...
        public async Task<bool> CreateConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var quantityKindFactor = thing as QuantityKindFactor;
            return await this.QuantityKindFactorDao.WriteAsync(transaction, partition, quantityKindFactor, sequence, container);
        }

        /// <summary>
        /// Persist the supplied <see cref="QuantityKindFactor"/> instance. Update if it already exists.
        /// This is typically used during the import of existing data to the Database.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        ...
        {
            var quantityKindFactor = thing as QuantityKindFactor;
            return await this.QuantityKindFactorDao.UpsertAsync(transaction, partition, quantityKindFactor, sequence, container);
        }
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having List of instances of <see cref="QuantityKindFactor"/> as result.
        /// </returns>
        public async Task<IEnumerable<Thing>> GetShallowAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var authorizedContext = this.AuthorizeReadRequest("QuantityKindFactor", containerSecurityContext, partition);
            ...
            var quantityKindFactorColl = new List<Thing>(await this.QuantityKindFactorDao.ReadAsync(transaction, partition, idFilter, await this.TransactionManager.IsCachedDtoReadEnabledAsync(transaction), (DateTime)(await this.TransactionManager.GetRawSessionInstantAsync(transaction))));

            return await this.AfterGetAsync(quantityKindFactorColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having List of instances of <see cref="QuantityKindFactor"/> and contained <see cref="Thing"/>s as result.
        /// </returns>

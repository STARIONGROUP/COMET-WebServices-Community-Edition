...
namespace CometServer.Services
{
    ...
    public sealed partial class QuantityKindFactorService : ServiceBase, IQuantityKindFactorService
    {
        ...
        {
            return this.QuantityKindFactorDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.QuantityKindFactorDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.QuantityKindFactorDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        {
            return this.QuantityKindFactorDao.ReorderContainmentAsync(transaction, partition, orderedItem);
        }
        ...
        public Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.QuantityKindFactorDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

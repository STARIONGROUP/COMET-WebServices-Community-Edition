...
namespace CometServer.Services
{
    ...
    public sealed partial class QuantityKindFactorService : ServiceBase, IQuantityKindFactorService
    {
        ...
        public async Task<IEnumerable<Thing>> GetShallowAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var quantityKindFactorColl = new List<Thing>(await this.QuantityKindFactorDao.ReadAsync(transaction, partition, idFilter, isCachedDtoReadEnabled, sessionInstant));

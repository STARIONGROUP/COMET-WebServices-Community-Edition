...
namespace CometServer.Services
{
    ...
    public sealed partial class AndExpressionService : ServiceBase, IAndExpressionService
    {
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="AndExpression"/>, optionally with contained <see cref="Thing"/>s.
        /// </returns>
        ...
        {
            return this.AndExpressionDao.AddToCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.AndExpressionDao.DeleteFromCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.AndExpressionDao.ReorderCollectionProperty(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public bool DeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.AndExpressionDao.Delete(transaction, partition, thing.Iid);
        }
        ...
        public bool UpdateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return this.AndExpressionDao.Update(transaction, partition, andExpression, container);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="AndExpression"/>.
        /// </returns>
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var andExpressionColl = new List<Thing>(this.AndExpressionDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction), (DateTime)this.TransactionManager.GetRawSessionInstant(transaction)));

            return this.AfterGet(andExpressionColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="AndExpression"/> and contained <see cref="Thing"/>s.
        /// </returns>

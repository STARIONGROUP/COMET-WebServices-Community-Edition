...
namespace CometServer.Services
{
    ...
    public sealed partial class AndExpressionService : ServiceBase, IAndExpressionService
    {
        ...
        {
            return this.AndExpressionDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.AndExpressionDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.AndExpressionDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.AndExpressionDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

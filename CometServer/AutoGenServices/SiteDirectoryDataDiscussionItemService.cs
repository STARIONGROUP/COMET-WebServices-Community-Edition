...
namespace CometServer.Services
{
    ...
    public sealed partial class SiteDirectoryDataDiscussionItemService : ServiceBase, ISiteDirectoryDataDiscussionItemService
    {
        ...
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var siteDirectoryDataDiscussionItemColl = new List<Thing>(this.SiteDirectoryDataDiscussionItemDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction)));

// --------------------------------------------------------------------------------------------------------------------
// <copyright file="SiteDirectoryDataDiscussionItemService.cs" company="Starion Group S.A.">
...
namespace CometServer.Services
{
    ...
    /// <summary>
    /// The <see cref="SiteDirectoryDataDiscussionItem"/> Service which uses the ORM layer to interact with the data model.
    /// </summary>
    public sealed partial class SiteDirectoryDataDiscussionItemService : ServiceBase, ISiteDirectoryDataDiscussionItemService
    {
        /// <summary>
        /// Gets or sets the <see cref="ISiteDirectoryDataDiscussionItemDao"/>.
        /// </summary>
        public ISiteDirectoryDataDiscussionItemDao SiteDirectoryDataDiscussionItemDao { get; set; }

        /// <summary>
        /// Get the requested <see cref="SiteDirectoryDataDiscussionItem"/>s from the ORM layer.
        /// </summary>
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having a list of instances of <see cref="SiteDirectoryDataDiscussionItem"/>, optionally with contained <see cref="Thing"/>s as result.
        /// </returns>
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="SiteDirectoryDataDiscussionItem"/> id that will be the source for each link table record.
        /// </param>
        /// <param name="value">
        ...
        {
            return await this.SiteDirectoryDataDiscussionItemDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="SiteDirectoryDataDiscussionItem"/> id that is the source of the link table records.
        /// </param>
        /// <param name="value">
        ...
        {
            return await this.SiteDirectoryDataDiscussionItemDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return await this.SiteDirectoryDataDiscussionItemDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        /// <summary>
        /// Delete the supplied <see cref="SiteDirectoryDataDiscussionItem"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="SiteDirectoryDataDiscussionItem"/> to delete.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="SiteDirectoryDataDiscussionItem"/> to be removed.
        /// </param>
        /// <returns>
        ...
        public async Task<bool> DeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return await this.SiteDirectoryDataDiscussionItemDao.DeleteAsync(transaction, partition, thing.Iid);
        }
        ...
        public async Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return await this.SiteDirectoryDataDiscussionItemDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

        /// <summary>
        /// Update the supplied <see cref="SiteDirectoryDataDiscussionItem"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="SiteDirectoryDataDiscussionItem"/> <see cref="Thing"/> to update.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="SiteDirectoryDataDiscussionItem"/> to be updated.
        /// </param>
        /// <returns>
        ...
        public async Task<bool> UpdateConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return await this.SiteDirectoryDataDiscussionItemDao.UpdateAsync(transaction, partition, siteDirectoryDataDiscussionItem, container);
        }

        /// <summary>
        /// Persist the supplied <see cref="SiteDirectoryDataDiscussionItem"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="SiteDirectoryDataDiscussionItem"/> <see cref="Thing"/> to create.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="SiteDirectoryDataDiscussionItem"/> to be persisted.
        /// </param>
        /// <param name="sequence">
        ...
        public async Task<bool> CreateConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var siteDirectoryDataDiscussionItem = thing as SiteDirectoryDataDiscussionItem;
            return await this.SiteDirectoryDataDiscussionItemDao.WriteAsync(transaction, partition, siteDirectoryDataDiscussionItem, container);
        }

        /// <summary>
        /// Persist the supplied <see cref="SiteDirectoryDataDiscussionItem"/> instance. Update if it already exists.
        /// This is typically used during the import of existing data to the Database.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        ...
        {
            var siteDirectoryDataDiscussionItem = thing as SiteDirectoryDataDiscussionItem;
            return await this.SiteDirectoryDataDiscussionItemDao.UpsertAsync(transaction, partition, siteDirectoryDataDiscussionItem, container);
        }
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having List of instances of <see cref="SiteDirectoryDataDiscussionItem"/> as result.
        /// </returns>
        public async Task<IEnumerable<Thing>> GetShallowAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var authorizedContext = this.AuthorizeReadRequest("SiteDirectoryDataDiscussionItem", containerSecurityContext, partition);
            ...
            var siteDirectoryDataDiscussionItemColl = new List<Thing>(await this.SiteDirectoryDataDiscussionItemDao.ReadAsync(transaction, partition, idFilter, await this.TransactionManager.IsCachedDtoReadEnabledAsync(transaction), (DateTime)(await this.TransactionManager.GetRawSessionInstantAsync(transaction))));

            return await this.AfterGetAsync(siteDirectoryDataDiscussionItemColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having List of instances of <see cref="SiteDirectoryDataDiscussionItem"/> and contained <see cref="Thing"/>s as result.
        /// </returns>

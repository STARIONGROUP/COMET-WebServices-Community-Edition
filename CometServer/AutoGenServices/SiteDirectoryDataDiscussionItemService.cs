...
namespace CometServer.Services
{
    ...
    public sealed partial class SiteDirectoryDataDiscussionItemService : ServiceBase, ISiteDirectoryDataDiscussionItemService
    {
        ...
        {
            return this.SiteDirectoryDataDiscussionItemDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.SiteDirectoryDataDiscussionItemDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.SiteDirectoryDataDiscussionItemDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.SiteDirectoryDataDiscussionItemDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

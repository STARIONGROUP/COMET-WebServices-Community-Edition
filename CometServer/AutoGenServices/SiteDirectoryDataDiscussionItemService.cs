...
namespace CometServer.Services
{
    ...
    public sealed partial class SiteDirectoryDataDiscussionItemService : ServiceBase, ISiteDirectoryDataDiscussionItemService
    {
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="SiteDirectoryDataDiscussionItem"/>, optionally with contained <see cref="Thing"/>s.
        /// </returns>
        ...
        {
            return this.SiteDirectoryDataDiscussionItemDao.AddToCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.SiteDirectoryDataDiscussionItemDao.DeleteFromCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        public bool DeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.SiteDirectoryDataDiscussionItemDao.Delete(transaction, partition, thing.Iid);
        }
        ...
        public bool RawDeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.SiteDirectoryDataDiscussionItemDao.RawDelete(transaction, partition, thing.Iid);
        }
        ...
        public bool UpdateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return this.SiteDirectoryDataDiscussionItemDao.Update(transaction, partition, siteDirectoryDataDiscussionItem, container);
        }
        ...
        public bool CreateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var siteDirectoryDataDiscussionItem = thing as SiteDirectoryDataDiscussionItem;
            return this.SiteDirectoryDataDiscussionItemDao.Write(transaction, partition, siteDirectoryDataDiscussionItem, container);
        }
        ...
        {
            var siteDirectoryDataDiscussionItem = thing as SiteDirectoryDataDiscussionItem;
            return this.SiteDirectoryDataDiscussionItemDao.Upsert(transaction, partition, siteDirectoryDataDiscussionItem, container);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="SiteDirectoryDataDiscussionItem"/>.
        /// </returns>
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var siteDirectoryDataDiscussionItemColl = new List<Thing>(this.SiteDirectoryDataDiscussionItemDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction), (DateTime)this.TransactionManager.GetRawSessionInstant(transaction)));

            return this.AfterGet(siteDirectoryDataDiscussionItemColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="SiteDirectoryDataDiscussionItem"/> and contained <see cref="Thing"/>s.
        /// </returns>

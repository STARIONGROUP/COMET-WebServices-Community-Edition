...
namespace CometServer.Services
{
    ...
    public sealed partial class SiteDirectoryDataDiscussionItemService : ServiceBase, ISiteDirectoryDataDiscussionItemService
    {
        ...
        public async Task<IEnumerable<Thing>> GetShallowAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var siteDirectoryDataDiscussionItemColl = new List<Thing>(await this.SiteDirectoryDataDiscussionItemDao.ReadAsync(transaction, partition, idFilter, isCachedDtoReadEnabled, sessionInstant));

...
namespace CometServer.Services
{
    ...
    public sealed partial class DiscussionItemService : ServiceBase, IDiscussionItemService
    {
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="DiscussionItem"/>, optionally with contained <see cref="Thing"/>s.
        /// </returns>
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="DiscussionItem"/>.
        /// </returns>
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            discussionItemColl.AddRange(this.EngineeringModelDataDiscussionItemService.GetShallow(transaction, partition, idFilter, authorizedContext));
            discussionItemColl.AddRange(this.SiteDirectoryDataDiscussionItemService.GetShallow(transaction, partition, idFilter, authorizedContext));

            return this.AfterGet(discussionItemColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="DiscussionItem"/> and contained <see cref="Thing"/>s.
        /// </returns>
        public IEnumerable<Thing> GetDeep(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            results.AddRange(this.EngineeringModelDataDiscussionItemService.GetDeep(transaction, partition, idFilter, containerSecurityContext));
            results.AddRange(this.SiteDirectoryDataDiscussionItemService.GetDeep(transaction, partition, idFilter, containerSecurityContext));
            return results;
        }

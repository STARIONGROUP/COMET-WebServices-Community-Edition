...
namespace CometServer.Services
{
    ...
    public sealed partial class ChangeRequestService : ServiceBase, IChangeRequestService
    {
        ...
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var changeRequestColl = new List<Thing>(this.ChangeRequestDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction)));

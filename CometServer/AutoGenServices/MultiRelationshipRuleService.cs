...
namespace CometServer.Services
{
    ...
    public sealed partial class MultiRelationshipRuleService : ServiceBase, IMultiRelationshipRuleService
    {
        ...
        {
            return await this.MultiRelationshipRuleDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return await this.MultiRelationshipRuleDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return await this.MultiRelationshipRuleDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public async Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return await this.MultiRelationshipRuleDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }
        ...
        public async Task<IEnumerable<Thing>> GetShallowAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var multiRelationshipRuleColl = new List<Thing>(await this.MultiRelationshipRuleDao.ReadAsync(transaction, partition, idFilter, await this.TransactionManager.IsCachedDtoReadEnabledAsync(transaction), (DateTime)(await this.TransactionManager.GetRawSessionInstantAsync(transaction))));

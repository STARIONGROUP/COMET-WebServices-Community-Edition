...
namespace CometServer.Services
{
    ...
    public sealed partial class TermService : ServiceBase, ITermService
    {
        ...
        {
            return this.TermDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.TermDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.TermDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.TermDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

...
namespace CometServer.Services
{
    ...
    public sealed partial class OrganizationalParticipantService : ServiceBase, IOrganizationalParticipantService
    {
        ...
        {
            return this.OrganizationalParticipantDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.OrganizationalParticipantDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.OrganizationalParticipantDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.OrganizationalParticipantDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

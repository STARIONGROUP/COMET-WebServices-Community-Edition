...
namespace CometServer.Services
{
    ...
    public sealed partial class OrganizationalParticipantService : ServiceBase, IOrganizationalParticipantService
    {
        ...
        public bool RawDeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.OrganizationalParticipantDao.RawDelete(transaction, partition, thing.Iid);
        }
        ...
        {
            var organizationalParticipant = thing as OrganizationalParticipant;
            return this.OrganizationalParticipantDao.Upsert(transaction, partition, organizationalParticipant, container);
        }
        ...
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var organizationalParticipantColl = new List<Thing>(this.OrganizationalParticipantDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction), (DateTime)this.TransactionManager.GetRawSessionInstant(transaction)));

...
namespace CometServer.Services
{
    ...
    public sealed partial class OrganizationalParticipantService : ServiceBase, IOrganizationalParticipantService
    {
        ...
        public async Task<IEnumerable<Thing>> GetShallowAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var organizationalParticipantColl = new List<Thing>(await this.OrganizationalParticipantDao.ReadAsync(transaction, partition, idFilter, isCachedDtoReadEnabled, sessionInstant));

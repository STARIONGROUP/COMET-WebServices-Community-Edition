...
namespace CometServer.Services
{
    ...
    public sealed partial class GoalService : ServiceBase, IGoalService
    {
        ...
        {
            return this.GoalDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.GoalDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.GoalDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.GoalDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

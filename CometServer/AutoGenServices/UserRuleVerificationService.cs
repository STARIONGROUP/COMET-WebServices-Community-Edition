// --------------------------------------------------------------------------------------------------------------------
// <copyright file="UserRuleVerificationService.cs" company="Starion Group S.A.">
...
namespace CometServer.Services
{
    ...
    /// <summary>
    /// The <see cref="UserRuleVerification"/> Service which uses the ORM layer to interact with the data model.
    /// </summary>
    public sealed partial class UserRuleVerificationService : ServiceBase, IUserRuleVerificationService
    {
        /// <summary>
        /// Gets or sets the <see cref="IRuleViolationService"/>.
        /// </summary>
        public IRuleViolationService ViolationService { get; set; }

        /// <summary>
        /// Gets or sets the <see cref="IUserRuleVerificationDao"/>.
        /// </summary>
        public IUserRuleVerificationDao UserRuleVerificationDao { get; set; }

        /// <summary>
        /// Get the requested <see cref="UserRuleVerification"/>s from the ORM layer.
        /// </summary>
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having a list of instances of <see cref="UserRuleVerification"/>, optionally with contained <see cref="Thing"/>s as result.
        /// </returns>
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="UserRuleVerification"/> id that will be the source for each link table record.
        /// </param>
        /// <param name="value">
        ...
        {
            return await this.UserRuleVerificationDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="UserRuleVerification"/> id that is the source of the link table records.
        /// </param>
        /// <param name="value">
        ...
        {
            return await this.UserRuleVerificationDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="UserRuleVerification"/> id that is the source for the reordered link table record.
        /// </param>
        ...
        {
            return await this.UserRuleVerificationDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        /// <summary>
        /// Delete the supplied <see cref="UserRuleVerification"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="UserRuleVerification"/> to delete.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="UserRuleVerification"/> to be removed.
        /// </param>
        /// <returns>
        ...
        public async Task<bool> DeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return await this.UserRuleVerificationDao.DeleteAsync(transaction, partition, thing.Iid);
        }
        ...
        public async Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return await this.UserRuleVerificationDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

        /// <summary>
        /// Update the supplied <see cref="UserRuleVerification"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="UserRuleVerification"/> <see cref="Thing"/> to update.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="UserRuleVerification"/> to be updated.
        /// </param>
        /// <returns>
        ...
        public async Task<bool> UpdateConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return await this.UserRuleVerificationDao.UpdateAsync(transaction, partition, userRuleVerification, container);
        }

        /// <summary>
        /// Persist the supplied <see cref="UserRuleVerification"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="UserRuleVerification"/> <see cref="Thing"/> to create.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="UserRuleVerification"/> to be persisted.
        /// </param>
        /// <param name="sequence">
        ...
        public async Task<bool> CreateConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var userRuleVerification = thing as UserRuleVerification;
            var createSuccesful = await this.UserRuleVerificationDao.WriteAsync(transaction, partition, userRuleVerification, sequence, container);
            return createSuccesful && await this.CreateContainmentAsync(transaction, partition, userRuleVerification);
        }

        /// <summary>
        /// Persist the supplied <see cref="UserRuleVerification"/> instance. Update if it already exists.
        /// This is typically used during the import of existing data to the Database.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        ...
        {
            var userRuleVerification = thing as UserRuleVerification;
            var createSuccesful = await this.UserRuleVerificationDao.UpsertAsync(transaction, partition, userRuleVerification, sequence, container);
            return createSuccesful && await this.UpsertContainmentAsync(transaction, partition, userRuleVerification);
        }
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having List of instances of <see cref="UserRuleVerification"/> as result.
        /// </returns>
        public async Task<IEnumerable<Thing>> GetShallowAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var authorizedContext = this.AuthorizeReadRequest("UserRuleVerification", containerSecurityContext, partition);
            ...
            var userRuleVerificationColl = new List<Thing>(await this.UserRuleVerificationDao.ReadAsync(transaction, partition, idFilter, await this.TransactionManager.IsCachedDtoReadEnabledAsync(transaction), (DateTime)(await this.TransactionManager.GetRawSessionInstantAsync(transaction))));

            return await this.AfterGetAsync(userRuleVerificationColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having List of instances of <see cref="UserRuleVerification"/> and contained <see cref="Thing"/>s as result.
        /// </returns>
        public async Task<IEnumerable<Thing>> GetDeepAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var userRuleVerificationColl = results.Where(i => i.GetType() == typeof(UserRuleVerification)).Cast<UserRuleVerification>().ToList();

            results.AddRange(await this.ViolationService.GetDeepAsync(transaction, partition, userRuleVerificationColl.SelectMany(x => x.Violation), containerSecurityContext));
        ...
        /// <summary>
        /// Persist the <see cref="UserRuleVerification"/> containment tree to the ORM layer.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// The <see cref="UserRuleVerification"/> instance to persist.
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having True if the persistence was successful as result.
        /// </returns>
        private async Task<bool> CreateContainmentAsync(NpgsqlTransaction transaction, string partition, UserRuleVerification userRuleVerification)
        {
            var results = new List<bool>();

            foreach (var violation in this.ResolveFromRequestCache(userRuleVerification.Violation))
            {
                results.Add(await this.ViolationService.CreateConceptAsync(transaction, partition, violation, userRuleVerification));
            }
        ...
        /// <summary>
        /// Persist the <see cref="UserRuleVerification"/> containment tree to the ORM layer. Update if it already exists.
        /// This is typically used during the import of existing data to the Database.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        ...
        /// An awaitable <see cref="Task"/> having True if the persistence was successful as result.
        /// </returns>
        private async Task<bool> UpsertContainmentAsync(NpgsqlTransaction transaction, string partition, UserRuleVerification userRuleVerification)
        {
            var results = new List<bool>();

            foreach (var violation in this.ResolveFromRequestCache(userRuleVerification.Violation))
            {
                results.Add(await this.ViolationService.UpsertConceptAsync(transaction, partition, violation, userRuleVerification));
            }

...
namespace CometServer.Services
{
    ...
    public sealed partial class UserRuleVerificationService : ServiceBase, IUserRuleVerificationService
    {
        ...
        {
            return this.UserRuleVerificationDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.UserRuleVerificationDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.UserRuleVerificationDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.UserRuleVerificationDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

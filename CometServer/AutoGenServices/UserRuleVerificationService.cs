...
namespace CometServer.Services
{
    ...
    public sealed partial class UserRuleVerificationService : ServiceBase, IUserRuleVerificationService
    {
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="UserRuleVerification"/>, optionally with contained <see cref="Thing"/>s.
        /// </returns>
        ...
        {
            return this.UserRuleVerificationDao.AddToCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.UserRuleVerificationDao.DeleteFromCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.UserRuleVerificationDao.ReorderCollectionProperty(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public bool DeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.UserRuleVerificationDao.Delete(transaction, partition, thing.Iid);
        }
        ...
        public bool RawDeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.UserRuleVerificationDao.RawDelete(transaction, partition, thing.Iid);
        }
        ...
        public bool UpdateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return this.UserRuleVerificationDao.Update(transaction, partition, userRuleVerification, container);
        }
        ...
        public bool CreateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var userRuleVerification = thing as UserRuleVerification;
            var createSuccesful = this.UserRuleVerificationDao.Write(transaction, partition, userRuleVerification, sequence, container);
            return createSuccesful && this.CreateContainment(transaction, partition, userRuleVerification);
        }
        ...
        {
            var userRuleVerification = thing as UserRuleVerification;
            var createSuccesful = this.UserRuleVerificationDao.Upsert(transaction, partition, userRuleVerification, sequence, container);
            return createSuccesful && this.UpsertContainment(transaction, partition, userRuleVerification);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="UserRuleVerification"/>.
        /// </returns>
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var userRuleVerificationColl = new List<Thing>(this.UserRuleVerificationDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction), (DateTime)this.TransactionManager.GetRawSessionInstant(transaction)));

            return this.AfterGet(userRuleVerificationColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="UserRuleVerification"/> and contained <see cref="Thing"/>s.
        /// </returns>
        public IEnumerable<Thing> GetDeep(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            results.AddRange(this.ViolationService.GetDeep(transaction, partition, userRuleVerificationColl.SelectMany(x => x.Violation), containerSecurityContext));
        ...
        private bool CreateContainment(NpgsqlTransaction transaction, string partition, UserRuleVerification userRuleVerification)
        {
            ...
            {
                results.Add(this.ViolationService.CreateConcept(transaction, partition, violation, userRuleVerification));
            }
        ...
        /// True if the persistence was successful.
        /// </returns>
        private bool UpsertContainment(NpgsqlTransaction transaction, string partition, UserRuleVerification userRuleVerification)
        {
            var results = new List<bool>();

            foreach (var violation in this.ResolveFromRequestCache(userRuleVerification.Violation))
            {
                results.Add(this.ViolationService.UpsertConcept(transaction, partition, violation, userRuleVerification));
            }

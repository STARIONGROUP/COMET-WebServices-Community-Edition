...
namespace CometServer.Services
{
    ...
    public sealed partial class UserRuleVerificationService : ServiceBase, IUserRuleVerificationService
    {
        ...
        public async Task<IEnumerable<Thing>> GetShallowAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var userRuleVerificationColl = new List<Thing>(await this.UserRuleVerificationDao.ReadAsync(transaction, partition, idFilter, isCachedDtoReadEnabled, sessionInstant));

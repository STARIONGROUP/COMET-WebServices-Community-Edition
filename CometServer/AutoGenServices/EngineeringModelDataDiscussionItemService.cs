...
namespace CometServer.Services
{
    ...
    public sealed partial class EngineeringModelDataDiscussionItemService : ServiceBase, IEngineeringModelDataDiscussionItemService
    {
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having a list of instances of <see cref="EngineeringModelDataDiscussionItem"/>, optionally with contained <see cref="Thing"/>s as result.
        /// </returns>
        ...
        public async Task<bool> DeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return await this.EngineeringModelDataDiscussionItemDao.DeleteAsync(transaction, partition, thing.Iid);
        }
        ...
        public async Task<bool> UpdateConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return await this.EngineeringModelDataDiscussionItemDao.UpdateAsync(transaction, partition, engineeringModelDataDiscussionItem, container);
        }
        ...
        public async Task<bool> CreateConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var engineeringModelDataDiscussionItem = thing as EngineeringModelDataDiscussionItem;
            return await this.EngineeringModelDataDiscussionItemDao.WriteAsync(transaction, partition, engineeringModelDataDiscussionItem, container);
        }
        ...
        {
            var engineeringModelDataDiscussionItem = thing as EngineeringModelDataDiscussionItem;
            return await this.EngineeringModelDataDiscussionItemDao.UpsertAsync(transaction, partition, engineeringModelDataDiscussionItem, container);
        }
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having List of instances of <see cref="EngineeringModelDataDiscussionItem"/> as result.
        /// </returns>
        public async Task<IEnumerable<Thing>> GetShallowAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var engineeringModelDataDiscussionItemColl = new List<Thing>(await this.EngineeringModelDataDiscussionItemDao.ReadAsync(transaction, partition, idFilter, await this.TransactionManager.IsCachedDtoReadEnabledAsync(transaction), (DateTime)(await this.TransactionManager.GetRawSessionInstantAsync(transaction))));

            return await this.AfterGetAsync(engineeringModelDataDiscussionItemColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having List of instances of <see cref="EngineeringModelDataDiscussionItem"/> and contained <see cref="Thing"/>s as result.
        /// </returns>

// --------------------------------------------------------------------------------------------------------------------
// <copyright file="EngineeringModelDataDiscussionItemService.cs" company="Starion Group S.A.">
...
namespace CometServer.Services
{
    ...
    /// <summary>
    /// The <see cref="EngineeringModelDataDiscussionItem"/> Service which uses the ORM layer to interact with the data model.
    /// </summary>
    public sealed partial class EngineeringModelDataDiscussionItemService : ServiceBase, IEngineeringModelDataDiscussionItemService
    {
        /// <summary>
        /// Gets or sets the <see cref="IEngineeringModelDataDiscussionItemDao"/>.
        /// </summary>
        public IEngineeringModelDataDiscussionItemDao EngineeringModelDataDiscussionItemDao { get; set; }

        /// <summary>
        /// Get the requested <see cref="EngineeringModelDataDiscussionItem"/>s from the ORM layer.
        /// </summary>
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="EngineeringModelDataDiscussionItem"/>, optionally with contained <see cref="Thing"/>s.
        /// </returns>
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="EngineeringModelDataDiscussionItem"/> id that will be the source for each link table record.
        /// </param>
        /// <param name="value">
        ...
        {
            return this.EngineeringModelDataDiscussionItemDao.AddToCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="EngineeringModelDataDiscussionItem"/> id that is the source of the link table records.
        /// </param>
        /// <param name="value">
        ...
        {
            return this.EngineeringModelDataDiscussionItemDao.DeleteFromCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="EngineeringModelDataDiscussionItem"/> id that is the source for the reordered link table record.
        /// </param>
        ...
        {
            return this.EngineeringModelDataDiscussionItemDao.ReorderCollectionProperty(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        /// <summary>
        /// Delete the supplied <see cref="EngineeringModelDataDiscussionItem"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="EngineeringModelDataDiscussionItem"/> to delete.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="EngineeringModelDataDiscussionItem"/> to be removed.
        /// </param>
        /// <returns>
        ...
        public bool DeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.EngineeringModelDataDiscussionItemDao.Delete(transaction, partition, thing.Iid);
        }
        ...
        public bool RawDeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.EngineeringModelDataDiscussionItemDao.RawDelete(transaction, partition, thing.Iid);
        }

        /// <summary>
        /// Update the supplied <see cref="EngineeringModelDataDiscussionItem"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="EngineeringModelDataDiscussionItem"/> <see cref="Thing"/> to update.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="EngineeringModelDataDiscussionItem"/> to be updated.
        /// </param>
        /// <returns>
        ...
        public bool UpdateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return this.EngineeringModelDataDiscussionItemDao.Update(transaction, partition, engineeringModelDataDiscussionItem, container);
        }

        /// <summary>
        /// Persist the supplied <see cref="EngineeringModelDataDiscussionItem"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="EngineeringModelDataDiscussionItem"/> <see cref="Thing"/> to create.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="EngineeringModelDataDiscussionItem"/> to be persisted.
        /// </param>
        /// <param name="sequence">
        ...
        public bool CreateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var engineeringModelDataDiscussionItem = thing as EngineeringModelDataDiscussionItem;
            return this.EngineeringModelDataDiscussionItemDao.Write(transaction, partition, engineeringModelDataDiscussionItem, container);
        }

        /// <summary>
        /// Persist the supplied <see cref="EngineeringModelDataDiscussionItem"/> instance. Update if it already exists.
        /// This is typically used during the import of existing data to the Database.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        ...
        {
            var engineeringModelDataDiscussionItem = thing as EngineeringModelDataDiscussionItem;
            return this.EngineeringModelDataDiscussionItemDao.Upsert(transaction, partition, engineeringModelDataDiscussionItem, container);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="EngineeringModelDataDiscussionItem"/>.
        /// </returns>
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var authorizedContext = this.AuthorizeReadRequest("EngineeringModelDataDiscussionItem", containerSecurityContext, partition);
            ...
            var engineeringModelDataDiscussionItemColl = new List<Thing>(this.EngineeringModelDataDiscussionItemDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction), (DateTime)this.TransactionManager.GetRawSessionInstant(transaction)));

            return this.AfterGet(engineeringModelDataDiscussionItemColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="EngineeringModelDataDiscussionItem"/> and contained <see cref="Thing"/>s.
        /// </returns>

...
namespace CometServer.Services
{
    ...
    public sealed partial class EngineeringModelDataDiscussionItemService : ServiceBase, IEngineeringModelDataDiscussionItemService
    {
        ...
        public async Task<IEnumerable<Thing>> GetShallowAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var engineeringModelDataDiscussionItemColl = new List<Thing>(await this.EngineeringModelDataDiscussionItemDao.ReadAsync(transaction, partition, idFilter, isCachedDtoReadEnabled, sessionInstant));

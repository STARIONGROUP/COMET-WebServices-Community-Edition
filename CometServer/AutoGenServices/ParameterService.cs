...
namespace CometServer.Services
{
    ...
    /// <summary>
    /// The <see cref="Parameter"/> Service which uses the ORM layer to interact with the data model.
    /// </summary>
    public sealed partial class ParameterService : ServiceBase, IParameterService
    {
        /// <summary>
        ...
        /// </summary>
        public IParameterValueSetService ValueSetService { get; set; }

        /// <summary>
        /// Gets or sets the <see cref="IParameterDao"/>.
        /// </summary>
        public IParameterDao ParameterDao { get; set; }

        /// <summary>
        /// Get the requested <see cref="Parameter"/>s from the ORM layer.
        /// </summary>
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having a list of instances of <see cref="Parameter"/>, optionally with contained <see cref="Thing"/>s as result.
        /// </returns>
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="Parameter"/> id that will be the source for each link table record.
        /// </param>
        /// <param name="value">
        ...
        {
            return await this.ParameterDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="Parameter"/> id that is the source of the link table records.
        /// </param>
        /// <param name="value">
        ...
        {
            return await this.ParameterDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="Parameter"/> id that is the source for the reordered link table record.
        /// </param>
        ...
        {
            return await this.ParameterDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        /// <summary>
        /// Delete the supplied <see cref="Parameter"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="Parameter"/> to delete.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="Parameter"/> to be removed.
        /// </param>
        /// <returns>
        ...
        public async Task<bool> DeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return await this.ParameterDao.DeleteAsync(transaction, partition, thing.Iid);
        }
        ...
        public async Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return await this.ParameterDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

        /// <summary>
        /// Update the supplied <see cref="Parameter"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="Parameter"/> <see cref="Thing"/> to update.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="Parameter"/> to be updated.
        /// </param>
        /// <returns>
        ...
        public async Task<bool> UpdateConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return await this.ParameterDao.UpdateAsync(transaction, partition, parameter, container);
        }

        /// <summary>
        /// Persist the supplied <see cref="Parameter"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="Parameter"/> <see cref="Thing"/> to create.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="Parameter"/> to be persisted.
        /// </param>
        /// <param name="sequence">
        ...
        public async Task<bool> CreateConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var parameter = thing as Parameter;
            var createSuccesful = await this.ParameterDao.WriteAsync(transaction, partition, parameter, container);
            return createSuccesful && await this.CreateContainmentAsync(transaction, partition, parameter);
        }

        /// <summary>
        /// Persist the supplied <see cref="Parameter"/> instance. Update if it already exists.
        /// This is typically used during the import of existing data to the Database.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        ...
        {
            var parameter = thing as Parameter;
            var createSuccesful = await this.ParameterDao.UpsertAsync(transaction, partition, parameter, container);
            return createSuccesful && await this.UpsertContainmentAsync(transaction, partition, parameter);
        }
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having List of instances of <see cref="Parameter"/> as result.
        /// </returns>
        public async Task<IEnumerable<Thing>> GetShallowAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var authorizedContext = this.AuthorizeReadRequest("Parameter", containerSecurityContext, partition);
            ...
            var parameterColl = new List<Thing>(await this.ParameterDao.ReadAsync(transaction, partition, idFilter, await this.TransactionManager.IsCachedDtoReadEnabledAsync(transaction), (DateTime)(await this.TransactionManager.GetRawSessionInstantAsync(transaction))));

            return await this.AfterGetAsync(parameterColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having List of instances of <see cref="Parameter"/> and contained <see cref="Thing"/>s as result.
        /// </returns>
        public async Task<IEnumerable<Thing>> GetDeepAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var parameterColl = results.Where(i => i.GetType() == typeof(Parameter)).Cast<Parameter>().ToList();

            results.AddRange(await this.ParameterSubscriptionService.GetDeepAsync(transaction, partition, parameterColl.SelectMany(x => x.ParameterSubscription), containerSecurityContext));
            results.AddRange(await this.ValueSetService.GetDeepAsync(transaction, partition, parameterColl.SelectMany(x => x.ValueSet), containerSecurityContext));
        ...
        /// <summary>
        /// Persist the <see cref="Parameter"/> containment tree to the ORM layer.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// The <see cref="Parameter"/> instance to persist.
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having True if the persistence was successful as result.
        /// </returns>
        private async Task<bool> CreateContainmentAsync(NpgsqlTransaction transaction, string partition, Parameter parameter)
        {
            var results = new List<bool>();

            foreach (var parameterSubscription in this.ResolveFromRequestCache(parameter.ParameterSubscription))
            {
                results.Add(await this.ParameterSubscriptionService.CreateConceptAsync(transaction, partition, parameterSubscription, parameter));
            }

            foreach (var valueSet in this.ResolveFromRequestCache(parameter.ValueSet))
            {
                results.Add(await this.ValueSetService.CreateConceptAsync(transaction, partition, valueSet, parameter));
            }
        ...
        /// <summary>
        /// Persist the <see cref="Parameter"/> containment tree to the ORM layer. Update if it already exists.
        /// This is typically used during the import of existing data to the Database.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        ...
        /// An awaitable <see cref="Task"/> having True if the persistence was successful as result.
        /// </returns>
        private async Task<bool> UpsertContainmentAsync(NpgsqlTransaction transaction, string partition, Parameter parameter)
        {
            var results = new List<bool>();

            foreach (var parameterSubscription in this.ResolveFromRequestCache(parameter.ParameterSubscription))
            {
                results.Add(await this.ParameterSubscriptionService.UpsertConceptAsync(transaction, partition, parameterSubscription, parameter));
            }

            foreach (var valueSet in this.ResolveFromRequestCache(parameter.ValueSet))
            {
                results.Add(await this.ValueSetService.UpsertConceptAsync(transaction, partition, valueSet, parameter));
            }

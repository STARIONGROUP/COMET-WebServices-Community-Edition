...
namespace CometServer.Services
{
    ...
    public sealed partial class ConversionBasedUnitService : ServiceBase, IConversionBasedUnitService
    {
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="ConversionBasedUnit"/>, optionally with contained <see cref="Thing"/>s.
        /// </returns>
        ...
        public bool UpdateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            {
                return this.LinearConversionUnitService.UpdateConcept(transaction, partition, conversionBasedUnit, container);
            }

            if (conversionBasedUnit.IsSameOrDerivedClass<PrefixedUnit>())
            {
                return this.PrefixedUnitService.UpdateConcept(transaction, partition, conversionBasedUnit, container);
            }
        ...
        public bool CreateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            if (conversionBasedUnit.IsSameOrDerivedClass<LinearConversionUnit>())
            {
                return this.LinearConversionUnitService.CreateConcept(transaction, partition, conversionBasedUnit, container);
            }

            if (conversionBasedUnit.IsSameOrDerivedClass<PrefixedUnit>())
            {
                return this.PrefixedUnitService.CreateConcept(transaction, partition, conversionBasedUnit, container);
            }
            throw new NotSupportedException(string.Format("The supplied DTO type: {0} is not a supported type", conversionBasedUnit.GetType().Name));
        }
        ...
        public bool UpsertConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            if (conversionBasedUnit.IsSameOrDerivedClass<LinearConversionUnit>())
            {
                return this.LinearConversionUnitService.UpsertConcept(transaction, partition, conversionBasedUnit, container);
            }

            if (conversionBasedUnit.IsSameOrDerivedClass<PrefixedUnit>())
            {
                return this.PrefixedUnitService.UpsertConcept(transaction, partition, conversionBasedUnit, container);
            }
            throw new NotSupportedException(string.Format("The supplied DTO type: {0} is not a supported type", conversionBasedUnit.GetType().Name));
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="ConversionBasedUnit"/>.
        /// </returns>
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            conversionBasedUnitColl.AddRange(this.LinearConversionUnitService.GetShallow(transaction, partition, idFilter, authorizedContext));
            conversionBasedUnitColl.AddRange(this.PrefixedUnitService.GetShallow(transaction, partition, idFilter, authorizedContext));

            return this.AfterGet(conversionBasedUnitColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="ConversionBasedUnit"/> and contained <see cref="Thing"/>s.
        /// </returns>
        public IEnumerable<Thing> GetDeep(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            results.AddRange(this.LinearConversionUnitService.GetDeep(transaction, partition, idFilter, containerSecurityContext));
            results.AddRange(this.PrefixedUnitService.GetDeep(transaction, partition, idFilter, containerSecurityContext));
            return results;
        }

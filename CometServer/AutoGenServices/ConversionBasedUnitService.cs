// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ConversionBasedUnitService.cs" company="Starion Group S.A.">
...
namespace CometServer.Services
{
    ...
    /// <summary>
    /// The <see cref="ConversionBasedUnit"/> Service which uses the ORM layer to interact with the data model.
    /// </summary>
    [ExcludeFromCodeCoverage]
    public sealed partial class ConversionBasedUnitService : ServiceBase, IConversionBasedUnitService
    {
        /// <summary>
        /// Gets or sets the <see cref="ILinearConversionUnitService"/>.
        /// </summary>
        public ILinearConversionUnitService LinearConversionUnitService { get; set; }

        /// <summary>
        /// Gets or sets the <see cref="IPrefixedUnitService"/>.
        /// </summary>
        public IPrefixedUnitService PrefixedUnitService { get; set; }

        /// <summary>
        /// Get the requested <see cref="ConversionBasedUnit"/>s from the ORM layer.
        /// </summary>
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having a list of instances of <see cref="ConversionBasedUnit"/>, optionally with contained <see cref="Thing"/>s as result.
        /// </returns>
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="ConversionBasedUnit"/> id that will be the source for each link table record.
        /// </param>
        /// <param name="value">
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="ConversionBasedUnit"/> id that is the source of the link table records.
        /// </param>
        /// <param name="value">
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="ConversionBasedUnit"/> id that is the source for the reordered link table record.
        /// </param>
        ...
        /// <summary>
        /// Delete the supplied <see cref="ConversionBasedUnit"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="ConversionBasedUnit"/> to delete.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="ConversionBasedUnit"/> to be removed.
        /// </param>
        /// <returns>
        ...
        /// <summary>
        /// Update the supplied <see cref="ConversionBasedUnit"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="ConversionBasedUnit"/> <see cref="Thing"/> to update.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="ConversionBasedUnit"/> to be updated.
        /// </param>
        /// <returns>
        ...
        public async Task<bool> UpdateConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            if (conversionBasedUnit.IsSameOrDerivedClass<LinearConversionUnit>())
            {
                return await this.LinearConversionUnitService.UpdateConceptAsync(transaction, partition, conversionBasedUnit, container);
            }

            if (conversionBasedUnit.IsSameOrDerivedClass<PrefixedUnit>())
            {
                return await this.PrefixedUnitService.UpdateConceptAsync(transaction, partition, conversionBasedUnit, container);
            }
            throw new NotSupportedException(string.Format("The supplied DTO type: {0} is not a supported type", conversionBasedUnit.GetType().Name));
        }

        /// <summary>
        /// Persist the supplied <see cref="ConversionBasedUnit"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="ConversionBasedUnit"/> <see cref="Thing"/> to create.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="ConversionBasedUnit"/> to be persisted.
        /// </param>
        /// <param name="sequence">
        ...
        public async Task<bool> CreateConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            if (conversionBasedUnit.IsSameOrDerivedClass<LinearConversionUnit>())
            {
                return await this.LinearConversionUnitService.CreateConceptAsync(transaction, partition, conversionBasedUnit, container);
            }

            if (conversionBasedUnit.IsSameOrDerivedClass<PrefixedUnit>())
            {
                return await this.PrefixedUnitService.CreateConceptAsync(transaction, partition, conversionBasedUnit, container);
            }
            throw new NotSupportedException(string.Format("The supplied DTO type: {0} is not a supported type", conversionBasedUnit.GetType().Name));
        }

        /// <summary>
        /// Persist the supplied <see cref="ConversionBasedUnit"/> instance. Update if it already exists.
        /// This is typically used during the import of existing data to the Database.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        ...
        public async Task<bool> UpsertConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            if (conversionBasedUnit.IsSameOrDerivedClass<LinearConversionUnit>())
            {
                return await this.LinearConversionUnitService.UpsertConceptAsync(transaction, partition, conversionBasedUnit, container);
            }

            if (conversionBasedUnit.IsSameOrDerivedClass<PrefixedUnit>())
            {
                return await this.PrefixedUnitService.UpsertConceptAsync(transaction, partition, conversionBasedUnit, container);
            }
            throw new NotSupportedException(string.Format("The supplied DTO type: {0} is not a supported type", conversionBasedUnit.GetType().Name));
        }
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having List of instances of <see cref="ConversionBasedUnit"/> as result.
        /// </returns>
        public async Task<IEnumerable<Thing>> GetShallowAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var authorizedContext = this.AuthorizeReadRequest("ConversionBasedUnit", containerSecurityContext, partition);
            ...
            var conversionBasedUnitColl = new List<Thing>();
            conversionBasedUnitColl.AddRange(await this.LinearConversionUnitService.GetShallowAsync(transaction, partition, idFilter, authorizedContext));
            conversionBasedUnitColl.AddRange(await this.PrefixedUnitService.GetShallowAsync(transaction, partition, idFilter, authorizedContext));

            return await this.AfterGetAsync(conversionBasedUnitColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having List of instances of <see cref="ConversionBasedUnit"/> and contained <see cref="Thing"/>s as result.
        /// </returns>
        public async Task<IEnumerable<Thing>> GetDeepAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            results.AddRange(await this.LinearConversionUnitService.GetDeepAsync(transaction, partition, idFilter, containerSecurityContext));
            results.AddRange(await this.PrefixedUnitService.GetDeepAsync(transaction, partition, idFilter, containerSecurityContext));
            return results;
        }

...
namespace CometServer.Services
{
    ...
    public sealed partial class FileService : ServiceBase, IFileService
    {
        ...
        {
            return this.FileDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.FileDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.FileDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.FileDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

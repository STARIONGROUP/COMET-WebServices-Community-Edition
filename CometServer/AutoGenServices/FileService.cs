...
namespace CometServer.Services
{
    ...
    public sealed partial class FileService : ServiceBase, IFileService
    {
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="File"/>, optionally with contained <see cref="Thing"/>s.
        /// </returns>
        ...
        {
            return this.FileDao.AddToCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.FileDao.DeleteFromCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.FileDao.ReorderCollectionProperty(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public bool DeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.FileDao.Delete(transaction, partition, thing.Iid);
        }
        ...
        public bool RawDeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.FileDao.RawDelete(transaction, partition, thing.Iid);
        }
        ...
        public bool UpdateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return this.FileDao.Update(transaction, partition, file, container);
        }
        ...
        public bool CreateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var file = thing as File;
            var createSuccesful = this.FileDao.Write(transaction, partition, file, container);
            return createSuccesful && this.CreateContainment(transaction, partition, file);
        }
        ...
        {
            var file = thing as File;
            var createSuccesful = this.FileDao.Upsert(transaction, partition, file, container);
            return createSuccesful && this.UpsertContainment(transaction, partition, file);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="File"/>.
        /// </returns>
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var fileColl = new List<Thing>(this.FileDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction), (DateTime)this.TransactionManager.GetRawSessionInstant(transaction)));

            return this.AfterGet(fileColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="File"/> and contained <see cref="Thing"/>s.
        /// </returns>
        public IEnumerable<Thing> GetDeep(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            results.AddRange(this.FileRevisionService.GetDeep(transaction, partition, fileColl.SelectMany(x => x.FileRevision), containerSecurityContext));
        ...
        /// True if the persistence was successful.
        /// </returns>
        private bool CreateContainment(NpgsqlTransaction transaction, string partition, File file)
        {
            var results = new List<bool>();

            foreach (var fileRevision in this.ResolveFromRequestCache(file.FileRevision))
            {
                results.Add(this.FileRevisionService.CreateConcept(transaction, partition, fileRevision, file));
            }
        ...
        /// True if the persistence was successful.
        /// </returns>
        private bool UpsertContainment(NpgsqlTransaction transaction, string partition, File file)
        {
            var results = new List<bool>();

            foreach (var fileRevision in this.ResolveFromRequestCache(file.FileRevision))
            {
                results.Add(this.FileRevisionService.UpsertConcept(transaction, partition, fileRevision, file));
            }

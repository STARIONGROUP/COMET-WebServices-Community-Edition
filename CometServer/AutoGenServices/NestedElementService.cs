...
namespace CometServer.Services
{
    ...
    public sealed partial class NestedElementService : ServiceBase, INestedElementService
    {
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="NestedElement"/>, optionally with contained <see cref="Thing"/>s.
        /// </returns>
        ...
        {
            return this.NestedElementDao.AddToCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.NestedElementDao.DeleteFromCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.NestedElementDao.ReorderCollectionProperty(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public bool DeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.NestedElementDao.Delete(transaction, partition, thing.Iid);
        }
        ...
        public bool RawDeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.NestedElementDao.RawDelete(transaction, partition, thing.Iid);
        }
        ...
        public bool UpdateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return this.NestedElementDao.Update(transaction, partition, nestedElement, container);
        }
        ...
        public bool CreateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var nestedElement = thing as NestedElement;
            var createSuccesful = this.NestedElementDao.Write(transaction, partition, nestedElement, container);
            return createSuccesful && this.CreateContainment(transaction, partition, nestedElement);
        }
        ...
        {
            var nestedElement = thing as NestedElement;
            var createSuccesful = this.NestedElementDao.Upsert(transaction, partition, nestedElement, container);
            return createSuccesful && this.UpsertContainment(transaction, partition, nestedElement);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="NestedElement"/>.
        /// </returns>
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var nestedElementColl = new List<Thing>(this.NestedElementDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction), (DateTime)this.TransactionManager.GetRawSessionInstant(transaction)));

            return this.AfterGet(nestedElementColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="NestedElement"/> and contained <see cref="Thing"/>s.
        /// </returns>
        public IEnumerable<Thing> GetDeep(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            results.AddRange(this.NestedParameterService.GetDeep(transaction, partition, nestedElementColl.SelectMany(x => x.NestedParameter), containerSecurityContext));
        ...
        /// True if the persistence was successful.
        /// </returns>
        private bool CreateContainment(NpgsqlTransaction transaction, string partition, NestedElement nestedElement)
        {
            var results = new List<bool>();

            foreach (var nestedParameter in this.ResolveFromRequestCache(nestedElement.NestedParameter))
            {
                results.Add(this.NestedParameterService.CreateConcept(transaction, partition, nestedParameter, nestedElement));
            }

// --------------------------------------------------------------------------------------------------------------------
// <copyright file="NestedElementService.cs" company="Starion Group S.A.">
...
namespace CometServer.Services
{
    ...
    /// <summary>
    /// The <see cref="NestedElement"/> Service which uses the ORM layer to interact with the data model.
    /// </summary>
    public sealed partial class NestedElementService : ServiceBase, INestedElementService
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets or sets the <see cref="INestedElementDao"/>.
        /// </summary>
        public INestedElementDao NestedElementDao { get; set; }

        /// <summary>
        /// Get the requested <see cref="NestedElement"/>s from the ORM layer.
        /// </summary>
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having a list of instances of <see cref="NestedElement"/>, optionally with contained <see cref="Thing"/>s as result.
        /// </returns>
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="NestedElement"/> id that will be the source for each link table record.
        /// </param>
        /// <param name="value">
        ...
        {
            return await this.NestedElementDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="NestedElement"/> id that is the source of the link table records.
        /// </param>
        /// <param name="value">
        ...
        {
            return await this.NestedElementDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="NestedElement"/> id that is the source for the reordered link table record.
        /// </param>
        ...
        {
            return await this.NestedElementDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        /// <summary>
        /// Delete the supplied <see cref="NestedElement"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="NestedElement"/> to delete.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="NestedElement"/> to be removed.
        /// </param>
        /// <returns>
        ...
        public async Task<bool> DeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return await this.NestedElementDao.DeleteAsync(transaction, partition, thing.Iid);
        }
        ...
        public async Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return await this.NestedElementDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

        /// <summary>
        /// Update the supplied <see cref="NestedElement"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="NestedElement"/> <see cref="Thing"/> to update.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="NestedElement"/> to be updated.
        /// </param>
        /// <returns>
        ...
        public async Task<bool> UpdateConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return await this.NestedElementDao.UpdateAsync(transaction, partition, nestedElement, container);
        }

        /// <summary>
        /// Persist the supplied <see cref="NestedElement"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="NestedElement"/> <see cref="Thing"/> to create.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="NestedElement"/> to be persisted.
        /// </param>
        /// <param name="sequence">
        ...
        public async Task<bool> CreateConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var nestedElement = thing as NestedElement;
            var createSuccesful = await this.NestedElementDao.WriteAsync(transaction, partition, nestedElement, container);
            return createSuccesful && await this.CreateContainmentAsync(transaction, partition, nestedElement);
        }

        /// <summary>
        /// Persist the supplied <see cref="NestedElement"/> instance. Update if it already exists.
        /// This is typically used during the import of existing data to the Database.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        ...
        {
            var nestedElement = thing as NestedElement;
            var createSuccesful = await this.NestedElementDao.UpsertAsync(transaction, partition, nestedElement, container);
            return createSuccesful && await this.UpsertContainmentAsync(transaction, partition, nestedElement);
        }
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having List of instances of <see cref="NestedElement"/> as result.
        /// </returns>
        public async Task<IEnumerable<Thing>> GetShallowAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var authorizedContext = this.AuthorizeReadRequest("NestedElement", containerSecurityContext, partition);
            ...
            var nestedElementColl = new List<Thing>(await this.NestedElementDao.ReadAsync(transaction, partition, idFilter, await this.TransactionManager.IsCachedDtoReadEnabledAsync(transaction), (DateTime)(await this.TransactionManager.GetRawSessionInstantAsync(transaction))));

            return await this.AfterGetAsync(nestedElementColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having List of instances of <see cref="NestedElement"/> and contained <see cref="Thing"/>s as result.
        /// </returns>
        public async Task<IEnumerable<Thing>> GetDeepAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var nestedElementColl = results.Where(i => i.GetType() == typeof(NestedElement)).Cast<NestedElement>().ToList();

            results.AddRange(await this.NestedParameterService.GetDeepAsync(transaction, partition, nestedElementColl.SelectMany(x => x.NestedParameter), containerSecurityContext));
        ...
        /// <summary>
        /// Persist the <see cref="NestedElement"/> containment tree to the ORM layer.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// An awaitable <see cref="Task"/> having True if the persistence was successful as result.
        /// </returns>
        private async Task<bool> CreateContainmentAsync(NpgsqlTransaction transaction, string partition, NestedElement nestedElement)
        {
            var results = new List<bool>();

            foreach (var nestedParameter in this.ResolveFromRequestCache(nestedElement.NestedParameter))
            {
                results.Add(await this.NestedParameterService.CreateConceptAsync(transaction, partition, nestedParameter, nestedElement));
            }
        ...
        /// An awaitable <see cref="Task"/> having True if the persistence was successful as result.
        /// </returns>
        private async Task<bool> UpsertContainmentAsync(NpgsqlTransaction transaction, string partition, NestedElement nestedElement)
        {
            var results = new List<bool>();

            foreach (var nestedParameter in this.ResolveFromRequestCache(nestedElement.NestedParameter))
            {
                results.Add(await this.NestedParameterService.UpsertConceptAsync(transaction, partition, nestedParameter, nestedElement));
            }

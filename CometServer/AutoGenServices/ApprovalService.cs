...
namespace CometServer.Services
{
    ...
    public sealed partial class ApprovalService : ServiceBase, IApprovalService
    {
        ...
        {
            return this.ApprovalDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.ApprovalDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.ApprovalDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.ApprovalDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

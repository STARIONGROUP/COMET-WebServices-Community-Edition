...
namespace CometServer.Services
{
    ...
    public sealed partial class ApprovalService : ServiceBase, IApprovalService
    {
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="Approval"/>, optionally with contained <see cref="Thing"/>s.
        /// </returns>
        ...
        {
            return this.ApprovalDao.AddToCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.ApprovalDao.DeleteFromCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.ApprovalDao.ReorderCollectionProperty(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public bool DeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.ApprovalDao.Delete(transaction, partition, thing.Iid);
        }
        ...
        public bool RawDeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.ApprovalDao.RawDelete(transaction, partition, thing.Iid);
        }
        ...
        public bool UpdateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return this.ApprovalDao.Update(transaction, partition, approval, container);
        }
        ...
        public bool CreateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var approval = thing as Approval;
            return this.ApprovalDao.Write(transaction, partition, approval, container);
        }
        ...
        {
            var approval = thing as Approval;
            return this.ApprovalDao.Upsert(transaction, partition, approval, container);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="Approval"/>.
        /// </returns>
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var approvalColl = new List<Thing>(this.ApprovalDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction), (DateTime)this.TransactionManager.GetRawSessionInstant(transaction)));

            return this.AfterGet(approvalColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="Approval"/> and contained <see cref="Thing"/>s.
        /// </returns>

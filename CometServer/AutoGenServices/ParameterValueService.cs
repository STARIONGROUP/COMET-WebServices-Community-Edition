...
namespace CometServer.Services
{
    ...
    public sealed partial class ParameterValueService : ServiceBase, IParameterValueService
    {
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="ParameterValue"/>, optionally with contained <see cref="Thing"/>s.
        /// </returns>
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="ParameterValue"/>.
        /// </returns>
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            parameterValueColl.AddRange(this.RelationshipParameterValueService.GetShallow(transaction, partition, idFilter, authorizedContext));
            parameterValueColl.AddRange(this.RequirementsContainerParameterValueService.GetShallow(transaction, partition, idFilter, authorizedContext));

            return this.AfterGet(parameterValueColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="ParameterValue"/> and contained <see cref="Thing"/>s.
        /// </returns>
        public IEnumerable<Thing> GetDeep(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            results.AddRange(this.RelationshipParameterValueService.GetDeep(transaction, partition, idFilter, containerSecurityContext));
            results.AddRange(this.RequirementsContainerParameterValueService.GetDeep(transaction, partition, idFilter, containerSecurityContext));
            return results;
        }

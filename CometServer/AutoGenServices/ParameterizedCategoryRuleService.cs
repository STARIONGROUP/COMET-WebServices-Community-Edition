...
namespace CometServer.Services
{
    ...
    public sealed partial class ParameterizedCategoryRuleService : ServiceBase, IParameterizedCategoryRuleService
    {
        ...
        {
            return this.ParameterizedCategoryRuleDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.ParameterizedCategoryRuleDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.ParameterizedCategoryRuleDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.ParameterizedCategoryRuleDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

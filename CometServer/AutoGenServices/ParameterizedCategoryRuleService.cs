...
namespace CometServer.Services
{
    ...
    public sealed partial class ParameterizedCategoryRuleService : ServiceBase, IParameterizedCategoryRuleService
    {
        ...
        public async Task<IEnumerable<Thing>> GetShallowAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var parameterizedCategoryRuleColl = new List<Thing>(await this.ParameterizedCategoryRuleDao.ReadAsync(transaction, partition, idFilter, isCachedDtoReadEnabled, sessionInstant));

// --------------------------------------------------------------------------------------------------------------------
// <copyright file="DependentParameterTypeAssignmentService.cs" company="Starion Group S.A.">
...
namespace CometServer.Services
{
    ...
    /// <summary>
    /// The <see cref="DependentParameterTypeAssignment"/> Service which uses the ORM layer to interact with the data model.
    /// </summary>
    public sealed partial class DependentParameterTypeAssignmentService : ServiceBase, IDependentParameterTypeAssignmentService
    {
        /// <summary>
        /// Gets or sets the <see cref="IDependentParameterTypeAssignmentDao"/>.
        /// </summary>
        public IDependentParameterTypeAssignmentDao DependentParameterTypeAssignmentDao { get; set; }

        /// <summary>
        /// Get the requested <see cref="DependentParameterTypeAssignment"/>s from the ORM layer.
        /// </summary>
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having a list of instances of <see cref="DependentParameterTypeAssignment"/>, optionally with contained <see cref="Thing"/>s as result.
        /// </returns>
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="DependentParameterTypeAssignment"/> id that will be the source for each link table record.
        /// </param>
        /// <param name="value">
        ...
        {
            return await this.DependentParameterTypeAssignmentDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="DependentParameterTypeAssignment"/> id that is the source of the link table records.
        /// </param>
        /// <param name="value">
        ...
        {
            return await this.DependentParameterTypeAssignmentDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="DependentParameterTypeAssignment"/> id that is the source for the reordered link table record.
        /// </param>
        ...
        {
            return await this.DependentParameterTypeAssignmentDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        {
            return await this.DependentParameterTypeAssignmentDao.ReorderContainmentAsync(transaction, partition, orderedItem);
        }

        /// <summary>
        /// Delete the supplied <see cref="DependentParameterTypeAssignment"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="DependentParameterTypeAssignment"/> to delete.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="DependentParameterTypeAssignment"/> to be removed.
        /// </param>
        /// <returns>
        ...
        public async Task<bool> DeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return await this.DependentParameterTypeAssignmentDao.DeleteAsync(transaction, partition, thing.Iid);
        }
        ...
        public async Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return await this.DependentParameterTypeAssignmentDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

        /// <summary>
        /// Update the supplied <see cref="DependentParameterTypeAssignment"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="DependentParameterTypeAssignment"/> <see cref="Thing"/> to update.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="DependentParameterTypeAssignment"/> to be updated.
        /// </param>
        /// <returns>
        ...
        public async Task<bool> UpdateConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return await this.DependentParameterTypeAssignmentDao.UpdateAsync(transaction, partition, dependentParameterTypeAssignment, container);
        }

        /// <summary>
        /// Persist the supplied <see cref="DependentParameterTypeAssignment"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="DependentParameterTypeAssignment"/> <see cref="Thing"/> to create.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="DependentParameterTypeAssignment"/> to be persisted.
        /// </param>
        /// <param name="sequence">
        ...
        public async Task<bool> CreateConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var dependentParameterTypeAssignment = thing as DependentParameterTypeAssignment;
            return await this.DependentParameterTypeAssignmentDao.WriteAsync(transaction, partition, dependentParameterTypeAssignment, sequence, container);
        }

        /// <summary>
        /// Persist the supplied <see cref="DependentParameterTypeAssignment"/> instance. Update if it already exists.
        /// This is typically used during the import of existing data to the Database.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        ...
        {
            var dependentParameterTypeAssignment = thing as DependentParameterTypeAssignment;
            return await this.DependentParameterTypeAssignmentDao.UpsertAsync(transaction, partition, dependentParameterTypeAssignment, sequence, container);
        }
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having List of instances of <see cref="DependentParameterTypeAssignment"/> as result.
        /// </returns>
        public async Task<IEnumerable<Thing>> GetShallowAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var authorizedContext = this.AuthorizeReadRequest("DependentParameterTypeAssignment", containerSecurityContext, partition);
            ...
            var dependentParameterTypeAssignmentColl = new List<Thing>(await this.DependentParameterTypeAssignmentDao.ReadAsync(transaction, partition, idFilter, await this.TransactionManager.IsCachedDtoReadEnabledAsync(transaction), (DateTime)(await this.TransactionManager.GetRawSessionInstantAsync(transaction))));

            return await this.AfterGetAsync(dependentParameterTypeAssignmentColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having List of instances of <see cref="DependentParameterTypeAssignment"/> and contained <see cref="Thing"/>s as result.
        /// </returns>

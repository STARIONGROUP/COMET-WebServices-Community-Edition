...
namespace CometServer.Services
{
    ...
    public sealed partial class DependentParameterTypeAssignmentService : ServiceBase, IDependentParameterTypeAssignmentService
    {
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="DependentParameterTypeAssignment"/>, optionally with contained <see cref="Thing"/>s.
        /// </returns>
        ...
        {
            return this.DependentParameterTypeAssignmentDao.AddToCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.DependentParameterTypeAssignmentDao.DeleteFromCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.DependentParameterTypeAssignmentDao.ReorderCollectionProperty(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        {
            return this.DependentParameterTypeAssignmentDao.ReorderContainment(transaction, partition, orderedItem);
        }
        ...
        public bool DeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.DependentParameterTypeAssignmentDao.Delete(transaction, partition, thing.Iid);
        }
        ...
        public bool RawDeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.DependentParameterTypeAssignmentDao.RawDelete(transaction, partition, thing.Iid);
        }
        ...
        public bool UpdateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return this.DependentParameterTypeAssignmentDao.Update(transaction, partition, dependentParameterTypeAssignment, container);
        }
        ...
        public bool CreateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var dependentParameterTypeAssignment = thing as DependentParameterTypeAssignment;
            return this.DependentParameterTypeAssignmentDao.Write(transaction, partition, dependentParameterTypeAssignment, sequence, container);
        }
        ...
        {
            var dependentParameterTypeAssignment = thing as DependentParameterTypeAssignment;
            return this.DependentParameterTypeAssignmentDao.Upsert(transaction, partition, dependentParameterTypeAssignment, sequence, container);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="DependentParameterTypeAssignment"/>.
        /// </returns>
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var dependentParameterTypeAssignmentColl = new List<Thing>(this.DependentParameterTypeAssignmentDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction), (DateTime)this.TransactionManager.GetRawSessionInstant(transaction)));

            return this.AfterGet(dependentParameterTypeAssignmentColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="DependentParameterTypeAssignment"/> and contained <see cref="Thing"/>s.
        /// </returns>

...
namespace CometServer.Services
{
    ...
    public sealed partial class DependentParameterTypeAssignmentService : ServiceBase, IDependentParameterTypeAssignmentService
    {
        ...
        {
            return this.DependentParameterTypeAssignmentDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.DependentParameterTypeAssignmentDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.DependentParameterTypeAssignmentDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        {
            return this.DependentParameterTypeAssignmentDao.ReorderContainmentAsync(transaction, partition, orderedItem);
        }
        ...
        public Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.DependentParameterTypeAssignmentDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

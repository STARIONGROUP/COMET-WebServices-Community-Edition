...
namespace CometServer.Services
{
    ...
    public sealed partial class RuleVerificationListService : ServiceBase, IRuleVerificationListService
    {
        ...
        {
            return this.RuleVerificationListDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.RuleVerificationListDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.RuleVerificationListDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.RuleVerificationListDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

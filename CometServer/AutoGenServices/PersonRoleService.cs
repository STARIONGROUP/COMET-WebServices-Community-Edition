...
namespace CometServer.Services
{
    ...
    public sealed partial class PersonRoleService : ServiceBase, IPersonRoleService
    {
        ...
        {
            return this.PersonRoleDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.PersonRoleDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.PersonRoleDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.PersonRoleDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

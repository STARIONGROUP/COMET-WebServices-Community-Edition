...
namespace CometServer.Services
{
    ...
    public sealed partial class ParametricConstraintService : ServiceBase, IParametricConstraintService
    {
        ...
        {
            return this.ParametricConstraintDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.ParametricConstraintDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.ParametricConstraintDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        {
            return this.ParametricConstraintDao.ReorderContainmentAsync(transaction, partition, orderedItem);
        }
        ...
        public Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.ParametricConstraintDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

...
namespace CometServer.Services
{
    ...
    public sealed partial class ParametricConstraintService : ServiceBase, IParametricConstraintService
    {
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="ParametricConstraint"/>, optionally with contained <see cref="Thing"/>s.
        /// </returns>
        ...
        {
            return this.ParametricConstraintDao.AddToCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.ParametricConstraintDao.DeleteFromCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.ParametricConstraintDao.ReorderCollectionProperty(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        {
            return this.ParametricConstraintDao.ReorderContainment(transaction, partition, orderedItem);
        }
        ...
        public bool DeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.ParametricConstraintDao.Delete(transaction, partition, thing.Iid);
        }
        ...
        public bool RawDeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.ParametricConstraintDao.RawDelete(transaction, partition, thing.Iid);
        }
        ...
        public bool UpdateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return this.ParametricConstraintDao.Update(transaction, partition, parametricConstraint, container);
        }
        ...
        public bool CreateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var parametricConstraint = thing as ParametricConstraint;
            var createSuccesful = this.ParametricConstraintDao.Write(transaction, partition, parametricConstraint, sequence, container);
            return createSuccesful && this.CreateContainment(transaction, partition, parametricConstraint);
        }
        ...
        {
            var parametricConstraint = thing as ParametricConstraint;
            var createSuccesful = this.ParametricConstraintDao.Upsert(transaction, partition, parametricConstraint, sequence, container);
            return createSuccesful && this.UpsertContainment(transaction, partition, parametricConstraint);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="ParametricConstraint"/>.
        /// </returns>
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var parametricConstraintColl = new List<Thing>(this.ParametricConstraintDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction), (DateTime)this.TransactionManager.GetRawSessionInstant(transaction)));

            return this.AfterGet(parametricConstraintColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="ParametricConstraint"/> and contained <see cref="Thing"/>s.
        /// </returns>
        public IEnumerable<Thing> GetDeep(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            results.AddRange(this.ExpressionService.GetDeep(transaction, partition, parametricConstraintColl.SelectMany(x => x.Expression), containerSecurityContext));
        ...
        /// True if the persistence was successful.
        /// </returns>
        private bool CreateContainment(NpgsqlTransaction transaction, string partition, ParametricConstraint parametricConstraint)
        {
            var results = new List<bool>();

            foreach (var expression in this.ResolveFromRequestCache(parametricConstraint.Expression))
            {
                results.Add(this.ExpressionService.CreateConcept(transaction, partition, expression, parametricConstraint));
            }

// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ParametricConstraintService.cs" company="Starion Group S.A.">
...
namespace CometServer.Services
{
    ...
    /// <summary>
    /// The <see cref="ParametricConstraint"/> Service which uses the ORM layer to interact with the data model.
    /// </summary>
    public sealed partial class ParametricConstraintService : ServiceBase, IParametricConstraintService
    {
        /// <summary>
        /// Gets or sets the <see cref="IBooleanExpressionService"/>.
        /// </summary>
        public IBooleanExpressionService ExpressionService { get; set; }

        /// <summary>
        /// Gets or sets the <see cref="IParametricConstraintDao"/>.
        /// </summary>
        public IParametricConstraintDao ParametricConstraintDao { get; set; }

        /// <summary>
        /// Get the requested <see cref="ParametricConstraint"/>s from the ORM layer.
        /// </summary>
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having a list of instances of <see cref="ParametricConstraint"/>, optionally with contained <see cref="Thing"/>s as result.
        /// </returns>
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="ParametricConstraint"/> id that will be the source for each link table record.
        /// </param>
        /// <param name="value">
        ...
        {
            return await this.ParametricConstraintDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="ParametricConstraint"/> id that is the source of the link table records.
        /// </param>
        /// <param name="value">
        ...
        {
            return await this.ParametricConstraintDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="ParametricConstraint"/> id that is the source for the reordered link table record.
        /// </param>
        ...
        {
            return await this.ParametricConstraintDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        {
            return await this.ParametricConstraintDao.ReorderContainmentAsync(transaction, partition, orderedItem);
        }

        /// <summary>
        /// Delete the supplied <see cref="ParametricConstraint"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="ParametricConstraint"/> to delete.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="ParametricConstraint"/> to be removed.
        /// </param>
        /// <returns>
        ...
        public async Task<bool> DeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return await this.ParametricConstraintDao.DeleteAsync(transaction, partition, thing.Iid);
        }
        ...
        public async Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return await this.ParametricConstraintDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

        /// <summary>
        /// Update the supplied <see cref="ParametricConstraint"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="ParametricConstraint"/> <see cref="Thing"/> to update.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="ParametricConstraint"/> to be updated.
        /// </param>
        /// <returns>
        ...
        public async Task<bool> UpdateConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return await this.ParametricConstraintDao.UpdateAsync(transaction, partition, parametricConstraint, container);
        }

        /// <summary>
        /// Persist the supplied <see cref="ParametricConstraint"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="ParametricConstraint"/> <see cref="Thing"/> to create.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="ParametricConstraint"/> to be persisted.
        /// </param>
        /// <param name="sequence">
        ...
        public async Task<bool> CreateConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var parametricConstraint = thing as ParametricConstraint;
            var createSuccesful = await this.ParametricConstraintDao.WriteAsync(transaction, partition, parametricConstraint, sequence, container);
            return createSuccesful && await this.CreateContainmentAsync(transaction, partition, parametricConstraint);
        }

        /// <summary>
        /// Persist the supplied <see cref="ParametricConstraint"/> instance. Update if it already exists.
        /// This is typically used during the import of existing data to the Database.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        ...
        {
            var parametricConstraint = thing as ParametricConstraint;
            var createSuccesful = await this.ParametricConstraintDao.UpsertAsync(transaction, partition, parametricConstraint, sequence, container);
            return createSuccesful && await this.UpsertContainmentAsync(transaction, partition, parametricConstraint);
        }
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having List of instances of <see cref="ParametricConstraint"/> as result.
        /// </returns>
        public async Task<IEnumerable<Thing>> GetShallowAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var authorizedContext = this.AuthorizeReadRequest("ParametricConstraint", containerSecurityContext, partition);
            ...
            var parametricConstraintColl = new List<Thing>(await this.ParametricConstraintDao.ReadAsync(transaction, partition, idFilter, await this.TransactionManager.IsCachedDtoReadEnabledAsync(transaction), (DateTime)(await this.TransactionManager.GetRawSessionInstantAsync(transaction))));

            return await this.AfterGetAsync(parametricConstraintColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having List of instances of <see cref="ParametricConstraint"/> and contained <see cref="Thing"/>s as result.
        /// </returns>
        public async Task<IEnumerable<Thing>> GetDeepAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var parametricConstraintColl = results.Where(i => i.GetType() == typeof(ParametricConstraint)).Cast<ParametricConstraint>().ToList();

            results.AddRange(await this.ExpressionService.GetDeepAsync(transaction, partition, parametricConstraintColl.SelectMany(x => x.Expression), containerSecurityContext));
        ...
        /// <summary>
        /// Persist the <see cref="ParametricConstraint"/> containment tree to the ORM layer.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// An awaitable <see cref="Task"/> having True if the persistence was successful as result.
        /// </returns>
        private async Task<bool> CreateContainmentAsync(NpgsqlTransaction transaction, string partition, ParametricConstraint parametricConstraint)
        {
            var results = new List<bool>();

            foreach (var expression in this.ResolveFromRequestCache(parametricConstraint.Expression))
            {
                results.Add(await this.ExpressionService.CreateConceptAsync(transaction, partition, expression, parametricConstraint));
            }
        ...
        /// An awaitable <see cref="Task"/> having True if the persistence was successful as result.
        /// </returns>
        private async Task<bool> UpsertContainmentAsync(NpgsqlTransaction transaction, string partition, ParametricConstraint parametricConstraint)
        {
            var results = new List<bool>();

            foreach (var expression in this.ResolveFromRequestCache(parametricConstraint.Expression))
            {
                results.Add(await this.ExpressionService.UpsertConceptAsync(transaction, partition, expression, parametricConstraint));
            }

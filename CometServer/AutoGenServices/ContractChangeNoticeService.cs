...
namespace CometServer.Services
{
    ...
    public sealed partial class ContractChangeNoticeService : ServiceBase, IContractChangeNoticeService
    {
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="ContractChangeNotice"/>, optionally with contained <see cref="Thing"/>s.
        /// </returns>
        ...
        {
            return this.ContractChangeNoticeDao.AddToCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.ContractChangeNoticeDao.DeleteFromCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.ContractChangeNoticeDao.ReorderCollectionProperty(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public bool DeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.ContractChangeNoticeDao.Delete(transaction, partition, thing.Iid);
        }
        ...
        public bool RawDeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.ContractChangeNoticeDao.RawDelete(transaction, partition, thing.Iid);
        }
        ...
        public bool UpdateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return this.ContractChangeNoticeDao.Update(transaction, partition, contractChangeNotice, container);
        }
        ...
        public bool CreateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var contractChangeNotice = thing as ContractChangeNotice;
            var createSuccesful = this.ContractChangeNoticeDao.Write(transaction, partition, contractChangeNotice, container);
            return createSuccesful && this.CreateContainment(transaction, partition, contractChangeNotice);
        }
        ...
        {
            var contractChangeNotice = thing as ContractChangeNotice;
            var createSuccesful = this.ContractChangeNoticeDao.Upsert(transaction, partition, contractChangeNotice, container);
            return createSuccesful && this.UpsertContainment(transaction, partition, contractChangeNotice);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="ContractChangeNotice"/>.
        /// </returns>
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var contractChangeNoticeColl = new List<Thing>(this.ContractChangeNoticeDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction), (DateTime)this.TransactionManager.GetRawSessionInstant(transaction)));

            return this.AfterGet(contractChangeNoticeColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="ContractChangeNotice"/> and contained <see cref="Thing"/>s.
        /// </returns>
        public IEnumerable<Thing> GetDeep(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            results.AddRange(this.RelatedThingService.GetDeep(transaction, partition, contractChangeNoticeColl.SelectMany(x => x.RelatedThing), containerSecurityContext));
        ...
        private bool CreateContainment(NpgsqlTransaction transaction, string partition, ContractChangeNotice contractChangeNotice)
        {
            ...
            {
                results.Add(this.ApprovedByService.CreateConcept(transaction, partition, approvedBy, contractChangeNotice));
            }

            foreach (var discussion in this.ResolveFromRequestCache(contractChangeNotice.Discussion))
            {
                results.Add(this.DiscussionService.CreateConcept(transaction, partition, discussion, contractChangeNotice));
            }

            foreach (var relatedThing in this.ResolveFromRequestCache(contractChangeNotice.RelatedThing))
            {
                results.Add(this.RelatedThingService.CreateConcept(transaction, partition, relatedThing, contractChangeNotice));
            }

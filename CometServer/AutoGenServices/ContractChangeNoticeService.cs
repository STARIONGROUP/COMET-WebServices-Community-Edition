// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ContractChangeNoticeService.cs" company="Starion Group S.A.">
...
namespace CometServer.Services
{
    ...
    /// <summary>
    /// The <see cref="ContractChangeNotice"/> Service which uses the ORM layer to interact with the data model.
    /// </summary>
    public sealed partial class ContractChangeNoticeService : ServiceBase, IContractChangeNoticeService
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets or sets the <see cref="IContractChangeNoticeDao"/>.
        /// </summary>
        public IContractChangeNoticeDao ContractChangeNoticeDao { get; set; }

        /// <summary>
        /// Get the requested <see cref="ContractChangeNotice"/>s from the ORM layer.
        /// </summary>
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having a list of instances of <see cref="ContractChangeNotice"/>, optionally with contained <see cref="Thing"/>s as result.
        /// </returns>
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="ContractChangeNotice"/> id that will be the source for each link table record.
        /// </param>
        /// <param name="value">
        ...
        {
            return await this.ContractChangeNoticeDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="ContractChangeNotice"/> id that is the source of the link table records.
        /// </param>
        /// <param name="value">
        ...
        {
            return await this.ContractChangeNoticeDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="ContractChangeNotice"/> id that is the source for the reordered link table record.
        /// </param>
        ...
        {
            return await this.ContractChangeNoticeDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        /// <summary>
        /// Delete the supplied <see cref="ContractChangeNotice"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="ContractChangeNotice"/> to delete.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="ContractChangeNotice"/> to be removed.
        /// </param>
        /// <returns>
        ...
        public async Task<bool> DeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return await this.ContractChangeNoticeDao.DeleteAsync(transaction, partition, thing.Iid);
        }
        ...
        public async Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return await this.ContractChangeNoticeDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

        /// <summary>
        /// Update the supplied <see cref="ContractChangeNotice"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="ContractChangeNotice"/> <see cref="Thing"/> to update.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="ContractChangeNotice"/> to be updated.
        /// </param>
        /// <returns>
        ...
        public async Task<bool> UpdateConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return await this.ContractChangeNoticeDao.UpdateAsync(transaction, partition, contractChangeNotice, container);
        }

        /// <summary>
        /// Persist the supplied <see cref="ContractChangeNotice"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="ContractChangeNotice"/> <see cref="Thing"/> to create.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="ContractChangeNotice"/> to be persisted.
        /// </param>
        /// <param name="sequence">
        ...
        public async Task<bool> CreateConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var contractChangeNotice = thing as ContractChangeNotice;
            var createSuccesful = await this.ContractChangeNoticeDao.WriteAsync(transaction, partition, contractChangeNotice, container);
            return createSuccesful && await this.CreateContainmentAsync(transaction, partition, contractChangeNotice);
        }

        /// <summary>
        /// Persist the supplied <see cref="ContractChangeNotice"/> instance. Update if it already exists.
        /// This is typically used during the import of existing data to the Database.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        ...
        {
            var contractChangeNotice = thing as ContractChangeNotice;
            var createSuccesful = await this.ContractChangeNoticeDao.UpsertAsync(transaction, partition, contractChangeNotice, container);
            return createSuccesful && await this.UpsertContainmentAsync(transaction, partition, contractChangeNotice);
        }
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having List of instances of <see cref="ContractChangeNotice"/> as result.
        /// </returns>
        public async Task<IEnumerable<Thing>> GetShallowAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var authorizedContext = this.AuthorizeReadRequest("ContractChangeNotice", containerSecurityContext, partition);
            ...
            var contractChangeNoticeColl = new List<Thing>(await this.ContractChangeNoticeDao.ReadAsync(transaction, partition, idFilter, await this.TransactionManager.IsCachedDtoReadEnabledAsync(transaction), (DateTime)(await this.TransactionManager.GetRawSessionInstantAsync(transaction))));

            return await this.AfterGetAsync(contractChangeNoticeColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having List of instances of <see cref="ContractChangeNotice"/> and contained <see cref="Thing"/>s as result.
        /// </returns>
        public async Task<IEnumerable<Thing>> GetDeepAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            results.AddRange(await this.ApprovedByService.GetDeepAsync(transaction, partition, contractChangeNoticeColl.SelectMany(x => x.ApprovedBy), containerSecurityContext));
            results.AddRange(await this.DiscussionService.GetDeepAsync(transaction, partition, contractChangeNoticeColl.SelectMany(x => x.Discussion), containerSecurityContext));
            results.AddRange(await this.RelatedThingService.GetDeepAsync(transaction, partition, contractChangeNoticeColl.SelectMany(x => x.RelatedThing), containerSecurityContext));
        ...
        /// <summary>
        /// Persist the <see cref="ContractChangeNotice"/> containment tree to the ORM layer.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// An awaitable <see cref="Task"/> having True if the persistence was successful as result.
        /// </returns>
        private async Task<bool> CreateContainmentAsync(NpgsqlTransaction transaction, string partition, ContractChangeNotice contractChangeNotice)
        {
            var results = new List<bool>();

            foreach (var approvedBy in this.ResolveFromRequestCache(contractChangeNotice.ApprovedBy))
            {
                results.Add(await this.ApprovedByService.CreateConceptAsync(transaction, partition, approvedBy, contractChangeNotice));
            }

            foreach (var discussion in this.ResolveFromRequestCache(contractChangeNotice.Discussion))
            {
                results.Add(await this.DiscussionService.CreateConceptAsync(transaction, partition, discussion, contractChangeNotice));
            }

            foreach (var relatedThing in this.ResolveFromRequestCache(contractChangeNotice.RelatedThing))
            {
                results.Add(await this.RelatedThingService.CreateConceptAsync(transaction, partition, relatedThing, contractChangeNotice));
            }
        ...
        /// An awaitable <see cref="Task"/> having True if the persistence was successful as result.
        /// </returns>
        private async Task<bool> UpsertContainmentAsync(NpgsqlTransaction transaction, string partition, ContractChangeNotice contractChangeNotice)
        {
            var results = new List<bool>();

            foreach (var approvedBy in this.ResolveFromRequestCache(contractChangeNotice.ApprovedBy))
            {
                results.Add(await this.ApprovedByService.UpsertConceptAsync(transaction, partition, approvedBy, contractChangeNotice));
            }

            foreach (var discussion in this.ResolveFromRequestCache(contractChangeNotice.Discussion))
            {
                results.Add(await this.DiscussionService.UpsertConceptAsync(transaction, partition, discussion, contractChangeNotice));
            }

            foreach (var relatedThing in this.ResolveFromRequestCache(contractChangeNotice.RelatedThing))
            {
                results.Add(await this.RelatedThingService.UpsertConceptAsync(transaction, partition, relatedThing, contractChangeNotice));
            }

...
namespace CometServer.Services
{
    ...
    public sealed partial class ContractChangeNoticeService : ServiceBase, IContractChangeNoticeService
    {
        ...
        {
            return this.ContractChangeNoticeDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.ContractChangeNoticeDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.ContractChangeNoticeDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.ContractChangeNoticeDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

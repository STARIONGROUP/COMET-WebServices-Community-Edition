...
namespace CometServer.Services
{
    ...
    public sealed partial class OptionService : ServiceBase, IOptionService
    {
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="Option"/>, optionally with contained <see cref="Thing"/>s.
        /// </returns>
        ...
        {
            return this.OptionDao.AddToCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.OptionDao.DeleteFromCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.OptionDao.ReorderCollectionProperty(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        {
            return this.OptionDao.ReorderContainment(transaction, partition, orderedItem);
        }
        ...
        public bool DeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.OptionDao.Delete(transaction, partition, thing.Iid);
        }
        ...
        public bool RawDeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.OptionDao.RawDelete(transaction, partition, thing.Iid);
        }
        ...
        public bool UpdateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return this.OptionDao.Update(transaction, partition, option, container);
        }
        ...
        public bool CreateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var option = thing as Option;
            var createSuccesful = this.OptionDao.Write(transaction, partition, option, sequence, container);
            return createSuccesful && this.CreateContainment(transaction, partition, option);
        }
        ...
        {
            var option = thing as Option;
            var createSuccesful = this.OptionDao.Upsert(transaction, partition, option, sequence, container);
            return createSuccesful && this.UpsertContainment(transaction, partition, option);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="Option"/>.
        /// </returns>
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var optionColl = new List<Thing>(this.OptionDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction), (DateTime)this.TransactionManager.GetRawSessionInstant(transaction)));

            return this.AfterGet(optionColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="Option"/> and contained <see cref="Thing"/>s.
        /// </returns>
        ...
        /// True if the persistence was successful.
        /// </returns>
        private bool CreateContainment(NpgsqlTransaction transaction, string partition, Option option)
        {
            ...
            {
                results.Add(this.HyperLinkService.CreateConcept(transaction, partition, hyperLink, option));
            }

            foreach (var nestedElement in this.ResolveFromRequestCache(option.NestedElement))
            {
                results.Add(this.NestedElementService.CreateConcept(transaction, partition, nestedElement, option));
            }
        ...
        /// True if the persistence was successful.
        /// </returns>
        private bool UpsertContainment(NpgsqlTransaction transaction, string partition, Option option)
        {
            var results = new List<bool>();
            ...
            foreach (var definition in this.ResolveFromRequestCache(option.Definition))
            {
                results.Add(this.DefinitionService.UpsertConcept(transaction, partition, definition, option));
            }

            foreach (var hyperLink in this.ResolveFromRequestCache(option.HyperLink))
            {
                results.Add(this.HyperLinkService.UpsertConcept(transaction, partition, hyperLink, option));
            }

            foreach (var nestedElement in this.ResolveFromRequestCache(option.NestedElement))
            {
                results.Add(this.NestedElementService.UpsertConcept(transaction, partition, nestedElement, option));
            }

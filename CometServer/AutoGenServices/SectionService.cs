...
namespace CometServer.Services
{
    ...
    public sealed partial class SectionService : ServiceBase, ISectionService
    {
        ...
        {
            return this.SectionDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.SectionDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.SectionDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        {
            return this.SectionDao.ReorderContainmentAsync(transaction, partition, orderedItem);
        }
        ...
        public Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.SectionDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

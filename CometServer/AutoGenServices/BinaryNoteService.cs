...
namespace CometServer.Services
{
    ...
    public sealed partial class BinaryNoteService : ServiceBase, IBinaryNoteService
    {
        ...
        {
            return this.BinaryNoteDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.BinaryNoteDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.BinaryNoteDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.BinaryNoteDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

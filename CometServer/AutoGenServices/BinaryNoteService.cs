...
namespace CometServer.Services
{
    ...
    public sealed partial class BinaryNoteService : ServiceBase, IBinaryNoteService
    {
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="BinaryNote"/>, optionally with contained <see cref="Thing"/>s.
        /// </returns>
        ...
        {
            return this.BinaryNoteDao.AddToCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.BinaryNoteDao.DeleteFromCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.BinaryNoteDao.ReorderCollectionProperty(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public bool DeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.BinaryNoteDao.Delete(transaction, partition, thing.Iid);
        }
        ...
        public bool RawDeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.BinaryNoteDao.RawDelete(transaction, partition, thing.Iid);
        }
        ...
        public bool UpdateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return this.BinaryNoteDao.Update(transaction, partition, binaryNote, container);
        }
        ...
        public bool CreateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var binaryNote = thing as BinaryNote;
            return this.BinaryNoteDao.Write(transaction, partition, binaryNote, sequence, container);
        }
        ...
        {
            var binaryNote = thing as BinaryNote;
            return this.BinaryNoteDao.Upsert(transaction, partition, binaryNote, sequence, container);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="BinaryNote"/>.
        /// </returns>
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var binaryNoteColl = new List<Thing>(this.BinaryNoteDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction), (DateTime)this.TransactionManager.GetRawSessionInstant(transaction)));

            return this.AfterGet(binaryNoteColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="BinaryNote"/> and contained <see cref="Thing"/>s.
        /// </returns>

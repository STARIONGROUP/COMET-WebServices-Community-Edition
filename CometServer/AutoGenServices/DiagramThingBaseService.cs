...
namespace CometServer.Services
{
    ...
    public sealed partial class DiagramThingBaseService : ServiceBase, IDiagramThingBaseService
    {
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="DiagramThingBase"/>, optionally with contained <see cref="Thing"/>s.
        /// </returns>
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="DiagramThingBase"/>.
        /// </returns>
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            diagramThingBaseColl.AddRange(this.BoundsService.GetShallow(transaction, partition, idFilter, authorizedContext));
            diagramThingBaseColl.AddRange(this.ColorService.GetShallow(transaction, partition, idFilter, authorizedContext));
            diagramThingBaseColl.AddRange(this.DiagramElementContainerService.GetShallow(transaction, partition, idFilter, authorizedContext));
            diagramThingBaseColl.AddRange(this.DiagrammingStyleService.GetShallow(transaction, partition, idFilter, authorizedContext));
            diagramThingBaseColl.AddRange(this.PointService.GetShallow(transaction, partition, idFilter, authorizedContext));

            return this.AfterGet(diagramThingBaseColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="DiagramThingBase"/> and contained <see cref="Thing"/>s.
        /// </returns>
        public IEnumerable<Thing> GetDeep(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            results.AddRange(this.BoundsService.GetDeep(transaction, partition, idFilter, containerSecurityContext));
            results.AddRange(this.ColorService.GetDeep(transaction, partition, idFilter, containerSecurityContext));
            results.AddRange(this.DiagramElementContainerService.GetDeep(transaction, partition, idFilter, containerSecurityContext));
            results.AddRange(this.DiagrammingStyleService.GetDeep(transaction, partition, idFilter, containerSecurityContext));
            results.AddRange(this.PointService.GetDeep(transaction, partition, idFilter, containerSecurityContext));
            return results;
        }

// --------------------------------------------------------------------------------------------------------------------
// <copyright file="DiagramThingBaseService.cs" company="Starion Group S.A.">
...
namespace CometServer.Services
{
    ...
    /// <summary>
    /// The <see cref="DiagramThingBase"/> Service which uses the ORM layer to interact with the data model.
    /// </summary>
    public sealed partial class DiagramThingBaseService : ServiceBase, IDiagramThingBaseService
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets or sets the <see cref="IDiagramElementContainerService"/>.
        /// </summary>
        public IDiagramElementContainerService DiagramElementContainerService { get; set; }

        /// <summary>
        /// Gets or sets the <see cref="IDiagrammingStyleService"/>.
        /// </summary>
        public IDiagrammingStyleService DiagrammingStyleService { get; set; }

        /// <summary>
        /// Gets or sets the <see cref="IPointService"/>.
        /// </summary>
        public IPointService PointService { get; set; }

        /// <summary>
        /// Get the requested <see cref="DiagramThingBase"/>s from the ORM layer.
        /// </summary>
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having a list of instances of <see cref="DiagramThingBase"/>, optionally with contained <see cref="Thing"/>s as result.
        /// </returns>
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="DiagramThingBase"/> id that will be the source for each link table record.
        /// </param>
        /// <param name="value">
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="DiagramThingBase"/> id that is the source of the link table records.
        /// </param>
        /// <param name="value">
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="DiagramThingBase"/> id that is the source for the reordered link table record.
        /// </param>
        ...
        /// <summary>
        /// Delete the supplied <see cref="DiagramThingBase"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="DiagramThingBase"/> to delete.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="DiagramThingBase"/> to be removed.
        /// </param>
        /// <returns>
        ...
        /// <summary>
        /// Update the supplied <see cref="DiagramThingBase"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="DiagramThingBase"/> <see cref="Thing"/> to update.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="DiagramThingBase"/> to be updated.
        /// </param>
        /// <returns>
        ...
        public async Task<bool> UpdateConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            var diagramThingBase = thing as DiagramThingBase;
            throw new NotSupportedException(string.Format("The abstract DTO type: {0} cannot be updated.", diagramThingBase.GetType().Name));
        }

        /// <summary>
        /// Persist the supplied <see cref="DiagramThingBase"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="DiagramThingBase"/> <see cref="Thing"/> to create.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="DiagramThingBase"/> to be persisted.
        /// </param>
        /// <param name="sequence">
        ...
        public async Task<bool> CreateConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var diagramThingBase = thing as DiagramThingBase;
            throw new NotSupportedException(string.Format("The abstract DTO type: {0} cannot be created.", diagramThingBase.GetType().Name));
        }

        /// <summary>
        /// Persist the supplied <see cref="DiagramThingBase"/> instance. Update if it already exists.
        /// This is typically used during the import of existing data to the Database.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having List of instances of <see cref="DiagramThingBase"/> as result.
        /// </returns>
        public async Task<IEnumerable<Thing>> GetShallowAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var authorizedContext = this.AuthorizeReadRequest("DiagramThingBase", containerSecurityContext, partition);
            ...
            var diagramThingBaseColl = new List<Thing>();
            diagramThingBaseColl.AddRange(await this.BoundsService.GetShallowAsync(transaction, partition, idFilter, authorizedContext));
            diagramThingBaseColl.AddRange(await this.ColorService.GetShallowAsync(transaction, partition, idFilter, authorizedContext));
            diagramThingBaseColl.AddRange(await this.DiagramElementContainerService.GetShallowAsync(transaction, partition, idFilter, authorizedContext));
            diagramThingBaseColl.AddRange(await this.DiagrammingStyleService.GetShallowAsync(transaction, partition, idFilter, authorizedContext));
            diagramThingBaseColl.AddRange(await this.PointService.GetShallowAsync(transaction, partition, idFilter, authorizedContext));

            return await this.AfterGetAsync(diagramThingBaseColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having List of instances of <see cref="DiagramThingBase"/> and contained <see cref="Thing"/>s as result.
        /// </returns>
        public async Task<IEnumerable<Thing>> GetDeepAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            results.AddRange(await this.BoundsService.GetDeepAsync(transaction, partition, idFilter, containerSecurityContext));
            results.AddRange(await this.ColorService.GetDeepAsync(transaction, partition, idFilter, containerSecurityContext));
            results.AddRange(await this.DiagramElementContainerService.GetDeepAsync(transaction, partition, idFilter, containerSecurityContext));
            results.AddRange(await this.DiagrammingStyleService.GetDeepAsync(transaction, partition, idFilter, containerSecurityContext));
            results.AddRange(await this.PointService.GetDeepAsync(transaction, partition, idFilter, containerSecurityContext));
            return results;
        }

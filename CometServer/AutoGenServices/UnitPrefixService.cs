...
namespace CometServer.Services
{
    ...
    public sealed partial class UnitPrefixService : ServiceBase, IUnitPrefixService
    {
        ...
        {
            return this.UnitPrefixDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.UnitPrefixDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.UnitPrefixDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.UnitPrefixDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

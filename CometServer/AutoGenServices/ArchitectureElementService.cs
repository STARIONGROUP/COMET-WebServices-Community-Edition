// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ArchitectureElementService.cs" company="RHEA System S.A.">
...
namespace CometServer.Services
{
    ...
    /// <summary>
    /// The <see cref="ArchitectureElement"/> Service which uses the ORM layer to interact with the data model.
    /// </summary>
    public sealed partial class ArchitectureElementService : ServiceBase, IArchitectureElementService
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets or sets the <see cref="IArchitectureElementDao"/>.
        /// </summary>
        public IArchitectureElementDao ArchitectureElementDao { get; set; }

        /// <summary>
        /// Get the requested <see cref="ArchitectureElement"/>s from the ORM layer.
        /// </summary>
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="ArchitectureElement"/>, optionally with contained <see cref="Thing"/>s.
        /// </returns>
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="ArchitectureElement"/> id that will be the source for each link table record.
        /// </param>
        /// <param name="value">
        ...
        {
            return this.ArchitectureElementDao.AddToCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="ArchitectureElement"/> id that is the source of the link table records.
        /// </param>
        /// <param name="value">
        ...
        {
            return this.ArchitectureElementDao.DeleteFromCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="ArchitectureElement"/> id that is the source for the reordered link table record.
        /// </param>
        ...
        {
            return this.ArchitectureElementDao.ReorderCollectionProperty(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        /// <summary>
        /// Delete the supplied <see cref="ArchitectureElement"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="ArchitectureElement"/> to delete.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="ArchitectureElement"/> to be removed.
        /// </param>
        /// <returns>
        ...
        public bool DeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.ArchitectureElementDao.Delete(transaction, partition, thing.Iid);
        }
        ...
        public bool RawDeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.ArchitectureElementDao.RawDelete(transaction, partition, thing.Iid);
        }

        /// <summary>
        /// Update the supplied <see cref="ArchitectureElement"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="ArchitectureElement"/> <see cref="Thing"/> to update.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="ArchitectureElement"/> to be updated.
        /// </param>
        /// <returns>
        ...
        public bool UpdateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return this.ArchitectureElementDao.Update(transaction, partition, architectureElement, container);
        }

        /// <summary>
        /// Persist the supplied <see cref="ArchitectureElement"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="ArchitectureElement"/> <see cref="Thing"/> to create.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="ArchitectureElement"/> to be persisted.
        /// </param>
        /// <param name="sequence">
        ...
        public bool CreateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var architectureElement = thing as ArchitectureElement;
            var createSuccesful = this.ArchitectureElementDao.Write(transaction, partition, architectureElement, container);
            return createSuccesful && this.CreateContainment(transaction, partition, architectureElement);
        }

        /// <summary>
        /// Persist the supplied <see cref="ArchitectureElement"/> instance. Update if it already exists.
        /// This is typically used during the import of existing data to the Database.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        ...
        {
            var architectureElement = thing as ArchitectureElement;
            var createSuccesful = this.ArchitectureElementDao.Upsert(transaction, partition, architectureElement, container);
            return createSuccesful && this.UpsertContainment(transaction, partition, architectureElement);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="ArchitectureElement"/>.
        /// </returns>
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var authorizedContext = this.AuthorizeReadRequest("ArchitectureElement", containerSecurityContext, partition);
            ...
            var architectureElementColl = new List<Thing>(this.ArchitectureElementDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction), (DateTime)this.TransactionManager.GetRawSessionInstant(transaction)));

            return this.AfterGet(architectureElementColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="ArchitectureElement"/> and contained <see cref="Thing"/>s.
        /// </returns>
        public IEnumerable<Thing> GetDeep(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var architectureElementColl = results.Where(i => i.GetType() == typeof(ArchitectureElement)).Cast<ArchitectureElement>().ToList();
        ...
        /// <summary>
        /// Persist the <see cref="ArchitectureElement"/> containment tree to the ORM layer.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// The <see cref="ArchitectureElement"/> instance to persist.
        /// </param>
        /// <returns>
        /// True if the persistence was successful.
        /// </returns>
        private bool CreateContainment(NpgsqlTransaction transaction, string partition, ArchitectureElement architectureElement)
        {
            var results = new List<bool>();

            foreach (var bounds in this.ResolveFromRequestCache(architectureElement.Bounds))
            {
                results.Add(this.BoundsService.CreateConcept(transaction, partition, bounds, architectureElement));
            }
        ...
        /// <summary>
        /// Persist the <see cref="ArchitectureElement"/> containment tree to the ORM layer. Update if it already exists.
        /// This is typically used during the import of existing data to the Database.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        ...
        /// True if the persistence was successful.
        /// </returns>
        private bool UpsertContainment(NpgsqlTransaction transaction, string partition, ArchitectureElement architectureElement)
        {
            var results = new List<bool>();

            foreach (var bounds in this.ResolveFromRequestCache(architectureElement.Bounds))
            {
                results.Add(this.BoundsService.UpsertConcept(transaction, partition, bounds, architectureElement));
            }
            ...
            foreach (var localStyle in this.ResolveFromRequestCache(architectureElement.LocalStyle))
            {
                results.Add(this.LocalStyleService.UpsertConcept(transaction, partition, localStyle, architectureElement));
            }

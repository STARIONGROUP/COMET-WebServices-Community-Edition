...
namespace CometServer.Services
{
    ...
    public sealed partial class ParticipantPermissionService : ServiceBase, IParticipantPermissionService
    {
        ...
        public async Task<IEnumerable<Thing>> GetShallowAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var participantPermissionColl = new List<Thing>(await this.ParticipantPermissionDao.ReadAsync(transaction, partition, idFilter, isCachedDtoReadEnabled, sessionInstant));

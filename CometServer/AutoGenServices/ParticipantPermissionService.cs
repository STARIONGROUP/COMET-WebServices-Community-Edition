...
namespace CometServer.Services
{
    ...
    public sealed partial class ParticipantPermissionService : ServiceBase, IParticipantPermissionService
    {
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="ParticipantPermission"/>, optionally with contained <see cref="Thing"/>s.
        /// </returns>
        ...
        {
            return this.ParticipantPermissionDao.AddToCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.ParticipantPermissionDao.DeleteFromCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.ParticipantPermissionDao.ReorderCollectionProperty(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public bool DeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.ParticipantPermissionDao.Delete(transaction, partition, thing.Iid);
        }
        ...
        public bool RawDeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.ParticipantPermissionDao.RawDelete(transaction, partition, thing.Iid);
        }
        ...
        public bool UpdateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return this.ParticipantPermissionDao.Update(transaction, partition, participantPermission, container);
        }
        ...
        public bool CreateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var participantPermission = thing as ParticipantPermission;
            return this.ParticipantPermissionDao.Write(transaction, partition, participantPermission, container);
        }
        ...
        {
            var participantPermission = thing as ParticipantPermission;
            return this.ParticipantPermissionDao.Upsert(transaction, partition, participantPermission, container);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="ParticipantPermission"/>.
        /// </returns>
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var participantPermissionColl = new List<Thing>(this.ParticipantPermissionDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction), (DateTime)this.TransactionManager.GetRawSessionInstant(transaction)));

            return this.AfterGet(participantPermissionColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="ParticipantPermission"/> and contained <see cref="Thing"/>s.
        /// </returns>

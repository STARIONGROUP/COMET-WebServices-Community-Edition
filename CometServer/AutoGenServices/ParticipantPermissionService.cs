...
namespace CometServer.Services
{
    ...
    public sealed partial class ParticipantPermissionService : ServiceBase, IParticipantPermissionService
    {
        ...
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var participantPermissionColl = new List<Thing>(this.ParticipantPermissionDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction)));

...
namespace CometServer.Services
{
    ...
    public sealed partial class ParticipantPermissionService : ServiceBase, IParticipantPermissionService
    {
        ...
        {
            return this.ParticipantPermissionDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.ParticipantPermissionDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.ParticipantPermissionDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.ParticipantPermissionDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

...
namespace CometServer.Services
{
    ...
    public sealed partial class SiteLogEntryService : ServiceBase, ISiteLogEntryService
    {
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="SiteLogEntry"/>, optionally with contained <see cref="Thing"/>s.
        /// </returns>
        ...
        {
            return this.SiteLogEntryDao.AddToCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.SiteLogEntryDao.DeleteFromCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.SiteLogEntryDao.ReorderCollectionProperty(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public bool DeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.SiteLogEntryDao.Delete(transaction, partition, thing.Iid);
        }
        ...
        public bool RawDeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.SiteLogEntryDao.RawDelete(transaction, partition, thing.Iid);
        }
        ...
        public bool UpdateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return this.SiteLogEntryDao.Update(transaction, partition, siteLogEntry, container);
        }
        ...
        {
            var siteLogEntry = thing as SiteLogEntry;
            var createSuccesful = this.SiteLogEntryDao.Upsert(transaction, partition, siteLogEntry, container);
            return createSuccesful && this.UpsertContainment(transaction, partition, siteLogEntry);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="SiteLogEntry"/>.
        /// </returns>
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var siteLogEntryColl = new List<Thing>(this.SiteLogEntryDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction), (DateTime)this.TransactionManager.GetRawSessionInstant(transaction)));

            return this.AfterGet(siteLogEntryColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="SiteLogEntry"/> and contained <see cref="Thing"/>s.
        /// </returns>

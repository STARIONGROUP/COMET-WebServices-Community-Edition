...
namespace CometServer.Services
{
    ...
    public sealed partial class SiteLogEntryService : ServiceBase, ISiteLogEntryService
    {
        ...
        {
            return this.SiteLogEntryDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.SiteLogEntryDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.SiteLogEntryDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.SiteLogEntryDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

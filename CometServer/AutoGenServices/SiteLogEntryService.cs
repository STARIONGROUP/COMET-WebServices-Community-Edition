...
namespace CometServer.Services
{
    ...
    public sealed partial class SiteLogEntryService : ServiceBase, ISiteLogEntryService
    {
        ...
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var siteLogEntryColl = new List<Thing>(this.SiteLogEntryDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction)));

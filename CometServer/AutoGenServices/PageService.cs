...
namespace CometServer.Services
{
    ...
    public sealed partial class PageService : ServiceBase, IPageService
    {
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="Page"/>, optionally with contained <see cref="Thing"/>s.
        /// </returns>
        ...
        {
            return this.PageDao.AddToCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.PageDao.DeleteFromCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.PageDao.ReorderCollectionProperty(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public bool DeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.PageDao.Delete(transaction, partition, thing.Iid);
        }
        ...
        public bool RawDeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.PageDao.RawDelete(transaction, partition, thing.Iid);
        }
        ...
        public bool UpdateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return this.PageDao.Update(transaction, partition, page, container);
        }
        ...
        public bool CreateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var page = thing as Page;
            var createSuccesful = this.PageDao.Write(transaction, partition, page, sequence, container);
            return createSuccesful && this.CreateContainment(transaction, partition, page);
        }
        ...
        {
            var page = thing as Page;
            var createSuccesful = this.PageDao.Upsert(transaction, partition, page, sequence, container);
            return createSuccesful && this.UpsertContainment(transaction, partition, page);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="Page"/>.
        /// </returns>
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var pageColl = new List<Thing>(this.PageDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction), (DateTime)this.TransactionManager.GetRawSessionInstant(transaction)));

            return this.AfterGet(pageColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="Page"/> and contained <see cref="Thing"/>s.
        /// </returns>
        public IEnumerable<Thing> GetDeep(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            results.AddRange(this.NoteService.GetDeep(transaction, partition, pageColl.SelectMany(x => x.Note).ToIdList(), containerSecurityContext));
        ...
        /// True if the persistence was successful.
        /// </returns>
        private bool CreateContainment(NpgsqlTransaction transaction, string partition, Page page)
        {
            var results = new List<bool>();

            foreach (var note in this.ResolveFromRequestCache(page.Note))
            {
                results.Add(this.NoteService.CreateConcept(transaction, partition, (Note)note.V, page, note.K));
            }
        ...
        /// True if the persistence was successful.
        /// </returns>
        private bool UpsertContainment(NpgsqlTransaction transaction, string partition, Page page)
        {
            var results = new List<bool>();

            foreach (var note in this.ResolveFromRequestCache(page.Note))
            {
                results.Add(this.NoteService.UpsertConcept(transaction, partition, (Note)note.V, page, note.K));
            }

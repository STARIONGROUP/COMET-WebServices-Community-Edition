// --------------------------------------------------------------------------------------------------------------------
// <copyright file="RequirementsContainerService.cs" company="Starion Group S.A.">
...
namespace CometServer.Services
{
    ...
    /// <summary>
    /// The <see cref="RequirementsContainer"/> Service which uses the ORM layer to interact with the data model.
    /// </summary>
    public sealed partial class RequirementsContainerService : ServiceBase, IRequirementsContainerService
    {
        /// <summary>
        ...
        /// <summary>
        /// Get the requested <see cref="RequirementsContainer"/>s from the ORM layer.
        /// </summary>
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having a list of instances of <see cref="RequirementsContainer"/>, optionally with contained <see cref="Thing"/>s as result.
        /// </returns>
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="RequirementsContainer"/> id that will be the source for each link table record.
        /// </param>
        /// <param name="value">
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="RequirementsContainer"/> id that is the source of the link table records.
        /// </param>
        /// <param name="value">
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="RequirementsContainer"/> id that is the source for the reordered link table record.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="RequirementsContainer"/> <see cref="Thing"/> to update.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="RequirementsContainer"/> to be updated.
        /// </param>
        /// <returns>
        ...
        public async Task<bool> UpdateConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            throw new NotSupportedException(string.Format("The abstract DTO type: {0} cannot be updated.", requirementsContainer.GetType().Name));
        }

        /// <summary>
        /// Persist the supplied <see cref="RequirementsContainer"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="RequirementsContainer"/> <see cref="Thing"/> to create.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="RequirementsContainer"/> to be persisted.
        /// </param>
        /// <param name="sequence">
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having List of instances of <see cref="RequirementsContainer"/> as result.
        /// </returns>
        public async Task<IEnumerable<Thing>> GetShallowAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var authorizedContext = this.AuthorizeReadRequest("RequirementsContainer", containerSecurityContext, partition);
            ...
            var requirementsContainerColl = new List<Thing>();
            requirementsContainerColl.AddRange(await this.RequirementsGroupService.GetShallowAsync(transaction, partition, idFilter, authorizedContext));
            requirementsContainerColl.AddRange(await this.RequirementsSpecificationService.GetShallowAsync(transaction, partition, idFilter, authorizedContext));

            return await this.AfterGetAsync(requirementsContainerColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having List of instances of <see cref="RequirementsContainer"/> and contained <see cref="Thing"/>s as result.
        /// </returns>
        public async Task<IEnumerable<Thing>> GetDeepAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            results.AddRange(await this.RequirementsGroupService.GetDeepAsync(transaction, partition, idFilter, containerSecurityContext));
            results.AddRange(await this.RequirementsSpecificationService.GetDeepAsync(transaction, partition, idFilter, containerSecurityContext));
            return results;
        }

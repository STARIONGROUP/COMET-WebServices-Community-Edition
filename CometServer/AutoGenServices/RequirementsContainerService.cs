...
namespace CometServer.Services
{
    ...
    public sealed partial class RequirementsContainerService : ServiceBase, IRequirementsContainerService
    {
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="RequirementsContainer"/>, optionally with contained <see cref="Thing"/>s.
        /// </returns>
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="RequirementsContainer"/>.
        /// </returns>
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            requirementsContainerColl.AddRange(this.RequirementsGroupService.GetShallow(transaction, partition, idFilter, authorizedContext));
            requirementsContainerColl.AddRange(this.RequirementsSpecificationService.GetShallow(transaction, partition, idFilter, authorizedContext));

            return this.AfterGet(requirementsContainerColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="RequirementsContainer"/> and contained <see cref="Thing"/>s.
        /// </returns>
        public IEnumerable<Thing> GetDeep(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            results.AddRange(this.RequirementsGroupService.GetDeep(transaction, partition, idFilter, containerSecurityContext));
            results.AddRange(this.RequirementsSpecificationService.GetDeep(transaction, partition, idFilter, containerSecurityContext));
            return results;
        }

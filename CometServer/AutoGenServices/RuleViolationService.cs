...
namespace CometServer.Services
{
    ...
    public sealed partial class RuleViolationService : ServiceBase, IRuleViolationService
    {
        ...
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var ruleViolationColl = new List<Thing>(this.RuleViolationDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction)));

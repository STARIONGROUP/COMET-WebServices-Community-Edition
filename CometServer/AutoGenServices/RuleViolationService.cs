...
namespace CometServer.Services
{
    ...
    public sealed partial class RuleViolationService : ServiceBase, IRuleViolationService
    {
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="RuleViolation"/>, optionally with contained <see cref="Thing"/>s.
        /// </returns>
        ...
        {
            return this.RuleViolationDao.AddToCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.RuleViolationDao.DeleteFromCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.RuleViolationDao.ReorderCollectionProperty(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public bool DeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.RuleViolationDao.Delete(transaction, partition, thing.Iid);
        }
        ...
        public bool RawDeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.RuleViolationDao.RawDelete(transaction, partition, thing.Iid);
        }
        ...
        public bool UpdateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return this.RuleViolationDao.Update(transaction, partition, ruleViolation, container);
        }
        ...
        public bool CreateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var ruleViolation = thing as RuleViolation;
            return this.RuleViolationDao.Write(transaction, partition, ruleViolation, container);
        }
        ...
        {
            var ruleViolation = thing as RuleViolation;
            return this.RuleViolationDao.Upsert(transaction, partition, ruleViolation, container);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="RuleViolation"/>.
        /// </returns>
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var ruleViolationColl = new List<Thing>(this.RuleViolationDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction), (DateTime)this.TransactionManager.GetRawSessionInstant(transaction)));

            return this.AfterGet(ruleViolationColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="RuleViolation"/> and contained <see cref="Thing"/>s.
        /// </returns>

...
namespace CometServer.Services
{
    ...
    public sealed partial class RuleViolationService : ServiceBase, IRuleViolationService
    {
        ...
        {
            return this.RuleViolationDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.RuleViolationDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.RuleViolationDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.RuleViolationDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ParameterTypeComponentService.cs" company="Starion Group S.A.">
...
namespace CometServer.Services
{
    ...
    /// <summary>
    /// The <see cref="ParameterTypeComponent"/> Service which uses the ORM layer to interact with the data model.
    /// </summary>
    public sealed partial class ParameterTypeComponentService : ServiceBase, IParameterTypeComponentService
    {
        /// <summary>
        /// Gets or sets the <see cref="IParameterTypeComponentDao"/>.
        /// </summary>
        public IParameterTypeComponentDao ParameterTypeComponentDao { get; set; }

        /// <summary>
        /// Get the requested <see cref="ParameterTypeComponent"/>s from the ORM layer.
        /// </summary>
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having a list of instances of <see cref="ParameterTypeComponent"/>, optionally with contained <see cref="Thing"/>s as result.
        /// </returns>
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="ParameterTypeComponent"/> id that will be the source for each link table record.
        /// </param>
        /// <param name="value">
        ...
        {
            return await this.ParameterTypeComponentDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="ParameterTypeComponent"/> id that is the source of the link table records.
        /// </param>
        /// <param name="value">
        ...
        {
            return await this.ParameterTypeComponentDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="ParameterTypeComponent"/> id that is the source for the reordered link table record.
        /// </param>
        ...
        {
            return await this.ParameterTypeComponentDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        {
            return await this.ParameterTypeComponentDao.ReorderContainmentAsync(transaction, partition, orderedItem);
        }

        /// <summary>
        /// Delete the supplied <see cref="ParameterTypeComponent"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="ParameterTypeComponent"/> to delete.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="ParameterTypeComponent"/> to be removed.
        /// </param>
        /// <returns>
        ...
        public async Task<bool> DeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return await this.ParameterTypeComponentDao.DeleteAsync(transaction, partition, thing.Iid);
        }
        ...
        public async Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return await this.ParameterTypeComponentDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

        /// <summary>
        /// Update the supplied <see cref="ParameterTypeComponent"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="ParameterTypeComponent"/> <see cref="Thing"/> to update.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="ParameterTypeComponent"/> to be updated.
        /// </param>
        /// <returns>
        ...
        public async Task<bool> UpdateConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return await this.ParameterTypeComponentDao.UpdateAsync(transaction, partition, parameterTypeComponent, container);
        }

        /// <summary>
        /// Persist the supplied <see cref="ParameterTypeComponent"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="ParameterTypeComponent"/> <see cref="Thing"/> to create.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="ParameterTypeComponent"/> to be persisted.
        /// </param>
        /// <param name="sequence">
        ...
        public async Task<bool> CreateConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var parameterTypeComponent = thing as ParameterTypeComponent;
            return await this.ParameterTypeComponentDao.WriteAsync(transaction, partition, parameterTypeComponent, sequence, container);
        }

        /// <summary>
        /// Persist the supplied <see cref="ParameterTypeComponent"/> instance. Update if it already exists.
        /// This is typically used during the import of existing data to the Database.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        ...
        {
            var parameterTypeComponent = thing as ParameterTypeComponent;
            return await this.ParameterTypeComponentDao.UpsertAsync(transaction, partition, parameterTypeComponent, sequence, container);
        }
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having List of instances of <see cref="ParameterTypeComponent"/> as result.
        /// </returns>
        public async Task<IEnumerable<Thing>> GetShallowAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var authorizedContext = this.AuthorizeReadRequest("ParameterTypeComponent", containerSecurityContext, partition);
            ...
            var parameterTypeComponentColl = new List<Thing>(await this.ParameterTypeComponentDao.ReadAsync(transaction, partition, idFilter, await this.TransactionManager.IsCachedDtoReadEnabledAsync(transaction), (DateTime)(await this.TransactionManager.GetRawSessionInstantAsync(transaction))));

            return await this.AfterGetAsync(parameterTypeComponentColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having List of instances of <see cref="ParameterTypeComponent"/> and contained <see cref="Thing"/>s as result.
        /// </returns>

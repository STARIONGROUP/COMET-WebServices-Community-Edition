...
namespace CometServer.Services
{
    ...
    public sealed partial class ParameterTypeComponentService : ServiceBase, IParameterTypeComponentService
    {
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="ParameterTypeComponent"/>, optionally with contained <see cref="Thing"/>s.
        /// </returns>
        ...
        {
            return this.ParameterTypeComponentDao.AddToCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.ParameterTypeComponentDao.DeleteFromCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.ParameterTypeComponentDao.ReorderCollectionProperty(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        {
            return this.ParameterTypeComponentDao.ReorderContainment(transaction, partition, orderedItem);
        }
        ...
        public bool DeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.ParameterTypeComponentDao.Delete(transaction, partition, thing.Iid);
        }
        ...
        public bool RawDeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.ParameterTypeComponentDao.RawDelete(transaction, partition, thing.Iid);
        }
        ...
        public bool UpdateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return this.ParameterTypeComponentDao.Update(transaction, partition, parameterTypeComponent, container);
        }
        ...
        public bool CreateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var parameterTypeComponent = thing as ParameterTypeComponent;
            return this.ParameterTypeComponentDao.Write(transaction, partition, parameterTypeComponent, sequence, container);
        }
        ...
        {
            var parameterTypeComponent = thing as ParameterTypeComponent;
            return this.ParameterTypeComponentDao.Upsert(transaction, partition, parameterTypeComponent, sequence, container);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="ParameterTypeComponent"/>.
        /// </returns>
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var parameterTypeComponentColl = new List<Thing>(this.ParameterTypeComponentDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction), (DateTime)this.TransactionManager.GetRawSessionInstant(transaction)));

            return this.AfterGet(parameterTypeComponentColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="ParameterTypeComponent"/> and contained <see cref="Thing"/>s.
        /// </returns>

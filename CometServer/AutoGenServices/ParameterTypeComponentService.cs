...
namespace CometServer.Services
{
    ...
    public sealed partial class ParameterTypeComponentService : ServiceBase, IParameterTypeComponentService
    {
        ...
        {
            return this.ParameterTypeComponentDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.ParameterTypeComponentDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.ParameterTypeComponentDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        {
            return this.ParameterTypeComponentDao.ReorderContainmentAsync(transaction, partition, orderedItem);
        }
        ...
        public Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.ParameterTypeComponentDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

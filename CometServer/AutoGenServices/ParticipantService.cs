...
namespace CometServer.Services
{
    ...
    public sealed partial class ParticipantService : ServiceBase, IParticipantService
    {
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="Participant"/>, optionally with contained <see cref="Thing"/>s.
        /// </returns>
        ...
        {
            return this.ParticipantDao.AddToCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.ParticipantDao.DeleteFromCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.ParticipantDao.ReorderCollectionProperty(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public bool DeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.ParticipantDao.Delete(transaction, partition, thing.Iid);
        }
        ...
        public bool RawDeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.ParticipantDao.RawDelete(transaction, partition, thing.Iid);
        }
        ...
        public bool UpdateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return this.ParticipantDao.Update(transaction, partition, participant, container);
        }
        ...
        public bool CreateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var participant = thing as Participant;
            return this.ParticipantDao.Write(transaction, partition, participant, container);
        }
        ...
        {
            var participant = thing as Participant;
            return this.ParticipantDao.Upsert(transaction, partition, participant, container);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="Participant"/>.
        /// </returns>
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var participantColl = new List<Thing>(this.ParticipantDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction), (DateTime)this.TransactionManager.GetRawSessionInstant(transaction)));

            return this.AfterGet(participantColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="Participant"/> and contained <see cref="Thing"/>s.
        /// </returns>

...
namespace CometServer.Services
{
    ...
    public sealed partial class ParticipantService : ServiceBase, IParticipantService
    {
        ...
        {
            return this.ParticipantDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.ParticipantDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.ParticipantDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.ParticipantDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

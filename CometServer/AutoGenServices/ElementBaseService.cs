...
namespace CometServer.Services
{
    ...
    public sealed partial class ElementBaseService : ServiceBase, IElementBaseService
    {
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="ElementBase"/>, optionally with contained <see cref="Thing"/>s.
        /// </returns>
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="ElementBase"/>.
        /// </returns>
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            elementBaseColl.AddRange(this.ElementDefinitionService.GetShallow(transaction, partition, idFilter, authorizedContext));
            elementBaseColl.AddRange(this.ElementUsageService.GetShallow(transaction, partition, idFilter, authorizedContext));

            return this.AfterGet(elementBaseColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="ElementBase"/> and contained <see cref="Thing"/>s.
        /// </returns>
        public IEnumerable<Thing> GetDeep(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            results.AddRange(this.ElementDefinitionService.GetDeep(transaction, partition, idFilter, containerSecurityContext));
            results.AddRange(this.ElementUsageService.GetDeep(transaction, partition, idFilter, containerSecurityContext));
            return results;
        }

...
namespace CometServer.Services
{
    ...
    public sealed partial class RatioScaleService : ServiceBase, IRatioScaleService
    {
        ...
        {
            return this.RatioScaleDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.RatioScaleDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.RatioScaleDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.RatioScaleDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }
        ...
        public async Task<IEnumerable<Thing>> GetShallowAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var ratioScaleColl = new List<Thing>(await this.RatioScaleDao.ReadAsync(transaction, partition, idFilter, isCachedDtoReadEnabled, sessionInstant));

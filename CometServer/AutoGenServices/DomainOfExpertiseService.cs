...
namespace CometServer.Services
{
    ...
    public sealed partial class DomainOfExpertiseService : ServiceBase, IDomainOfExpertiseService
    {
        ...
        public async Task<IEnumerable<Thing>> GetShallowAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var domainOfExpertiseColl = new List<Thing>(await this.DomainOfExpertiseDao.ReadAsync(transaction, partition, idFilter, isCachedDtoReadEnabled, sessionInstant));

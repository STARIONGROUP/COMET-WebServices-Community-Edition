...
namespace CometServer.Services
{
    ...
    public sealed partial class ParameterOverrideValueSetService : ServiceBase, IParameterOverrideValueSetService
    {
        ...
        public async Task<IEnumerable<Thing>> GetShallowAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var parameterOverrideValueSetColl = new List<Thing>(await this.ParameterOverrideValueSetDao.ReadAsync(transaction, partition, idFilter, isCachedDtoReadEnabled, sessionInstant));

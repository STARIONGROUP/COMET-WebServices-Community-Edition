...
namespace CometServer.Services
{
    ...
    public sealed partial class ParameterOverrideValueSetService : ServiceBase, IParameterOverrideValueSetService
    {
        ...
        {
            return this.ParameterOverrideValueSetDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.ParameterOverrideValueSetDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.ParameterOverrideValueSetDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.ParameterOverrideValueSetDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

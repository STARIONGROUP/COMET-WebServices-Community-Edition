...
namespace CometServer.Services
{
    ...
    public sealed partial class NotExpressionService : ServiceBase, INotExpressionService
    {
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="NotExpression"/>, optionally with contained <see cref="Thing"/>s.
        /// </returns>
        ...
        {
            return this.NotExpressionDao.AddToCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.NotExpressionDao.DeleteFromCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.NotExpressionDao.ReorderCollectionProperty(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public bool DeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.NotExpressionDao.Delete(transaction, partition, thing.Iid);
        }
        ...
        public bool RawDeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.NotExpressionDao.RawDelete(transaction, partition, thing.Iid);
        }
        ...
        public bool UpdateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return this.NotExpressionDao.Update(transaction, partition, notExpression, container);
        }
        ...
        public bool CreateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var notExpression = thing as NotExpression;
            return this.NotExpressionDao.Write(transaction, partition, notExpression, container);
        }
        ...
        {
            var notExpression = thing as NotExpression;
            return this.NotExpressionDao.Upsert(transaction, partition, notExpression, container);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="NotExpression"/>.
        /// </returns>
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var notExpressionColl = new List<Thing>(this.NotExpressionDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction), (DateTime)this.TransactionManager.GetRawSessionInstant(transaction)));

            return this.AfterGet(notExpressionColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="NotExpression"/> and contained <see cref="Thing"/>s.
        /// </returns>

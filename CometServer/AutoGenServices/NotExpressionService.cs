...
namespace CometServer.Services
{
    ...
    public sealed partial class NotExpressionService : ServiceBase, INotExpressionService
    {
        ...
        {
            return this.NotExpressionDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.NotExpressionDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.NotExpressionDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.NotExpressionDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

...
namespace CometServer.Services
{
    ...
    public sealed partial class BuiltInRuleVerificationService : ServiceBase, IBuiltInRuleVerificationService
    {
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="BuiltInRuleVerification"/>, optionally with contained <see cref="Thing"/>s.
        /// </returns>
        ...
        {
            return this.BuiltInRuleVerificationDao.AddToCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.BuiltInRuleVerificationDao.DeleteFromCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.BuiltInRuleVerificationDao.ReorderCollectionProperty(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public bool DeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.BuiltInRuleVerificationDao.Delete(transaction, partition, thing.Iid);
        }
        ...
        public bool RawDeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.BuiltInRuleVerificationDao.RawDelete(transaction, partition, thing.Iid);
        }
        ...
        public bool UpdateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return this.BuiltInRuleVerificationDao.Update(transaction, partition, builtInRuleVerification, container);
        }
        ...
        public bool CreateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var builtInRuleVerification = thing as BuiltInRuleVerification;
            var createSuccesful = this.BuiltInRuleVerificationDao.Write(transaction, partition, builtInRuleVerification, sequence, container);
            return createSuccesful && this.CreateContainment(transaction, partition, builtInRuleVerification);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="BuiltInRuleVerification"/>.
        /// </returns>
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var builtInRuleVerificationColl = new List<Thing>(this.BuiltInRuleVerificationDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction), (DateTime)this.TransactionManager.GetRawSessionInstant(transaction)));

            return this.AfterGet(builtInRuleVerificationColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="BuiltInRuleVerification"/> and contained <see cref="Thing"/>s.
        /// </returns>
        ...
        /// True if the persistence was successful.
        /// </returns>
        private bool CreateContainment(NpgsqlTransaction transaction, string partition, BuiltInRuleVerification builtInRuleVerification)
        {

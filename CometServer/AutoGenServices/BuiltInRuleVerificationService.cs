// --------------------------------------------------------------------------------------------------------------------
// <copyright file="BuiltInRuleVerificationService.cs" company="Starion Group S.A.">
...
namespace CometServer.Services
{
    ...
    /// <summary>
    /// The <see cref="BuiltInRuleVerification"/> Service which uses the ORM layer to interact with the data model.
    /// </summary>
    public sealed partial class BuiltInRuleVerificationService : ServiceBase, IBuiltInRuleVerificationService
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets or sets the <see cref="IBuiltInRuleVerificationDao"/>.
        /// </summary>
        public IBuiltInRuleVerificationDao BuiltInRuleVerificationDao { get; set; }

        /// <summary>
        /// Get the requested <see cref="BuiltInRuleVerification"/>s from the ORM layer.
        /// </summary>
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having a list of instances of <see cref="BuiltInRuleVerification"/>, optionally with contained <see cref="Thing"/>s as result.
        /// </returns>
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="BuiltInRuleVerification"/> id that will be the source for each link table record.
        /// </param>
        /// <param name="value">
        ...
        {
            return await this.BuiltInRuleVerificationDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="BuiltInRuleVerification"/> id that is the source of the link table records.
        /// </param>
        /// <param name="value">
        ...
        {
            return await this.BuiltInRuleVerificationDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="BuiltInRuleVerification"/> id that is the source for the reordered link table record.
        /// </param>
        ...
        {
            return await this.BuiltInRuleVerificationDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        /// <summary>
        /// Delete the supplied <see cref="BuiltInRuleVerification"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="BuiltInRuleVerification"/> to delete.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="BuiltInRuleVerification"/> to be removed.
        /// </param>
        /// <returns>
        ...
        public async Task<bool> DeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return await this.BuiltInRuleVerificationDao.DeleteAsync(transaction, partition, thing.Iid);
        }
        ...
        public async Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return await this.BuiltInRuleVerificationDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

        /// <summary>
        /// Update the supplied <see cref="BuiltInRuleVerification"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="BuiltInRuleVerification"/> <see cref="Thing"/> to update.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="BuiltInRuleVerification"/> to be updated.
        /// </param>
        /// <returns>
        ...
        public async Task<bool> UpdateConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return await this.BuiltInRuleVerificationDao.UpdateAsync(transaction, partition, builtInRuleVerification, container);
        }

        /// <summary>
        /// Persist the supplied <see cref="BuiltInRuleVerification"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        public async Task<bool> CreateConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var builtInRuleVerification = thing as BuiltInRuleVerification;
            var createSuccesful = await this.BuiltInRuleVerificationDao.WriteAsync(transaction, partition, builtInRuleVerification, sequence, container);
            return createSuccesful && await this.CreateContainmentAsync(transaction, partition, builtInRuleVerification);
        }
        ...
        {
            var builtInRuleVerification = thing as BuiltInRuleVerification;
            var createSuccesful = await this.BuiltInRuleVerificationDao.UpsertAsync(transaction, partition, builtInRuleVerification, sequence, container);
            return createSuccesful && await this.UpsertContainmentAsync(transaction, partition, builtInRuleVerification);
        }
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having List of instances of <see cref="BuiltInRuleVerification"/> as result.
        /// </returns>
        public async Task<IEnumerable<Thing>> GetShallowAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var authorizedContext = this.AuthorizeReadRequest("BuiltInRuleVerification", containerSecurityContext, partition);
            ...
            var builtInRuleVerificationColl = new List<Thing>(await this.BuiltInRuleVerificationDao.ReadAsync(transaction, partition, idFilter, await this.TransactionManager.IsCachedDtoReadEnabledAsync(transaction), (DateTime)(await this.TransactionManager.GetRawSessionInstantAsync(transaction))));

            return await this.AfterGetAsync(builtInRuleVerificationColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having List of instances of <see cref="BuiltInRuleVerification"/> and contained <see cref="Thing"/>s as result.
        /// </returns>
        public async Task<IEnumerable<Thing>> GetDeepAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            results.AddRange(await this.ViolationService.GetDeepAsync(transaction, partition, builtInRuleVerificationColl.SelectMany(x => x.Violation), containerSecurityContext));
        ...
        /// <summary>
        /// Persist the <see cref="BuiltInRuleVerification"/> containment tree to the ORM layer.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// An awaitable <see cref="Task"/> having True if the persistence was successful as result.
        /// </returns>
        private async Task<bool> CreateContainmentAsync(NpgsqlTransaction transaction, string partition, BuiltInRuleVerification builtInRuleVerification)
        {
            var results = new List<bool>();

            foreach (var violation in this.ResolveFromRequestCache(builtInRuleVerification.Violation))
            {
                results.Add(await this.ViolationService.CreateConceptAsync(transaction, partition, violation, builtInRuleVerification));
            }
        ...
        /// An awaitable <see cref="Task"/> having True if the persistence was successful as result.
        /// </returns>
        private async Task<bool> UpsertContainmentAsync(NpgsqlTransaction transaction, string partition, BuiltInRuleVerification builtInRuleVerification)
        {
            var results = new List<bool>();

            foreach (var violation in this.ResolveFromRequestCache(builtInRuleVerification.Violation))
            {
                results.Add(await this.ViolationService.UpsertConceptAsync(transaction, partition, violation, builtInRuleVerification));
            }

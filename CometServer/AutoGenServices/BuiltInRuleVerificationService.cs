...
namespace CometServer.Services
{
    ...
    public sealed partial class BuiltInRuleVerificationService : ServiceBase, IBuiltInRuleVerificationService
    {
        ...
        {
            return this.BuiltInRuleVerificationDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.BuiltInRuleVerificationDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.BuiltInRuleVerificationDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.BuiltInRuleVerificationDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

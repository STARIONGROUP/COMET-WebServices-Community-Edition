...
namespace CometServer.Services
{
    ...
    public sealed partial class DateParameterTypeService : ServiceBase, IDateParameterTypeService
    {
        ...
        public async Task<IEnumerable<Thing>> GetShallowAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var dateParameterTypeColl = new List<Thing>(await this.DateParameterTypeDao.ReadAsync(transaction, partition, idFilter, isCachedDtoReadEnabled, sessionInstant));

...
namespace CometServer.Services
{
    ...
    public sealed partial class DateParameterTypeService : ServiceBase, IDateParameterTypeService
    {
        ...
        {
            return this.DateParameterTypeDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.DateParameterTypeDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.DateParameterTypeDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.DateParameterTypeDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

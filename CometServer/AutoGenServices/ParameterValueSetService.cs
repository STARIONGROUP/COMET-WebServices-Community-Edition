...
namespace CometServer.Services
{
    ...
    public sealed partial class ParameterValueSetService : ServiceBase, IParameterValueSetService
    {
        ...
        {
            return this.ParameterValueSetDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.ParameterValueSetDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.ParameterValueSetDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.ParameterValueSetDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

...
namespace CometServer.Services
{
    ...
    public sealed partial class ParameterValueSetService : ServiceBase, IParameterValueSetService
    {
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="ParameterValueSet"/>, optionally with contained <see cref="Thing"/>s.
        /// </returns>
        ...
        {
            return this.ParameterValueSetDao.AddToCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.ParameterValueSetDao.DeleteFromCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.ParameterValueSetDao.ReorderCollectionProperty(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public bool DeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.ParameterValueSetDao.Delete(transaction, partition, thing.Iid);
        }
        ...
        public bool RawDeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.ParameterValueSetDao.RawDelete(transaction, partition, thing.Iid);
        }
        ...
        public bool UpdateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return this.ParameterValueSetDao.Update(transaction, partition, parameterValueSet, container);
        }
        ...
        public bool CreateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var parameterValueSet = thing as ParameterValueSet;
            return this.ParameterValueSetDao.Write(transaction, partition, parameterValueSet, container);
        }
        ...
        {
            var parameterValueSet = thing as ParameterValueSet;
            return this.ParameterValueSetDao.Upsert(transaction, partition, parameterValueSet, container);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="ParameterValueSet"/>.
        /// </returns>
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var parameterValueSetColl = new List<Thing>(this.ParameterValueSetDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction), (DateTime)this.TransactionManager.GetRawSessionInstant(transaction)));

            return this.AfterGet(parameterValueSetColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="ParameterValueSet"/> and contained <see cref="Thing"/>s.
        /// </returns>

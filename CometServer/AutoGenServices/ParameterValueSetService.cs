...
namespace CometServer.Services
{
    ...
    public sealed partial class ParameterValueSetService : ServiceBase, IParameterValueSetService
    {
        ...
        public async Task<IEnumerable<Thing>> GetShallowAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var parameterValueSetColl = new List<Thing>(await this.ParameterValueSetDao.ReadAsync(transaction, partition, idFilter, isCachedDtoReadEnabled, sessionInstant));

...
namespace CometServer.Services
{
    ...
    public sealed partial class ExclusiveOrExpressionService : ServiceBase, IExclusiveOrExpressionService
    {
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="ExclusiveOrExpression"/>, optionally with contained <see cref="Thing"/>s.
        /// </returns>
        ...
        {
            return this.ExclusiveOrExpressionDao.AddToCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.ExclusiveOrExpressionDao.DeleteFromCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.ExclusiveOrExpressionDao.ReorderCollectionProperty(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public bool DeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.ExclusiveOrExpressionDao.Delete(transaction, partition, thing.Iid);
        }
        ...
        public bool RawDeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.ExclusiveOrExpressionDao.RawDelete(transaction, partition, thing.Iid);
        }
        ...
        public bool UpdateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return this.ExclusiveOrExpressionDao.Update(transaction, partition, exclusiveOrExpression, container);
        }
        ...
        public bool CreateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var exclusiveOrExpression = thing as ExclusiveOrExpression;
            return this.ExclusiveOrExpressionDao.Write(transaction, partition, exclusiveOrExpression, container);
        }
        ...
        {
            var exclusiveOrExpression = thing as ExclusiveOrExpression;
            return this.ExclusiveOrExpressionDao.Upsert(transaction, partition, exclusiveOrExpression, container);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="ExclusiveOrExpression"/>.
        /// </returns>
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var exclusiveOrExpressionColl = new List<Thing>(this.ExclusiveOrExpressionDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction), (DateTime)this.TransactionManager.GetRawSessionInstant(transaction)));

            return this.AfterGet(exclusiveOrExpressionColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="ExclusiveOrExpression"/> and contained <see cref="Thing"/>s.
        /// </returns>

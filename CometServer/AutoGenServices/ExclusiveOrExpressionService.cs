...
namespace CometServer.Services
{
    ...
    public sealed partial class ExclusiveOrExpressionService : ServiceBase, IExclusiveOrExpressionService
    {
        ...
        public async Task<IEnumerable<Thing>> GetShallowAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var exclusiveOrExpressionColl = new List<Thing>(await this.ExclusiveOrExpressionDao.ReadAsync(transaction, partition, idFilter, isCachedDtoReadEnabled, sessionInstant));

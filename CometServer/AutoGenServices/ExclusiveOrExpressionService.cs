...
namespace CometServer.Services
{
    ...
    public sealed partial class ExclusiveOrExpressionService : ServiceBase, IExclusiveOrExpressionService
    {
        ...
        {
            return this.ExclusiveOrExpressionDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.ExclusiveOrExpressionDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.ExclusiveOrExpressionDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.ExclusiveOrExpressionDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

...
namespace CometServer.Services
{
    ...
    public sealed partial class ScaleReferenceQuantityValueService : ServiceBase, IScaleReferenceQuantityValueService
    {
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="ScaleReferenceQuantityValue"/>, optionally with contained <see cref="Thing"/>s.
        /// </returns>
        ...
        {
            return this.ScaleReferenceQuantityValueDao.AddToCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.ScaleReferenceQuantityValueDao.DeleteFromCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.ScaleReferenceQuantityValueDao.ReorderCollectionProperty(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public bool DeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.ScaleReferenceQuantityValueDao.Delete(transaction, partition, thing.Iid);
        }
        ...
        public bool RawDeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.ScaleReferenceQuantityValueDao.RawDelete(transaction, partition, thing.Iid);
        }
        ...
        public bool UpdateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return this.ScaleReferenceQuantityValueDao.Update(transaction, partition, scaleReferenceQuantityValue, container);
        }
        ...
        public bool CreateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var scaleReferenceQuantityValue = thing as ScaleReferenceQuantityValue;
            return this.ScaleReferenceQuantityValueDao.Write(transaction, partition, scaleReferenceQuantityValue, container);
        }
        ...
        {
            var scaleReferenceQuantityValue = thing as ScaleReferenceQuantityValue;
            return this.ScaleReferenceQuantityValueDao.Upsert(transaction, partition, scaleReferenceQuantityValue, container);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="ScaleReferenceQuantityValue"/>.
        /// </returns>
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var scaleReferenceQuantityValueColl = new List<Thing>(this.ScaleReferenceQuantityValueDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction), (DateTime)this.TransactionManager.GetRawSessionInstant(transaction)));

            return this.AfterGet(scaleReferenceQuantityValueColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="ScaleReferenceQuantityValue"/> and contained <see cref="Thing"/>s.
        /// </returns>

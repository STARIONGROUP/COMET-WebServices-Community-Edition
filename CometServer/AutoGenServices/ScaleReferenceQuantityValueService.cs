...
namespace CometServer.Services
{
    ...
    public sealed partial class ScaleReferenceQuantityValueService : ServiceBase, IScaleReferenceQuantityValueService
    {
        ...
        public async Task<IEnumerable<Thing>> GetShallowAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var scaleReferenceQuantityValueColl = new List<Thing>(await this.ScaleReferenceQuantityValueDao.ReadAsync(transaction, partition, idFilter, isCachedDtoReadEnabled, sessionInstant));

// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ScaleReferenceQuantityValueService.cs" company="Starion Group S.A.">
...
namespace CometServer.Services
{
    ...
    /// <summary>
    /// The <see cref="ScaleReferenceQuantityValue"/> Service which uses the ORM layer to interact with the data model.
    /// </summary>
    public sealed partial class ScaleReferenceQuantityValueService : ServiceBase, IScaleReferenceQuantityValueService
    {
        /// <summary>
        /// Gets or sets the <see cref="IScaleReferenceQuantityValueDao"/>.
        /// </summary>
        public IScaleReferenceQuantityValueDao ScaleReferenceQuantityValueDao { get; set; }

        /// <summary>
        /// Get the requested <see cref="ScaleReferenceQuantityValue"/>s from the ORM layer.
        /// </summary>
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having a list of instances of <see cref="ScaleReferenceQuantityValue"/>, optionally with contained <see cref="Thing"/>s as result.
        /// </returns>
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="ScaleReferenceQuantityValue"/> id that will be the source for each link table record.
        /// </param>
        /// <param name="value">
        ...
        {
            return await this.ScaleReferenceQuantityValueDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="ScaleReferenceQuantityValue"/> id that is the source of the link table records.
        /// </param>
        /// <param name="value">
        ...
        {
            return await this.ScaleReferenceQuantityValueDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="ScaleReferenceQuantityValue"/> id that is the source for the reordered link table record.
        /// </param>
        ...
        {
            return await this.ScaleReferenceQuantityValueDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        /// <summary>
        /// Delete the supplied <see cref="ScaleReferenceQuantityValue"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="ScaleReferenceQuantityValue"/> to delete.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="ScaleReferenceQuantityValue"/> to be removed.
        /// </param>
        /// <returns>
        ...
        public async Task<bool> DeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return await this.ScaleReferenceQuantityValueDao.DeleteAsync(transaction, partition, thing.Iid);
        }
        ...
        public async Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return await this.ScaleReferenceQuantityValueDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

        /// <summary>
        /// Update the supplied <see cref="ScaleReferenceQuantityValue"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="ScaleReferenceQuantityValue"/> <see cref="Thing"/> to update.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="ScaleReferenceQuantityValue"/> to be updated.
        /// </param>
        /// <returns>
        ...
        public async Task<bool> UpdateConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return await this.ScaleReferenceQuantityValueDao.UpdateAsync(transaction, partition, scaleReferenceQuantityValue, container);
        }

        /// <summary>
        /// Persist the supplied <see cref="ScaleReferenceQuantityValue"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="ScaleReferenceQuantityValue"/> <see cref="Thing"/> to create.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="ScaleReferenceQuantityValue"/> to be persisted.
        /// </param>
        /// <param name="sequence">
        ...
        public async Task<bool> CreateConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var scaleReferenceQuantityValue = thing as ScaleReferenceQuantityValue;
            return await this.ScaleReferenceQuantityValueDao.WriteAsync(transaction, partition, scaleReferenceQuantityValue, container);
        }

        /// <summary>
        /// Persist the supplied <see cref="ScaleReferenceQuantityValue"/> instance. Update if it already exists.
        /// This is typically used during the import of existing data to the Database.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        ...
        {
            var scaleReferenceQuantityValue = thing as ScaleReferenceQuantityValue;
            return await this.ScaleReferenceQuantityValueDao.UpsertAsync(transaction, partition, scaleReferenceQuantityValue, container);
        }
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having List of instances of <see cref="ScaleReferenceQuantityValue"/> as result.
        /// </returns>
        public async Task<IEnumerable<Thing>> GetShallowAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var authorizedContext = this.AuthorizeReadRequest("ScaleReferenceQuantityValue", containerSecurityContext, partition);
            ...
            var scaleReferenceQuantityValueColl = new List<Thing>(await this.ScaleReferenceQuantityValueDao.ReadAsync(transaction, partition, idFilter, await this.TransactionManager.IsCachedDtoReadEnabledAsync(transaction), (DateTime)(await this.TransactionManager.GetRawSessionInstantAsync(transaction))));

            return await this.AfterGetAsync(scaleReferenceQuantityValueColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having List of instances of <see cref="ScaleReferenceQuantityValue"/> and contained <see cref="Thing"/>s as result.
        /// </returns>

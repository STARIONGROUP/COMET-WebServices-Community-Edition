...
namespace CometServer.Services
{
    ...
    public sealed partial class DiagramCanvasService : ServiceBase, IDiagramCanvasService
    {
        ...
        {
            return this.DiagramCanvasDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.DiagramCanvasDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.DiagramCanvasDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.DiagramCanvasDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

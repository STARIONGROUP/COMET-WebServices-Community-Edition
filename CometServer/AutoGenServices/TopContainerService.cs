...
namespace CometServer.Services
{
    ...
    public sealed partial class TopContainerService : ServiceBase, ITopContainerService
    {
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="TopContainer"/>, optionally with contained <see cref="Thing"/>s.
        /// </returns>
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="TopContainer"/>.
        /// </returns>
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            topContainerColl.AddRange(this.EngineeringModelService.GetShallow(transaction, partition, idFilter, authorizedContext));
            topContainerColl.AddRange(this.SiteDirectoryService.GetShallow(transaction, partition, idFilter, authorizedContext));

            return this.AfterGet(topContainerColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="TopContainer"/> and contained <see cref="Thing"/>s.
        /// </returns>
        public IEnumerable<Thing> GetDeep(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            results.AddRange(this.EngineeringModelService.GetDeep(transaction, partition, idFilter, containerSecurityContext));
            results.AddRange(this.SiteDirectoryService.GetDeep(transaction, partition, idFilter, containerSecurityContext));
            return results;
        }

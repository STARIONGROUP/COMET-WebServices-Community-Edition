...
namespace CometServer.Services
{
    ...
    public sealed partial class CommonFileStoreService : ServiceBase, ICommonFileStoreService
    {
        ...
        {
            return this.CommonFileStoreDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.CommonFileStoreDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.CommonFileStoreDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.CommonFileStoreDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }
        ...
        public async Task<IEnumerable<Thing>> GetShallowAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var commonFileStoreColl = new List<Thing>(await this.CommonFileStoreDao.ReadAsync(transaction, partition, idFilter, isCachedDtoReadEnabled, sessionInstant));

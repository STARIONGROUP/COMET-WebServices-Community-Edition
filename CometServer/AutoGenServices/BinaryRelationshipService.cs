...
namespace CometServer.Services
{
    ...
    public sealed partial class BinaryRelationshipService : ServiceBase, IBinaryRelationshipService
    {
        ...
        public async Task<IEnumerable<Thing>> GetShallowAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var binaryRelationshipColl = new List<Thing>(await this.BinaryRelationshipDao.ReadAsync(transaction, partition, idFilter, isCachedDtoReadEnabled, sessionInstant));

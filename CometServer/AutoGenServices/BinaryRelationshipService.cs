// --------------------------------------------------------------------------------------------------------------------
// <copyright file="BinaryRelationshipService.cs" company="Starion Group S.A.">
...
namespace CometServer.Services
{
    ...
    /// <summary>
    /// The <see cref="BinaryRelationship"/> Service which uses the ORM layer to interact with the data model.
    /// </summary>
    public sealed partial class BinaryRelationshipService : ServiceBase, IBinaryRelationshipService
    {
        /// <summary>
        /// Gets or sets the <see cref="IRelationshipParameterValueService"/>.
        /// </summary>
        public IRelationshipParameterValueService ParameterValueService { get; set; }

        /// <summary>
        /// Gets or sets the <see cref="IBinaryRelationshipDao"/>.
        /// </summary>
        public IBinaryRelationshipDao BinaryRelationshipDao { get; set; }

        /// <summary>
        /// Get the requested <see cref="BinaryRelationship"/>s from the ORM layer.
        /// </summary>
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having a list of instances of <see cref="BinaryRelationship"/>, optionally with contained <see cref="Thing"/>s as result.
        /// </returns>
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="BinaryRelationship"/> id that will be the source for each link table record.
        /// </param>
        /// <param name="value">
        ...
        {
            return await this.BinaryRelationshipDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="BinaryRelationship"/> id that is the source of the link table records.
        /// </param>
        /// <param name="value">
        ...
        {
            return await this.BinaryRelationshipDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="BinaryRelationship"/> id that is the source for the reordered link table record.
        /// </param>
        ...
        {
            return await this.BinaryRelationshipDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        /// <summary>
        /// Delete the supplied <see cref="BinaryRelationship"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="BinaryRelationship"/> to delete.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="BinaryRelationship"/> to be removed.
        /// </param>
        /// <returns>
        ...
        public async Task<bool> DeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return await this.BinaryRelationshipDao.DeleteAsync(transaction, partition, thing.Iid);
        }
        ...
        public async Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return await this.BinaryRelationshipDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

        /// <summary>
        /// Update the supplied <see cref="BinaryRelationship"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="BinaryRelationship"/> <see cref="Thing"/> to update.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="BinaryRelationship"/> to be updated.
        /// </param>
        /// <returns>
        ...
        public async Task<bool> UpdateConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return await this.BinaryRelationshipDao.UpdateAsync(transaction, partition, binaryRelationship, container);
        }

        /// <summary>
        /// Persist the supplied <see cref="BinaryRelationship"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="BinaryRelationship"/> <see cref="Thing"/> to create.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="BinaryRelationship"/> to be persisted.
        /// </param>
        /// <param name="sequence">
        ...
        public async Task<bool> CreateConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var binaryRelationship = thing as BinaryRelationship;
            var createSuccesful = await this.BinaryRelationshipDao.WriteAsync(transaction, partition, binaryRelationship, container);
            return createSuccesful && await this.CreateContainmentAsync(transaction, partition, binaryRelationship);
        }

        /// <summary>
        /// Persist the supplied <see cref="BinaryRelationship"/> instance. Update if it already exists.
        /// This is typically used during the import of existing data to the Database.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        ...
        {
            var binaryRelationship = thing as BinaryRelationship;
            var createSuccesful = await this.BinaryRelationshipDao.UpsertAsync(transaction, partition, binaryRelationship, container);
            return createSuccesful && await this.UpsertContainmentAsync(transaction, partition, binaryRelationship);
        }
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having List of instances of <see cref="BinaryRelationship"/> as result.
        /// </returns>
        public async Task<IEnumerable<Thing>> GetShallowAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var authorizedContext = this.AuthorizeReadRequest("BinaryRelationship", containerSecurityContext, partition);
            ...
            var binaryRelationshipColl = new List<Thing>(await this.BinaryRelationshipDao.ReadAsync(transaction, partition, idFilter, await this.TransactionManager.IsCachedDtoReadEnabledAsync(transaction), (DateTime)(await this.TransactionManager.GetRawSessionInstantAsync(transaction))));

            return await this.AfterGetAsync(binaryRelationshipColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having List of instances of <see cref="BinaryRelationship"/> and contained <see cref="Thing"/>s as result.
        /// </returns>
        public async Task<IEnumerable<Thing>> GetDeepAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            results.AddRange(await this.ParameterValueService.GetDeepAsync(transaction, partition, binaryRelationshipColl.SelectMany(x => x.ParameterValue), containerSecurityContext));
        ...
        /// <summary>
        /// Persist the <see cref="BinaryRelationship"/> containment tree to the ORM layer.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// The <see cref="BinaryRelationship"/> instance to persist.
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having True if the persistence was successful as result.
        /// </returns>
        private async Task<bool> CreateContainmentAsync(NpgsqlTransaction transaction, string partition, BinaryRelationship binaryRelationship)
        {
            var results = new List<bool>();

            foreach (var parameterValue in this.ResolveFromRequestCache(binaryRelationship.ParameterValue))
            {
                results.Add(await this.ParameterValueService.CreateConceptAsync(transaction, partition, parameterValue, binaryRelationship));
            }
        ...
        /// <summary>
        /// Persist the <see cref="BinaryRelationship"/> containment tree to the ORM layer. Update if it already exists.
        /// This is typically used during the import of existing data to the Database.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        ...
        /// An awaitable <see cref="Task"/> having True if the persistence was successful as result.
        /// </returns>
        private async Task<bool> UpsertContainmentAsync(NpgsqlTransaction transaction, string partition, BinaryRelationship binaryRelationship)
        {
            var results = new List<bool>();

            foreach (var parameterValue in this.ResolveFromRequestCache(binaryRelationship.ParameterValue))
            {
                results.Add(await this.ParameterValueService.UpsertConceptAsync(transaction, partition, parameterValue, binaryRelationship));
            }

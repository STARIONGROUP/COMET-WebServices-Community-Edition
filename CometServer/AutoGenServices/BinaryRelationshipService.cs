...
namespace CometServer.Services
{
    ...
    public sealed partial class BinaryRelationshipService : ServiceBase, IBinaryRelationshipService
    {
        ...
        {
            return this.BinaryRelationshipDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.BinaryRelationshipDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.BinaryRelationshipDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.BinaryRelationshipDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

...
namespace CometServer.Services
{
    ...
    public sealed partial class BinaryRelationshipService : ServiceBase, IBinaryRelationshipService
    {
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="BinaryRelationship"/>, optionally with contained <see cref="Thing"/>s.
        /// </returns>
        ...
        {
            return this.BinaryRelationshipDao.AddToCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.BinaryRelationshipDao.DeleteFromCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.BinaryRelationshipDao.ReorderCollectionProperty(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public bool DeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.BinaryRelationshipDao.Delete(transaction, partition, thing.Iid);
        }
        ...
        public bool RawDeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.BinaryRelationshipDao.RawDelete(transaction, partition, thing.Iid);
        }
        ...
        public bool UpdateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return this.BinaryRelationshipDao.Update(transaction, partition, binaryRelationship, container);
        }
        ...
        public bool CreateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var binaryRelationship = thing as BinaryRelationship;
            var createSuccesful = this.BinaryRelationshipDao.Write(transaction, partition, binaryRelationship, container);
            return createSuccesful && this.CreateContainment(transaction, partition, binaryRelationship);
        }
        ...
        {
            var binaryRelationship = thing as BinaryRelationship;
            var createSuccesful = this.BinaryRelationshipDao.Upsert(transaction, partition, binaryRelationship, container);
            return createSuccesful && this.UpsertContainment(transaction, partition, binaryRelationship);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="BinaryRelationship"/>.
        /// </returns>
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var binaryRelationshipColl = new List<Thing>(this.BinaryRelationshipDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction), (DateTime)this.TransactionManager.GetRawSessionInstant(transaction)));

            return this.AfterGet(binaryRelationshipColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="BinaryRelationship"/> and contained <see cref="Thing"/>s.
        /// </returns>
        ...
        /// True if the persistence was successful.
        /// </returns>
        private bool CreateContainment(NpgsqlTransaction transaction, string partition, BinaryRelationship binaryRelationship)
        {
            var results = new List<bool>();

            foreach (var parameterValue in this.ResolveFromRequestCache(binaryRelationship.ParameterValue))
            {
                results.Add(this.ParameterValueService.CreateConcept(transaction, partition, parameterValue, binaryRelationship));
            }
        ...
        /// True if the persistence was successful.
        /// </returns>
        private bool UpsertContainment(NpgsqlTransaction transaction, string partition, BinaryRelationship binaryRelationship)
        {
            var results = new List<bool>();

            foreach (var parameterValue in this.ResolveFromRequestCache(binaryRelationship.ParameterValue))
            {
                results.Add(this.ParameterValueService.UpsertConcept(transaction, partition, parameterValue, binaryRelationship));
            }

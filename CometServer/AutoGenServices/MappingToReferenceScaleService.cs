...
namespace CometServer.Services
{
    ...
    public sealed partial class MappingToReferenceScaleService : ServiceBase, IMappingToReferenceScaleService
    {
        ...
        public async Task<IEnumerable<Thing>> GetShallowAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var mappingToReferenceScaleColl = new List<Thing>(await this.MappingToReferenceScaleDao.ReadAsync(transaction, partition, idFilter, isCachedDtoReadEnabled, sessionInstant));

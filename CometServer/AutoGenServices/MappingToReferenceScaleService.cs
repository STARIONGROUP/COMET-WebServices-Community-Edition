...
namespace CometServer.Services
{
    ...
    public sealed partial class MappingToReferenceScaleService : ServiceBase, IMappingToReferenceScaleService
    {
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="MappingToReferenceScale"/>, optionally with contained <see cref="Thing"/>s.
        /// </returns>
        ...
        {
            return this.MappingToReferenceScaleDao.AddToCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.MappingToReferenceScaleDao.DeleteFromCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.MappingToReferenceScaleDao.ReorderCollectionProperty(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public bool DeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.MappingToReferenceScaleDao.Delete(transaction, partition, thing.Iid);
        }
        ...
        public bool RawDeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.MappingToReferenceScaleDao.RawDelete(transaction, partition, thing.Iid);
        }
        ...
        public bool UpdateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return this.MappingToReferenceScaleDao.Update(transaction, partition, mappingToReferenceScale, container);
        }
        ...
        public bool CreateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var mappingToReferenceScale = thing as MappingToReferenceScale;
            return this.MappingToReferenceScaleDao.Write(transaction, partition, mappingToReferenceScale, container);
        }
        ...
        {
            var mappingToReferenceScale = thing as MappingToReferenceScale;
            return this.MappingToReferenceScaleDao.Upsert(transaction, partition, mappingToReferenceScale, container);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="MappingToReferenceScale"/>.
        /// </returns>
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var mappingToReferenceScaleColl = new List<Thing>(this.MappingToReferenceScaleDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction), (DateTime)this.TransactionManager.GetRawSessionInstant(transaction)));

            return this.AfterGet(mappingToReferenceScaleColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="MappingToReferenceScale"/> and contained <see cref="Thing"/>s.
        /// </returns>

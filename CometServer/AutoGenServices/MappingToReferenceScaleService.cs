...
namespace CometServer.Services
{
    ...
    public sealed partial class MappingToReferenceScaleService : ServiceBase, IMappingToReferenceScaleService
    {
        ...
        {
            return this.MappingToReferenceScaleDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.MappingToReferenceScaleDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.MappingToReferenceScaleDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.MappingToReferenceScaleDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

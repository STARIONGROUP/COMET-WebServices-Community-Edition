...
namespace CometServer.Services
{
    ...
    public sealed partial class SimpleQuantityKindService : ServiceBase, ISimpleQuantityKindService
    {
        ...
        public async Task<IEnumerable<Thing>> GetShallowAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var simpleQuantityKindColl = new List<Thing>(await this.SimpleQuantityKindDao.ReadAsync(transaction, partition, idFilter, isCachedDtoReadEnabled, sessionInstant));

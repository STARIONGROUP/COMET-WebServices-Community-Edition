...
namespace CometServer.Services
{
    ...
    public sealed partial class GlossaryService : ServiceBase, IGlossaryService
    {
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="Glossary"/>, optionally with contained <see cref="Thing"/>s.
        /// </returns>
        ...
        {
            return this.GlossaryDao.AddToCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.GlossaryDao.DeleteFromCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.GlossaryDao.ReorderCollectionProperty(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public bool DeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.GlossaryDao.Delete(transaction, partition, thing.Iid);
        }
        ...
        public bool RawDeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.GlossaryDao.RawDelete(transaction, partition, thing.Iid);
        }
        ...
        public bool UpdateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return this.GlossaryDao.Update(transaction, partition, glossary, container);
        }
        ...
        public bool CreateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var glossary = thing as Glossary;
            var createSuccesful = this.GlossaryDao.Write(transaction, partition, glossary, container);
            return createSuccesful && this.CreateContainment(transaction, partition, glossary);
        }
        ...
        {
            var glossary = thing as Glossary;
            var createSuccesful = this.GlossaryDao.Upsert(transaction, partition, glossary, container);
            return createSuccesful && this.UpsertContainment(transaction, partition, glossary);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="Glossary"/>.
        /// </returns>
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var glossaryColl = new List<Thing>(this.GlossaryDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction), (DateTime)this.TransactionManager.GetRawSessionInstant(transaction)));

            return this.AfterGet(glossaryColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="Glossary"/> and contained <see cref="Thing"/>s.
        /// </returns>
        ...
        /// True if the persistence was successful.
        /// </returns>
        private bool CreateContainment(NpgsqlTransaction transaction, string partition, Glossary glossary)
        {
            ...
            {
                results.Add(this.HyperLinkService.CreateConcept(transaction, partition, hyperLink, glossary));
            }

            foreach (var term in this.ResolveFromRequestCache(glossary.Term))
            {
                results.Add(this.TermService.CreateConcept(transaction, partition, term, glossary));
            }
        ...
        /// True if the persistence was successful.
        /// </returns>
        private bool UpsertContainment(NpgsqlTransaction transaction, string partition, Glossary glossary)
        {
            var results = new List<bool>();
            ...
            foreach (var definition in this.ResolveFromRequestCache(glossary.Definition))
            {
                results.Add(this.DefinitionService.UpsertConcept(transaction, partition, definition, glossary));
            }

            foreach (var hyperLink in this.ResolveFromRequestCache(glossary.HyperLink))
            {
                results.Add(this.HyperLinkService.UpsertConcept(transaction, partition, hyperLink, glossary));
            }

            foreach (var term in this.ResolveFromRequestCache(glossary.Term))
            {
                results.Add(this.TermService.UpsertConcept(transaction, partition, term, glossary));
            }

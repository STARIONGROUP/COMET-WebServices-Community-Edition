...
namespace CometServer.Services
{
    ...
    public sealed partial class GlossaryService : ServiceBase, IGlossaryService
    {
        ...
        {
            return this.GlossaryDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.GlossaryDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.GlossaryDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.GlossaryDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

// --------------------------------------------------------------------------------------------------------------------
// <copyright file="DiagramObjectService.cs" company="Starion Group S.A.">
...
namespace CometServer.Services
{
    ...
    public sealed partial class DiagramObjectService : ServiceBase, IDiagramObjectService
    {
        ...
        /// <summary>
        /// Gets or sets the <see cref="IDiagramObjectDao"/>.
        /// </summary>
        public IDiagramObjectDao DiagramObjectDao { get; set; }

        /// <summary>
        /// Get the requested <see cref="DiagramObject"/>s from the ORM layer.
        /// </summary>
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having a list of instances of <see cref="DiagramObject"/>, optionally with contained <see cref="Thing"/>s as result.
        /// </returns>
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="DiagramObject"/> id that will be the source for each link table record.
        /// </param>
        /// <param name="value">
        ...
        {
            return await this.DiagramObjectDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="DiagramObject"/> id that is the source of the link table records.
        /// </param>
        /// <param name="value">
        ...
        {
            return await this.DiagramObjectDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="DiagramObject"/> id that is the source for the reordered link table record.
        /// </param>
        ...
        {
            return await this.DiagramObjectDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        /// <summary>
        /// Delete the supplied <see cref="DiagramObject"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="DiagramObject"/> to delete.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="DiagramObject"/> to be removed.
        /// </param>
        /// <returns>
        ...
        public async Task<bool> DeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return await this.DiagramObjectDao.DeleteAsync(transaction, partition, thing.Iid);
        }
        ...
        public async Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return await this.DiagramObjectDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

        /// <summary>
        /// Update the supplied <see cref="DiagramObject"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="DiagramObject"/> <see cref="Thing"/> to update.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="DiagramObject"/> to be updated.
        /// </param>
        /// <returns>
        ...
        public async Task<bool> UpdateConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return await this.DiagramObjectDao.UpdateAsync(transaction, partition, diagramObject, container);
        }

        /// <summary>
        /// Persist the supplied <see cref="DiagramObject"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="DiagramObject"/> <see cref="Thing"/> to create.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="DiagramObject"/> to be persisted.
        /// </param>
        /// <param name="sequence">
        ...
        public async Task<bool> CreateConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var diagramObject = thing as DiagramObject;
            var createSuccesful = await this.DiagramObjectDao.WriteAsync(transaction, partition, diagramObject, container);
            return createSuccesful && await this.CreateContainmentAsync(transaction, partition, diagramObject);
        }

        /// <summary>
        /// Persist the supplied <see cref="DiagramObject"/> instance. Update if it already exists.
        /// This is typically used during the import of existing data to the Database.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        ...
        {
            var diagramObject = thing as DiagramObject;
            var createSuccesful = await this.DiagramObjectDao.UpsertAsync(transaction, partition, diagramObject, container);
            return createSuccesful && await this.UpsertContainmentAsync(transaction, partition, diagramObject);
        }
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having List of instances of <see cref="DiagramObject"/> as result.
        /// </returns>
        public async Task<IEnumerable<Thing>> GetShallowAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var authorizedContext = this.AuthorizeReadRequest("DiagramObject", containerSecurityContext, partition);
            ...
            var diagramObjectColl = new List<Thing>(await this.DiagramObjectDao.ReadAsync(transaction, partition, idFilter, await this.TransactionManager.IsCachedDtoReadEnabledAsync(transaction), (DateTime)(await this.TransactionManager.GetRawSessionInstantAsync(transaction))));

            return await this.AfterGetAsync(diagramObjectColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having List of instances of <see cref="DiagramObject"/> and contained <see cref="Thing"/>s as result.
        /// </returns>
        public async Task<IEnumerable<Thing>> GetDeepAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            results.AddRange(await this.BoundsService.GetDeepAsync(transaction, partition, diagramObjectColl.SelectMany(x => x.Bounds), containerSecurityContext));
            results.AddRange(await this.DiagramElementService.GetDeepAsync(transaction, partition, diagramObjectColl.SelectMany(x => x.DiagramElement), containerSecurityContext));
            results.AddRange(await this.LocalStyleService.GetDeepAsync(transaction, partition, diagramObjectColl.SelectMany(x => x.LocalStyle), containerSecurityContext));
        ...
        /// <summary>
        /// Persist the <see cref="DiagramObject"/> containment tree to the ORM layer.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// An awaitable <see cref="Task"/> having True if the persistence was successful as result.
        /// </returns>
        private async Task<bool> CreateContainmentAsync(NpgsqlTransaction transaction, string partition, DiagramObject diagramObject)
        {
            var results = new List<bool>();

            foreach (var bounds in this.ResolveFromRequestCache(diagramObject.Bounds))
            {
                results.Add(await this.BoundsService.CreateConceptAsync(transaction, partition, bounds, diagramObject));
            }

            foreach (var diagramElement in this.ResolveFromRequestCache(diagramObject.DiagramElement))
            {
                results.Add(await this.DiagramElementService.CreateConceptAsync(transaction, partition, diagramElement, diagramObject));
            }

            foreach (var localStyle in this.ResolveFromRequestCache(diagramObject.LocalStyle))
            {
                results.Add(await this.LocalStyleService.CreateConceptAsync(transaction, partition, localStyle, diagramObject));
            }
        ...
        /// An awaitable <see cref="Task"/> having True if the persistence was successful as result.
        /// </returns>
        private async Task<bool> UpsertContainmentAsync(NpgsqlTransaction transaction, string partition, DiagramObject diagramObject)
        {
            var results = new List<bool>();

            foreach (var bounds in this.ResolveFromRequestCache(diagramObject.Bounds))
            {
                results.Add(await this.BoundsService.UpsertConceptAsync(transaction, partition, bounds, diagramObject));
            }

            foreach (var diagramElement in this.ResolveFromRequestCache(diagramObject.DiagramElement))
            {
                results.Add(await this.DiagramElementService.UpsertConceptAsync(transaction, partition, diagramElement, diagramObject));
            }

            foreach (var localStyle in this.ResolveFromRequestCache(diagramObject.LocalStyle))
            {
                results.Add(await this.LocalStyleService.UpsertConceptAsync(transaction, partition, localStyle, diagramObject));
            }

...
namespace CometServer.Services
{
    ...
    public sealed partial class DiagramObjectService : ServiceBase, IDiagramObjectService
    {
        ...
        {
            return this.DiagramObjectDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.DiagramObjectDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.DiagramObjectDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.DiagramObjectDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

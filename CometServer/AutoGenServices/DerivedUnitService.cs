...
namespace CometServer.Services
{
    ...
    public sealed partial class DerivedUnitService : ServiceBase, IDerivedUnitService
    {
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="DerivedUnit"/>, optionally with contained <see cref="Thing"/>s.
        /// </returns>
        ...
        {
            return this.DerivedUnitDao.AddToCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.DerivedUnitDao.DeleteFromCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.DerivedUnitDao.ReorderCollectionProperty(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public bool DeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.DerivedUnitDao.Delete(transaction, partition, thing.Iid);
        }
        ...
        public bool RawDeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.DerivedUnitDao.RawDelete(transaction, partition, thing.Iid);
        }
        ...
        public bool UpdateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return this.DerivedUnitDao.Update(transaction, partition, derivedUnit, container);
        }
        ...
        public bool CreateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var derivedUnit = thing as DerivedUnit;
            var createSuccesful = this.DerivedUnitDao.Write(transaction, partition, derivedUnit, container);
            return createSuccesful && this.CreateContainment(transaction, partition, derivedUnit);
        }
        ...
        {
            var derivedUnit = thing as DerivedUnit;
            var createSuccesful = this.DerivedUnitDao.Upsert(transaction, partition, derivedUnit, container);
            return createSuccesful && this.UpsertContainment(transaction, partition, derivedUnit);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="DerivedUnit"/>.
        /// </returns>
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var derivedUnitColl = new List<Thing>(this.DerivedUnitDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction), (DateTime)this.TransactionManager.GetRawSessionInstant(transaction)));

            return this.AfterGet(derivedUnitColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="DerivedUnit"/> and contained <see cref="Thing"/>s.
        /// </returns>
        ...
        /// True if the persistence was successful.
        /// </returns>
        private bool CreateContainment(NpgsqlTransaction transaction, string partition, DerivedUnit derivedUnit)
        {
            ...
            {
                results.Add(this.HyperLinkService.CreateConcept(transaction, partition, hyperLink, derivedUnit));
            }

            foreach (var unitFactor in this.ResolveFromRequestCache(derivedUnit.UnitFactor))
            {
                results.Add(this.UnitFactorService.CreateConcept(transaction, partition, (UnitFactor)unitFactor.V, derivedUnit, unitFactor.K));
            }

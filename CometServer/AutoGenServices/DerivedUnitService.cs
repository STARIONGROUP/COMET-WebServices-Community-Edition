...
namespace CometServer.Services
{
    ...
    public sealed partial class DerivedUnitService : ServiceBase, IDerivedUnitService
    {
        ...
        {
            return this.DerivedUnitDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.DerivedUnitDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.DerivedUnitDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.DerivedUnitDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

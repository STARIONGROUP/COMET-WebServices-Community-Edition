...
namespace CometServer.Services
{
    ...
    public sealed partial class ActionItemService : ServiceBase, IActionItemService
    {
        ...
        {
            return this.ActionItemDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.ActionItemDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.ActionItemDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.ActionItemDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

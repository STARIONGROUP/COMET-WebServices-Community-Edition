...
namespace CometServer.Services
{
    ...
    public sealed partial class ModelLogEntryService : ServiceBase, IModelLogEntryService
    {
        ...
        {
            return this.ModelLogEntryDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.ModelLogEntryDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.ModelLogEntryDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.ModelLogEntryDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

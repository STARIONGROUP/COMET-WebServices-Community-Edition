...
namespace CometServer.Services
{
    ...
    public sealed partial class ModelLogEntryService : ServiceBase, IModelLogEntryService
    {
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="ModelLogEntry"/>, optionally with contained <see cref="Thing"/>s.
        /// </returns>
        ...
        {
            return this.ModelLogEntryDao.AddToCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.ModelLogEntryDao.DeleteFromCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.ModelLogEntryDao.ReorderCollectionProperty(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public bool DeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.ModelLogEntryDao.Delete(transaction, partition, thing.Iid);
        }
        ...
        public bool RawDeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.ModelLogEntryDao.RawDelete(transaction, partition, thing.Iid);
        }
        ...
        public bool UpdateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return this.ModelLogEntryDao.Update(transaction, partition, modelLogEntry, container);
        }
        ...
        {
            var modelLogEntry = thing as ModelLogEntry;
            var createSuccesful = this.ModelLogEntryDao.Upsert(transaction, partition, modelLogEntry, container);
            return createSuccesful && this.UpsertContainment(transaction, partition, modelLogEntry);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="ModelLogEntry"/>.
        /// </returns>
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var modelLogEntryColl = new List<Thing>(this.ModelLogEntryDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction), (DateTime)this.TransactionManager.GetRawSessionInstant(transaction)));

            return this.AfterGet(modelLogEntryColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="ModelLogEntry"/> and contained <see cref="Thing"/>s.
        /// </returns>

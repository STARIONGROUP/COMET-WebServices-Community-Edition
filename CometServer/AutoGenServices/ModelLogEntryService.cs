...
namespace CometServer.Services
{
    ...
    public sealed partial class ModelLogEntryService : ServiceBase, IModelLogEntryService
    {
        ...
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var modelLogEntryColl = new List<Thing>(this.ModelLogEntryDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction)));

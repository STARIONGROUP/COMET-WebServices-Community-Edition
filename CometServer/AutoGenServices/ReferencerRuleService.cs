...
namespace CometServer.Services
{
    ...
    public sealed partial class ReferencerRuleService : ServiceBase, IReferencerRuleService
    {
        ...
        {
            return this.ReferencerRuleDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.ReferencerRuleDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.ReferencerRuleDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.ReferencerRuleDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

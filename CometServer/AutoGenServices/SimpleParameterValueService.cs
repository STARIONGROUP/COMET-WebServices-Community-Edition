...
namespace CometServer.Services
{
    ...
    public sealed partial class SimpleParameterValueService : ServiceBase, ISimpleParameterValueService
    {
        ...
        public async Task<IEnumerable<Thing>> GetShallowAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var simpleParameterValueColl = new List<Thing>(await this.SimpleParameterValueDao.ReadAsync(transaction, partition, idFilter, isCachedDtoReadEnabled, sessionInstant));

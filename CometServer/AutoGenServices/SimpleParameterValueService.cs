...
namespace CometServer.Services
{
    ...
    public sealed partial class SimpleParameterValueService : ServiceBase, ISimpleParameterValueService
    {
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="SimpleParameterValue"/>, optionally with contained <see cref="Thing"/>s.
        /// </returns>
        ...
        {
            return this.SimpleParameterValueDao.AddToCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.SimpleParameterValueDao.DeleteFromCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.SimpleParameterValueDao.ReorderCollectionProperty(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public bool DeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.SimpleParameterValueDao.Delete(transaction, partition, thing.Iid);
        }
        ...
        public bool RawDeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.SimpleParameterValueDao.RawDelete(transaction, partition, thing.Iid);
        }
        ...
        public bool UpdateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return this.SimpleParameterValueDao.Update(transaction, partition, simpleParameterValue, container);
        }
        ...
        public bool CreateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var simpleParameterValue = thing as SimpleParameterValue;
            return this.SimpleParameterValueDao.Write(transaction, partition, simpleParameterValue, container);
        }
        ...
        {
            var simpleParameterValue = thing as SimpleParameterValue;
            return this.SimpleParameterValueDao.Upsert(transaction, partition, simpleParameterValue, container);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="SimpleParameterValue"/>.
        /// </returns>
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var simpleParameterValueColl = new List<Thing>(this.SimpleParameterValueDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction), (DateTime)this.TransactionManager.GetRawSessionInstant(transaction)));

            return this.AfterGet(simpleParameterValueColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="SimpleParameterValue"/> and contained <see cref="Thing"/>s.
        /// </returns>

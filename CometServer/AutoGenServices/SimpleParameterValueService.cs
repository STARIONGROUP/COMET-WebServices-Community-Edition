...
namespace CometServer.Services
{
    ...
    public sealed partial class SimpleParameterValueService : ServiceBase, ISimpleParameterValueService
    {
        ...
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var simpleParameterValueColl = new List<Thing>(this.SimpleParameterValueDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction)));

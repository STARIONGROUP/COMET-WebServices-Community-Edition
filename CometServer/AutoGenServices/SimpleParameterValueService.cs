...
namespace CometServer.Services
{
    ...
    public sealed partial class SimpleParameterValueService : ServiceBase, ISimpleParameterValueService
    {
        ...
        {
            return this.SimpleParameterValueDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.SimpleParameterValueDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.SimpleParameterValueDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.SimpleParameterValueDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

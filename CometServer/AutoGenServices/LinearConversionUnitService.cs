...
namespace CometServer.Services
{
    ...
    public sealed partial class LinearConversionUnitService : ServiceBase, ILinearConversionUnitService
    {
        ...
        {
            return this.LinearConversionUnitDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.LinearConversionUnitDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.LinearConversionUnitDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.LinearConversionUnitDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

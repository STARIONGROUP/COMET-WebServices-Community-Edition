// --------------------------------------------------------------------------------------------------------------------
// <copyright file="LinearConversionUnitService.cs" company="Starion Group S.A.">
...
namespace CometServer.Services
{
    ...
    /// <summary>
    /// The <see cref="LinearConversionUnit"/> Service which uses the ORM layer to interact with the data model.
    /// </summary>
    public sealed partial class LinearConversionUnitService : ServiceBase, ILinearConversionUnitService
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets or sets the <see cref="ILinearConversionUnitDao"/>.
        /// </summary>
        public ILinearConversionUnitDao LinearConversionUnitDao { get; set; }

        /// <summary>
        /// Get the requested <see cref="LinearConversionUnit"/>s from the ORM layer.
        /// </summary>
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having a list of instances of <see cref="LinearConversionUnit"/>, optionally with contained <see cref="Thing"/>s as result.
        /// </returns>
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="LinearConversionUnit"/> id that will be the source for each link table record.
        /// </param>
        /// <param name="value">
        ...
        {
            return await this.LinearConversionUnitDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="LinearConversionUnit"/> id that is the source of the link table records.
        /// </param>
        /// <param name="value">
        ...
        {
            return await this.LinearConversionUnitDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="LinearConversionUnit"/> id that is the source for the reordered link table record.
        /// </param>
        ...
        {
            return await this.LinearConversionUnitDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        /// <summary>
        /// Delete the supplied <see cref="LinearConversionUnit"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="LinearConversionUnit"/> to delete.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="LinearConversionUnit"/> to be removed.
        /// </param>
        /// <returns>
        ...
        public async Task<bool> DeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return await this.LinearConversionUnitDao.DeleteAsync(transaction, partition, thing.Iid);
        }
        ...
        public async Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return await this.LinearConversionUnitDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

        /// <summary>
        /// Update the supplied <see cref="LinearConversionUnit"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="LinearConversionUnit"/> <see cref="Thing"/> to update.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="LinearConversionUnit"/> to be updated.
        /// </param>
        /// <returns>
        ...
        public async Task<bool> UpdateConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return await this.LinearConversionUnitDao.UpdateAsync(transaction, partition, linearConversionUnit, container);
        }

        /// <summary>
        /// Persist the supplied <see cref="LinearConversionUnit"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="LinearConversionUnit"/> <see cref="Thing"/> to create.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="LinearConversionUnit"/> to be persisted.
        /// </param>
        /// <param name="sequence">
        ...
        public async Task<bool> CreateConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var linearConversionUnit = thing as LinearConversionUnit;
            var createSuccesful = await this.LinearConversionUnitDao.WriteAsync(transaction, partition, linearConversionUnit, container);
            return createSuccesful && await this.CreateContainmentAsync(transaction, partition, linearConversionUnit);
        }

        /// <summary>
        /// Persist the supplied <see cref="LinearConversionUnit"/> instance. Update if it already exists.
        /// This is typically used during the import of existing data to the Database.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        ...
        {
            var linearConversionUnit = thing as LinearConversionUnit;
            var createSuccesful = await this.LinearConversionUnitDao.UpsertAsync(transaction, partition, linearConversionUnit, container);
            return createSuccesful && await this.UpsertContainmentAsync(transaction, partition, linearConversionUnit);
        }
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having List of instances of <see cref="LinearConversionUnit"/> as result.
        /// </returns>
        public async Task<IEnumerable<Thing>> GetShallowAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var authorizedContext = this.AuthorizeReadRequest("LinearConversionUnit", containerSecurityContext, partition);
            ...
            var linearConversionUnitColl = new List<Thing>(await this.LinearConversionUnitDao.ReadAsync(transaction, partition, idFilter, await this.TransactionManager.IsCachedDtoReadEnabledAsync(transaction), (DateTime)(await this.TransactionManager.GetRawSessionInstantAsync(transaction))));

            return await this.AfterGetAsync(linearConversionUnitColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having List of instances of <see cref="LinearConversionUnit"/> and contained <see cref="Thing"/>s as result.
        /// </returns>
        public async Task<IEnumerable<Thing>> GetDeepAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var linearConversionUnitColl = results.Where(i => i.GetType() == typeof(LinearConversionUnit)).Cast<LinearConversionUnit>().ToList();

            results.AddRange(await this.AliasService.GetDeepAsync(transaction, partition, linearConversionUnitColl.SelectMany(x => x.Alias), containerSecurityContext));
            results.AddRange(await this.DefinitionService.GetDeepAsync(transaction, partition, linearConversionUnitColl.SelectMany(x => x.Definition), containerSecurityContext));
            results.AddRange(await this.HyperLinkService.GetDeepAsync(transaction, partition, linearConversionUnitColl.SelectMany(x => x.HyperLink), containerSecurityContext));
        ...
        /// <summary>
        /// Persist the <see cref="LinearConversionUnit"/> containment tree to the ORM layer.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// An awaitable <see cref="Task"/> having True if the persistence was successful as result.
        /// </returns>
        private async Task<bool> CreateContainmentAsync(NpgsqlTransaction transaction, string partition, LinearConversionUnit linearConversionUnit)
        {
            var results = new List<bool>();

            foreach (var alias in this.ResolveFromRequestCache(linearConversionUnit.Alias))
            {
                results.Add(await this.AliasService.CreateConceptAsync(transaction, partition, alias, linearConversionUnit));
            }

            foreach (var definition in this.ResolveFromRequestCache(linearConversionUnit.Definition))
            {
                results.Add(await this.DefinitionService.CreateConceptAsync(transaction, partition, definition, linearConversionUnit));
            }

            foreach (var hyperLink in this.ResolveFromRequestCache(linearConversionUnit.HyperLink))
            {
                results.Add(await this.HyperLinkService.CreateConceptAsync(transaction, partition, hyperLink, linearConversionUnit));
            }
        ...
        /// An awaitable <see cref="Task"/> having True if the persistence was successful as result.
        /// </returns>
        private async Task<bool> UpsertContainmentAsync(NpgsqlTransaction transaction, string partition, LinearConversionUnit linearConversionUnit)
        {
            var results = new List<bool>();

            foreach (var alias in this.ResolveFromRequestCache(linearConversionUnit.Alias))
            {
                results.Add(await this.AliasService.UpsertConceptAsync(transaction, partition, alias, linearConversionUnit));
            }

            foreach (var definition in this.ResolveFromRequestCache(linearConversionUnit.Definition))
            {
                results.Add(await this.DefinitionService.UpsertConceptAsync(transaction, partition, definition, linearConversionUnit));
            }

            foreach (var hyperLink in this.ResolveFromRequestCache(linearConversionUnit.HyperLink))
            {
                results.Add(await this.HyperLinkService.UpsertConceptAsync(transaction, partition, hyperLink, linearConversionUnit));
            }

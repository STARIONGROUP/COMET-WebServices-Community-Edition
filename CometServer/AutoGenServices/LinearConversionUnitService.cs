// --------------------------------------------------------------------------------------------------------------------
// <copyright file="LinearConversionUnitService.cs" company="RHEA System S.A.">
...
namespace CometServer.Services
{
    ...
    public sealed partial class LinearConversionUnitService : ServiceBase, ILinearConversionUnitService
    {
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="LinearConversionUnit"/>, optionally with contained <see cref="Thing"/>s.
        /// </returns>
        ...
        {
            return this.LinearConversionUnitDao.AddToCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.LinearConversionUnitDao.DeleteFromCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.LinearConversionUnitDao.ReorderCollectionProperty(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public bool DeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.LinearConversionUnitDao.Delete(transaction, partition, thing.Iid);
        }
        ...
        public bool RawDeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.LinearConversionUnitDao.RawDelete(transaction, partition, thing.Iid);
        }
        ...
        public bool UpdateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return this.LinearConversionUnitDao.Update(transaction, partition, linearConversionUnit, container);
        }
        ...
        public bool CreateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var linearConversionUnit = thing as LinearConversionUnit;
            var createSuccesful = this.LinearConversionUnitDao.Write(transaction, partition, linearConversionUnit, container);
            return createSuccesful && this.CreateContainment(transaction, partition, linearConversionUnit);
        }
        ...
        {
            var linearConversionUnit = thing as LinearConversionUnit;
            var createSuccesful = this.LinearConversionUnitDao.Upsert(transaction, partition, linearConversionUnit, container);
            return createSuccesful && this.UpsertContainment(transaction, partition, linearConversionUnit);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="LinearConversionUnit"/>.
        /// </returns>
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var linearConversionUnitColl = new List<Thing>(this.LinearConversionUnitDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction), (DateTime)this.TransactionManager.GetRawSessionInstant(transaction)));

            return this.AfterGet(linearConversionUnitColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="LinearConversionUnit"/> and contained <see cref="Thing"/>s.
        /// </returns>
        public IEnumerable<Thing> GetDeep(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            results.AddRange(this.AliasService.GetDeep(transaction, partition, linearConversionUnitColl.SelectMany(x => x.Alias), containerSecurityContext));
            results.AddRange(this.AttachmentService.GetDeep(transaction, partition, linearConversionUnitColl.SelectMany(x => x.Attachment), containerSecurityContext));
            results.AddRange(this.DefinitionService.GetDeep(transaction, partition, linearConversionUnitColl.SelectMany(x => x.Definition), containerSecurityContext));
            results.AddRange(this.HyperLinkService.GetDeep(transaction, partition, linearConversionUnitColl.SelectMany(x => x.HyperLink), containerSecurityContext));
        ...
        /// True if the persistence was successful.
        /// </returns>
        private bool CreateContainment(NpgsqlTransaction transaction, string partition, LinearConversionUnit linearConversionUnit)
        {
            var results = new List<bool>();

            foreach (var alias in this.ResolveFromRequestCache(linearConversionUnit.Alias))
            {
                results.Add(this.AliasService.CreateConcept(transaction, partition, alias, linearConversionUnit));
            }

            foreach (var attachment in this.ResolveFromRequestCache(linearConversionUnit.Attachment))
            {
                results.Add(this.AttachmentService.CreateConcept(transaction, partition, attachment, linearConversionUnit));
            }

            foreach (var definition in this.ResolveFromRequestCache(linearConversionUnit.Definition))
            {
                results.Add(this.DefinitionService.CreateConcept(transaction, partition, definition, linearConversionUnit));
            }

            foreach (var hyperLink in this.ResolveFromRequestCache(linearConversionUnit.HyperLink))
            {
                results.Add(this.HyperLinkService.CreateConcept(transaction, partition, hyperLink, linearConversionUnit));
            }
        ...
        private bool UpsertContainment(NpgsqlTransaction transaction, string partition, LinearConversionUnit linearConversionUnit)
        {
            ...
            foreach (var attachment in this.ResolveFromRequestCache(linearConversionUnit.Attachment))
            {
                results.Add(this.AttachmentService.UpsertConcept(transaction, partition, attachment, linearConversionUnit));
            }

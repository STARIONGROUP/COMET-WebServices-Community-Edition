...
namespace CometServer.Services
{
    ...
    public sealed partial class ModellingThingReferenceService : ServiceBase, IModellingThingReferenceService
    {
        ...
        {
            return this.ModellingThingReferenceDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.ModellingThingReferenceDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.ModellingThingReferenceDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.ModellingThingReferenceDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

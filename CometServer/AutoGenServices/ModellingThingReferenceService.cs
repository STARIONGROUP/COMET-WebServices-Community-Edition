...
namespace CometServer.Services
{
    ...
    public sealed partial class ModellingThingReferenceService : ServiceBase, IModellingThingReferenceService
    {
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="ModellingThingReference"/>, optionally with contained <see cref="Thing"/>s.
        /// </returns>
        ...
        {
            return this.ModellingThingReferenceDao.DeleteFromCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.ModellingThingReferenceDao.ReorderCollectionProperty(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public bool DeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.ModellingThingReferenceDao.Delete(transaction, partition, thing.Iid);
        }
        ...
        public bool RawDeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.ModellingThingReferenceDao.RawDelete(transaction, partition, thing.Iid);
        }
        ...
        public bool UpdateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return this.ModellingThingReferenceDao.Update(transaction, partition, modellingThingReference, container);
        }
        ...
        public bool CreateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var modellingThingReference = thing as ModellingThingReference;
            return this.ModellingThingReferenceDao.Write(transaction, partition, modellingThingReference, container);
        }
        ...
        {
            var modellingThingReference = thing as ModellingThingReference;
            return this.ModellingThingReferenceDao.Upsert(transaction, partition, modellingThingReference, container);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="ModellingThingReference"/>.
        /// </returns>
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var modellingThingReferenceColl = new List<Thing>(this.ModellingThingReferenceDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction), (DateTime)this.TransactionManager.GetRawSessionInstant(transaction)));

            return this.AfterGet(modellingThingReferenceColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="ModellingThingReference"/> and contained <see cref="Thing"/>s.
        /// </returns>

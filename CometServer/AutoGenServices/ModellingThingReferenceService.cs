...
namespace CometServer.Services
{
    ...
    public sealed partial class ModellingThingReferenceService : ServiceBase, IModellingThingReferenceService
    {
        ...
        public async Task<IEnumerable<Thing>> GetShallowAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var modellingThingReferenceColl = new List<Thing>(await this.ModellingThingReferenceDao.ReadAsync(transaction, partition, idFilter, isCachedDtoReadEnabled, sessionInstant));

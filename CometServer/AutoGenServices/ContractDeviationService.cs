// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ContractDeviationService.cs" company="Starion Group S.A.">
...
namespace CometServer.Services
{
    ...
    /// <summary>
    /// The <see cref="ContractDeviation"/> Service which uses the ORM layer to interact with the data model.
    /// </summary>
    [ExcludeFromCodeCoverage]
    public sealed partial class ContractDeviationService : ServiceBase, IContractDeviationService
    {
        /// <summary>
        /// Gets or sets the <see cref="IChangeRequestService"/>.
        /// </summary>
        public IChangeRequestService ChangeRequestService { get; set; }

        /// <summary>
        /// Gets or sets the <see cref="IRequestForDeviationService"/>.
        /// </summary>
        public IRequestForDeviationService RequestForDeviationService { get; set; }

        /// <summary>
        /// Gets or sets the <see cref="IRequestForWaiverService"/>.
        /// </summary>
        public IRequestForWaiverService RequestForWaiverService { get; set; }

        /// <summary>
        /// Get the requested <see cref="ContractDeviation"/>s from the ORM layer.
        /// </summary>
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having a list of instances of <see cref="ContractDeviation"/>, optionally with contained <see cref="Thing"/>s as result.
        /// </returns>
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="ContractDeviation"/> id that will be the source for each link table record.
        /// </param>
        /// <param name="value">
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="ContractDeviation"/> id that is the source of the link table records.
        /// </param>
        /// <param name="value">
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="ContractDeviation"/> id that is the source for the reordered link table record.
        /// </param>
        ...
        /// <summary>
        /// Delete the supplied <see cref="ContractDeviation"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="ContractDeviation"/> to delete.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="ContractDeviation"/> to be removed.
        /// </param>
        /// <returns>
        ...
        /// <summary>
        /// Update the supplied <see cref="ContractDeviation"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="ContractDeviation"/> <see cref="Thing"/> to update.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="ContractDeviation"/> to be updated.
        /// </param>
        /// <returns>
        ...
        public async Task<bool> UpdateConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            var contractDeviation = thing as ContractDeviation;
            if (contractDeviation.IsSameOrDerivedClass<ChangeRequest>())
            {
                return await this.ChangeRequestService.UpdateConceptAsync(transaction, partition, contractDeviation, container);
            }

            if (contractDeviation.IsSameOrDerivedClass<RequestForDeviation>())
            {
                return await this.RequestForDeviationService.UpdateConceptAsync(transaction, partition, contractDeviation, container);
            }

            if (contractDeviation.IsSameOrDerivedClass<RequestForWaiver>())
            {
                return await this.RequestForWaiverService.UpdateConceptAsync(transaction, partition, contractDeviation, container);
            }
            throw new NotSupportedException(string.Format("The supplied DTO type: {0} is not a supported type", contractDeviation.GetType().Name));
        }

        /// <summary>
        /// Persist the supplied <see cref="ContractDeviation"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="ContractDeviation"/> <see cref="Thing"/> to create.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="ContractDeviation"/> to be persisted.
        /// </param>
        /// <param name="sequence">
        ...
        public async Task<bool> CreateConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            if (contractDeviation.IsSameOrDerivedClass<ChangeRequest>())
            {
                return await this.ChangeRequestService.CreateConceptAsync(transaction, partition, contractDeviation, container);
            }

            if (contractDeviation.IsSameOrDerivedClass<RequestForDeviation>())
            {
                return await this.RequestForDeviationService.CreateConceptAsync(transaction, partition, contractDeviation, container);
            }

            if (contractDeviation.IsSameOrDerivedClass<RequestForWaiver>())
            {
                return await this.RequestForWaiverService.CreateConceptAsync(transaction, partition, contractDeviation, container);
            }
            throw new NotSupportedException(string.Format("The supplied DTO type: {0} is not a supported type", contractDeviation.GetType().Name));
        }

        /// <summary>
        /// Persist the supplied <see cref="ContractDeviation"/> instance. Update if it already exists.
        /// This is typically used during the import of existing data to the Database.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        ...
        public async Task<bool> UpsertConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            if (contractDeviation.IsSameOrDerivedClass<ChangeRequest>())
            {
                return await this.ChangeRequestService.UpsertConceptAsync(transaction, partition, contractDeviation, container);
            }

            if (contractDeviation.IsSameOrDerivedClass<RequestForDeviation>())
            {
                return await this.RequestForDeviationService.UpsertConceptAsync(transaction, partition, contractDeviation, container);
            }

            if (contractDeviation.IsSameOrDerivedClass<RequestForWaiver>())
            {
                return await this.RequestForWaiverService.UpsertConceptAsync(transaction, partition, contractDeviation, container);
            }
            throw new NotSupportedException(string.Format("The supplied DTO type: {0} is not a supported type", contractDeviation.GetType().Name));
        }
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having List of instances of <see cref="ContractDeviation"/> as result.
        /// </returns>
        public async Task<IEnumerable<Thing>> GetShallowAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var authorizedContext = this.AuthorizeReadRequest("ContractDeviation", containerSecurityContext, partition);
            ...
            var contractDeviationColl = new List<Thing>();
            contractDeviationColl.AddRange(await this.ChangeRequestService.GetShallowAsync(transaction, partition, idFilter, authorizedContext));
            contractDeviationColl.AddRange(await this.RequestForDeviationService.GetShallowAsync(transaction, partition, idFilter, authorizedContext));
            contractDeviationColl.AddRange(await this.RequestForWaiverService.GetShallowAsync(transaction, partition, idFilter, authorizedContext));

            return await this.AfterGetAsync(contractDeviationColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having List of instances of <see cref="ContractDeviation"/> and contained <see cref="Thing"/>s as result.
        /// </returns>
        public async Task<IEnumerable<Thing>> GetDeepAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            results.AddRange(await this.ChangeRequestService.GetDeepAsync(transaction, partition, idFilter, containerSecurityContext));
            results.AddRange(await this.RequestForDeviationService.GetDeepAsync(transaction, partition, idFilter, containerSecurityContext));
            results.AddRange(await this.RequestForWaiverService.GetDeepAsync(transaction, partition, idFilter, containerSecurityContext));
            return results;
        }

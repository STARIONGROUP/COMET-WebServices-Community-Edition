...
namespace CometServer.Services
{
    ...
    public sealed partial class BinaryRelationshipRuleService : ServiceBase, IBinaryRelationshipRuleService
    {
        ...
        public async Task<IEnumerable<Thing>> GetShallowAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var binaryRelationshipRuleColl = new List<Thing>(await this.BinaryRelationshipRuleDao.ReadAsync(transaction, partition, idFilter, isCachedDtoReadEnabled, sessionInstant));

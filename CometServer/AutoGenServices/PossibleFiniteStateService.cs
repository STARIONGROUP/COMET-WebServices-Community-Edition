...
namespace CometServer.Services
{
    ...
    public sealed partial class PossibleFiniteStateService : ServiceBase, IPossibleFiniteStateService
    {
        ...
        {
            return this.PossibleFiniteStateDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.PossibleFiniteStateDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.PossibleFiniteStateDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        {
            return this.PossibleFiniteStateDao.ReorderContainmentAsync(transaction, partition, orderedItem);
        }
        ...
        public Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.PossibleFiniteStateDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

...
namespace CometServer.Services
{
    ...
    public sealed partial class FolderService : ServiceBase, IFolderService
    {
        ...
        {
            return this.FolderDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.FolderDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.FolderDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.FolderDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

...
namespace CometServer.Services
{
    ...
    public sealed partial class FolderService : ServiceBase, IFolderService
    {
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="Folder"/>, optionally with contained <see cref="Thing"/>s.
        /// </returns>
        ...
        {
            return this.FolderDao.AddToCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.FolderDao.DeleteFromCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.FolderDao.ReorderCollectionProperty(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public bool DeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.FolderDao.Delete(transaction, partition, thing.Iid);
        }
        ...
        public bool RawDeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.FolderDao.RawDelete(transaction, partition, thing.Iid);
        }
        ...
        public bool UpdateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return this.FolderDao.Update(transaction, partition, folder, container);
        }
        ...
        public bool CreateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var folder = thing as Folder;
            return this.FolderDao.Write(transaction, partition, folder, container);
        }
        ...
        {
            var folder = thing as Folder;
            return this.FolderDao.Upsert(transaction, partition, folder, container);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="Folder"/>.
        /// </returns>
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var folderColl = new List<Thing>(this.FolderDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction), (DateTime)this.TransactionManager.GetRawSessionInstant(transaction)));

            return this.AfterGet(folderColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="Folder"/> and contained <see cref="Thing"/>s.
        /// </returns>

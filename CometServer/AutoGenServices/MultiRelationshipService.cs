...
namespace CometServer.Services
{
    ...
    public sealed partial class MultiRelationshipService : ServiceBase, IMultiRelationshipService
    {
        ...
        {
            return this.MultiRelationshipDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.MultiRelationshipDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.MultiRelationshipDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.MultiRelationshipDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

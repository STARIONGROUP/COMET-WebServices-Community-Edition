// --------------------------------------------------------------------------------------------------------------------
// <copyright file="MultiRelationshipService.cs" company="Starion Group S.A.">
...
namespace CometServer.Services
{
    ...
    /// <summary>
    /// The <see cref="MultiRelationship"/> Service which uses the ORM layer to interact with the data model.
    /// </summary>
    public sealed partial class MultiRelationshipService : ServiceBase, IMultiRelationshipService
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets or sets the <see cref="IMultiRelationshipDao"/>.
        /// </summary>
        public IMultiRelationshipDao MultiRelationshipDao { get; set; }

        /// <summary>
        /// Get the requested <see cref="MultiRelationship"/>s from the ORM layer.
        /// </summary>
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having a list of instances of <see cref="MultiRelationship"/>, optionally with contained <see cref="Thing"/>s as result.
        /// </returns>
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="MultiRelationship"/> id that will be the source for each link table record.
        /// </param>
        /// <param name="value">
        ...
        {
            return await this.MultiRelationshipDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="MultiRelationship"/> id that is the source of the link table records.
        /// </param>
        /// <param name="value">
        ...
        {
            return await this.MultiRelationshipDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="MultiRelationship"/> id that is the source for the reordered link table record.
        /// </param>
        ...
        {
            return await this.MultiRelationshipDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        /// <summary>
        /// Delete the supplied <see cref="MultiRelationship"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="MultiRelationship"/> to delete.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="MultiRelationship"/> to be removed.
        /// </param>
        /// <returns>
        ...
        public async Task<bool> DeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return await this.MultiRelationshipDao.DeleteAsync(transaction, partition, thing.Iid);
        }
        ...
        public async Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return await this.MultiRelationshipDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

        /// <summary>
        /// Update the supplied <see cref="MultiRelationship"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="MultiRelationship"/> <see cref="Thing"/> to update.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="MultiRelationship"/> to be updated.
        /// </param>
        /// <returns>
        ...
        public async Task<bool> UpdateConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return await this.MultiRelationshipDao.UpdateAsync(transaction, partition, multiRelationship, container);
        }

        /// <summary>
        /// Persist the supplied <see cref="MultiRelationship"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="MultiRelationship"/> <see cref="Thing"/> to create.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="MultiRelationship"/> to be persisted.
        /// </param>
        /// <param name="sequence">
        ...
        public async Task<bool> CreateConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var multiRelationship = thing as MultiRelationship;
            var createSuccesful = await this.MultiRelationshipDao.WriteAsync(transaction, partition, multiRelationship, container);
            return createSuccesful && await this.CreateContainmentAsync(transaction, partition, multiRelationship);
        }

        /// <summary>
        /// Persist the supplied <see cref="MultiRelationship"/> instance. Update if it already exists.
        /// This is typically used during the import of existing data to the Database.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        ...
        {
            var multiRelationship = thing as MultiRelationship;
            var createSuccesful = await this.MultiRelationshipDao.UpsertAsync(transaction, partition, multiRelationship, container);
            return createSuccesful && await this.UpsertContainmentAsync(transaction, partition, multiRelationship);
        }
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having List of instances of <see cref="MultiRelationship"/> as result.
        /// </returns>
        public async Task<IEnumerable<Thing>> GetShallowAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var authorizedContext = this.AuthorizeReadRequest("MultiRelationship", containerSecurityContext, partition);
            ...
            var multiRelationshipColl = new List<Thing>(await this.MultiRelationshipDao.ReadAsync(transaction, partition, idFilter, await this.TransactionManager.IsCachedDtoReadEnabledAsync(transaction), (DateTime)(await this.TransactionManager.GetRawSessionInstantAsync(transaction))));

            return await this.AfterGetAsync(multiRelationshipColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having List of instances of <see cref="MultiRelationship"/> and contained <see cref="Thing"/>s as result.
        /// </returns>
        public async Task<IEnumerable<Thing>> GetDeepAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var multiRelationshipColl = results.Where(i => i.GetType() == typeof(MultiRelationship)).Cast<MultiRelationship>().ToList();

            results.AddRange(await this.ParameterValueService.GetDeepAsync(transaction, partition, multiRelationshipColl.SelectMany(x => x.ParameterValue), containerSecurityContext));
        ...
        /// <summary>
        /// Persist the <see cref="MultiRelationship"/> containment tree to the ORM layer.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// The <see cref="MultiRelationship"/> instance to persist.
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having True if the persistence was successful as result.
        /// </returns>
        private async Task<bool> CreateContainmentAsync(NpgsqlTransaction transaction, string partition, MultiRelationship multiRelationship)
        {
            var results = new List<bool>();

            foreach (var parameterValue in this.ResolveFromRequestCache(multiRelationship.ParameterValue))
            {
                results.Add(await this.ParameterValueService.CreateConceptAsync(transaction, partition, parameterValue, multiRelationship));
            }
        ...
        /// <summary>
        /// Persist the <see cref="MultiRelationship"/> containment tree to the ORM layer. Update if it already exists.
        /// This is typically used during the import of existing data to the Database.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        ...
        /// An awaitable <see cref="Task"/> having True if the persistence was successful as result.
        /// </returns>
        private async Task<bool> UpsertContainmentAsync(NpgsqlTransaction transaction, string partition, MultiRelationship multiRelationship)
        {
            var results = new List<bool>();

            foreach (var parameterValue in this.ResolveFromRequestCache(multiRelationship.ParameterValue))
            {
                results.Add(await this.ParameterValueService.UpsertConceptAsync(transaction, partition, parameterValue, multiRelationship));
            }

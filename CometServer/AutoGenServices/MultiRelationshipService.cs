...
namespace CometServer.Services
{
    ...
    public sealed partial class MultiRelationshipService : ServiceBase, IMultiRelationshipService
    {
        ...
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var multiRelationshipColl = new List<Thing>(this.MultiRelationshipDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction)));

...
namespace CometServer.Services
{
    ...
    public sealed partial class MultiRelationshipService : ServiceBase, IMultiRelationshipService
    {
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="MultiRelationship"/>, optionally with contained <see cref="Thing"/>s.
        /// </returns>
        ...
        {
            return this.MultiRelationshipDao.AddToCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.MultiRelationshipDao.DeleteFromCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.MultiRelationshipDao.ReorderCollectionProperty(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public bool DeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.MultiRelationshipDao.Delete(transaction, partition, thing.Iid);
        }
        ...
        public bool RawDeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.MultiRelationshipDao.RawDelete(transaction, partition, thing.Iid);
        }
        ...
        public bool UpdateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return this.MultiRelationshipDao.Update(transaction, partition, multiRelationship, container);
        }
        ...
        public bool CreateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var multiRelationship = thing as MultiRelationship;
            var createSuccesful = this.MultiRelationshipDao.Write(transaction, partition, multiRelationship, container);
            return createSuccesful && this.CreateContainment(transaction, partition, multiRelationship);
        }
        ...
        {
            var multiRelationship = thing as MultiRelationship;
            var createSuccesful = this.MultiRelationshipDao.Upsert(transaction, partition, multiRelationship, container);
            return createSuccesful && this.UpsertContainment(transaction, partition, multiRelationship);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="MultiRelationship"/>.
        /// </returns>
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var multiRelationshipColl = new List<Thing>(this.MultiRelationshipDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction), (DateTime)this.TransactionManager.GetRawSessionInstant(transaction)));

            return this.AfterGet(multiRelationshipColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="MultiRelationship"/> and contained <see cref="Thing"/>s.
        /// </returns>
        public IEnumerable<Thing> GetDeep(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            results.AddRange(this.ParameterValueService.GetDeep(transaction, partition, multiRelationshipColl.SelectMany(x => x.ParameterValue), containerSecurityContext));
        ...
        private bool CreateContainment(NpgsqlTransaction transaction, string partition, MultiRelationship multiRelationship)
        {
            ...
            {
                results.Add(this.ParameterValueService.CreateConcept(transaction, partition, parameterValue, multiRelationship));
            }
        ...
        /// True if the persistence was successful.
        /// </returns>
        private bool UpsertContainment(NpgsqlTransaction transaction, string partition, MultiRelationship multiRelationship)
        {
            var results = new List<bool>();

            foreach (var parameterValue in this.ResolveFromRequestCache(multiRelationship.ParameterValue))
            {
                results.Add(this.ParameterValueService.UpsertConcept(transaction, partition, parameterValue, multiRelationship));
            }

// --------------------------------------------------------------------------------------------------------------------
// <copyright file="StakeHolderValueMapSettingsService.cs" company="Starion Group S.A.">
...
namespace CometServer.Services
{
    ...
    /// <summary>
    /// The <see cref="StakeHolderValueMapSettings"/> Service which uses the ORM layer to interact with the data model.
    /// </summary>
    public sealed partial class StakeHolderValueMapSettingsService : ServiceBase, IStakeHolderValueMapSettingsService
    {
        /// <summary>
        /// Gets or sets the <see cref="IStakeHolderValueMapSettingsDao"/>.
        /// </summary>
        public IStakeHolderValueMapSettingsDao StakeHolderValueMapSettingsDao { get; set; }

        /// <summary>
        /// Get the requested <see cref="StakeHolderValueMapSettings"/>s from the ORM layer.
        /// </summary>
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having a list of instances of <see cref="StakeHolderValueMapSettings"/>, optionally with contained <see cref="Thing"/>s as result.
        /// </returns>
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="StakeHolderValueMapSettings"/> id that will be the source for each link table record.
        /// </param>
        /// <param name="value">
        ...
        {
            return await this.StakeHolderValueMapSettingsDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="StakeHolderValueMapSettings"/> id that is the source of the link table records.
        /// </param>
        /// <param name="value">
        ...
        {
            return await this.StakeHolderValueMapSettingsDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="StakeHolderValueMapSettings"/> id that is the source for the reordered link table record.
        /// </param>
        ...
        {
            return await this.StakeHolderValueMapSettingsDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        /// <summary>
        /// Delete the supplied <see cref="StakeHolderValueMapSettings"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="StakeHolderValueMapSettings"/> to delete.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="StakeHolderValueMapSettings"/> to be removed.
        /// </param>
        /// <returns>
        ...
        public async Task<bool> DeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return await this.StakeHolderValueMapSettingsDao.DeleteAsync(transaction, partition, thing.Iid);
        }
        ...
        public async Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return await this.StakeHolderValueMapSettingsDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

        /// <summary>
        /// Update the supplied <see cref="StakeHolderValueMapSettings"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="StakeHolderValueMapSettings"/> <see cref="Thing"/> to update.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="StakeHolderValueMapSettings"/> to be updated.
        /// </param>
        /// <returns>
        ...
        public async Task<bool> UpdateConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return await this.StakeHolderValueMapSettingsDao.UpdateAsync(transaction, partition, stakeHolderValueMapSettings, container);
        }

        /// <summary>
        /// Persist the supplied <see cref="StakeHolderValueMapSettings"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="StakeHolderValueMapSettings"/> <see cref="Thing"/> to create.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="StakeHolderValueMapSettings"/> to be persisted.
        /// </param>
        /// <param name="sequence">
        ...
        public async Task<bool> CreateConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var stakeHolderValueMapSettings = thing as StakeHolderValueMapSettings;
            return await this.StakeHolderValueMapSettingsDao.WriteAsync(transaction, partition, stakeHolderValueMapSettings, container);
        }

        /// <summary>
        /// Persist the supplied <see cref="StakeHolderValueMapSettings"/> instance. Update if it already exists.
        /// This is typically used during the import of existing data to the Database.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        ...
        {
            var stakeHolderValueMapSettings = thing as StakeHolderValueMapSettings;
            return await this.StakeHolderValueMapSettingsDao.UpsertAsync(transaction, partition, stakeHolderValueMapSettings, container);
        }
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having List of instances of <see cref="StakeHolderValueMapSettings"/> as result.
        /// </returns>
        public async Task<IEnumerable<Thing>> GetShallowAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var authorizedContext = this.AuthorizeReadRequest("StakeHolderValueMapSettings", containerSecurityContext, partition);
            ...
            var stakeHolderValueMapSettingsColl = new List<Thing>(await this.StakeHolderValueMapSettingsDao.ReadAsync(transaction, partition, idFilter, await this.TransactionManager.IsCachedDtoReadEnabledAsync(transaction), (DateTime)(await this.TransactionManager.GetRawSessionInstantAsync(transaction))));

            return await this.AfterGetAsync(stakeHolderValueMapSettingsColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having List of instances of <see cref="StakeHolderValueMapSettings"/> and contained <see cref="Thing"/>s as result.
        /// </returns>

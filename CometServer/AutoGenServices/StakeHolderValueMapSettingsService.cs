...
namespace CometServer.Services
{
    ...
    public sealed partial class StakeHolderValueMapSettingsService : ServiceBase, IStakeHolderValueMapSettingsService
    {
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="StakeHolderValueMapSettings"/>, optionally with contained <see cref="Thing"/>s.
        /// </returns>
        ...
        {
            return this.StakeHolderValueMapSettingsDao.AddToCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.StakeHolderValueMapSettingsDao.DeleteFromCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.StakeHolderValueMapSettingsDao.ReorderCollectionProperty(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public bool DeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.StakeHolderValueMapSettingsDao.Delete(transaction, partition, thing.Iid);
        }
        ...
        public bool RawDeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.StakeHolderValueMapSettingsDao.RawDelete(transaction, partition, thing.Iid);
        }
        ...
        public bool UpdateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return this.StakeHolderValueMapSettingsDao.Update(transaction, partition, stakeHolderValueMapSettings, container);
        }
        ...
        public bool CreateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var stakeHolderValueMapSettings = thing as StakeHolderValueMapSettings;
            return this.StakeHolderValueMapSettingsDao.Write(transaction, partition, stakeHolderValueMapSettings, container);
        }
        ...
        {
            var stakeHolderValueMapSettings = thing as StakeHolderValueMapSettings;
            return this.StakeHolderValueMapSettingsDao.Upsert(transaction, partition, stakeHolderValueMapSettings, container);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="StakeHolderValueMapSettings"/>.
        /// </returns>
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var stakeHolderValueMapSettingsColl = new List<Thing>(this.StakeHolderValueMapSettingsDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction), (DateTime)this.TransactionManager.GetRawSessionInstant(transaction)));

            return this.AfterGet(stakeHolderValueMapSettingsColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="StakeHolderValueMapSettings"/> and contained <see cref="Thing"/>s.
        /// </returns>

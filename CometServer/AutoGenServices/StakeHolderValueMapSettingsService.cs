...
namespace CometServer.Services
{
    ...
    public sealed partial class StakeHolderValueMapSettingsService : ServiceBase, IStakeHolderValueMapSettingsService
    {
        ...
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var stakeHolderValueMapSettingsColl = new List<Thing>(this.StakeHolderValueMapSettingsDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction)));

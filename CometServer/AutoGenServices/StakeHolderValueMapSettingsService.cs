...
namespace CometServer.Services
{
    ...
    public sealed partial class StakeHolderValueMapSettingsService : ServiceBase, IStakeHolderValueMapSettingsService
    {
        ...
        {
            return this.StakeHolderValueMapSettingsDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.StakeHolderValueMapSettingsDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.StakeHolderValueMapSettingsDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.StakeHolderValueMapSettingsDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

...
namespace CometServer.Services
{
    ...
    public sealed partial class IterationSetupService : ServiceBase, IIterationSetupService
    {
        ...
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var iterationSetupColl = new List<Thing>(this.IterationSetupDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction)));

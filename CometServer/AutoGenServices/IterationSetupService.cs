...
namespace CometServer.Services
{
    ...
    public sealed partial class IterationSetupService : ServiceBase, IIterationSetupService
    {
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="IterationSetup"/>, optionally with contained <see cref="Thing"/>s.
        /// </returns>
        ...
        {
            return this.IterationSetupDao.AddToCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.IterationSetupDao.DeleteFromCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.IterationSetupDao.ReorderCollectionProperty(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public bool DeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.IterationSetupDao.Delete(transaction, partition, thing.Iid);
        }
        ...
        public bool RawDeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.IterationSetupDao.RawDelete(transaction, partition, thing.Iid);
        }
        ...
        public bool UpdateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return this.IterationSetupDao.Update(transaction, partition, iterationSetup, container);
        }
        ...
        public bool CreateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var iterationSetup = thing as IterationSetup;
            return this.IterationSetupDao.Write(transaction, partition, iterationSetup, container);
        }
        ...
        {
            var iterationSetup = thing as IterationSetup;
            return this.IterationSetupDao.Upsert(transaction, partition, iterationSetup, container);
        }
        ...
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var iterationSetupColl = new List<Thing>(this.IterationSetupDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction), (DateTime)this.TransactionManager.GetRawSessionInstant(transaction)));

            return this.AfterGet(iterationSetupColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="IterationSetup"/> and contained <see cref="Thing"/>s.
        /// </returns>

...
namespace CometServer.Services
{
    ...
    public sealed partial class IterationSetupService : ServiceBase, IIterationSetupService
    {
        ...
        {
            return this.IterationSetupDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.IterationSetupDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.IterationSetupDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.IterationSetupDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

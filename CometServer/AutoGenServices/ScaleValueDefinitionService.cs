...
namespace CometServer.Services
{
    ...
    public sealed partial class ScaleValueDefinitionService : ServiceBase, IScaleValueDefinitionService
    {
        ...
        {
            return this.ScaleValueDefinitionDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.ScaleValueDefinitionDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.ScaleValueDefinitionDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.ScaleValueDefinitionDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

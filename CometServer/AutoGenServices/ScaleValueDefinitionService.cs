...
namespace CometServer.Services
{
    ...
    public sealed partial class ScaleValueDefinitionService : ServiceBase, IScaleValueDefinitionService
    {
        ...
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var scaleValueDefinitionColl = new List<Thing>(this.ScaleValueDefinitionDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction)));

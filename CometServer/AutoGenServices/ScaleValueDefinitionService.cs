...
namespace CometServer.Services
{
    ...
    public sealed partial class ScaleValueDefinitionService : ServiceBase, IScaleValueDefinitionService
    {
        ...
        public async Task<IEnumerable<Thing>> GetShallowAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var scaleValueDefinitionColl = new List<Thing>(await this.ScaleValueDefinitionDao.ReadAsync(transaction, partition, idFilter, isCachedDtoReadEnabled, sessionInstant));

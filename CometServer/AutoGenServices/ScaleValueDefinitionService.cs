...
namespace CometServer.Services
{
    ...
    public sealed partial class ScaleValueDefinitionService : ServiceBase, IScaleValueDefinitionService
    {
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="ScaleValueDefinition"/>, optionally with contained <see cref="Thing"/>s.
        /// </returns>
        ...
        {
            return this.ScaleValueDefinitionDao.AddToCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.ScaleValueDefinitionDao.DeleteFromCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.ScaleValueDefinitionDao.ReorderCollectionProperty(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public bool DeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.ScaleValueDefinitionDao.Delete(transaction, partition, thing.Iid);
        }
        ...
        public bool RawDeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.ScaleValueDefinitionDao.RawDelete(transaction, partition, thing.Iid);
        }
        ...
        public bool UpdateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return this.ScaleValueDefinitionDao.Update(transaction, partition, scaleValueDefinition, container);
        }
        ...
        public bool CreateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var scaleValueDefinition = thing as ScaleValueDefinition;
            var createSuccesful = this.ScaleValueDefinitionDao.Write(transaction, partition, scaleValueDefinition, container);
            return createSuccesful && this.CreateContainment(transaction, partition, scaleValueDefinition);
        }
        ...
        {
            var scaleValueDefinition = thing as ScaleValueDefinition;
            var createSuccesful = this.ScaleValueDefinitionDao.Upsert(transaction, partition, scaleValueDefinition, container);
            return createSuccesful && this.UpsertContainment(transaction, partition, scaleValueDefinition);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="ScaleValueDefinition"/>.
        /// </returns>
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var scaleValueDefinitionColl = new List<Thing>(this.ScaleValueDefinitionDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction), (DateTime)this.TransactionManager.GetRawSessionInstant(transaction)));

            return this.AfterGet(scaleValueDefinitionColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="ScaleValueDefinition"/> and contained <see cref="Thing"/>s.
        /// </returns>
        ...
        /// True if the persistence was successful.
        /// </returns>
        private bool UpsertContainment(NpgsqlTransaction transaction, string partition, ScaleValueDefinition scaleValueDefinition)
        {
            var results = new List<bool>();
            ...
            foreach (var definition in this.ResolveFromRequestCache(scaleValueDefinition.Definition))
            {
                results.Add(this.DefinitionService.UpsertConcept(transaction, partition, definition, scaleValueDefinition));
            }

            foreach (var hyperLink in this.ResolveFromRequestCache(scaleValueDefinition.HyperLink))
            {
                results.Add(this.HyperLinkService.UpsertConcept(transaction, partition, hyperLink, scaleValueDefinition));
            }

...
namespace CometServer.Services
{
    ...
    public sealed partial class DerivedQuantityKindService : ServiceBase, IDerivedQuantityKindService
    {
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="DerivedQuantityKind"/>, optionally with contained <see cref="Thing"/>s.
        /// </returns>
        ...
        {
            return this.DerivedQuantityKindDao.AddToCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.DerivedQuantityKindDao.DeleteFromCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.DerivedQuantityKindDao.ReorderCollectionProperty(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public bool DeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.DerivedQuantityKindDao.Delete(transaction, partition, thing.Iid);
        }
        ...
        public bool RawDeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.DerivedQuantityKindDao.RawDelete(transaction, partition, thing.Iid);
        }
        ...
        public bool UpdateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return this.DerivedQuantityKindDao.Update(transaction, partition, derivedQuantityKind, container);
        }
        ...
        public bool CreateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var derivedQuantityKind = thing as DerivedQuantityKind;
            var createSuccesful = this.DerivedQuantityKindDao.Write(transaction, partition, derivedQuantityKind, container);
            return createSuccesful && this.CreateContainment(transaction, partition, derivedQuantityKind);
        }
        ...
        {
            var derivedQuantityKind = thing as DerivedQuantityKind;
            var createSuccesful = this.DerivedQuantityKindDao.Upsert(transaction, partition, derivedQuantityKind, container);
            return createSuccesful && this.UpsertContainment(transaction, partition, derivedQuantityKind);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="DerivedQuantityKind"/>.
        /// </returns>
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var derivedQuantityKindColl = new List<Thing>(this.DerivedQuantityKindDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction), (DateTime)this.TransactionManager.GetRawSessionInstant(transaction)));

            return this.AfterGet(derivedQuantityKindColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="DerivedQuantityKind"/> and contained <see cref="Thing"/>s.
        /// </returns>
        ...
        /// True if the persistence was successful.
        /// </returns>
        private bool UpsertContainment(NpgsqlTransaction transaction, string partition, DerivedQuantityKind derivedQuantityKind)
        {
            var results = new List<bool>();
            ...
            foreach (var definition in this.ResolveFromRequestCache(derivedQuantityKind.Definition))
            {
                results.Add(this.DefinitionService.UpsertConcept(transaction, partition, definition, derivedQuantityKind));
            }

            foreach (var hyperLink in this.ResolveFromRequestCache(derivedQuantityKind.HyperLink))
            {
                results.Add(this.HyperLinkService.UpsertConcept(transaction, partition, hyperLink, derivedQuantityKind));
            }

            foreach (var quantityKindFactor in this.ResolveFromRequestCache(derivedQuantityKind.QuantityKindFactor))
            {
                results.Add(this.QuantityKindFactorService.UpsertConcept(transaction, partition, (QuantityKindFactor)quantityKindFactor.V, derivedQuantityKind, quantityKindFactor.K));
            }

...
namespace CometServer.Services
{
    ...
    public sealed partial class DerivedQuantityKindService : ServiceBase, IDerivedQuantityKindService
    {
        ...
        {
            return this.DerivedQuantityKindDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.DerivedQuantityKindDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.DerivedQuantityKindDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.DerivedQuantityKindDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

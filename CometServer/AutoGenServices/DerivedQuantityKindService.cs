// --------------------------------------------------------------------------------------------------------------------
// <copyright file="DerivedQuantityKindService.cs" company="Starion Group S.A.">
...
namespace CometServer.Services
{
    ...
    /// <summary>
    /// The <see cref="DerivedQuantityKind"/> Service which uses the ORM layer to interact with the data model.
    /// </summary>
    public sealed partial class DerivedQuantityKindService : ServiceBase, IDerivedQuantityKindService
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets or sets the <see cref="IDerivedQuantityKindDao"/>.
        /// </summary>
        public IDerivedQuantityKindDao DerivedQuantityKindDao { get; set; }

        /// <summary>
        /// Get the requested <see cref="DerivedQuantityKind"/>s from the ORM layer.
        /// </summary>
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having a list of instances of <see cref="DerivedQuantityKind"/>, optionally with contained <see cref="Thing"/>s as result.
        /// </returns>
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="DerivedQuantityKind"/> id that will be the source for each link table record.
        /// </param>
        /// <param name="value">
        ...
        {
            return await this.DerivedQuantityKindDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="DerivedQuantityKind"/> id that is the source of the link table records.
        /// </param>
        /// <param name="value">
        ...
        {
            return await this.DerivedQuantityKindDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="DerivedQuantityKind"/> id that is the source for the reordered link table record.
        /// </param>
        ...
        {
            return await this.DerivedQuantityKindDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        /// <summary>
        /// Delete the supplied <see cref="DerivedQuantityKind"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="DerivedQuantityKind"/> to delete.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="DerivedQuantityKind"/> to be removed.
        /// </param>
        /// <returns>
        ...
        public async Task<bool> DeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return await this.DerivedQuantityKindDao.DeleteAsync(transaction, partition, thing.Iid);
        }
        ...
        public async Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return await this.DerivedQuantityKindDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

        /// <summary>
        /// Update the supplied <see cref="DerivedQuantityKind"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="DerivedQuantityKind"/> <see cref="Thing"/> to update.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="DerivedQuantityKind"/> to be updated.
        /// </param>
        /// <returns>
        ...
        public async Task<bool> UpdateConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return await this.DerivedQuantityKindDao.UpdateAsync(transaction, partition, derivedQuantityKind, container);
        }

        /// <summary>
        /// Persist the supplied <see cref="DerivedQuantityKind"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="DerivedQuantityKind"/> <see cref="Thing"/> to create.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="DerivedQuantityKind"/> to be persisted.
        /// </param>
        /// <param name="sequence">
        ...
        public async Task<bool> CreateConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var derivedQuantityKind = thing as DerivedQuantityKind;
            var createSuccesful = await this.DerivedQuantityKindDao.WriteAsync(transaction, partition, derivedQuantityKind, container);
            return createSuccesful && await this.CreateContainmentAsync(transaction, partition, derivedQuantityKind);
        }

        /// <summary>
        /// Persist the supplied <see cref="DerivedQuantityKind"/> instance. Update if it already exists.
        /// This is typically used during the import of existing data to the Database.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        ...
        {
            var derivedQuantityKind = thing as DerivedQuantityKind;
            var createSuccesful = await this.DerivedQuantityKindDao.UpsertAsync(transaction, partition, derivedQuantityKind, container);
            return createSuccesful && await this.UpsertContainmentAsync(transaction, partition, derivedQuantityKind);
        }
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having List of instances of <see cref="DerivedQuantityKind"/> as result.
        /// </returns>
        public async Task<IEnumerable<Thing>> GetShallowAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var authorizedContext = this.AuthorizeReadRequest("DerivedQuantityKind", containerSecurityContext, partition);
            ...
            var derivedQuantityKindColl = new List<Thing>(await this.DerivedQuantityKindDao.ReadAsync(transaction, partition, idFilter, await this.TransactionManager.IsCachedDtoReadEnabledAsync(transaction), (DateTime)(await this.TransactionManager.GetRawSessionInstantAsync(transaction))));

            return await this.AfterGetAsync(derivedQuantityKindColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having List of instances of <see cref="DerivedQuantityKind"/> and contained <see cref="Thing"/>s as result.
        /// </returns>
        public async Task<IEnumerable<Thing>> GetDeepAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            results.AddRange(await this.AliasService.GetDeepAsync(transaction, partition, derivedQuantityKindColl.SelectMany(x => x.Alias), containerSecurityContext));
            results.AddRange(await this.DefinitionService.GetDeepAsync(transaction, partition, derivedQuantityKindColl.SelectMany(x => x.Definition), containerSecurityContext));
            results.AddRange(await this.HyperLinkService.GetDeepAsync(transaction, partition, derivedQuantityKindColl.SelectMany(x => x.HyperLink), containerSecurityContext));
            results.AddRange(await this.QuantityKindFactorService.GetDeepAsync(transaction, partition, derivedQuantityKindColl.SelectMany(x => x.QuantityKindFactor).ToIdList(), containerSecurityContext));
        ...
        /// <summary>
        /// Persist the <see cref="DerivedQuantityKind"/> containment tree to the ORM layer.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// The <see cref="DerivedQuantityKind"/> instance to persist.
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having True if the persistence was successful as result.
        /// </returns>
        private async Task<bool> CreateContainmentAsync(NpgsqlTransaction transaction, string partition, DerivedQuantityKind derivedQuantityKind)
        {
            var results = new List<bool>();

            foreach (var alias in this.ResolveFromRequestCache(derivedQuantityKind.Alias))
            {
                results.Add(await this.AliasService.CreateConceptAsync(transaction, partition, alias, derivedQuantityKind));
            }

            foreach (var definition in this.ResolveFromRequestCache(derivedQuantityKind.Definition))
            {
                results.Add(await this.DefinitionService.CreateConceptAsync(transaction, partition, definition, derivedQuantityKind));
            }

            foreach (var hyperLink in this.ResolveFromRequestCache(derivedQuantityKind.HyperLink))
            {
                results.Add(await this.HyperLinkService.CreateConceptAsync(transaction, partition, hyperLink, derivedQuantityKind));
            }

            foreach (var quantityKindFactor in this.ResolveFromRequestCache(derivedQuantityKind.QuantityKindFactor))
            {
                results.Add(await this.QuantityKindFactorService.CreateConceptAsync(transaction, partition, (QuantityKindFactor)quantityKindFactor.V, derivedQuantityKind, quantityKindFactor.K));
            }
        ...
        /// <summary>
        /// Persist the <see cref="DerivedQuantityKind"/> containment tree to the ORM layer. Update if it already exists.
        /// This is typically used during the import of existing data to the Database.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        ...
        /// An awaitable <see cref="Task"/> having True if the persistence was successful as result.
        /// </returns>
        private async Task<bool> UpsertContainmentAsync(NpgsqlTransaction transaction, string partition, DerivedQuantityKind derivedQuantityKind)
        {
            var results = new List<bool>();

            foreach (var alias in this.ResolveFromRequestCache(derivedQuantityKind.Alias))
            {
                results.Add(await this.AliasService.UpsertConceptAsync(transaction, partition, alias, derivedQuantityKind));
            }

            foreach (var definition in this.ResolveFromRequestCache(derivedQuantityKind.Definition))
            {
                results.Add(await this.DefinitionService.UpsertConceptAsync(transaction, partition, definition, derivedQuantityKind));
            }

            foreach (var hyperLink in this.ResolveFromRequestCache(derivedQuantityKind.HyperLink))
            {
                results.Add(await this.HyperLinkService.UpsertConceptAsync(transaction, partition, hyperLink, derivedQuantityKind));
            }

            foreach (var quantityKindFactor in this.ResolveFromRequestCache(derivedQuantityKind.QuantityKindFactor))
            {
                results.Add(await this.QuantityKindFactorService.UpsertConceptAsync(transaction, partition, (QuantityKindFactor)quantityKindFactor.V, derivedQuantityKind, quantityKindFactor.K));
            }

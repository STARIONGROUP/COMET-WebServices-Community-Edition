...
namespace CometServer.Services
{
    ...
    public sealed partial class DateTimeParameterTypeService : ServiceBase, IDateTimeParameterTypeService
    {
        ...
        public async Task<IEnumerable<Thing>> GetShallowAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var dateTimeParameterTypeColl = new List<Thing>(await this.DateTimeParameterTypeDao.ReadAsync(transaction, partition, idFilter, isCachedDtoReadEnabled, sessionInstant));

...
namespace CometServer.Services
{
    ...
    public sealed partial class DiagrammingStyleService : ServiceBase, IDiagrammingStyleService
    {
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="DiagrammingStyle"/>, optionally with contained <see cref="Thing"/>s.
        /// </returns>
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="DiagrammingStyle"/>.
        /// </returns>
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            diagrammingStyleColl.AddRange(this.OwnedStyleService.GetShallow(transaction, partition, idFilter, authorizedContext));
            diagrammingStyleColl.AddRange(this.SharedStyleService.GetShallow(transaction, partition, idFilter, authorizedContext));

            return this.AfterGet(diagrammingStyleColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="DiagrammingStyle"/> and contained <see cref="Thing"/>s.
        /// </returns>
        public IEnumerable<Thing> GetDeep(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            results.AddRange(this.OwnedStyleService.GetDeep(transaction, partition, idFilter, containerSecurityContext));
            results.AddRange(this.SharedStyleService.GetDeep(transaction, partition, idFilter, containerSecurityContext));
            return results;
        }

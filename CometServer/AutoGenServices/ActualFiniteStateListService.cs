...
namespace CometServer.Services
{
    ...
    public sealed partial class ActualFiniteStateListService : ServiceBase, IActualFiniteStateListService
    {
        ...
        public async Task<IEnumerable<Thing>> GetShallowAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var actualFiniteStateListColl = new List<Thing>(await this.ActualFiniteStateListDao.ReadAsync(transaction, partition, idFilter, isCachedDtoReadEnabled, sessionInstant));

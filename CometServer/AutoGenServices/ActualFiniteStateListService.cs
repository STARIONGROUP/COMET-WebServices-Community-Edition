...
namespace CometServer.Services
{
    ...
    /// <summary>
    /// The <see cref="ActualFiniteStateList"/> Service which uses the ORM layer to interact with the data model.
    /// </summary>
    public sealed partial class ActualFiniteStateListService : ServiceBase, IActualFiniteStateListService
    {
        /// <summary>
        /// Gets or sets the <see cref="IActualFiniteStateService"/>.
        /// </summary>
        public IActualFiniteStateService ActualStateService { get; set; }

        /// <summary>
        /// Gets or sets the <see cref="IActualFiniteStateListDao"/>.
        /// </summary>
        public IActualFiniteStateListDao ActualFiniteStateListDao { get; set; }

        /// <summary>
        /// Get the requested <see cref="ActualFiniteStateList"/>s from the ORM layer.
        /// </summary>
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having a list of instances of <see cref="ActualFiniteStateList"/>, optionally with contained <see cref="Thing"/>s as result.
        /// </returns>
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="ActualFiniteStateList"/> id that will be the source for each link table record.
        /// </param>
        /// <param name="value">
        ...
        {
            return await this.ActualFiniteStateListDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="ActualFiniteStateList"/> id that is the source of the link table records.
        /// </param>
        /// <param name="value">
        ...
        {
            return await this.ActualFiniteStateListDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="ActualFiniteStateList"/> id that is the source for the reordered link table record.
        /// </param>
        ...
        {
            return await this.ActualFiniteStateListDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        /// <summary>
        /// Delete the supplied <see cref="ActualFiniteStateList"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="ActualFiniteStateList"/> to delete.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="ActualFiniteStateList"/> to be removed.
        /// </param>
        /// <returns>
        ...
        public async Task<bool> DeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return await this.ActualFiniteStateListDao.DeleteAsync(transaction, partition, thing.Iid);
        }
        ...
        public async Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return await this.ActualFiniteStateListDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

        /// <summary>
        /// Update the supplied <see cref="ActualFiniteStateList"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="ActualFiniteStateList"/> <see cref="Thing"/> to update.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="ActualFiniteStateList"/> to be updated.
        /// </param>
        /// <returns>
        ...
        public async Task<bool> UpdateConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return await this.ActualFiniteStateListDao.UpdateAsync(transaction, partition, actualFiniteStateList, container);
        }

        /// <summary>
        /// Persist the supplied <see cref="ActualFiniteStateList"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        public async Task<bool> CreateConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var actualFiniteStateList = thing as ActualFiniteStateList;
            var createSuccesful = await this.ActualFiniteStateListDao.WriteAsync(transaction, partition, actualFiniteStateList, container);
            return createSuccesful && await this.CreateContainmentAsync(transaction, partition, actualFiniteStateList);
        }
        ...
        {
            var actualFiniteStateList = thing as ActualFiniteStateList;
            var createSuccesful = await this.ActualFiniteStateListDao.UpsertAsync(transaction, partition, actualFiniteStateList, container);
            return createSuccesful && await this.UpsertContainmentAsync(transaction, partition, actualFiniteStateList);
        }
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having List of instances of <see cref="ActualFiniteStateList"/> as result.
        /// </returns>
        public async Task<IEnumerable<Thing>> GetShallowAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var authorizedContext = this.AuthorizeReadRequest("ActualFiniteStateList", containerSecurityContext, partition);
            ...
            var actualFiniteStateListColl = new List<Thing>(await this.ActualFiniteStateListDao.ReadAsync(transaction, partition, idFilter, await this.TransactionManager.IsCachedDtoReadEnabledAsync(transaction), (DateTime)(await this.TransactionManager.GetRawSessionInstantAsync(transaction))));

            return await this.AfterGetAsync(actualFiniteStateListColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having List of instances of <see cref="ActualFiniteStateList"/> and contained <see cref="Thing"/>s as result.
        /// </returns>
        public async Task<IEnumerable<Thing>> GetDeepAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            results.AddRange(await this.ActualStateService.GetDeepAsync(transaction, partition, actualFiniteStateListColl.SelectMany(x => x.ActualState), containerSecurityContext));
        ...
        /// An awaitable <see cref="Task"/> having True if the persistence was successful as result.
        /// </returns>
        private async Task<bool> CreateContainmentAsync(NpgsqlTransaction transaction, string partition, ActualFiniteStateList actualFiniteStateList)
        {
            var results = new List<bool>();

            foreach (var actualState in this.ResolveFromRequestCache(actualFiniteStateList.ActualState))
            {
                results.Add(await this.ActualStateService.CreateConceptAsync(transaction, partition, actualState, actualFiniteStateList));
            }
        ...
        /// An awaitable <see cref="Task"/> having True if the persistence was successful as result.
        /// </returns>
        private async Task<bool> UpsertContainmentAsync(NpgsqlTransaction transaction, string partition, ActualFiniteStateList actualFiniteStateList)
        {
            var results = new List<bool>();

            foreach (var actualState in this.ResolveFromRequestCache(actualFiniteStateList.ActualState))
            {
                results.Add(await this.ActualStateService.UpsertConceptAsync(transaction, partition, actualState, actualFiniteStateList));
            }

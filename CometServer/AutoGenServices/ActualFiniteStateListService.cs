...
namespace CometServer.Services
{
    ...
    public sealed partial class ActualFiniteStateListService : ServiceBase, IActualFiniteStateListService
    {
        ...
        {
            return this.ActualFiniteStateListDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.ActualFiniteStateListDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.ActualFiniteStateListDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.ActualFiniteStateListDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

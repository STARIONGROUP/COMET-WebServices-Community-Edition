...
namespace CometServer.Services
{
    ...
    public sealed partial class ActualFiniteStateListService : ServiceBase, IActualFiniteStateListService
    {
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="ActualFiniteStateList"/>, optionally with contained <see cref="Thing"/>s.
        /// </returns>
        ...
        {
            return this.ActualFiniteStateListDao.AddToCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.ActualFiniteStateListDao.DeleteFromCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.ActualFiniteStateListDao.ReorderCollectionProperty(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public bool DeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.ActualFiniteStateListDao.Delete(transaction, partition, thing.Iid);
        }
        ...
        public bool RawDeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.ActualFiniteStateListDao.RawDelete(transaction, partition, thing.Iid);
        }
        ...
        public bool UpdateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return this.ActualFiniteStateListDao.Update(transaction, partition, actualFiniteStateList, container);
        }
        ...
        public bool CreateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var actualFiniteStateList = thing as ActualFiniteStateList;
            var createSuccesful = this.ActualFiniteStateListDao.Write(transaction, partition, actualFiniteStateList, container);
            return createSuccesful && this.CreateContainment(transaction, partition, actualFiniteStateList);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="ActualFiniteStateList"/>.
        /// </returns>
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var actualFiniteStateListColl = new List<Thing>(this.ActualFiniteStateListDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction), (DateTime)this.TransactionManager.GetRawSessionInstant(transaction)));

            return this.AfterGet(actualFiniteStateListColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="ActualFiniteStateList"/> and contained <see cref="Thing"/>s.
        /// </returns>
        ...
        /// True if the persistence was successful.
        /// </returns>
        private bool CreateContainment(NpgsqlTransaction transaction, string partition, ActualFiniteStateList actualFiniteStateList)
        {

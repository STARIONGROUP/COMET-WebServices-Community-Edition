// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ReferenceDataLibraryService.cs" company="Starion Group S.A.">
...
namespace CometServer.Services
{
    ...
    /// <summary>
    /// The <see cref="ReferenceDataLibrary"/> Service which uses the ORM layer to interact with the data model.
    /// </summary>
    public sealed partial class ReferenceDataLibraryService : ServiceBase, IReferenceDataLibraryService
    {
        ...
        /// <summary>
        /// Get the requested <see cref="ReferenceDataLibrary"/>s from the ORM layer.
        /// </summary>
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having a list of instances of <see cref="ReferenceDataLibrary"/>, optionally with contained <see cref="Thing"/>s as result.
        /// </returns>
        ...
        /// <summary>
        /// Delete the supplied <see cref="ReferenceDataLibrary"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// The container instance of the <see cref="ReferenceDataLibrary"/> to be removed.
        /// </param>
        /// <returns>
        ...
        /// <summary>
        /// Update the supplied <see cref="ReferenceDataLibrary"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="ReferenceDataLibrary"/> <see cref="Thing"/> to update.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="ReferenceDataLibrary"/> to be updated.
        /// </param>
        /// <returns>
        ...
        /// <summary>
        /// Persist the supplied <see cref="ReferenceDataLibrary"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="ReferenceDataLibrary"/> <see cref="Thing"/> to create.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="ReferenceDataLibrary"/> to be persisted.
        /// </param>
        /// <param name="sequence">
        ...
        /// <summary>
        /// Persist the supplied <see cref="ReferenceDataLibrary"/> instance. Update if it already exists.
        /// This is typically used during the import of existing data to the Database.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having List of instances of <see cref="ReferenceDataLibrary"/> as result.
        /// </returns>
        public async Task<IEnumerable<Thing>> GetShallowAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            referenceDataLibraryColl.AddRange(await this.ModelReferenceDataLibraryService.GetShallowAsync(transaction, partition, idFilter, authorizedContext));
            referenceDataLibraryColl.AddRange(await this.SiteReferenceDataLibraryService.GetShallowAsync(transaction, partition, idFilter, authorizedContext));

            return await this.AfterGetAsync(referenceDataLibraryColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having List of instances of <see cref="ReferenceDataLibrary"/> and contained <see cref="Thing"/>s as result.
        /// </returns>
        public async Task<IEnumerable<Thing>> GetDeepAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            results.AddRange(await this.ModelReferenceDataLibraryService.GetDeepAsync(transaction, partition, idFilter, containerSecurityContext));
            results.AddRange(await this.SiteReferenceDataLibraryService.GetDeepAsync(transaction, partition, idFilter, containerSecurityContext));
            return results;
        }

...
namespace CometServer.Services
{
    ...
    public sealed partial class ActualFiniteStateService : ServiceBase, IActualFiniteStateService
    {
        ...
        public async Task<IEnumerable<Thing>> GetShallowAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var actualFiniteStateColl = new List<Thing>(await this.ActualFiniteStateDao.ReadAsync(transaction, partition, idFilter, isCachedDtoReadEnabled, sessionInstant));

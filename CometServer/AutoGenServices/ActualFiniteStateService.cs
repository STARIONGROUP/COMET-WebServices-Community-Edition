...
namespace CometServer.Services
{
    ...
    public sealed partial class ActualFiniteStateService : ServiceBase, IActualFiniteStateService
    {
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="ActualFiniteState"/>, optionally with contained <see cref="Thing"/>s.
        /// </returns>
        ...
        {
            return this.ActualFiniteStateDao.AddToCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.ActualFiniteStateDao.DeleteFromCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.ActualFiniteStateDao.ReorderCollectionProperty(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public bool DeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.ActualFiniteStateDao.Delete(transaction, partition, thing.Iid);
        }
        ...
        public bool RawDeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.ActualFiniteStateDao.RawDelete(transaction, partition, thing.Iid);
        }
        ...
        public bool UpdateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return this.ActualFiniteStateDao.Update(transaction, partition, actualFiniteState, container);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="ActualFiniteState"/>.
        /// </returns>
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var actualFiniteStateColl = new List<Thing>(this.ActualFiniteStateDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction), (DateTime)this.TransactionManager.GetRawSessionInstant(transaction)));

            return this.AfterGet(actualFiniteStateColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="ActualFiniteState"/> and contained <see cref="Thing"/>s.
        /// </returns>

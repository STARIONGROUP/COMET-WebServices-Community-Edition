...
namespace CometServer.Services
{
    ...
    public sealed partial class ActualFiniteStateService : ServiceBase, IActualFiniteStateService
    {
        ...
        {
            return this.ActualFiniteStateDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.ActualFiniteStateDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.ActualFiniteStateDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.ActualFiniteStateDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

...
namespace CometServer.Services
{
    ...
    public sealed partial class SiteDirectoryThingReferenceService : ServiceBase, ISiteDirectoryThingReferenceService
    {
        ...
        public async Task<IEnumerable<Thing>> GetShallowAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var siteDirectoryThingReferenceColl = new List<Thing>(await this.SiteDirectoryThingReferenceDao.ReadAsync(transaction, partition, idFilter, isCachedDtoReadEnabled, sessionInstant));

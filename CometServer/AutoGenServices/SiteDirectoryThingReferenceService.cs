...
namespace CometServer.Services
{
    ...
    public sealed partial class SiteDirectoryThingReferenceService : ServiceBase, ISiteDirectoryThingReferenceService
    {
        ...
        {
            return this.SiteDirectoryThingReferenceDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.SiteDirectoryThingReferenceDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.SiteDirectoryThingReferenceDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.SiteDirectoryThingReferenceDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

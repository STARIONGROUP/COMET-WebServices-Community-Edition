// --------------------------------------------------------------------------------------------------------------------
// <copyright file="SiteDirectoryThingReferenceService.cs" company="Starion Group S.A.">
...
namespace CometServer.Services
{
    ...
    /// <summary>
    /// The <see cref="SiteDirectoryThingReference"/> Service which uses the ORM layer to interact with the data model.
    /// </summary>
    public sealed partial class SiteDirectoryThingReferenceService : ServiceBase, ISiteDirectoryThingReferenceService
    {
        /// <summary>
        /// Gets or sets the <see cref="ISiteDirectoryThingReferenceDao"/>.
        /// </summary>
        public ISiteDirectoryThingReferenceDao SiteDirectoryThingReferenceDao { get; set; }

        /// <summary>
        /// Get the requested <see cref="SiteDirectoryThingReference"/>s from the ORM layer.
        /// </summary>
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having a list of instances of <see cref="SiteDirectoryThingReference"/>, optionally with contained <see cref="Thing"/>s as result.
        /// </returns>
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="SiteDirectoryThingReference"/> id that will be the source for each link table record.
        /// </param>
        /// <param name="value">
        ...
        {
            return await this.SiteDirectoryThingReferenceDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="SiteDirectoryThingReference"/> id that is the source of the link table records.
        /// </param>
        /// <param name="value">
        ...
        {
            return await this.SiteDirectoryThingReferenceDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="SiteDirectoryThingReference"/> id that is the source for the reordered link table record.
        /// </param>
        ...
        {
            return await this.SiteDirectoryThingReferenceDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        /// <summary>
        /// Delete the supplied <see cref="SiteDirectoryThingReference"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="SiteDirectoryThingReference"/> to delete.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="SiteDirectoryThingReference"/> to be removed.
        /// </param>
        /// <returns>
        ...
        public async Task<bool> DeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return await this.SiteDirectoryThingReferenceDao.DeleteAsync(transaction, partition, thing.Iid);
        }
        ...
        public async Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return await this.SiteDirectoryThingReferenceDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

        /// <summary>
        /// Update the supplied <see cref="SiteDirectoryThingReference"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="SiteDirectoryThingReference"/> <see cref="Thing"/> to update.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="SiteDirectoryThingReference"/> to be updated.
        /// </param>
        /// <returns>
        ...
        public async Task<bool> UpdateConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return await this.SiteDirectoryThingReferenceDao.UpdateAsync(transaction, partition, siteDirectoryThingReference, container);
        }

        /// <summary>
        /// Persist the supplied <see cref="SiteDirectoryThingReference"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="SiteDirectoryThingReference"/> <see cref="Thing"/> to create.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="SiteDirectoryThingReference"/> to be persisted.
        /// </param>
        /// <param name="sequence">
        ...
        public async Task<bool> CreateConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var siteDirectoryThingReference = thing as SiteDirectoryThingReference;
            return await this.SiteDirectoryThingReferenceDao.WriteAsync(transaction, partition, siteDirectoryThingReference, container);
        }

        /// <summary>
        /// Persist the supplied <see cref="SiteDirectoryThingReference"/> instance. Update if it already exists.
        /// This is typically used during the import of existing data to the Database.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        ...
        {
            var siteDirectoryThingReference = thing as SiteDirectoryThingReference;
            return await this.SiteDirectoryThingReferenceDao.UpsertAsync(transaction, partition, siteDirectoryThingReference, container);
        }
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having List of instances of <see cref="SiteDirectoryThingReference"/> as result.
        /// </returns>
        public async Task<IEnumerable<Thing>> GetShallowAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var authorizedContext = this.AuthorizeReadRequest("SiteDirectoryThingReference", containerSecurityContext, partition);
            ...
            var siteDirectoryThingReferenceColl = new List<Thing>(await this.SiteDirectoryThingReferenceDao.ReadAsync(transaction, partition, idFilter, await this.TransactionManager.IsCachedDtoReadEnabledAsync(transaction), (DateTime)(await this.TransactionManager.GetRawSessionInstantAsync(transaction))));

            return await this.AfterGetAsync(siteDirectoryThingReferenceColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having List of instances of <see cref="SiteDirectoryThingReference"/> and contained <see cref="Thing"/>s as result.
        /// </returns>

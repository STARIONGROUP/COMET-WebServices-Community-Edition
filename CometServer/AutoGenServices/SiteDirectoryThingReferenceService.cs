...
namespace CometServer.Services
{
    ...
    public sealed partial class SiteDirectoryThingReferenceService : ServiceBase, ISiteDirectoryThingReferenceService
    {
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="SiteDirectoryThingReference"/>, optionally with contained <see cref="Thing"/>s.
        /// </returns>
        ...
        {
            return this.SiteDirectoryThingReferenceDao.AddToCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.SiteDirectoryThingReferenceDao.DeleteFromCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.SiteDirectoryThingReferenceDao.ReorderCollectionProperty(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public bool DeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.SiteDirectoryThingReferenceDao.Delete(transaction, partition, thing.Iid);
        }
        ...
        public bool RawDeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.SiteDirectoryThingReferenceDao.RawDelete(transaction, partition, thing.Iid);
        }
        ...
        public bool UpdateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return this.SiteDirectoryThingReferenceDao.Update(transaction, partition, siteDirectoryThingReference, container);
        }
        ...
        public bool CreateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var siteDirectoryThingReference = thing as SiteDirectoryThingReference;
            return this.SiteDirectoryThingReferenceDao.Write(transaction, partition, siteDirectoryThingReference, container);
        }
        ...
        {
            var siteDirectoryThingReference = thing as SiteDirectoryThingReference;
            return this.SiteDirectoryThingReferenceDao.Upsert(transaction, partition, siteDirectoryThingReference, container);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="SiteDirectoryThingReference"/>.
        /// </returns>
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var siteDirectoryThingReferenceColl = new List<Thing>(this.SiteDirectoryThingReferenceDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction), (DateTime)this.TransactionManager.GetRawSessionInstant(transaction)));

            return this.AfterGet(siteDirectoryThingReferenceColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="SiteDirectoryThingReference"/> and contained <see cref="Thing"/>s.
        /// </returns>

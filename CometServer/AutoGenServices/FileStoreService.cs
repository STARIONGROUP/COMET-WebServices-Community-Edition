// --------------------------------------------------------------------------------------------------------------------
// <copyright file="FileStoreService.cs" company="RHEA System S.A.">
...
namespace CometServer.Services
{
    ...
    public sealed partial class FileStoreService : ServiceBase, IFileStoreService
    {
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="FileStore"/>, optionally with contained <see cref="Thing"/>s.
        /// </returns>
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="FileStore"/>.
        /// </returns>
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            fileStoreColl.AddRange(this.CommonFileStoreService.GetShallow(transaction, partition, idFilter, authorizedContext));
            fileStoreColl.AddRange(this.DomainFileStoreService.GetShallow(transaction, partition, idFilter, authorizedContext));

            return this.AfterGet(fileStoreColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="FileStore"/> and contained <see cref="Thing"/>s.
        /// </returns>
        public IEnumerable<Thing> GetDeep(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            results.AddRange(this.CommonFileStoreService.GetDeep(transaction, partition, idFilter, containerSecurityContext));
            results.AddRange(this.DomainFileStoreService.GetDeep(transaction, partition, idFilter, containerSecurityContext));
            return results;
        }

...
namespace CometServer.Services
{
    ...
    public sealed partial class ParameterBaseService : ServiceBase, IParameterBaseService
    {
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="ParameterBase"/>, optionally with contained <see cref="Thing"/>s.
        /// </returns>
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="ParameterBase"/>.
        /// </returns>
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            parameterBaseColl.AddRange(this.ParameterOrOverrideBaseService.GetShallow(transaction, partition, idFilter, authorizedContext));
            parameterBaseColl.AddRange(this.ParameterSubscriptionService.GetShallow(transaction, partition, idFilter, authorizedContext));

            return this.AfterGet(parameterBaseColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="ParameterBase"/> and contained <see cref="Thing"/>s.
        /// </returns>
        public IEnumerable<Thing> GetDeep(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            results.AddRange(this.ParameterOrOverrideBaseService.GetDeep(transaction, partition, idFilter, containerSecurityContext));
            results.AddRange(this.ParameterSubscriptionService.GetDeep(transaction, partition, idFilter, containerSecurityContext));
            return results;
        }

...
namespace CometServer.Services
{
    ...
    public sealed partial class BoundsService : ServiceBase, IBoundsService
    {
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="Bounds"/>, optionally with contained <see cref="Thing"/>s.
        /// </returns>
        ...
        {
            return this.BoundsDao.AddToCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.BoundsDao.DeleteFromCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.BoundsDao.ReorderCollectionProperty(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public bool DeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.BoundsDao.Delete(transaction, partition, thing.Iid);
        }
        ...
        public bool RawDeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.BoundsDao.RawDelete(transaction, partition, thing.Iid);
        }
        ...
        public bool UpdateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return this.BoundsDao.Update(transaction, partition, bounds, container);
        }
        ...
        public bool CreateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var bounds = thing as Bounds;
            return this.BoundsDao.Write(transaction, partition, bounds, container);
        }
        ...
        {
            var bounds = thing as Bounds;
            return this.BoundsDao.Upsert(transaction, partition, bounds, container);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="Bounds"/>.
        /// </returns>
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var boundsColl = new List<Thing>(this.BoundsDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction), (DateTime)this.TransactionManager.GetRawSessionInstant(transaction)));

            return this.AfterGet(boundsColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="Bounds"/> and contained <see cref="Thing"/>s.
        /// </returns>

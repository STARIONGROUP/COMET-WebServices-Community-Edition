...
namespace CometServer.Services
{
    ...
    public sealed partial class BoundsService : ServiceBase, IBoundsService
    {
        ...
        {
            return this.BoundsDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.BoundsDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.BoundsDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.BoundsDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

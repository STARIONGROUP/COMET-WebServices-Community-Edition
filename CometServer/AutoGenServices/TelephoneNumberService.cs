...
namespace CometServer.Services
{
    ...
    public sealed partial class TelephoneNumberService : ServiceBase, ITelephoneNumberService
    {
        ...
        {
            return this.TelephoneNumberDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.TelephoneNumberDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.TelephoneNumberDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.TelephoneNumberDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

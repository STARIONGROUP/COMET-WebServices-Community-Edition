...
namespace CometServer.Services
{
    ...
    public sealed partial class TelephoneNumberService : ServiceBase, ITelephoneNumberService
    {
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="TelephoneNumber"/>, optionally with contained <see cref="Thing"/>s.
        /// </returns>
        ...
        {
            return this.TelephoneNumberDao.AddToCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.TelephoneNumberDao.DeleteFromCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.TelephoneNumberDao.ReorderCollectionProperty(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public bool DeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.TelephoneNumberDao.Delete(transaction, partition, thing.Iid);
        }
        ...
        public bool RawDeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.TelephoneNumberDao.RawDelete(transaction, partition, thing.Iid);
        }
        ...
        public bool UpdateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return this.TelephoneNumberDao.Update(transaction, partition, telephoneNumber, container);
        }
        ...
        public bool CreateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var telephoneNumber = thing as TelephoneNumber;
            return this.TelephoneNumberDao.Write(transaction, partition, telephoneNumber, container);
        }
        ...
        {
            var telephoneNumber = thing as TelephoneNumber;
            return this.TelephoneNumberDao.Upsert(transaction, partition, telephoneNumber, container);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="TelephoneNumber"/>.
        /// </returns>
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var telephoneNumberColl = new List<Thing>(this.TelephoneNumberDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction), (DateTime)this.TransactionManager.GetRawSessionInstant(transaction)));

            return this.AfterGet(telephoneNumberColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="TelephoneNumber"/> and contained <see cref="Thing"/>s.
        /// </returns>

...
namespace CometServer.Services
{
    ...
    public sealed partial class ParameterValueSetBaseService : ServiceBase, IParameterValueSetBaseService
    {
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="ParameterValueSetBase"/>, optionally with contained <see cref="Thing"/>s.
        /// </returns>
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="ParameterValueSetBase"/>.
        /// </returns>
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            parameterValueSetBaseColl.AddRange(this.ParameterOverrideValueSetService.GetShallow(transaction, partition, idFilter, authorizedContext));
            parameterValueSetBaseColl.AddRange(this.ParameterValueSetService.GetShallow(transaction, partition, idFilter, authorizedContext));

            return this.AfterGet(parameterValueSetBaseColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="ParameterValueSetBase"/> and contained <see cref="Thing"/>s.
        /// </returns>
        public IEnumerable<Thing> GetDeep(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            results.AddRange(this.ParameterOverrideValueSetService.GetDeep(transaction, partition, idFilter, containerSecurityContext));
            results.AddRange(this.ParameterValueSetService.GetDeep(transaction, partition, idFilter, containerSecurityContext));
            return results;
        }

...
namespace CometServer.Services
{
    ...
    public sealed partial class ValueGroupService : ServiceBase, IValueGroupService
    {
        ...
        {
            return this.ValueGroupDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.ValueGroupDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.ValueGroupDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.ValueGroupDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

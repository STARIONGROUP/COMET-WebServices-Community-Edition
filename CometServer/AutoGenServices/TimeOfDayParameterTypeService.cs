...
namespace CometServer.Services
{
    ...
    public sealed partial class TimeOfDayParameterTypeService : ServiceBase, ITimeOfDayParameterTypeService
    {
        ...
        public async Task<IEnumerable<Thing>> GetShallowAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var timeOfDayParameterTypeColl = new List<Thing>(await this.TimeOfDayParameterTypeDao.ReadAsync(transaction, partition, idFilter, isCachedDtoReadEnabled, sessionInstant));

// --------------------------------------------------------------------------------------------------------------------
// <copyright file="TimeOfDayParameterTypeService.cs" company="RHEA System S.A.">
...
namespace CometServer.Services
{
    ...
    public sealed partial class TimeOfDayParameterTypeService : ServiceBase, ITimeOfDayParameterTypeService
    {
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="TimeOfDayParameterType"/>, optionally with contained <see cref="Thing"/>s.
        /// </returns>
        ...
        {
            return this.TimeOfDayParameterTypeDao.AddToCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.TimeOfDayParameterTypeDao.DeleteFromCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.TimeOfDayParameterTypeDao.ReorderCollectionProperty(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public bool DeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.TimeOfDayParameterTypeDao.Delete(transaction, partition, thing.Iid);
        }
        ...
        public bool RawDeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.TimeOfDayParameterTypeDao.RawDelete(transaction, partition, thing.Iid);
        }
        ...
        public bool UpdateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return this.TimeOfDayParameterTypeDao.Update(transaction, partition, timeOfDayParameterType, container);
        }
        ...
        public bool CreateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var timeOfDayParameterType = thing as TimeOfDayParameterType;
            var createSuccesful = this.TimeOfDayParameterTypeDao.Write(transaction, partition, timeOfDayParameterType, container);
            return createSuccesful && this.CreateContainment(transaction, partition, timeOfDayParameterType);
        }
        ...
        {
            var timeOfDayParameterType = thing as TimeOfDayParameterType;
            var createSuccesful = this.TimeOfDayParameterTypeDao.Upsert(transaction, partition, timeOfDayParameterType, container);
            return createSuccesful && this.UpsertContainment(transaction, partition, timeOfDayParameterType);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="TimeOfDayParameterType"/>.
        /// </returns>
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var timeOfDayParameterTypeColl = new List<Thing>(this.TimeOfDayParameterTypeDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction), (DateTime)this.TransactionManager.GetRawSessionInstant(transaction)));

            return this.AfterGet(timeOfDayParameterTypeColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="TimeOfDayParameterType"/> and contained <see cref="Thing"/>s.
        /// </returns>
        public IEnumerable<Thing> GetDeep(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            results.AddRange(this.AliasService.GetDeep(transaction, partition, timeOfDayParameterTypeColl.SelectMany(x => x.Alias), containerSecurityContext));
            results.AddRange(this.AttachmentService.GetDeep(transaction, partition, timeOfDayParameterTypeColl.SelectMany(x => x.Attachment), containerSecurityContext));
            results.AddRange(this.DefinitionService.GetDeep(transaction, partition, timeOfDayParameterTypeColl.SelectMany(x => x.Definition), containerSecurityContext));
            results.AddRange(this.HyperLinkService.GetDeep(transaction, partition, timeOfDayParameterTypeColl.SelectMany(x => x.HyperLink), containerSecurityContext));
        ...
        private bool CreateContainment(NpgsqlTransaction transaction, string partition, TimeOfDayParameterType timeOfDayParameterType)
        {
            ...
            foreach (var attachment in this.ResolveFromRequestCache(timeOfDayParameterType.Attachment))
            {
                results.Add(this.AttachmentService.CreateConcept(transaction, partition, attachment, timeOfDayParameterType));
            }
        ...
        /// True if the persistence was successful.
        /// </returns>
        private bool UpsertContainment(NpgsqlTransaction transaction, string partition, TimeOfDayParameterType timeOfDayParameterType)
        {
            var results = new List<bool>();

            foreach (var alias in this.ResolveFromRequestCache(timeOfDayParameterType.Alias))
            {
                results.Add(this.AliasService.UpsertConcept(transaction, partition, alias, timeOfDayParameterType));
            }

            foreach (var attachment in this.ResolveFromRequestCache(timeOfDayParameterType.Attachment))
            {
                results.Add(this.AttachmentService.UpsertConcept(transaction, partition, attachment, timeOfDayParameterType));
            }

            foreach (var definition in this.ResolveFromRequestCache(timeOfDayParameterType.Definition))
            {
                results.Add(this.DefinitionService.UpsertConcept(transaction, partition, definition, timeOfDayParameterType));
            }

            foreach (var hyperLink in this.ResolveFromRequestCache(timeOfDayParameterType.HyperLink))
            {
                results.Add(this.HyperLinkService.UpsertConcept(transaction, partition, hyperLink, timeOfDayParameterType));
            }

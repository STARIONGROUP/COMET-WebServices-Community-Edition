// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ConstantService.cs" company="RHEA System S.A.">
...
namespace CometServer.Services
{
    ...
    /// <summary>
    /// The <see cref="Constant"/> Service which uses the ORM layer to interact with the data model.
    /// </summary>
    public sealed partial class ConstantService : ServiceBase, IConstantService
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets or sets the <see cref="IConstantDao"/>.
        /// </summary>
        public IConstantDao ConstantDao { get; set; }

        /// <summary>
        /// Get the requested <see cref="Constant"/>s from the ORM layer.
        /// </summary>
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="Constant"/>, optionally with contained <see cref="Thing"/>s.
        /// </returns>
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="Constant"/> id that will be the source for each link table record.
        /// </param>
        /// <param name="value">
        ...
        {
            return this.ConstantDao.AddToCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="Constant"/> id that is the source of the link table records.
        /// </param>
        /// <param name="value">
        ...
        {
            return this.ConstantDao.DeleteFromCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="Constant"/> id that is the source for the reordered link table record.
        /// </param>
        ...
        {
            return this.ConstantDao.ReorderCollectionProperty(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        /// <summary>
        /// Delete the supplied <see cref="Constant"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="Constant"/> to delete.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="Constant"/> to be removed.
        /// </param>
        /// <returns>
        ...
        public bool DeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.ConstantDao.Delete(transaction, partition, thing.Iid);
        }
        ...
        public bool RawDeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.ConstantDao.RawDelete(transaction, partition, thing.Iid);
        }

        /// <summary>
        /// Update the supplied <see cref="Constant"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="Constant"/> <see cref="Thing"/> to update.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="Constant"/> to be updated.
        /// </param>
        /// <returns>
        ...
        public bool UpdateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return this.ConstantDao.Update(transaction, partition, constant, container);
        }

        /// <summary>
        /// Persist the supplied <see cref="Constant"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="Constant"/> <see cref="Thing"/> to create.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="Constant"/> to be persisted.
        /// </param>
        /// <param name="sequence">
        ...
        public bool CreateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var constant = thing as Constant;
            var createSuccesful = this.ConstantDao.Write(transaction, partition, constant, container);
            return createSuccesful && this.CreateContainment(transaction, partition, constant);
        }

        /// <summary>
        /// Persist the supplied <see cref="Constant"/> instance. Update if it already exists.
        /// This is typically used during the import of existing data to the Database.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        ...
        {
            var constant = thing as Constant;
            var createSuccesful = this.ConstantDao.Upsert(transaction, partition, constant, container);
            return createSuccesful && this.UpsertContainment(transaction, partition, constant);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="Constant"/>.
        /// </returns>
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var authorizedContext = this.AuthorizeReadRequest("Constant", containerSecurityContext, partition);
            ...
            var constantColl = new List<Thing>(this.ConstantDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction), (DateTime)this.TransactionManager.GetRawSessionInstant(transaction)));

            return this.AfterGet(constantColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="Constant"/> and contained <see cref="Thing"/>s.
        /// </returns>
        public IEnumerable<Thing> GetDeep(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            results.AddRange(this.AttachmentService.GetDeep(transaction, partition, constantColl.SelectMany(x => x.Attachment), containerSecurityContext));
            ...
            results.AddRange(this.HyperLinkService.GetDeep(transaction, partition, constantColl.SelectMany(x => x.HyperLink), containerSecurityContext));
        ...
        /// <summary>
        /// Persist the <see cref="Constant"/> containment tree to the ORM layer.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="constant">
        /// The <see cref="Constant"/> instance to persist.
        /// </param>
        /// <returns>
        /// True if the persistence was successful.
        /// </returns>
        private bool CreateContainment(NpgsqlTransaction transaction, string partition, Constant constant)
        {
            var results = new List<bool>();

            foreach (var alias in this.ResolveFromRequestCache(constant.Alias))
            {
                results.Add(this.AliasService.CreateConcept(transaction, partition, alias, constant));
            }

            foreach (var attachment in this.ResolveFromRequestCache(constant.Attachment))
            {
                results.Add(this.AttachmentService.CreateConcept(transaction, partition, attachment, constant));
            }

            foreach (var definition in this.ResolveFromRequestCache(constant.Definition))
            {
                results.Add(this.DefinitionService.CreateConcept(transaction, partition, definition, constant));
            }

            foreach (var hyperLink in this.ResolveFromRequestCache(constant.HyperLink))
            {
                results.Add(this.HyperLinkService.CreateConcept(transaction, partition, hyperLink, constant));
            }
        ...
        /// <summary>
        /// Persist the <see cref="Constant"/> containment tree to the ORM layer. Update if it already exists.
        /// This is typically used during the import of existing data to the Database.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        ...
        /// True if the persistence was successful.
        /// </returns>
        private bool UpsertContainment(NpgsqlTransaction transaction, string partition, Constant constant)
        {
            var results = new List<bool>();

            foreach (var alias in this.ResolveFromRequestCache(constant.Alias))
            {
                results.Add(this.AliasService.UpsertConcept(transaction, partition, alias, constant));
            }

            foreach (var attachment in this.ResolveFromRequestCache(constant.Attachment))
            {
                results.Add(this.AttachmentService.UpsertConcept(transaction, partition, attachment, constant));
            }

            foreach (var definition in this.ResolveFromRequestCache(constant.Definition))
            {
                results.Add(this.DefinitionService.UpsertConcept(transaction, partition, definition, constant));
            }

            foreach (var hyperLink in this.ResolveFromRequestCache(constant.HyperLink))
            {
                results.Add(this.HyperLinkService.UpsertConcept(transaction, partition, hyperLink, constant));
            }

...
namespace CometServer.Services
{
    ...
    public sealed partial class ConstantService : ServiceBase, IConstantService
    {
        ...
        {
            return this.ConstantDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.ConstantDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.ConstantDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.ConstantDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

...
namespace CometServer.Services
{
    ...
    public sealed partial class RequestForDeviationService : ServiceBase, IRequestForDeviationService
    {
        ...
        public async Task<IEnumerable<Thing>> GetShallowAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var requestForDeviationColl = new List<Thing>(await this.RequestForDeviationDao.ReadAsync(transaction, partition, idFilter, isCachedDtoReadEnabled, sessionInstant));

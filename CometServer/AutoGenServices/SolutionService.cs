...
namespace CometServer.Services
{
    ...
    public sealed partial class SolutionService : ServiceBase, ISolutionService
    {
        ...
        {
            return this.SolutionDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.SolutionDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.SolutionDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.SolutionDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

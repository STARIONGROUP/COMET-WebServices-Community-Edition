...
namespace CometServer.Services
{
    ...
    public sealed partial class SolutionService : ServiceBase, ISolutionService
    {
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="Solution"/>, optionally with contained <see cref="Thing"/>s.
        /// </returns>
        ...
        {
            return this.SolutionDao.AddToCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.SolutionDao.DeleteFromCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.SolutionDao.ReorderCollectionProperty(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public bool DeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.SolutionDao.Delete(transaction, partition, thing.Iid);
        }
        ...
        public bool RawDeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.SolutionDao.RawDelete(transaction, partition, thing.Iid);
        }
        ...
        public bool UpdateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return this.SolutionDao.Update(transaction, partition, solution, container);
        }
        ...
        public bool CreateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var solution = thing as Solution;
            return this.SolutionDao.Write(transaction, partition, solution, container);
        }
        ...
        {
            var solution = thing as Solution;
            return this.SolutionDao.Upsert(transaction, partition, solution, container);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="Solution"/>.
        /// </returns>
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var solutionColl = new List<Thing>(this.SolutionDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction), (DateTime)this.TransactionManager.GetRawSessionInstant(transaction)));

            return this.AfterGet(solutionColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="Solution"/> and contained <see cref="Thing"/>s.
        /// </returns>

...
namespace CometServer.Services
{
    ...
    public sealed partial class EnumerationValueDefinitionService : ServiceBase, IEnumerationValueDefinitionService
    {
        ...
        public async Task<IEnumerable<Thing>> GetShallowAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var enumerationValueDefinitionColl = new List<Thing>(await this.EnumerationValueDefinitionDao.ReadAsync(transaction, partition, idFilter, isCachedDtoReadEnabled, sessionInstant));

...
namespace CometServer.Services
{
    ...
    public sealed partial class EnumerationValueDefinitionService : ServiceBase, IEnumerationValueDefinitionService
    {
        ...
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var enumerationValueDefinitionColl = new List<Thing>(this.EnumerationValueDefinitionDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction)));

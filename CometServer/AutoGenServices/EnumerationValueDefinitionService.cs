...
namespace CometServer.Services
{
    ...
    public sealed partial class EnumerationValueDefinitionService : ServiceBase, IEnumerationValueDefinitionService
    {
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="EnumerationValueDefinition"/>, optionally with contained <see cref="Thing"/>s.
        /// </returns>
        ...
        {
            return this.EnumerationValueDefinitionDao.AddToCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.EnumerationValueDefinitionDao.DeleteFromCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.EnumerationValueDefinitionDao.ReorderCollectionProperty(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public bool DeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.EnumerationValueDefinitionDao.Delete(transaction, partition, thing.Iid);
        }
        ...
        public bool RawDeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.EnumerationValueDefinitionDao.RawDelete(transaction, partition, thing.Iid);
        }
        ...
        public bool UpdateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return this.EnumerationValueDefinitionDao.Update(transaction, partition, enumerationValueDefinition, container);
        }
        ...
        public bool CreateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var enumerationValueDefinition = thing as EnumerationValueDefinition;
            var createSuccesful = this.EnumerationValueDefinitionDao.Write(transaction, partition, enumerationValueDefinition, sequence, container);
            return createSuccesful && this.CreateContainment(transaction, partition, enumerationValueDefinition);
        }
        ...
        {
            var enumerationValueDefinition = thing as EnumerationValueDefinition;
            var createSuccesful = this.EnumerationValueDefinitionDao.Upsert(transaction, partition, enumerationValueDefinition, sequence, container);
            return createSuccesful && this.UpsertContainment(transaction, partition, enumerationValueDefinition);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="EnumerationValueDefinition"/>.
        /// </returns>
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var enumerationValueDefinitionColl = new List<Thing>(this.EnumerationValueDefinitionDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction), (DateTime)this.TransactionManager.GetRawSessionInstant(transaction)));

            return this.AfterGet(enumerationValueDefinitionColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="EnumerationValueDefinition"/> and contained <see cref="Thing"/>s.
        /// </returns>
        ...
        /// True if the persistence was successful.
        /// </returns>
        private bool CreateContainment(NpgsqlTransaction transaction, string partition, EnumerationValueDefinition enumerationValueDefinition)
        {
            ...
            {
                results.Add(this.HyperLinkService.CreateConcept(transaction, partition, hyperLink, enumerationValueDefinition));
            }
        ...
        /// True if the persistence was successful.
        /// </returns>
        private bool UpsertContainment(NpgsqlTransaction transaction, string partition, EnumerationValueDefinition enumerationValueDefinition)
        {
            var results = new List<bool>();
            ...
            foreach (var definition in this.ResolveFromRequestCache(enumerationValueDefinition.Definition))
            {
                results.Add(this.DefinitionService.UpsertConcept(transaction, partition, definition, enumerationValueDefinition));
            }

            foreach (var hyperLink in this.ResolveFromRequestCache(enumerationValueDefinition.HyperLink))
            {
                results.Add(this.HyperLinkService.UpsertConcept(transaction, partition, hyperLink, enumerationValueDefinition));
            }

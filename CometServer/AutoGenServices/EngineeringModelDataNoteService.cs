// --------------------------------------------------------------------------------------------------------------------
// <copyright file="EngineeringModelDataNoteService.cs" company="Starion Group S.A.">
...
namespace CometServer.Services
{
    ...
    /// <summary>
    /// The <see cref="EngineeringModelDataNote"/> Service which uses the ORM layer to interact with the data model.
    /// </summary>
    public sealed partial class EngineeringModelDataNoteService : ServiceBase, IEngineeringModelDataNoteService
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets or sets the <see cref="IEngineeringModelDataNoteDao"/>.
        /// </summary>
        public IEngineeringModelDataNoteDao EngineeringModelDataNoteDao { get; set; }

        /// <summary>
        /// Get the requested <see cref="EngineeringModelDataNote"/>s from the ORM layer.
        /// </summary>
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having a list of instances of <see cref="EngineeringModelDataNote"/>, optionally with contained <see cref="Thing"/>s as result.
        /// </returns>
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="EngineeringModelDataNote"/> id that will be the source for each link table record.
        /// </param>
        /// <param name="value">
        ...
        {
            return await this.EngineeringModelDataNoteDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="EngineeringModelDataNote"/> id that is the source of the link table records.
        /// </param>
        /// <param name="value">
        ...
        {
            return await this.EngineeringModelDataNoteDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        /// </param>
        /// <param name="iid">
        /// The <see cref="EngineeringModelDataNote"/> id that is the source for the reordered link table record.
        /// </param>
        ...
        {
            return await this.EngineeringModelDataNoteDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        /// <summary>
        /// Delete the supplied <see cref="EngineeringModelDataNote"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="EngineeringModelDataNote"/> to delete.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="EngineeringModelDataNote"/> to be removed.
        /// </param>
        /// <returns>
        ...
        public async Task<bool> DeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return await this.EngineeringModelDataNoteDao.DeleteAsync(transaction, partition, thing.Iid);
        }
        ...
        public async Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return await this.EngineeringModelDataNoteDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

        /// <summary>
        /// Update the supplied <see cref="EngineeringModelDataNote"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="EngineeringModelDataNote"/> <see cref="Thing"/> to update.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="EngineeringModelDataNote"/> to be updated.
        /// </param>
        /// <returns>
        ...
        public async Task<bool> UpdateConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            return await this.EngineeringModelDataNoteDao.UpdateAsync(transaction, partition, engineeringModelDataNote, container);
        }

        /// <summary>
        /// Persist the supplied <see cref="EngineeringModelDataNote"/> instance.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// </param>
        /// <param name="thing">
        /// The <see cref="EngineeringModelDataNote"/> <see cref="Thing"/> to create.
        /// </param>
        /// <param name="container">
        /// The container instance of the <see cref="EngineeringModelDataNote"/> to be persisted.
        /// </param>
        /// <param name="sequence">
        ...
        public async Task<bool> CreateConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            var engineeringModelDataNote = thing as EngineeringModelDataNote;
            var createSuccesful = await this.EngineeringModelDataNoteDao.WriteAsync(transaction, partition, engineeringModelDataNote, container);
            return createSuccesful && await this.CreateContainmentAsync(transaction, partition, engineeringModelDataNote);
        }

        /// <summary>
        /// Persist the supplied <see cref="EngineeringModelDataNote"/> instance. Update if it already exists.
        /// This is typically used during the import of existing data to the Database.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        ...
        {
            var engineeringModelDataNote = thing as EngineeringModelDataNote;
            var createSuccesful = await this.EngineeringModelDataNoteDao.UpsertAsync(transaction, partition, engineeringModelDataNote, container);
            return createSuccesful && await this.UpsertContainmentAsync(transaction, partition, engineeringModelDataNote);
        }
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having List of instances of <see cref="EngineeringModelDataNote"/> as result.
        /// </returns>
        public async Task<IEnumerable<Thing>> GetShallowAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var authorizedContext = this.AuthorizeReadRequest("EngineeringModelDataNote", containerSecurityContext, partition);
            ...
            var engineeringModelDataNoteColl = new List<Thing>(await this.EngineeringModelDataNoteDao.ReadAsync(transaction, partition, idFilter, await this.TransactionManager.IsCachedDtoReadEnabledAsync(transaction), (DateTime)(await this.TransactionManager.GetRawSessionInstantAsync(transaction))));

            return await this.AfterGetAsync(engineeringModelDataNoteColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having List of instances of <see cref="EngineeringModelDataNote"/> and contained <see cref="Thing"/>s as result.
        /// </returns>
        public async Task<IEnumerable<Thing>> GetDeepAsync(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var engineeringModelDataNoteColl = results.Where(i => i.GetType() == typeof(EngineeringModelDataNote)).Cast<EngineeringModelDataNote>().ToList();

            results.AddRange(await this.DiscussionService.GetDeepAsync(transaction, partition, engineeringModelDataNoteColl.SelectMany(x => x.Discussion), containerSecurityContext));
            results.AddRange(await this.RelatedThingService.GetDeepAsync(transaction, partition, engineeringModelDataNoteColl.SelectMany(x => x.RelatedThing), containerSecurityContext));
        ...
        /// <summary>
        /// Persist the <see cref="EngineeringModelDataNote"/> containment tree to the ORM layer.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        /// </param>
        ...
        /// The <see cref="EngineeringModelDataNote"/> instance to persist.
        /// </param>
        /// <returns>
        /// An awaitable <see cref="Task"/> having True if the persistence was successful as result.
        /// </returns>
        private async Task<bool> CreateContainmentAsync(NpgsqlTransaction transaction, string partition, EngineeringModelDataNote engineeringModelDataNote)
        {
            var results = new List<bool>();

            foreach (var discussion in this.ResolveFromRequestCache(engineeringModelDataNote.Discussion))
            {
                results.Add(await this.DiscussionService.CreateConceptAsync(transaction, partition, discussion, engineeringModelDataNote));
            }

            foreach (var relatedThing in this.ResolveFromRequestCache(engineeringModelDataNote.RelatedThing))
            {
                results.Add(await this.RelatedThingService.CreateConceptAsync(transaction, partition, relatedThing, engineeringModelDataNote));
            }
        ...
        /// <summary>
        /// Persist the <see cref="EngineeringModelDataNote"/> containment tree to the ORM layer. Update if it already exists.
        /// This is typically used during the import of existing data to the Database.
        /// </summary>
        /// <param name="transaction">
        /// The current <see cref="NpgsqlTransaction"/> to the database.
        ...
        /// An awaitable <see cref="Task"/> having True if the persistence was successful as result.
        /// </returns>
        private async Task<bool> UpsertContainmentAsync(NpgsqlTransaction transaction, string partition, EngineeringModelDataNote engineeringModelDataNote)
        {
            var results = new List<bool>();

            foreach (var discussion in this.ResolveFromRequestCache(engineeringModelDataNote.Discussion))
            {
                results.Add(await this.DiscussionService.UpsertConceptAsync(transaction, partition, discussion, engineeringModelDataNote));
            }

            foreach (var relatedThing in this.ResolveFromRequestCache(engineeringModelDataNote.RelatedThing))
            {
                results.Add(await this.RelatedThingService.UpsertConceptAsync(transaction, partition, relatedThing, engineeringModelDataNote));
            }

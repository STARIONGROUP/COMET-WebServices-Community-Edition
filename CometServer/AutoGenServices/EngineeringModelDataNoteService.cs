...
namespace CometServer.Services
{
    ...
    public sealed partial class EngineeringModelDataNoteService : ServiceBase, IEngineeringModelDataNoteService
    {
        ...
        {
            return this.EngineeringModelDataNoteDao.AddToCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.EngineeringModelDataNoteDao.DeleteFromCollectionPropertyAsync(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.EngineeringModelDataNoteDao.ReorderCollectionPropertyAsync(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public Task<bool> RawDeleteConceptAsync(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.EngineeringModelDataNoteDao.RawDeleteAsync(transaction, partition, thing.Iid);
        }

...
namespace CometServer.Tests.Resources
{
    ...
    public class ResourceLoaderTestFixture
    {
        ...
        [Test]
        public void Verify_that_version_is_returned()
        {
            var result = this.resourceLoader.QueryVersion();

            Assert.That(result, Is.Not.Null.Or.Empty);
        }

        [Test]
        public void Verify_that_logo_is_returned()
        {
            var result = this.resourceLoader.QueryLogo();

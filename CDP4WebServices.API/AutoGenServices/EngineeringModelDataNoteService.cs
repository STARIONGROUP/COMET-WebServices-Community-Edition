...
namespace CDP4WebServices.API.Services
{
    ...
    /// <summary>
    /// The EngineeringModelDataNote Service which uses the ORM layer to interact with the data model.
    /// </summary>
    public sealed partial class EngineeringModelDataNoteService : ServiceBase, IEngineeringModelDataNoteService
    {
        ...
        /// <summary>
        /// Gets or sets the engineeringModelDataNote dao.
        /// </summary>
        ...
        public IEnumerable<Thing> GetDeep(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            results.AddRange(this.ModellingThingReferenceService.GetDeep(transaction, partition, engineeringModelDataNoteColl.SelectMany(x => x.RelatedThing), containerSecurityContext));
            results.AddRange(this.EngineeringModelDataDiscussionItemService.GetDeep(transaction, partition, engineeringModelDataNoteColl.SelectMany(x => x.Discussion), containerSecurityContext));

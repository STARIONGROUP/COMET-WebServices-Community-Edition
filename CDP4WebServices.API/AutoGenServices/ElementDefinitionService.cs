...
namespace CDP4WebServices.API.Services
{
    ...
    /// <summary>
    /// The ElementDefinition Service which uses the ORM layer to interact with the data model.
    /// </summary>
    public sealed partial class ElementDefinitionService : ServiceBase, IElementDefinitionService
    {
        ...
        /// <summary>
        /// Gets or sets the elementDefinition dao.
        /// </summary>
        ...
        public IEnumerable<Thing> GetDeep(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            results.AddRange(this.ElementUsageService.GetDeep(transaction, partition, elementDefinitionColl.SelectMany(x => x.ContainedElement), containerSecurityContext));
        ...
        /// The elementDefinition instance to persist.
        /// </param>
        /// <returns>
        /// True if the persistence was successful.
        /// </returns>
        private bool CreateContainment(NpgsqlTransaction transaction, string partition, ElementDefinition elementDefinition)
        {
            ...
            {
               results.Add(this.ElementUsageService.CreateConcept(transaction, partition, containedElement, elementDefinition));
            }

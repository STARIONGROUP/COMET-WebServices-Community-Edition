...
namespace CDP4WebServices.API.Services
{
    ...
    /// <summary>
    /// The StakeholderValue Service which uses the ORM layer to interact with the data model.
    /// </summary>
    public sealed partial class StakeholderValueService : ServiceBase, IStakeholderValueService
    {
        ...
        /// <summary>
        /// Gets or sets the stakeholderValue dao.
        /// </summary>
        ...
        /// The stakeholderValue instance to persist.
        /// </param>
        /// <returns>
        /// True if the persistence was successful.
        /// </returns>

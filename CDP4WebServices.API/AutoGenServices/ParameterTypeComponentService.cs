...
namespace CDP4WebServices.API.Services
{
    ...
    public sealed partial class ParameterTypeComponentService : ServiceBase, IParameterTypeComponentService
    {
        ...
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var parameterTypeComponentColl = new List<Thing>(this.ParameterTypeComponentDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction)));

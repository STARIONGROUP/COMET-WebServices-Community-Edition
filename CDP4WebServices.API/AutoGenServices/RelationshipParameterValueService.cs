...
namespace CDP4WebServices.API.Services
{
    ...
    public sealed partial class RelationshipParameterValueService : ServiceBase, IRelationshipParameterValueService
    {
        ...
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var relationshipParameterValueColl = new List<Thing>(this.RelationshipParameterValueDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction)));

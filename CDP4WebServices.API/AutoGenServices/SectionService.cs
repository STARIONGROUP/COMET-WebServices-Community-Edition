// --------------------------------------------------------------------------------------------------------------------
// <copyright file="SectionService.cs" company="RHEA System S.A.">
...
namespace CDP4WebServices.API.Services
{
    ...
    /// <summary>
    /// The Section Service which uses the ORM layer to interact with the data model.
    /// </summary>
    public sealed partial class SectionService : ServiceBase, ISectionService
    {
        ...
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var sectionColl = new List<Thing>(this.SectionDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction)));
        ...
        /// </param>
        /// <param name="section">
        /// The section instance to persist.
        /// </param>
        /// <returns>
        /// True if the persistence was successful.
        /// </returns>

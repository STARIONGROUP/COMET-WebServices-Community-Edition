...
namespace CDP4WebServices.API.Services
{
    ...
    /// <summary>
    /// The DiagramCanvas Service which uses the ORM layer to interact with the data model.
    /// </summary>
    public sealed partial class DiagramCanvasService : ServiceBase, IDiagramCanvasService
    {
        ...
        /// <summary>
        /// Gets or sets the diagramCanvas dao.
        /// </summary>
        ...
        public IEnumerable<Thing> GetDeep(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            results.AddRange(this.DiagramElementThingService.GetDeep(transaction, partition, diagramCanvasColl.SelectMany(x => x.DiagramElement), containerSecurityContext));
        ...
        /// The diagramCanvas instance to persist.
        /// </param>
        /// <returns>
        /// True if the persistence was successful.
        /// </returns>
        private bool CreateContainment(NpgsqlTransaction transaction, string partition, DiagramCanvas diagramCanvas)
        {
            ...
            {
               results.Add(this.DiagramElementThingService.CreateConcept(transaction, partition, diagramElement, diagramCanvas));
            }

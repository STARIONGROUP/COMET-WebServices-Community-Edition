...
namespace CDP4WebServices.API.Services
{
    ...
    /// <summary>
    /// The BinaryRelationship Service which uses the ORM layer to interact with the data model.
    /// </summary>
    public sealed partial class BinaryRelationshipService : ServiceBase, IBinaryRelationshipService
    {
        ...
        /// <summary>
        /// Gets or sets the binaryRelationship dao.
        /// </summary>
        ...
        public IEnumerable<Thing> GetDeep(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            results.AddRange(this.RelationshipParameterValueService.GetDeep(transaction, partition, binaryRelationshipColl.SelectMany(x => x.ParameterValue), containerSecurityContext));
        ...
        /// The binaryRelationship instance to persist.
        /// </param>
        /// <returns>
        /// True if the persistence was successful.
        /// </returns>
        private bool CreateContainment(NpgsqlTransaction transaction, string partition, BinaryRelationship binaryRelationship)
        {
            ...
            {
               results.Add(this.RelationshipParameterValueService.CreateConcept(transaction, partition, parameterValue, binaryRelationship));
            }

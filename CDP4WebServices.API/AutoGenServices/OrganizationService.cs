...
namespace CDP4WebServices.API.Services
{
    ...
    public sealed partial class OrganizationService : ServiceBase, IOrganizationService
    {
        ...
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var organizationColl = new List<Thing>(this.OrganizationDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction)));

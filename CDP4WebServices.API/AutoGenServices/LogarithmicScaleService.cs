...
namespace CDP4WebServices.API.Services
{
    ...
    /// <summary>
    /// The LogarithmicScale Service which uses the ORM layer to interact with the data model.
    /// </summary>
    public sealed partial class LogarithmicScaleService : ServiceBase, ILogarithmicScaleService
    {
        ...
        /// <summary>
        /// Gets or sets the logarithmicScale dao.
        /// </summary>
        ...
        public IEnumerable<Thing> GetDeep(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            results.AddRange(this.ScaleValueDefinitionService.GetDeep(transaction, partition, logarithmicScaleColl.SelectMany(x => x.ValueDefinition), containerSecurityContext));
            ...
            results.AddRange(this.ScaleReferenceQuantityValueService.GetDeep(transaction, partition, logarithmicScaleColl.SelectMany(x => x.ReferenceQuantityValue), containerSecurityContext));
        ...
        /// The logarithmicScale instance to persist.
        /// </param>
        /// <returns>
        /// True if the persistence was successful.
        /// </returns>
        private bool CreateContainment(NpgsqlTransaction transaction, string partition, LogarithmicScale logarithmicScale)
        {
            ...
            {
               results.Add(this.ScaleValueDefinitionService.CreateConcept(transaction, partition, valueDefinition, logarithmicScale));
            }
            ...
            {
               results.Add(this.ScaleReferenceQuantityValueService.CreateConcept(transaction, partition, referenceQuantityValue, logarithmicScale));
            }

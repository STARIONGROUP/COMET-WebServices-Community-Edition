...
namespace CDP4WebServices.API.Services
{
    ...
    public sealed partial class ArrayParameterTypeService : ServiceBase, IArrayParameterTypeService
    {
        ...
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var arrayParameterTypeColl = new List<Thing>(this.ArrayParameterTypeDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction)));

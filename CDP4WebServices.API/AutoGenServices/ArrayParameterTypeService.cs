...
namespace CDP4WebServices.API.Services
{
    ...
    /// <summary>
    /// The ArrayParameterType Service which uses the ORM layer to interact with the data model.
    /// </summary>
    public sealed partial class ArrayParameterTypeService : ServiceBase, IArrayParameterTypeService
    {
        ...
        /// <summary>
        /// Gets or sets the arrayParameterType dao.
        /// </summary>
        ...
        public IEnumerable<Thing> GetDeep(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            results.AddRange(this.ParameterTypeComponentService.GetDeep(transaction, partition, arrayParameterTypeColl.SelectMany(x => x.Component).ToIdList(), containerSecurityContext));

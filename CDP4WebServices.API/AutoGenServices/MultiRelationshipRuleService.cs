...
namespace CDP4WebServices.API.Services
{
    ...
    /// <summary>
    /// The MultiRelationshipRule Service which uses the ORM layer to interact with the data model.
    /// </summary>
    public sealed partial class MultiRelationshipRuleService : ServiceBase, IMultiRelationshipRuleService
    {
        ...
        /// <summary>
        /// Gets or sets the multiRelationshipRule dao.
        /// </summary>
        ...
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var multiRelationshipRuleColl = new List<Thing>(this.MultiRelationshipRuleDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction)));

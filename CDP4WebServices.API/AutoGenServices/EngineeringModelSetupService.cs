...
namespace CDP4WebServices.API.Services
{
    ...
    /// <summary>
    /// The EngineeringModelSetup Service which uses the ORM layer to interact with the data model.
    /// </summary>
    public sealed partial class EngineeringModelSetupService : ServiceBase, IEngineeringModelSetupService
    {
        ...
        public IEnumerable<Thing> GetDeep(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            results.AddRange(this.ModelReferenceDataLibraryService.GetDeep(transaction, partition, engineeringModelSetupColl.SelectMany(x => x.RequiredRdl), containerSecurityContext));
        ...
        /// The engineeringModelSetup instance to persist.
        /// </param>
        /// <returns>
        /// True if the persistence was successful.
        /// </returns>
        private bool CreateContainment(NpgsqlTransaction transaction, string partition, EngineeringModelSetup engineeringModelSetup)
        {
            ...
            {
               results.Add(this.ModelReferenceDataLibraryService.CreateConcept(transaction, partition, requiredRdl, engineeringModelSetup));
            }

...
namespace CDP4WebServices.API.Services
{
    ...
    /// <summary>
    /// The UserRuleVerification Service which uses the ORM layer to interact with the data model.
    /// </summary>
    public sealed partial class UserRuleVerificationService : ServiceBase, IUserRuleVerificationService
    {
        ...
        /// <summary>
        /// Gets or sets the userRuleVerification dao.
        /// </summary>
        ...
        public IEnumerable<Thing> GetDeep(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            results.AddRange(this.RuleViolationService.GetDeep(transaction, partition, userRuleVerificationColl.SelectMany(x => x.Violation), containerSecurityContext));

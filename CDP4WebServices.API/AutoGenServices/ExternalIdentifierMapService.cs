...
namespace CDP4WebServices.API.Services
{
    ...
    public sealed partial class ExternalIdentifierMapService : ServiceBase, IExternalIdentifierMapService
    {
        ...
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var externalIdentifierMapColl = new List<Thing>(this.ExternalIdentifierMapDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction)));

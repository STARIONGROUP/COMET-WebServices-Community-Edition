...
namespace CDP4WebServices.API.Services
{
    ...
    /// <summary>
    /// The ExternalIdentifierMap Service which uses the ORM layer to interact with the data model.
    /// </summary>
    public sealed partial class ExternalIdentifierMapService : ServiceBase, IExternalIdentifierMapService
    {
        ...
        /// <summary>
        /// Gets or sets the externalIdentifierMap dao.
        /// </summary>
        ...
        public IEnumerable<Thing> GetDeep(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            results.AddRange(this.IdCorrespondenceService.GetDeep(transaction, partition, externalIdentifierMapColl.SelectMany(x => x.Correspondence), containerSecurityContext));

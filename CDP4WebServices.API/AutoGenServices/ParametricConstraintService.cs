...
namespace CDP4WebServices.API.Services
{
    ...
    /// <summary>
    /// The ParametricConstraint Service which uses the ORM layer to interact with the data model.
    /// </summary>
    public sealed partial class ParametricConstraintService : ServiceBase, IParametricConstraintService
    {
        ...
        /// <summary>
        /// Gets or sets the parametricConstraint dao.
        /// </summary>
        ...
        public IEnumerable<Thing> GetDeep(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            results.AddRange(this.BooleanExpressionService.GetDeep(transaction, partition, parametricConstraintColl.SelectMany(x => x.Expression), containerSecurityContext));
        ...
        /// The parametricConstraint instance to persist.
        /// </param>
        /// <returns>
        /// True if the persistence was successful.
        /// </returns>
        private bool CreateContainment(NpgsqlTransaction transaction, string partition, ParametricConstraint parametricConstraint)
        {
            ...
            {
               results.Add(this.BooleanExpressionService.CreateConcept(transaction, partition, expression, parametricConstraint));
            }

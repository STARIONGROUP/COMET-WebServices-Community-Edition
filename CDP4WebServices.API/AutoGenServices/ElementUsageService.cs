...
namespace CDP4WebServices.API.Services
{
    ...
    public sealed partial class ElementUsageService : ServiceBase, IElementUsageService
    {
        ...
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var elementUsageColl = new List<Thing>(this.ElementUsageDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction)));

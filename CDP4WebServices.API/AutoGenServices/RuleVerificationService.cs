...
namespace CDP4WebServices.API.Services
{
    ...
    public sealed partial class RuleVerificationService : ServiceBase, IRuleVerificationService
    {
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="RuleVerification"/>, optionally with contained <see cref="Thing"/>s.
        /// </returns>
        ...
        public bool UpdateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            {
                return this.BuiltInRuleVerificationService.UpdateConcept(transaction, partition, ruleVerification, container);
            }

            if (ruleVerification.IsSameOrDerivedClass<UserRuleVerification>())
            {
                return this.UserRuleVerificationService.UpdateConcept(transaction, partition, ruleVerification, container);
            }
        ...
        public bool CreateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            if (ruleVerification.IsSameOrDerivedClass<BuiltInRuleVerification>())
            {
                return this.BuiltInRuleVerificationService.CreateConcept(transaction, partition, ruleVerification, container, sequence);
            }

            if (ruleVerification.IsSameOrDerivedClass<UserRuleVerification>())
            {
                return this.UserRuleVerificationService.CreateConcept(transaction, partition, ruleVerification, container, sequence);
            }
            throw new NotSupportedException(string.Format("The supplied DTO type: {0} is not a supported type", ruleVerification.GetType().Name));
        }
        ...
        public bool UpsertConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            if (ruleVerification.IsSameOrDerivedClass<BuiltInRuleVerification>())
            {
                return this.BuiltInRuleVerificationService.UpsertConcept(transaction, partition, ruleVerification, container, sequence);
            }

            if (ruleVerification.IsSameOrDerivedClass<UserRuleVerification>())
            {
                return this.UserRuleVerificationService.UpsertConcept(transaction, partition, ruleVerification, container, sequence);
            }
            throw new NotSupportedException(string.Format("The supplied DTO type: {0} is not a supported type", ruleVerification.GetType().Name));
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="RuleVerification"/>.
        /// </returns>
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            ruleVerificationColl.AddRange(this.BuiltInRuleVerificationService.GetShallow(transaction, partition, idFilter, authorizedContext));
            ruleVerificationColl.AddRange(this.UserRuleVerificationService.GetShallow(transaction, partition, idFilter, authorizedContext));

            return this.AfterGet(ruleVerificationColl, transaction, partition, idFilter);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="RuleVerification"/> and contained <see cref="Thing"/>s.
        /// </returns>
        public IEnumerable<Thing> GetDeep(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            results.AddRange(this.BuiltInRuleVerificationService.GetDeep(transaction, partition, idFilter, containerSecurityContext));
            results.AddRange(this.UserRuleVerificationService.GetDeep(transaction, partition, idFilter, containerSecurityContext));
            return results;
        }

...
namespace CDP4WebServices.API.Services
{
    ...
    public sealed partial class PossibleFiniteStateListService : ServiceBase, IPossibleFiniteStateListService
    {
        ...
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var possibleFiniteStateListColl = new List<Thing>(this.PossibleFiniteStateListDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction)));

...
namespace CDP4WebServices.API.Services
{
    ...
    /// <summary>
    /// The PossibleFiniteStateList Service which uses the ORM layer to interact with the data model.
    /// </summary>
    public sealed partial class PossibleFiniteStateListService : ServiceBase, IPossibleFiniteStateListService
    {
        ...
        /// <summary>
        /// Gets or sets the possibleFiniteStateList dao.
        /// </summary>
        ...
        public IEnumerable<Thing> GetDeep(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            results.AddRange(this.PossibleFiniteStateService.GetDeep(transaction, partition, possibleFiniteStateListColl.SelectMany(x => x.PossibleState).ToIdList(), containerSecurityContext));
        ...
        /// The possibleFiniteStateList instance to persist.
        /// </param>
        /// <returns>
        /// True if the persistence was successful.
        /// </returns>
        private bool CreateContainment(NpgsqlTransaction transaction, string partition, PossibleFiniteStateList possibleFiniteStateList)
        {
            ...
            {
               results.Add(this.PossibleFiniteStateService.CreateConcept(transaction, partition, (PossibleFiniteState)possibleState.V, possibleFiniteStateList, possibleState.K));
            }

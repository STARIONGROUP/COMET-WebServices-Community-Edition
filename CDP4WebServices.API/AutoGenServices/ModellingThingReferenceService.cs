...
namespace CDP4WebServices.API.Services
{
    ...
    public sealed partial class ModellingThingReferenceService : ServiceBase, IModellingThingReferenceService
    {
        ...
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var modellingThingReferenceColl = new List<Thing>(this.ModellingThingReferenceDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction)));

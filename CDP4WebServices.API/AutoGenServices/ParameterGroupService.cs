...
namespace CDP4WebServices.API.Services
{
    ...
    public sealed partial class ParameterGroupService : ServiceBase, IParameterGroupService
    {
        ...
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var parameterGroupColl = new List<Thing>(this.ParameterGroupDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction)));

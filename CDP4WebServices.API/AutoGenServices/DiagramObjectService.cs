...
namespace CDP4WebServices.API.Services
{
    ...
    /// <summary>
    /// The DiagramObject Service which uses the ORM layer to interact with the data model.
    /// </summary>
    public sealed partial class DiagramObjectService : ServiceBase, IDiagramObjectService
    {
        ...
        /// <summary>
        /// Gets or sets the diagramObject dao.
        /// </summary>
        ...
        public IEnumerable<Thing> GetDeep(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            results.AddRange(this.DiagramElementThingService.GetDeep(transaction, partition, diagramObjectColl.SelectMany(x => x.DiagramElement), containerSecurityContext));
            ...
            results.AddRange(this.OwnedStyleService.GetDeep(transaction, partition, diagramObjectColl.SelectMany(x => x.LocalStyle), containerSecurityContext));
        ...
        /// The diagramObject instance to persist.
        /// </param>
        /// <returns>
        /// True if the persistence was successful.
        /// </returns>
        private bool CreateContainment(NpgsqlTransaction transaction, string partition, DiagramObject diagramObject)
        {
            ...
            {
               results.Add(this.DiagramElementThingService.CreateConcept(transaction, partition, diagramElement, diagramObject));
            }
            ...
            {
               results.Add(this.OwnedStyleService.CreateConcept(transaction, partition, localStyle, diagramObject));
            }

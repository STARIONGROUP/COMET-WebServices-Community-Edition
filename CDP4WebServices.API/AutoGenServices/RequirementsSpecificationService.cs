...
namespace CDP4WebServices.API.Services
{
    ...
    /// <summary>
    /// The RequirementsSpecification Service which uses the ORM layer to interact with the data model.
    /// </summary>
    public sealed partial class RequirementsSpecificationService : ServiceBase, IRequirementsSpecificationService
    {
        ...
        /// <summary>
        /// Gets or sets the requirementsSpecification dao.
        /// </summary>
        ...
        public IEnumerable<Thing> GetDeep(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            results.AddRange(this.RequirementsGroupService.GetDeep(transaction, partition, requirementsSpecificationColl.SelectMany(x => x.Group), containerSecurityContext));
            results.AddRange(this.RequirementsContainerParameterValueService.GetDeep(transaction, partition, requirementsSpecificationColl.SelectMany(x => x.ParameterValue), containerSecurityContext));
        ...
        /// The requirementsSpecification instance to persist.
        /// </param>
        /// <returns>
        /// True if the persistence was successful.
        /// </returns>
        private bool CreateContainment(NpgsqlTransaction transaction, string partition, RequirementsSpecification requirementsSpecification)
        {
            ...
            {
               results.Add(this.RequirementsGroupService.CreateConcept(transaction, partition, group, requirementsSpecification));
            }

            foreach (var parameterValue in this.ResolveFromRequestCache(requirementsSpecification.ParameterValue))
            {
               results.Add(this.RequirementsContainerParameterValueService.CreateConcept(transaction, partition, parameterValue, requirementsSpecification));
            }

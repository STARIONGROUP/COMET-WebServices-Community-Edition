...
namespace CDP4WebServices.API.Services
{
    ...
    public sealed partial class ArchitectureElementService : ServiceBase, IArchitectureElementService
    {
        ...
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var architectureElementColl = new List<Thing>(this.ArchitectureElementDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction)));

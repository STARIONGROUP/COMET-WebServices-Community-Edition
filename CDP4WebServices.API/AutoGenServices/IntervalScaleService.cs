...
namespace CDP4WebServices.API.Services
{
    ...
    /// <summary>
    /// The IntervalScale Service which uses the ORM layer to interact with the data model.
    /// </summary>
    public sealed partial class IntervalScaleService : ServiceBase, IIntervalScaleService
    {
        ...
        /// <summary>
        /// Gets or sets the intervalScale dao.
        /// </summary>
        ...
        public IEnumerable<Thing> GetDeep(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            results.AddRange(this.ScaleValueDefinitionService.GetDeep(transaction, partition, intervalScaleColl.SelectMany(x => x.ValueDefinition), containerSecurityContext));
        ...
        /// The intervalScale instance to persist.
        /// </param>
        /// <returns>
        /// True if the persistence was successful.
        /// </returns>
        private bool CreateContainment(NpgsqlTransaction transaction, string partition, IntervalScale intervalScale)
        {
            ...
            {
               results.Add(this.ScaleValueDefinitionService.CreateConcept(transaction, partition, valueDefinition, intervalScale));
            }

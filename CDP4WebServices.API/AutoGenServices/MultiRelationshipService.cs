...
namespace CDP4WebServices.API.Services
{
    ...
    /// <summary>
    /// The MultiRelationship Service which uses the ORM layer to interact with the data model.
    /// </summary>
    public sealed partial class MultiRelationshipService : ServiceBase, IMultiRelationshipService
    {
        ...
        /// <summary>
        /// Gets or sets the multiRelationship dao.
        /// </summary>
        ...
        public IEnumerable<Thing> GetDeep(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            results.AddRange(this.RelationshipParameterValueService.GetDeep(transaction, partition, multiRelationshipColl.SelectMany(x => x.ParameterValue), containerSecurityContext));

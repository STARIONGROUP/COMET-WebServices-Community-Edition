...
namespace CDP4WebServices.API.Services
{
    ...
    public sealed partial class DomainFileStoreService : ServiceBase, IDomainFileStoreService
    {
        ...
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var domainFileStoreColl = new List<Thing>(this.DomainFileStoreDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction)));

...
namespace CDP4WebServices.API.Services
{
    ...
    /// <summary>
    /// The ParameterOverride Service which uses the ORM layer to interact with the data model.
    /// </summary>
    public sealed partial class ParameterOverrideService : ServiceBase, IParameterOverrideService
    {
        ...
        /// <summary>
        /// Gets or sets the parameterOverride dao.
        /// </summary>
        ...
        public IEnumerable<Thing> GetDeep(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            results.AddRange(this.ParameterOverrideValueSetService.GetDeep(transaction, partition, parameterOverrideColl.SelectMany(x => x.ValueSet), containerSecurityContext));
        ...
        /// The parameterOverride instance to persist.
        /// </param>
        /// <returns>
        /// True if the persistence was successful.
        /// </returns>
        private bool CreateContainment(NpgsqlTransaction transaction, string partition, ParameterOverride parameterOverride)
        {
            ...
            {
               results.Add(this.ParameterOverrideValueSetService.CreateConcept(transaction, partition, valueSet, parameterOverride));
            }

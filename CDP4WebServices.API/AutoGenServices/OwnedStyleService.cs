...
namespace CDP4WebServices.API.Services
{
    ...
    /// <summary>
    /// The OwnedStyle Service which uses the ORM layer to interact with the data model.
    /// </summary>
    public sealed partial class OwnedStyleService : ServiceBase, IOwnedStyleService
    {
        ...
        /// <summary>
        /// Gets or sets the ownedStyle dao.
        /// </summary>
        ...
        public IEnumerable<Thing> GetDeep(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            results.AddRange(this.ColorService.GetDeep(transaction, partition, ownedStyleColl.SelectMany(x => x.UsedColor), containerSecurityContext));
        ...
        /// The ownedStyle instance to persist.
        /// </param>
        /// <returns>
        /// True if the persistence was successful.
        /// </returns>
        private bool CreateContainment(NpgsqlTransaction transaction, string partition, OwnedStyle ownedStyle)
        {
            ...
            {
               results.Add(this.ColorService.CreateConcept(transaction, partition, usedColor, ownedStyle));
            }

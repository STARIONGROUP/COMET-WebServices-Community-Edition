...
namespace CDP4WebServices.API.Services
{
    ...
    public sealed partial class BuiltInRuleVerificationService : ServiceBase, IBuiltInRuleVerificationService
    {
        ...
        {
            return this.BuiltInRuleVerificationDao.ReorderContainment(transaction, partition, orderedItem);
        }
        ...
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var builtInRuleVerificationColl = new List<Thing>(this.BuiltInRuleVerificationDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction)));

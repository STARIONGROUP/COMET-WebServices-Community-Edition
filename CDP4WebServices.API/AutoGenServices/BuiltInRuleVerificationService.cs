...
namespace CDP4WebServices.API.Services
{
    ...
    /// <summary>
    /// The BuiltInRuleVerification Service which uses the ORM layer to interact with the data model.
    /// </summary>
    public sealed partial class BuiltInRuleVerificationService : ServiceBase, IBuiltInRuleVerificationService
    {
        ...
        /// <summary>
        /// Gets or sets the builtInRuleVerification dao.
        /// </summary>
        ...
        public IEnumerable<Thing> GetDeep(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            results.AddRange(this.RuleViolationService.GetDeep(transaction, partition, builtInRuleVerificationColl.SelectMany(x => x.Violation), containerSecurityContext));
        ...
        /// The builtInRuleVerification instance to persist.
        /// </param>
        /// <returns>
        /// True if the persistence was successful.
        /// </returns>
        private bool CreateContainment(NpgsqlTransaction transaction, string partition, BuiltInRuleVerification builtInRuleVerification)
        {
            ...
            {
               results.Add(this.RuleViolationService.CreateConcept(transaction, partition, violation, builtInRuleVerification));
            }

...
namespace CDP4WebServices.API.Services
{
    ...
    /// <summary>
    /// The StakeHolderValueMap Service which uses the ORM layer to interact with the data model.
    /// </summary>
    public sealed partial class StakeHolderValueMapService : ServiceBase, IStakeHolderValueMapService
    {
        ...
        /// <summary>
        /// Gets or sets the stakeHolderValueMap dao.
        /// </summary>
        ...
        public IEnumerable<Thing> GetDeep(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            results.AddRange(this.StakeHolderValueMapSettingsService.GetDeep(transaction, partition, stakeHolderValueMapColl.SelectMany(x => x.Settings), containerSecurityContext));

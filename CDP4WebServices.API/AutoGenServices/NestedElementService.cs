...
namespace CDP4WebServices.API.Services
{
    ...
    public sealed partial class NestedElementService : ServiceBase, INestedElementService
    {
        ...
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var nestedElementColl = new List<Thing>(this.NestedElementDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction)));

...
namespace CDP4WebServices.API.Services
{
    ...
    public sealed partial class ParameterValueSetService : ServiceBase, IParameterValueSetService
    {
        ...
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var parameterValueSetColl = new List<Thing>(this.ParameterValueSetDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction)));

...
namespace CDP4WebServices.API.Services
{
    ...
    public sealed partial class LinearConversionUnitService : ServiceBase, ILinearConversionUnitService
    {
        ...
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var linearConversionUnitColl = new List<Thing>(this.LinearConversionUnitDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction)));

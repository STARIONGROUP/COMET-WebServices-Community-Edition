...
namespace CDP4WebServices.API.Services
{
    ...
    public sealed partial class ArchitectureDiagramService : ServiceBase, IArchitectureDiagramService
    {
        ...
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var architectureDiagramColl = new List<Thing>(this.ArchitectureDiagramDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction)));

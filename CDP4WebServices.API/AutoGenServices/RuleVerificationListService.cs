...
namespace CDP4WebServices.API.Services
{
    ...
    /// <summary>
    /// The RuleVerificationList Service which uses the ORM layer to interact with the data model.
    /// </summary>
    public sealed partial class RuleVerificationListService : ServiceBase, IRuleVerificationListService
    {
        ...
        /// <summary>
        /// Gets or sets the ruleVerificationList dao.
        /// </summary>
        ...
        /// The ruleVerificationList instance to persist.
        /// </param>
        /// <returns>
        /// True if the persistence was successful.
        /// </returns>

...
namespace CometServer.Services
{
    ...
    public sealed partial class AndExpressionService : ServiceBase, IAndExpressionService
    {
        ...
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var andExpressionColl = new List<Thing>(this.AndExpressionDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction)));

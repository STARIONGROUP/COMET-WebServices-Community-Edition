...
namespace CDP4WebServices.API.Services
{
    ...
    /// <summary>
    /// The EnumerationParameterType Service which uses the ORM layer to interact with the data model.
    /// </summary>
    public sealed partial class EnumerationParameterTypeService : ServiceBase, IEnumerationParameterTypeService
    {
        ...
        /// <summary>
        /// Gets or sets the enumerationParameterType dao.
        /// </summary>
        ...
        public IEnumerable<Thing> GetDeep(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            results.AddRange(this.EnumerationValueDefinitionService.GetDeep(transaction, partition, enumerationParameterTypeColl.SelectMany(x => x.ValueDefinition).ToIdList(), containerSecurityContext));
        ...
        /// The enumerationParameterType instance to persist.
        /// </param>
        /// <returns>
        /// True if the persistence was successful.
        /// </returns>
        private bool CreateContainment(NpgsqlTransaction transaction, string partition, EnumerationParameterType enumerationParameterType)
        {
            ...
            {
               results.Add(this.EnumerationValueDefinitionService.CreateConcept(transaction, partition, (EnumerationValueDefinition)valueDefinition.V, enumerationParameterType, valueDefinition.K));
            }

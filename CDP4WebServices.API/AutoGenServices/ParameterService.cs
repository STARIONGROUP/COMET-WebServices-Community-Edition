...
namespace CDP4WebServices.API.Services
{
    ...
    /// <summary>
    /// The Parameter Service which uses the ORM layer to interact with the data model.
    /// </summary>
    public sealed partial class ParameterService : ServiceBase, IParameterService
    {
        ...
        /// <summary>
        /// Gets or sets the parameter dao.
        /// </summary>
        ...
        public IEnumerable<Thing> GetDeep(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            results.AddRange(this.ParameterValueSetService.GetDeep(transaction, partition, parameterColl.SelectMany(x => x.ValueSet), containerSecurityContext));
        ...
        /// The parameter instance to persist.
        /// </param>
        /// <returns>
        /// True if the persistence was successful.
        /// </returns>
        private bool CreateContainment(NpgsqlTransaction transaction, string partition, Parameter parameter)
        {
            ...
            {
               results.Add(this.ParameterValueSetService.CreateConcept(transaction, partition, valueSet, parameter));
            }

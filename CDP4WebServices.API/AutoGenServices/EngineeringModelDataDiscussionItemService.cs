...
namespace CDP4WebServices.API.Services
{
    ...
    public sealed partial class EngineeringModelDataDiscussionItemService : ServiceBase, IEngineeringModelDataDiscussionItemService
    {
        ...
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var engineeringModelDataDiscussionItemColl = new List<Thing>(this.EngineeringModelDataDiscussionItemDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction)));

...
namespace CDP4WebServices.API.Services
{
    ...
    public sealed partial class UserPreferenceService : ServiceBase, IUserPreferenceService
    {
        ...
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var userPreferenceColl = new List<Thing>(this.UserPreferenceDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction)));

...
namespace CDP4WebServices.API.Services
{
    ...
    public sealed partial class ActualFiniteStateListService : ServiceBase, IActualFiniteStateListService
    {
        ...
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var actualFiniteStateListColl = new List<Thing>(this.ActualFiniteStateListDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction)));

...
namespace CDP4WebServices.API.Services
{
    ...
    /// <summary>
    /// The ActualFiniteStateList Service which uses the ORM layer to interact with the data model.
    /// </summary>
    public sealed partial class ActualFiniteStateListService : ServiceBase, IActualFiniteStateListService
    {
        ...
        /// <summary>
        /// Gets or sets the actualFiniteStateList dao.
        /// </summary>
        ...
        public IEnumerable<Thing> GetDeep(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            results.AddRange(this.ActualFiniteStateService.GetDeep(transaction, partition, actualFiniteStateListColl.SelectMany(x => x.ActualState), containerSecurityContext));
        ...
        /// The actualFiniteStateList instance to persist.
        /// </param>
        /// <returns>
        /// True if the persistence was successful.
        /// </returns>
        private bool CreateContainment(NpgsqlTransaction transaction, string partition, ActualFiniteStateList actualFiniteStateList)
        {
            ...
            {
               results.Add(this.ActualFiniteStateService.CreateConcept(transaction, partition, actualState, actualFiniteStateList));
            }

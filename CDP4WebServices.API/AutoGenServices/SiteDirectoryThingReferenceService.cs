...
namespace CDP4WebServices.API.Services
{
    ...
    public sealed partial class SiteDirectoryThingReferenceService : ServiceBase, ISiteDirectoryThingReferenceService
    {
        ...
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var siteDirectoryThingReferenceColl = new List<Thing>(this.SiteDirectoryThingReferenceDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction)));

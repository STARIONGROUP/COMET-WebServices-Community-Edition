...
namespace CDP4WebServices.API.Services
{
    ...
    public sealed partial class BooleanParameterTypeService : ServiceBase, IBooleanParameterTypeService
    {
        ...
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var booleanParameterTypeColl = new List<Thing>(this.BooleanParameterTypeDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction)));

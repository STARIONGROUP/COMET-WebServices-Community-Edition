// --------------------------------------------------------------------------------------------------------------------
// <copyright file="CompoundParameterTypeService.cs" company="RHEA System S.A.">
...
namespace CDP4WebServices.API.Services
{
    ...
    public sealed partial class CompoundParameterTypeService : ServiceBase, ICompoundParameterTypeService
    {
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="CompoundParameterType"/>, optionally with contained <see cref="Thing"/>s.
        /// </returns>
        ...
        {
            return this.CompoundParameterTypeDao.AddToCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.CompoundParameterTypeDao.DeleteFromCollectionProperty(transaction, partition, propertyName, iid, value);
        }
        ...
        {
            return this.CompoundParameterTypeDao.ReorderCollectionProperty(transaction, partition, propertyName, iid, orderUpdate);
        }
        ...
        public bool DeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.CompoundParameterTypeDao.Delete(transaction, partition, thing.Iid);
        }
        ...
        public bool RawDeleteConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container = null)
        {
            ...
            return this.CompoundParameterTypeDao.RawDelete(transaction, partition, thing.Iid);
        }
        ...
        public bool UpdateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container)
        {
            ...
            {
                return this.ArrayParameterTypeService.UpdateConcept(transaction, partition, compoundParameterType, container);
            }
            return this.CompoundParameterTypeDao.Update(transaction, partition, compoundParameterType, container);
        }
        ...
        public bool CreateConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            if (compoundParameterType.IsSameOrDerivedClass<ArrayParameterType>())
            {
                return this.ArrayParameterTypeService.CreateConcept(transaction, partition, compoundParameterType, container);
            }

            var createSuccesful = this.CompoundParameterTypeDao.Write(transaction, partition, compoundParameterType, container);
            return createSuccesful && this.CreateContainment(transaction, partition, compoundParameterType);
        }
        ...
        public bool UpsertConcept(NpgsqlTransaction transaction, string partition, Thing thing, Thing container, long sequence = -1)
        {
            ...
            if (compoundParameterType.IsSameOrDerivedClass<ArrayParameterType>())
            {
                return this.ArrayParameterTypeService.UpsertConcept(transaction, partition, compoundParameterType, container);
            }

            var createSuccesful = this.CompoundParameterTypeDao.Upsert(transaction, partition, compoundParameterType, container);
            return createSuccesful && this.UpsertContainment(transaction, partition, compoundParameterType);
        }
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="CompoundParameterType"/>.
        /// </returns>
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var compoundParameterTypeColl = new List<Thing>(this.CompoundParameterTypeDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction)));
        ...
        /// </param>
        /// <returns>
        /// List of instances of <see cref="CompoundParameterType"/> and contained <see cref="Thing"/>s.
        /// </returns>
        ...
        /// True if the persistence was successful.
        /// </returns>
        private bool CreateContainment(NpgsqlTransaction transaction, string partition, CompoundParameterType compoundParameterType)
        {
            ...
            {
                results.Add(this.DefinitionService.CreateConcept(transaction, partition, definition, compoundParameterType));
            }

            foreach (var hyperLink in this.ResolveFromRequestCache(compoundParameterType.HyperLink))
            {
                results.Add(this.HyperLinkService.CreateConcept(transaction, partition, hyperLink, compoundParameterType));
            }
        ...
        /// True if the persistence was successful.
        /// </returns>
        private bool UpsertContainment(NpgsqlTransaction transaction, string partition, CompoundParameterType compoundParameterType)
        {
            var results = new List<bool>();
            ...
            foreach (var component in this.ResolveFromRequestCache(compoundParameterType.Component))
            {
                results.Add(this.ComponentService.UpsertConcept(transaction, partition, (ParameterTypeComponent)component.V, compoundParameterType, component.K));
            }

            foreach (var definition in this.ResolveFromRequestCache(compoundParameterType.Definition))
            {
                results.Add(this.DefinitionService.UpsertConcept(transaction, partition, definition, compoundParameterType));
            }

            foreach (var hyperLink in this.ResolveFromRequestCache(compoundParameterType.HyperLink))
            {
                results.Add(this.HyperLinkService.UpsertConcept(transaction, partition, hyperLink, compoundParameterType));
            }

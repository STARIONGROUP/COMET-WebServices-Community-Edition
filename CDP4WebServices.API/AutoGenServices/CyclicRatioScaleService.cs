...
namespace CDP4WebServices.API.Services
{
    ...
    /// <summary>
    /// The CyclicRatioScale Service which uses the ORM layer to interact with the data model.
    /// </summary>
    public sealed partial class CyclicRatioScaleService : ServiceBase, ICyclicRatioScaleService
    {
        ...
        /// <summary>
        /// Gets or sets the cyclicRatioScale dao.
        /// </summary>
        ...
        public IEnumerable<Thing> GetDeep(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            results.AddRange(this.ScaleValueDefinitionService.GetDeep(transaction, partition, cyclicRatioScaleColl.SelectMany(x => x.ValueDefinition), containerSecurityContext));

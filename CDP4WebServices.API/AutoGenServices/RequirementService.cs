...
namespace CDP4WebServices.API.Services
{
    ...
    /// <summary>
    /// The Requirement Service which uses the ORM layer to interact with the data model.
    /// </summary>
    public sealed partial class RequirementService : ServiceBase, IRequirementService
    {
        ...
        /// <summary>
        /// Gets or sets the requirement dao.
        /// </summary>
        ...
        public IEnumerable<Thing> GetDeep(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            results.AddRange(this.SimpleParameterValueService.GetDeep(transaction, partition, requirementColl.SelectMany(x => x.ParameterValue), containerSecurityContext));
        ...
        /// The requirement instance to persist.
        /// </param>
        /// <returns>
        /// True if the persistence was successful.
        /// </returns>
        private bool CreateContainment(NpgsqlTransaction transaction, string partition, Requirement requirement)
        {
            ...
            {
               results.Add(this.SimpleParameterValueService.CreateConcept(transaction, partition, parameterValue, requirement));
            }

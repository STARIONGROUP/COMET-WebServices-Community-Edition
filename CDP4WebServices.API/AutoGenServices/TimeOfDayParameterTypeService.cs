...
namespace CDP4WebServices.API.Services
{
    ...
    public sealed partial class TimeOfDayParameterTypeService : ServiceBase, ITimeOfDayParameterTypeService
    {
        ...
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var timeOfDayParameterTypeColl = new List<Thing>(this.TimeOfDayParameterTypeDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction)));

...
namespace CDP4WebServices.API.Services
{
    ...
    public sealed partial class NotExpressionService : ServiceBase, INotExpressionService
    {
        ...
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var notExpressionColl = new List<Thing>(this.NotExpressionDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction)));

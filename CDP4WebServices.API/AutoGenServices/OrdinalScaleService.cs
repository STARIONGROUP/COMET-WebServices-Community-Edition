...
namespace CDP4WebServices.API.Services
{
    ...
    /// <summary>
    /// The OrdinalScale Service which uses the ORM layer to interact with the data model.
    /// </summary>
    public sealed partial class OrdinalScaleService : ServiceBase, IOrdinalScaleService
    {
        ...
        /// <summary>
        /// Gets or sets the ordinalScale dao.
        /// </summary>
        ...
        public IEnumerable<Thing> GetDeep(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            results.AddRange(this.ScaleValueDefinitionService.GetDeep(transaction, partition, ordinalScaleColl.SelectMany(x => x.ValueDefinition), containerSecurityContext));
        ...
        /// The ordinalScale instance to persist.
        /// </param>
        /// <returns>
        /// True if the persistence was successful.
        /// </returns>
        private bool CreateContainment(NpgsqlTransaction transaction, string partition, OrdinalScale ordinalScale)
        {
            ...
            {
               results.Add(this.ScaleValueDefinitionService.CreateConcept(transaction, partition, valueDefinition, ordinalScale));
            }

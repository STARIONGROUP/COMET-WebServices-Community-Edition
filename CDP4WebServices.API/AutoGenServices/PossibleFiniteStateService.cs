...
namespace CDP4WebServices.API.Services
{
    ...
    /// <summary>
    /// The PossibleFiniteState Service which uses the ORM layer to interact with the data model.
    /// </summary>
    public sealed partial class PossibleFiniteStateService : ServiceBase, IPossibleFiniteStateService
    {
        ...
        /// <summary>
        /// Gets or sets the possibleFiniteState dao.
        /// </summary>
        ...
        /// The possibleFiniteState instance to persist.
        /// </param>
        /// <returns>
        /// True if the persistence was successful.
        /// </returns>

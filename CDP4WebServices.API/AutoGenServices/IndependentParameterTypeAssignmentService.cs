...
namespace CDP4WebServices.API.Services
{
    ...
    public sealed partial class IndependentParameterTypeAssignmentService : ServiceBase, IIndependentParameterTypeAssignmentService
    {
        ...
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var independentParameterTypeAssignmentColl = new List<Thing>(this.IndependentParameterTypeAssignmentDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction)));

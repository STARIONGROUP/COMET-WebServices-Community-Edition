...
namespace CDP4WebServices.API.Services
{
    ...
    public sealed partial class MappingToReferenceScaleService : ServiceBase, IMappingToReferenceScaleService
    {
        ...
        public IEnumerable<Thing> GetShallow(NpgsqlTransaction transaction, string partition, IEnumerable<Guid> ids, ISecurityContext containerSecurityContext)
        {
            ...
            var mappingToReferenceScaleColl = new List<Thing>(this.MappingToReferenceScaleDao.Read(transaction, partition, idFilter, this.TransactionManager.IsCachedDtoReadEnabled(transaction)));

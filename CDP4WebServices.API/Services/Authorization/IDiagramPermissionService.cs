// --------------------------------------------------------------------------------------------------------------------
// <copyright file="IDiagramPermissionService.cs" company="RHEA System S.A.">
...
namespace CDP4WebServices.API.Services.Authorization
{
    ...
    /// <summary>
    /// The Diagram permission interface.
    /// </summary>
    public interface IDiagramPermissionService
    {
        /// <summary>
        ...
        bool CanReadOwnedDiagram(IOwnedThing canvas, PublicationState publicationState, ParticipantAccessRightKind accessKind);
    }
}

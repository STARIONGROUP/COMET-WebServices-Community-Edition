...
namespace CDP4WebServices.API.Tests.SideEffects
{
    ...
    public class SpecializedQuantityKindSideEffectTestFixture
    {
        ...
        public void VerifyThatExceptionIsThrownWhenGeneralReferenceIsKindItself()
        {
            ...
            this.rawUpdateInfo = new ClasslessDTO(null) { { TestKey, this.specializedQuantityKindA.Iid } };
        ...
        public void VerifyThatExceptionIsThrownWhenGeneralReferenceIsOutOfChainOrLeadsToCircularDependency()
        {
            ...
            // Out of chain
            this.rawUpdateInfo = new ClasslessDTO(null) { { TestKey, this.specializedQuantityKindE.Iid } };
        ...
        public void VerifyThatExceptionIsNotThrownWhenGeneralReferenceDoesNotLeadToCircularDependency()
        {
            ...
            // There is a chain a -> b -> c
            this.rawUpdateInfo = new ClasslessDTO(null) { { TestKey, this.specializedQuantityKindD.Iid } };

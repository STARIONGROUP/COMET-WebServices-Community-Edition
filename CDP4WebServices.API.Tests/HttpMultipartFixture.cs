...
//            // When
//            var request = new HttpRequest("POST", new Url { Path = "/" }, CreateRequestStream(stream), headers);
...
//            // When
//            var request = new HttpRequest("POST", new Url { Path = "/", Scheme = "http" }, CreateRequestStream(stream), headers);
